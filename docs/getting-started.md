# GCP Radar: usage and operations
...
For the fuller project manual, start with [`docs/README.md`](README.md), then read [`docs/pipeline.md`](pipeline.md) for the stage-by-stage execution model and [`docs/repository-map.md`](repository-map.md) for the repository layout.
...
- [`docs/README.md`](README.md): project overview and documentation map
- [`docs/pipeline.md`](pipeline.md): pipeline purpose, stage contracts, and feedback loop
- [`docs/repository-map.md`](repository-map.md): top-level repository structure
- [`docs/strategy-so-far.md`](strategy-so-far.md): current strategy, bottlenecks, and implementation notes
