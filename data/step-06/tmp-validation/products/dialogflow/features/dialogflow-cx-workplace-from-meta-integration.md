...
- A value of 0.0 applies no boost and is not allowed. boostControlSpec : Provides more controls for a customized ranking than the basic combination of condition and boost.
