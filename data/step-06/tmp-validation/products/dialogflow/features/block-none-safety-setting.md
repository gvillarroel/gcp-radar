...
generated_at: "2026-04-14T02:32:45.625Z"
...
- After the restore, the restored draft agent will be trained automatically (unless disabled in agent settings).
- After the import, the imported draft agent will be trained automatically (unless disabled in agent settings).
- AgentsTransport , ], ] ] = None , client options : typing .
