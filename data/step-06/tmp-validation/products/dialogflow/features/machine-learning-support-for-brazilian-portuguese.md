...
generated_at: "2026-04-14T02:32:45.811Z"
product_name: "Dialogflow"
product_slug: "dialogflow"
feature_name: "Machine Learning Support for Brazilian Portuguese"
feature_slug: "machine-learning-support-for-brazilian-portuguese"
latest_feature_date: "2018-02-22"
deprecation_date: ""
...
# Machine Learning Support for Brazilian Portuguese
...
Machine learning support was added for Brazilian Portuguese, Korean, and Dutch.
...
- Intent training Flows uses machine learning (ML) algorithms to understand end-user inputs, match them to intents, and extract structured data.
...
- Machine learning and training Best Practice Details Intents should have at least 10-20 (depending on complexity of intent) training phrases.
- The more parameters you have in your intents, the more phrases you should provide to train the machine learning model.
- Machine learning will take care of grammatical forms, but you have to include all possible items.
...
- ML settings (machine learning) To access the machine learning settings, click the ML Settings tab.
