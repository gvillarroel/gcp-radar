...
feature_name: "Dialogflow CX generative AI agents"
feature_slug: "dialogflow-cx-generative-ai-agents"
...
# Dialogflow CX generative AI agents
...
Dialogflow CX generative AI agents use generative AI to power conversational agents.
...
- A conversation is an interaction between an agent, including live agents and Dialogflow agents, and a support customer.
- Get Validation Result Request The request message for Agents.GetValidationResult . com. google. cloud. dialogflow. v2.
