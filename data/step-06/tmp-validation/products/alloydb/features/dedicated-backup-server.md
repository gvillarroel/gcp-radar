...
feature_name: "Dedicated backup server"
feature_slug: "dedicated-backup-server"
...
AlloyDB Omni supports a dedicated backup server for streamlined backup operations.
...
Evidence snippets:
- Product Backup and recovery mechanisms Cloud SQL Supports both on-demand and automated backups, allowing you to restore an instance to a previous state.
- Firestore Supports automated backups that let you restore a database to a previous state.
- Bigtable Supports on-demand and automated backups.
