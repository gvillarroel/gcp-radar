...
generated_at: "2026-04-14T00:15:29.115Z"
...
- Union field query plans per minute . query plans per minute can be only one of the following: queryPlansPerMinute integer ( uint32 format) Number of query execution plans captured by Insights per minute for all queries combined.
...
- Supports running hybrid queries and similarity searches.
