...
- Modify the retention of automated snapshots To customize the retention period of automated snapshots, set the perfsnap.retention flag, which sets the duration for which automatic snapshots are kept.
