...
feature_name: "Variable read pool node count"
feature_slug: "variable-read-pool-node-count"
...
AlloyDB Omni read pool instances can be configured with a variable number of nodes.
...
- ReadPoolConfig JSON representation { "nodeCount" : integer } Fields nodeCount integer Read capacity, i.e. number of nodes in a read pool instance.
