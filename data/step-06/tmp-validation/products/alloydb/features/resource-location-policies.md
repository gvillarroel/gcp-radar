...
generated_at: "2026-04-14T00:15:29.185Z"
...
- REST To update specific fields of an existing cluster, use the PATCH method on the projects.locations.clusters resource .
...
- This ensures that even if an attacker compromises the agent's IAM token, the scope of damage is limited by the database engine's internal permissions—for example, preventing a DROP TABLE command.
