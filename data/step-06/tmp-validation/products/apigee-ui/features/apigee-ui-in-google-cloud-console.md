...
feature_name: "Apigee UI in Google Cloud console"
feature_slug: "apigee-ui-in-google-cloud-console"
...
# Apigee UI in Google Cloud console
...
The Apigee UI in Google Cloud console is a new integrated interface for performing Apigee tasks managed in Google Cloud.
...
Evidence snippets:
- Access the Apigee UI in the Google Cloud console, making it easier to access and manage Apigee while working with other Google Cloud resources.
...
- Apigee UI navigation If you are a long-time Apigee user, you may be accustomed to navigating the previous Apigee UI to perform the tasks you complete most frequently.
