...
generated_at: "2026-04-14T03:58:56.389Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "All ports for internal load balancer Services"
feature_slug: "all-ports-for-internal-load-balancer-services"
...
- Ingress supports more advanced use cases, such as: Name-based virtual hosting: You can use Ingress to reuse the load balancer for multiple domain names, subdomains, and to expose multiple Services on a single IP address and load balancer.
