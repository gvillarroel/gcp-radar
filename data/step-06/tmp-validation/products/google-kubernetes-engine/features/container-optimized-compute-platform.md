...
generated_at: "2026-04-14T03:58:56.154Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "Container-optimized compute platform"
feature_slug: "container-optimized-compute-platform"
...
GKE Standard clusters can now use the container-optimized compute platform features associated with Autopilot.
...
- Example: nodeLabels : { 'example-nodelabel-key' : 'example-nodelabel-value' , 'example-nodelabel-key-2' : 'example-nodelabel-value-2' , } nodepools optional []string Requires GKE version 1.30.3-gke.1451000 or later A list of existing manually created node pools in Standard mode clusters.
