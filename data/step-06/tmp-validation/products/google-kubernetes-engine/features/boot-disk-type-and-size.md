...
generated_at: "2026-04-14T03:58:56.412Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "Boot disk type and size"
feature_slug: "boot-disk-type-and-size"
...
- Sets the boot disk size to 100 GiB for any new auto-created node pools.
...
- If omitted, GKE determines an optimal size based on node memory. swap size can be only one of the following: swapSizeGib string ( int64 format) Specifies the size of the swap space in gibibytes (GiB). swapSizePercent integer Specifies the size of the swap space as a percentage of the boot disk size.
