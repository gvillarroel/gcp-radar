...
generated_at: "2026-04-14T03:58:56.243Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "Webhook insights and recommendations"
feature_slug: "webhook-insights-and-recommendations"
...
# Webhook insights and recommendations
...
GKE provides insights and recommendations for webhooks that intercept system resources or have no available endpoints.
...
- CVE-2020-8561 Medium GKE clusters on Description Severity A security vulnerability, CVE-2020-8561 , has been discovered in Kubernetes where certain webhooks can be made to redirect kube-apiserver requests to private networks of that API server.
- CVE-2020-8561 Medium GKE clusters on Description Severity A security vulnerability, CVE-2020-8561 , has been discovered in Kubernetes where certain webhooks can be made to redirect kube-apiserver requests to private networks of that API server.
...
Evidence snippets:
- Mutating dynamic admission webhooks In Autopilot clusters only, GKE modifies mutating webhooks to exclude resources in managed namespaces, such as kube-system , from being intercepted.
