...
generated_at: "2026-04-14T03:58:56.307Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "Spot Pods on GKE Autopilot"
feature_slug: "spot-pods-on-gke-autopilot"
...
Spot Pods let you run fault-tolerant workloads on GKE Autopilot clusters at reduced cost.
...
- If the ComputeClass that you set as the default uses podFamily priority rules, Pods that don't select a different ComputeClass can run as general-purpose Autopilot Pods.
- If you set an Autopilot ComputeClass as the default, you can ensure that all Pods run in Autopilot mode unless a workload selects a different option.
