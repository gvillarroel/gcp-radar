...
feature_name: "Simplified networking configuration"
feature_slug: "simplified-networking-configuration"
...
Cloud Composer 3 simplifies environment networking configuration.
...
Evidence snippets:
- In the Network configuration section: In the Networking type , select Private IP environment .
...
Evidence snippets:
- To specify Airflow configuration overrides and environment variables: Console On the Create environment page: Expand the Networking, Airflow config overrides, and additional features item.
