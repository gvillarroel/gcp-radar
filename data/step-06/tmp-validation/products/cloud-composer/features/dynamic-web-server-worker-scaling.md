...
generated_at: "2026-04-14T01:12:02.288Z"
product_name: "Cloud Composer"
product_slug: "cloud-composer"
feature_name: "Dynamic web server worker scaling"
feature_slug: "dynamic-web-server-worker-scaling"
...
# Dynamic web server worker scaling
...
Cloud Composer 2 dynamically sets the number of web server workers based on available CPU and memory.
...
Evidence snippets:
- The minimum and maximum number of workers in your environment changes dynamically depending on the number of tasks in the queue.
...
Evidence snippets:
- Scale and performance parameters You can control the scale and performance parameters of your environment by adjusting the machine types used by the Airflow database and web server components of your environment.
...
- In addition to running Airflow workers, your environment nodes also run schedulers and other environment components.
