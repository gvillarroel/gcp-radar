...
- Enable or disable Data Catalog sync for an existing service To enable or disable Data Catalog sync for an existing service, use the following instructions.
- If you disable Data Catalog sync, your metadata stops syncing from Dataproc Metastore to Data Catalog.
