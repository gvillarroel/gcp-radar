...
generated_at: "2026-04-14T01:49:39.178Z"
...
- Checkpoint diagnostic data Cluster node detail logs: Managed Service for Apache Spark runs the following commands to collect and write YARN and HDFS information to the following locations in the checkpoint diagnostic data folder in Cloud Storage.
...
- Console Managed Service for Apache Spark Job driver and YARN container logs are listed under the Cloud Managed Service for Apache Spark Job resource.
