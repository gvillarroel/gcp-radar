...
Evidence snippets:
- Image families are used to group similar images together, and can be used when creating a cluster as a pointer to the most recent image in the family.
...
- Dataproc derives the names from clusterName , numInstances , and the instance group. imageUri string Optional.
