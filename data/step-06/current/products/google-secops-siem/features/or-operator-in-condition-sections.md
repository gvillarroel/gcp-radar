...
generated_at: "2026-04-15T00:53:15.511Z"
...
- UDM fields that can or cannot be downloaded to CSV from the platform Supported and unsupported UDM fields for downloading are shown in the following subsections.
...
- These two outcome variables are then combined together in another matched conditions variable, which allows the use of chained logic in the condition section.
- These variables are then combined to form a new outcome variable that can be used in the condition section.
