...
generated_at: "2026-04-15T00:53:15.563Z"
product_name: "Google SecOps SIEM"
product_slug: "google-secops-siem"
feature_name: "Azure Event Hub feed"
feature_slug: "azure-event-hub-feed"
...
- Create an Azure Event Hub feed Supported in: Google secops SIEM This document shows you how to set up an Azure Event Hub to send security data to Google Security Operations.
- Obtain the event hub connection string required for Google SecOps to ingest data from the Azure event hub.
