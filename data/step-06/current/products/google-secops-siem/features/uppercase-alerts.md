...
- How alerts are surfaced Google SecOps evaluates the events returned in search against events that exist for alerts in the customer environment.
...
- The Alerts tab displays the source of the alert in the Inputs column.
