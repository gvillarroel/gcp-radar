...
generated_at: "2026-04-11T17:56:14.477Z"
product_name: "Google SecOps SIEM"
product_slug: "google-secops-siem"
feature_name: "India (Mumbai) region"
feature_slug: "india-mumbai-region"
...
Chronicle customers can store customer data in the India (Mumbai) region and use a regional API endpoint.
...
Evidence snippets:
- December 15, 2023 Feature Google has added KSA (Dammam) and India (Mumbai) as new regions for Chronicle customers.
