...
Evidence snippets:
- September 04, 2018 Feature Key Visualizer now includes the ability to view multiple metrics at once .
...
- April 06, 2020 Feature Key Visualizer for Cloud Bigtable is now integrated into the Google Cloud Console .
- Change You can now use Key Visualizer for Cloud Bigtable to analyze tables that are at least 1 GB.
