...
feature_name: "Go 1.22 runtime preview for App Engine standard environment"
feature_slug: "go-1-22-runtime-preview-for-app-engine-standard-environment"
...
keywords:
  - "runtime: go122"
  - "Go 1.22 runtime preview"
  - "go122"
  - "Go 1.22 availability"
  - "Go 1.22 preview"
  - "enable preview"
...
# Go 1.22 runtime preview for App Engine standard environment
...
Go 1.22 is now available in preview for the App Engine standard environment.
