...
feature_name: "Legacy bundled services for Go 1.12+ in App Engine standard"
feature_slug: "legacy-bundled-services-for-go-1-12-in-app-engine-standard"
...
keywords:
  - "App Engine legacy bundled APIs"
  - "legacy bundled APIs"
  - "language-idiomatic libraries"
  - "legacy service compatibility"
  - "standard environment bundles"
  - "legacy bundled services"
  - "idiomatic libraries"
  - "Go 1.12+ bundled services"
---

# Legacy bundled services for Go 1.12+ in App Engine standard
...
App Engine legacy bundled services are now available at GA for Go 1.12+ runtimes in the standard environment via language-idiomatic libraries.
...
- Re-rank rationale: This page is specifically about installing and using legacy bundled services with the Go runtime, including required SDK/import updates and migration guidance.
