...
Evidence snippets:
- App Engine apps can use third-party companies to send email, SMS messages, or make and receive phone calls.
...
- Learn more about SendGrid: SendGrid developer documentation SendGrid client libraries SMS and Voice Services via Twilio You can use Twilio to embed voice, VoIP, and messaging into applications.
