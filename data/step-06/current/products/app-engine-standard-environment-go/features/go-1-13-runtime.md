...
The App Engine standard environment supports deploying applications with the Go 1.13 runtime; App Engine standard environment supports the Go 1.13 runtime.
