...
generated_at: "2026-04-14T05:36:38.543Z"
product_name: "App Engine Admin API"
product_slug: "app-engine-admin-api"
feature_name: "Cloud Endpoints Frameworks v1 for App Engine standard deprecation"
feature_slug: "cloud-endpoints-frameworks-v1-for-app-engine-standard-deprecation"
...
# Cloud Endpoints Frameworks v1 for App Engine standard deprecation
...
Cloud Endpoints Frameworks v1 for App Engine standard was deprecated, with migration to v2 required before shutdown; deprecated on 2017-08-02.
...
- Las siguientes tareas muestran el flujo de trabajo básico de un desarrollador para crear ese servicio web con el almacenamiento de datos de Firestore en modo Datastore (Datastore) y la autenticación de Firebase : Crea tu Google Cloud proyecto Consulta cómo crear un Google Cloud proyecto y, a continuación, configurar los recursos de App Engine para tu servicio web.
- Escribir un servicio web Aprende a escribir y probar localmente un servicio web básico y, a continuación, define los archivos de configuración que necesitas para desplegar ese servicio web en App Engine.
