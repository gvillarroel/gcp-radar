...
generated_at: "2026-04-14T15:34:54.595Z"
...
source_links:
  ...
  - "https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-java-service"
keywords:
  - "based"
  - "directly"
  - "deployment"
...
- RUN cmake -- build / v / binary RUN strip / v / binary / cloud run hello Create the final deployment image, using scratch (the empty Docker image) as the starting point.
- By following the steps in this quickstart, Cloud Run automatically builds a Dockerfile for you when you deploy from source code .
...
### "Quickstart: Build and deploy a Java Spring Boot web app to Google Cloud\

- URL: [https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-java-service](https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-java-service)
- Source ID: `site-docs-reference-2`
- Final score: 181
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
