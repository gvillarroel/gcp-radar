...
generated_at: "2026-04-14T15:34:54.523Z"
...
- We strongly recommend that you enforce this constraint to disable the automatic role grant.
...
- Use the gcloud credential helper to authorize Docker to push to your Artifact Registry. gcloud auth configure-docker Use the Jib Maven Plugin to build and push the container to Artifact Registry. mvn compile jib:build -Dimage = REGION -docker.pkg.dev/ PROJECT ID / REPOSITORY /renderer Where PROJECT ID is your Google Cloud project ID, and renderer is the name you want to give your service.
