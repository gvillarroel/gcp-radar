...
generated_at: "2026-04-10T19:26:07.609Z"
product_name: "Chat API"
product_slug: "chat-api"
feature_name: "Chat card widget: Chip"
feature_slug: "chat-card-widget-chip"
...
Chat cards now support the Chip widget for building card-based user interfaces.
...
- Currently supported field paths: text attachment cards (Requires app authentication .) cards v2 (Requires app authentication .) accessory widgets (Requires app authentication .) quoted message metadata (Only allows removal of the quoted message.) allow missing bool Optional.
