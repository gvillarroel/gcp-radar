...
generated_at: "2026-04-10T19:26:07.574Z"
product_name: "Chat API"
product_slug: "chat-api"
feature_name: "Chat API per-space write quotas for messages and reactions"
feature_slug: "chat-api-per-space-write-quotas-for-messages-and-reactions"
...
# Chat API per-space write quotas for messages and reactions
...
Chat API per-space quota limits for writing messages and reactions were increased, with `spaces.messages.create` raised to 600 per minute and `spaces.messages.reactions.create` raised to 300 per minute.
...
- Setting for managing webhooks in a space. postMessages object ( PermissionSetting ) Output only.
