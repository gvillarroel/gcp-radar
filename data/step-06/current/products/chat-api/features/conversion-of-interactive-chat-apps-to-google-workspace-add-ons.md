...
generated_at: "2026-04-10T19:26:07.566Z"
product_name: "Chat API"
product_slug: "chat-api"
feature_name: "Conversion of interactive Chat apps to Google Workspace add-ons"
feature_slug: "conversion-of-interactive-chat-apps-to-google-workspace-add-ons"
...
# Conversion of interactive Chat apps to Google Workspace add-ons
...
Interactive event-driven Google Chat apps can be converted into Google Workspace add-ons to extend Chat within the Workspace add-ons framework.
...
- Available for Google Workspace add-ons and unavailable for Google Chat apps. fixed footer CardFixedFooter The fixed footer shown at the bottom of this card.
