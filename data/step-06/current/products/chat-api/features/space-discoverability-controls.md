...
generated_at: "2026-04-14T15:27:57.203Z"
product_name: "Chat API"
product_slug: "chat-api"
feature_name: "Space discoverability controls"
feature_slug: "space-discoverability-controls"
...
Evidence snippets:
- To learn more, see Make a space discoverable to specific users . access settings.audience is not supported with useAdminAccess . permission settings : Supports changing the permission settings of a space.
- To learn more, see Make a space discoverable to specific users .
- For details, see Make a space discoverable to a target audience .
