...
generated_at: "2026-04-12T12:12:51.049Z"
...
- When you create an HA VPN gateway, two new external IP addresses are created.
- The new HA VPN gateway that you create has two new external IP addresses.
