...
feature_name: "Cloud VPN regional availability in europe-central2"
feature_slug: "cloud-vpn-regional-availability-in-europe-central2"
...
# Cloud VPN regional availability in europe-central2
...
Cloud VPN is available in the europe-central2 region (Warsaw, Poland).
...
Evidence snippets:
- March 24, 2021 Feature Cloud VPN is now available in region europe-central2 (Warsaw, Poland).
