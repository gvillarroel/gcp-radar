...
feature_name: "Create Plugin API for custom plugins"
feature_slug: "create-plugin-api-for-custom-plugins"
...
# Create Plugin API for custom plugins
...
Adds an API operation to create custom plugins in API hub for connecting to specific API data sources.
...
- API hub supports two types of attributes: System attributes : These are predefined attributes provided by API hub, such as API style, Target users, and Maturity level Additional attributes : These are custom attributes that you can create to meet your organization's specific needs.
