...
feature_name: "Fast failure for blocked package downloads in Private IP environments"
feature_slug: "fast-failure-for-blocked-package-downloads-in-private-ip-environments"
...
# Fast failure for blocked package downloads in Private IP environments
...
Cloud Composer fails faster when Private IP network settings block downloads of publicly hosted Python packages.
