...
feature_name: "Cloud SQL migration assessment"
feature_slug: "cloud-sql-migration-assessment"
...
# Cloud SQL migration assessment
...
Migration Center can assess database migration journeys to Cloud SQL and provide a technical fit assessment for the target.
...
- Run automated scripts to collect data from other cloud providers or from databases, then import the data into Migration Center for further assessment.
...
- Plan your migration By using the detailed assessment, you can plan your migration, while lowering the overall migration risks.
