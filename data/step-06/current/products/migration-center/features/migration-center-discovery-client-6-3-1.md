...
generated_at: "2026-04-10T05:27:46.545Z"
product_name: "Migration Center"
product_slug: "migration-center"
feature_name: "Migration Center discovery client 6.3.1"
feature_slug: "migration-center-discovery-client-6-3-1"
...
source_links:
  ...
  - "https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList"
keywords:
  - "migration"
  - "center"
  - "discovery"
...
# Migration Center discovery client 6.3.1
...
Migration Center discovery client version 6.3.1 is available with new features and bug fixes.
...
- [https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList](https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList)
...
### AssetList | Migration Center | Google Cloud Documentation

- URL: [https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList](https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList)
...
Evidence snippets:
- AssetList Migration Center Google Cloud Documentation Source URL: https://docs.cloud.google.com/migration-center/docs/reference/rest/v1/AssetList Documentation · Compute · Migration Center · Reference · Send feedback · JSON representation · Lists the asset IDs of all assets.
- Send feedback · Except as otherwise noted, the content of this page is licensed under the Creative Commons Attribution 4.0 License, and code samples are licensed ...
