...
feature_name: "Google Forms integration"
feature_slug: "google-forms-integration"
...
Adds a Google Forms integration.
...
- Force Bool N/A No If selected, the action performs an ungraceful (hard) shutdown, immediately halting the instance without letting it flush file system caches or metadata.
