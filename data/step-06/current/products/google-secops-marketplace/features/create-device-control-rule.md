...
feature_name: "Create Device Control Rule"
feature_slug: "create-device-control-rule"
...
- To streamline and improve the mapping process for the connector, the default value device product resolves to a fallback value that is referenced from the code.
