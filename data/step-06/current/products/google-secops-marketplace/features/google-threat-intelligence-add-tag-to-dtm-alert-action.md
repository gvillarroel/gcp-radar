...
feature_name: "Google Threat Intelligence Add Tag To DTM Alert action"
feature_slug: "google-threat-intelligence-add-tag-to-dtm-alert-action"
...
# Google Threat Intelligence Add Tag To DTM Alert action
...
- Add Threat Type To Case Checkbox Unchecked No If enabled, action will add threat types of the entity from all records as tags to the case.
...
- Tags CSV N/A No Specify additional tags that should be added to the Threat Intelligence Set.
