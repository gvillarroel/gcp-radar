...
feature_name: "Get Custom Field Values"
feature_slug: "get-custom-field-values"
...
- For any fields that aren't provided, default values are applied during collector creation.
...
- Reason: {exception.stacktrace} General List Policies Description List all the managed policies that are available in your AWS account, including your own customer-defined managed policies and all AWS managed policies.
...
- The possible values are as follows: New Notified Resolved Suppressed Custom Fields Optional The finding custom fields to update, such as Custom field 1: VALUE , Custom field 2: VALUE .
