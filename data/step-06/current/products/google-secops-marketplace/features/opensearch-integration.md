...
feature_name: "OpenSearch integration"
feature_slug: "opensearch-integration"
...
- Allocate a new Elastic IP address Associate a new Elastic IP address Resource management - use instance custom tags to track and identify AWS resources.
