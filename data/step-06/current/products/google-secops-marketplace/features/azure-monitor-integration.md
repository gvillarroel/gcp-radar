...
feature_name: "Azure Monitor integration"
feature_slug: "azure-monitor-integration"
...
- Collect Microsoft Entra ID data (formerly called Azure AD), including the following: Microsoft Entra ID logs Microsoft Entra ID audit logs Microsoft Entra ID context data Collect Microsoft Graph security API alert logs to Ingest Microsoft Defender for Cloud logs using the Microsoft Graph Security API.
