...
feature_name: "DeepSeek-V3.1 model availability in Model Garden"
feature_slug: "deepseek-v3-1-model-availability-in-model-garden"
...
# DeepSeek-V3.1 model availability in Model Garden
...
The DeepSeek-V3.1 model is now available through Vertex AI Model Garden.
...
- The notebook environment is where you run code that downloads and prepares a dataset, then use the dataset to create and train a model.
