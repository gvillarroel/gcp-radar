...
feature_name: "Vector Search Private Service Connect automation"
feature_slug: "vector-search-private-service-connect-automation"
...
- Retrieve approximate nearest neighbors using a Private Service Connect endpoint After you've connected to the Private Service Connect endpoint over gRPC, you can search for approximate nearest neighbors of an embedding or entity.
- Search nearest neighbor matches using a Private Service Connect endpoint : Choose this option only if the online store is configured for Optimized online serving from a dedicated serving endpoint over Private Service Connect.
- If you want to search nearest neighbor matches using a Private Service Connect endpoint, install or upgrade to the latest version of the Python SDK.
...
- Vector Search also supports autoscaling which can automatically resize the number of nodes based on the demands of your workloads.
