...
Evidence snippets:
- February 26, 2021 Feature Hierarchical firewall policies are now available in General Availability .
- June 03, 2020 Feature Hierarchical firewall policies are now available in Beta .
- May 11, 2016 Feature The following VPC IAM roles are now generally available: roles/compute.networkAdmin , roles/compute.securityAdmin , roles/iam.serviceAccountActor For more information, read the IAM documentation.
- August 05, 2022 Feature Network firewall policies and regional firewall policies are now available in General Availability .
