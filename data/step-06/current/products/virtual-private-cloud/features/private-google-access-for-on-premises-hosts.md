...
- Fixed Connectivity from on-premises hosts to a Private Service Connect endpoint that is used to access managed services now correctly establishes for all service attachment configurations.
...
- February 01, 2019 Feature The private access option for on-premises hosts is now Generally Available .
