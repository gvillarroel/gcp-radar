...
Evidence snippets:
- December 20, 2018 Feature IP address allocation for private services access is now available in General Availability .
...
- VM A2 and VM B2 can both access Google APIs and services, including Cloud Storage, because they each have external IP addresses.
