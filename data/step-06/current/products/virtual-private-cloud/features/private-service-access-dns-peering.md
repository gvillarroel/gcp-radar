...
feature_name: "Private Service Access DNS peering"
feature_slug: "private-service-access-dns-peering"
...
- Update the subnet—for example, to expand the CIDR range or enable Private Google Access.
