...
feature_name: "VPC Flow Logs VPC network-level enablement via Network Management API"
feature_slug: "vpc-flow-logs-vpc-network-level-enablement-via-network-management-api"
...
# VPC Flow Logs VPC network-level enablement via Network Management API
...
VPC networks can have VPC Flow Logs enabled via the Network Management API.
