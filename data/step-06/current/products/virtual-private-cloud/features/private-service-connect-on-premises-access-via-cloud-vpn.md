...
- You can do this in any of the following ways: If your destination endpoint is within an on-premises network, use a NCC solution or a hybrid connectivity solution , such as Cloud VPN or Cloud Interconnect .
