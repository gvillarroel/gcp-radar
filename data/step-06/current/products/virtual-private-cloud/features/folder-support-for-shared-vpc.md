...
Evidence snippets:
- May 09, 2018 Feature Folder support for Shared VPC is now available in Beta .
- July 23, 2020 Feature Serverless VPC Access support for Shared VPC is now available in Beta .
- Feature The ability to connect VM interfaces other than nic0 to a Shared VPC is now available in General Availability for instance templates and managed instance groups.
