...
- Paths for Private Service Connect endpoints for global Google APIs When you create a Private Service Connect endpoint for global Google APIs , Google Cloud adds a route for the endpoint to your VPC network.
...
Evidence snippets:
- April 25, 2022 Feature Automatic DNS configuration for Private Service Connect endpoints is available in General Availability .
