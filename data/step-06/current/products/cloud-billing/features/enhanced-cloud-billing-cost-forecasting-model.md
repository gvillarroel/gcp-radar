...
generated_at: "2026-04-14T13:57:37.545Z"
...
- Comprehensive data regularization : The forecasting model consistently structures your cost data over time, enabling reliable time-series analysis by our machine learning models.
- The cost trend is determined by: Gathering historical data : Based on the report filters you select, the forecasting model collects all of your historical Google Cloud spend.
- For example, if you're viewing a report for the current month, cost data from previous months is included in the forecasting model for the calculation of predicted cost.
