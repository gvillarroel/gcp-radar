...
feature_name: "Qwen-Image-Edit"
feature_slug: "qwen-image-edit"
...
Evidence snippets:
- This includes the input text prompt and uploaded photos in the case of image editing.
...
- This config is only enabled in Editing config. alternateInitConfig object ( AlternateInitConfig ) Parameters for AlternateInitConfig outpaintingConfig object ( OutpaintingProcessingConfig ) Outpainting config.
