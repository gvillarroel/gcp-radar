...
feature_name: "DeepSeek-V3.2-Exp"
feature_slug: "deepseek-v3-2-exp"
...
Evidence snippets:
- For links to model cards, see the list of models in Explore AI models in Model Garden .
...
- Assuming that the policies are merged, access to the model is denied at the project level because the explicit deny policy at the folder level takes precedence.
