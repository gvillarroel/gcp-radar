...
feature_name: "gpt-oss models in Model Garden"
feature_slug: "gpt-oss-models-in-model-garden"
...
- For example, this policy doesn't apply to models that are registered in Vertex AI Model Registry.
