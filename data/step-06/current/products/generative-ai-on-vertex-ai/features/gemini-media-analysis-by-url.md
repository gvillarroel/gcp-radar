...
feature_name: "Gemini media analysis by URL"
feature_slug: "gemini-media-analysis-by-url"
...
Evidence snippets:
- It can be any MIME type supported by Gemini multimodal models, such as text, audio, or video.
