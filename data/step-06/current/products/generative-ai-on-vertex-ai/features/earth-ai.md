...
feature_name: "Earth AI"
feature_slug: "earth-ai"
...
Earth AI is a model available through Model Garden.
...
- Reservations help ensure that capacity is available when your model predictions requests need them.
