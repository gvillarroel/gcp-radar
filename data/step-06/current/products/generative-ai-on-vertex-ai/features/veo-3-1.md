...
feature_name: "Veo 3.1"
feature_slug: "veo-3-1"
...
Veo 3.1 is generally available for video generation; Veo 3.1 is a preview model for Veo video generation.
...
- Note: this option is not yet available in the Vertex AI SDK. audio track extraction - bool Extract the audio track from video input and interleave it with video frames for embeddings.
