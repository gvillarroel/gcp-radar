...
feature_name: "Vertex AI Agent Engine playground"
feature_slug: "vertex-ai-agent-engine-playground"
...
You can use the playground to test and interact with your agent in the Google Cloud console.
...
- Delete model resources From within the Gradio app, you can delete model endpoints to clean up Vertex AI resources.
- To ensure that the Compute Engine default service account has the necessary permissions to launch Spaces, ask your administrator to grant the following IAM roles to the Compute Engine default service account on your Google Cloud project: Important: You must grant these roles to the Compute Engine default service account, not to your user account.
...
- An example of a Context would be a run of a machine learning pipeline. context cache A context cache in Vertex AI is a large amount of data that can be used in multiple requests to a Gemini model.
