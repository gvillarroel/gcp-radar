...
feature_name: "Vector embedding ETL pipeline with Dataflow"
feature_slug: "vector-embedding-etl-pipeline-with-dataflow"
...
# Vector embedding ETL pipeline with Dataflow
...
AlloyDB supports building vector embedding ETL pipelines with Dataflow to generate and ingest embeddings from files or real-time sources.
