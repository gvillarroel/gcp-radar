...
Enhanced Query Insights provides assistive diagnostics to detect and troubleshoot database and query performance problems.
...
Evidence snippets:
- Benefits of using query insights Query insights provide monitoring and diagnostics that let you detect and fix query performance problems.
...
- Query insights can integrate with your existing APM tools, letting you monitor and troubleshoot query problems using your favorite tool.
