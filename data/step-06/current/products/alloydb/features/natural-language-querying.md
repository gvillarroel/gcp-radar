...
- This field changes based on the database you are querying. database reference : Specifies information related to your database instance. cluster id : The cluster ID of the database instance. project id : The project ID of the database instance. region : The region of the AlloyDB instance. instance id : The instance ID of the AlloyDB instance. database id : The ID of the database. agent context reference : Links to authored context in the database. context set id : The complete context set ID of the context stored in the database.
