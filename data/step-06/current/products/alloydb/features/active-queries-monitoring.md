...
feature_name: "Active queries monitoring"
feature_slug: "active-queries-monitoring"
...
Active queries monitoring helps monitor and troubleshoot queries currently running in a database.
...
- Don't include sensitive or personally identifiable information in your cluster ID because the cluster ID might be visible in various operational contexts, such as system logs, monitoring dashboards, and support communications.
- Check the active account by running gcloud auth list .
- Check the active account by running gcloud auth list .
...
- Wait event metrics, enabled by default, help you diagnose and debug performance issues for long-running queries and their associated wait times.
