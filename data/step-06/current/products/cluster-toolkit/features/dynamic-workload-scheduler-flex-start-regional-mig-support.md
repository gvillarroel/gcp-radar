...
generated_at: "2026-04-12T12:12:52.447Z"
product_name: "Cluster Toolkit"
product_slug: "cluster-toolkit"
feature_name: "Dynamic Workload Scheduler Flex-start regional MIG support"
feature_slug: "dynamic-workload-scheduler-flex-start-regional-mig-support"
...
- To configure your cluster, you can either start with one of the cluster blueprint examples which you can modify, or create your own blueprint.
...
- You can use Rapid Cache to colocate storage in the same zone as your HPC workloads, providing higher throughput (up to 2.5 TB/s), lower latency, and location flexibility when used with a multi-region bucket.
...
Evidence snippets:
- Architecture diagram for an HPC cluster that uses Slurm community/examples/tutorial-starccm.yaml : this blueprint sets up an environment with four virtual machine (VM) instances, but it doesn't include a scheduler.
- This tutorial shows you how to deploy an HPC cluster and run a Simcenter STAR CCM+ workload.
...
- In Cloud Shell, start the cluster creation. ./gcluster deploy -d ${H4D DEPLOYMENT FILE NAME}.yaml examples/hpc-slurm-h4d/hpc-slurm-h4d.yaml --auto-approve Connect to the cluster After deploying, connect to the Google Cloud console to view your cluster.
