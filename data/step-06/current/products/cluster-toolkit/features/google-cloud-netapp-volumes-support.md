...
feature_name: "Google Cloud NetApp Volumes support"
feature_slug: "google-cloud-netapp-volumes-support"
...
Cluster Toolkit adds support for Google Cloud NetApp Volumes.
...
- For performance limits, see the Filestore documentation and the NetApp Volumes documentation .
- Resource Recommendation Machine family Use a machine type from one of the following machine series: H4D H3 C2 C2D OS image Use the HPC VM image Apply the HPC VM image best practices File system Use one of the following: A Google Cloud managed NFS service such as Filestore or NetApp Volumes A Google Cloud managed posix-based parallel file system, such as Managed Lustre MPI Use Intel MPI Review Set up and scale MPI applications on H4D VMs with Cloud RDMA What's next Run Ansys Fluent on Google Cloud .
