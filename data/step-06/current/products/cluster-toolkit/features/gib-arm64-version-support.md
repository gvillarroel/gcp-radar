...
generated_at: "2026-04-12T12:12:52.433Z"
product_name: "Cluster Toolkit"
product_slug: "cluster-toolkit"
feature_name: "gIB Arm64 version support"
feature_slug: "gib-arm64-version-support"
...
Cluster Toolkit supports gIB versions 1.1.1 and 1.1.0 on Arm64-based architecture.
...
- Home Documentation Compute Cluster Toolkit Guides Send feedback Update Cluster Toolkit version Stay organized with collections Save and categorize content based on your preferences.
- Update the gcluster command-line tool To update Cluster Toolkit, install the latest version of the command-line tool.
...
- Example 1: Deploys a basic HPC cluster with Slurm Example 2: Deploys an HPC cluster with Slurm and a tiered file system For a full list of example cluster blueprints, see the Cluster Toolkit GitHub repository .
...
- Home Documentation Compute Cluster Toolkit Guides Send feedback Set up and scale MPI applications on H4D VMs with Cloud RDMA Stay organized with collections Save and categorize content based on your preferences.
- If you use Cluster Toolkit, then it runs scripts that typically handle the installation.
...
- Install Cluster Toolkit To install Cluster Toolkit, download the prebuilt binary bundle by completing the following steps: In Cloud Shell, set the Cluster Toolkit version tag: export TAG= LATEST VERSION TAG Replace LATEST VERSION TAG with the tag for the latest Cluster Toolkit release , such as v1.82.0 .
