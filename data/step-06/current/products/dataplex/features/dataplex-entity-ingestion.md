...
- Builder Builder for projects/{project}/locations/{location}/lakes/{lake}/zones/{zone}/entities/{entity}/partitions/{partition}. com. google. cloud. dataplex. v1.
- Builder Builder for projects/{project}/locations/{location}/lakes/{lake}/zones/{zone}/entities/{entity}. com. google. cloud. dataplex. v1.
...
- Knowledge Catalog service account roles and permissions If you haven't created any data quality or data profile scans or you don't have a Knowledge Catalog lake in this project, create a service identifier by running: gcloud beta services identity create --service=dataplex.googleapis.com .
