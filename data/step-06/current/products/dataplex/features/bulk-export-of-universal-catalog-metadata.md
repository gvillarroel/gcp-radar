...
feature_name: "Bulk export of Universal Catalog metadata"
feature_slug: "bulk-export-of-universal-catalog-metadata"
...
Evidence snippets:
- This document explains how to export metadata from Knowledge Catalog (formerly Dataplex Universal Catalog) using a metadata export job for use in external systems.
