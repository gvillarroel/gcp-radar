...
- Managed Service for Apache Spark advises that, when possible, you create Managed Service for Apache Spark clusters with the latest sub-minor image versions.
