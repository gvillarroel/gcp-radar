...
- December 08, 2020 Feature Restartable jobs : Added the ability for users to specify the maximum number of total failures when a job is submitted.
...
- Failure Action Actions in response to failure of a resource associated with a cluster. com. google. cloud. dataproc. v1.
- Cluster Selector A selector that chooses target cluster for jobs based on metadata. com. google. cloud. dataproc. v1.
