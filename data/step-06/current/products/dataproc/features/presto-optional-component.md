...
- Presto client tags to attach to this query properties map (key: string, value: string) Optional.
- See the Presto documentation for supported output formats clientTags[] string Optional.
