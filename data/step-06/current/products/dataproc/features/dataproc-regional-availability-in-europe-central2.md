...
feature_name: "Dataproc regional availability in europe-central2"
feature_slug: "dataproc-regional-availability-in-europe-central2"
...
# Dataproc regional availability in europe-central2
...
Dataproc is available in the europe-central2 (Warsaw) region.
...
Evidence snippets:
- March 24, 2021 Feature Dataproc is now available in the europe-central2 region (Warsaw).
...
- Announcement New Dataproc Serverless for Spark runtime versions : 1.1.32 2.0.40 2.1.19 September 19, 2023 Feature Dataproc is now available in the me-central2 region (Dammam, Saudi Arabia).
