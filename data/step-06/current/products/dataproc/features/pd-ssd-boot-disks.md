...
- If a user has dataproc.clusters.create in the project, this permission is granted. dataproc.nodeGroups.get Get the details of a Managed Service for Apache Spark node group. dataproc.nodeGroups.update Resize a Managed Service for Apache Spark node group.
