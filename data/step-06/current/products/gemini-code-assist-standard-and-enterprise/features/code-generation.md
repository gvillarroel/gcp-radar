...
- Generate and modify code @REPOSITORY NAME Implement an authentication function similar to the one in this repository. @REPOSITORY NAME Refactor the following code to follow the conventions in the selected repository.
...
Evidence snippets:
- After code customization is set up, it works as part of the code completion and code generation features.
