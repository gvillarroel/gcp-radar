...
feature_name: "Custom commands"
feature_slug: "custom-commands"
...
Lets you create, save, and run preconfigured prompts for repetitive tasks in IntelliJ Gemini Code Assist; VS Code Gemini Code Assist supports custom commands in the inline chat menu and lightbulb menu.
...
Evidence snippets:
- For IntelliJ and other supported JetBrains IDEs, you'll create, save, and execute the custom command from the Prompt Library, and from the in-editor prompt.
- You can also create your own custom commands to help you accomplish repetitive tasks faster in your IDE.
...
- Use commands Slash / commands let you quickly run commands similar to commands in a terminal window.
