...
generated_at: "2026-04-10T19:04:48.318Z"
product_name: "Buildpacks"
product_slug: "buildpacks"
feature_name: "OS-only runtime (osonly24) preview availability"
feature_slug: "os-only-runtime-osonly24-preview-availability"
...
# OS-only runtime (osonly24) preview availability
...
The osonly24 OS-only runtime is available in preview to deploy Go applications and binaries such as Dart and Go.
...
- If the API key is bound to a service account, the API key also provides the identity and authorization of the service account ( Preview ).
