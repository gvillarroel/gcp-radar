...
feature_name: "Security Command Center Management API"
feature_slug: "security-command-center-management-api"
...
The Security Command Center Management API provides API support for managing settings and custom modules.
