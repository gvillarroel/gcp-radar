...
feature_slug: "security-command-center-premium-tier"
...
The Security Command Center Premium tier is now available; The Security Command Center Premium tier includes Security Health Analytics, Web Security Scanner managed scans, Event Threat Detection, and Container Threat Detection.
