...
feature_name: "GVM real-time label patching"
feature_slug: "gvm-real-time-label-patching"
...
- To reduce the time it takes to create each VM, convert the virtual disk image to the qcow2 format first, as shown in this document.
