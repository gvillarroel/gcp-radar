...
feature_slug: "local-codebase-awareness-configuration"
...
# Local codebase awareness configuration
...
You can configure how Gemini Code Assist uses local codebase awareness in VS Code.
