...
feature_slug: "cloud-console-links-in-gemini-responses"
...
# Cloud console links in Gemini responses
...
Gemini can include direct links to relevant Cloud console pages in response output.
