...
feature_slug: "gemini-code-assist-usage-dashboard"
...
# Gemini Code Assist usage dashboard
...
Organizations can view aggregated Gemini Code Assist usage metrics in an automatically available dashboard; Organizations can view aggregated Gemini Code Assist usage metrics in an automatically available dashboard.
