...
feature_name: "Candlestick chart"
feature_slug: "candlestick-chart"
...
A chart type that visualizes ranges in data, including opening and closing values and the highs and lows of each range.
