...
feature_name: "Voice Virtual Agents call transfer to phone number or SIP endpoint"
feature_slug: "voice-virtual-agents-call-transfer-to-phone-number-or-sip-endpoint"
...
# Voice Virtual Agents call transfer to phone number or SIP endpoint
...
Voice Virtual Agents can transfer a call to a specific phone number or SIP endpoint.
...
- Voicemail - Phone Number Blocked Voicemail - Request Phone Number Voicemail - Phone Number Input Success Message Only: "After Hour Deflection" message plays and the call ends.
...
- Activate the Enable SMS Notification slider to allow SMS notifications to the agent for any incoming calls to the phone number specified in the agent's CCAI Platform user profile.
