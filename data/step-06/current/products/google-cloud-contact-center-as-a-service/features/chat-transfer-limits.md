...
feature_name: "Chat transfer limits"
feature_slug: "chat-transfer-limits"
...
- To configure transfer limits for chats, follow these steps: In the CCAI Platform portal, click Settings > Chat .
- Configure transfer limits for chats You can configure the maximum number times that a chat can be transferred.
