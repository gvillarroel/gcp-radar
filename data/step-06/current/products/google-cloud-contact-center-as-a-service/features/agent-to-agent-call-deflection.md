...
feature_name: "Agent-to-agent call deflection"
feature_slug: "agent-to-agent-call-deflection"
...
# Agent-to-agent call deflection
...
Agent-to-agent calls can be configured to deflect to voicemail after a set timeout.
