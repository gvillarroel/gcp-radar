...
feature_name: "Virtual agent ticket creation and assignment for custom CRM apps"
feature_slug: "virtual-agent-ticket-creation-and-assignment-for-custom-crm-apps"
...
# Virtual agent ticket creation and assignment for custom CRM apps
...
Virtual agents can create and assign incoming tickets for custom CRM apps before a human agent takes ownership.
