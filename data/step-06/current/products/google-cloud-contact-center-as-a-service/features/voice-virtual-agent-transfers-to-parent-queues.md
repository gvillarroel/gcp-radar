...
- To set up call forwarding for escalation to a human agent, follow these steps: Create your queue menu and nodes where the transfers will be organized in the IVR Voice channel.
