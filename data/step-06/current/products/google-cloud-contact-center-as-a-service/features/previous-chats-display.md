...
generated_at: "2026-04-10T05:27:29.750Z"
product_name: "Google Cloud Contact Center as a Service"
product_slug: "google-cloud-contact-center-as-a-service"
feature_name: "Previous chats display"
feature_slug: "previous-chats-display"
...
Agents and end users can view prior support chat interactions above the current chat.
...
Evidence snippets:
- Previous chats are displayed above the new incoming chat, so agents and end-users can scroll up in the chat view to read through previous interactions.
- December 06, 2023 Feature Mobile Release 2.4, iOS and Android SDK : New functionality Display Previous Chats allows end-users and agents to see any prior support chat interactions.
- Feature Display previous chats : Display previous chats allows end-users and agents to see any prior support chat interactions.
