...
feature_name: "Destination queue display in the agent adapter"
feature_slug: "destination-queue-display-in-the-agent-adapter"
...
# Destination queue display in the agent adapter
...
The agent adapter shows the destination queue during IVR call transfers and deflections.
