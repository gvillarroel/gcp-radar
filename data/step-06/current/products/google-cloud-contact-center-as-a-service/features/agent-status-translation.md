...
feature_name: "Agent status translation"
feature_slug: "agent-status-translation"
...
- Columns can be customized to show various details such as the number of Agents and those agents' statuses, queue priority, number of calls, and more.
