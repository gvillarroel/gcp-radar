...
feature_name: "Self-service ordering after one-time order form in Bare Metal Solution"
feature_slug: "self-service-ordering-after-one-time-order-form-in-bare-metal-solution"
...
# Self-service ordering after one-time order form in Bare Metal Solution
...
You can now use Bare Metal Solution self-service to order resources after submitting a one-time order form.
