...
deprecation_date: "September 30th, 2018"
...
App Engine flexible environment supported legacy health checks for instance monitoring; deprecated on September 30th, 2018.
...
- By default, if no target tags are provided, the App Engine flexible environment generates a unique tag that follows the format of aef- INSTANCE ID .
