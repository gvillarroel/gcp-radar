...
generated_at: "2026-04-10T05:28:03.080Z"
product_name: "Text-to-Speech"
product_slug: "text-to-speech"
feature_name: "Text-to-Speech voice support for nl-BE (Dutch"
feature_slug: "text-to-speech-voice-support-for-nl-be-dutch"
...
# Text-to-Speech voice support for nl-BE (Dutch
...
Text-to-Speech added a supported voice for the nl-BE locale (Dutch, Belgium).
...
Evidence snippets:
- Cloud Text-to-Speech API Google Cloud Documentation Source URL: https://docs.cloud.google.com/text-to-speech/docs/reference/rest Documentation · AI and ML · Cloud Text-to-Speech · Reference · Send feedback · Synthesizes natural-sounding speech by applying powerful neural network models.
