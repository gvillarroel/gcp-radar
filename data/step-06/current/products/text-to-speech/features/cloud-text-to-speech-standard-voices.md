...
feature_name: "Cloud Text-to-Speech Standard voices"
feature_slug: "cloud-text-to-speech-standard-voices"
...
# Cloud Text-to-Speech Standard voices
...
Standard voices were added for Danish (Denmark), Polish (Poland), Portuguese (Brazil), Russian (Russia), Slovak (Slovakia), and Turkish (Turkey).
