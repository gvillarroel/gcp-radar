...
generated_at: "2026-04-12T12:19:11.985Z"
product_name: "Speech-to-Text"
product_slug: "speech-to-text"
feature_name: "Speech-to-Text Chirp 2 model ASR accuracy and speed improvements"
feature_slug: "speech-to-text-chirp-2-model-asr-accuracy-and-speed-improvements"
...
# Speech-to-Text Chirp 2 model ASR accuracy and speed improvements
...
The Chirp 2 model was updated to improve ASR accuracy and recognition speed.
...
- Home Documentation AI and ML Cloud Speech-to-Text Send feedback Chirp 2: Enhanced multilingual accuracy Stay organized with collections Save and categorize content based on your preferences.
- It improves on the original Chirp model in accuracy and speed, as well as expanding into key new features like word-level timestamps, model adaptation, and speech translation.
...
- Pricing Creating and using a Custom Speech-to-Text model involves certain costs which are primarily based on the resources used during the training and subsequent deployment of the model.
