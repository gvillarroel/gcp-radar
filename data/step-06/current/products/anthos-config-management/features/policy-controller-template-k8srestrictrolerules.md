...
feature_name: "Policy Controller template K8sRestrictRoleRules"
feature_slug: "policy-controller-template-k8srestrictrolerules"
...
keywords:
  - "restrict role rules"
  - "Kubernetes Role rules"
  - "role rules policy"
  - "RestrictRoleRules template"
  - "K8sRestrictRoleRules"
  - "Policy Controller template library"
  - "constraint template library"
---

# Policy Controller template K8sRestrictRoleRules
...
The Policy Controller constraint template library includes a new K8sRestrictRoleRules template.
...
Evidence snippets:
- June 28, 2023 1.15.2 Feature The constraint template library includes a new template: K8sRestrictRoleRules .
