...
feature_name: "K8sBlockAllIngress constraint template"
feature_slug: "k8sblockallingress-constraint-template"
...
keywords:
  - "all ingress blocking"
  - "block all ingress"
  - "ingress deny template"
  - "K8sBlockAllIngress constraint"
  - "K8sBlockAllIngress template"
  - "K8sBlockAllIngress"
  - "Constraint Template Library"
---

# K8sBlockAllIngress constraint template
...
The Constraint Template Library added the K8sBlockAllIngress template.
...
Evidence snippets:
- 1.14.0 Feature The constraint template library includes a new template: K8sBlockAllIngress .
