...
feature_name: "K8sRestrictAdmissionController constraint template"
feature_slug: "k8srestrictadmissioncontroller-constraint-template"
...
keywords:
  - "k8s-restrict-admission-controller"
  - "RestrictAdmissionController ConstraintTemplate"
  - "admission controller restriction constraint"
  - "K8sRestrictAdmissionController"
  - "RestrictAdmissionController"
  - "policy constraint template"
  - "Constraint Template Library"
---

# K8sRestrictAdmissionController constraint template
...
Added the K8sRestrictAdmissionController constraint template to the Constraint Template Library.
...
Evidence snippets:
- 1.17.2 Feature The constraint template library includes a new template: K8sRestrictAdmissionController .
