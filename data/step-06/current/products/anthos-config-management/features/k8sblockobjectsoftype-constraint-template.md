...
keywords:
  - "block object types"
  - "block objects of type"
  - "object type restriction"
  - "K8sBlockObjectsOfType constraint"
  - "K8sBlockObjectsOfType"
  - "resource type constraint template"
...
The Constraint Template Library added the K8sBlockObjectsOfType template.
...
Evidence snippets:
- 1.14.0 Feature The constraint template library includes a new template: K8sBlockObjectsOfType .
