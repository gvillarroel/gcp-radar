...
generated_at: "2026-04-11T20:06:37.222Z"
product_name: "Anthos Config Management"
product_slug: "anthos-config-management"
feature_name: "Policy Controller template K8sRestrictAutomountServiceAccountTokens"
feature_slug: "policy-controller-template-k8srestrictautomountserviceaccounttokens"
...
keywords:
  - "restrict automount service account tokens"
  - "service account token automount"
  - "automount token restriction"
  - "K8sRestrictAutomountServiceAccountTokens"
  - "RestrictAutomountServiceAccountTokens"
  - "Policy Controller template library"
  - "constraint template library"
---

# Policy Controller template K8sRestrictAutomountServiceAccountTokens
...
The Policy Controller constraint template library includes a new K8sRestrictAutomountServiceAccountTokens template.
...
Evidence snippets:
- 1.15.2 Feature The constraint template library includes a new template: K8sRestrictAutomountServiceAccountTokens .
