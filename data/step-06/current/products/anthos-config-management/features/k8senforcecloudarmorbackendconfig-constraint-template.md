...
generated_at: "2026-04-11T20:06:37.231Z"
product_name: "Anthos Config Management"
product_slug: "anthos-config-management"
feature_name: "K8sEnforceCloudArmorBackendConfig constraint template"
feature_slug: "k8senforcecloudarmorbackendconfig-constraint-template"
...
keywords:
  - "enforce Cloud Armor backend config"
  - "enforce Cloud Armor backend"
  - "Cloud Armor BackendConfig template"
  - "Cloud Armor BackendConfig"
  - "K8sEnforceCloudArmorBackendConfig template"
  - "K8sEnforceCloudArmorBackendConfig"
  - "BackendConfig constraint"
  - "Constraint Template Library"
---

# K8sEnforceCloudArmorBackendConfig constraint template
...
The Constraint Template Library added a new template named `K8sEnforceCloudArmorBackendConfig`.
...
Evidence snippets:
- 1.14.0 Feature The constraint template library includes a new template: K8sEnforceCloudArmorBackendConfig .
