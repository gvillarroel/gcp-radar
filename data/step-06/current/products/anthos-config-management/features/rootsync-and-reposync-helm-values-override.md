...
RootSync and RepoSync support overriding default Helm chart values through the spec.helm.values field.
...
- Pour modifier le fichier valuesFile après la synchronisation, vous devez créer un ConfigMap avec un autre nom et mettre à jour RootSync ou RepoSync spec.valuesFileRefs.name .
