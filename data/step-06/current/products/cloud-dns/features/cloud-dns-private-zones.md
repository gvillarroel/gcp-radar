...
feature_name: "Cloud DNS private zones"
feature_slug: "cloud-dns-private-zones"
...
Cloud DNS private zones enable creating DNS zones that are resolvable only within private Google Cloud environments; Cloud DNS private zones enable creating DNS zones that are resolvable only within private Google Cloud environments.
...
- Ensure inbound forwarding is enabled for the authorized VPC network Inbound forwarding must be enabled for each VPC network that is authorized to query your Cloud DNS private zone.
...
Evidence snippets:
- Cloud DNS enables you to create Service Directory-backed zones, which are a type of private zone containing information about your services and endpoints.
