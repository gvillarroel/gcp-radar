...
feature_name: "Custom splitter model"
feature_slug: "custom-splitter-model"
...
Evidence snippets:
- Custom splitter model versions The following models are available for custom splitter.
- It supports zero-shot splitting and classification.
