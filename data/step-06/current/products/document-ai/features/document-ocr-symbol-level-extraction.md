...
feature_name: "Document OCR symbol-level extraction"
feature_slug: "document-ocr-symbol-level-extraction"
...
# Document OCR symbol-level extraction
...
Document OCR now supports symbol-level extraction.
...
Evidence snippets:
- Custom Document Extraction Options Options to control the training of the Custom Document Extraction (CDE) Processor. com. google. cloud. documentai. v1.
- Builder Options to control the training of the Custom Document Extraction (CDE) Processor. com. google. cloud. documentai. v1.
- Confidence Level Metrics Evaluations metrics, at a specific confidence level. com. google. cloud. documentai. v1.
- It is a known entity type, such as a person, an organization, or location. com. google. cloud. documentai. v1.
