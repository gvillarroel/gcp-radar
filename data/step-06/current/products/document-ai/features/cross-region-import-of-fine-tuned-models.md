...
feature_name: "Cross-region import of fine-tuned models"
feature_slug: "cross-region-import-of-fine-tuned-models"
...
# Cross-region import of fine-tuned models
...
Document AI supports cross-region import of fine-tuned models for processor versions based on Gemini 1.5 and later; Document AI supports cross-region import of fine-tuned models for processor versions based on Gemini 1.5 and later.
...
Evidence snippets:
- Define processor schema You can create the processor schema either before or after you import documents into your dataset.
- This processor identifies classes of documents from a user-defined set of classes.
- You can train fine-tuned and custom models with your labeled data.
...
- Custom Extractor Description Extract fields from documents using generative AI or custom models; fine-tune models to accurately extract data from your documents.
