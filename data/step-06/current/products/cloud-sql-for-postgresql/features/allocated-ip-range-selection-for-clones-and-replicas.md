...
- In 'CIDR' notation, also known as 'slash' notation (for example: 157.197.200.0/24 ). allocatedIpRange string The name of the allocated ip range for the private ip Cloud SQL instance.
