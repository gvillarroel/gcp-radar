...
feature_name: "tcp_keepalives_idle flag"
feature_slug: "tcp-keepalives-idle-flag"
...
- Sprintf ( "%s:%s@tcp(%s:%s)/%s?parseTime=true" , dbUser , dbPwd , dbTCPHost , dbPort , dbName ) // dbPool is the pool of database connections. dbPool , err := sql .
