...
feature_name: "insert_username extension"
feature_slug: "insert-username-extension"
...
The insert_username extension stores the current user name into a text field for change tracking.
...
- October 19, 2022 Feature The rollout of the following PostgreSQL minor versions, extension versions, and plugin versions is currently underway: Minor versions 10.21 is upgraded to 10.22.
- March 29, 2023 Feature The rollout of the following PostgreSQL minor versions, extension versions, and plugin versions is currently underway: Minor versions 10.21 is upgraded to 10.22.
