...
feature_name: "Region: europe-central2 (Warsaw)"
feature_slug: "region-europe-central2-warsaw"
...
Cloud SQL for PostgreSQL instances can be deployed in the europe-central2 (Warsaw) region.
