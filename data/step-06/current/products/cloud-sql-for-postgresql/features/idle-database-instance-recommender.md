...
The idle database instance recommender identifies idle instances and estimates savings from shutting them down; The idle database instance recommender identifies idle instances and estimates savings from shutting them down.
