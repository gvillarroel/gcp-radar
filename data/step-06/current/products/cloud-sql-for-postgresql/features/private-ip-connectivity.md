...
- If the outbound connectivity IP address conflicts with the eth0 IP or the Private Service Connect forwarding rule, then the IP address might not connect correctly.
