...
generated_at: "2026-04-11T00:45:01.416Z"
product_name: "Cloud SQL for PostgreSQL"
product_slug: "cloud-sql-for-postgresql"
feature_name: "tcp_keepalives_interval flag"
feature_slug: "tcp-keepalives-interval-flag"
...
The tcp_keepalives_interval flag sets the interval between TCP keepalive probes.
...
Evidence snippets:
- July 29, 2021 Cloud SQL for PostgreSQL Feature Cloud SQL for PostgreSQL now supports the following flags: tcp keepalives count tcp keepalives idle tcp keepalives interval For more information about these flags, see the Cloud SQL for PostgreSQL flags documentation.
...
Evidence snippets:
- To connect using the Cloud SQL Auth Proxy and the caching sha2 password plugin over a TCP socket connection, add the --get-server-public-key flag.
