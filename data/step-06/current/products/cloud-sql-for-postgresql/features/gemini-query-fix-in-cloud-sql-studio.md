...
feature_name: "Gemini query fix in Cloud SQL Studio"
feature_slug: "gemini-query-fix-in-cloud-sql-studio"
...
# Gemini query fix in Cloud SQL Studio
...
Gemini query fix in Cloud SQL Studio helps users fix SQL query errors with Gemini assistance.
...
Evidence snippets:
- Grant the cloudsql.studioUser , cloudsql.instanceUser , and geminidataanalytics.queryDataUser roles to the IAM user at the project level.
