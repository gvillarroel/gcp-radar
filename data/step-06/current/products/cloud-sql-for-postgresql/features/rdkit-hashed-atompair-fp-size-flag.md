...
feature_name: "rdkit.hashed_atompair_fp_size flag"
feature_slug: "rdkit-hashed-atompair-fp-size-flag"
...
# rdkit.hashed_atompair_fp_size flag
...
The rdkit.hashed_atompair_fp_size flag sets the size of atom-pair bit-vector fingerprints.
...
Evidence snippets:
- 9192 No rdkit.hashed_atompair_fp_size integer 64 ...
- 9192 No rdkit.hashed_torsion_fp_size integer 64 ...
...
- Cloud SQL also sets the value of the expire logs days and binlog expire logs seconds flags to the equivalent of one day automatically.
