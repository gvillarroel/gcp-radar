...
feature_name: "rdkit.sss_fp_size flag"
feature_slug: "rdkit-sss-fp-size-flag"
...
The rdkit.sss_fp_size flag sets the fingerprint size used for substructure screening.
...
Evidence snippets:
- 5 No rdkit.sss_fp_size integer 64 ...
...
Evidence snippets:
- NONE is used for flags that do not take a value, such as skip grant tables . appliesTo[] enum ( SqlDatabaseVersion ) The database version this flag applies to.
- SqlFlagScope Scopes of a flag describe where the flag is used.
