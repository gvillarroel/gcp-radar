...
feature_name: "Region: us-west4 (Las Vegas)"
feature_slug: "region-us-west4-las-vegas"
...
Cloud SQL for PostgreSQL instances can be deployed in the us-west4 (Las Vegas) region.
...
- April 20, 2020 Feature Support for us-west4 region (Las Vegas).
