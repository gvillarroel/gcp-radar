...
generated_at: "2026-04-11T00:45:01.409Z"
...
- Connect with the psql client Debian/Ubuntu Install the psql client from the package manager: sudo apt-get update sudo apt-get install postgresql-client CentOS/RHEL Install the psql client from the package manager: sudo yum install postgresql openSUSE Install the psql client from the package manager: sudo zypper install postgresql Other platforms Download the PostgreSQL Core Distribution for your platform from the PostgreSQL Downloads page .
