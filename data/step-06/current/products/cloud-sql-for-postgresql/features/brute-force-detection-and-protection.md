...
Brute-force detection and protection identifies brute-force access attempts against Cloud SQL instances and helps mitigate their risk.
...
Evidence snippets:
- This helps protect your instances from brute-force access attempts by identifying the source and mitigating the risk caused by these attempts.
- February 19, 2026 Feature Cloud SQL now provides brute-force detection and protection for your Cloud SQL instances.
