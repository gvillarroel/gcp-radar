...
generated_at: "2026-04-11T00:45:01.430Z"
...
- With committed use discounts for Cloud SQL, you can earn a deep discount off your cost of use in exchange for committing to continuously use database instances in a particular region for a 1- or 3-year term.
- With committed use discounts for Cloud SQL, you can earn a deep discount off your cost of use in exchange for committing to continuously use database instances in a particular region for a 1- or 3-year term.
- June 23, 2020 Cloud SQL for MySQL Feature Committed use discounts (CUDs) are now available to purchase for Cloud SQL.
...
Evidence snippets:
- With committed use discounts for Cloud SQL, you can earn a deep discount off your cost of use in exchange for committing to continuously use database instances in a particular region for a 1- or 3-year term.
- June 23, 2020 Feature Committed use discounts (CUDs) are now available to purchase for Cloud SQL.
