...
feature_name: "max_parallel_workers flag"
feature_slug: "max-parallel-workers-flag"
...
The max_parallel_workers flag sets the maximum number of workers the system can use for parallel operations.
