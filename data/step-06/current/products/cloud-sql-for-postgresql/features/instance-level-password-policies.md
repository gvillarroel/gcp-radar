...
feature_name: "Instance-level password policies"
feature_slug: "instance-level-password-policies"
...
- By default, IAM policy bindings are applied at the project-level, such that principals receive role permissions for all Cloud SQL instances in the project.
...
- Optional: Configure a password policy for the instance as follows: Select the Enable password policies checkbox.
