...
generated_at: "2026-04-12T12:16:03.685Z"
product_name: "Firestore with MongoDB compatibility"
product_slug: "firestore-with-mongodb-compatibility"
feature_name: "$range aggregation operator"
feature_slug: "range-aggregation-operator"
...
Supports the $range aggregation operator.
...
- For example, the first range which appears in the tree, here (1..5] , corresponds to the constraints on the first key, here a , in the ordered list of keys: index: type=CollectionGroupIndex, id=CICAgOjXh#EK, keys=[a ASC, b ASC, key ASC] constraints: / ----(1..5] ----[1L] Each level of indentation indicates the constraint applying to the next key in the list.
