...
feature_slug: "dedicated-api-only-service-accounts"
...
Lets admins create dedicated service accounts for API-only access and migrate eligible user accounts to them.
