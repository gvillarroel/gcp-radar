...
feature_slug: "self-service-explores-connection-test"
...
The Self-service Explores admin page includes a connection test button for verifying BigQuery support.
