...
generated_at: "2026-04-15T12:48:36.731Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "UNPIVOT operator"
feature_slug: "unpivot-operator"
...
The UNPIVOT operator transforms columns into rows in BigQuery SQL queries; The UNPIVOT operator transforms columns into rows in BigQuery SQL queries.
...
- By default, UNPIVOT excludes rows with NULL values. single column unpivot : Rotates columns into one values column and one name column . multi column unpivot : Rotates columns into multiple values column s and one name column . unpivot alias : An alias for the results of the UNPIVOT operation.
- PIVOT operator FROM from item [, ...] pivot operator pivot operator : PIVOT( aggregate function call [ as alias ][, ...] FOR input column IN ( pivot column [ as alias ][, ...] ) ) [AS alias ] as alias : [AS] alias The PIVOT operator rotates rows into columns, using aggregation.
