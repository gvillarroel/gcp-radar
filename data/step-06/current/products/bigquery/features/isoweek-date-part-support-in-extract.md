...
feature_name: "ISOWEEK date part support in EXTRACT"
feature_slug: "isoweek-date-part-support-in-extract"
...
# ISOWEEK date part support in EXTRACT
...
BigQuery standard SQL supports ISOWEEK as a date part for the EXTRACT function.
...
- Return Data Type INT64 Examples In the following example, EXTRACT returns a value corresponding to the DAY date part.
