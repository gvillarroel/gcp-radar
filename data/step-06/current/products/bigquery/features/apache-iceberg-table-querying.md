...
feature_name: "Apache Iceberg table querying"
feature_slug: "apache-iceberg-table-querying"
...
BigQuery can query Apache Iceberg tables created by open source engines.
