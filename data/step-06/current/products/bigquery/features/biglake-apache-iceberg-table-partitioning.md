...
feature_name: "BigLake Apache Iceberg table partitioning"
feature_slug: "biglake-apache-iceberg-table-partitioning"
...
# BigLake Apache Iceberg table partitioning
...
BigLake tables for Apache Iceberg in BigQuery now support partitioning.
