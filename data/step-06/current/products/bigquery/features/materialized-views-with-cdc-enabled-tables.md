...
feature_name: "Materialized views with CDC-enabled tables"
feature_slug: "materialized-views-with-cdc-enabled-tables"
...
# Materialized views with CDC-enabled tables
...
BigQuery materialized views can be configured with tables that use CDC streaming update and delete operations.
...
- Required permissions This statement requires the following IAM permissions : Permission Resource bigquery.tables.delete The materialized view to delete. bigquery.tables.get The materialized view to delete.
