...
generated_at: "2026-04-10T13:25:38.597Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "BigQuery cross-cloud joins across Google Cloud and BigQuery Omni regions"
feature_slug: "bigquery-cross-cloud-joins-across-google-cloud-and-bigquery-omni-regions"
...
keywords:
  - "Google Cloud and Omni regions"
  - "cross-region joins"
  - "Omni cross-cloud join"
  - "cross-cloud joins"
  - "multi-cloud joins"
...
# BigQuery cross-cloud joins across Google Cloud and BigQuery Omni regions
...
BigQuery now supports cross-cloud joins so queries can span Google Cloud and BigQuery Omni regions.

## Extended Definition

BigQuery supports cross-cloud queries that join tables stored in BigQuery Omni regions with tables in BigQuery regions, allowing a single query to combine data across these environments. In Google documentation, this is described as running ad hoc queries and cross-cloud queries that can join any tables in the Omni region with tables in BigQuery regions. The access-control documentation also indicates BigQuery Omni has its own IAM service role context, while also stating there are no IAM permissions defined specifically for the Omni service itself.

## Evidence Summary

The quickstart page provides the functional behavior of cross-cloud joins across Omni and BigQuery regions, and the IAM page provides role/context details for BigQuery Omni, including the note that it has no dedicated service permissions.
