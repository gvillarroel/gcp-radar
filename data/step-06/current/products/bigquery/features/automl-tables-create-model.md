...
feature_name: "AutoML Tables CREATE MODEL"
feature_slug: "automl-tables-create-model"
...
The CREATE MODEL statement can train AutoML Tables models on structured data in BigQuery ML.
...
- CREATE MODEL statement for Wide-and-Deep models 'AUTOML CLASSIFIER' Create a classification model using AutoML.
...
- Train the model Train an AutoML classifier model that predicts iris type using the CREATE MODEL statement.
