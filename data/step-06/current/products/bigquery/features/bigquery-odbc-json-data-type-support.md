...
feature_name: "BigQuery ODBC JSON data type support"
feature_slug: "bigquery-odbc-json-data-type-support"
...
# BigQuery ODBC JSON data type support
...
The BigQuery ODBC connector now supports the JSON data type.
...
- JSON TYPE Gets the JSON type of the outermost JSON value and converts the name of this type to a SQL STRING value.
