...
feature_name: "PIVOT operator"
feature_slug: "pivot-operator"
...
The PIVOT operator rotates row values into columns in BigQuery SQL queries; The PIVOT operator rotates row values into columns in BigQuery SQL queries.
