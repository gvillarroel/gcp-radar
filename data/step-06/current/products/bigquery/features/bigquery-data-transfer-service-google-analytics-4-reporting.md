...
generated_at: "2026-04-10T13:25:38.386Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "BigQuery Data Transfer Service Google Analytics 4 reporting"
feature_slug: "bigquery-data-transfer-service-google-analytics-4-reporting"
...
keywords:
  - "GA4 custom report transfer"
  - "GA4 reporting transfer"
  - "GA4 data source"
  - "GA4 transfer"
...
# BigQuery Data Transfer Service Google Analytics 4 reporting
...
Enables BigQuery Data Transfer Service to ingest Google Analytics 4 reporting data and custom reports.

## Extended Definition

BigQuery Data Transfer Service (DTS) provides scheduled data ingestion workflows that can extract and load data from supported sources into BigQuery. Google Analytics 4 is explicitly listed as a supported Google service in DTS’s supported data sources, so GA4 can be used as a transfer source in these recurring BigQuery ETL/ELT workflows. Evidence for transfer-specific IAM support is limited to the presence of a dedicated BigQuery Data Transfer Service service-agent role in IAM docs, but the provided excerpts do not explicitly document GA4 custom-report or reporting-transfer behavior.

## Evidence Summary

The DTS introduction confirms GA4 is a supported source, the ELT tutorial confirms DTS supports recurring scheduled imports from supported sources into BigQuery, and IAM docs identify a predefined BigQuery Data Transfer Service service-agent role.
