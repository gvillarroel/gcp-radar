...
feature_name: "Notebook consolidated action bar"
feature_slug: "notebook-consolidated-action-bar"
...
# Notebook consolidated action bar
...
The notebook action bar is consolidated by default to provide more space for writing code.
...
- Partner references BigQuery connector in Gretel BigQuery Destination Action Harbr Data Solution Harbr Data Category ETL & Data Integration Description Harbrdata is a company that provides a cloud-based platform for data sharing and collaboration between organizations.
- Plus, it provides a built-in orchestration tool, which lets analysts manage tasks, trigger policies, automate workflows, and more.
