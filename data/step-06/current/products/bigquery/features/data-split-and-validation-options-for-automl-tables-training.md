...
feature_name: "Data split and validation options for AutoML Tables training"
feature_slug: "data-split-and-validation-options-for-automl-tables-training"
...
# Data split and validation options for AutoML Tables training
...
BigQuery ML supports data split and validation options for AutoML Tables model training.
...
- Before you configure your default options, you must first create a .bigqueryrc file.
