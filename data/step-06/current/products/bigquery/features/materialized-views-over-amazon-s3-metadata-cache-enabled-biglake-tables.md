...
feature_name: "Materialized views over Amazon S3 metadata cache-enabled BigLake tables"
feature_slug: "materialized-views-over-amazon-s3-metadata-cache-enabled-biglake-tables"
...
BigQuery cross-cloud supports materialized views over Amazon S3 metadata cache-enabled BigLake tables; BigQuery supports materialized views on Amazon S3 metadata cache-enabled BigLake tables.
...
Evidence snippets:
- To understand the use cases of logical and materialized view, see Overview of logical and materialized views .
