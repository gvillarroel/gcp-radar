...
generated_at: "2026-04-10T13:25:38.459Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "BigQuery Data Transfer Service MySQL source transfer"
feature_slug: "bigquery-data-transfer-service-mysql-source-transfer"
...
keywords:
  - "Create MySQL transfer config"
  - "MySQL DTS source"
  - "MySQL data transfer connection"
  - "MySQL to BigQuery transfer"
...
# BigQuery Data Transfer Service MySQL source transfer
...
BigQuery Data Transfer Service now supports transferring data from MySQL sources.

## Extended Definition

The BigQuery Data Transfer Service supports MySQL as a built-in source type, allowing scheduled data transfers that extract and load data from MySQL into BigQuery. In practice, MySQL data movement is configured like other DTS sources via BigQuery Data Transfer Service workflows (for example, using the Google Cloud console, bq CLI, BigQuery Data Transfer Service API, or the Pipelines & Connections flow), rather than through a custom one-off import process.

## Evidence Summary

The DTS introduction page explicitly lists MySQL among supported sources and the tutorial confirms recurring scheduled DTS workflows for supported sources, while the access-control page identifies DTS-specific role context for service operations.
