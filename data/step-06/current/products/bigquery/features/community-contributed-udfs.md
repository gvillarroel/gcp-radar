...
feature_name: "Community-contributed UDFs"
feature_slug: "community-contributed-udfs"
...
Community-contributed user-defined functions are available through the bigquery-utils repository and the public persistent_udfs dataset.
...
- SELECT FROM ( SELECT product , sales , quarter FROM Produce ) PIVOT ( SUM ( sales ) FOR quarter IN ( 'Q1' , 'Q2' , 'Q3' , 'Q4' )) / ---------+-----+-----+------+------+ product Q1 Q2 Q3 Q4 +---------+-----+-----+------+------+ Apple 78 0 NULL NULL Kale 121 108 45 3 +---------+-----+-----+------+------ / You can select a subset of values in the pivot column : SELECT FROM ( SELECT product , sales , quarter FROM Produce ) PIVOT ( SUM ( sales ) FOR quarter IN ( 'Q1' , 'Q2' , 'Q3' )) / ---------+-----+-----+------+ product Q1 Q2 Q3 +---------+-----+-----+------+ Apple 78 0 NULL Kale 121 108 45 +---------+-----+-----+------ / SELECT FROM ( SELECT sales , quarter FROM Produce ) PIVOT ( SUM ( sales ) FOR quarter IN ( 'Q1' , 'Q2' , 'Q3' )) / -----+-----+----+ Q1 Q2 Q3 +-----+-----+----+ 199 108 45 +-----+-----+---- / You can include multiple aggregation functions in the PIVOT .
