...
feature_name: "DROP EXTERNAL TABLE statement"
feature_slug: "drop-external-table-statement"
...
BigQuery Standard SQL supports the DROP EXTERNAL TABLE statement.
...
Evidence snippets:
- The DROP EXTERNAL statement only removes the external table definition from BigQuery.
