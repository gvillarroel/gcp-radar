...
feature_name: "Custom masking routines"
feature_slug: "custom-masking-routines"
...
- You can use the following data masking rules: Custom masking routine .
...
- For more information about creating UDFs for custom masking routines, see Create custom masking routines .
...
Evidence snippets:
- For BigLake tables based on Cloud Storage, you can also use dynamic data masking .
