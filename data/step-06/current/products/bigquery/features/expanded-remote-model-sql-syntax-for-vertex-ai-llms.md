...
feature_name: "Expanded remote model SQL syntax for Vertex AI LLMs"
feature_slug: "expanded-remote-model-sql-syntax-for-vertex-ai-llms"
...
- When you create the remote model, you need the endpoint ID that was generated when you deployed the model to Vertex AI.
