...
feature_name: "BigQuery Studio geospatial result map visualization"
feature_slug: "bigquery-studio-geospatial-result-map-visualization"
...
# BigQuery Studio geospatial result map visualization
...
BigQuery Studio can visualize geospatial query results on an interactive map.
...
- Home Documentation Data analytics BigQuery Guides Send feedback Visualize geospatial analytics data using a Colab notebook Stay organized with collections Save and categorize content based on your preferences.
...
Evidence snippets:
- Visualize your results in BigQuery Geo Viz , which is a web tool for visualization of geospatial data in BigQuery using Google Maps APIs.
- Visualize the query results in BigQuery To visualize your results in BigQuery, follow these steps: In the Query results pane, click the Visualization tab.
- Visualize the query results in Geo Viz You can also visualize your results using BigQuery Geo Viz.
- What's next To learn more about how to visualize options for geospatial analytics, see Visualizing geospatial data .
