...
feature_name: "View column descriptions"
feature_slug: "view-column-descriptions"
...
BigQuery lets you add descriptions to view columns by using CREATE VIEW or ALTER COLUMN statements; View column descriptions let users add descriptions to view columns with CREATE VIEW or ALTER COLUMN statements.
...
- Schema When you query the INFORMATION SCHEMA.SEARCH INDEX COLUMNS view, the query results contain one row for each indexed column on each table in a dataset.
