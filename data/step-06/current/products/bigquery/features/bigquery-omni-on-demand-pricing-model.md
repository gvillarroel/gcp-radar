...
generated_at: "2026-04-10T13:25:38.712Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "BigQuery Omni on-demand pricing model"
feature_slug: "bigquery-omni-on-demand-pricing-model"
...
# BigQuery Omni on-demand pricing model
...
BigQuery Omni adds support for an on-demand pricing model.

## Extended Definition

The provided excerpts confirm BigQuery Omni is a distinct BigQuery capability with its own IAM service role (`roles/bigqueryomni.serviceAgent`) for service operations. They also describe BigQuery on-demand billing for certain fine-grained DML operations, but they do not explicitly link on-demand pricing to BigQuery Omni itself. As a result, this feature’s Omni-specific pricing mode is only weakly evidenced here and appears only indirectly through general BigQuery on-demand pricing language.

## Evidence Summary

The IAM page lists a dedicated BigQuery Omni service role, the Salesforce quickstart page demonstrates Omni cross-cloud query/data movement patterns, and the DML page documents when on-demand pricing is applied in BigQuery but without explicit Omni attribution.
