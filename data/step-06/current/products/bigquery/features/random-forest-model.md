...
feature_name: "Random Forest model"
feature_slug: "random-forest-model"
...
The Random Forest model lets BigQuery ML train and use random forest models for machine learning workloads.
...
- The FROM clause — causes the query to train the model by using the bigquery-public-data.google analytics sample.ga sessions sample tables.
