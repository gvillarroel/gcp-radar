...
feature_name: "ODBC JSON data type support"
feature_slug: "odbc-json-data-type-support"
...
The BigQuery ODBC driver supports the JSON data type.
...
- You can review the GoogleSQL data types that this function supports and their JSON encodings in the JSON encodings section.
