...
generated_at: "2026-04-15T12:48:36.439Z"
product_name: "BigQuery"
product_slug: "bigquery"
feature_name: "Table explorer"
feature_slug: "table-explorer"
...
- As a publisher, you can create a listing and specify the resource description, sample queries to run or sample message data, links to any relevant documentation, and any additional information that helps subscribers use your shared resource.
...
- It lets users gain insight into datasets through univariate and multivariate statistics, create custom visualizations using a drag-and-drop interface, and share reports with all stakeholders.
