...
generated_at: "2026-04-12T12:16:13.690Z"
product_name: "Gemini Enterprise"
product_slug: "gemini-enterprise"
feature_name: "Source attribution from model"
feature_slug: "source-attribution-from-model"
...
Gemini Enterprise shows other sources used by the Gemini models in the Sources panel of an answer.
...
- This page shows how to get started with the Cloud Client Libraries for the Gemini Enterprise API.
...
- Use an imported list of autocomplete suggestions You can choose to provide your own list of autocomplete suggestions instead of using autocomplete suggestions generated from an autocomplete data model.
- Send feedback Except as otherwise noted, the content of this page is licensed under the Creative Commons Attribution 4.0 License , and code samples are licensed under the Apache 2.0 License .
- Home Documentation AI and ML Gemini Enterprise Send feedback Configure advanced autocomplete Stay organized with collections Save and categorize content based on your preferences.
...
- Gemini Enterprise applies the Sensitive Data Protection inspection service to look for and block common types of PII from appearing as suggestions.
