...
generated_at: "2026-04-11T19:30:14.953Z"
...
Evidence snippets:
- SummarySpec ( summary result count = 5 , include citations = True , ignore adversarial query = True , ignore non summary seeking query = True , model prompt spec = discoveryengine .
- SummarySpec ( summary result count = 5 , include citations = True , ignore adversarial query = True , ignore non summary seeking query = True , model prompt spec = discoveryengine .
