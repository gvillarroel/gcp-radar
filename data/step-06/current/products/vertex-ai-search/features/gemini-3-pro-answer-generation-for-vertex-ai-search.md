...
generated_at: "2026-04-11T19:30:14.829Z"
...
- The base LLM model is available for six months after the release date of the next version of the model, per the Vertex AI model lifecycle policy .
