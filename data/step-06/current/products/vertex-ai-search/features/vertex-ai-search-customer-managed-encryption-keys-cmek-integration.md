...
generated_at: "2026-04-11T19:30:14.954Z"
product_name: "Vertex AI Search"
product_slug: "vertex-ai-search"
feature_name: "Vertex AI Search customer-managed encryption keys (CMEK) integration"
feature_slug: "vertex-ai-search-customer-managed-encryption-keys-cmek-integration"
...
# Vertex AI Search customer-managed encryption keys (CMEK) integration
...
Vertex AI Search Enterprise Search supports a customer-managed encryption key (CMEK) allowlisted preview, allowing customers to use their own key to encrypt US multi-region datastore contents at rest.
