...
feature_name: "GitHub Enterprise Cloud connectivity"
feature_slug: "github-enterprise-cloud-connectivity"
...
source_links:
  ...
  - "https://docs.cloud.google.com/developer-connect/docs/connect-github-enterprise-cloud"
...
# GitHub Enterprise Cloud connectivity
...
Developer Connect supports connectivity with GitHub Enterprise Cloud repositories.
...
- [https://docs.cloud.google.com/developer-connect/docs/connect-github-enterprise-cloud](https://docs.cloud.google.com/developer-connect/docs/connect-github-enterprise-cloud)
...
### "Connect to GitHub Enterprise Cloud \_|\_ Developer Connect \_|\_ Google\

- URL: [https://docs.cloud.google.com/developer-connect/docs/connect-github-enterprise-cloud](https://docs.cloud.google.com/developer-connect/docs/connect-github-enterprise-cloud)
- Source ID: `site-iam-reference`
- Final score: 297
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- Home Documentation Application development Developer Connect Guides Send feedback Connect to GitHub Enterprise Cloud Stay organized with collections Save and categorize content based on your preferences.
- These instructions are for application developers, platform administrators, and security managers who want to use GitHub Enterprise Cloud source code repositories with Google.
- Configure IP allowlists Developer Connect is compatible with GitHub Enterprise Cloud organizations that use IP allowlists to restrict access to their resources.
