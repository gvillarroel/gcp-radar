...
generated_at: "2026-04-15T11:57:14.543Z"
...
Active queries lets you monitor currently running queries in the Query insights dashboard.
...
- After sampling, data is not visible for up to 165 seconds. state : Thread state. database/mysql/threads GA (project) MySQL Thread GAUGE , INT64 , 1 cloudsql database Number of Threads. threads cached indicates threads in the thread cache, threads connected indicates currently open connections, threads running indicates threads that are not sleeping.
