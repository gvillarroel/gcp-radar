...
- Linked servers Issue Troubleshooting Msg 7411, Level 16, State 1, Line 25 Server 'LINKED SERVER NAME' is not configured for DATA ACCESS.
...
- 60 No cloudsql enable linked servers boolean on off No cost threshold for parallelism integer 0 ...
- While this value might be fine for servers routinely running small queries, it might pose a cost issue if you also need to periodically run very large queries.
