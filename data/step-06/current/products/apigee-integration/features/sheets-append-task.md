...
feature_name: "Sheets - Append task"
feature_slug: "sheets-append-task"
...
Adds a Sheets append integration task in preview.
...
- Function Description ADD Adds the specified number to an existing number.
