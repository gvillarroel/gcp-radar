...
feature_name: "Data Mapping JSON subfield support"
feature_slug: "data-mapping-json-subfield-support"
...
- MERGE Merges two JSON variables (objects or arrays).
...
- For example: { "properties" : { "PersonID" : { "type" : [ "integer" , "string" , "number" ], "readOnly" : false } } } In these cases, using the data mapping functions, you must explicitly convert the child variables to the desired type.
