...
feature_name: "App Engine Serverless VPC Access for Shared VPC"
feature_slug: "app-engine-serverless-vpc-access-for-shared-vpc"
...
keywords:
  - "VPC connectivity for App Engine"
  - "SVPC Access for App Engine"
  - "Shared VPC integration"
  - "App Engine standard integration"
  - "Shared VPC support"
  - "Serverless VPC Access"
  - "Shared VPC"
---

# App Engine Serverless VPC Access for Shared VPC
...
Serverless VPC Access integration with Shared VPC is now generally available for App Engine standard environment; Serverless VPC Access support for Shared VPC in App Engine standard entered beta availability.
