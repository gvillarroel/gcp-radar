...
feature_name: "Place Details API (New)"
feature_slug: "place-details-api-new"
...
Provides rich place information such as name, address, location coordinates, and place type.
...
Evidence snippets:
- The Places SDK for iOS (New) provides your app with rich information about places, including the place's name and address, the geographical location specified as latitude/longitude coordinates, the type of place (such as night club, pet store, museum), and more.
...
- Get place details The GMSPlace class contains information about a specific place, including all of the data fields shown in Place Data Fields (New) .
- Home Products Google Maps Platform Documentation iOS Places SDK for iOS Send feedback Place Details (New) Stay organized with collections Save and categorize content based on your preferences.
...
- It includes information such as the name of the place and its address, geographical location, place ID, phone number, place type, website URL, and more.
