...
source_links:
  - "https://developers.google.com/maps/documentation/places/ios-sdk/place-search-ui-kit"
...
- URL: [https://developers.google.com/maps/documentation/places/ios-sdk/place-search-ui-kit](https://developers.google.com/maps/documentation/places/ios-sdk/place-search-ui-kit)
...
- Swift private let configuration = PlaceSearchConfiguration ( content : [. address (), . rating ()] ) You can also optionally customize the following aspects of the content that appears in your Place Search component: content : The content shown in the component. mediaSize : The photo size in the vertical orientation of the fragment.
- Swift // use placeSearchViewRequest = .searchNearby(...) to configure a searchNearby request @ State private var let placeSearchViewRequest = . searchByText ( SearchByTextRequest ( textQuery : "Googleplex" , placeProperties : [. all ], locationBias : CircularCoordinateRegion ( center : CLLocationCoordinate2D ( latitude : 0 , longitude : 0 ), radius : 0 ) ) ) You can also optionally receive callbacks when the component loads, a place is selected, or when there is an error loading the component.
