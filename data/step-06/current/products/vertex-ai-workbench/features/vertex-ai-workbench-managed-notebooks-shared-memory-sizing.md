...
feature_name: "Vertex AI Workbench managed notebooks shared memory sizing"
feature_slug: "vertex-ai-workbench-managed-notebooks-shared-memory-sizing"
...
# Vertex AI Workbench managed notebooks shared memory sizing
...
Vertex AI Workbench managed notebooks now increase shared memory size to match available memory capacity.
