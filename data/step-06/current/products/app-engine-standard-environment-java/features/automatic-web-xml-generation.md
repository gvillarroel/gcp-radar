...
feature_name: "Automatic web.xml generation"
feature_slug: "automatic-web-xml-generation"
...
App Engine can avoid generating a web.xml file when a Java 7 app already includes a servlet 3.1 web.xml.
