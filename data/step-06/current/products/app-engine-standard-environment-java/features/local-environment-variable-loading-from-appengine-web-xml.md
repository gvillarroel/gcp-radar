...
feature_name: "Local environment variable loading from appengine-web.xml"
feature_slug: "local-environment-variable-loading-from-appengine-web-xml"
...
# Local environment variable loading from appengine-web.xml
...
The local development server now reads and includes environment variables defined in appengine-web.xml.
