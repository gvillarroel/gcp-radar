...
keywords:
  - "host project connector setup"
  - "shared VPC connector config"
  - "Shared VPC host projects"
  - "host-project VPC connector"
  - "Serverless VPC Access connector"
  - "connector in shared VPC"
...
Serverless VPC Access connectors can now be configured for Shared VPC host projects in GA.
...
- Re-rank rationale: The page explicitly describes creating Serverless VPC Access connectors for App Engine with Shared VPC, including cross-project connector/subnet requirements that define how shared-network usage works.
