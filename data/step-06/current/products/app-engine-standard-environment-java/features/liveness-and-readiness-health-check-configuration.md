...
feature_name: "Liveness and readiness health check configuration"
feature_slug: "liveness-and-readiness-health-check-configuration"
...
The SDK adds updated liveness and readiness health check support in appengine-web.xml for compatible flexible runtimes.
