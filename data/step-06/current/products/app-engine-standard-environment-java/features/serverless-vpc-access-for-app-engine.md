...
generated_at: "2026-04-11T21:44:03.357Z"
...
keywords:
  - "private network egress from App Engine"
  - "VPC connector integration"
  - "SVPC"
  - "App Engine VPC connector"
  - "VPC Access connector"
  - "connectors for App Engine"
...
- Re-rank rationale: It is an App Engine Standard Environment guide that explains connecting services directly to a VPC network via Serverless VPC Access.
