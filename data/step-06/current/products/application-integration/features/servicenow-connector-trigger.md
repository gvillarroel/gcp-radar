...
feature_name: "ServiceNow connector trigger"
feature_slug: "servicenow-connector-trigger"
...
A ServiceNow connector event trigger became available in preview in Application Integration.
...
- ServiceNow trigger The ServiceNow trigger is a Connector Event trigger that lets you invoke an integration based on the custom ServiceNow events that you've defined in your ServiceNow instance business rule .
- Note that the ServiceNow trigger is an Connector Event trigger , therefore you can only use a ServiceNow connection with event subscription enabled to configure the trigger.
