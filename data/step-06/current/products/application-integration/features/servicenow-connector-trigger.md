...
- Map trigger payload to Salesforce connector When the integration is invoked using the Salesforce trigger, you extract the case ID and map it to a Salesforce connector to retrieve additional details of the case.
