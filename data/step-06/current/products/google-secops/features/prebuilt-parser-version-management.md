...
generated_at: "2026-04-14T16:02:18.741Z"
...
- For example: /path/to/cert.key syslog settings.tls settings.minimum tls version string Optional The minimum TLS version. syslog settings.tls settings.insecure skip verify bool Optional If true , enables SSL certification verification.
- For example: /path/to/cert.key kafka settings.tls settings.minimum tls version string Optional The minimum TLS version. kafka settings.tls settings.insecure skip verify bool Optional If true , enables SSL certification verification.
...
- Pre-GA features might have limited support, and changes to pre-GA features might not be compatible with other pre-GA versions.
