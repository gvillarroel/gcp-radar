...
generated_at: "2026-04-14T16:02:18.740Z"
product_name: "Google SecOps"
product_slug: "google-secops"
feature_name: "Netskope v1 API feed"
feature_slug: "netskope-v1-api-feed"
...
The Netskope v1 API feed is no longer supported and users must move to Netskope REST API v2; deprecated on 2025-10-15.
...
- If you configure the feed to delete source files, you must add the Google SecOps service account as a principal on your bucket and grant it the IAM Storage Object Admin ( roles/storage.objectAdmin ) role.
