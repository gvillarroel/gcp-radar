...
feature_name: "App Engine flexible environment selector migration"
feature_slug: "app-engine-flexible-environment-selector-migration"
...
# App Engine flexible environment selector migration
...
Flexible environment applications are now selected using env:flex instead of vm:true in app.yaml.
