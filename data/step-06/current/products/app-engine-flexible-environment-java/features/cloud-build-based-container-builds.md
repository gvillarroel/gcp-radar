...
generated_at: "2026-04-15T00:05:03.314Z"
product_name: "App Engine flexible environment Java"
product_slug: "app-engine-flexible-environment-java"
feature_name: "Cloud Build-based container builds"
feature_slug: "cloud-build-based-container-builds"
...
# Cloud Build-based container builds
...
Managed VMs can use Cloud Build in Beta to remotely build container images for deployment instead of the default transient Compute Engine VM builder.
...
Evidence snippets:
- ADD www/ /usr/share/nginx/www/ RUN chmod -R a+r /usr/share/nginx/www The FROM command builds a base image using the official docker image for the nginx web server.
