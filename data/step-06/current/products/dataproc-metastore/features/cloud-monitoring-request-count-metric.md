...
feature_name: "Cloud Monitoring request_count metric"
feature_slug: "cloud-monitoring-request-count-metric"
...
- To work around this issue, or if you encounter a VPC-SC issue of type NO MATCHING ACCESS LEVEL while creating your Dataproc Metastore service, create an access level for your service so it can access the APIs inside the service perimeter.
