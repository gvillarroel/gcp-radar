...
generated_at: "2026-04-14T18:41:06.035Z"
product_name: "Cloud Deployment Manager"
product_slug: "cloud-deployment-manager"
feature_name: "Deployment updates"
feature_slug: "deployment-updates"
...
Deployment Manager supports updating deployments in the v2beta2 API.
...
- Infra Manager leverages Terraform to create infrastructure deployments using infrastructure as code (IaC).
- Infra Manager manages updates through its CreateDeployment and UpdateDeployment methods.
- Infra Manager also integrates with IAM for granular access control to deployments.
