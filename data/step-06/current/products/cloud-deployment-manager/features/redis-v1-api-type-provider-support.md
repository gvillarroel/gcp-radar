...
generated_at: "2026-04-14T18:41:05.955Z"
product_name: "Cloud Deployment Manager"
product_slug: "cloud-deployment-manager"
feature_name: "Redis v1 API type provider support"
feature_slug: "redis-v1-api-type-provider-support"
...
# Redis v1 API type provider support
...
Deployment Manager supports the Redis v1 API through the gcp-types/redis-v1 type provider.
