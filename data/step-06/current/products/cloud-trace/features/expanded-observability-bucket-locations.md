...
feature_name: "Expanded observability bucket locations"
feature_slug: "expanded-observability-bucket-locations"
...
- Verify that the linked BigQuery dataset for the observability bucket named Trace exists.
