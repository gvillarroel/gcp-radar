...
The App Engine standard environment now supports the Python 3.12 runtime as a generally available runtime option; Python 3.12 support was introduced for App Engine standard environment in preview.
