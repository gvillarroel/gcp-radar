...
feature_name: "App Engine availability in europe-west2"
feature_slug: "app-engine-availability-in-europe-west2"
...
App Engine is available as a deployment region in europe-west2 (London).
