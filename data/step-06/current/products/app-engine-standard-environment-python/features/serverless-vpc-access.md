...
Serverless VPC Access reached general availability for connecting App Engine to VPC resources; Serverless VPC Access entered beta, allowing App Engine apps to connect securely to VPC resources.
