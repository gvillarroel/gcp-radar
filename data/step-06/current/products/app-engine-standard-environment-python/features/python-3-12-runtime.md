...
Python 3.12 is a supported App Engine standard environment runtime for Python applications; Python 3.12 is a supported App Engine standard environment runtime for Python applications.
