...
generated_at: "2026-04-10T21:10:29.904Z"
product_name: "Cloud Database Migration Service"
product_slug: "cloud-database-migration-service"
feature_name: "Table-level observability for heterogeneous Oracle and SQL Server migrations"
feature_slug: "table-level-observability-for-heterogeneous-oracle-and-sql-server-migrations"
...
# Table-level observability for heterogeneous Oracle and SQL Server migrations
...
Migration job observability now includes per-table progress monitoring in addition to aggregate database-level metrics for heterogeneous Oracle and SQL Server migrations.
