...
generated_at: "2026-04-10T21:10:29.966Z"
product_name: "Cloud Database Migration Service"
product_slug: "cloud-database-migration-service"
feature_name: "MySQL 8.0.36 target version support"
feature_slug: "mysql-8-0-36-target-version-support"
...
# MySQL 8.0.36 target version support
...
Evidence snippets:
- May 22, 2024 Feature Database Migration Service now supports migrations to MySQL minor version 8.0.36.
- For more information, see the following pages: Migration data flow for Oracle to Cloud SQL for PostgreSQL Migration data flow for Oracle to AlloyDB for PostgreSQL Migration data flow for SQL Server to Cloud SQL for PostgreSQL Migration data flow for SQL Server to AlloyDB for PostgreSQL November 05, 2025 Feature Database Migration Service for homogeneous MySQL migrations to Cloud SQL for MySQL now supports MySQL version 8.0.43.
