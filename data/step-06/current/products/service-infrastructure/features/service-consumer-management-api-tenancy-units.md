...
generated_at: "2026-04-10T05:27:58.960Z"
product_name: "Service Infrastructure"
product_slug: "service-infrastructure"
feature_name: "Service Consumer Management API Tenancy Units"
feature_slug: "service-consumer-management-api-tenancy-units"
...
- Summary of the Service Management REST API.
- Summary of the Service Networking REST API.
- Summary of the Service Control REST API.

### Service Management API | Service Infrastructure | Google Cloud Documentation
...
Evidence snippets:
- Service Management API Service Infrastructure Google Cloud Documentation Source URL: https://docs.cloud.google.com/service-infrastructure/docs/service-management/reference/rest To call this service, we recommend that you use the Google-provided client libraries.
...
- A Discovery Document is a machine-readable specification for describing ...
