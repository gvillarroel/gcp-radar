...
- This field is only populated for requests when the request has a TRAFFIC AWARE or TRAFFIC AWARE OPTIMAL ComputeRoutesRequest.routing preference value, and TRAFFIC ON POLYLINE is included in the ComputeRoutesRequest.extra computations .
