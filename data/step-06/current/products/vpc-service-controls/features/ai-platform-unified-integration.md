...
feature_name: "AI Platform (Unified) integration"
feature_slug: "ai-platform-unified-integration"
...
# AI Platform (Unified) integration
...
VPC Service Controls integrates with AI Platform (Unified) to support service perimeter protections for that service.
...
Evidence snippets:
- Limitations The Unified Maintenance integration with VPC Service Controls has no known limitations.
...
Evidence snippets:
- Home Documentation Networking VPC Service Controls Guides Send feedback Design and architect service perimeters Stay organized with collections Save and categorize content based on your preferences.
...
- Since your project and the Google-owned project that contains the target bucket aren't in the same perimeter, VPC Service Controls denies the request with the RESOURCES NOT IN SAME SERVICE PERIMETER violation reason.
- There are certain limitations when you want to access Cloud Storage buckets from projects within a VPC Service Controls perimeter that resides in a different organization.
