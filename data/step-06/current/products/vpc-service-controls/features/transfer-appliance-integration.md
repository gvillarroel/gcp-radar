...
generated_at: "2026-04-12T12:20:13.558Z"
product_name: "VPC Service Controls"
product_slug: "vpc-service-controls"
feature_name: "Transfer Appliance integration"
feature_slug: "transfer-appliance-integration"
...
# Transfer Appliance integration
...
VPC Service Controls integrates with Transfer Appliance to support service perimeter protections for that service.
...
Evidence snippets:
- Limitations When Cloud Storage is protected by VPC Service Controls, the Cloud KMS key you share with the Transfer Appliance Team must be within the same project as the destination Cloud Storage bucket.
- Limitations The Storage Transfer Service integration with VPC Service Controls has no known limitations.
- For setup information, see Using Storage Transfer Service with VPC Service Controls Transfer service for on-premises data See Using Transfer for on-premises with VPC Service Controls for details and setup information for Transfer for on-premises.
