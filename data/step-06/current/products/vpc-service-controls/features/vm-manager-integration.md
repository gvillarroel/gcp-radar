...
feature_name: "VM Manager integration"
feature_slug: "vm-manager-integration"
...
VPC Service Controls supports integration with VM Manager.
...
- To use VM Manager from within VPC Service Controls perimeters, set up VM Manager .
