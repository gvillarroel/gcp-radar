...
feature_name: "Service Directory integration"
feature_slug: "service-directory-integration"
...
VPC Service Controls integrates with Service Directory to support service perimeter protections for that service.
...
- Limitations The Service Directory integration with VPC Service Controls has no known limitations.
...
- In comparison, VPC Service Controls allows you to define a perimeter to prevent communication with services outside the perimeter.
- Objectives Configure a VPC Service Controls perimeter with additional networking controls to mitigate exfiltration paths.
...
- To resolve this issue, create a VPC network with a different name and add it to the perimeter.
