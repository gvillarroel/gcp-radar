...
generated_at: "2026-04-12T12:20:13.530Z"
product_name: "VPC Service Controls"
product_slug: "vpc-service-controls"
feature_name: "Storage Insights integration"
feature_slug: "storage-insights-integration"
...
VPC Service Controls supports integration with Storage Insights.
...
Evidence snippets:
- Limitations The Storage Insights integration with VPC Service Controls has no known limitations.
...
- Limitations The Customer Experience Insights integration with VPC Service Controls has no known limitations.
- Limitations The Storage Transfer Service integration with VPC Service Controls has no known limitations.
...
- Cloud Storage issues Denials when targeting a non-existent logging Cloud Storage bucket If the specified logging bucket doesn't exist, VPC Service Controls denies access with the RESOURCES NOT IN SAME SERVICE PERIMETER violation reason.
