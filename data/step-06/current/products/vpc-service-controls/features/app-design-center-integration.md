...
feature_name: "App Design Center integration"
feature_slug: "app-design-center-integration"
...
VPC Service Controls supports integration with App Design Center.
...
- Service name designcenter.googleapis.com Details The API for App Design Center can be protected by VPC Service Controls and the product can be used normally inside service perimeters.
...
- VPC Service Controls perimeter restrictions don't apply to BigQuery query result export If you are trying to restrict the export of protected data from BigQuery to Google Drive, Google Sheets, or Looker Studio, you might see some deviation from expected behavior.
