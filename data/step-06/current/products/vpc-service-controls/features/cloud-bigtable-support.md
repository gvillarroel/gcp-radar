...
feature_name: "Cloud Bigtable support"
feature_slug: "cloud-bigtable-support"
...
VPC Service Controls supports protecting Cloud Bigtable resources.
...
- The perimeter protects the Cloud Storage service. my-authorized-gcs-project uses a number of services, including Cloud Storage, Bigtable, and others. my-authorized-compute-project hosts a VPC network.
