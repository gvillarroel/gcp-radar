...
generated_at: "2026-04-12T12:20:13.554Z"
product_name: "VPC Service Controls"
product_slug: "vpc-service-controls"
feature_name: "OS Login integration"
feature_slug: "os-login-integration"
...
VPC Service Controls supports integration with OS Login.
...
- The following are the possible values: TRUE : The service integration with VPC Service Controls has known limitations.
- Service name oslogin.googleapis.com Details You can call the OS Login API from within VPC Service Controls perimeters.
- Limitations The Microservices integration with VPC Service Controls has no known limitations.
