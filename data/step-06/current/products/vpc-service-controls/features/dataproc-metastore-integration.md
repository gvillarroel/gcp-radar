...
generated_at: "2026-04-12T12:20:13.556Z"
...
VPC Service Controls integrates with Dataproc Metastore to support service perimeter protections for that service.
...
Evidence snippets:
- Limitations The Dataproc Metastore integration with VPC Service Controls has no known limitations.
- Limitations The BigLake metastore integration with VPC Service Controls has no known limitations.
...
- Service name metastore.googleapis.com Details The API for Dataproc Metastore can be protected by VPC Service Controls and the product can be used normally inside service perimeters.
...
- If you use a Google Cloud service that VPC Service Controls doesn't support , email addresses that belong to the domain google.com are redacted and replaced with google-internal . google-internal refers to internal Google-owned identities. <PUBLIC IP ADDRESS> is the IP address of the caller.
