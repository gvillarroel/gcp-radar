...
feature_name: "Retail API integration"
feature_slug: "retail-api-integration"
...
Evidence snippets:
- Limitations The Retail API integration with VPC Service Controls has no known limitations.
