...
feature_name: "BigQuery Data Policy API integration"
feature_slug: "bigquery-data-policy-api-integration"
...
# BigQuery Data Policy API integration
...
VPC Service Controls supports integration with the BigQuery Data Policy API.
...
Evidence snippets:
- Limitations The BigQuery Data Policy API integration with VPC Service Controls has no known limitations.
...
Evidence snippets:
- User-managed notebooks API requests blocked by VPC Service Controls despite being allowed in an ingress or egress rule If you have allowed access to User-managed notebooks API using an ingress policy and you have set the identity type as ANY USER ACCOUNT or ANY SERVICE ACCOUNT , VPC Service Controls blocks access to the API.
