...
feature_name: "Memorystore for Memcached integration"
feature_slug: "memorystore-for-memcached-integration"
...
Evidence snippets:
- Limitations The Memorystore for Valkey integration with VPC Service Controls has no known limitations.
...
- Service name memcache.googleapis.com Details The API for Memorystore for Memcached can be protected by VPC Service Controls and the product can be used normally inside service perimeters.
