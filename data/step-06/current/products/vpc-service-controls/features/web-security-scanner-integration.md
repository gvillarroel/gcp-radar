...
generated_at: "2026-04-12T12:20:13.533Z"
product_name: "VPC Service Controls"
product_slug: "vpc-service-controls"
feature_name: "Web Security Scanner integration"
feature_slug: "web-security-scanner-integration"
...
VPC Service Controls supports integration with Web Security Scanner.
...
Evidence snippets:
- Limitations The Web Security Scanner integration with VPC Service Controls has no known limitations.
- Service name websecurityscanner.googleapis.com Details Web Security Scanner and VPC Service Controls are subject to different terms of service.
- Limitations The Firebase Security Rules integration with VPC Service Controls has no known limitations.
- Limitations The Container Security API integration with VPC Service Controls has no known limitations.
