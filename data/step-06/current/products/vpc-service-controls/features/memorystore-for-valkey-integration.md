...
feature_name: "Memorystore for Valkey integration"
feature_slug: "memorystore-for-valkey-integration"
...
# Memorystore for Valkey integration
...
Provides VPC Service Controls integration support for Memorystore for Valkey.
...
- For this reason, the display name for Memorystore for Valkey is "Memorystore API" when using the VPC Service Controls in the Google Cloud console.
