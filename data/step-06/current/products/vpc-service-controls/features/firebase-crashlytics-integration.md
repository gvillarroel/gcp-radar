...
feature_name: "Firebase Crashlytics integration"
feature_slug: "firebase-crashlytics-integration"
...
VPC Service Controls supports integration with Firebase Crashlytics.
...
Evidence snippets:
- Limitations The Firebase Crashlytics integration with VPC Service Controls has no known limitations.
- Limitations The Firebase Security Rules integration with VPC Service Controls has no known limitations.
- Limitations The Firebase Data Connect integration with VPC Service Controls has no known limitations.
...
- The enterprise needs to be able to log data from multiple different VPC Service Controls perimeters into the shared logs project, which is in its own perimeter.
