...
feature_name: "Backup for GKE integration"
feature_slug: "backup-for-gke-integration"
...
VPC Service Controls supports integration with Backup for GKE.
...
Evidence snippets:
- Limitations The Backup for GKE integration with VPC Service Controls has no known limitations.
...
- Service name gkebackup.googleapis.com Details You can use VPC Service Controls to protect backup for GKE and you can use backup for GKE features normally inside service perimeters.
