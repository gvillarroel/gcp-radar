...
generated_at: "2026-04-12T12:20:13.506Z"
product_name: "VPC Service Controls"
product_slug: "vpc-service-controls"
feature_name: "Vertex AI Agent Engine integration"
feature_slug: "vertex-ai-agent-engine-integration"
...
VPC Service Controls supports integration with Vertex AI Agent Engine.
...
Evidence snippets:
- Service name aiplatform.googleapis.com Details The API for Vertex AI Agent Engine can be protected by VPC Service Controls and the product can be used normally inside service perimeters.
...
Evidence snippets:
- Vertex AI issues This section lists the issues you might encounter while using Vertex AI resources that are inside a VPC Service Controls perimeter.
