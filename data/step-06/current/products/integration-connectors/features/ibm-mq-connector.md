...
feature_name: "IBM MQ connector"
feature_slug: "ibm-mq-connector"
...
Provides a connector for IBM MQ.
...
- IBM Db2 The IBM DB2 connector lets you perform insert, delete, update, and read operations on an IBM Db2 database.
