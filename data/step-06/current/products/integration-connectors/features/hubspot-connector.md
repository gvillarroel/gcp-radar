...
generated_at: "2026-04-12T12:17:32.232Z"
product_name: "Integration Connectors"
product_slug: "integration-connectors"
feature_name: "HubSpot connector"
feature_slug: "hubspot-connector"
...
source_links:
  ...
  - "https://docs.cloud.google.com/integration-connectors/docs/connectors/authorize.net/configure"
keywords:
  - "hubspot"
  - "connector"
  - "the"
...
The HubSpot connector is available in preview.
...
### Authorize.Net \_|\_ Integration Connectors \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/integration-connectors/docs/connectors/authorize.net/configure](https://docs.cloud.google.com/integration-connectors/docs/connectors/authorize.net/configure)
- Source ID: `site-docs-root-2`
- Final score: 205
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- Preview — BigQuery Connector This feature is subject to the "Pre-GA Offerings Terms" in the General Service Terms section of the Service Specific Terms .
- In the Connection Details section, complete the following: Connector : Select Authorize.Net from the drop down list of available Connectors.
