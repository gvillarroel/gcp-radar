...
feature_name: "HL7 trigger event subscription"
feature_slug: "hl7-trigger-event-subscription"
...
source_links:
  ...
  - "https://docs.cloud.google.com/integration-connectors/docs/about-connectors"
keywords:
  - "hl7"
  - "trigger"
  - "event"
...
- If you want to use a proxy to connect to your backend (for event subscription), enter the following details: Proxy SSL Type : The SSL type to use when connecting to the proxy server.
- Configure event subscription If you have enabled the event subscription, enter the following values in the Event Subscription Details section: Enter the authentication details.
...
### Integration Connectors overview \_|\_ Google Cloud Documentation
...
- Interact with data from multiple disparate sources and formats in a standardized and streamlined manner. [FUTURE PLACEHOLDER] Trigger Integration Flows based on events that happen in the source application. --> What's next To get started with Integration Connectors, see Set up Integration Connectors .
- Simplified integration development As an integration developer, you can use the Google Cloud console to: Create and configure a connection once and use the connection in any future integrations.
...
- URL: [https://docs.cloud.google.com/integration-connectors/docs/about-connectors](https://docs.cloud.google.com/integration-connectors/docs/about-connectors)
- Source ID: `site-docs-root`
- Final score: 113
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
