...
feature_name: "Salesforce Commerce Cloud B2B connector"
feature_slug: "salesforce-commerce-cloud-b2b-connector"
...
source_links:
  ...
  - "https://docs.cloud.google.com/integration-connectors/docs/connectors/commercetools/configure"
...
# Salesforce Commerce Cloud B2B connector
...
The Salesforce Commerce Cloud B2B connector is available in Google Cloud Marketplace.
...
Evidence snippets:
- In the Connection Details section, complete the following: Connector : Select BigCommerce from the drop down list of available Connectors.
- Before you begin Before using the BigCommerce connector, do the following tasks: In your Google Cloud project: Ensure that network connectivity is set up.
...
### Commercetools \_|\_ Integration Connectors \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/integration-connectors/docs/connectors/commercetools/configure](https://docs.cloud.google.com/integration-connectors/docs/connectors/commercetools/configure)
- Source ID: `site-docs-root-2`
- Final score: 259
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- In the Connection Details section, complete the following: Connector : Select Commercetools from the drop down list of available Connectors.
- Before you begin Before using the Commercetools connector, do the following tasks: In your Google Cloud project: Ensure that network connectivity is set up.
- Action: An action is a first class function that is made available to the integration through the connector interface.
- Grant the following IAM roles to the service account that you want to use for the connector: roles/secretmanager.viewer roles/secretmanager.secretAccessor A service account is a special type of Google account intended to represent a non-human user that needs to authenticate and be authorized to access data in Google APIs.
