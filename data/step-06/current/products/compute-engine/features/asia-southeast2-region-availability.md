...
feature_name: "asia-southeast2 region availability"
feature_slug: "asia-southeast2-region-availability"
...
# asia-southeast2 region availability
...
The asia-southeast2 region adds a new Compute Engine region for deploying resources.
...
- Product-specific Pricing Compute Engine Cloud SQL Google Kubernetes Engine Cloud Storage BigQuery See full price list with 100+ products close Learn & build Google Cloud Free Program $300 in free credits and 20+ free products.
...
- Locations table For information about which regions and zones support data transfer, see the following table.
...
- A4X Max and A4X limitations The following limitations apply to A4X Max and A4X instances: A4X Max instances Caution: The Compute Engine Service Level Agreement (SLA) doesn't apply to the A4X Max machine series.
- Home Documentation Compute Compute Engine Guides Send feedback Accelerator-optimized machine family Stay organized with collections Save and categorize content based on your preferences.
