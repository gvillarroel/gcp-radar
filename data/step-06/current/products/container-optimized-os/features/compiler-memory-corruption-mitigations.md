...
feature_name: "compiler memory corruption mitigations"
feature_slug: "compiler-memory-corruption-mitigations"
...
# compiler memory corruption mitigations
...
Container-Optimized OS includes compiler mitigations to reduce memory corruption vulnerabilities; Container-Optimized OS adds compiler mitigations against memory corruption vulnerabilities.
...
- Note: Creating the report consumes CPU and memory resource, and storing the report consumes disk space and disk I/O bandwidth resource on the node.
