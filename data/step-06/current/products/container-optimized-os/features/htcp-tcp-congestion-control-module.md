...
feature_name: "HTCP TCP congestion control module"
feature_slug: "htcp-tcp-congestion-control-module"
...
# HTCP TCP congestion control module
...
Container-Optimized OS enables the HTCP TCP congestion control algorithm as a module.
