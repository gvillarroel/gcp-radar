...
feature_name: "ReplicaSet API"
feature_slug: "replicaset-api"
...
The deprecated ReplicaSet beta API versions are no longer served in GKE v1.16 and should be migrated to apps/v1; deprecated on 2020-02-25.
