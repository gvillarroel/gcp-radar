...
generated_at: "2026-04-14T04:42:56.876Z"
product_name: "Google Kubernetes Engine"
product_slug: "google-kubernetes-engine"
feature_name: "DaemonSet maxSurge"
feature_slug: "daemonset-maxsurge"
...
- Then you deploy a DaemonSet that does the following: Schedules Pods on tainted nodes by using a toleration for the taint.
...
Evidence snippets:
- High GKE on VMware Updated: 2024-03-06 Description Severity A security vulnerability, CVE-2024-21626, has been discovered in runc where a user with permission to create Pods on Container-Optimized OS and Ubuntu nodes might be able to gain full access to the node filesystem.
- High GKE on Azure Updated: 2024-05-06 Description Severity A security vulnerability, CVE-2024-21626, has been discovered in runc where a user with permission to create Pods on Container-Optimized OS and Ubuntu nodes might be able to gain full access to the node filesystem.
- High GKE on AWS Updated: 2024-05-06 Description Severity A security vulnerability, CVE-2024-21626, has been discovered in runc where a user with permission to create Pods on Container-Optimized OS and Ubuntu nodes might be able to gain full access to the node filesystem.
- GKE Updated: 2024-03-06 Description Severity A security vulnerability, CVE-2024-21626, has been discovered in runc where a user with permission to create Pods on Container-Optimized OS and Ubuntu nodes might be able to gain full access to the node filesystem.
