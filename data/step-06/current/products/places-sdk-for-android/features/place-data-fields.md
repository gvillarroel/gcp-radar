...
- With Place Details and Text Search you use field lists to control the list of fields to return in the response.
...
- The Place Autocomplete (Legacy) service also returns a place ID for each place that matches the supplied search query and filter.
