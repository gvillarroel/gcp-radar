...
Evidence snippets:
- If you don't enable Places SDK for Android (New), then Place.getPlaceTypes() only supports the legacy place types shown in Place Types .
- Home Products Google Maps Platform Documentation Android Places SDK for Android Guides Send feedback Place Types (New) Stay organized with collections Save and categorize content based on your preferences.
...
- The Autocomplete (New) widget is available in Places SDK for Android version 4.3.1 and later.
