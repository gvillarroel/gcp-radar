...
Cloud Storage FUSE mounting behavior can be controlled with a configuration file instead of global options.
...
- This document describes how to use a Cloud Storage FUSE configuration file to configure the behavior of Cloud Storage FUSE in a persistent manner.
