...
Cloud Storage is available in the Tel Aviv region (me-west1).
...
- This page explains the concepts of availability and durability within Cloud Storage: Availability: The ability to access data immediately upon request.
