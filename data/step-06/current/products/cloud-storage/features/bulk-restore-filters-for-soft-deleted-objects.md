...
feature_name: "Bulk restore filters for soft-deleted objects"
feature_slug: "bulk-restore-filters-for-soft-deleted-objects"
...
- What's next For a list of roles and the permissions they contain, see IAM roles for Cloud Storage .
...
- See: https://cloud.google.com/storage/docs/json api/v1/objects/list#list-object-glob soft deleted bool (Optional) If true, only soft-deleted objects will be listed as distinct results in order of increasing generation number.
