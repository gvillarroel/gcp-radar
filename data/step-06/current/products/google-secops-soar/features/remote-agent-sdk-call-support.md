...
feature_name: "Remote agent SDK call support"
feature_slug: "remote-agent-sdk-call-support"
...
- GATEWAY ERROR API returned a gateway error to the call made by Google SecOps.
...
- The following pattern refers to an entity context: $e.graph.entity.hostname Note that there are two equivalent methods of referring to a UDM event: $u.udm.principal.asset id $u.principal.asset id You can mix and match all of these qualifiers in rule text.
