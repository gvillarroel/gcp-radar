...
latest_feature_date: "2025-03-29"
deprecation_date: ""
...
The User Preferences dialog centralizes platform time zones, date and time settings, notifications, and accessibility options.
...
Evidence snippets:
- Each time a user signs in to the platform, they are automatically added to the User Management page, found under Settings > Organization .
