...
feature_name: "Job execution table sorting"
feature_slug: "job-execution-table-sorting"
...
- Fetch Max Hours Backwards Integer 1 No The number of hours prior to now to retrieve alerts.
