...
Users can group environments into logical categories for user assignment, IdP mapping, playbooks, and case filters.
...
Evidence snippets:
- Users can only access data within the environments or groups assigned to them.
- Map and authenticate users The combination of permission groups, SOC roles, and environments determines the Google SecOps user journey for each IdP group in the Google SecOps platform.
- You can map IdP groups with multiple permission groups, SOC roles, and environments.
