...
generated_at: "2026-04-15T11:56:51.981Z"
...
- Export the database to your Cloud Storage bucket: Note : If you want to use serverless exports, then use the offload parameter.
