...
- WARNING: Changing this might restart the instance. secondaryZone string The preferred Compute Engine zone for the secondary/failover (for example: us-central1-a, us-central1-b, etc.).
