...
generated_at: "2026-04-15T11:56:51.959Z"
...
Cloud SQL provides a recommender that identifies overprovisioned database instances and suggests rightsizing to reduce costs; Cloud SQL provides a preview recommender that identifies overprovisioned database instances and suggests rightsizing to reduce costs.
...
- HTTP request Path parameters Request body Response body Authorization scopes InstancesDemoteRequest JSON representation DemoteContext JSON representation Examples Try it!
