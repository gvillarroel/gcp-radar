...
generated_at: "2026-04-15T11:56:51.928Z"
...
- When you use new network architecture enforcement before a project is fully upgraded, you might experience instance creation failure if sufficient IP address space isn't available.
- When you use new network architecture enforcement before a project is fully upgraded, you might experience instance creation failure if sufficient IP address space isn't available.
- You can use the sqlNetworkArchitecture field to enforce the use of the new network architecture for the instance upon creation, even if the project isn't fully upgraded.
