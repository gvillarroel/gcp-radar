...
- The list of DNS names used by this instance. outOfDiskReport object ( SqlOutOfDiskReport ) This field represents the report generated by the proactive database wellness job for OutOfDisk issues.
- Enums SQL OUT OF DISK STATE UNSPECIFIED Unspecified state NORMAL The instance has plenty space on data disk SOFT SHUTDOWN Data disk is almost used up.
