...
source_links:
  - "https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/flags"
...
### REST Resource: flags \_|\_ Cloud SQL for MySQL \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/flags](https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/flags)
- Source ID: `site-api-reference`
- Final score: 141
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- Home Documentation Databases Cloud SQL MySQL Reference Send feedback REST Resource: flags Stay organized with collections Save and categorize content based on your preferences.
