...
Evidence snippets:
- MYSQL 8 0 30 The database major version is MySQL 8.0 and the minor version is 30.
...
Evidence snippets:
- September 06, 2022 Feature Cloud SQL for MySQL now supports minor version 8.0.30.
