...
- You can't enable managed buffer pool for instances that use a shared core or for instances that are running MySQL 5.6 or MySQL 5.7.
- For more information about the implementation of MySQL 8.4 in Cloud SQL, see the following topics: MySQL 8.4 authentication plugin default MySQL features unsupported for Cloud SQL MySQL 8.4 user privileges (cloudsqlsuperuser) To create a MySQL 8.4 instance in Cloud SQL, see Create instances .
