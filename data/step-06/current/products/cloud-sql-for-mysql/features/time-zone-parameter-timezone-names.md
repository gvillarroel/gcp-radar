...
Evidence snippets:
- July 07, 2022 Feature Cloud SQL for MySQL now supports setting timezone names as values for the time zone parameter.
- Refer to the Cloud SQL documentation for a list of supported timezone names.
