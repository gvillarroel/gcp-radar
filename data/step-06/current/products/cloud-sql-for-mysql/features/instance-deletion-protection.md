...
Evidence snippets:
- If deletion protection is enabled for an instance, confirm your plans to delete the instance.
- Then disable deletion protection before deleting the instance.
