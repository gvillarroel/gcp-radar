...
The in-place major version upgrade feature became generally available for Cloud SQL for MySQL.
...
Evidence snippets:
- Feature The In-place Major Version Upgrade feature is now generally available for Cloud SQL for MySQL.
...
- For more information about upgrading the major version of a Cloud SQL instance, see Upgrade the database major version-place .
- To perform a major version upgrade, see Upgrade the database major version in-place .
