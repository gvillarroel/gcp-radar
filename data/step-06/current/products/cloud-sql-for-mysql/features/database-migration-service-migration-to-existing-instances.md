...
- For example, if an error causes a loss of data, then you can recover a database to its state before the error occurred.
- You can use a backup from a live or deleted instance, and use it to restore to a new or existing instance.
