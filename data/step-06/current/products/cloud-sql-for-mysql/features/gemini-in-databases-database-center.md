...
feature_name: "Gemini in Databases Database Center"
feature_slug: "gemini-in-databases-database-center"
...
source_links:
  ...
  - "https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/databases/list"
keywords:
  - "gemini"
  - "databases"
  - "database"
...
### Method: databases.list \_|\_ Cloud SQL for MySQL \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/databases/list](https://docs.cloud.google.com/sql/docs/mysql/admin-api/rest/v1/databases/list)
...
Evidence snippets:
- If successful, the response body contains data with the following structure: JSON representation { "kind" : string , "items" : [ { object ( Database ) } ] } Fields kind string This is always sql#databasesList . items[] object ( Database ) databases.list of database resources in the instance.
- Home Documentation Databases Cloud SQL MySQL Reference Send feedback Method: databases.list Stay organized with collections Save and categorize content based on your preferences.
- HTTP request GET https://sqladmin.googleapis.com/v1/projects/{project}/instances/{instance}/databases The URL uses gRPC Transcoding syntax.
