...
- If your network project contains instances that use the old Cloud SQL network architecture, then you can't create a Private Service Connect instance.
...
- Enums SQL NETWORK ARCHITECTURE UNSPECIFIED NEW NETWORK ARCHITECTURE The instance uses the new network architecture.
