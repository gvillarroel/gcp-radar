...
feature_name: "Ops Agent MySQL metrics integration"
feature_slug: "ops-agent-mysql-metrics-integration"
...
# Ops Agent MySQL metrics integration
...
The Ops Agent can collect MySQL metrics for Cloud Monitoring.
