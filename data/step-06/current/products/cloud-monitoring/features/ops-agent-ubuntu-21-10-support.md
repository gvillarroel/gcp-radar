...
generated_at: "2026-04-10T22:55:18.122Z"
...
- For example, if a policy with priority 1000 failed to start the Ops Agent on a VM, you could add a label like status=failed to the VM.
