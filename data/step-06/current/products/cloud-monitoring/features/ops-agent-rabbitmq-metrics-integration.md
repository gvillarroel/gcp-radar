...
feature_name: "Ops Agent RabbitMQ metrics integration"
feature_slug: "ops-agent-rabbitmq-metrics-integration"
...
# Ops Agent RabbitMQ metrics integration
...
The Ops Agent can collect RabbitMQ metrics for Cloud Monitoring.
