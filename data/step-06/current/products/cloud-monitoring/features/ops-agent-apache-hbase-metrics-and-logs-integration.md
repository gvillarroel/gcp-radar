...
generated_at: "2026-04-15T00:01:13.913Z"
product_name: "Cloud Monitoring"
product_slug: "cloud-monitoring"
feature_name: "Ops Agent Apache HBase metrics and logs integration"
feature_slug: "ops-agent-apache-hbase-metrics-and-logs-integration"
...
# Ops Agent Apache HBase metrics and logs integration
...
The Ops Agent can collect Apache HBase metrics and logs for Cloud Monitoring.
...
- Some metrics, such as the total number of log entries received by your Google Cloud project, are automatically derived from your logs.
- Metrics from an agent in your VM Some system metrics are automatically captured from your Compute Engine instances.
- These log-based metrics record numeric information about the logs written to Cloud Logging .
