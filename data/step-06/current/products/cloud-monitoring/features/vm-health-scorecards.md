...
generated_at: "2026-04-15T00:01:13.953Z"
...
- Spanner instances (Global and regional) Traffic : api/api request count Server error rate : Ratio of requests with a response status that indicates an error to the total number of requests.
