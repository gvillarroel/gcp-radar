...
Metrics Explorer lets users select monitored resource types and metrics and aggregate data across instances.
...
- For Prometheus metrics, the monitored-resource type is prometheus target .
