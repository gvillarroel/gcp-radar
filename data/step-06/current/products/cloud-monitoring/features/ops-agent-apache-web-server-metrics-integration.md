...
feature_name: "Ops Agent Apache Web Server metrics integration"
feature_slug: "ops-agent-apache-web-server-metrics-integration"
...
# Ops Agent Apache Web Server metrics integration
...
The Ops Agent can collect Apache Web Server metrics for Cloud Monitoring.
