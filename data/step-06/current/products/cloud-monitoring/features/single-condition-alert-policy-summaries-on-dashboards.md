...
feature_name: "Single-condition alert policy summaries on dashboards"
feature_slug: "single-condition-alert-policy-summaries-on-dashboards"
...
# Single-condition alert policy summaries on dashboards
...
Custom dashboards can display summaries of single-condition alerting policies including time series, thresholds, and incident status.
...
- Returns Type Description google.cloud.monitoring v3.types.AlertPolicy A description of the conditions under which some aspect of your system is considered to be "unhealthy" and the ways to notify people or services about this state.
- Returns Type Description google.cloud.monitoring v3.types.AlertPolicy A description of the conditions under which some aspect of your system is considered to be "unhealthy" and the ways to notify people or services about this state.
- Returns Type Description google.cloud.monitoring v3.types.AlertPolicy A description of the conditions under which some aspect of your system is considered to be "unhealthy" and the ways to notify people or services about this state.
