...
feature_name: "NetApp Volumes Standard service level"
feature_slug: "netapp-volumes-standard-service-level"
...
# NetApp Volumes Standard service level
...
The Standard service level is a new NetApp Volumes service tier.
...
- This page describes the capabilities of different service levels that NetApp Volumes offers to its users.
...
Evidence snippets:
- Look up tiering statistics NetApp Volumes provides auto-tiering statistics at both the volume and storage pool levels.
...
- Note: Dual-protocol (NFS and SMB combined) isn't allowed for the Flex tier volumes.
- The new volume is listed on the Volumes page.
