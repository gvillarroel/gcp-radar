...
feature_name: "Cluster Enabled and Cluster Disabled instance creation modes"
feature_slug: "cluster-enabled-and-cluster-disabled-instance-creation-modes"
...
# Cluster Enabled and Cluster Disabled instance creation modes
...
Memorystore for Valkey now supports creating instances in Cluster Enabled and Cluster Disabled modes.
...
- In the Node Type section, select one of the following node types : Shared-Core ( shared-core-nano ) Small ( standard-small ) Medium ( highmem-medium ) X-Large ( highmem-xlarge ) In the Cluster Mode section, specify whether you want a Cluster Mode Enabled or Cluster Mode Disabled instance.
- Note: After you create a Cluster Mode Enabled or Cluster Mode Disabled instance, you can't change the instance to the other mode.
...
- Instance endpoints for Cluster Mode Enabled This section explains the discovery and data endpoints that Cluster Mode Enabled instance has.
...
- Connect to an in-transit encryption enabled instance This section provides an example of how to connect to a Memorystore for Valkey Cluster Mode Disabled instance that has in-transit encryption enabled.
