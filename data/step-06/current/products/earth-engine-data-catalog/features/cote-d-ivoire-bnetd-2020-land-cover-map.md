...
A 2020 land cover map for Cote d'Ivoire from BNETD.
...
- Home Earth Engine Data Catalog All Datasets Send feedback Cote d'Ivoire BNETD 2020 Land Cover Map Stay organized with collections Save and categorize content based on your preferences.
- Page Summary outlined flag The Cote d'Ivoire BNETD 2020 Land Cover Map was produced by the Ivorian Government with technical and financial support from the European Union.
...
Evidence snippets:
- The Dynamic Land Cover map at … copernicus eea esa eu landcover landuse-landcover Cote d'Ivoire BNETD 2020 Land Cover Map The Cote d'Ivoire BNETD 2020 Land Cover Map was produced by the Ivorian Government through a national institution, the Center for Geographic Information and Digital from the National Study Office Techniques and Development (BNETD-CIGN), with technical and financial support from the European Union.
- Key actions include creating maps of crop types (Canada AAFC), land cover (Cote d'Ivoire BNETD, Copernicus CORINE), burned areas (FireCCI51), and human settlements (World Settlement Footprint).
