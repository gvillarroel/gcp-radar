...
feature_name: "Brandenburg (Germany) Orthophotos 20 cm"
feature_slug: "brandenburg-germany-orthophotos-20-cm"
...
# Brandenburg (Germany) Orthophotos 20 cm
...
This dataset provides 20 cm orthophotos for Brandenburg, Germany; deprecated on 2023-01-24.
...
Evidence snippets:
- Brandenburg (Germany) RGBN orthophotos 20 cm Orthophotos are an aerial photo dataset covering the Brandenburg state of Germany.
...
Evidence snippets:
- The BLM AIM data archive is … blm ecosystems hydrology range soil table Brandenburg (Germany) RGBN orthophotos 20 cm Orthophotos are an aerial photo dataset covering the Brandenburg state of Germany.
