...
generated_at: "2026-04-14T15:13:19.572Z"
product_name: "Earth Engine Data Catalog"
product_slug: "earth-engine-data-catalog"
feature_name: "OpenET SSEBop Monthly Evapotranspiration v2.0"
feature_slug: "openet-ssebop-monthly-evapotranspiration-v2-0"
...
A monthly evapotranspiration product based on OpenET SSEBop for version 2.0.
...
- OpenET provides ET data from multiple satellite-driven models, and also calculates a single "ensemble value" from the … evapotranspiration gridmet-derived landsat-derived monthly openet publisher-dataset OpenET Ensemble Monthly Evapotranspiration v2.1 The OpenET dataset includes satellite-based data on the total amount of water that is transferred from the land surface to the atmosphere through the process of evapotranspiration (ET).
- The ALEXI evapotranspiration (ET) model specifically uses time … evapotranspiration gridmet-derived landsat-derived monthly openet publisher-dataset OpenET Ensemble Monthly Evapotranspiration v2.0 The OpenET dataset includes satellite-based data on the total amount of water that is transferred from the land surface to the atmosphere through the process of evapotranspiration (ET).
