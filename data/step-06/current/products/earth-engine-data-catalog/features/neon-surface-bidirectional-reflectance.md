...
A NEON hyperspectral surface bidirectional reflectance dataset.
...
- Wavelengths between 1340-1445 nm and 1790-1955 nm are set to … airborne forest highres hyperspectral neon neon-prod-earthengine NEON Surface Directional Reflectance The NEON AOP Surface Directional Reflectance is a hyperspectral VSWIR (visible to shortwave infrared) data product, containing 426 bands spanning wavelengths from 380 nm to 2510 nm.
