...
feature_name: "LANDFIRE Succession Classes"
feature_slug: "landfire-succession-classes"
...
Provides LANDFIRE succession class classifications.
...
Evidence snippets:
- Landfire (LF) Historical fire regimes, intervals, and … doi fire landfire nature-conservancy usda usgs LANDFIRE SClass (Succession Classes) v1.4.0 LANDFIRE (LF), Landscape Fire and Resource Management Planning Tools, is a shared program between the wildland fire management programs of the U.S.
...
Evidence snippets:
- Landfire (LF) Historical fire regimes, intervals, and … doi fire landfire nature-conservancy usda usgs LANDFIRE SClass (Succession Classes) v1.4.0 LANDFIRE (LF), Landscape Fire and Resource Management Planning Tools, is a shared program between the wildland fire management programs of the U.S.
- Documentation: User's Guide Algorithm Theoretical Basis … 8-day aqua fire global modis nasa Monitoring Trends in Burn Severity (MTBS) Burn Severity Images The burn severity mosaics consist of thematic raster images of MTBS burn severity classes for all currently completed MTBS fires for the continental United States, Alaska, Hawaii and Puerto Rico.
...
- It contains the maximum value of the individual pixel classes over the compositing period.
