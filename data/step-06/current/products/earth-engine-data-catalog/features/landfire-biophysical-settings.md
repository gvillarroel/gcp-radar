...
Provides LANDFIRE biophysical settings.
...
Evidence snippets:
- This system is … drought fire rainfall LANDFIRE BPS (Biophysical Settings) v1.4.0 LANDFIRE (LF), Landscape Fire and Resource Management Planning Tools, is a shared program between the wildland fire management programs of the U.S.
