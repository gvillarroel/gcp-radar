...
generated_at: "2026-04-11T12:40:58.749Z"
product_name: "Earth Engine Data Catalog"
product_slug: "earth-engine-data-catalog"
feature_name: "JAXA ALOS AW3D30 v2.1"
feature_slug: "jaxa-alos-aw3d30-v2-1"
latest_feature_date: "2019-12-31"
deprecation_date: "2019-12-31"
coverage_status: "LOW"
source_links:
...
- Values are estimated using multi-band passive … climate geophysical gpm hourly jaxa precipitation GTOPO30: Global 30 Arc-Second Elevation GTOPO30 is a global digital elevation model (DEM) with a horizontal grid spacing of 30 arc seconds (approximately 1 kilometer).
...
- AHN4 Dataset contains the Netherlands AHN 0.5m DSM … ahn dem elevation elevation-topography geophysical lidar ALOS DSM: Global 30m v4.1 ALOS World 3D - 30m (AW3D30) is a global digital surface model (DSM) dataset with a horizontal resolution of approximately 30 meters (1 arcsec mesh).
- Values are estimated using multi-band passive … climate geophysical gpm hourly jaxa precipitation GTOPO30: Global 30 Arc-Second Elevation GTOPO30 is a global digital elevation model (DEM) with a horizontal grid spacing of 30 arc seconds (approximately 1 kilometer).
- It is based on the 30m "AVE" band of JAXA's ALOS DEM (available in EE as JAXA/ALOS/AW3D30 V1 1).
- It is based on the 30m "AVE" band of JAXA's ALOS DEM (available in EE as JAXA/ALOS/AW3D30 V1 1).
