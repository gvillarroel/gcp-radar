...
generated_at: "2026-04-14T15:13:20.425Z"
product_name: "Earth Engine Data Catalog"
product_slug: "earth-engine-data-catalog"
feature_name: "WHBU/NBAR_2YEAR"
feature_slug: "whbu-nbar-2year"
latest_feature_date: "2011-07-26"
deprecation_date: ""
coverage_status: "MEDIUM"
source_links:
  - "https://developers.google.com/earth-engine/datasets/catalog/WHBU_NBAR_2YEAR"
keywords:
  - "whbu"
  - "nbar"
  - "2year"
...
- [https://developers.google.com/earth-engine/datasets/catalog/WHBU_NBAR_2YEAR](https://developers.google.com/earth-engine/datasets/catalog/WHBU_NBAR_2YEAR)

## Supporting Pages

### MODIS 2-year Nadir BRDF-Adjusted Reflectance (NBAR) Mosaic | Earth Engine Data Catalog | Google for Developers

- URL: [https://developers.google.com/earth-engine/datasets/catalog/WHBU_NBAR_2YEAR](https://developers.google.com/earth-engine/datasets/catalog/WHBU_NBAR_2YEAR)
- Source ID: `feature-recovery-direct-http`
- Final score: 483
- Re-rank relevance: N/A

Evidence snippets:
- This specific mosaic picks observations from the three highest quality categories over a 2-year period … WHBU/NBAR_2YEAR, albedo,annual,bu,mcd43a4,modis-derived,nbar,reflectance,satellite-imagery 2001-01-01T00:00:00Z/2017-01-01T00:00:00Z -60.1 -180 60.1 180 Google Earth Engine https://developers.google.com/earth-engine/datasets https://doi.org/10.1088/1748-9326/3/4/045011 https://doi.org/10.1088/1748-9326/3/4/045011 Need to tell us more? [[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],[],[],["The dataset, available from 2001 to 2017, provides MODIS-derived annual mosaics of Nadir BRDF-Adjusted Reflectance (NBAR) imagery, created using the MODIS 8-Day 500-meter BRDF-Albedo Quality product.
- ImageCollection ( 'WHBU/NBAR_2YEAR' ); Map . addLayer ( dataset . mean (), { min : 0 , max : 7000 }); Open in Code Editor MODIS 2-year Nadir BRDF-Adjusted Reflectance (NBAR) Mosaic The mosaics are created by using the MODIS 8-Day 500 meter BRDF-Albedo Quality product.
- Dataset Availability 2001-01-01T00:00:00Z–2017-01-01T00:00:00Z Dataset Producer Baccini, A. (Woods Hole Research Center), Sulla-Menashe, D. (Boston University) Earth Engine Snippet ee.ImageCollection("WHBU/NBAR_2YEAR") open_in_new Cadence 1 Year Tags albedo annual bu mcd43a4 modis-derived nbar reflectance satellite-imagery whrc Description The mosaics are created by using the MODIS 8-Day 500 meter BRDF-Albedo Quality product.
- MODIS 2-year Nadir BRDF-Adjusted Reflectance (NBAR) Mosaic | Earth Engine Data Catalog | Google for Developers Skip to main content Earth Engine Data Catalog / English Deutsch Español Español – América Latina Français Indonesia Italiano Polski Português – Brasil Tiếng Việt Türkçe Русский עברית العربيّة فارسی हिंदी বাংলা ภาษาไทย 中文 – 简体 中文 – 繁體 日本語 한국어 Sign in Home Categories All Datasets All Tags Landsat MODIS Sentinel Publisher Community API Docs Dataset Status Changelog Earth Engine Data Catalog Home Categories All Datasets All Tags Landsat MODIS Sentinel Publisher Community API Docs Dataset Status Changelog Home Earth Engine Data Catalog Categories Send feedback MODIS 2-year Nadir BRDF-Adjusted Reflectance (NBAR) Mosaic Stay organized with collections Save and categorize content based on your preferences.
...
Evidence snippets:
- A quality band is also provided for each of the 10 albedo bands. photo library MODIS/061/MCD43A3 MCD43A4.061 MODIS Nadir BRDF-Adjusted Reflectance Daily 500m The MCD43A4 V6.1 Nadir Bidirectional Reflectance Distribution Function Adjusted Reflectance (NBAR) product provides 500 meter reflectance data of the MODIS "land" bands 1-7.
- The MCD12Q2 Version 6.1 data product is derived from time series of the 2-band Enhanced Vegetation Index (EVI2) calculated from MODIS Nadir Bidirectional Reflectance Distribution Function (BRDF)-Adjusted Reflectance(NBAR).
