...
feature_name: "NOAA CDR VIIRS NDVI"
feature_slug: "noaa-cdr-viirs-ndvi"
...
- The VNP13 data products are designed … 16-day evi nasa ndvi noaa npp VNP15A2H: LAI/FPAR 8-Day L4 Global 500m SIN Grid The Visible Infrared Imaging Radiometer Suite (VIIRS) Leaf Area Index (LAI) and Fraction of Photosynthetically Active Radiation (FPAR) Version 1 data product provides information about the vegetative canopy layer at 500 meter resolution (VNP15A2H).
- The data are projected … cdr daily land ndvi noaa vegetation-indices TCB: Malaria Atlas Project Gap-Filled Tasseled Cap Brightness (8-Daily 1km) This gap-filled Tasseled Cap Brightness (TCB) dataset was created by applying the tasseled-cap equations defined in Lobser and Cohen (2007) to MODIS BRDF-corrected imagery (MCD43B4).
