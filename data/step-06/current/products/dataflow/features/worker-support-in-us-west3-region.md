...
feature_name: "Worker support in us-west3 region"
feature_slug: "worker-support-in-us-west3-region"
...
# Worker support in us-west3 region
...
Dataflow can run worker VMs in zones within the us-west3 region.
