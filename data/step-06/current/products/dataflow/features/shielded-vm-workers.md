...
feature_name: "Shielded VM workers"
feature_slug: "shielded-vm-workers"
...
- By default, the Cloud Dataflow service will cap the dynamic number of workers to a ceiling of 5 worker VMs.
- September 07, 2021 Feature Dataflow now supports Shielded VM workers .
...
Evidence snippets:
- Dataflow Shielded VM Starting on June 1, 2022, the Dataflow service uses Shielded VM for all workers.
- By running preemptible VMs and regular VMs in parallel, Dataflow improves the user experience if Compute Engine stops preemptible VM instances during a system event.
