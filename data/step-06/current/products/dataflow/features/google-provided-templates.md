...
- Template workflow Using Dataflow templates involves the following high-level steps: Developers set up a development environment and develop their pipeline.
...
- FROM gcr.io/dataflow-templates-base/python3-template-launcher-base Configure the Template to launch the pipeline with a --requirements file option.
