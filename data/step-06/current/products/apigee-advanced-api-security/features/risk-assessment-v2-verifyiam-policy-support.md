...
feature_name: "Risk Assessment v2 VerifyIAM policy support"
feature_slug: "risk-assessment-v2-verifyiam-policy-support"
...
# Risk Assessment v2 VerifyIAM policy support
...
Risk Assessment v2 now supports the VerifyIAM policy in assessments.
...
Evidence snippets:
- Assessment check / name Description Recommendation Auth policies check / auth-policies-check Check whether any of the following auth policies are enabled: AccessControl , BasicAuthentication , HMAC , OAuth , ValidateSAMLAssertion , VerifyAPIKey , VerifyIAM , VerifyJWS , or VerifyJWT policy.
