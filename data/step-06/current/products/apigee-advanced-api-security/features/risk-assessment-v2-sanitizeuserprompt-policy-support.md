...
- Assessment check / name Description Recommendation SanitizeUserPrompt policy check / sanitize-user-prompt-policy-check Check whether a SanitizeUserPrompt policy is in use.
