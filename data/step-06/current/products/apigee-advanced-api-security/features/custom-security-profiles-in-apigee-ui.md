...
generated_at: "2026-04-14T04:26:55.426Z"
product_name: "Apigee Advanced API Security"
product_slug: "apigee-advanced-api-security"
feature_name: "Custom security profiles in Apigee UI"
feature_slug: "custom-security-profiles-in-apigee-ui"
...
# Custom security profiles in Apigee UI
...
Customers can create and edit custom security profiles in the Apigee UI to define which security categories contribute to risk scoring.
...
- Manage custom security profiles in the Apigee UI This section shows how to view, create, edit, and delete custom security profiles using the Apigee UI.
- Create and edit custom security profiles On the Risk Assessment screen, select the Security Profiles tab.
- Delete custom security profiles To delete an existing custom security profile, select Delete from the Actions menu in the row for that profile or click the profile name from the profiles list to see the profile metadata, and then click Delete .
...
- API hub offers you the capability to manually create and manage custom plugins to connect to third party systems and gateways.
- Console To create a custom plugin, do the following: In the Google Cloud console, go to the API hub page.
- Create a custom plugin You can create a custom plugin using the Google Cloud console or the REST API.
