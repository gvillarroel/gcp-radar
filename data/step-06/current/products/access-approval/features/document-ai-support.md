...
generated_at: "2026-04-12T16:01:25.253Z"
product_name: "Access Approval"
product_slug: "access-approval"
feature_name: "Document AI support"
feature_slug: "document-ai-support"
...
Access Approval supports Document AI.
...
- Format is one of: "projects/{project}/serviceAccount" "folders/{folder}/serviceAccount" "organizations/{organization}/serviceAccount" accountEmail string Email address of the service account.
...
- Home Documentation Developer tools Python Client libraries Send feedback Class AccessApprovalClient (1.19.0) Stay organized with collections Save and categorize content based on your preferences.
