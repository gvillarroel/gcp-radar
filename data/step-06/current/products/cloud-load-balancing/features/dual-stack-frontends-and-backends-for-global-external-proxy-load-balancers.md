...
feature_name: "Dual-stack frontends and backends for global external proxy load balancers"
feature_slug: "dual-stack-frontends-and-backends-for-global-external-proxy-load-balancers"
...
- If the backend subnet's ipv6-access-type is set to EXTERNAL , you must use a different dual-stack or IPv6-only subnet with ipv6-access-type set to INTERNAL for the load balancer's internal forwarding rule.
