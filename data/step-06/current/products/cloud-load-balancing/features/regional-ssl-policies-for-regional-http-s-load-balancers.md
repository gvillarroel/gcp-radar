...
feature_name: "Regional SSL policies for regional HTTP(S) load balancers"
feature_slug: "regional-ssl-policies-for-regional-http-s-load-balancers"
...
- For load balancers that use HTTP/3 , the underlying transport protocol is QUIC, which uses TLS 1.3 exclusively.
