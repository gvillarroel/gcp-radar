...
feature_name: "Backend buckets for regional Application Load Balancers"
feature_slug: "backend-buckets-for-regional-application-load-balancers"
...
- Sample architecture In the following diagram, the external Application Load Balancer uses a URL map to direct traffic from specified URL paths to your backends.
- Home Documentation Networking Load Balancing Guides Send feedback Backend buckets overview Stay organized with collections Save and categorize content based on your preferences.
