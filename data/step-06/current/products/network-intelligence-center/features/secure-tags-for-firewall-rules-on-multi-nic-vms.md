...
generated_at: "2026-04-12T12:18:03.480Z"
product_name: "Network Intelligence Center"
product_slug: "network-intelligence-center"
feature_name: "Secure tags for firewall rules on multi-NIC VMs"
feature_slug: "secure-tags-for-firewall-rules-on-multi-nic-vms"
...
# Secure tags for firewall rules on multi-NIC VMs
...
Connectivity Tests can analyze firewall configurations that use secure tags on VM instances with multiple network interfaces.
...
- Connectivity Tests doesn't perform firewall connection tracking Connection tracking for VPC firewalls stores information about new and established connections and enables allowing or restricting subsequent traffic based on that information.
...
Evidence snippets:
- You can also use tags attached to Monitoring Points to apply policies quickly and consistently to multiple Monitoring Points.
- Monitoring policy groups : A container for multiple monitoring policies that targets a managed list of IPs or hostnames.
- Single monitoring policies : An individual set of rules for defining a specific monitoring scenario.
- For more information on tags, see Tagging - Best Practices in the AppNeta documentation.
