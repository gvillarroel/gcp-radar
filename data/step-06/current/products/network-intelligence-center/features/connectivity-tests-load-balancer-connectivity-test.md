...
feature_name: "Connectivity Tests load balancer connectivity test"
feature_slug: "connectivity-tests-load-balancer-connectivity-test"
...
# Connectivity Tests load balancer connectivity test
...
Connectivity Tests can verify connectivity from a VM or IP address to a load balancer.
...
- For information about how Connectivity Tests analyzes backends of a load balancer, see Number of traces in a test to a load balancer .
