...
generated_at: "2026-04-12T12:18:03.481Z"
product_name: "Network Intelligence Center"
product_slug: "network-intelligence-center"
feature_name: "Direct VPC egress for Cloud Run connectivity tests"
feature_slug: "direct-vpc-egress-for-cloud-run-connectivity-tests"
...
# Direct VPC egress for Cloud Run connectivity tests
...
Connectivity Tests can analyze serverless endpoints that use Direct VPC egress in Cloud Run.
...
- For example, if the executed query already includes the IP address details, you don't need to run the query with this field again and can't drill down using this field.
