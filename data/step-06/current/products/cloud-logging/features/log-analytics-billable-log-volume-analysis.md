...
Evidence snippets:
- June 26, 2024 Feature You can now analyze your billable log volume when using Log Analytics.
...
- September 27, 2022 Feature Using Log Analytics, you can run SQL queries that analyze your log data to generate useful insights.
- For more information, see Analyze log volume with Log Analytics .
