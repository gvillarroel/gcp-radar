...
feature_name: "RabbitMQ Log Collection in Ops Agent"
feature_slug: "rabbitmq-log-collection-in-ops-agent"
...
# RabbitMQ Log Collection in Ops Agent
...
Ops Agent can collect RabbitMQ logs for Cloud Logging.
