...
- The following ports, which don't need to be open externally, must be available to the agent on your VM: 20201 20202 Support policy The Ops Agent is supported according to the support time horizons policy .
