...
feature_slug: "firestore-managed-billing-report-label"
...
The `goog-firestoremanaged` billing report label lets you view costs for Firestore import and export operations.
