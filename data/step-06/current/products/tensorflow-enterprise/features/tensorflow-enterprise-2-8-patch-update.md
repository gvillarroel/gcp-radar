...
generated_at: "2026-04-12T12:19:15.741Z"
product_name: "Tensorflow Enterprise"
product_slug: "tensorflow-enterprise"
feature_name: "TensorFlow Enterprise 2.8 patch update"
feature_slug: "tensorflow-enterprise-2-8-patch-update"
...
source_links:
  ...
  - "https://docs.cloud.google.com/tensorflow-enterprise/docs/performance"
...
# TensorFlow Enterprise 2.8 patch update
...
TensorFlow Enterprise version 2.8 was updated to patch version 2.8.1.
...
- [https://docs.cloud.google.com/tensorflow-enterprise/docs/performance](https://docs.cloud.google.com/tensorflow-enterprise/docs/performance)
...
Evidence snippets:
- Version details Version Support time period Date of release Support end date TensorFlow Enterprise 2.11 One year December 15, 2022 December 14, 2023 TensorFlow Enterprise 2.10 One year September 20, 2022 September 19, 2023 TensorFlow Enterprise 2.9 One year May 16, 2022 May 15, 2023 TensorFlow Enterprise 2.8 (includes Long Term Version Support) Three years February 2, 2022 February 1, 2025 TensorFlow Enterprise 2.7 Unspecified November 4, 2021 Not applicable TensorFlow Enterprise 2.6 (includes Long Term Version Support) Three years August 11, 2021 August 10, 2024 TensorFlow Enterprise 2.5 Unspecified May 14, 2021 Not applicable TensorFlow Enterprise 2.3 (includes Long Term Version Support) Three years August 17, 2020 August 16, 2023 TensorFlow Enterprise 2.1 (includes Long Term Version Support) Three years January 8, 2020 January 7, 2023 TensorFlow Enterprise 1.15 (includes Long Term Version Support) Three years October 30, 2019 October 29, 2022 What's included in TensorFlow Enterprise The following packages are included in TensorFlow Enterprise.
...
- Create a Deep Learning VM instance To create a TensorFlow Enterprise Deep Learning VM instance, complete these steps: Go to the Deep Learning VM Cloud Marketplace page in the Google Cloud console.

### Performance \_|\_ TensorFlow Enterprise \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/tensorflow-enterprise/docs/performance](https://docs.cloud.google.com/tensorflow-enterprise/docs/performance)
- Source ID: `site-docs-reference`
- Final score: 169
- Re-rank relevance: N/A
...
Evidence snippets:
- Need to tell us more? [[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Hard to understand","hardToUnderstand","thumb-down"],["Incorrect information or sample code","incorrectInformationOrSampleCode","thumb-down"],["Missing the information/samples I need","missingTheInformationSamplesINeed","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-04-08 UTC."],[],[]]
- Although it caters to every user, those deploying it on Google Cloud can benefit from enterprise-grade support and performance from the creators of TensorFlow.
- TensorFlow Enterprise makes accessing data on Google Cloud faster and easier Send feedback Except as otherwise noted, the content of this page is licensed under the Creative Commons Attribution 4.0 License , and code samples are licensed under the Apache 2.0 License .
- Home Documentation AI and ML TensorFlow Enterprise Guides Send feedback Performance Stay organized with collections Save and categorize content based on your preferences.
