...
product_name: "Batch"
product_slug: "batch"
feature_name: "Batch Java code samples"
feature_slug: "batch-java-code-samples"
latest_feature_date: "2022-10-12"
deprecation_date: ""
coverage_status: "LOW"
source_links:
  - "https://docs.cloud.google.com/batch/docs/release-notes"
  - "https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy.Builder"
  - "https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy"
keywords:
  - "java"
  - "documentation"
  - "includes"
...
Batch documentation now includes Java language code samples, including examples for creating container/script jobs and listing, describing, and deleting jobs.
...
- [https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy.Builder](https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy.Builder)
- [https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy](https://docs.cloud.google.com/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.AllocationPolicy)
...
- The following samples are available in Java: Create and submit a job using a VM instance template Create and submit a job that uses a Cloud Storage bucket List tasks Describe a task View logs from Cloud Logging for a job For more information, see All Batch code samples .
