...
feature_name: "Full node management via API"
feature_slug: "full-node-management-via-api"
...
The service supports administration of full nodes through APIs.
...
The Blockchain Node Engine REST and RPC references directly document the node resource model, control-plane lifecycle operations, and endpoint metadata, while the IAM full resource names page documents the URI-style resource naming format used by Google APIs.
