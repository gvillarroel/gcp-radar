...
feature_name: "IAMPolicyMember service identity member source"
feature_slug: "iampolicymember-service-identity-member-source"
...
# IAMPolicyMember service identity member source
...
IAMPolicyMember supports sourcing a member from a ServiceIdentity reference through spec.memberFrom.serviceIdentityRef.
