...
feature_name: "ComputeSnapshot chain name support"
feature_slug: "computesnapshot-chain-name-support"
...
Config Connector supports the chainName field for ComputeSnapshot resources.
