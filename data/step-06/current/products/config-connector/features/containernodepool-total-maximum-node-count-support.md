...
feature_name: "ContainerNodePool total maximum node count support"
feature_slug: "containernodepool-total-maximum-node-count-support"
...
- Must be >=0 and autoscaling.totalMaxNodeCount Optional integer Maximum number of all nodes in the node pool.
