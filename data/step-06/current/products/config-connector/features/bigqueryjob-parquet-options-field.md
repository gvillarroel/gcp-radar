...
feature_name: "BigQueryJob parquet options field"
feature_slug: "bigqueryjob-parquet-options-field"
...
# BigQueryJob parquet options field
...
Config Connector now supports the parquetOptions field for BigQueryJob load jobs.
