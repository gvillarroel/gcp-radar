...
feature_name: "ContainerCluster FQDN network policy"
feature_slug: "containercluster-fqdn-network-policy"
...
# ContainerCluster FQDN network policy
...
Config Connector added the enableFqdnNetworkPolicy field to ContainerCluster.
