...
feature_name: "RedisInstance serverCaCerts status field"
feature_slug: "redisinstance-servercacerts-status-field"
...
# RedisInstance serverCaCerts status field
...
Config Connector exposes the serverCaCerts field in RedisInstance status.
