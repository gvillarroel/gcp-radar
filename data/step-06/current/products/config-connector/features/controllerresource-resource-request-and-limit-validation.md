...
feature_name: "ControllerResource resource request and limit validation"
feature_slug: "controllerresource-resource-request-and-limit-validation"
...
# ControllerResource resource request and limit validation
...
Config Connector added value validation for resource requests and limits in customizable ControllerResource CRDs.
...
- The rate limit controls how many requests Config Connector makes to the Kubernetes API server.
- The burst value allows for more requests than the qps limit for short periods.
