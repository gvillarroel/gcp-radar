...
feature_name: "ArtifactRegistryRepository docker configuration field"
feature_slug: "artifactregistryrepository-docker-configuration-field"
...
# ArtifactRegistryRepository docker configuration field
...
Config Connector now supports the dockerConfig field for the ArtifactRegistryRepository resource.
...
- The configuration for logging of each type of permission. auditConfigs[].auditLogConfigs[] Required object auditConfigs[].auditLogConfigs[].exemptedMembers Optional list (string) Identities that do not cause logging for this type of permission.
- The list of IAM audit configs. auditConfigs[] Optional object Specifies the Cloud Audit Logs configuration for the IAM policy. auditConfigs[].auditLogConfigs Required list (object) Required.
