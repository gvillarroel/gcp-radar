...
feature_name: "CRD server-side dry-run support"
feature_slug: "crd-server-side-dry-run-support"
...
Evidence snippets:
- Cause Your Kubernetes cluster does not have the CRD for the Foo resource kind installed.
...
Evidence snippets:
- For example, this link contains CRDs for version 1.89.0 .
