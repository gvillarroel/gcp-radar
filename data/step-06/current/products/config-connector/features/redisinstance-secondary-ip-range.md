...
feature_name: "RedisInstance secondary IP range"
feature_slug: "redisinstance-secondary-ip-range"
...
Config Connector supports the secondaryIpRange field for RedisInstance resources.
