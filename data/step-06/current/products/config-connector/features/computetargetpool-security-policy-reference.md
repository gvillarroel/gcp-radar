...
feature_name: "ComputeTargetPool security policy reference"
feature_slug: "computetargetpool-security-policy-reference"
...
# ComputeTargetPool security policy reference
...
Config Connector added the securityPolicyRef field to ComputeTargetPool.
