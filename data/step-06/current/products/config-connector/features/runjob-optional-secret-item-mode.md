...
feature_name: "RunJob optional secret item mode"
feature_slug: "runjob-optional-secret-item-mode"
...
# RunJob optional secret item mode
...
Config Connector made the secret items mode field optional in RunJob volumes.
