...
generated_at: "2026-04-10T19:56:38.596Z"
product_name: "Cloud Asset Inventory"
product_slug: "cloud-asset-inventory"
feature_name: "Cloud Asset Inventory ExportAssets/ListAssets/BatchGetAssetsHistory/QueryAssets/Feed/Search API support for netapp.googleapis.com/ActiveDirectory"
feature_slug: "cloud-asset-inventory-exportassets-listassets-batchgetassetshistory-queryassets-feed-search-api-support-for-netapp-googleapis-com-activedirectory"
...
# Cloud Asset Inventory ExportAssets/ListAssets/BatchGetAssetsHistory/QueryAssets/Feed/Search API support for netapp.googleapis.com/ActiveDirectory
...
Cloud Asset Inventory now makes the NetApp ActiveDirectory resource type publicly available through ExportAssets, ListAssets, BatchGetAssetsHistory, QueryAssets, Feed, and Search APIs.
...
- Returns Type Description google.cloud.asset v1.types.QueryAssetsResponse QueryAssets response. saved query path saved query path ( project : str , saved query : str ) - > str Returns a fully-qualified saved query string. search all iam policies search all iam policies ( request : typing .
