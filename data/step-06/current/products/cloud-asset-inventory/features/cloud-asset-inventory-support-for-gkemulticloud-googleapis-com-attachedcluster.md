...
generated_at: "2026-04-14T13:43:35.171Z"
product_name: "Cloud Asset Inventory"
product_slug: "cloud-asset-inventory"
feature_name: "Cloud Asset Inventory support for gkemulticloud.googleapis.com/AttachedCluster"
feature_slug: "cloud-asset-inventory-support-for-gkemulticloud-googleapis-com-attachedcluster"
...
source_links:
  ...
  - "https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.types"
keywords:
  - "attachedcluster"
  - "gkemulticloud"
  - "googleapis"
...
# Cloud Asset Inventory support for gkemulticloud.googleapis.com/AttachedCluster
...
Cloud Asset Inventory now makes the GKE Multicloud AttachedCluster resource type publicly available through its asset APIs.
...
- [https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.types](https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.types)
...
### Package types (4.2.0) \_|\_ Python client libraries \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.types](https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.types)
- Source ID: `site-python-reference`
- Final score: 58
- Re-rank relevance: N/A
