...
feature_name: "Google Cloud Marketplace Kubernetes applications"
feature_slug: "google-cloud-marketplace-kubernetes-applications"
latest_feature_date: "2019-04-09"
deprecation_date: ""
coverage_status: "MEDIUM"
source_links:
  - "https://docs.cloud.google.com/marketplace/docs/manage-billing"
  - "https://docs.cloud.google.com/marketplace/docs/container-images"
...
# Google Cloud Marketplace Kubernetes applications
...
Google Cloud Marketplace offers Kubernetes applications that can be deployed to GKE clusters; Google Cloud Marketplace offers Kubernetes applications that can be deployed to GKE clusters.
...
- [https://docs.cloud.google.com/marketplace/docs/container-images](https://docs.cloud.google.com/marketplace/docs/container-images)
...
Evidence snippets:
- If you're managing billing for a Kubernetes app within your organization: Ensure that all users who will deploy the product have the following IAM roles: Viewer ( roles/viewer ) for the project where a Kubernetes app will be deployed.
...
- If there are Cloud Marketplace resources that the project needs to run which haven't been purchased by the new Cloud Billing account that you selected, the Google Cloud console detects the discrepancy and displays a warning message as a reminder.
...
### "Deploying container images from Google Cloud Marketplace to Kubernetes or\

- URL: [https://docs.cloud.google.com/marketplace/docs/container-images](https://docs.cloud.google.com/marketplace/docs/container-images)
...
Evidence snippets:
- Verify that kubectl can connect to the clusters While Minikube is running (after running minikube start ), you can use the following command to check if your nodes are running: kubectl get nodes Follow the getting started documentation for the container in the Kubernetes section Each container product on Cloud Marketplace contains a getting started guide.
- You can run the following to see if your nodes are running: kubectl get nodes Follow the getting started documentation for the container in the Kubernetes section Each container product on Cloud Marketplace contains a getting started guide.
- Home Documentation Access and resource management Google Cloud Marketplace Guides Send feedback Deploying container images from Google Cloud Marketplace to Kubernetes or Docker Stay organized with collections Save and categorize content based on your preferences.
- Verify that kubectl can connect to the clusters After your environment is set up, verify kubectl can reach the clusters you created.
...
- Using custom roles with Cloud Marketplace If you want granular control over the permissions you grant users, you can create custom roles with the permissions that you want to grant.
...
- Cloud Marketplace links usage fees to an automatically-created Google Cloud project whose ID begins with pr , followed by a series of unique letters and numbers.
- For example, some vendors might charge by the number of containers that you run the app on and the number of API requests you make to the app.
