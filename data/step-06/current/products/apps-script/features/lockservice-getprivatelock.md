...
feature_name: "LockService.getPrivateLock"
feature_slug: "lockservice-getprivatelock"
...
LockService.getPrivateLock() was deprecated and replaced by LockService.getUserLock() and LockService.getScriptLock(); deprecated on 2014-09-04.
