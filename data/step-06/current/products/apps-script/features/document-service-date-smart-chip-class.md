...
feature_name: "Document Service Date smart chip class"
feature_slug: "document-service-date-smart-chip-class"
...
# Document Service Date smart chip class
...
Adds a Date smart chip class for representing formatted date chips in Google Docs.
...
- Page Summary outlined flag This document details how to update a deployment of an Apps Script project using a PUT request.
