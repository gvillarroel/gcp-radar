...
feature_name: "FormApp video item API"
feature_slug: "formapp-video-item-api"
...
Added Form.addVideoItem() to allow scripts to insert YouTube videos in forms.
