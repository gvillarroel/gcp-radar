...
feature_name: "ListItem.setNestingLevel() method"
feature_slug: "listitem-setnestinglevel-method"
...
# ListItem.setNestingLevel() method
...
ListItem gained setNestingLevel() to control the nesting depth of list items.
