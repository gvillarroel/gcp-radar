...
feature_name: "UiInstance.createAnchor mailto link support"
feature_slug: "uiinstance-createanchor-mailto-link-support"
...
# UiInstance.createAnchor mailto link support
...
Added support in UiInstance.createAnchor for links using the mailto URI scheme.
...
- These links let you deactivate the trigger or edit the script to fix the bug.
