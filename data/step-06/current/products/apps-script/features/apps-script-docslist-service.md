...
feature_name: "Apps Script DocsList service"
feature_slug: "apps-script-docslist-service"
latest_feature_date: "2015-04-23"
deprecation_date: "2015-04-23"
...
The DocsList service was sunset and is no longer functional, with DriveApp as the replacement; The DocsList service was deprecated, with deprecation scheduled for April 20, 2015; deprecated on 2015-04-23.
...
- Deprecated The DocsList service , which was deprecated in 2014 , has been sunset and no longer functions.
...
- Page Summary outlined flag This page provides details on how to list a script's executed processes, including their type and status.
...
- Page Summary outlined flag This page describes how to list the deployments of an Apps Script project using a GET HTTP request.
