...
feature_name: "Script Service everyMinutes() method"
feature_slug: "script-service-everyminutes-method"
...
# Script Service everyMinutes() method
...
The Script service added an everyMinutes() method to define minute-based trigger scheduling.
