...
feature_name: "FormApp custom closed-form message APIs"
feature_slug: "formapp-custom-closed-form-message-apis"
...
# FormApp custom closed-form message APIs
...
Added Form.getCustomClosedFormMessage() and Form.setCustomClosedFormMessage(message) to manage custom messages shown after form submission.
...
- The custom function can be used by entering =FACT CHECK("Your statement here") in a Google Sheet cell, with an optional second argument for specific output formatting.
