...
feature_name: "RichTextValue.getLinkUrl"
feature_slug: "richtextvalue-getlinkurl"
...
Adds RichTextValue.getLinkUrl() to retrieve the URL linked to a rich text value.
