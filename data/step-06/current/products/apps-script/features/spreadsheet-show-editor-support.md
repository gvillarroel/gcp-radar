...
feature_name: "Spreadsheet.show editor support"
feature_slug: "spreadsheet-show-editor-support"
...
# Spreadsheet.show editor support
...
Added Spreadsheet.show() to script editor autocomplete and documentation.
...
Evidence snippets:
- August 16, 2010 Feature Added Spreadsheet.show() to the script editor autocomplete and the documentation.
