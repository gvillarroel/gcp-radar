...
feature_name: "GmailAttachment class"
feature_slug: "gmailattachment-class"
...
Apps Script introduced the GmailAttachment class, a Blob-like object with a getSize() method that is not subject to quota limits.
