...
feature_name: "Folder.createShortcut"
feature_slug: "folder-createshortcut"
...
Adds Folder.createShortcut(targetId) to create shortcut files from Drive item IDs.
...
- Response body If successful, the response body contains a newly created instance of Deployment .
