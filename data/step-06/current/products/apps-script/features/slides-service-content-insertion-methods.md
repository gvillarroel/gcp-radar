...
feature_name: "Slides service content insertion methods"
feature_slug: "slides-service-content-insertion-methods"
...
# Slides service content insertion methods
...
Added insertion APIs across Slides classes (Layout, Master, Page, Presentation, Slide, and TextRange) to add groups, media, shapes, tables, charts, and text range content from scripts.
