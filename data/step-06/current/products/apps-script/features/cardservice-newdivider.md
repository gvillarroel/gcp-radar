...
feature_name: "CardService.newDivider"
feature_slug: "cardservice-newdivider"
...
Adds the newDivider() method to the Card service for adding divider widgets in Google Workspace add-on cards.
...
- To add a divider to an add-on card, use the newDivider() method within the Card service .
