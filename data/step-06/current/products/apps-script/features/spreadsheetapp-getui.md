...
feature_name: "SpreadsheetApp.getUi"
feature_slug: "spreadsheetapp-getui"
...
Added SpreadsheetApp.getUi() to access the spreadsheet UI for adding menus, dialogs, and sidebars in the new Sheets version.
