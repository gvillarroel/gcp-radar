...
feature_name: "FormApp.setShuffleQuestions"
feature_slug: "formapp-setshufflequestions"
...
Added Form.setShuffleQuestions(shuffle) to enable or disable randomized question ordering on each form page.
