...
feature_name: "Apps Script Charts embedded chart support"
feature_slug: "apps-script-charts-embedded-chart-support"
...
# Apps Script Charts embedded chart support
...
Extended the Charts service to support embedded charts in Google Sheets and added new chart types including timeline, bubble, candlestick, gauge, geo, radar, sparkline, stepped area, treemap, and waterfall.
