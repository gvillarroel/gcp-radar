...
feature_name: "Apps Script Blob class"
feature_slug: "apps-script-blob-class"
...
Introduced a new Blob class to simplify data movement across Apps Script services.
