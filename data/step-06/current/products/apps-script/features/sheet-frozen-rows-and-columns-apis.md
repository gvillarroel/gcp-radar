...
feature_name: "Sheet frozen rows and columns APIs"
feature_slug: "sheet-frozen-rows-and-columns-apis"
...
# Sheet frozen rows and columns APIs
...
Added Sheet.getFrozenRows() and Sheet.getFrozenColumns() methods.
