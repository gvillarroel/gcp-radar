...
feature_name: "Spreadsheet service Sheet tab color methods"
feature_slug: "spreadsheet-service-sheet-tab-color-methods"
...
# Spreadsheet service Sheet tab color methods
...
Adds methods on Sheet to get and set tab colors with Color objects.
