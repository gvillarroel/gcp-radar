...
feature_name: "Spreadsheet.deleteSheet method"
feature_slug: "spreadsheet-deletesheet-method"
...
# Spreadsheet.deleteSheet method
...
Adds Spreadsheet.deleteSheet(sheet), enabling scripts to delete sheets that are not the active sheet.
...
- When a spreadsheet is copied, any scripts attached to it are copied as well.
...
- April 01, 2013 Feature Issue 995 : The new methods Sheet.hideSheet() , Sheet.isSheetHidden() , and Sheet.showSheet() allow scripts to control the visibility of individual sheets within a spreadsheet.
