...
feature_name: "LinkPreview class in Apps Script Card Service"
feature_slug: "linkpreview-class-in-apps-script-card-service"
...
# LinkPreview class in Apps Script Card Service
...
The LinkPreview class is added to Apps Script Card Service for controlling link preview card metadata.
...
- March 05, 2024 Feature (Generally Available) : The LinkPreview class has been added to the Apps Script Card service.
