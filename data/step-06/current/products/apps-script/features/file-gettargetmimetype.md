...
feature_name: "File.getTargetMimeType"
feature_slug: "file-gettargetmimetype"
...
Adds File.getTargetMimeType() to return the MIME type of the item a shortcut references.
