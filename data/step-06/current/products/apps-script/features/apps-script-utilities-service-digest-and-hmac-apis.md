...
feature_name: "Apps Script Utilities service: Digest and HMAC APIs"
feature_slug: "apps-script-utilities-service-digest-and-hmac-apis"
...
# Apps Script Utilities service: Digest and HMAC APIs
...
Utilities added digest and HMAC/hash signature methods for byte-array inputs with configurable algorithms.
