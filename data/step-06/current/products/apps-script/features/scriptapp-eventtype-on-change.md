...
Added the ON_CHANGE value to ScriptApp.EventType so Google Sheets change events can be detected.
...
- JSON representation { "result" : value } Fields result value ( Value format) The return value of the script function.
...
Evidence snippets:
- Otherwise, the custom function doesn't recalculate until you edit the function, or you change the value of a referenced cell.
