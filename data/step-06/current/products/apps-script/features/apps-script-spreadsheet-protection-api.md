...
feature_name: "Apps Script Spreadsheet Protection API"
feature_slug: "apps-script-spreadsheet-protection-api"
...
# Apps Script Spreadsheet Protection API
...
Apps Script added a new Spreadsheet protection model with Protection, ProtectionType, and related range/sheet protection methods such as protect() and getProtections().
...
- The BigQuery service lets you use the Google BigQuery API in Google Apps Script.
