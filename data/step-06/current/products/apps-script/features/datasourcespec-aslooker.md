...
feature_name: "DataSourceSpec.asLooker()"
feature_slug: "datasourcespec-aslooker"
...
The DataSourceSpec.asLooker() method is added to produce Looker-based data source specifications.
