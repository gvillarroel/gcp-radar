...
feature_name: "Apps Script Data Studio dynamic connector response APIs"
feature_slug: "apps-script-data-studio-dynamic-connector-response-apis"
...
# Apps Script Data Studio dynamic connector response APIs
...
Data Studio connectors gained dynamic response and control capability through new response classes and dynamic flags on input/config components.
...
- Home Google Workspace Apps Script Reference Send feedback ExecuteStreamResponse Stay organized with collections Save and categorize content based on your preferences.
