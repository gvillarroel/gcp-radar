...
feature_name: "Apps Script Google Analytics Management API advanced service"
feature_slug: "apps-script-google-analytics-management-api-advanced-service"
...
# Apps Script Google Analytics Management API advanced service
...
The Apps Script Advanced Service for Google Analytics Management API is deprecated and replaced by the Google Analytics Data API Advanced Service; deprecated on 2025-06-04.
