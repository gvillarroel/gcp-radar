...
feature_name: "Apps Script Chrome Web Store custom web app icon"
feature_slug: "apps-script-chrome-web-store-custom-web-app-icon"
...
# Apps Script Chrome Web Store custom web app icon
...
Apps Script web apps published to the Chrome Web Store can now be assigned a custom app icon shown on Chrome’s New Tab Page.
