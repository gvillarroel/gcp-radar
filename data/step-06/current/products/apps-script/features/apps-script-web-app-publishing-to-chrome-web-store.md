...
feature_name: "Apps Script web app publishing to Chrome Web Store"
feature_slug: "apps-script-web-app-publishing-to-chrome-web-store"
...
# Apps Script web app publishing to Chrome Web Store
...
Publishing Apps Script web apps to the Chrome Web Store was discontinued and previously published web apps are no longer discoverable there; deprecated on 2019-10-28.
