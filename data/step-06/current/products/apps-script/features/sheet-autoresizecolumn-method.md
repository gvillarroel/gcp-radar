...
feature_name: "Sheet.autoResizeColumn method"
feature_slug: "sheet-autoresizecolumn-method"
...
Adds autoResizeColumn() to Sheet for automatically resizing a column to fit its contents.
...
- Issue 3539 : In the new version of Sheets, the Range methods setValue and setValues now automatically detect when a value should be set as a formula.
