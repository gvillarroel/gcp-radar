...
feature_name: "LockService.getDocumentLock"
feature_slug: "lockservice-getdocumentlock"
...
Added LockService.getDocumentLock() to provide document-level locking for all users in an add-on context.
