...
feature_name: "Apps Script Card service widgets and event response builders"
feature_slug: "apps-script-card-service-widgets-and-event-response-builders"
...
# Apps Script Card service widgets and event response builders
...
The Card service added new widget and event-response classes and builder methods, including calendar, drive item, time/date picker, and fixed-footer APIs.
