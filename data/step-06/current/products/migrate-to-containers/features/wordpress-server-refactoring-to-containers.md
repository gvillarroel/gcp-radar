...
generated_at: "2026-04-14T15:21:10.793Z"
product_name: "Migrate to Containers"
product_slug: "migrate-to-containers"
feature_name: "WordPress server refactoring to containers"
feature_slug: "wordpress-server-refactoring-to-containers"
...
# WordPress server refactoring to containers
...
WordPress servers running on Apache 2 Linux can be refactored into containers deployed on GKE, GKE Autopilot, Anthos, and Cloud Run.
...
- It is also possible to configure the loglevel for particular modules, e.g. #LogLevel info ssl:warn ErrorLog $ { APACHE LOG DIR } / error . log CustomLog $ { APACHE LOG DIR } / access . log combined For most configuration files from conf-available/, which are enabled or disabled at a global level, it is possible to include a line for only one particular virtual host.
