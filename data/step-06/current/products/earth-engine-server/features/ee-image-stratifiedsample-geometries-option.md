...
generated_at: "2026-04-11T11:22:38.421Z"
product_name: "Earth Engine Server"
product_slug: "earth-engine-server"
feature_name: "ee.Image.stratifiedSample() geometries option"
feature_slug: "ee-image-stratifiedsample-geometries-option"
...
# ee.Image.stratifiedSample() geometries option
...
- Configuration parameters Observe that the dictionary of configuration parameters passed to Export.image includes scale (in meters) and the export region as an ee.Geometry .
