...
generated_at: "2026-04-10T05:27:06.478Z"
product_name: "Database Center"
product_slug: "database-center"
feature_name: "Memorystore support"
feature_slug: "memorystore-support"
...
Database Center supports viewing and analyzing Memorystore resources in fleet inventory.
...
### Learn about Database Center using Gemini | Google Cloud Documentation
...
- Learn about Database Center using Gemini Google Cloud Documentation Source URL: https://docs.cloud.google.com/database-center/docs/learn-database-products-using-gemini A database fleet consists of all the provisioned database resources across all Google Cloud database products that your organization uses.
- Database resources are the clusters, instances, and virtual machines that power your workloads.
