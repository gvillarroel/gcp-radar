...
feature_name: "Cloud SQL enhanced backup protection monitoring"
feature_slug: "cloud-sql-enhanced-backup-protection-monitoring"
...
# Cloud SQL enhanced backup protection monitoring
...
Database Center can monitor Cloud SQL resources for enhanced backup protection from Backup and DR Service.
...
- Use enhanced backup protection Use enhanced protection to back up your Cloud SQL databases.
...
- To learn how to configure enhanced backups for Cloud SQL resources, see Enhanced backups .
...
- You can follow the same procedure for the other Database Center metric types.
...
- Availability For example, to identify database resources, you can enter the following prompt: Which of my Cloud SQL databases are located in us-east1?
