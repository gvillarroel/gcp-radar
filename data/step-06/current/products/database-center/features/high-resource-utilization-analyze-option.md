...
feature_name: "High resource utilization analyze option"
feature_slug: "high-resource-utilization-analyze-option"
...
- Note: Health issues marked with an (E+) in the following table require the Cloud SQL Enterprise edition or higher to monitor those issues using the Database Center.
...
Evidence snippets:
- You can view a list of your database resources to identify which are most highly utilized for different metrics, such as CPU utilization and storage used.
...
- The resource with the highest utilization is at the top.
