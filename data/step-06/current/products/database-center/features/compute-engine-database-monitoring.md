...
feature_name: "Compute Engine database monitoring"
feature_slug: "compute-engine-database-monitoring"
latest_feature_date: "2025-08-05"
deprecation_date: ""
coverage_status: "MEDIUM"
source_links:
  - "https://docs.cloud.google.com/database-center/docs/monitor-gce-databases"
...
# Compute Engine database monitoring
...
Database Center can monitor databases running on Google Compute Engine virtual machines.
...
- [https://docs.cloud.google.com/database-center/docs/overview](https://docs.cloud.google.com/database-center/docs/overview)

## Supporting Pages

### "Monitor databases on Compute Engine virtual machines \_|\_ Database Center\

- URL: [https://docs.cloud.google.com/database-center/docs/monitor-gce-databases](https://docs.cloud.google.com/database-center/docs/monitor-gce-databases)
...
Evidence snippets:
- Home Documentation Databases Database Center Guides Send feedback Monitor databases on Compute Engine virtual machines Stay organized with collections Save and categorize content based on your preferences.
- Database Center supports the following databases on Compute Engine VMs: MySQL PostgreSQL Microsoft SQL Server Health issues for databases on Compute Engine VMs The following health issues are supported for databases on a Compute Engine VM: Health issue MySQL PostgreSQL SQL Server Outdated minor version for patch ✔ ✔ ✔ Exposed to broad access ✔ ✔ ✔ Unencrypted connections ✔ ✔ ✔ Auditing not enabled ✔ ✔ ✔ No root password ✔ ✔ Send feedback Except as otherwise noted, the content of this page is licensed under the Creative Commons Attribution 4.0 License , and code samples are licensed under the Apache 2.0 License .
- Database Center also displays health issues and recommendations for self-managed databases that you run on Compute Engine virtual machines (VMs).
- Database Center provides a centralized view across your fleet of Google Cloud databases.
...
- You can customize which databases and health issues Database Center displays.
...
### Database Center overview \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/database-center/docs/overview](https://docs.cloud.google.com/database-center/docs/overview)
- Source ID: `site-docs-root`
- Final score: 227
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- Database Center supports health issues for the following Google Cloud database products: AlloyDB for PostgreSQL Bigtable Cloud SQL for MySQL Cloud SQL for PostgreSQL Cloud SQL for SQL Server Firestore Memorystore MySQL running on a Compute Engine (VM) ( Preview ) Oracle Database@Google Cloud ( Preview ) PostgreSQL running on a Compute Engine (VM) ( Preview ) Spanner SQL Server running on a Compute Engine virtual machine (VM) ( Preview ) Gemini chat is available in Database Center to respond to your questions about database fleet health, giving you customized recommendations based on your Google Cloud projects, and helping you identify and implement the right policies for your database fleets.
- For example, database platform teams can use Database Center to identify compliance risks and enforce best practices, while site reliability engineers can use Database Center to help ensure that their database resources are protected against downtime.
- Types of health issues that you can monitor You can use Database Center to determine the following about your database fleet's health: Your overall Google Cloud database footprint.
- Home Documentation Databases Database Center Guides Send feedback Database Center overview Stay organized with collections Save and categorize content based on your preferences.
