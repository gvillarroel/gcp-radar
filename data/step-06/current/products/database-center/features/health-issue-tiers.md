...
feature_name: "Health issue tiers"
feature_slug: "health-issue-tiers"
...
- Filter the database health issues so the database issues you want to see are visible in the Database Center dashboard.
