...
feature_name: "Cloud Armor preconfigured WAF rules with ModSecurity CRS 3.3"
feature_slug: "cloud-armor-preconfigured-waf-rules-with-modsecurity-crs-3-3"
...
# Cloud Armor preconfigured WAF rules with ModSecurity CRS 3.3
...
Cloud Armor preconfigured WAF rules added ModSecurity Core Rule Set (CRS) 3.3 in public preview.
...
- After the potential attack subsides and traffic patterns go back to the original baseline, either because the attack concluded or you blocked it with the appropriate Cloud Armor rules, Adaptive Protection alerts on future traffic behaviors that are considered departures from the baseline.
- If you are migrating from an older CRS version, see the WAF rules version comparison for a list of rule changes and renames.
