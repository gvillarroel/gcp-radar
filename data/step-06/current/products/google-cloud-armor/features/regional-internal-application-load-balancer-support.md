...
feature_name: "Regional internal Application Load Balancer support"
feature_slug: "regional-internal-application-load-balancer-support"
...
# Regional internal Application Load Balancer support
...
Cloud Armor can protect regional internal Application Load Balancers using regional backend security policies.
...
- Note: Regional internal Application Load Balancer backends are counted as protected resources only if a security policy is attached.
...
- Security policies Use Cloud Armor security policies to protect applications running behind a load balancer from distributed denial-of-service (DDoS) and other web-based attacks, whether the applications are deployed on Google Cloud, in a hybrid deployment, or in a multi-cloud architecture.
