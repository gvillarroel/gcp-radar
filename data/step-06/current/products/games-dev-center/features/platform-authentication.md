...
generated_at: "2026-04-12T12:16:03.762Z"
product_name: "Games Dev Center"
product_slug: "games-dev-center"
feature_name: "Platform authentication"
feature_slug: "platform-authentication"
...
Play Games Services v2 adds platform authentication support.
...
Evidence snippets:
- As the primary method for platform authentication, Play Games Services links to the full range of features if you follow program guidelines.
- Importance of Play Games Services to the Platform: Play Games Services v2 operates as a platform connector.
- Get Started Key capabilities of the Play Games platform Integrating Play Games Services unlocks platform capabilities that improve user retention and cross-platform continuity.
...
- URL: [https://developers.google.com/games/services](https://developers.google.com/games/services)
...
- REST Resource: players Methods get GET /games/v1/players/{playerId} Retrieves the Player resource with the given ID. getMultipleApplicationPlayerIds GET /games/v1/players/me/multipleApplicationPlayerIds Get the application player ids for the currently authenticated player across all requested games by the same developer as the calling application. getScopedPlayerIds GET /games/v1/players/me/scopedIds Retrieves scoped player identifiers for currently authenticated user. list GET /games/v1/players/me/players/{collection} Get the collection of players for the currently authenticated user.
