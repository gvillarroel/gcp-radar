...
feature_slug: "cloud-run-remote-functions-for-spanner-googlesql-queries"
...
Spanner can call user-defined remote functions hosted on Cloud Run directly from GoogleSQL queries.
