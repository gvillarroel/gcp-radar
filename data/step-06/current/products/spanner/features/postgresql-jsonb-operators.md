...
feature_name: "PostgreSQL JSONB operators"
feature_slug: "postgresql-jsonb-operators"
...
Spanner adds PostgreSQL JSONB operators, including concat (jsonb || jsonb) and delete (jsonb - text).
