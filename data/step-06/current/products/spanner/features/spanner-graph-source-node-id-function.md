...
feature_name: "Spanner Graph SOURCE_NODE_ID() function"
feature_slug: "spanner-graph-source-node-id-function"
...
# Spanner Graph SOURCE_NODE_ID() function
...
Adds the Spanner Graph SOURCE_NODE_ID() function, which returns the unique identifier of a graph edge's source node.
