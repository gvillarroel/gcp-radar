...
feature_slug: "googlesql-json-keys-function"
...
The GoogleSQL JSON_KEYS function is generally available in Spanner and returns the unique keys from a JSON expression.
