...
feature_name: "BigQuery external dataset integration with Spanner"
feature_slug: "bigquery-external-dataset-integration-with-spanner"
...
# BigQuery external dataset integration with Spanner
...
Spanner adds the ability to create BigQuery external datasets linked to existing Spanner databases, and the feature is available in Preview.
