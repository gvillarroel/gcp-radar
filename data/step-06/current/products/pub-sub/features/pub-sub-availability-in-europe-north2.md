...
feature_name: "Pub/Sub availability in europe-north2"
feature_slug: "pub-sub-availability-in-europe-north2"
...
# Pub/Sub availability in europe-north2
...
Pub/Sub is available in the europe-north2 region.
...
Evidence snippets:
- Pub/Sub is unavailable in Europe Although rare, you may also want to deal with cases where Pub/Sub itself is unavailable.
- Pub/Sub is unavailable in Europe.
- Therefore, the subscribers in the region in Australia can stop receiving messages if the subscribers in Europe have enough capacity to handle all of the messages published in the United States.
