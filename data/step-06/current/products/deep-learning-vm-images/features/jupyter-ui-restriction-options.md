...
generated_at: "2026-04-15T00:52:27.199Z"
product_name: "Deep Learning VM Images"
product_slug: "deep-learning-vm-images"
feature_name: "Jupyter UI restriction options"
feature_slug: "jupyter-ui-restriction-options"
...
# Jupyter UI restriction options
...
Deep Learning VM instances now support Jupyter options for disabling terminals and permanently deleting files instead of sending them to trash.
...
- Go to the VM Instances page Select the checkbox next to the Deep Learning VM instance.
- Go to the VM Instances page Select the checkbox next to the Deep Learning VM instance.
