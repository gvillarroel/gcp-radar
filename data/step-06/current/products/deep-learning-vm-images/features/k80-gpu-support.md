...
generated_at: "2026-04-15T00:52:27.191Z"
product_name: "Deep Learning VM Images"
product_slug: "deep-learning-vm-images"
feature_name: "K80 GPU support"
feature_slug: "k80-gpu-support"
latest_feature_date: "2022-08-12"
deprecation_date: "2022-08-12"
...
K80 GPUs are no longer supported with the latest NVIDIA driver in Deep Learning VM Images; deprecated on 2022-08-12.
...
- For details, see GPUs on Compute Engine . --metadata is used to specify that the NVIDIA driver should be installed on your behalf.
...
- For details, see GPU regions and zones availability . --metadata is used to specify that the NVIDIA driver should be installed on your behalf.
