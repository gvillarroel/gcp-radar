...
generated_at: "2026-04-15T00:52:27.204Z"
product_name: "Deep Learning VM Images"
product_slug: "deep-learning-vm-images"
feature_name: "Installed Python package manifests"
feature_slug: "installed-python-package-manifests"
...
Each image now publishes its installed Python package list in files stored on Cloud Storage.
...
- For example, an image from the family pytorch-2-9-cu129-ubuntu-2204-nvidia-580 has PyTorch 2.9, CUDA 12.9, and the OS is Ubuntu 22.04 with NVIDIA driver 580 pre-installed.
