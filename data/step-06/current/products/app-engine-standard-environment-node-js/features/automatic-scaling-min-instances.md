...
feature_name: "Automatic scaling min instances"
feature_slug: "automatic-scaling-min-instances"
...
Automatic scaling can keep a minimum number of application instances running.
