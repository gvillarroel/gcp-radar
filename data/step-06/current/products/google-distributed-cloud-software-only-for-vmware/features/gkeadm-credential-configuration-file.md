...
generated_at: "2026-04-14T16:48:38.231Z"
product_name: "Google Distributed Cloud (software only) for VMware"
product_slug: "google-distributed-cloud-software-only-for-vmware"
feature_name: "gkeadm credential configuration file"
feature_slug: "gkeadm-credential-configuration-file"
...
# gkeadm credential configuration file
...
Gkeadm can generate and use a credential configuration file to remove credentials from admin-ws-config.yaml.
...
These pages confirm `gkeadm` creates admin-related configuration files and show credential fields in those configs, but provide limited direct evidence for a dedicated credential file workflow that externalizes credentials from `admin-ws-config.yaml`.
...
- This enables advanced clusters, which is required to set up topolog domains. infraConfigFilePath Add the full path to the vSphere infrastructure configuration file in the infraConfigFilePath field. vCenter Remove this entire section.
