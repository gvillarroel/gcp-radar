...
generated_at: "2026-04-14T16:48:38.120Z"
product_name: "Google Distributed Cloud (software only) for VMware"
product_slug: "google-distributed-cloud-software-only-for-vmware"
feature_name: "Anthos clusters on VMware 1.12.7-gke.20"
feature_slug: "anthos-clusters-on-vmware-1-12-7-gke-20"
...
# Anthos clusters on VMware 1.12.7-gke.20
...
Anthos clusters on VMware version 1.12.7-gke.20 is available and runs on Kubernetes 1.23.17-gke.900.

## Extended Definition

Anthos clusters on VMware versioned releases are managed via Google Distributed Cloud (software-only) for VMware by creating or upgrading user clusters with a specified version string through `gcloud container vmware clusters` commands and Terraform resources. This feature is constrained by version availability on the admin cluster: available versions are listed with `gcloud container vmware clusters query-version-config`, and a chosen Anthos version must be made available on the admin cluster before user cluster creation or upgrade. The provided excerpts do not explicitly confirm the specific release `1.12.7-gke.20` or its Kubernetes base version (`1.23.17-gke.900`).

## Evidence Summary

The cited pages document how to create and upgrade VMware user clusters, including querying supported versions and ensuring versions are staged on the admin cluster, and note that Anthos on Google Distributed Cloud is software-only on VMware/bare metal with versioned documentation.
