...
generated_at: "2026-04-14T16:48:38.153Z"
product_name: "Google Distributed Cloud (software only) for VMware"
product_slug: "google-distributed-cloud-software-only-for-vmware"
feature_name: "Anthos clusters on VMware 1.12.0-gke.446"
feature_slug: "anthos-clusters-on-vmware-1-12-0-gke-446"
...
# Anthos clusters on VMware 1.12.0-gke.446
...
Anthos clusters on VMware version 1.12.0-gke.446 is available and runs on Kubernetes 1.23.5-gke.1504.

## Extended Definition

In Google Distributed Cloud (software only) for VMware, Anthos clusters are created and upgraded using explicit version strings (for example, `1.34.200-gke.68`, `1.16.3-gke.45`) selected from supported versions. Operators can retrieve supported versions with `gcloud container vmware clusters query-version-config`, and an Anthos version must first be made available on the admin cluster before a user cluster can be created or upgraded. The provided excerpts do not explicitly show support for the specific release `1.12.0-gke.446` or a Kubernetes mapping to `1.23.5-gke.1504`; they only show other sample versions.

## Evidence Summary

The cited pages define version-driven cluster lifecycle behavior for Anthos clusters on VMware, including querying available versions and the requirement to stage versions on the admin cluster before user-cluster creation or upgrade.
