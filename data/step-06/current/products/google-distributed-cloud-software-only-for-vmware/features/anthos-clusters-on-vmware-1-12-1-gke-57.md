...
generated_at: "2026-04-14T16:48:38.148Z"
product_name: "Google Distributed Cloud (software only) for VMware"
product_slug: "google-distributed-cloud-software-only-for-vmware"
feature_name: "Anthos clusters on VMware 1.12.1-gke.57"
feature_slug: "anthos-clusters-on-vmware-1-12-1-gke-57"
...
# Anthos clusters on VMware 1.12.1-gke.57
...
Anthos clusters on VMware version 1.12.1-gke.57 is available and runs on Kubernetes 1.23.5-gke.1505.

## Extended Definition

Anthos clusters on VMware 1.12.1-gke.57 is a specific published Google Distributed Cloud (software only) for VMware release, associated in the release notes with Kubernetes version 1.23.5-gke.1505. For lifecycle operations, this version can be selected via the normal cluster-version workflows: `gcloud container vmware clusters query-version-config` is used to retrieve available versions, and the target Anthos version must be present on the admin cluster before creating or upgrading a user cluster.

## Evidence Summary

The release-notes page explicitly states this release and its Kubernetes base version, while the create/upgrade pages provide the version discovery (`query-version-config`) and admin-cluster-preparation requirements used for creating or upgrading user clusters.
