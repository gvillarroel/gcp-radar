...
generated_at: "2026-04-14T15:27:30.666Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Qatar Regions control package"
feature_slug: "qatar-regions-control-package"
...
The Qatar Regions control package supports Cloud Build, Cloud SQL for PostgreSQL, Cloud Workstations, Document AI, Firebase Security Rules, Cloud OS Login API, Storage Transfer Service, and Google Security Operations SOAR.
...
- The following additional information applies to Qatar Data Boundary: Data residency : The Qatar Data Boundary control package sets data location controls to support Qatar-only regions .
...
- Google Cloud NetApp Volumes Affected Google Cloud NetApp Volumes features Feature Description Supported service levels Qatar Data Boundary supports the following service levels: Standard Premium Extreme Flex, for the File type only.
...
- Free Qatar Data Boundary The Qatar Data Boundary control package sets data location controls to support Qatar-only regions .
