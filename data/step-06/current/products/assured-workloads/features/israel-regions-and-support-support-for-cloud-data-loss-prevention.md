...
generated_at: "2026-04-14T15:27:30.775Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Israel Regions and Support support for Cloud Data Loss Prevention"
feature_slug: "israel-regions-and-support-support-for-cloud-data-loss-prevention"
...
# Israel Regions and Support support for Cloud Data Loss Prevention
...
The Israel Regions and Support compliance program supports Cloud Data Loss Prevention in Assured Workloads.
...
- Free Israel Data Boundary and Support The Israel Data Boundary and Support control package sets data location controls to support Israel-only regions .
...
- Google Cloud NetApp Volumes Affected Google Cloud NetApp Volumes features Feature Description Supported service levels Israel Data Boundary supports the following service levels: Standard Premium Extreme Flex, for the File type only.
...
- You should disable your default logging buckets or restrict default buckets to in-scope regions to maintain compliance using the following command: gcloud alpha logging settings update --organization=ORGANIZATION ID --disable-default-sink For more information, see Regionalize your logs .
- Google Cloud NetApp Volumes Affected Google Cloud NetApp Volumes features Feature Description Supported service levels Israel Data Boundary and Support supports the following service levels: Standard Premium Extreme Flex, for the File type only.
