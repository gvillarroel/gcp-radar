...
generated_at: "2026-04-14T15:27:30.610Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Hong Kong Data Boundary control package"
feature_slug: "hong-kong-data-boundary-control-package"
...
source_links:
  ...
  - "https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-regions"
...
The Hong Kong Data Boundary control package supports Binary Authorization, Cloud Asset Inventory, Database Center, Text-to-Speech, Vertex AI Batch prediction, Vertex AI Model Monitoring, Vertex AI Model Registry, Vertex AI Online prediction, Vertex AI Pipelines, Vertex AI Training, and Web Risk.
...
- [https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-regions](https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-regions)
...
- Pricing : The Hong Kong Data Boundary control package is included in Assured Workloads' Free tier , which incurs no additional charges.
- Google Cloud NetApp Volumes Affected Google Cloud NetApp Volumes features Feature Description Supported service levels Hong Kong Data Boundary supports the following service levels: Standard Premium Extreme Flex, for the File type only.

### Hong Kong Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-regions](https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-regions)
...
Evidence snippets:
- Premium Hong Kong Data Boundary The Hong Kong Data Boundary control package sets data location controls to support Hong Kong-only regions .
