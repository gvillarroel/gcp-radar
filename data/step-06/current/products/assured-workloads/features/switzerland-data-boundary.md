...
generated_at: "2026-04-14T15:27:30.582Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Switzerland data boundary"
feature_slug: "switzerland-data-boundary"
...
An Assured Workloads data boundary for Switzerland; An Assured Workloads data boundary for Switzerland.
...
- Support : Technical support services for Switzerland Data Boundary workloads are available with Standard, Enhanced, or Premium Cloud Customer Care subscriptions.
- It is your responsibility not to use BigQuery Data Transfer Service connectors for Switzerland Data Boundary workloads.
...
- After completing the steps above, Assured Workloads creates the following resources: An Assured Workloads folder, which enforces security controls on supported Google Cloud products to adhere with the Switzerland Data Boundary control package.
- Before you begin If you haven't already, you must complete the following below to create an Assured Workloads folder for the Switzerland Data Boundary control package : Ensure that you understand Assured Workloads concepts .
- Use your new Assured Workloads folder To start using your Assured Workloads folder, it's important that you put the resources that you want to be compliant with Switzerland Data Boundary in the new folder.
