...
generated_at: "2026-04-10T18:11:44.429Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Assured Workloads CJIS program support for Google Workspace Admin Console"
feature_slug: "assured-workloads-cjis-program-support-for-google-workspace-admin-console"
...
# Assured Workloads CJIS program support for Google Workspace Admin Console
...
Assured Workloads adds support for Google Workspace Admin Console under the CJIS compliance program.
...
Evidence snippets:
- Create an Assured Workloads folder for Data Boundary for CJIS In the Google Cloud console, go to the Assured Workloads page.
...
- After completing the steps above, Assured Workloads creates the following resources: An Assured Workloads folder, which enforces security controls on supported Google Cloud products to adhere with the Data Boundary for CJIS control package.
- Use your new Assured Workloads folder To start using your Assured Workloads folder, it's important that you put the resources that you want to be compliant with Data Boundary for CJIS in the new folder.
