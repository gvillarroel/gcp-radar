...
generated_at: "2026-04-14T15:27:30.636Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Data Boundary for Impact Level 4 (IL4) control package"
feature_slug: "data-boundary-for-impact-level-4-il4-control-package"
...
# Data Boundary for Impact Level 4 (IL4) control package
...
The Data Boundary for Impact Level 4 (IL4) control package supports Certificate Authority Service, Cloud Build, Cloud NAT, GKE Hub, Memorystore for Redis, Secret Manager, and Sensitive Data Protection.
...
- Google Cloud-wide Affected Google Cloud-wide features Feature Description Google Cloud console To access the Google Cloud console when using the Data Boundary for IL4 control package, you have the option of using the Jurisdictional Google Cloud console .
...
- Google Cloud-wide Affected Google Cloud-wide features Feature Description Google Cloud console To access the Google Cloud console when using the Data Boundary for IL5 control package, you have the option of using the Jurisdictional Google Cloud console .
...
Evidence snippets:
- Premium Data Boundary for Impact Level 4 (IL4) The Data Boundary for IL4 control package sets data location controls to support US-only regions .
- Premium Data Boundary for Impact Level 5 (IL5) The Data Boundary for IL5 control package sets data location controls to support US-only regions .
- Free Data Boundary for Impact Level 2 (IL2) The Data Boundary for IL2 control package sets data location controls to support US-only regions .
