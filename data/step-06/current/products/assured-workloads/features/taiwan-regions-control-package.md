...
generated_at: "2026-04-14T15:27:30.673Z"
product_name: "Assured Workloads"
product_slug: "assured-workloads"
feature_name: "Taiwan Regions control package"
feature_slug: "taiwan-regions-control-package"
...
# Taiwan Regions control package
...
The Taiwan Regions control package supports Cloud Build, Cloud SQL for PostgreSQL, Cloud Workstations, Document AI, Firebase Security Rules, Cloud OS Login API, Storage Transfer Service, and Google Security Operations SOAR.
...
- Google Cloud NetApp Volumes Affected Google Cloud NetApp Volumes features Feature Description Supported service levels Taiwan Data Boundary supports the following service levels: Standard Premium Extreme Flex, for the File type only.
...
- Free Taiwan Data Boundary The Taiwan Data Boundary control package sets data location controls to support Taiwan-only regions .
