...
feature_name: "Custom organization policy constraints for Live Stream API resources"
feature_slug: "custom-organization-policy-constraints-for-live-stream-api-resources"
...
# Custom organization policy constraints for Live Stream API resources
...
Organization Policy custom constraints can provide more granular control over specific fields for some Live Stream API resources.
