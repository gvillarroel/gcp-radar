...
feature_name: "FunctionalType metadata property"
feature_slug: "functionaltype-metadata-property"
...
# FunctionalType metadata property
...
Services and workloads now include an output-only FunctionalType property that identifies each resource’s known function, initially supporting AGENT.
...
- You can view details of your deployed applications and their services and workloads, including location, registration status, and metadata.
- Attributes are mutable, user-defined metadata that you can apply to applications, services, and workloads to organize and govern them.
