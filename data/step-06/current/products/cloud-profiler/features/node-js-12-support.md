...
generated_at: "2026-04-12T12:11:53.471Z"
...
source_links:
  ...
  - "https://docs.cloud.google.com/profiler/docs/troubleshooting"
...
- [https://docs.cloud.google.com/profiler/docs/troubleshooting](https://docs.cloud.google.com/profiler/docs/troubleshooting)
...
### Troubleshoot \_|\_ Cloud Profiler \_|\_ Google Cloud Documentation

- URL: [https://docs.cloud.google.com/profiler/docs/troubleshooting](https://docs.cloud.google.com/profiler/docs/troubleshooting)
- Source ID: `site-docs-root`
- Final score: 206
- Re-rank relevance: MODERATE
- Re-rank rationale: Fast mode kept the lexical match without page-level LLM reranking.
...
Evidence snippets:
- For more information, see the individual language pages: Profiling Go applications Profiling Java applications Profiling Node.js applications Profiling Python applications .
- Errors with Node.js This section lists issues that you might encounter when using the Node.js profiling agent and provides suggestions for how to fix each of them.
- Application doesn't exit normally with Node.js The profiling agent for Node.js interferes with the normal exit of the program; it can take up to an hour for the program to exit after all the tasks in the program have completed.
- Cloud Profiler API is disabled The following error occurs when the Profiler API isn't enabled for your Google Cloud project: failed to create a profile, will retry: rpc error: code = PermissionDenied desc = Cloud Profiler API has not been used in project 012345 before or it is disabled.
