...
generated_at: "2026-04-10T05:26:39.820Z"
product_name: "Cloud Key Management Service"
product_slug: "cloud-key-management-service"
feature_name: "Cloud KMS regional availability in me-central1"
feature_slug: "cloud-kms-regional-availability-in-me-central1"
...
# Cloud KMS regional availability in me-central1
...
- On this page Preliminary decisions Decide whether to use CMEK Choose manual or automated key creation Design your CMEK architecture Use a centralized CMEK key project for each environment Create Cloud KMS key rings for each location Choose a key granularity strategy Choose the protection level for keys Use Google Cloud-generated key material when possible Choose the right key purpose and algorithm for your needs Choose a rotation period Apply appropriate access controls Apply the principle of least privilege Plan for separation of duties Enforce CMEK consistently Enforce project liens Require CMEK keys Require a minimum scheduled for destruction duration Enforce allowed protection levels for CMEKs Configure detective controls for CMEKs Enable and aggregate audit logging Monitor key usage Enable Security Command Center for Cloud KMS vulnerability findings Assess your compliance requirements Summary of best practices What's next This page outlines best practices for configuring encryption at rest with customer-managed encryption keys (CMEKs) on your Google Cloud resources.
...
Evidence snippets:
- March 30, 2023 Feature Cloud KMS is available in the following region: me-central1 For more information, see Cloud KMS locations .
...
- April 18, 2023 Feature Cloud HSM resources are now available in the following regions: europe-west12 me-central1 For information about which locations are supported by Cloud KMS, Cloud HSM, and Cloud EKM, see Cloud KMS locations .
- For more details, see Cloud Key Management Service pricing March 04, 2025 Feature Cloud KMS is available in the following region: europe-north2 For more information, see Cloud KMS locations .
