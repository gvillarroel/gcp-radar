...
feature_name: "Cloud KMS regional availability in southamerica-west1"
feature_slug: "cloud-kms-regional-availability-in-southamerica-west1"
...
# Cloud KMS regional availability in southamerica-west1
...
Cloud KMS is available in the southamerica-west1 region.
...
Evidence snippets:
- November 16, 2021 Feature Cloud KMS is now available in the Santiago (southamerica-west1) region.
...
- May 10, 2022 Feature Cloud KMS is available in the following region: europe-southwest1 For more information, see Cloud KMS locations .
- August 22, 2023 Feature Cloud KMS is available in the following region: europe-west10 For more information, see Cloud KMS locations .
