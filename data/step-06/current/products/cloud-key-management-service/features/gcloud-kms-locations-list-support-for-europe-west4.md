...
generated_at: "2026-04-10T05:26:39.873Z"
...
source_links:
  ...
  - "https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/list"
keywords:
  - "gcloud"
  - "kms"
  - "locations"
...
- [https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/list](https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/list)
...
Evidence snippets:
- January 22, 2018 Feature The gcloud kms locations list command now supports the europe-west4 region.
...
- This region will not be viewable in the Google Cloud Platform console or returned by gcloud kms locations list until approximately January 17, 2018.
- October 31, 2022 Feature Cloud HSM resources are now available in the following regions: europe-southwest1 europe-west9 me-west1 For information about which locations are supported by Cloud KMS, Cloud HSM, and Cloud EKM, see Cloud KMS locations .

### "Method: locations.list \_|\_ Cloud Key Management Service \_|\_ Google Cloud\

- URL: [https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/list](https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/list)
- Source ID: `site-api-reference`
- Final score: 182
- Re-rank relevance: N/A

Evidence snippets:
- HTTP request Choose a location: global europe-west3 europe-west8 europe-west9 me-central2 us-east1 us-east4 us-west2 us-west1 us-east7 us-central1 us-west3 us-central2 us-west4 us-west8 us-east5 us-south1 us in ca GET https://cloudkms.googleapis.com/v1/{name=projects/ }/locations The URLs use gRPC Transcoding syntax.
- IAM Permissions Requires the following IAM permission on the name resource: cloudkms.locations.list For more information, see the IAM documentation .
- Full name : projects.locations.list Lists information about the supported locations for this service.
- Response body The response message for Locations.ListLocations .
