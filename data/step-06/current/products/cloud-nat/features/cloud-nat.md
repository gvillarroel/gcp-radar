...
generated_at: "2026-04-12T12:11:52.332Z"
product_name: "Cloud NAT"
product_slug: "cloud-nat"
feature_name: "Cloud NAT"
feature_slug: "cloud-nat"
...
Cloud NAT provides managed network address translation for outbound connectivity from private resources; Cloud NAT provides managed network address translation for outbound connectivity from private resources.
...
- If the network interface has an external IP address assigned to it, Google Cloud automatically performs one-to-one NAT for packets whose sources match the interface's primary internal IP address.
