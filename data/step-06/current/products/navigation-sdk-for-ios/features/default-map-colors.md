...
generated_at: "2026-04-12T12:18:01.313Z"
...
- Policies and use When customizing map styles in the Navigation SDK, you must adhere to the policies regarding acceptable modifications to the navigation UI.
...
- If guidance is inactive, this call is a NO-OP instruction. @note: If the map view is short, the SDK hides the accessory view due to limited space.
