# Routes API Step 03 URL Ranking
...
| ---: | --- | --- | --- | ---: | --- |
| 100 | no | supporting_page | https://docs.cloud.google.com/go/docs/reference/cloud.google.com/go/maps/latest/routing/apiv2 | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | yes | product_root | https://developers.google.com/maps/documentation/routes | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://developers.google.com/maps/documentation/routes/compute_route_directions | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://developers.google.com/maps/documentation/routes/get-api-key | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | yes | api_reference | https://developers.google.com/maps/documentation/routes/reference/rest | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://docs.cloud.google.com/nodejs/docs/reference/routing/latest | 4 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | yes | product_root | https://developers.google.com/maps/documentation/routes/overview | 2 | Fallback heuristic scoring was used because API scoring was unavailable. |
