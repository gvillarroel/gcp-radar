...
| ---: | --- | --- | --- | ---: | --- |
| 100 | yes | product_root | https://docs.cloud.google.com/migration-center/docs | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
...
| 95 | no | supporting_page | https://developers.google.com/analytics/devguides/migration?hl=en | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
