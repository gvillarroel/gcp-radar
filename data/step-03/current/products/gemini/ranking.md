...
| ---: | --- | --- | --- | ---: | --- |
| 100 | yes | product_root | https://docs.cloud.google.com/gemini/docs | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://docs.cloud.google.com/gemini/docs/discover/works | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
...
| 95 | no | iam_reference | https://docs.cloud.google.com/iam/docs/roles-permissions/geminicloudassist | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
| 95 | no | iam_reference | https://docs.cloud.google.com/iam/docs/roles-permissions/geminicodeassistmanagement | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
| 95 | no | iam_reference | https://docs.cloud.google.com/iam/docs/roles-permissions/geminidataanalytics | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
| 95 | no | iam_reference | https://docs.cloud.google.com/iam/docs/roles-permissions/generativelanguage | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
...
| 90 | no | supporting_page | https://docs.cloud.google.com/gemini/docs/api-and-reference | 1 | Fallback heuristic scoring was used because API scoring was unavailable. |
