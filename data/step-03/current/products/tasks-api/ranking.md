...
| ---: | --- | --- | --- | ---: | --- |
| 100 | yes | api_reference | https://developers.google.com/workspace/tasks/reference/rest | 4 | Fallback heuristic scoring was used because API scoring was unavailable. |
...
| 100 | no | supporting_page | https://docs.cloud.google.com/go/docs/reference/cloud.google.com/go/cloudtasks/latest/apiv2 | 4 | Heuristic tail scoring was applied outside the API-ranked set. |
| 100 | no | supporting_page | https://docs.cloud.google.com/workflows/docs/reference/googleapis/cloudtasks/Overview | 3 | Heuristic tail scoring was applied outside the API-ranked set. |
| 100 | yes | product_reference | https://developers.google.com/tasks/reference/rest/v1/tasks | 4 | Heuristic tail scoring was applied outside the API-ranked set. |
| 95 | yes | product_root | https://developers.google.com/workspace/tasks/overview | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://developers.google.com/resources/api-libraries/documentation/tasks/v1/java/latest/com/google/api/services/tasks/Tasks.html | 2 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://developers.google.com/resources/api-libraries/documentation/tasks/v1/java/latest/com/google/api/services/tasks/TasksRequest.html | 2 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://developers.google.com/tasks | 2 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://docs.cloud.google.com/cpp/docs/reference/tasks/latest | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
| 95 | no | supporting_page | https://docs.cloud.google.com/tasks/docs/access-control | 2 | Heuristic tail scoring was applied outside the API-ranked set. |
...
| 90 | yes | iam_reference | https://developers.google.com/workspace/tasks/auth | 1 | Fallback heuristic scoring was used because API scoring was unavailable. |
...
| 90 | no | supporting_page | https://developers.google.com/resources/api-libraries/documentation/tasks/v1/csharp/latest | 1 | Fallback heuristic scoring was used because API scoring was unavailable. |
