...
| ---: | --- | --- | --- | ---: | --- |
| 100 | yes | product_root | https://docs.cloud.google.com/unified-maintenance/docs | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | yes | product_root | https://docs.cloud.google.com/unified-maintenance/docs/overview | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://docs.cloud.google.com/unified-maintenance/docs/reference/rpc/google.cloud.maintenance.api.v1 | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://docs.cloud.google.com/unified-maintenance/docs/set-up-unified-maintenance | 5 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 100 | no | supporting_page | https://docs.cloud.google.com/unified-maintenance/docs/view-maintenance-api | 3 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://docs.cloud.google.com/unified-maintenance/docs/quickstart-client-libraries | 4 | Fallback heuristic scoring was used because API scoring was unavailable. |
| 95 | no | supporting_page | https://docs.cloud.google.com/unified-maintenance/docs/view-maintenance | 2 | Fallback heuristic scoring was used because API scoring was unavailable. |
...
| 90 | yes | iam_reference | https://docs.cloud.google.com/hub/docs/maintenance | 1 | Heuristic tail scoring was applied outside the API-ranked set. |
