...
Generated at: `2026-04-29T04:08:46.975Z`
Product status: `PASS`
...
- Service card ID: `apigee-integrated-portal:service`
...
| Portal catalog pagination | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/apigee-mcp/apigee-mcp-quickstart)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/tutorials/view-with-trace) |
| Content Security Policy for portals | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/apigee-mcp/apigee-mcp-quickstart)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/intro-portals)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis) |
| Apps and Teams table column sorting | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/intro-portals)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/tutorials/secure-calls-your-api-through-oauth-20-client-credentials) |
| GraphQL schema publishing | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/intro-portals)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis)<br>[source](https://docs.cloud.google.com/apigee/docs/apihub/tutorials/enrich-api-data) |
| Inactive user login error messaging | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/intro-portals)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/tutorials/using-model-armor-policies) |
| Portal SSO email sender address configuration | MEDIUM | PASS | unknown | [source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/intro-portals)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/publish-apis)<br>[source](https://docs.cloud.google.com/apigee/docs/api-platform/publish/portal/search-page) |
