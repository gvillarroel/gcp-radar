---
title: "Method: projects.locations.caPools.certificateAuthorities.activate \_|\_ Certificate\
  \ Authority Service \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/certificate-authority-service/docs/reference/rest/v1/projects.locations.caPools.certificateAuthorities/activate
...
source_metadata:
  url: https://docs.cloud.google.com/certificate-authority-service/docs/reference/rest/v1/projects.locations.caPools.certificateAuthorities/activate
  title: "Method: projects.locations.caPools.certificateAuthorities.activate \_|\_\
    \ Certificate Authority Service \_|\_ Google Cloud Documentation"
...
Activate a CertificateAuthority that is in state AWAITING_USER_ACTIVATION and is of type SUBORDINATE . After the parent Certificate Authority signs a certificate signing request from certificateAuthorities.fetch , this method can complete the activation process.
HTTP request
