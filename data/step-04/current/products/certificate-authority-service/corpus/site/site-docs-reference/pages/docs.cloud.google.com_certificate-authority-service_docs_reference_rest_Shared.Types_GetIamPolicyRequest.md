---
title: "GetIamPolicyRequest \_|\_ Certificate Authority Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/certificate-authority-service/docs/reference/rest/Shared.Types/GetIamPolicyRequest
...
GetPolicyOptions
JSON representation
Request message for certificateAuthorities.getIamPolicy method.
JSON representation
{
"resource" : string ,
"options" : {
