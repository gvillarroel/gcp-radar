---
title: "Authenticate to CA Service \_|\_ Certificate Authority Service \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/certificate-authority-service/docs/authentication
...
This document describes how to authenticate to Certificate Authority Service programmatically. How
you authenticate to Certificate Authority Service depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
CA Service supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The CA Service client libraries provide
high-level language support for authenticating to CA Service
programmatically.
...
For more information about using the gcloud CLI with CA Service,
...
Set up authentication for CA Service
...
CA Service, as described in Before you begin .
...
Access control for CA Service
After you authenticate to CA Service, you must be authorized to access
Google Cloud resources. CA Service uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for CA Service, see
