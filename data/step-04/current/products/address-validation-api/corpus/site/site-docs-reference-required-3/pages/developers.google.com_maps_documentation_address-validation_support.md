---
title: "Support Options for Address Validation API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/address-validation/support
knowledge_key: corpus
source_id: site-docs-reference-required-3
source_type: site
entrypoint: https://developers.google.com/maps/documentation/address-validation/add-subpremises-address-example
source_metadata:
  url: https://developers.google.com/maps/documentation/address-validation/support
  title: "Support Options for Address Validation API \_|\_ Google for Developers"
...
Resources
Send feedback
Support Options for Address Validation API
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Get help with the Google Address Validation API through community support on Stack Overflow, by reporting issues on the issue tracker, or by contacting Google Maps Platform Support.
Create and manage support cases for the API through the Google Cloud Console, requiring a valid billing account and an enabled API.
Enhanced Support customers have access to faster response times, additional support services, and features like case escalation and video conferencing.
Billing Admins can contact billing support by creating a new project with billing enabled and an API enabled, granting them Project Owner access.
For data privacy and protection questions, utilize the Data Privacy Inquiry Form instead of creating a standard support case.
Get help
Feeling a little stuck? There are several ways to get some help with your
app.
Ask a question on
Stack Overflow .
Report a bug or feature request on the
issue tracker .
Contact the Maps support team .
Community support on Stack Overflow
We use the popular programming Q&A website
Stack Overflow
to field technical questions about the Address Validation API. Stack Overflow is a
...
google-maps
to your search query. You can look for Address Validation API-specific topics by adding
google-address-validation-api . You may wish to add additional tags to your question
...
problem. Most people will not debug errors in your code
...
resolution times.
Bugs
If you think the cause of a problem is a bug in the Address Validation API, report it on
...
[[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-04-09 UTC."],[],["For technical questions, use Stack Overflow with the `google-address-validation-api` tag. Report bugs or request features via the Issue Tracker, providing detailed descriptions. Enhanced Support users should create support cases for issues, with response times ranging from 1-24 hours based on impact. Contact support through the Cloud Console for unresolved queries, managing cases there with specific project roles. For data privacy concerns use the privacy form. Enhanced Support offers case escalation, video conferencing, SLA reports and map data quality investigation.\n"]]
