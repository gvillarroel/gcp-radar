---
title: "Build a Google Chat app with a Gemini Enterprise AI agent \_|\_ Google Workspace\
  \ add-ons \_|\_ Google for Developers"
url: https://developers.google.com/workspace/add-ons/chat/quickstart-ge-agent
...
The Gemini Enterprise AI agent receives and processes the interaction.
...
Note the Project number and Project ID fields.
Go to Gemini Enterprise:
Open Gemini Enterprise
Note the Location and ID of the application.
Click the following button to open the GE AI Agent Quickstart
Apps Script project.
Open the project
...
REASONING_ENGINE_RESOURCE_NAME with the Gemini Enterprise app resource
...
In GCP project number , paste the Google Cloud project number noted in
previous steps.
...
In the new direct message with the app, type I need to find ideas! and press enter .
