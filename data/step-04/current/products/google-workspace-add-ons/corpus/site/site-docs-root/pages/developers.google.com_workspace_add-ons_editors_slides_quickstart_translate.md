---
title: "Translate text from Google Slides \_|\_ Google Workspace add-ons \_|\_ Google\
  \ for Developers"
url: https://developers.google.com/workspace/add-ons/editors/slides/quickstart/translate
...
Set up the script
Create a Slides presentation at
slides.new .
Click Extensions >
Apps Script .
Click Untitled project .
Rename the Apps Script project to Translate
Slides and click Rename .
...
Click Extensions >
Translate Slides
> Start . It can take several
seconds for the add-on menu item to appear.
