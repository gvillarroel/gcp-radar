---
title: "Authenticate to Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/authentication
...
This document describes how to authenticate to Assured Workloads programmatically. How
you authenticate to Assured Workloads depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Assured Workloads supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Assured Workloads client libraries provide
high-level language support for authenticating to Assured Workloads
programmatically.
...
Set up authentication for Assured Workloads
...
Access control for Assured Workloads
After you authenticate to Assured Workloads, you must be authorized to access
Google Cloud resources. Assured Workloads uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Assured Workloads, see
