---
title: "API Hub roles and permissions \_|\_ Identity and Access Management (IAM) \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/roles-permissions/apihub
...
source_metadata:
  url: https://docs.cloud.google.com/iam/docs/roles-permissions/apihub
  title: "API Hub roles and permissions \_|\_ Identity and Access Management (IAM)\
...
Reference
Send feedback
API Hub roles and permissions
Stay organized with collections
Save and categorize content based on your preferences.
This page lists the IAM roles and permissions for API Hub. To
...
Cloud API Hub Admin ( roles/ apihub.admin )
Cloud API hub Provisioning Admin ( roles/ apihub.provisioningAdmin )
Cloud API hub Runtime Project Attachment Editor ( roles/ apihub.runTimeProjectAttachmentsEditor )
Service agent roles
Warning: Don't grant service agent roles to any principals except service agents .
Apigee Core Service Agent ( roles/ apigee.coreServiceAgent )
Apigee Service Agent ( roles/ apigee.serviceAgent )
