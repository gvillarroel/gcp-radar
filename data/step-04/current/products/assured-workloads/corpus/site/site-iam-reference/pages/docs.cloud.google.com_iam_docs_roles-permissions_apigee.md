---
title: "Apigee roles and permissions \_|\_ Identity and Access Management (IAM) \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/roles-permissions/apigee
...
source_metadata:
  url: https://docs.cloud.google.com/iam/docs/roles-permissions/apigee
  title: "Apigee roles and permissions \_|\_ Identity and Access Management (IAM)\
...
Reference
Send feedback
Apigee roles and permissions
Stay organized with collections
Save and categorize content based on your preferences.
This page lists the IAM roles and permissions for Apigee. To
...
apigee.appgroupapps.list
apigee.appgroupapps.manage
apigee.appgroupbalances.*
apigee.appgroupbalances.adjust
apigee.appgroupbalances.get
apigee.appgroupbalances.update
apigee. appgroupmonetizationconfigs.*
apigee. appgroupmonetizationconfigs. get
apigee. appgroupmonetizationconfigs. update
apigee.appgroups.*
apigee.appgroups.create
...
( roles/ apigee.spaceContentViewer )
...
Service agent that grants access to Apigee resources - API Products, Developers, Developer Apps, App Keys, and Apigee Environments (without granting impersonation permissions).
Warning: Do not grant service agent roles to any principals except
service agents .
apigee.apiproducts.get
apigee.apiproducts.list
...
Apigee Editor ( roles/ apigee.editor )
Apigee Space Content Editor ( roles/ apigee.spaceContentEditor )
apigee. apiproductattributes. delete
Owner ( roles/ owner )
Editor ( roles/ editor )
Apigee Organization Admin ( roles/ apigee.admin )
...
Apigee Read-only Admin ( roles/ apigee.readOnlyAdmin )
Apigee Space Content Editor ( roles/ apigee.spaceContentEditor )
Apigee Space Content Viewer ( roles/ apigee.spaceContentViewer )
Support User ( roles/ iam.supportUser )
apigee. apiproductattributes. list
Owner ( roles/ owner )
Editor ( roles/ editor )
...
Apigee Core Service Agent ( roles/ apigee.coreServiceAgent )
...
Apigee Organization Admin ( roles/ apigee.admin )
Apigee Editor ( roles/ apigee.editor )
Apigee Deployment Invoker ( roles/ apigee.deploymentInvoker )
Apigee Environment Admin ( roles/ apigee.environmentAdmin )
apigee.deployments.list
Owner ( roles/ owner )
Editor ( roles/ editor )
...
Service agent roles
Warning: Don't grant service agent roles to any principals except service agents .
API-Hub Runtime Project Service Agent ( roles/ apihub.runtimeProjectServiceAgent )
apigee. deployments. setIamPolicy
Owner ( roles/ owner )
Apigee Organization Admin ( roles/ apigee.admin )
Security Admin ( roles/ iam.securityAdmin )
