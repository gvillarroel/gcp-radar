---
title: "Policy Controller roles and permissions \_|\_ Identity and Access Management\
  \ (IAM) \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/roles-permissions/anthospolicycontroller
...
This page lists the IAM roles and permissions for Policy Controller. To
search through all roles and permissions, see the role and
permission index .
Policy Controller roles
Policy Controller offers the following service agent roles.
