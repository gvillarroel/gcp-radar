---
title: "Indonesia Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/indonesia-data-boundary
...
Indonesia Data Boundary workloads in Assured Workloads. It provides
...
Indonesia Data Boundary:
Data residency : The Indonesia Data Boundary control package sets data
location controls to support
Indonesia-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Indonesia Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Indonesia Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Indonesia Data Boundary control package is included in
...
requirements for Indonesia Data Boundary. Unsupported products are not recommended for use
...
Indonesia Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Indonesia Data Boundary workloads.
...
Indonesia Data Boundary supports the following service levels:
Standard
Premium
Extreme
