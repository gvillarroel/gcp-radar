---
title: "South Africa Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/south-africa-data-boundary
...
South Africa Data Boundary workloads in Assured Workloads. It provides
...
South Africa Data Boundary:
Data residency : The South Africa Data Boundary control package sets data
location controls to support
Qatar-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for South Africa Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. South Africa Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The South Africa Data Boundary control package is included in
...
requirements for South Africa Data Boundary. Unsupported products are not recommended for use
...
South Africa Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for South Africa Data Boundary workloads.
...
South Africa Data Boundary supports the following service levels:
Standard
Premium
Extreme
