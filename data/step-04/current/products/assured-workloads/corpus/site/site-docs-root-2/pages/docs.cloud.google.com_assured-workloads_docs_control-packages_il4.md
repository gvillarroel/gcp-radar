---
title: "Data Boundary for Impact Level 4 (IL4) \_|\_ Assured Workloads \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/il4
...
Data Boundary for IL4. Nothing in this document is intended to provide you
with or should be used as a substitute for legal advice.
This page describes the set of controls that are applied on
Data Boundary for IL4 workloads in Assured Workloads. It provides
...
Data residency : The Data Boundary for IL4 control package sets data
...
Support : Technical support services for Data Boundary for IL4 workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Data Boundary for IL4 workloads support cases are routed to
US Persons located in the US. For more information, see
Getting support .
Pricing : The Data Boundary for IL4 control package is included in
Assured Workloads' Premium tier , which incurs an additional 20%
charge. For more information, see
Assured Workloads pricing .
Prerequisites
To remain compliant as a user of the Data Boundary for IL4 control package,
verify that you satisfy and adhere to the following prerequisites:
Create a Data Boundary for IL4 folder using Assured Workloads and
deploy your IL4 workloads only in that folder.
Only enable and use in-scope services for
Data Boundary for IL4 workloads.
...
occur.
For all services used in a Data Boundary for IL4 folder, don't store
...
page for additional information about deploying IL4 workloads in
Google Cloud.
...
Data Boundary for IL4. It can be accessed at one of the following URLs:
...
requirements for Data Boundary for IL4. Unsupported products are not recommended for use
...
Data Boundary for IL4 folders. Other applicable organization policy constraints—even if
...
To access the Google Cloud console when using the Data Boundary for IL4 control package,
you have the option of using the
Jurisdictional Google Cloud console .
The Jurisdictional Google Cloud console is not required for Data Boundary for IL4, and can be
...
The following BigQuery APIs are IL4-compliant:
bigquery.googleapis.com
bigquerydatapolicy.googleapis.com
bigqueryconnection.googleapis.com
bigquerymigration.googleapis.com
...
Regions
BigQuery is IL4-compliant for all BigQuery
US regions except the US multi-region. IL4 compliance cannot
...
IL4-compliant region when creating BigQuery datasets.
Queries on IL4 datasets from non-IL4 projects
BigQuery doesn't prevent IL4 datasets from being
queried from non-IL4 projects. Ensure that any query that uses
a read or a join operation on IL4 technical data is in an
IL4-compliant folder.
...
connectors for Data Boundary for IL4 workloads.
...
Feature
Description
IL4-compliant Cloud Vision API endpoints
...
( vision.googleapis.com ) is not IL4-compliant and
...
compliant with Data Boundary for IL4.
What's next
