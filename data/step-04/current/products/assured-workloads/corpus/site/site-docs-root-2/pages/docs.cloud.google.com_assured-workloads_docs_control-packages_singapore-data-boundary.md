---
title: "Singapore Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/singapore-data-boundary
...
Singapore Data Boundary workloads in Assured Workloads. It provides
...
Singapore Data Boundary:
Data residency : The Singapore Data Boundary control package sets data
location controls to support
Singapore-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Singapore Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Singapore Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Singapore Data Boundary control package is included in
...
requirements for Singapore Data Boundary. Unsupported products are not recommended for use
...
Singapore Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Singapore Data Boundary workloads.
...
Singapore Data Boundary supports the following service levels:
Standard
Premium
Extreme
