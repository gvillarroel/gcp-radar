---
title: "Switzerland Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/switzerland-data-boundary
...
Switzerland Data Boundary workloads in Assured Workloads. It provides
...
Switzerland Data Boundary:
Data residency : The Switzerland Data Boundary control package sets data
location controls to support
Switzerland-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Switzerland Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Switzerland Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Switzerland Data Boundary control package is included in
...
requirements for Switzerland Data Boundary. Unsupported products are not recommended for use
...
Switzerland Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Switzerland Data Boundary workloads.
...
Switzerland Data Boundary supports the following service levels:
Standard
Premium
Extreme
