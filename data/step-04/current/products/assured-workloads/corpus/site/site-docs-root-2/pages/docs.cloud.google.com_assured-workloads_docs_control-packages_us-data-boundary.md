---
title: "US Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/us-data-boundary
...
US Data Boundary workloads in Assured Workloads. It provides
...
US Data Boundary:
Data residency : The US Data Boundary control package sets data
location controls to support
US-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for US Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. US Data Boundary
...
Pricing : The US Data Boundary control package is included in
...
requirements for US Data Boundary. Unsupported products are not recommended for use
...
US Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for US Data Boundary workloads.
...
US Data Boundary supports the following service levels:
Standard
Premium
Extreme
...
Learn about the US Data Boundary and Support
control package
