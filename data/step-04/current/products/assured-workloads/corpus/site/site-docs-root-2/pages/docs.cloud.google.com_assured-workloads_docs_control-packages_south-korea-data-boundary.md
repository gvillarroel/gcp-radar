---
title: "South Korea Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/south-korea-data-boundary
...
South Korea Data Boundary workloads in Assured Workloads. It provides
...
South Korea Data Boundary:
Data residency : The South Korea Data Boundary control package sets data
location controls to support
South Korea-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for South Korea Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. South Korea Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The South Korea Data Boundary control package is included in
...
requirements for South Korea Data Boundary. Unsupported products are not recommended for use
...
South Korea Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for South Korea Data Boundary workloads.
...
South Korea Data Boundary supports the following service levels:
Standard
Premium
Extreme
