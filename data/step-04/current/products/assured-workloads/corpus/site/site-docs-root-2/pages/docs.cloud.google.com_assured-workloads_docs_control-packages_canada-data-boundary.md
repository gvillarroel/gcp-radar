---
title: "Canada Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/canada-data-boundary
...
Canada Data Boundary workloads in Assured Workloads. It provides
...
Canada Data Boundary:
Data residency : The Canada Data Boundary control package sets data
location controls to support
Canada-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Canada Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Canada Data Boundary
...
Pricing : The Canada Data Boundary control package is included in
...
requirements for Canada Data Boundary. Unsupported products are not recommended for use
...
Canada Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Canada Data Boundary workloads.
...
Canada Data Boundary supports the following service levels:
Standard
Premium
Extreme
...
Learn about the Canada Data Boundary and Support
control package
