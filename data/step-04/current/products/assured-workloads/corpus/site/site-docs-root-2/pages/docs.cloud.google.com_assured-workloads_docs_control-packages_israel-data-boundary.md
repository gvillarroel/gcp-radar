---
title: "Israel Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/israel-data-boundary
...
Israel Data Boundary workloads in Assured Workloads. It provides
...
Israel Data Boundary:
Data residency : The Israel Data Boundary control package sets data
location controls to support
Israel-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Israel Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Israel Data Boundary
...
Pricing : The Israel Data Boundary control package is included in
...
requirements for Israel Data Boundary. Unsupported products are not recommended for use
...
Israel Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Israel Data Boundary workloads.
...
Israel Data Boundary supports the following service levels:
Standard
Premium
Extreme
...
Learn about the Israel Data Boundary and Support
control package
