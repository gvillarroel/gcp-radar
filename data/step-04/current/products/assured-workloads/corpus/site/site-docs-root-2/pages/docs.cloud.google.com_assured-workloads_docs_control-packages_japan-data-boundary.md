---
title: "Japan Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/japan-data-boundary
...
Japan Data Boundary workloads in Assured Workloads. It provides
...
Japan Data Boundary:
Data residency : The Japan Data Boundary control package sets data
location controls to support
Japan-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Japan Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Japan Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Japan Data Boundary control package is included in
...
requirements for Japan Data Boundary. Unsupported products are not recommended for use
...
Japan Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Japan Data Boundary workloads.
...
Japan Data Boundary supports the following service levels:
Standard
Premium
Extreme
