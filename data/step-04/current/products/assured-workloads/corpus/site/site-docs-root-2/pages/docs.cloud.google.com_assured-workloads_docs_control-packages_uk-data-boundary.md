---
title: "UK Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/uk-data-boundary
...
UK Data Boundary workloads in Assured Workloads. It provides
...
UK Data Boundary:
Data residency : The UK Data Boundary control package sets data
location controls to support
UK-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for UK Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. UK Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The UK Data Boundary control package is included in
...
requirements for UK Data Boundary. Unsupported products are not recommended for use
...
UK Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for UK Data Boundary workloads.
...
UK Data Boundary supports the following service levels:
Standard
Premium
Extreme
