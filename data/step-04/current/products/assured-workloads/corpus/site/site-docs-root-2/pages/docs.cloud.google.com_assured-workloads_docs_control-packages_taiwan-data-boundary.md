---
title: "Taiwan Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/taiwan-data-boundary
...
Taiwan Data Boundary workloads in Assured Workloads. It provides
...
Taiwan Data Boundary:
Data residency : The Taiwan Data Boundary control package sets data
location controls to support
Taiwan-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Taiwan Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Taiwan Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Taiwan Data Boundary control package is included in
...
requirements for Taiwan Data Boundary. Unsupported products are not recommended for use
...
Taiwan Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Taiwan Data Boundary workloads.
...
Taiwan Data Boundary supports the following service levels:
Standard
Premium
Extreme
