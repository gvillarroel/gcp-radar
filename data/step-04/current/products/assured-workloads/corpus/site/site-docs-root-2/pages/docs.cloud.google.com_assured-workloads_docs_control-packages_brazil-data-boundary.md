---
title: "Brazil Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/brazil-data-boundary
...
Brazil Data Boundary workloads in Assured Workloads. It provides
...
Brazil Data Boundary:
Data residency : The Brazil Data Boundary control package sets data
location controls to support
Brazil-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Brazil Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Brazil Data Boundary workloads
support cases are routed to global support personnel.
Pricing : The Brazil Data Boundary control package is included in
...
requirements for Brazil Data Boundary. Unsupported products are not recommended for use
...
Brazil Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Brazil Data Boundary workloads.
...
Brazil Data Boundary supports the following service levels:
Standard
Premium
Extreme
