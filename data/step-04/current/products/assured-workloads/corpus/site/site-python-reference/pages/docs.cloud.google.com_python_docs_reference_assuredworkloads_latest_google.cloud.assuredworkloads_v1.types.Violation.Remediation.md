---
title: "Class Remediation (2.2.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.Violation.Remediation
...
Description
instructions
google.cloud.assuredworkloads_v1.types.Violation.Remediation.Instructions
...
denied values
remediation_type
google.cloud.assuredworkloads_v1.types.Violation.Remediation.RemediationType
...
Classifying remediation into various types based on the kind
