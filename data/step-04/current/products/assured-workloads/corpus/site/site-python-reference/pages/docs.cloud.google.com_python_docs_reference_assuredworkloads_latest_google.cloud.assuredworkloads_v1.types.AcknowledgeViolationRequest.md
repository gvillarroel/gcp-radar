---
title: "Class AcknowledgeViolationRequest (2.2.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.AcknowledgeViolationRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.AcknowledgeViolationRequest
  title: "Class AcknowledgeViolationRequest (2.2.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class AcknowledgeViolationRequest (2.2.0)
...
0.2.1
0.1.0
AcknowledgeViolationRequest ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
