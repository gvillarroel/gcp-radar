---
title: "Class GetWorkloadRequest (2.2.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.GetWorkloadRequest
...
Client libraries
Send feedback
Class GetWorkloadRequest (2.2.0)
