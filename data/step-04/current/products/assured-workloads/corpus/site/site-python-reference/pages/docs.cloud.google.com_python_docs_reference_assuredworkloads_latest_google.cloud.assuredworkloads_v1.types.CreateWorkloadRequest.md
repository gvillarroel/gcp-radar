---
title: "Class CreateWorkloadRequest (2.2.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.CreateWorkloadRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/assuredworkloads/latest/google.cloud.assuredworkloads_v1.types.CreateWorkloadRequest
  title: "Class CreateWorkloadRequest (2.2.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class CreateWorkloadRequest (2.2.0)
