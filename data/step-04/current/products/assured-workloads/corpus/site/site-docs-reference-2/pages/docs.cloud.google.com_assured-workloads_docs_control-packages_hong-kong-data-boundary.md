---
title: "Hong Kong Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/hong-kong-data-boundary
...
Hong Kong Data Boundary workloads in Assured Workloads. It provides
...
Hong Kong Data Boundary:
Data residency : The Hong Kong Data Boundary control package sets data
location controls to support
Hong Kong-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Hong Kong Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Hong Kong Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Hong Kong Data Boundary control package is included in
...
requirements for Hong Kong Data Boundary. Unsupported products are not recommended for use
...
Hong Kong Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Hong Kong Data Boundary workloads.
...
Hong Kong Data Boundary supports the following service levels:
Standard
Premium
Extreme
