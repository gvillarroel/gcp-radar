---
title: "EU Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/eu-data-boundary
...
EU Data Boundary workloads in Assured Workloads. It provides
...
EU Data Boundary:
Data residency : The EU Data Boundary control package sets data
location controls to support
EU-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for EU Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. EU Data Boundary
...
Pricing : The EU Data Boundary control package is included in
...
requirements for EU Data Boundary. Unsupported products are not recommended for use
...
EU Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for EU Data Boundary workloads.
...
EU Data Boundary supports the following service levels:
Standard
Premium
Extreme
...
Learn about the EU Data Boundary and Support
control package
