---
title: "Australia Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/australia-data-boundary-support
...
source_metadata:
  url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/australia-data-boundary-support
  title: "Australia Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google\
    \ Cloud Documentation"
...
Australia Data Boundary and Support workloads in Assured Workloads. It provides
...
Australia Data Boundary and Support:
Data residency : The Australia Data Boundary and Support control package sets data
location controls to support
Australia-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Australia Data Boundary and Support workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Australia Data Boundary and Support workloads support cases are routed to
personnel in five specific countries (United States, Canada, Australia, United
Kingdom, and New Zealand); see
Getting support
for more information.
Pricing : The Australia Data Boundary and Support control package is included in
...
requirements for Australia Data Boundary and Support. Unsupported products are not recommended for use
...
Australia Data Boundary and Support folders. Other applicable organization policy constraints—even if
...
connectors for Australia Data Boundary and Support workloads.
...
Australia Data Boundary and Support supports the following service levels:
Standard
Premium
Extreme
...
Learn about the Australia Data Boundary
control package
