---
title: "Canada Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/canada-data-boundary-support
...
Canada Data Boundary and Support workloads in Assured Workloads. It provides
...
Canada Data Boundary and Support:
Data residency : The Canada Data Boundary and Support control package sets data
location controls to support
Canada-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Canada Data Boundary and Support workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Canada Data Boundary and Support workloads support cases are routed to
Canadian personnel located in Canada;
see Getting support
for more information.
Pricing : The Canada Data Boundary and Support control package is included in
...
requirements for Canada Data Boundary and Support. Unsupported products are not recommended for use
...
Canada Data Boundary and Support folders. Other applicable organization policy constraints—even if
...
connectors for Canada Data Boundary and Support workloads.
...
Canada Data Boundary and Support supports the following service levels:
Standard
Premium
Extreme
