---
title: "Australia Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/australia-data-boundary
...
Australia Data Boundary workloads in Assured Workloads. It provides
...
Australia Data Boundary:
Data residency : The Australia Data Boundary control package sets data
location controls to support
Australia-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Australia Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Australia Data Boundary workloads
support cases are routed to global support personnel. If you require a more
restrictive support personnel control option, consider the
Australia Data Boundary and Assured Support
control package instead.
Pricing : The Australia Data Boundary control package is included in
...
requirements for Australia Data Boundary. Unsupported products are not recommended for use
...
Australia Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Australia Data Boundary workloads.
...
Australia Data Boundary supports the following service levels:
Standard
Premium
Extreme
...
Learn about the Australia Data Boundary and Support
control package
