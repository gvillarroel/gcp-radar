---
title: "Qatar Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/qatar-data-boundary
...
Qatar Data Boundary workloads in Assured Workloads. It provides
...
Qatar Data Boundary:
Data residency : The Qatar Data Boundary control package sets data
location controls to support
Qatar-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Qatar Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. Qatar Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The Qatar Data Boundary control package is included in
...
requirements for Qatar Data Boundary. Unsupported products are not recommended for use
...
Qatar Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for Qatar Data Boundary workloads.
...
Qatar Data Boundary supports the following service levels:
Standard
Premium
Extreme
