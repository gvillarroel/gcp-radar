---
title: "India Data Boundary \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/india-data-boundary
...
India Data Boundary workloads in Assured Workloads. It provides
...
India Data Boundary:
Data residency : The India Data Boundary control package sets data
location controls to support
India-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for India Data Boundary workloads
are available with Standard, Enhanced, or Premium
Cloud Customer Care subscriptions. India Data Boundary
workloads support cases are routed to global support personnel.
Pricing : The India Data Boundary control package is included in
...
requirements for India Data Boundary. Unsupported products are not recommended for use
...
India Data Boundary folders. Other applicable organization policy constraints—even if
...
connectors for India Data Boundary workloads.
...
India Data Boundary supports the following service levels:
Standard
Premium
Extreme
