---
title: "Assured Workloads release notes \_|\_ Google Cloud Documentation"
...
This page documents production updates to Assured Workloads. Check this
...
v1
Feature
The EU Data Boundary with Access Justifications
supports the following products:
Backup for GKE
Cloud Build
Cloud Workstations
...
v1
Feature
The Kingdom of Saudi Arabia (KSA) Data Boundary with Access Justifications
supports the following products:
Cloud Workstations
Firebase Security Rules
Secure Source Manager
...
v1
Feature
The South Africa Data Boundary
supports the following products:
Agent Assist
App Hub
Cloud Domains
...
v1
Feature
The Data Boundary for Canada Protected B
supports the following products:
Agent Assist
App Hub
Cloud Domains
...
v1
Feature
The EU Data Boundary and
EU Data Boundary and Support
now support the Stockholm ( europe-north2 ) region.
September 29, 2025
v1
Feature
The Data Boundary for Impact Level 4 (IL4)
...
Regional internal proxy Network Load Balancer
Speech-to-Text
See Supported products by control package
for more information.
v1
Feature
The IRS 1075 control package
supports the following products:
App Hub
Cloud Asset Inventory
Cloud Deploy
...
Feature
The UK Data Boundary
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
Text-to-Speech
...
v1
Feature
The Israel Data Boundary and Support
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
...
v1
Feature
The EU Data Boundary and Support
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
...
v1
Feature
The US Data Boundary and Support
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
...
v1
Feature
The Australia Data Boundary and Support
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
...
v1
Feature
The Canada Data Boundary and Support
control package supports the following products:
Binary Authorization
Cloud Asset Inventory
Database Center
...
v1
Feature
The FedRAMP Moderate , FedRAMP High , and IL2 control packages now support the following products:
Vertex AI Search
Generative AI on Vertex AI
March 07, 2025
v1
Feature
Looker (Google Cloud core) is now supported in the following control packages:
Australia Regions
Brazil Regions
Canada Regions
Chile Regions
...
Use REGIONAL_CONTROLS instead of FREE_REGIONS when calling organizations.locations.workloads.create to create a new Assured Workloads folder/workload
Expect REGIONAL_CONTROLS as the return value for ComplianceRegime from calls to organizations.locations.workloads.get and organizations.locations.workloads.list
Using Terraform:
...
v1
Feature
The following compliance programs now support the following products. See
supported products for more information:
Australia Regions with Assured Support :
Access Transparency
Canada Regions and Support :
Access Transparency
...
v1
Feature
The EU Regions and Support with Sovereignty Controls compliance regime is now in Preview .
April 30, 2021
v1
Change
