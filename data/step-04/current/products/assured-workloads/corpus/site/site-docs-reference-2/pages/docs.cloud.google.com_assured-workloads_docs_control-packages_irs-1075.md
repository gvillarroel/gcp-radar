---
title: "Data Boundary for IRS Publication 1075 \_|\_ Assured Workloads \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/irs-1075
...
Data Boundary for IRS 1075. Nothing in this document is intended to provide you
with or should be used as a substitute for legal advice.
This page describes the set of controls that are applied on
Data Boundary for IRS 1075 workloads in Assured Workloads. It provides
...
Data residency : The Data Boundary for IRS 1075 control package sets data
location controls to support
US-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Data Boundary for IRS 1075 workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Data Boundary for IRS 1075 workloads support cases are routed to
US Persons located in the US who have completed fingerprint-based CJIS
background checks, state-level law enforcement checks, and citizenship
verification. For more information, see
Getting support .
Pricing : The Data Boundary for IRS 1075 control package is included in
Assured Workloads' Premium tier , which incurs a 20% additional
charge. See Assured Workloads pricing
for more information.
Prerequisites
To remain compliant as a user of the Data Boundary for IRS 1075 control package,
verify that you satisfy and adhere to the following prerequisites:
Create an Data Boundary for IRS 1075 folder using Assured Workloads and
deploy your Data Boundary for IRS 1075 workloads only in that folder.
Only enable and use
in-scope Data Boundary for IRS 1075 services for
Data Boundary for IRS 1075 workloads.
...
Data Boundary for IRS 1075. It can be accessed at one of the following URLs:
...
requirements for Data Boundary for IRS 1075. Unsupported products are not recommended for use
...
Data Boundary for IRS 1075 folders. Other applicable organization policy constraints—even if
...
Description
Google Cloud console
To access the Google Cloud console when using the Data Boundary for IRS 1075 control package,
you have the option of using the
Jurisdictional Google Cloud console .
The Jurisdictional Google Cloud console is not required for Data Boundary for IRS 1075, and can be
...
connectors for Data Boundary for IRS 1075 workloads.
...
Set to deny the following Cloud Run functions generation that can be used to create new
Cloud Run functions resources:
1stGen
See
...
compliant with Data Boundary for IRS 1075.
What's next
