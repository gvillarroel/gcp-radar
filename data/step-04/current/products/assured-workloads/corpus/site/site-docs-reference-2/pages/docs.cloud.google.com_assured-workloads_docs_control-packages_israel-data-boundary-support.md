---
title: "Israel Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/israel-data-boundary-support
...
Israel Data Boundary and Support workloads in Assured Workloads. It provides
...
Israel Data Boundary and Support:
Data residency : The Israel Data Boundary and Support control package sets data
location controls to support
Israel-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Israel Data Boundary and Support workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Israel Data Boundary and Support workloads support cases are routed to
security-cleared Israeli Personnel located in Israel or security-cleared US
Persons located in the US; see
Getting support
for more information.
Pricing : The Israel Data Boundary and Support control package is included in
...
requirements for Israel Data Boundary and Support. Unsupported products are not recommended for use
...
Israel Data Boundary and Support folders. Other applicable organization policy constraints—even if
...
connectors for Israel Data Boundary and Support workloads.
...
Israel Data Boundary and Support supports the following service levels:
Standard
Premium
Extreme
...
Learn about the Israel Data Boundary
control package
