---
title: "EU Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/eu-regions-support
...
source_metadata:
  url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/eu-regions-support
  title: "EU Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud\
    \ Documentation"
...
EU Data Boundary and Support workloads in Assured Workloads. It provides
...
EU Data Boundary and Support:
Data residency : The EU Data Boundary and Support control package sets data
location controls to support
EU-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for EU Data Boundary and Support workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. EU Data Boundary and Support workloads support cases are routed to
EU personnel located in the EU; see
Getting support
for more information.
Pricing : The EU Data Boundary and Support control package is included in
...
requirements for EU Data Boundary and Support. Unsupported products are not recommended for use
...
EU Data Boundary and Support folders. Other applicable organization policy constraints—even if
...
To access the Google Cloud console when using the EU Data Boundary and Support control package,
you have the option of using the
Jurisdictional Google Cloud console .
The Jurisdictional Google Cloud console is not required for EU Data Boundary and Support, and can be
...
connectors for EU Data Boundary and Support workloads.
...
EU Data Boundary and Support supports the following service levels:
Standard
Premium
Extreme
Flex, for the File type only. The Unified type of the Flex service level
is not supported.
What's next
Learn how to create an Assured Workloads folder
Learn about the EU Data Boundary
control package
