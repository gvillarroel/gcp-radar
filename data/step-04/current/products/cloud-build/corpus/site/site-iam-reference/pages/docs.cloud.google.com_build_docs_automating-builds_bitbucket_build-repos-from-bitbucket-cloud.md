---
title: "Build repositories from Bitbucket Cloud \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/build/docs/automating-builds/bitbucket/build-repos-from-bitbucket-cloud
...
repositories hosted on Bitbucket Cloud .
You can execute builds in response to events such as commit pushes or
merge requests associated with your Bitbucket Cloud repository.
This page explains how you can enable build triggers for a
Bitbucket Cloud instance. For more information, see
Cloud Build triggers and
Cloud Build repositories .
Before you begin
Follow the instructions to connect to a Bitbucket Cloud host .
...
roles .
Enable the APIs
To create a trigger for a Bitbucket Cloud repository, you must have a connection
between Google Cloud and your repository. To create a connection through the
Bitbucket Cloud app in Google Cloud, see
...
Bitbucket Cloud installation.
Google Cloud console
To create Bitbucket Cloud triggers using the Google Cloud console, do the following:
...
Source : Configure information about your Bitbucket Cloud repository:
...
gcloud CLI
To create Bitbucket Cloud triggers using gcloud commands, run the following
command:
...
CONNECTION_NAME is the name of your Bitbucket Cloud connection.
...
API
To create a Bitbucket Cloud trigger with the API, use the
...
your Bitbucket Cloud installation using Developer Connect, see the
...
Data sharing
The data sent to Bitbucket Cloud from Cloud Build helps you identify
triggers by name and see build results on your Bitbucket Cloud repositories.
The following data is shared between Cloud Build and your Bitbucket
Cloud host:
