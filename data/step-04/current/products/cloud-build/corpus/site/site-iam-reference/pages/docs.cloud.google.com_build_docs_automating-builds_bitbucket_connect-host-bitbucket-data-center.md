---
title: "Connect to a Bitbucket Data Center host \_|\_ Cloud Build \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/build/docs/automating-builds/bitbucket/connect-host-bitbucket-data-center
...
1st gen
2nd gen
This page explains how to connect a
Bitbucket Data Center
host to Cloud Build. Connecting to a Bitbucket Data Center host integrates
your Bitbucket Data Center repositories with Cloud Build. This way, you
can configure build triggers to
build repositories from Bitbucket Data Center
and build repositories from Bitbucket Data Center in a private network .
Before you begin
...
your Bitbucket Data Center source repository.
If you haven't installed a Bitbucket Data Center instance, then see
Bitbucket Data Center installation guide for instructions.
Required IAM permissions
To get the permissions that
you need to connect to your Bitbucket Data Center host,
...
roles .
If your Bitbucket Data Center instance is hosted in a private network, see
...
Before you create a host connection for your Bitbucket Data Center instance,
create personal access tokens in Bitbucket Data Center by doing the following:
Sign in to your Bitbucket Data Center
instance.
...
connect to your Bitbucket Data Center repository.
...
Click Connect Host .
Select Bitbucket Data Center from the drop-down menu.
...
Username : Your Bitbucket Data Center account username. This account
should have admin access to the repositories that you want to
connect with Cloud Build.
Read access token : Enter your Bitbucket Data Center account personal
access token with read permissions.
Admin access token : Enter your Bitbucket Data Center account
...
Click Connect Host .
If your Bitbucket Data Center instance is on a peered network, connecting
...
network to connect to for your Bitbucket Data Center instances on-premises.
To learn more, see
Build repositories from Bitbucket Data Center in a private network .
...
your SSL certificate to use for requests to Bitbucket Data Center. The certificate should be in PEM format.
API
To connect your Bitbucket Data Center host to Cloud Build
...
Optional: PEERED_NETWORK is the VPC
network to peer to for your Bitbucket Data Center instances on-premises.
...
CONFIG_NAME is the name of your Bitbucket Data Center configuration.
...
Rotate old or expired Bitbucket Data Center access tokens
If your Bitbucket Data Center access token expires, then your Cloud Build host
connection is disconnected from its Bitbucket Data Center repository. As a result, you
will see errors in the following circumstances:
When you try to link a Bitbucket Data Center repository Cloud Build
connection, a
...
Where:
CONNECTION_PATH is the path of your Bitbucket Data Center
...
Rotate each access token in Bitbucket Data Center:
Go to the Bitbucket Data Center repository connected to your Cloud Build
host connection.
Follow the instructions in the Bitbucket documentation to
rotate an access token .
When you rotate a token, Bitbucket Data Center creates a new token with new
...
in the Bitbucket Data Center documentation.
What's next
