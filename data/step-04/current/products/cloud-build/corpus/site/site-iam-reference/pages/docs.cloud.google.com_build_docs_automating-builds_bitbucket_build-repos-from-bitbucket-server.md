---
title: "Build repositories from Bitbucket Server \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/build/docs/automating-builds/bitbucket/build-repos-from-bitbucket-server
...
repositories hosted on Bitbucket Server .
You can execute builds in response to events such as commit pushes or
merge requests associated with your Bitbucket Server repository.
This page explains how you can enable build triggers for a
Bitbucket Server instance. For more information, see
...
roles .
Enable the APIs
To create a trigger for a Bitbucket Server repository, you must have a connection
between Google Cloud and your repository. To create a connection through the
Bitbucket Server app in Google Cloud, see
Connect to a Bitbucket Server repository .
Create a Bitbucket Server trigger
This sections explains how you can connect your Bitbucket Server repositories
to Cloud Build and create a trigger to automatically invoke
builds on your connected repositories. If you want to use Bitbucket Server triggers in a private network, see Building repositories from Bitbucket Server in a private network for further instructions.
Google Cloud console
To create Bitbucket Server triggers using the Google Cloud console, do the following:
...
Source : Configure information about your Bitbucket Server repository:
...
gcloud CLI
To create Bitbucket Server triggers using gcloud commands, run the following
command:
...
CONNECTION_NAME is the name of your Bitbucket Server connection.
...
API
To create a Bitbucket Server trigger with the API, use the
...
your Bitbucket Server installation using Developer Connect, see the
