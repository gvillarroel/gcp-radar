...
title: "REST Resource: billingAccounts.budgets \_|\_ Cloud Billing \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/billing/docs/reference/budget/rest/v1beta1/billingAccounts.budgets
...
OwnershipScope
The ownership scope of a Budget . It determines which users have full-access to the Budget data, in addition to the permissions granted by their IAM role.
Enums
