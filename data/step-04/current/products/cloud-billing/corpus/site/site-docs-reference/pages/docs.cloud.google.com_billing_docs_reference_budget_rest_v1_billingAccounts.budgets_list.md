...
title: "Method: billingAccounts.budgets.list \_|\_ Cloud Billing \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/billing/docs/reference/budget/rest/v1/billingAccounts.budgets/list
...
HTTP request
GET https://billingbudgets.googleapis.com/v1/{parent=billingAccounts/*}/budgets
