---
title: "Class CreateBillingAccountRequest (1.18.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudbilling/latest/google.cloud.billing_v1.types.CreateBillingAccountRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/cloudbilling/latest/google.cloud.billing_v1.types.CreateBillingAccountRequest
  title: "Class CreateBillingAccountRequest (1.18.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class CreateBillingAccountRequest (1.18.0)
