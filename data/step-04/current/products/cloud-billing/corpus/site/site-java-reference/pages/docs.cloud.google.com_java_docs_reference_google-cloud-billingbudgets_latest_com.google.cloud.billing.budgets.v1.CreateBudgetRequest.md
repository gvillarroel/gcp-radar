---
title: "Class CreateBudgetRequest (2.88.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-billingbudgets/latest/com.google.cloud.billing.budgets.v1.CreateBudgetRequest
...
Client libraries
Send feedback
Class CreateBudgetRequest (2.88.0)
...
2.2.0
2.1.7
public final class CreateBudgetRequest extends GeneratedMessage implements CreateBudgetRequestOrBuilder
...
Descriptor
newBuilder()
public static CreateBudgetRequest . Builder newBuilder ()
Returns
Type
Description
CreateBudgetRequest.Builder
newBuilder(CreateBudgetRequest prototype)
public static CreateBudgetRequest . Builder newBuilder ( CreateBudgetRequest prototype )
Parameter
Name
Description
prototype
...
public static CreateBudgetRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateBudgetRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CreateBudgetRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CreateBudgetRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateBudgetRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CreateBudgetRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateBudgetRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CreateBudgetRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateBudgetRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateBudgetRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateBudgetRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CreateBudgetRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public CreateBudgetRequest getDefaultInstanceForType ()
Returns
Type
Description
CreateBudgetRequest
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CreateBudgetRequest . Builder newBuilderForType ()
Returns
Type
Description
CreateBudgetRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CreateBudgetRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CreateBudgetRequest . Builder toBuilder ()
Returns
Type
Description
CreateBudgetRequest.Builder
