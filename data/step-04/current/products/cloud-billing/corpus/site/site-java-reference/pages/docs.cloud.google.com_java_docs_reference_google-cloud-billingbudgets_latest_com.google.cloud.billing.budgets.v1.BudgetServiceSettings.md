---
title: "Class BudgetServiceSettings (2.88.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-billingbudgets/latest/com.google.cloud.billing.budgets.v1.BudgetServiceSettings
...
Client libraries
Send feedback
Class BudgetServiceSettings (2.88.0)
...
Static Methods
create(BudgetServiceStubSettings stub)
...
List < String >
newBuilder()
public static BudgetServiceSettings . Builder newBuilder ()
...
public static BudgetServiceSettings . Builder newBuilder ( ClientContext clientContext )
...
BudgetServiceSettings.Builder
newHttpJsonBuilder()
public static BudgetServiceSettings . Builder newHttpJsonBuilder ()
...
BudgetServiceSettings.Builder
Constructors
BudgetServiceSettings(BudgetServiceSettings.Builder settingsBuilder)
protected BudgetServiceSettings ( BudgetServiceSettings . Builder settingsBuilder )
Parameter
Name
Description
settingsBuilder
...
Type
Description
UnaryCallSettings < CreateBudgetRequest , Budget >
...
Type
Description
UnaryCallSettings < DeleteBudgetRequest , Empty >
getBudgetSettings()
...
Type
Description
UnaryCallSettings < GetBudgetRequest , Budget >
listBudgetsSettings()
...
Type
Description
PagedCallSettings < ListBudgetsRequest , ListBudgetsResponse , ListBudgetsPagedResponse >
toBuilder()
public BudgetServiceSettings . Builder toBuilder ()
...
Type
Description
UnaryCallSettings < UpdateBudgetRequest , Budget >
Send feedback
