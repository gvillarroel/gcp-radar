---
title: "Class CreateBudgetRequest.Builder (2.88.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-billingbudgets/latest/com.google.cloud.billing.budgets.v1.CreateBudgetRequest.Builder
...
Client libraries
Send feedback
Class CreateBudgetRequest.Builder (2.88.0)
...
2.2.0
2.1.7
public static final class CreateBudgetRequest . Builder extends GeneratedMessage . Builder<CreateBudgetRequest . Builder > implements CreateBudgetRequestOrBuilder
...
CreateBudgetRequest
buildPartial()
public CreateBudgetRequest buildPartial ()
Returns
Type
Description
CreateBudgetRequest
clear()
public CreateBudgetRequest . Builder clear ()
Returns
Type
Description
CreateBudgetRequest.Builder
...
clearBudget()
public CreateBudgetRequest . Builder clearBudget ()
...
CreateBudgetRequest.Builder
clearParent()
public CreateBudgetRequest . Builder clearParent ()
...
public CreateBudgetRequest . Builder mergeBudget ( Budget value )
Required. Budget to create.
.google.cloud.billing.budgets.v1.Budget budget = 2 [(.google.api.field_behavior) = REQUIRED];
Parameter
Name
...
Description
CreateBudgetRequest.Builder
mergeFrom(CreateBudgetRequest other)
public CreateBudgetRequest . Builder mergeFrom ( CreateBudgetRequest other )
Parameter
Name
Description
other
...
public CreateBudgetRequest . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public CreateBudgetRequest . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public CreateBudgetRequest . Builder setBudget ( Budget value )
Required. Budget to create.
.google.cloud.billing.budgets.v1.Budget budget = 2 [(.google.api.field_behavior) = REQUIRED];
Parameter
Name
...
public CreateBudgetRequest . Builder setBudget ( Budget . Builder builderForValue )
Required. Budget to create.
.google.cloud.billing.budgets.v1.Budget budget = 2 [(.google.api.field_behavior) = REQUIRED];
Parameter
Name
...
public CreateBudgetRequest . Builder setParent ( String value )
Required. The name of the billing account to create the budget in. Values
are of the form billingAccounts/{billingAccountId} .
string parent = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
...
public CreateBudgetRequest . Builder setParentBytes ( ByteString value )
Required. The name of the billing account to create the budget in. Values
are of the form billingAccounts/{billingAccountId} .
string parent = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
