---
title: "Class BillingAccountName (2.88.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-billingbudgets/latest/com.google.cloud.billing.budgets.v1.BillingAccountName
...
Client libraries
Send feedback
Class BillingAccountName (2.88.0)
...
boolean
newBuilder()
public static BillingAccountName . Builder newBuilder ()
Returns
Type
Description
...
toStringList(List<BillingAccountName> values)
...
Object.hashCode()
toBuilder()
public BillingAccountName . Builder toBuilder ()
Returns
Type
Description
BillingAccountName.Builder
