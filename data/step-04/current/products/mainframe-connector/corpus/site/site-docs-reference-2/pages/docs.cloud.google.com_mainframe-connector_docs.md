---
title: "Mainframe Connector documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/mainframe-connector/docs
...
Migration
Mainframe Connector
Mainframe Connector documentation
Read product documentation
Mainframe Connector lets you move data located on your mainframe in and out of
Cloud Storage and submit
BigQuery jobs from mainframe-based batch jobs,
defined by job control language (JCL).
...
Move locally transcoded data to Google Cloud
