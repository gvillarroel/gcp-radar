---
title: "Support Options for Geocoding API \_|\_ Google for Developers"
...
Resources
Send feedback
Support Options for Geocoding API
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Get help with the Geocoding API through Stack Overflow for technical questions and the Issue Tracker for bugs and feature requests.
Google Maps Platform offers support with varying response times based on the priority level and support plan chosen (Standard or Enhanced).
Enhanced Support provides faster response times, case escalation, video conferencing, SLA incident reports, and assistance with map data quality.
Users need a Google Cloud project with a linked billing account and enabled Google Maps Platform API to access support.
Billing Admins require project permissions to create support cases and may need to create a new project with necessary billing and API settings if they lack access.
Get help
...
Stack Overflow
to field technical questions about the Geocoding API. Stack Overflow is a
...
google-maps
to your search query. You can look for Geocoding API-specific topics by adding
google-geocoding-api . You may wish to add additional tags to your question
...
resolution times.
Bugs
If you think the cause of a problem is a bug in the Geocoding API, report it on
