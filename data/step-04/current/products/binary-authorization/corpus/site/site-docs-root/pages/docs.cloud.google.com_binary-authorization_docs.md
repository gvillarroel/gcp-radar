---
title: "Binary Authorization documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/binary-authorization/docs
...
End-to-end attestation tutorial (GKE)
Set up Binary Authorization on your platform
Create attestations in a Cloud Build pipeline
Configure a policy using Cloud console
Create attestors using Cloud console
Create attestations
...
Separation of duties and IAM roles
Custom roles
RPC API
info
Resources
