---
title: "Class ValidationHelperV1AsyncClient (1.15.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/binaryauthorization/latest/google.cloud.binaryauthorization_v1.services.validation_helper_v1.ValidationHelperV1AsyncClient
...
Client libraries
Send feedback
Class ValidationHelperV1AsyncClient (1.15.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the ValidationHelperV1Transport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.binaryauthorization_v1.types.ValidateAttestationOccurrenceRequest , dict]]
