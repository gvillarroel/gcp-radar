...
url: https://docs.cloud.google.com/python/docs/reference/binaryauthorization/latest
...
Enable the Binary Authorization.
...
pip install google-cloud-binary-authorization
Next Steps
Read the Client Library Documentation for Binary Authorization
to see other available methods on the client.
Read the Binary Authorization Product documentation to learn
