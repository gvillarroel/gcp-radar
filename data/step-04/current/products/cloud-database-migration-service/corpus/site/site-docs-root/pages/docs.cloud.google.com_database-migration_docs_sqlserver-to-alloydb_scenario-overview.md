---
title: "Database Migration Service for heterogeneous SQL Server to AlloyDB for PostgreSQL\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/database-migration/docs/sqlserver-to-alloydb/scenario-overview
...
SQL Server to Cloud SQL for AlloyDB
Guides
Send feedback
...
Supported sources and destinations lists all SQL Server
...
after migrating to AlloyDB for PostgreSQL.
...
and then loads the data to the AlloyDB for PostgreSQL destination cluster.
...
so that it uses the AlloyDB for PostgreSQL destination cluster as the
production database.
...
destination AlloyDB for PostgreSQL cluster after you complete the migration. This feature
keeps your original source database alive and up to date in case
