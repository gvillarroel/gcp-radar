---
title: "Oracle to Cloud SQL for PostgreSQL migration overview \_|\_ Database Migration\
  \ Service for heterogeneous Oracle to Cloud SQL for PostgreSQL \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/database-migration/docs/oracle-to-postgresql/scenario-overview
...
Guides
Send feedback
Oracle to Cloud SQL for PostgreSQL migration overview
...
database log files
Figure 1. Continuous data movement during a Database Migration Service heterogeneous migration from Oracle to Cloud SQL for PostgreSQL. (click to enlarge)
...
Oracle to Cloud SQL for PostgreSQL migration guide .
Monitoring
