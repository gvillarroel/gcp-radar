---
title: "Use the Database Migration Service remote MCP server \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/database-migration/docs/use-database-migration-service-mcp
...
source_metadata:
  url: https://docs.cloud.google.com/database-migration/docs/use-database-migration-service-mcp
  title: "Use the Database Migration Service remote MCP server \_|\_ Google Cloud\
    \ Documentation"
...
This document shows you how to use the Database Migration Service remote Model Context
...
The Database Migration Service remote MCP server lets you manage migration jobs from your
AI application. You can start, stop, resume, or delete migration jobs with
Database Migration Service remote MCP server.
.
The Database Migration Service remote MCP server is enabled when you
...
you need to to use the Database Migration Service remote MCP server,
...
Database Migration Service Admin ( roles/datamigration.admin )
For more information about granting roles, see Manage access to projects, folders, and organizations .
These predefined roles contain
the permissions required to to use the Database Migration Service remote MCP server. To see the exact permissions that are
required, expand the Required permissions section:
Required permissions
The following permissions are required to to use the Database Migration Service remote MCP server:
Make MCP tool calls:
mcp.tools.call
Database Migration Service resources:
...
The Database Migration Service remote MCP server uses the
OAuth 2.0
protocol with
...
tools so that access to resources can be controlled and monitored.
Database Migration Service does not accept API keys for authentication to MCP servers.
For more information about
authentication, see
Authenticate to MCP servers .
Database Migration Service MCP OAuth scopes
...
Database Migration Service has the following MCP tool OAuth scopes:
Scope URI for gcloud CLI
Description
https://www.googleapis.com/auth/cloud-platform
Allows access to all Google Cloud resources, including Database Migration Service.
https://www.googleapis.com/auth/cloud-datamigration
Allows viewing and managing data in Database Migration Service.
...
Configure an MCP client to use the Database Migration Service MCP server
...
For the Database Migration Service MCP server, enter the following as
required:
Server name : Database Migration Service MCP server
Server URL or Endpoint : datamigration.googleapis.com/mcp
Transport : HTTP
...
Authenticate to MCP servers .
OAuth scope : the
OAuth 2.0 scope that you want to use when connecting
to the Database Migration Service MCP server.
...
Database Migration Service MCP server, see the
Database Migration Service MCP reference .
List tools
Use the
MCP inspector to list tools, or send a
tools/list HTTP request directly to the Database Migration Service
...
Example use cases
The following are example use cases for the Database Migration Service
MCP server:
List, get, start, and delete migration jobs in your project.
List static IP addresses that Database Migration Service connects from to your source
database during heterogeneous migrations .
Use the get_operation tool to poll the status of operations such as
starting or deleting a migration job.
Example prompts:
...
MIGRATION_JOB_ID with your Database Migration Service migration job identifier.
...
What's next
Read the
Database Migration Service MCP reference documentation
Learn more about
