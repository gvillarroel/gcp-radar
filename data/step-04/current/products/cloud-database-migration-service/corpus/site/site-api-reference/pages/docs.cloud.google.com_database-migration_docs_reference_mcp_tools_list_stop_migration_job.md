...
url: https://docs.cloud.google.com/database-migration/docs/reference/mcp/tools_list/stop_migration_job
...
The following sample demonstrate how to use curl to invoke the stop_migration_job MCP tool.
Curl Request
