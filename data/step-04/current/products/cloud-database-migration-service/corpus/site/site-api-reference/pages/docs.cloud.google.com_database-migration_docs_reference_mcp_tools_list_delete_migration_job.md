...
url: https://docs.cloud.google.com/database-migration/docs/reference/mcp/tools_list/delete_migration_job
...
The following sample demonstrate how to use curl to invoke the delete_migration_job MCP tool.
Curl Request
