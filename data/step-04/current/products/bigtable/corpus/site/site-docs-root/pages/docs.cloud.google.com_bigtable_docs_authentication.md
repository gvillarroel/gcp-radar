---
title: "Authenticate to Bigtable \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigtable/docs/authentication
...
This document describes how to authenticate to Bigtable programmatically. How
you authenticate to Bigtable depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Bigtable supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
Client libraries
The Bigtable client libraries provide
high-level language support for authenticating to Bigtable
programmatically.
...
For more information about using the gcloud CLI with Bigtable,
...
Access control for Bigtable
After you authenticate to Bigtable, you must be authorized to access
Google Cloud resources. Bigtable uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Bigtable, see
