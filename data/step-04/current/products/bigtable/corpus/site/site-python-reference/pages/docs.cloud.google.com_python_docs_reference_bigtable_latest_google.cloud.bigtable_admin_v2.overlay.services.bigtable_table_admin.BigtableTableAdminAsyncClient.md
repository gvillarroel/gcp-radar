---
title: "Class BigtableTableAdminAsyncClient (2.35.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/bigtable/latest/google.cloud.bigtable_admin_v2.overlay.services.bigtable_table_admin.BigtableTableAdminAsyncClient
...
Client libraries
Send feedback
Class BigtableTableAdminAsyncClient (2.35.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the BigtableTableAdminTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CheckConsistencyRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CopyBackupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CreateAuthorizedViewRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CreateBackupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CreateSchemaBundleRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CreateTableRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.CreateTableFromSnapshotRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DeleteAuthorizedViewRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DeleteBackupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DeleteSchemaBundleRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DeleteSnapshotRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DeleteTableRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.DropRowRangeRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GenerateConsistencyTokenRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GetAuthorizedViewRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GetBackupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GetSchemaBundleRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GetSnapshotRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.GetTableRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ListAuthorizedViewsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ListBackupsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ListSchemaBundlesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ListSnapshotsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ListTablesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.ModifyColumnFamiliesRequest , dict]]
...
modifications
:class: MutableSequence[ google.cloud.bigtable_admin_v2.types.ModifyColumnFamiliesRequest.Modification ]
...
Additionally, the returned :class: long-running-operation <<xref uid="google.cloud.bigtable_admin_v2.overlay.types">google.cloud.bigtable_admin_v2.overlay.types</xref>.async_restore_table.AsyncRestoreTableOperation>
provides a method, xref_optimize_restore_table_operation that
provides access to a google.api_core.operation_async.AsyncOperation object representing the OptimizeRestoreTable long-running-operation
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.SnapshotTableRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.UndeleteTableRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.UpdateAuthorizedViewRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.UpdateBackupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.UpdateSchemaBundleRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.bigtable_admin_v2.types.UpdateTableRequest , dict]]
