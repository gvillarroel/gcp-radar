...
title: "MCP Tools Reference: bigtableadmin.googleapis.com \_|\_ Bigtable \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/bigtable/docs/reference/admin/mcp/tools_list/list_tables
...
The following sample demonstrate how to use curl to invoke the list_tables MCP tool.
Curl Request
