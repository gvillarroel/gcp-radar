---
title: "Class CreateExecutionRequest (2.88.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-workflow-executions/latest/com.google.cloud.workflows.executions.v1.CreateExecutionRequest
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-workflow-executions/latest/com.google.cloud.workflows.executions.v1.CreateExecutionRequest
  title: "Class CreateExecutionRequest (2.88.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
Class CreateExecutionRequest (2.88.0)
...
2.2.1
2.1.7
public final class CreateExecutionRequest extends GeneratedMessage implements CreateExecutionRequestOrBuilder
Request for the
CreateExecution
method.
Protobuf type google.cloud.workflows.executions.v1.CreateExecutionRequest
Inheritance
Object >
...
Static Methods
getDefaultInstance()
public static CreateExecutionRequest getDefaultInstance ()
Returns
Type
Description
CreateExecutionRequest
...
Descriptor
newBuilder()
public static CreateExecutionRequest . Builder newBuilder ()
Returns
Type
Description
CreateExecutionRequest.Builder
newBuilder(CreateExecutionRequest prototype)
public static CreateExecutionRequest . Builder newBuilder ( CreateExecutionRequest prototype )
Parameter
Name
Description
prototype
...
public static CreateExecutionRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateExecutionRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CreateExecutionRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CreateExecutionRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateExecutionRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CreateExecutionRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateExecutionRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CreateExecutionRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateExecutionRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateExecutionRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateExecutionRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CreateExecutionRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CreateExecutionRequest> parser ()
Returns
Type
Description
Parser < CreateExecutionRequest >
Methods
equals(Object obj)
...
getParserForType()
public Parser<CreateExecutionRequest> getParserForType ()
Returns
Type
Description
Parser < CreateExecutionRequest >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CreateExecutionRequest . Builder newBuilderForType ()
Returns
Type
Description
CreateExecutionRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CreateExecutionRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CreateExecutionRequest . Builder toBuilder ()
Returns
Type
Description
CreateExecutionRequest.Builder
