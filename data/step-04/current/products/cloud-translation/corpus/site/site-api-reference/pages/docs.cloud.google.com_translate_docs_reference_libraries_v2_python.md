---
title: "Python client library \_|\_ Cloud Translation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/translate/docs/reference/libraries/v2/python
...
Description
Library reference
Cloud Translation Python library reference
Language guide
...
Stack Overflow
Questions tagged with Cloud Translation and Python
Installation
...
To use the Python client library for Cloud Translation - Basic, you must
import the Cloud Translation API client library as follows:
from google.cloud import translate _v2
See how to
translate text
