---
title: "Reporting & Monitoring Overview \_|\_ Places SDK for iOS \_|\_ Google for\
  \ Developers"
url: https://developers.google.com/maps/documentation/places/ios-sdk/report-monitor
...
Page Summary
outlined_flag
Regularly review your Google Maps Platform API usage, quota, and billing information to control costs, stay within limits, and identify unexpected application interactions.
Google Maps Platform provides Reporting and Monitoring tools for reviewing this information; Reporting offers predefined visual reports for basic insights, while Monitoring allows for customized dashboards and alerts.
Quotas limit the number of API requests your project can make daily, per minute, and per user per minute, applying to successful and server error requests but excluding authentication failures.
Cloud Monitoring enables you to track API usage and quota consumption, create custom dashboards with charts, and define alerts for specific metric thresholds or quota limits.
Utilize Cloud Billing reports to analyze your Google Cloud Platform costs, identify spending trends, and forecast future expenses based on historical data.
