...
title: "GooglePlaces Framework Reference \_|\_ Places SDK for iOS \_|\_ Google for\
  \ Developers"
url: https://developers.google.com/maps/documentation/places/ios-sdk/reference/objc/Classes/GMSAutocompletePrediction
...
Page Summary
outlined_flag
GMSAutocompletePrediction objects represent predicted search queries based on partial user input.
Predictions include attributed text for the full description, primary text (place name), and secondary text (location).
Each prediction provides a placeID for detailed place information requests and an array of types describing the result.
Optionally, distanceMeters indicates the distance from the origin specified in the request's filter.
...
Objective-C
@property ( nonatomic , copy , readonly ) __GMS_AVAILABLE_BUT_DEPRECATED_MSG NSAttributedString * attributedFullText ;
...
Objective-C
@property ( nonatomic , copy , readonly ) __GMS_AVAILABLE_BUT_DEPRECATED_MSG NSAttributedString * attributedPrimaryText ;
...
Objective-C
@property ( nonatomic , copy , readonly ) __GMS_AVAILABLE_BUT_DEPRECATED_MSG NSString * placeID ;
types
Deprecated
Use GMSAutocompleteSuggestion instead.
...
Objective-C
@property ( nonatomic , copy , readonly ) __GMS_AVAILABLE_BUT_DEPRECATED_MSG NSArray < NSString *> * types ;
distanceMeters
Deprecated
Use GMSAutocompleteSuggestion instead.
