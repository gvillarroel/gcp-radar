---
title: "Places Types (New) \_|\_ Places SDK for iOS \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/places/ios-sdk/place-types
...
You must enable Places API (New) in your
Google Cloud project to access these types.
For more information, see Set up your Google Cloud
project .
...
property of the GMSPlace instance. The request must specify
GMSPlacePropertyTypes in the field list.
As part of a Nearby Search (New) request, used as
the value of the included types, excluded types,
included primary types, and excluded primary types parameter.
