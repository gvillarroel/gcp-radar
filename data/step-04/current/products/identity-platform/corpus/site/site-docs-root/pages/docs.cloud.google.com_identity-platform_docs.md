---
title: "Identity Platform documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity-platform/docs
...
Identity Platform provides backend services, SDKs, and UI libraries that make
it easier to authenticate users to your apps and services.
Go to the Identity Platform product page for more.
...
Guides
Quickstart: Sign in a user with an email by using Identity Platform
