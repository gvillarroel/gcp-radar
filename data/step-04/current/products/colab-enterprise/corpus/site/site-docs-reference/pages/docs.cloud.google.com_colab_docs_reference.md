---
title: "Vertex AI API usage overview \_|\_ Colab Enterprise \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/colab/docs/reference
...
Vertex AI API usage overview
You can interact with Colab Enterprise by using the Vertex AI API.
This guide provides an overview of using the Vertex AI API
and its reference documentation. To learn more,
see the Vertex AI
