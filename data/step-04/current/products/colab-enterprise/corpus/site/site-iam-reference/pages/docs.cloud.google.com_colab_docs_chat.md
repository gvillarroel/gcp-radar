---
title: "Chat about your notebook with Gemini \_|\_ Colab Enterprise \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/colab/docs/chat
...
source_metadata:
  url: https://docs.cloud.google.com/colab/docs/chat
  title: "Chat about your notebook with Gemini \_|\_ Colab Enterprise \_|\_ Google\
    \ Cloud Documentation"
...
Click the
Toggle
Gemini in Colab button to open the chat dialog.
In the Gemini dialog, enter a prompt to begin
your chat.
...
Gemini responds to your prompt. The response can
...
To copy a suggested code snippet, click the
Copy
button. Then paste the code into a code cell in your notebook.
To add a suggested code snippet as a new code cell in your notebook,
click the
Add
code cell button.
