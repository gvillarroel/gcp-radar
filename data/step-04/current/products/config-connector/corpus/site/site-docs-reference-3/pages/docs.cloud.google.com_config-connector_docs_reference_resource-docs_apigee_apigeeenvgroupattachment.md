---
title: "ApigeeEnvgroupAttachment \_|\_ Config Connector \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/config-connector/docs/reference/resource-docs/apigee/apigeeenvgroupattachment
...
/apigee/docs/reference/apis/apigee/rest/v1/organizations.envgroups.attachments
Config Connector Resource Short Names
gcpapigeeenvgroupattachment gcpapigeeenvgroupattachments apigeeenvgroupattachment
Config Connector Service Name
apigee.googleapis.com
Config Connector Resource Fully Qualified Name
apigeeenvgroupattachments.apigee.cnrm.cloud.google.com
...
envgroupRef.external
Optional
string
A reference to an externally managed ApigeeEnvgroup resource. Should be in the format "organizations/{{organizationID}}/envgroups/{{envgroupID}}".
envgroupRef.name
Optional
string
The name of a ApigeeEnvgroup resource.
envgroupRef.namespace
Optional
string
