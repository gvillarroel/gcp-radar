---
title: "Python Client for Database Center API \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/google-cloud-databasecenter/latest
...
Client libraries
Send feedback
Python Client for Database Center API
...
0.2.0
0.1.0
Database Center API : Database Center offers a comprehensive, organization-wide platform for
...
Enable the Database Center API.
...
pip install google-cloud-databasecenter
Windows
py -m venv <your-env>
.\<your-env>\Scripts\activate
pip install google-cloud-databasecenter
Next Steps
Read the Client Library Documentation for Database Center API
to see other available methods on the client.
Read the Database Center API Product documentation to learn
