---
title: "Class DatabaseCenterClient (0.7.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/google-cloud-databasecenter/latest/google.cloud.databasecenter_v1beta.services.database_center.DatabaseCenterClient
...
Client libraries
Send feedback
Class DatabaseCenterClient (0.7.0)
...
Instantiates the database center client.
Parameters
Name
Description
credentials
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the DatabaseCenterTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
google . cloud . databasecenter_v1beta . services . database_center . pagers . AggregateFleetPager
)
...
Description
request
Union[ google.cloud.databasecenter_v1beta.types.AggregateFleetRequest , dict]
...
Description
request
Union[ google.cloud.databasecenter_v1beta.types.AggregateIssueStatsRequest , dict]
...
google . cloud . databasecenter_v1beta . services . database_center . pagers . QueryDatabaseResourceGroupsPager
)
...
Description
request
Union[ google.cloud.databasecenter_v1beta.types.QueryDatabaseResourceGroupsRequest , dict]
...
google . cloud . databasecenter_v1beta . services . database_center . pagers . QueryIssuesPager
)
...
Description
request
Union[ google.cloud.databasecenter_v1beta.types.QueryIssuesRequest , dict]
...
google . cloud . databasecenter_v1beta . services . database_center . pagers . QueryProductsPager
)
...
Description
request
Union[ google.cloud.databasecenter_v1beta.types.QueryProductsRequest , dict]
