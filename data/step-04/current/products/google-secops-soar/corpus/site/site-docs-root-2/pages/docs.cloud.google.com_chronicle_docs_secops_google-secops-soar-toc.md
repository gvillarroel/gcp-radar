---
title: "SOAR table of contents \_|\_ Google Security Operations \_|\_ Google Cloud\
  \ Documentation"
...
Click
at the top of each SOAR document to return to this table of contents.
Google SecOps SOAR
Product overview
Getting started
...
Working with cases
Cases overview
Explore the cases page layout and options
Explore the case queue header
Review case-level data in the Overview tab
Create custom fields (Admin)
Case Wall tab
...
Define custom alert views using Playbook Designer
