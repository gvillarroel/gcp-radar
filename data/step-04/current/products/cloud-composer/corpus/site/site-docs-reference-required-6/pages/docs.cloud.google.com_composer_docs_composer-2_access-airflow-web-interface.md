...
url: https://docs.cloud.google.com/composer/docs/composer-2/access-airflow-web-interface
...
In Cloud Composer 2, the Airflow web server runs
...
the Airflow UI.
Cloud Composer 2 provides access to the interface based on user identities
and IAM policy bindings defined for users. Compared to
Cloud Composer 1, Cloud Composer 2 uses a different mechanism that does not
rely on Identity-Aware Proxy.
