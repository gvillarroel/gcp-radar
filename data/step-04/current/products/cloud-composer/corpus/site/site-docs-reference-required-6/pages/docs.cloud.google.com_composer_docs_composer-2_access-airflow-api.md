...
url: https://docs.cloud.google.com/composer/docs/composer-2/access-airflow-api
...
Note: For Workforce Identity Federation configurations : Service
accounts are considered Google Accounts, even if you use
Workforce Identity Federation. When interacting with Airflow UI using a
service account, make sure that you use the URLs dedicated to
Google Accounts. For more information, see
