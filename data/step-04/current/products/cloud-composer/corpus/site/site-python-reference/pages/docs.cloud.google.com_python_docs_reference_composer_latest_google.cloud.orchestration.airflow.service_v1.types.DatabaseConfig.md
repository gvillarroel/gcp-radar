---
title: "Class DatabaseConfig (1.19.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/composer/latest/google.cloud.orchestration.airflow.service_v1.types.DatabaseConfig
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/composer/latest/google.cloud.orchestration.airflow.service_v1.types.DatabaseConfig
  title: "Class DatabaseConfig (1.19.0) \_|\_ Python client libraries \_|\_ Google\
    \ Cloud Documentation"
...
1.0.0
0.1.3
DatabaseConfig ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
