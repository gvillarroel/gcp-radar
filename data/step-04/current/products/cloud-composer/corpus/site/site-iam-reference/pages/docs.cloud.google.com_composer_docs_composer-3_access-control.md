...
To use gcloud CLI with Cloud Composer environments,
you need the composer.environments.get permission.
If you want to run Airflow CLI commands, you need the following additional
permission: composer.environments.executeAirflowCommand .
If you want to manage environments or environment buckets with
Google Cloud CLI commands, you also must have a role that has
