...
url: https://docs.cloud.google.com/composer/docs/composer-3/access-environments-with-workforce-identity-federation
...
Airflow REST API
Before you begin
You don't need to configure your environment in any specific way to
support Workforce Identity Federation. All Airflow builds in
Cloud Composer 3 support Workforce Identity Federation.
