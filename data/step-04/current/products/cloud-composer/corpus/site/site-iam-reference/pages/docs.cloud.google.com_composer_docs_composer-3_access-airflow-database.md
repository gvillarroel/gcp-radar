...
url: https://docs.cloud.google.com/composer/docs/composer-3/access-airflow-database
...
Deprecated: This approach is deprecated starting from Airflow version 3.1.7
where there is no direct access to the Airflow database from a DAG. You can
still use this approach in Airflow 3.1.0 and Airflow 2.
