...
url: https://docs.cloud.google.com/composer/docs/composer-1/configure-scheduled-snapshots
...
In Cloud Composer 1, you can only
save snapshots of your environment. You
can do so to
