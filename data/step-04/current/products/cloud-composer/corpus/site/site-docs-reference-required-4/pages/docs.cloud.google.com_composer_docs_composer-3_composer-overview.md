...
url: https://docs.cloud.google.com/composer/docs/composer-3/composer-overview
...
Connecting an environment to your VPC network
...
Data lineage integration with Knowledge Catalog
