...
url: https://docs.cloud.google.com/composer/docs/composer-3/composer-security-overview
...
Private IP networking configuration . It is also
...
configure your VPC network , a Private IP environment
