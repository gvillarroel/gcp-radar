...
url: https://docs.cloud.google.com/composer/docs/composer-3/airflow-rbac
...
The scheduler applies DAG-level permissions when it parses a DAG.
dag = DAG (
access_control = {
...
Airflow 3
In Airflow 3, you can view audit logs on the Browse >
Audit Log page in the Airflow UI.
Figure 1. An entry on the Audit Logs page
in Airflow 3
Airflow 2
You can view audit logs on the Browse > Audit Logs page
in the Airflow UI.
Figure 1. An entry on the Audit Logs page
in Airflow 2
