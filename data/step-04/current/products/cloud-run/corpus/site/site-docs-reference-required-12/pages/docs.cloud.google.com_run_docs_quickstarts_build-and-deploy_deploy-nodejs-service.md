---
title: "Quickstart: Build and deploy a Node.js web app to Google Cloud with Cloud\
  \ Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-nodejs-service
...
In the same directory, create a index.js file, and copy the following
lines into it:
