---
title: "Quickstart: Build and deploy a Ruby web app to Google Cloud with Cloud Run\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-ruby-service
...
Create a file name Gemfile and copy the following into it:
...
gem "puma" , "~> 6.6"
gem "rackup" , "~> 1.0"
If you don't have Bundler 2.0 or greater installed,
install Bundler .
