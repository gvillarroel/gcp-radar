---
title: "Quickstart: build and create a Go job in Cloud Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/jobs/build-create-go
...
mkdir jobs
cd jobs
In the same directory, create a main.go file for the actual job code. Copy
...
Success: You created and executed a job using the Go runtime in Cloud Run.
Clean up
