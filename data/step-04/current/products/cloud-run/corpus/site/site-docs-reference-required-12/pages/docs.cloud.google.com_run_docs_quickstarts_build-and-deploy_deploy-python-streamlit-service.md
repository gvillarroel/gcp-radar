---
title: "Quickstart: Deploy a Python (Streamlit) web app to Google Cloud with Cloud\
...
Quickstart: Build and deploy a Python (Streamlit) web app to Cloud Run
...
handling is done by the Streamlit web service in the container.
Create a file named requirements.txt and paste the following code into it:
streamlit~=1.0
This code adds the Streamlit package needed by the sample.
