---
title: "Quickstart: Build and deploy a Nuxt.js web app to Google Cloud with Cloud\
  \ Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/frameworks/deploy-nuxtjs-service
...
Quickstart: Build and deploy a Nuxt.js web app to Cloud Run
...
You can deploy an existing Nuxt.js app to Cloud Run. To create and deploy a new Nuxt.js service, follow these steps:
To create a new Nuxt.js project named helloworld , use the command:
npx - y nuxi @3 init helloworld -- no - install
Press Enter when prompted to accept the defaults.
Change directory into helloworld :
cd helloworld
Run install command to fix any dependency mismatch:
npm install
...
Success: You deployed a Nuxt.js web app to Cloud Run.
Cloud Run locations
