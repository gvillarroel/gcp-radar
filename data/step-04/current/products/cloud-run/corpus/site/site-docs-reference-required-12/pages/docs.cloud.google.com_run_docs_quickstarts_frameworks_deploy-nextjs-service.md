---
title: "Quickstart: Build and deploy a Next.js web app to Google Cloud with Cloud\
  \ Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/frameworks/deploy-nextjs-service
...
server-rendered Next.js apps, consider using
...
To create a new Next.js project named helloworld , use the command:
