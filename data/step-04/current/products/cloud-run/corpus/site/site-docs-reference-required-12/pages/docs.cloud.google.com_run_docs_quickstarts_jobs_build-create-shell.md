---
title: "Quickstart: build and create a Shell job in Cloud Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/jobs/build-create-shell
...
source_metadata:
  url: https://docs.cloud.google.com/run/docs/quickstarts/jobs/build-create-shell
  title: "Quickstart: build and create a Shell job in Cloud Run \_|\_ Google Cloud\
    \ Documentation"
...
CMD [ "./script.sh" ]
In the same directory, create a script.sh file for the actual job code. Copy
...
Success: You created and executed a job using Shell script in Cloud Run.
Clean up
