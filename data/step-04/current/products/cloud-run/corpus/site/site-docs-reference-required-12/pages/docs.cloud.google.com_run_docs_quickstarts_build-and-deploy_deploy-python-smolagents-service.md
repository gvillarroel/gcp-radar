---
title: "Quickstart: Build and deploy a Python (smolagents) web app to Cloud Run \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-python-smolagents-service
...
source_metadata:
  url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-python-smolagents-service
  title: "Quickstart: Build and deploy a Python (smolagents) web app to Cloud Run\
...
This document shows you how to build and deploy a smolagents application to
Cloud Run.
...
You require an API key from Google AI Studio to deploy the smolagents app
...
Success: You deployed a smolagents web app to Cloud Run.
