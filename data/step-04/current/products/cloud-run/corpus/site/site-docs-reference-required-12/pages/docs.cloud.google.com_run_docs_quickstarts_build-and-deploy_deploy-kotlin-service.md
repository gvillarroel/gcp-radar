---
title: "Quickstart: Build and deploy a Kotlin web app to Google Cloud with Cloud Run\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-kotlin-service
...
source_metadata:
  url: https://docs.cloud.google.com/run/docs/quickstarts/build-and-deploy/deploy-kotlin-service
  title: "Quickstart: Build and deploy a Kotlin web app to Google Cloud with Cloud\
...
Quickstart: Build and deploy a Kotlin web app to Cloud Run
...
WSL (preferred)
cygwin
Update the DemoApplication class in
src/main/kotlin/DemoApplication.kt by adding
a @RestController to handle the / mapping:
package demo
...
Set the server port to be defined by the PORT environment variable in the application.properties :
server . port = $ { PORT : 8080 }
This code creates a basic web server that listens on the port defined by
the PORT environment variable .
Create a project.toml file in the root directory to specify a Java version:
[[build.env]]
name = "GOOGLE_RUNTIME_VERSION"
value = "21"
Your app is finished and ready to be deployed.
Note: To deploy Kotlin to Cloud Run with other frameworks, review the
Kotlin samples .
...
Success: You deployed a Kotlin web app to Cloud Run.
Cloud Run locations
