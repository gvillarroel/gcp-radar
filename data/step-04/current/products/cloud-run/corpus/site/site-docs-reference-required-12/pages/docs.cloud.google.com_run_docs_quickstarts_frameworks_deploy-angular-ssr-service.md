---
title: "Quickstart: Build and deploy a Angular SSR web app to Google Cloud with Cloud\
  \ Run \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/run/docs/quickstarts/frameworks/deploy-angular-ssr-service
...
source_metadata:
  url: https://docs.cloud.google.com/run/docs/quickstarts/frameworks/deploy-angular-ssr-service
  title: "Quickstart: Build and deploy a Angular SSR web app to Google Cloud with\
...
Quickstart: Build and deploy a Angular SSR web app to Cloud Run
...
Note: For automatic GitHub integration and optimized deployments with CDN for
server-rendered Angular apps, consider using
...
If you don't have Node.js 20 or greater installed,
install Node.js .
...
You can deploy an existing Angular SSR app to Cloud Run. To create and
deploy a new Angular SSR service, follow these steps:
To create a new Angular SSR project named helloworld , use the command:
npx - y @ angular / cli @21 new helloworld -- ssr
Press Enter when prompted to accept the defaults.
Change directory into helloworld :
cd helloworld
...
Success: You deployed a Angular SSR web app to Cloud Run.
Cloud Run locations
...
For automatic GitHub integration and optimized deployments with CDN for
server-rendered Angular apps, consider using
Firebase App Hosting .
Send feedback
