---
title: "Class BuildInfo (0.88.0) \_|\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-run/latest/com.google.cloud.run.v2.BuildInfo
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-run/latest/com.google.cloud.run.v2.BuildInfo
  title: "Class BuildInfo (0.88.0) \_|\_ Java client libraries \_|\_ Google Cloud\
    \ Documentation"
...
0.2.1
0.1.2
public final class BuildInfo extends GeneratedMessage implements BuildInfoOrBuilder
...
Descriptor
newBuilder()
public static BuildInfo . Builder newBuilder ()
Returns
Type
Description
BuildInfo.Builder
newBuilder(BuildInfo prototype)
public static BuildInfo . Builder newBuilder ( BuildInfo prototype )
Parameter
Name
Description
prototype
...
public static BuildInfo parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static BuildInfo parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static BuildInfo parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static BuildInfo parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static BuildInfo parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static BuildInfo parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static BuildInfo parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static BuildInfo parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static BuildInfo parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static BuildInfo parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static BuildInfo parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
GeneratedMessage.isInitialized()
newBuilderForType()
public BuildInfo . Builder newBuilderForType ()
Returns
Type
Description
BuildInfo.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected BuildInfo . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public BuildInfo . Builder toBuilder ()
Returns
Type
Description
BuildInfo.Builder
