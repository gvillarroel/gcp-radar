---
title: "google-cloud-run overview (0.88.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-run/latest/overview
...
Client libraries
Send feedback
google-cloud-run overview (0.88.0)
...
libraryDependencies += "com.google.cloud" % "google-cloud-run" % "0.88.0"
Which version ID should I get started with?
For this library, we recommend using com.google.cloud.run.v2 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Run). New Version IDs are introduced infrequently, and often involve
