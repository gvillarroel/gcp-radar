---
title: "Class RevisionsClient (0.16.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.revisions.RevisionsClient
...
Description
request
Union[ google.cloud.run_v2.types.DeleteRevisionRequest , dict]
...
Description
request
Union[ google.cloud.run_v2.types.GetRevisionRequest , dict]
...
Description
request
Union[ google.cloud.run_v2.types.ListRevisionsRequest , dict]
