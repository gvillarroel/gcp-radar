---
title: "Class BuildsClient (0.16.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.builds.BuildsClient
...
Description
request
Union[ google.cloud.run_v2.types.SubmitBuildRequest , dict]
