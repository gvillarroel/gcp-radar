---
title: "Class ExecutionsClient (0.16.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/run/latest/google.cloud.run_v2.services.executions.ExecutionsClient
...
Description
request
Union[ google.cloud.run_v2.types.CancelExecutionRequest , dict]
...
Description
request
Union[ google.cloud.run_v2.types.DeleteExecutionRequest , dict]
The request object. Request message for deleting an Execution.
name
str
...
Description
request
Union[ google.cloud.run_v2.types.GetExecutionRequest , dict]
...
Description
request
Union[ google.cloud.run_v2.types.ListExecutionsRequest , dict]
