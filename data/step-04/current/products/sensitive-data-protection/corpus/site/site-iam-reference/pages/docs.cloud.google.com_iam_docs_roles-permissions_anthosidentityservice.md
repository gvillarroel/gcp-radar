---
title: "GKE Identity Service roles and permissions \_|\_ Identity and Access Management\
  \ (IAM) \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/roles-permissions/anthosidentityservice
...
Reference
Send feedback
GKE Identity Service roles and permissions
Stay organized with collections
Save and categorize content based on your preferences.
This page lists the IAM roles and permissions for GKE Identity Service. To
search through all roles and permissions, see the role and
permission index .
GKE Identity Service roles
GKE Identity Service offers the following service agent roles.
