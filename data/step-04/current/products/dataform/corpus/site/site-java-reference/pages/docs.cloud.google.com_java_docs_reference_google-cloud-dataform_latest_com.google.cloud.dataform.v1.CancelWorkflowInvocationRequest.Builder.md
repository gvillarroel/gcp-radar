---
title: "Class CancelWorkflowInvocationRequest.Builder (0.87.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/com.google.cloud.dataform.v1.CancelWorkflowInvocationRequest.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/com.google.cloud.dataform.v1.CancelWorkflowInvocationRequest.Builder
  title: "Class CancelWorkflowInvocationRequest.Builder (0.87.0) \_|\_ Java client\
...
Client libraries
Send feedback
Class CancelWorkflowInvocationRequest.Builder (0.87.0)
...
0.3.0
0.2.4
public static final class CancelWorkflowInvocationRequest . Builder extends GeneratedMessage . Builder<CancelWorkflowInvocationRequest . Builder > implements CancelWorkflowInvocationRequestOrBuilder
...
Methods
build()
public CancelWorkflowInvocationRequest build ()
Returns
Type
Description
CancelWorkflowInvocationRequest
buildPartial()
public CancelWorkflowInvocationRequest buildPartial ()
Returns
Type
Description
CancelWorkflowInvocationRequest
clear()
public CancelWorkflowInvocationRequest . Builder clear ()
Returns
Type
Description
CancelWorkflowInvocationRequest.Builder
...
clearName()
public CancelWorkflowInvocationRequest . Builder clearName ()
...
mergeFrom(CancelWorkflowInvocationRequest other)
public CancelWorkflowInvocationRequest . Builder mergeFrom ( CancelWorkflowInvocationRequest other )
Parameter
Name
Description
other
...
public CancelWorkflowInvocationRequest . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public CancelWorkflowInvocationRequest . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public CancelWorkflowInvocationRequest . Builder setName ( String value )
Required. The workflow invocation resource's name.
string name = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
Name
...
public CancelWorkflowInvocationRequest . Builder setNameBytes ( ByteString value )
Required. The workflow invocation resource's name.
string name = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
Name
