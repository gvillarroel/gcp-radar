---
title: "Class CommitLogEntry (0.87.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/com.google.cloud.dataform.v1.CommitLogEntry
...
0.3.0
0.2.4
public final class CommitLogEntry extends GeneratedMessage implements CommitLogEntryOrBuilder
Represents a single commit log.
Protobuf type google.cloud.dataform.v1.CommitLogEntry
Inheritance
Object >
...
Descriptor
newBuilder()
public static CommitLogEntry . Builder newBuilder ()
Returns
Type
Description
CommitLogEntry.Builder
newBuilder(CommitLogEntry prototype)
public static CommitLogEntry . Builder newBuilder ( CommitLogEntry prototype )
Parameter
Name
Description
prototype
...
public static CommitLogEntry parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommitLogEntry parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CommitLogEntry parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CommitLogEntry parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommitLogEntry parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CommitLogEntry parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommitLogEntry parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CommitLogEntry parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommitLogEntry parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommitLogEntry parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommitLogEntry parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CommitLogEntry parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CommitLogEntry . Builder newBuilderForType ()
Returns
Type
Description
CommitLogEntry.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CommitLogEntry . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CommitLogEntry . Builder toBuilder ()
Returns
Type
Description
CommitLogEntry.Builder
