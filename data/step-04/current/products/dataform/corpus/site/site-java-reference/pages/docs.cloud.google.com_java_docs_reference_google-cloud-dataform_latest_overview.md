---
title: "google-cloud-dataform overview (0.87.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/overview
...
Client libraries
Send feedback
google-cloud-dataform overview (0.87.0)
...
0.2.4
Key Reference Links
Cloud Dataform Description: Help analytics teams manage data inside BigQuery using SQL.
Cloud Dataform Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Use the Cloud Dataform for Java
...
The example below demonstrates how you would import the BOM and include the google-cloud-dataform artifact.
...
For this library, we recommend using com.google.cloud.dataform.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Dataform). New Version IDs are introduced infrequently, and often involve
