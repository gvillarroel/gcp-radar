---
title: "Class CommitAuthor (0.87.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/com.google.cloud.dataform.v1.CommitAuthor
...
0.3.0
0.2.4
public final class CommitAuthor extends GeneratedMessage implements CommitAuthorOrBuilder
Represents the author of a Git commit.
Protobuf type google.cloud.dataform.v1.CommitAuthor
Inheritance
Object >
...
Static Methods
getDefaultInstance()
public static CommitAuthor getDefaultInstance ()
Returns
Type
Description
CommitAuthor
...
Descriptor
newBuilder()
public static CommitAuthor . Builder newBuilder ()
Returns
Type
Description
CommitAuthor.Builder
newBuilder(CommitAuthor prototype)
public static CommitAuthor . Builder newBuilder ( CommitAuthor prototype )
Parameter
Name
Description
prototype
...
public static CommitAuthor parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommitAuthor parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CommitAuthor parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CommitAuthor parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommitAuthor parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CommitAuthor parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommitAuthor parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CommitAuthor parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommitAuthor parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommitAuthor parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommitAuthor parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CommitAuthor parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CommitAuthor> parser ()
Returns
Type
Description
Parser < CommitAuthor >
...
The bytes for name.
getParserForType()
public Parser<CommitAuthor> getParserForType ()
Returns
Type
Description
Parser < CommitAuthor >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CommitAuthor . Builder newBuilderForType ()
Returns
Type
Description
CommitAuthor.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CommitAuthor . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CommitAuthor . Builder toBuilder ()
Returns
Type
Description
CommitAuthor.Builder
