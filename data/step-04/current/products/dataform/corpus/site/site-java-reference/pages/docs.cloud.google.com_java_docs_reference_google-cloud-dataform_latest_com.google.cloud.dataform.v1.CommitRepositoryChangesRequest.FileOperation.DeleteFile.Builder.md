---
title: "Class CommitRepositoryChangesRequest.FileOperation.DeleteFile.Builder (0.87.0)\
  \ \_|\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataform/latest/com.google.cloud.dataform.v1.CommitRepositoryChangesRequest.FileOperation.DeleteFile.Builder
...
Client libraries
Send feedback
Class CommitRepositoryChangesRequest.FileOperation.DeleteFile.Builder (0.87.0)
...
0.3.0
0.2.4
public static final class CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder extends GeneratedMessage . Builder<CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder > implements CommitRepositoryChangesRequest . FileOperation . DeleteFileOrBuilder
...
Methods
build()
public CommitRepositoryChangesRequest . FileOperation . DeleteFile build ()
Returns
Type
Description
CommitRepositoryChangesRequest.FileOperation.DeleteFile
buildPartial()
public CommitRepositoryChangesRequest . FileOperation . DeleteFile buildPartial ()
Returns
Type
Description
CommitRepositoryChangesRequest.FileOperation.DeleteFile
clear()
public CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder clear ()
Returns
Type
Description
CommitRepositoryChangesRequest.FileOperation.DeleteFile.Builder
...
mergeFrom(CommitRepositoryChangesRequest.FileOperation.DeleteFile other)
public CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder mergeFrom ( CommitRepositoryChangesRequest . FileOperation . DeleteFile other )
Parameter
Name
Description
other
...
public CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public CommitRepositoryChangesRequest . FileOperation . DeleteFile . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
