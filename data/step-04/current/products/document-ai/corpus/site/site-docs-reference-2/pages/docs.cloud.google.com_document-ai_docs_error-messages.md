---
title: "Error messages \_|\_ Document AI \_|\_ Google Cloud Documentation"
...
propagate and retry.
Visit the link specified in the error message and enable the
Document AI API.
...
Supported files (and for Layout Parser ) to see the available file types. If the
...
When a processor doesn't have a valid union schema or the given dataset schema
is not valid.
...
...
google.api_core.exceptions.RetryError : Deadline of 0.0 s exceeded while calling target function , last exception :
...
