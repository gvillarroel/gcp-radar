---
title: "Managing processor versions \_|\_ Document AI \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/document-ai/docs/manage-processor
...
earlier foundation models are deprecated .
...
July 22, 2022
Not applicable
pretrained-paystub-v3.0-2023-12-06
December 6, 2023
Not applicable
...
create and evaluate new user versions
...
Endpoint used
Experience
If you do not specify a processor version ID
Requests processed using a new default processor version.
If your default processor version is deprecated, the default updates to the most
recently launched stable Google version when the older default version is deprecated.
If you specify the processor version ID
The response fails if you call a processor endpoint and specify a version ID which has been deprecated.
...
updates. See how to change the default version .
...
As a developer, you're using a Custom Extractor to get data from documents.
...
Google published a new stable version named pretrained-foundation-model-v1.2-2024-05-10 (v1.2)
and announced that the v1.0 stable version is to be deprecated on April 9, 2025.
Since you kept your training and test documents in your processor's dataset,
...
Processors page.
Go to Processors
From the list of processors, click the name of the processor that you
want to view details for.
Select the Manage Versions (or Deploy & use ) tab, which will display all of the available
processor versions.
REST
...
From the list of processors, click the name of the processor that you
want to view details for.
Select the Manage Versions (or Deploy & use ) tab, which will display
...
When you create a processor , the initial
...
From the list of processors, click the name of the processor that you
want to view details for.
In the processor's Manage Versions (or Deploy & use ) tab, in the Default version
...
After creating a new processor version
...
Click Deploy , then again click Deploy on the dialog window. This
...
After
creating a new processor version
...
Click Undeploy , then again click Undeploy on the dialog window.
...
From the list of processors, click the name of the processor that you
want to view details for.
In the processor's Manage Versions (or Deploy & use ) tab, click the
action menu more_vert next to the processor version you want to delete.
...
in single-region locations , except for asia-south1 ,
...
UNDEPLOYED
UNDEPLOYING
You must grant the DocumentAI Core Service Agent of
the destination project Document AI Editor
...
Console
Look up DocumentAI Core Service Agent and fill in
...
Click grant access.
Add the destination project's DocumentAI Core Service Agent as a new principal,
and assign Document AI Editor role.
gcloud
...
Choose the project, the processor, and the processor version as the source
...
review configuring ingress and egress policies
and set up a VPC Service Controls perimeter ,
