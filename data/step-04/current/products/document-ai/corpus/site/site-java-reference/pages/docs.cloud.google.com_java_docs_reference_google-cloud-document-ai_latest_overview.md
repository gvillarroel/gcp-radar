---
title: "google-cloud-document-ai overview (2.92.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/overview
...
Client libraries
Send feedback
google-cloud-document-ai overview (2.92.0)
...
Version ID : The version of the Cloud service itself (e.g. Document AI). New Version IDs are introduced infrequently, and often involve
