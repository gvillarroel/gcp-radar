---
title: "Class CommonOperationMetadata (2.92.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/com.google.cloud.documentai.v1.CommonOperationMetadata
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/com.google.cloud.documentai.v1.CommonOperationMetadata
  title: "Class CommonOperationMetadata (2.92.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
Class CommonOperationMetadata (2.92.0)
...
2.2.1
2.1.9
public final class CommonOperationMetadata extends GeneratedMessage implements CommonOperationMetadataOrBuilder
...
Static Methods
getDefaultInstance()
public static CommonOperationMetadata getDefaultInstance ()
Returns
Type
Description
CommonOperationMetadata
...
Descriptor
newBuilder()
public static CommonOperationMetadata . Builder newBuilder ()
Returns
Type
Description
CommonOperationMetadata.Builder
newBuilder(CommonOperationMetadata prototype)
public static CommonOperationMetadata . Builder newBuilder ( CommonOperationMetadata prototype )
Parameter
Name
Description
prototype
...
public static CommonOperationMetadata parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommonOperationMetadata parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CommonOperationMetadata parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CommonOperationMetadata parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommonOperationMetadata parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CommonOperationMetadata parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CommonOperationMetadata parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CommonOperationMetadata parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommonOperationMetadata parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CommonOperationMetadata parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CommonOperationMetadata parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CommonOperationMetadata parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CommonOperationMetadata> parser ()
Returns
Type
Description
Parser < CommonOperationMetadata >
Methods
equals(Object obj)
...
CommonOperationMetadata
getParserForType()
public Parser<CommonOperationMetadata> getParserForType ()
Returns
Type
Description
Parser < CommonOperationMetadata >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CommonOperationMetadata . Builder newBuilderForType ()
Returns
Type
Description
CommonOperationMetadata.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CommonOperationMetadata . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CommonOperationMetadata . Builder toBuilder ()
Returns
Type
Description
CommonOperationMetadata.Builder
