---
title: "Class CreateProcessorRequest (2.92.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/com.google.cloud.documentai.v1.CreateProcessorRequest
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/com.google.cloud.documentai.v1.CreateProcessorRequest
  title: "Class CreateProcessorRequest (2.92.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
Class CreateProcessorRequest (2.92.0)
...
2.2.1
2.1.9
public final class CreateProcessorRequest extends GeneratedMessage implements CreateProcessorRequestOrBuilder
...
Descriptor
newBuilder()
public static CreateProcessorRequest . Builder newBuilder ()
Returns
Type
Description
CreateProcessorRequest.Builder
newBuilder(CreateProcessorRequest prototype)
public static CreateProcessorRequest . Builder newBuilder ( CreateProcessorRequest prototype )
Parameter
Name
Description
prototype
...
public static CreateProcessorRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateProcessorRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CreateProcessorRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CreateProcessorRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateProcessorRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CreateProcessorRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CreateProcessorRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CreateProcessorRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateProcessorRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CreateProcessorRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CreateProcessorRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CreateProcessorRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CreateProcessorRequest> parser ()
Returns
Type
Description
Parser < CreateProcessorRequest >
Methods
equals(Object obj)
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CreateProcessorRequest . Builder newBuilderForType ()
Returns
Type
Description
CreateProcessorRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CreateProcessorRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CreateProcessorRequest . Builder toBuilder ()
Returns
Type
Description
CreateProcessorRequest.Builder
