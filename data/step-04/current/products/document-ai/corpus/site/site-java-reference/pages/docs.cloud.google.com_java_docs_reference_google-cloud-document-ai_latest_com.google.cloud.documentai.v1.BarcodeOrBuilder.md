---
title: "Interface BarcodeOrBuilder (2.92.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-document-ai/latest/com.google.cloud.documentai.v1.BarcodeOrBuilder
...
Client libraries
Send feedback
Interface BarcodeOrBuilder (2.92.0)
...
The rawValue.
getRawValueBytes()
public abstract ByteString getRawValueBytes ()
Raw value encoded in the barcode.
For example: 'MEBKM:TITLE:Google;URL: https://www.google.com ;;' .
string raw_value = 3;
Returns
