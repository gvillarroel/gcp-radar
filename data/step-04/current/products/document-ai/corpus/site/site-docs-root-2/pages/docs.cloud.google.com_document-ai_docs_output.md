---
title: "Sample processor output \_|\_ Document AI \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/document-ai/docs/output
...
raw outputs from the Document AI API in the Document format.
The fields returned in the response can be limited by using a FieldMask
when making a processing request .
Digitize text
Processors
Output samples
...
Detailed entry
picture_as_pdfs Sample input file
