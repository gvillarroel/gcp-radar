---
title: "Class BatchProcessRequest (3.14.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/documentai/latest/google.cloud.documentai_v1.types.BatchProcessRequest
...
Client libraries
Send feedback
Class BatchProcessRequest (3.14.0)
...
input_documents
google.cloud.documentai_v1.types.BatchDocumentsInputConfig
The input documents for the
BatchProcessDocuments
method.
document_output_config
google.cloud.documentai_v1.types.DocumentOutputConfig
...
Default to false .
process_options
google.cloud.documentai_v1.types.ProcessOptions
