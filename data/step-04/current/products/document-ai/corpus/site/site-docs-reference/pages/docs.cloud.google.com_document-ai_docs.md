---
title: "Document AI documentation \_|\_ Google Cloud Documentation"
...
Document AI is a document understanding
platform that takes unstructured data from documents and transforms it into
structured data, making it easier to understand, analyze, and consume.
Document AI uses machine learning and Google Cloud to help you
create scalable, end-to-end, cloud-based document processing applications.
Go to the Document AI product page for more.
...
Tutorial
Process documents using document OCR
Tutorial
...
Support
Related products
Stack Overflow - Document AI
Google Developer Program forums - Document AI
Related resources
