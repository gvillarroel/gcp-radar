---
title: "Authenticate to Live Stream API \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/livestream/docs/authentication
...
This document describes how to authenticate to Live Stream API programmatically. How
you authenticate to Live Stream API depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Live Stream API supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Live Stream API client libraries provide
high-level language support for authenticating to Live Stream API
programmatically.
...
Set up authentication for Live Stream API
...
Access control for Live Stream API
After you authenticate to Live Stream API, you must be authorized to access
Google Cloud resources. Live Stream API uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Live Stream API, see
