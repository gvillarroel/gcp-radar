---
title: "Method: projects.locations.channels.clips.create \_|\_ Live Stream API \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/livestream/docs/reference/rest/v1/projects.locations.channels.clips/create
...
Reference
Send feedback
Method: projects.locations.channels.clips.create
...
HTTP request
POST https://livestream.googleapis.com/v1/{parent=projects/*/locations/*/channels/*}/clips
...
Request body
The request body contains an instance of Clip .
Response body
