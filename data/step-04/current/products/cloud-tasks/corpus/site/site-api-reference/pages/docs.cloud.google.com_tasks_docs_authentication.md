---
title: "Authenticate to Cloud Tasks \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/tasks/docs/authentication
knowledge_key: corpus
source_id: site-api-reference
source_type: site
entrypoint: https://docs.cloud.google.com/tasks/docs/reference/rest
source_metadata:
  url: https://docs.cloud.google.com/tasks/docs/authentication
  title: "Authenticate to Cloud Tasks \_|\_ Google Cloud Documentation"
...
Reference
Send feedback
Authenticate to Cloud Tasks
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Cloud Tasks programmatically. How
you authenticate to Cloud Tasks depends on the interface you use to access the API
and the environment where your code is running.
Before using Cloud Tasks to call an HTTP
target that requires authentication, make sure to set up a service account with
the appropriate credentials to access the handler. For more information, see
Set up a service account for HTTP target handler authentication .
The authentication methods described in this document result in bearer access
tokens that can be used to make authenticated API calls. For more information,
see
Use HTTP target tasks with authentication tokens .
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Cloud Tasks supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Cloud Tasks client libraries provide
high-level language support for authenticating to Cloud Tasks
programmatically.
...
For more information about using the gcloud CLI with Cloud Tasks,
see .
REST
...
Set up authentication for Cloud Tasks
...
Cloud Tasks, as described in in this Cloud Tasks quickstart .
...
Access control for Cloud Tasks
After you authenticate to Cloud Tasks, you must be authorized to access
Google Cloud resources. Cloud Tasks uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Cloud Tasks, see
