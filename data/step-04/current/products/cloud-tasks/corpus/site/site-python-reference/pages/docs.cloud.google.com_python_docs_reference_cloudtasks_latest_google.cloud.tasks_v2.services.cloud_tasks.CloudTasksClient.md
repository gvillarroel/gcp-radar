---
title: "Class CloudTasksClient (2.22.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudtasks/latest/google.cloud.tasks_v2.services.cloud_tasks.CloudTasksClient
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudTasksTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.tasks_v2.types.CreateQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.CreateTaskRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.DeleteQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.DeleteTaskRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.GetQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.GetTaskRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.ListQueuesRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.ListTasksRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.PauseQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.PurgeQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.ResumeQueueRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.RunTaskRequest , dict]
...
Description
request
Union[ google.cloud.tasks_v2.types.UpdateQueueRequest , dict]
