---
title: "Cloud Source Repositories audit logging information \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/source-repositories/docs/audit-logging
...
Guides
Send feedback
Cloud Source Repositories audit logging information
Stay organized with collections
Save and categorize content based on your preferences.
This document describes the audit logs created by Cloud Source Repositories as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Cloud Source Repositories:
...
type in Cloud Source Repositories:
Note: Cloud Source Repositories audit logging does not capture events from users
searching and browsing within repositories in the user interface.
Audit logs category
Cloud Source Repositories operations
Admin activity logs
SourceRepo.UpdateProjectConfig SourceRepo.UpdateRepo SourceRepo.CreateRepo SourceRepo.DeleteRepo SourceRepo.SetIamPolicy
Data Access logs (ADMIN_READ)
SourceRepo.GetProjectConfig SourceRepo.ListRepos SourceRepo.GetRepo SourceRepo.GetIamPolicy
Data Access logs (DATA_READ)
GitProtocol.LsRemote GitProtocol.UploadPack Browser.Access
Data Access logs (DATA_WRITE)
GitProtocol.ReceivePack
Data Access logs (NO CATEGORY)
SourceRepo.CreateRepo
Data access logs (NO CATEGORY) are enabled by default and can't be disabled by data access
configs. They can be excluded by a logs exclusion .
Audit log format
