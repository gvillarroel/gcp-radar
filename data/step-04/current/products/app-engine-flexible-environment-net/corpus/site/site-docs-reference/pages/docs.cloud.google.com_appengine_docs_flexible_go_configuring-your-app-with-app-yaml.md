...
url: https://docs.cloud.google.com/appengine/docs/flexible/go/configuring-your-app-with-app-yaml
...
You can specify the runtime configuration for your Go app,
...
Go version. To use any other supported version of Go,
