---
title: "Google.Cloud.AlloyDb.V1 \_|\_ .NET client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dotnet/docs/reference/Google.Cloud.AlloyDb.V1/latest
...
1.1.0
1.0.0
Google.Cloud.AlloyDb.V1 is a.NET client library for the AlloyDB API .
Note:
This documentation is for version 1.14.0 of the library.
Some samples may not work with other versions.
Installation
Install the Google.Cloud.AlloyDb.V1 package from NuGet. Add it to
