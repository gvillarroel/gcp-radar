...
url: https://docs.cloud.google.com/dotnet/docs/reference/Google.Cloud.ApigeeConnect.V1/latest
...
Google.Cloud.ApigeeConnect.V1 is a.NET client library for the Apigee Connect API .
Note:
This documentation is for version 2.5.0 of the library.
Some samples may not work with other versions.
Installation
Install the Google.Cloud.ApigeeConnect.V1 package from NuGet. Add it to
...
use the builder class associated with each client class (e.g. ConnectionServiceClientBuilder for ConnectionServiceClient)
...
Sample code:
var client = new ConnectionServiceClientBuilder
{
