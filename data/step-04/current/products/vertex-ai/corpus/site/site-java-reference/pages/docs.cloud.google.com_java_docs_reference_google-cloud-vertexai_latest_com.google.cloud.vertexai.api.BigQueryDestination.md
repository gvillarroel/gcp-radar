---
title: "Class BigQueryDestination (1.48.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.BigQueryDestination
...
Client libraries
Send feedback
Class BigQueryDestination (1.48.0)
...
0.2.0
0.1.0
public final class BigQueryDestination extends GeneratedMessage implements BigQueryDestinationOrBuilder
...
protected BigQueryDestination . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
