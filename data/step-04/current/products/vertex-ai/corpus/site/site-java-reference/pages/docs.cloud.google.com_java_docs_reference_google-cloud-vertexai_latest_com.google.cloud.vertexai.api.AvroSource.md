---
title: "Class AvroSource (1.48.0) \_|\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.AvroSource
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.AvroSource
  title: "Class AvroSource (1.48.0) \_|\_ Java client libraries \_|\_ Google Cloud\
    \ Documentation"
...
0.2.0
0.1.0
public final class AvroSource extends GeneratedMessage implements AvroSourceOrBuilder
...
Static Methods
getDefaultInstance()
public static AvroSource getDefaultInstance ()
Returns
Type
Description
AvroSource
...
Descriptor
newBuilder()
public static AvroSource . Builder newBuilder ()
Returns
Type
Description
AvroSource.Builder
newBuilder(AvroSource prototype)
public static AvroSource . Builder newBuilder ( AvroSource prototype )
Parameter
Name
Description
prototype
...
public static AvroSource parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AvroSource parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static AvroSource parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static AvroSource parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AvroSource parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static AvroSource parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AvroSource parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static AvroSource parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AvroSource parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AvroSource parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AvroSource parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static AvroSource parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<AvroSource> parser ()
Returns
Type
Description
Parser < AvroSource >
...
GcsSourceOrBuilder
getParserForType()
public Parser<AvroSource> getParserForType ()
Returns
Type
Description
Parser < AvroSource >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public AvroSource . Builder newBuilderForType ()
Returns
Type
Description
AvroSource.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected AvroSource . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public AvroSource . Builder toBuilder ()
Returns
Type
Description
AvroSource.Builder
