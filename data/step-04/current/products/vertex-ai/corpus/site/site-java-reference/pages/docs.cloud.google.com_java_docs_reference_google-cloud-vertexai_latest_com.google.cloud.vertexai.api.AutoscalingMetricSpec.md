---
title: "Class AutoscalingMetricSpec (1.48.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.AutoscalingMetricSpec
...
Client libraries
Send feedback
Class AutoscalingMetricSpec (1.48.0)
...
0.2.0
0.1.0
public final class AutoscalingMetricSpec extends GeneratedMessage implements AutoscalingMetricSpecOrBuilder
The metric specification that defines the target resource utilization
(CPU utilization, accelerator's duty cycle, and so on) for calculating the
desired replica count.
Protobuf type google.cloud.vertexai.v1.AutoscalingMetricSpec
Inheritance
Object >
...
protected AutoscalingMetricSpec . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
