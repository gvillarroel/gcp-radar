---
title: "Class ApiAuth.ApiKeyConfig.Builder (1.48.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.ApiAuth.ApiKeyConfig.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.ApiAuth.ApiKeyConfig.Builder
  title: "Class ApiAuth.ApiKeyConfig.Builder (1.48.0) \_|\_ Java client libraries\
...
Client libraries
Send feedback
Class ApiAuth.ApiKeyConfig.Builder (1.48.0)
...
0.2.0
0.1.0
public static final class ApiAuth . ApiKeyConfig . Builder extends GeneratedMessage . Builder<ApiAuth . ApiKeyConfig . Builder > implements ApiAuth . ApiKeyConfigOrBuilder
The API secret.
Protobuf type google.cloud.vertexai.v1.ApiAuth.ApiKeyConfig
Inheritance
java.lang.Object >
...
Methods
build()
public ApiAuth . ApiKeyConfig build ()
Returns
Type
Description
ApiAuth.ApiKeyConfig
buildPartial()
public ApiAuth . ApiKeyConfig buildPartial ()
Returns
Type
Description
ApiAuth.ApiKeyConfig
clear()
public ApiAuth . ApiKeyConfig . Builder clear ()
Returns
Type
Description
ApiAuth.ApiKeyConfig.Builder
...
public ApiAuth . ApiKeyConfig . Builder clearApiKeySecretVersion ()
...
public ApiAuth . ApiKeyConfig getDefaultInstanceForType ()
Returns
Type
Description
ApiAuth.ApiKeyConfig
...
mergeFrom(ApiAuth.ApiKeyConfig other)
public ApiAuth . ApiKeyConfig . Builder mergeFrom ( ApiAuth . ApiKeyConfig other )
Parameter
Name
Description
other
...
public ApiAuth . ApiKeyConfig . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public ApiAuth . ApiKeyConfig . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public ApiAuth . ApiKeyConfig . Builder setApiKeySecretVersion ( String value )
Required. The SecretManager secret version resource name storing API key.
e.g. projects/{project}/secrets/{secret}/versions/{version}
string api_key_secret_version = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
...
Description
value
String The apiKeySecretVersion to set.
Returns
Type
Description
ApiAuth.ApiKeyConfig.Builder
...
public ApiAuth . ApiKeyConfig . Builder setApiKeySecretVersionBytes ( ByteString value )
Required. The SecretManager secret version resource name storing API key.
e.g. projects/{project}/secrets/{secret}/versions/{version}
string api_key_secret_version = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
...
Description
value
ByteString The bytes for apiKeySecretVersion to set.
Returns
Type
Description
ApiAuth.ApiKeyConfig.Builder
