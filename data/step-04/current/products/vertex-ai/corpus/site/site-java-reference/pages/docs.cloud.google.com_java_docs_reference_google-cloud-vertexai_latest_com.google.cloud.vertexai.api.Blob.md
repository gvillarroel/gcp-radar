---
title: "Class Blob (1.48.0) \_|\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.Blob
...
0.2.0
0.1.0
public final class Blob extends GeneratedMessage implements BlobOrBuilder
Content blob.
...
Descriptor
newBuilder()
public static Blob . Builder newBuilder ()
Returns
Type
Description
Blob.Builder
newBuilder(Blob prototype)
public static Blob . Builder newBuilder ( Blob prototype )
Parameter
Name
Description
prototype
...
public static Blob parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Blob parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Blob parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Blob parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static Blob parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Blob parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static Blob parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Blob parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Blob parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Blob parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static Blob parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
GeneratedMessage.isInitialized()
newBuilderForType()
public Blob . Builder newBuilderForType ()
Returns
Type
Description
Blob.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected Blob . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
