---
title: "Class ApiAuth.Builder (1.48.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.ApiAuth.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.ApiAuth.Builder
  title: "Class ApiAuth.Builder (1.48.0) \_|\_ Java client libraries \_|\_ Google\
    \ Cloud Documentation"
...
0.2.0
0.1.0
public static final class ApiAuth . Builder extends GeneratedMessage . Builder<ApiAuth . Builder > implements ApiAuthOrBuilder
...
ApiAuth
buildPartial()
public ApiAuth buildPartial ()
Returns
Type
Description
ApiAuth
clear()
public ApiAuth . Builder clear ()
Returns
Type
Description
ApiAuth.Builder
...
clearApiKeyConfig()
public ApiAuth . Builder clearApiKeyConfig ()
The API secret.
...
ApiAuth.Builder
clearAuthConfig()
public ApiAuth . Builder clearAuthConfig ()
Returns
Type
Description
ApiAuth.Builder
...
public ApiAuth . Builder mergeApiKeyConfig ( ApiAuth . ApiKeyConfig value )
The API secret.
.google.cloud.vertexai.v1.ApiAuth.ApiKeyConfig api_key_config = 1;
Parameter
Name
...
Description
ApiAuth.Builder
mergeFrom(ApiAuth other)
public ApiAuth . Builder mergeFrom ( ApiAuth other )
Parameter
Name
Description
other
...
public ApiAuth . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public ApiAuth . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public ApiAuth . Builder setApiKeyConfig ( ApiAuth . ApiKeyConfig value )
The API secret.
.google.cloud.vertexai.v1.ApiAuth.ApiKeyConfig api_key_config = 1;
Parameter
Name
...
public ApiAuth . Builder setApiKeyConfig ( ApiAuth . ApiKeyConfig . Builder builderForValue )
The API secret.
.google.cloud.vertexai.v1.ApiAuth.ApiKeyConfig api_key_config = 1;
Parameter
Name
