---
title: "Class AutomaticResources (1.48.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-vertexai/latest/com.google.cloud.vertexai.api.AutomaticResources
...
Client libraries
Send feedback
Class AutomaticResources (1.48.0)
...
0.2.0
0.1.0
public final class AutomaticResources extends GeneratedMessage implements AutomaticResourcesOrBuilder
...
protected AutomaticResources . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
