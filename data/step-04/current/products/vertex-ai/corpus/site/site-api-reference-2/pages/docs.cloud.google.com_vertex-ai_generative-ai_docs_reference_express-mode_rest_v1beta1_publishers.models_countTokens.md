...
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/reference/express-mode/rest/v1beta1/publishers.models/countTokens
...
Endpoint
post
https: / /aiplatform.googleapis.com /v1beta1 /{model}:countTokens
Path parameters
model
string
