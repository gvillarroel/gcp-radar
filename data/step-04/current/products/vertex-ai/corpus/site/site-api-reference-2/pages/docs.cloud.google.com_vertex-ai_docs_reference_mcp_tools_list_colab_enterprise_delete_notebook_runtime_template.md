...
title: "MCP Tools Reference: aiplatform.googleapis.com \_|\_ Vertex AI \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/docs/reference/mcp/tools_list/colab_enterprise_delete_notebook_runtime_template
...
Tool: colab_enterprise_delete_notebook_runtime_template
Deletes a Colab Enterprise runtime template. Use this tool to permanently remove a runtime template.
The following sample demonstrate how to use curl to invoke the colab_enterprise_delete_notebook_runtime_template MCP tool.
Curl Request
...
"method": "tools/call",
"params": {
"name": "colab_enterprise_delete_notebook_runtime_template",
"arguments": {
