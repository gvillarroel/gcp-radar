...
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/reference/express-mode/rest/v1beta1/publishers.models/streamGenerateContent
...
Endpoint
post
https: / /aiplatform.googleapis.com /v1beta1 /{model}:streamGenerateContent
Path parameters
model
string
