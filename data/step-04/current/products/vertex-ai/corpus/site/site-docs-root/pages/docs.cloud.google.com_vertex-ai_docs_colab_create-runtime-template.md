---
title: "Create a runtime template in Colab Enterprise \_|\_ Vertex AI \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/docs/colab/create-runtime-template
...
This page shows you how to create a runtime template
in Colab Enterprise.
...
Terraform resource to create a Vertex AI
runtime template.
