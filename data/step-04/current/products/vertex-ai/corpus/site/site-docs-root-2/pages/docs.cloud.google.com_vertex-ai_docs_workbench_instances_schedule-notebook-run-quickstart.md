---
title: "Quickstart: Schedule a notebook run \_|\_ Vertex AI Workbench \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/docs/workbench/instances/schedule-notebook-run-quickstart
...
you need to create a Vertex AI Workbench instance and open JupyterLab,
...
Create an
instance .
Note: If you choose JupyterLab 4 as the JupyterLab version for the instance,
then the instance uses the Vertex AI scheduler to schedule the
notebook executions.
Open JupyterLab .
Open a new notebook
file .
...
roles .
Limitations
Consider the following limitation when scheduling a notebook run
in a JupyterLab 4 instance:
...
Go to Instances
Next to your instance name, click Open JupyterLab .
...
In Advanced options ,
enter a name for your bucket in the Cloud Storage bucket field,
...
Note: If your instance is shut down, the
...
Notebook Executor button.
Click the Schedules tab.
Click the schedule name. The Schedule details page
