---
title: "Configure autocomplete \_|\_ Vertex AI Search \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/generative-ai-app-builder/docs/configure-autocomplete
...
Notes:
For information about search-as-you-type for media search apps, see
Get search-as-you-type results for a media app .
To use autocomplete with search apps that are connected to multiple data
stores (blended
search) or have documents with access control or to boost specific
languages within autocomplete, see Configure
advanced autocomplete .
The suggestions that autocomplete generates vary depending on the type of data
that the search app uses:
Structured and unstructured data. By default, autocomplete
...
Website data. By default, autocomplete generates suggestions
...
sites with the experimental advanced document data model .
Healthcare data. By default, a canonical medical data source is used to
...
servingConfigs.search method. This model isn't
available for healthcare data.
User event. The user events model generates suggestions from
user-imported events of type search . This model isn't
available for healthcare data.
...
Imported suggestions that provide autocomplete
suggestions based on an imported list of suggestions. For more information,
see Use an imported list of autocomplete suggestions .
...
Vertex AI Search makes a reasonable effort to prevent
...
Vertex AI Search. For more information, see Protect against PII leaks .
Denylist
...
can be difficult to detect. As a result, Vertex AI Search
can't guarantee that PII won't be returned in autocomplete suggestions.
Vertex AI Search applies the
...
suggestions for your app. Vertex AI Search can't guarantee
...
Vertex AI Search administrator decides to:
...
For more information, see the
launch stage descriptions .
Vertex AI Search provides an advanced data model for autocomplete. Based on
