---
title: "Class AsyncMemoryRevisions (1.144.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.memory_revisions.AsyncMemoryRevisions
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.memory_revisions.AsyncMemoryRevisions
  title: "Class AsyncMemoryRevisions (1.144.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class AsyncMemoryRevisions (1.144.0)
...
Type
Description
AsyncPager[MemoryRevision]
An async pager of memory revisions.
Send feedback
