---
title: "Vertex Generative AI SDK for Python \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/summary_overview
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/summary_overview
  title: "Vertex Generative AI SDK for Python \_|\_ Python client libraries \_|\_\
...
of the types used to do this are from the Gen AI SDK .
import types
