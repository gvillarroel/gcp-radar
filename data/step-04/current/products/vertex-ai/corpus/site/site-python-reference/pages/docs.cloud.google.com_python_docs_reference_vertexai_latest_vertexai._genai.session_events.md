---
title: "Module session_events (1.144.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.session_events
...
1.60.0
1.59.0
API documentation for session_events module.
Classes
AsyncSessionEvents
