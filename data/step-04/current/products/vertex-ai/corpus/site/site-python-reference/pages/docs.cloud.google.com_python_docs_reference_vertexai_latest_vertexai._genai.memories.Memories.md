---
title: "Class Memories (1.144.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.memories.Memories
...
1.60.0
1.59.0
Memories ( api_client_ : google . genai . _api_client . BaseApiClient )
API documentation for Memories class.
Properties
revisions
...
An iterable of retrieved memories.
rollback
rollback (
* ,
name : str ,
