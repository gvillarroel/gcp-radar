---
title: "Module memory_revisions (1.144.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.memory_revisions
...
Client libraries
Send feedback
Module memory_revisions (1.144.0)
...
1.60.0
1.59.0
API documentation for memory_revisions module.
Classes
AsyncMemoryRevisions
