---
title: "Class AsyncSessions (1.144.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.sessions.AsyncSessions
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/vertexai/latest/vertexai._genai.sessions.AsyncSessions
  title: "Class AsyncSessions (1.144.0) \_|\_ Python client libraries \_|\_ Google\
    \ Cloud Documentation"
...
1.60.0
1.59.0
AsyncSessions ( api_client_ : google . genai . _api_client . BaseApiClient )
API documentation for AsyncSessions class.
Properties
events
