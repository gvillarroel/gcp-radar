---
title: "Class ServiceHealthAsyncClient (0.4.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/google-cloud-servicehealth/latest/google.cloud.servicehealth_v1.services.service_health.ServiceHealthAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/google-cloud-servicehealth/latest/google.cloud.servicehealth_v1.services.service_health.ServiceHealthAsyncClient
  title: "Class ServiceHealthAsyncClient (0.4.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class ServiceHealthAsyncClient (0.4.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the ServiceHealthTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.GetEventRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.GetOrganizationEventRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.GetOrganizationImpactRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.ListEventsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.ListOrganizationEventsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.servicehealth_v1.types.ListOrganizationImpactsRequest , dict]]
