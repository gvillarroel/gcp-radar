---
title: "Class GroupServiceAsyncClient (2.30.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/monitoring/latest/google.cloud.monitoring_v3.services.group_service.GroupServiceAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/monitoring/latest/google.cloud.monitoring_v3.services.group_service.GroupServiceAsyncClient
  title: "Class GroupServiceAsyncClient (2.30.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class GroupServiceAsyncClient (2.30.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the GroupServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.CreateGroupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.DeleteGroupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.GetGroupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.ListGroupMembersRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.ListGroupsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.monitoring_v3.types.UpdateGroupRequest , dict]]
