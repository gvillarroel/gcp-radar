---
title: "Package query_service (2.30.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/monitoring/latest/google.cloud.monitoring_v3.services.query_service
...
0.33.0
0.32.0
API documentation for monitoring_v3.services.query_service package.
Classes
