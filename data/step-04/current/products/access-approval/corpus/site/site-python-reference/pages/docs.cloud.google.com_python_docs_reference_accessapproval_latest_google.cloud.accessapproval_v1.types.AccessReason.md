---
title: "Class AccessReason (1.19.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/accessapproval/latest/google.cloud.accessapproval_v1.types.AccessReason
...
Class AccessReason (1.19.0) | Python client libraries | Google Cloud Documentation
...
Description
type_
google. cloud. accessapproval_ v1. types. Access Reason. Type
