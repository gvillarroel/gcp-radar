...
Class ApproveDecision (1.19.0) | Python client libraries | Google Cloud Documentation
...
signature_ info
google. cloud. accessapproval_ v1. types. Signature Info
