...
url: https://docs.cloud.google.com/python/docs/reference/accessapproval/latest/google.cloud.accessapproval_v1.types
...
Package types (1.19.0) | Python client libraries | Google Cloud Documentation
...
SDK, languages, frameworks, and tools
On this page
Classes AccessApprovalServiceAccount
