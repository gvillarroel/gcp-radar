---
title: "Python Client for Access Approval \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/accessapproval/latest
...
0.2.2
0.1.0
Access Approval : enables controlling access to your organization’s data by Google personnel.
...
pip install google-cloud-access-approval
Next Steps
Read the Client Library Documentation for Access Approval
to see other available methods on the client.
Read the Access Approval Product documentation to learn
