...
REST Resource: folders.approvalRequests | Access Approval | Google Cloud Documentation
...
SDK, languages, frameworks, and tools
On this page
Resource: ApprovalRequest AugmentedInfo
ResourceProperties
AccessReason
Type
AccessLocations
...
Was this helpful?
Send feedback
REST Resource: folders. approval Requests
