---
title: "Supported service method restrictions \_|\_ VPC Service Controls \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/vpc-service-controls/docs/supported-method-restrictions
...
This page provides a reference table of service methods and permissions that can
be restricted using Ingress and Egress rules .
Supported methods
Service Name
Action Type
Action
...
PERMISSION
bigquery.connections.create (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.CreateConnection method instead.)
PERMISSION
bigquery.connections.delete (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.DeleteConnection method instead.)
PERMISSION
bigquery.connections.get (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.GetConnection method instead.)
PERMISSION
bigquery.connections.getIamPolicy (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.GetIamPolicy method instead.)
PERMISSION
bigquery.connections.list (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.ListConnections method instead.)
PERMISSION
bigquery.connections.setIamPolicy (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.SetIamPolicy method instead.)
PERMISSION
bigquery.connections.update (DEPRECATED: using this permission has no effect on ingress and egress rules. Use ConnectionService.UpdateConnection method instead.)
PERMISSION
