...
VPC Service Controls is built on top of the Access Context Manager.
Use Access Context Manager APIs to create and manage service perimeters.
Clicking this link will take you to the Access Context Manager API reference documentation.
Send feedback
