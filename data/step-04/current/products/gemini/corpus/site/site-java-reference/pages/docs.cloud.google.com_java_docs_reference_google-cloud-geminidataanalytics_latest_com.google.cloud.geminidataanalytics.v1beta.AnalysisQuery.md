---
title: "Class AnalysisQuery (0.16.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-geminidataanalytics/latest/com.google.cloud.geminidataanalytics.v1beta.AnalysisQuery
...
0.2.0
0.1.0
public final class AnalysisQuery extends GeneratedMessage implements AnalysisQueryOrBuilder
...
Static Fields
DATA_RESULT_NAMES_FIELD_NUMBER
public static final int DATA_RESULT_NAMES_FIELD_NUMBER
Field Value
Type
Description
int
...
Static Methods
getDefaultInstance()
public static AnalysisQuery getDefaultInstance ()
Returns
Type
Description
AnalysisQuery
...
Descriptor
newBuilder()
public static AnalysisQuery . Builder newBuilder ()
Returns
Type
Description
AnalysisQuery.Builder
newBuilder(AnalysisQuery prototype)
public static AnalysisQuery . Builder newBuilder ( AnalysisQuery prototype )
Parameter
Name
Description
prototype
...
public static AnalysisQuery parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AnalysisQuery parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static AnalysisQuery parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static AnalysisQuery parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AnalysisQuery parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static AnalysisQuery parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AnalysisQuery parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static AnalysisQuery parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AnalysisQuery parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AnalysisQuery parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AnalysisQuery parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static AnalysisQuery parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<AnalysisQuery> parser ()
Returns
Type
Description
Parser < AnalysisQuery >
Methods
equals(Object obj)
...
AnalysisQuery
getParserForType()
public Parser<AnalysisQuery> getParserForType ()
Returns
Type
Description
Parser < AnalysisQuery >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public AnalysisQuery . Builder newBuilderForType ()
Returns
Type
Description
AnalysisQuery.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected AnalysisQuery . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public AnalysisQuery . Builder toBuilder ()
Returns
Type
Description
AnalysisQuery.Builder
