---
title: "Configure VPC Service Controls for Gemini \_|\_ Gemini Code Assist \_|\_ Google\
  \ for Developers"
url: https://developers.google.com/gemini-code-assist/docs/configure-vpc-service-controls
...
source_metadata:
  url: https://developers.google.com/gemini-code-assist/docs/configure-vpc-service-controls
  title: "Configure VPC Service Controls for Gemini \_|\_ Gemini Code Assist \_|\_\
...
Page Summary
outlined_flag
Configure VPC Service Controls to support Gemini by updating your organization's service perimeter and configuring VPC networks to block outbound traffic except to the restricted VIP range.
Before starting, ensure Gemini Code Assist is set up, you have the necessary IAM roles, and you have an organization-level service perimeter.
To add Gemini to your service perimeter, include the relevant projects, VPC networks, and Gemini API services within the perimeter configuration.
Configure VPC networks by enabling Private Google Access on subnets, configuring firewall rules to restrict outbound traffic, and creating a Cloud DNS response policy to route *.googleapis.com to the restricted VIP range.
Consider additional configurations for client machines inside and outside the perimeter, Gemini Code Assist IDE extensions, and Cloud Workstations when using VPC Service Controls with Gemini.
This document shows how to configure
VPC Service Controls to
support Gemini , an AI-powered
