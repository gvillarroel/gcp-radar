---
title: "Code customization overview \_|\_ Gemini Code Assist \_|\_ Google for Developers"
url: https://developers.google.com/gemini-code-assist/docs/code-customization-overview
...
Page Summary
outlined_flag
Code customization, available in Gemini Code Assist Enterprise, provides code suggestions based on your organization's private repositories, aligning with your coding style.
Code customization works by indexing your private code every 24 hours and including relevant matches in code prompts for suggestions.
Google ensures the security of your private code through single-tenant storage, access controls, no training on your code, and keeping your results private.
You can control access to your data using IAM permissions and by creating an .aiexclude file to prevent specific files or repositories from being indexed.
Code customization has limitations on the number of indexes, repositories, and supported languages and locations.
