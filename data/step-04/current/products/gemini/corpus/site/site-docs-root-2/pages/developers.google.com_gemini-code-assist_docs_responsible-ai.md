---
title: "Gemini Code Assist and responsible AI \_|\_ Google for Developers"
url: https://developers.google.com/gemini-code-assist/docs/responsible-ai
...
Page Summary
outlined_flag
This document describes how Gemini Code Assist is designed in view of the capabilities, limitations, and risks associated with generative AI.
Large language models (LLMs) can perform many useful tasks but also have potential for misapplication and unforeseen consequences, generating unexpected or incorrect output.
Gemini Code Assist has limitations such as difficulty with edge cases, potential for hallucinations and factual inaccuracies, and performance being affected by data quality and bias.
Gemini Code Assist is designed with Google's AI principles and includes safety filtering to block harmful content.
...
What's next
Learn more about
how Gemini Code Assist cites sources when helps you generate code .
