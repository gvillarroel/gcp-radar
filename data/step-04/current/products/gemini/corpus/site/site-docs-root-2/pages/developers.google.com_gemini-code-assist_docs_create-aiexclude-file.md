---
title: "Exclude files from Gemini Code Assist use \_|\_ Google for Developers"
url: https://developers.google.com/gemini-code-assist/docs/create-aiexclude-file
...
Page Summary
outlined_flag
Gemini Code Assist allows excluding specific files or subtrees from its context for various features.
Files can be excluded using either an .aiexclude or a .gitignore file.
The .aiexclude file is exclusively used for code customization and its directives override .gitignore in case of conflicts.
The syntax for an .aiexclude file is the same as a .gitignore file.
You can configure context exclusion settings, including changing the default .aiexclude file or disabling .gitignore , within the Gemini Code Assist extension settings in supported IDEs like VS Code.
