---
title: "Configure Gemini Code Assist code customization \_|\_ Google for Developers"
url: https://developers.google.com/gemini-code-assist/docs/code-customization
...
Indexing status can be checked through the Logs Explorer in the Console or by using the gcloud logging read command in the CLI.
Once set up, developers with appropriate access will receive code customization suggestions in their IDEs and can check the status.
...
Verify that you have the following Identity and Access Management roles on
