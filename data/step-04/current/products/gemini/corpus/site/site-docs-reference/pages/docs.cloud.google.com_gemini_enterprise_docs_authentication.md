---
title: "Authenticate to Gemini Enterprise \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/enterprise/docs/authentication
...
This document describes how to authenticate to Gemini Enterprise programmatically. How
you authenticate to Gemini Enterprise depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Gemini Enterprise supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Gemini Enterprise client libraries provide
high-level language support for authenticating to Gemini Enterprise
programmatically.
...
Set up authentication for Gemini Enterprise
...
Gemini Enterprise, as described in Before you begin .
...
Access control for Gemini Enterprise
After you authenticate to Gemini Enterprise, you must be authorized to access
Google Cloud resources. Gemini Enterprise uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Gemini Enterprise, see
