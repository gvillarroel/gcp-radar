---
title: "Method: projects.locations.codeToolsSettings.settingBindings.list \_|\_ Gemini\
  \ for Google Cloud \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/docs/api/reference/rest/v1/projects.locations.codeToolsSettings.settingBindings/list
...
source_metadata:
  url: https://docs.cloud.google.com/gemini/docs/api/reference/rest/v1/projects.locations.codeToolsSettings.settingBindings/list
  title: "Method: projects.locations.codeToolsSettings.settingBindings.list \_|\_\
...
parent
string
Required. Parent value for ListSettingBindingsRequest.
Query parameters
Parameters
pageSize
integer
...
Response body
If successful, the response body contains an instance of ListSettingBindingsResponse .
Authorization scopes
