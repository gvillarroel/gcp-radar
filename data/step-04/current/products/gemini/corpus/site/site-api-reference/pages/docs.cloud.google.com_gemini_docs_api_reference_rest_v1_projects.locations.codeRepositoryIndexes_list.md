---
title: "Method: projects.locations.codeRepositoryIndexes.list \_|\_ Gemini for Google\
  \ Cloud \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/docs/api/reference/rest/v1/projects.locations.codeRepositoryIndexes/list
...
parent
string
Required. Parent value for ListCodeRepositoryIndexesRequest
Query parameters
Parameters
pageSize
integer
...
Response body
Message for response to listing CodeRepositoryIndexes
...
codeRepositoryIndexes[]
object ( CodeRepositoryIndex )
The list of CodeRepositoryIndex
nextPageToken
string
