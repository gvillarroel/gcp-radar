---
title: "Module subscriber.client (2.35.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.client
...
Client libraries
Send feedback
Module subscriber.client (2.35.0)
