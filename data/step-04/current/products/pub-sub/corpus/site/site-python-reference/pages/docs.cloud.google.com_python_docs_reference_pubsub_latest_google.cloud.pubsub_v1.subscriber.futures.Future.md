---
title: "Class Future (2.35.0) \_|\_ Python client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.futures.Future
...
AcknowledgeError
If the operation did not succeed for another reason.
running
running () - > bool
