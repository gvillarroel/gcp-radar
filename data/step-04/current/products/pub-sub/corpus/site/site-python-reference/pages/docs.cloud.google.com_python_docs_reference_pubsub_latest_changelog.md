...
url: https://docs.cloud.google.com/python/docs/reference/pubsub/latest/changelog
...
2.13.1 (2022-07-07)
Bug Fixes
change info logs to debug ( #693 ) ( 950fbce )
require python 3.7+ ( #730 ) ( 0d949b8 )
2.13.0 (2022-06-06)
Features
...
Documentation
fix project_path typo in UPGRADING.md ( #660 ) ( 20d661c )
mark eod as preview ( #657 ) ( 418e1a3 )
2.12.0 (2022-04-06)
Features
...
2.10.0 (2022-03-04)
Features
add api key support ( #571 ) ( cdda762 )
add exactly once delivery flag ( #577 ) ( d6614e2 )
add support for exactly once delivery ( #578 ) ( 95a86fa )
exactly-once delivery support ( #550 ) ( 2fb6e15 )
Bug Fixes
...
2.9.0 (2021-11-10)
Features
add context manager support in client ( #516 ) ( 51eae67 )
add support for Python 3.10 ( #518 ) ( bb25d75 )
Bug Fixes
...
Documentation
add type annotations to codebase ( #509 ) ( 093cabf )
list oneofs in docstring ( 290b9c5 )
2.8.0 (2021-09-02)
Features
...
2.7.1 (2021-08-13)
Bug Fixes
remove dependency on pytz ( #472 ) ( 972cc16 )
2.7.0 (2021-07-24)
Features
