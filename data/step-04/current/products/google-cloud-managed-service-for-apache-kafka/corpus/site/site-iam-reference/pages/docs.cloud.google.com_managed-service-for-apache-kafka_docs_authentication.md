---
title: "Authenticate to Managed Service for Apache Kafka \_|\_ Google Cloud Managed\
  \ Service for Apache Kafka \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/managed-service-for-apache-kafka/docs/authentication
...
This document describes how to authenticate to Google Cloud Managed Service for Apache Kafka programmatically. How
you authenticate to Google Cloud Managed Service for Apache Kafka depends on the interface you use to access the API
and the environment where your code is running.
For information about
authenticating to Managed Service for Apache Kafka by using the open source Apache Kafka API,
see Authenticate to open source Apache Kafka API .
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Managed Service for Apache Kafka supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Managed Service for Apache Kafka client libraries provide
high-level language support for authenticating to Managed Service for Apache Kafka
programmatically.
...
Managed Service for Apache Kafka, you
...
For more information about using the gcloud CLI with Managed Service for Apache Kafka,
see the Managed Service for Apache Kafka gcloud CLI reference pages .
REST
You can authenticate to
the Managed Service for Apache Kafka API
...
Set up authentication for Managed Service for Apache Kafka
...
Authentication methods .
Access control for Managed Service for Apache Kafka
After you authenticate to Managed Service for Apache Kafka, you must be authorized to access
Google Cloud resources. Managed Service for Apache Kafka uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Managed Service for Apache Kafka, see
Access control with IAM and Kafka ACLs .
For more information about IAM and authorization, see
IAM overview .
What's next
Access control with IAM.
Authenticate to the open source Apache Kafka API.
