---
title: "Capacity Planner documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/capacity-planner/docs
...
Capacity Planner gives you visibility into the current and forecasted usage of the
virtual machine (VM) instances, Persistent Disk volumes, and GPUs in your project, folder, or
organization.
Preview
This product is
