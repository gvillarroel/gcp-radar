---
title: "Authenticate to Capacity Planner \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/capacity-planner/docs/authentication
...
This document describes how to authenticate to Capacity Planner programmatically. How
you authenticate to Capacity Planner depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Capacity Planner supports programmatic access. You can access the API in
the following ways:
REST
REST
You can authenticate to
the Capacity Planner API
...
Set up authentication for Capacity Planner
...
Capacity Planner, as described in Capacity Planner prerequisites for projects and users .
