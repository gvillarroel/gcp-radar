...
url: https://docs.cloud.google.com/python/docs/reference/recaptchaenterprise/latest
...
reCAPTCHA Enterprise : protect your website from fraudulent activity like scraping, credential stuffing, and automated account creation.
...
Enable the reCAPTCHA Enterprise.
...
pip install google-cloud-recaptcha-enterprise
Next Steps
Read the Client Library Documentation for reCAPTCHA Enterprise
to see other available methods on the client.
Read the reCAPTCHA Enterprise Product documentation to learn
