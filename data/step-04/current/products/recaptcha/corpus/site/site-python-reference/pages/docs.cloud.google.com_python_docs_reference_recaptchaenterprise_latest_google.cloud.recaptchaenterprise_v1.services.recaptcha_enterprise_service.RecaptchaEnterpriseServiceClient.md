---
title: "Class RecaptchaEnterpriseServiceClient (1.29.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/recaptchaenterprise/latest/google.cloud.recaptchaenterprise_v1.services.recaptcha_enterprise_service.RecaptchaEnterpriseServiceClient
...
Client libraries
Send feedback
Class RecaptchaEnterpriseServiceClient (1.29.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the RecaptchaEnterpriseServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.AddIpOverrideRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.CreateFirewallPolicyRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.DeleteFirewallPolicyRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.GetFirewallPolicyRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.ListFirewallPoliciesRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.ListIpOverridesRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.RemoveIpOverrideRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.ReorderFirewallPoliciesRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.RetrieveLegacySecretKeyRequest , dict]
...
Description
request
Union[ google.cloud.recaptchaenterprise_v1.types.UpdateFirewallPolicyRequest , dict]
