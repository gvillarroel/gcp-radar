---
title: "google-cloud-recaptchaenterprise overview (3.85.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-recaptchaenterprise/latest/overview
...
Client libraries
Send feedback
google-cloud-recaptchaenterprise overview (3.85.0)
...
reCAPTCHA Enterprise Product Reference
GitHub Repository
Maven artifact
Getting Started
...
libraryDependencies += "com.google.cloud" % "google-cloud-recaptchaenterprise" % "3.85.0"
Which version ID should I get started with?
For this library, we recommend using com.google.recaptchaenterprise.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. reCAPTCHA Enterprise). New Version IDs are introduced infrequently, and often involve
