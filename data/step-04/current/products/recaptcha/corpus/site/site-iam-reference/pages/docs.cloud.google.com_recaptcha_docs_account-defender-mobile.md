---
title: "Detect and prevent account-related fraudulent activities on mobile applications\
  \ \_|\_ reCAPTCHA \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/recaptcha/docs/account-defender-mobile
...
to detect and prevent account-related fraudulent activities on mobile applications.
...
detected by observing a specific user's behavior on a mobile application over a period of
time. reCAPTCHA Account defense helps in identifying these kinds
of subtle abuse by creating a site-specific model for your mobile application to detect a
...
Before you begin
reCAPTCHA Account defense for mobile applications is accessible after
triggering an automatic security review by adding a billing account to your project.
Add a billing account
to your project to onboard your mobile application to this feature.
Prepare your environment for reCAPTCHA .
Create a score-based key .
Configure your mobile application for reCAPTCHA Account defense
...
Integrate reCAPTCHA with your mobile application.
For Android apps, see Integrate reCAPTCHA with Android apps .
For iOS apps, see Integrate reCAPTCHA with iOS apps .
...
For each action of your app that is protected using reCAPTCHA, call the execute() method with RecaptchaAction . For more information about execute() and RecaptchaAction , see the following:
Android: execute() and RecaptchaAction .
iOS: execute() and RecaptchaAction .
reCAPTCHA provides a built-in set of actions, and if necessary you can create custom actions.
...
You can add action names that are meaningful and describe the user action such as PASSWORD_RESET or ACCOUNT_UPDATE by using custom() for Android or custom() for iOS .
Action name
...
TOKEN : token returned from the execute() call
KEY_ID : reCAPTCHA key associated with the app
ACCOUNT_ID : the identifier that is uniquely associated with the user account for a
user account to your app
...
access your mobile application.
...
see reasons values .
ACCOUNT_ID : Optional. the identifier that is uniquely associated with the user account on your app.
For more information, see
