---
title: "Authenticate to reCAPTCHA \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/recaptcha/docs/authentication
...
Reference
Send feedback
Authenticate to reCAPTCHA
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to reCAPTCHA programmatically. How
...
API access
reCAPTCHA supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The reCAPTCHA client libraries provide
high-level language support for authenticating to reCAPTCHA
programmatically.
...
For more information about using the gcloud CLI with reCAPTCHA,
...
reCAPTCHA supports API keys for the following API methods:
...
Set up authentication for reCAPTCHA
...
After you authenticate to reCAPTCHA, you must be authorized to access
Google Cloud resources. reCAPTCHA uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for reCAPTCHA, see
