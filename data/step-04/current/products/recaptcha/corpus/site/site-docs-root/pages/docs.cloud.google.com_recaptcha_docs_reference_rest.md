---
title: "reCAPTCHA Enterprise API \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/recaptcha/docs/reference/rest
...
https://recaptchaenterprise.googleapis.com/$discovery/rest?version=v1beta1
Service endpoint
...
patch
PATCH /v1/{firewallPolicy.name=projects/*/firewallpolicies/*}
