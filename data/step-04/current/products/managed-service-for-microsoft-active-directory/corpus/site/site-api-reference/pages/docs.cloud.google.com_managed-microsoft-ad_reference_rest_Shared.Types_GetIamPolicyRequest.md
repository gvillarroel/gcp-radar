---
title: "GetIamPolicyRequest \_|\_ Managed Microsoft AD \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/managed-microsoft-ad/reference/rest/Shared.Types/GetIamPolicyRequest
...
GetPolicyOptions
JSON representation
Request message for domains.getIamPolicy method.
JSON representation
{
"resource" : string ,
"options" : {
...
options
object ( GetPolicyOptions )
OPTIONAL: A GetPolicyOptions object for specifying options to domains.getIamPolicy .
GetPolicyOptions
Encapsulates settings provided to domains.getIamPolicy.
JSON representation
{
