---
title: "Support Options for Aerial View API \_|\_ Google Maps Aerial View API \_|\_\
...
source_metadata:
  url: https://developers.google.com/maps/documentation/aerial-view/support
  title: "Support Options for Aerial View API \_|\_ Google Maps Aerial View API \_\
...
Resources
Send feedback
Support Options for Aerial View API
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Google provides various support avenues for the Aerial View API, including Stack Overflow for technical questions and the Issue Tracker for bugs and feature requests.
Users can contact Google Maps Platform Support for issues not resolved through other channels, with Enhanced Support customers receiving priority assistance.
Support cases can be created through the Google Cloud Console, requiring a valid billing account and an enabled Google Maps Platform API.
The Google Maps Platform offers support with varying response times based on the priority level assigned to a case, ranging from critical to low impact.
Enhanced Support users have access to additional features like case escalation, video conferencing for complex issues, SLA incident reports, and map data quality assistance.
Get help
...
Stack Overflow
to field technical questions about the Aerial View API. Stack Overflow is a
...
google-maps
to your search query. You can look for Aerial View API-specific topics by adding
google-aerial-view-api . You may wish to add additional tags to your question
...
resolution times.
Bugs
If you think the cause of a problem is a bug in the Aerial View API, report it on
