---
title: "Set up the Aerial View API \_|\_ Google Maps Aerial View API \_|\_ Google\
  \ for Developers"
...
Aerial View API
Send feedback
Set up the Aerial View API
Stay organized with collections
Save and categorize content based on your preferences.
This document describes the steps needed to start using the Aerial View API.
checklist
