---
title: "Image computations with the Earth Engine REST API \_|\_ Google Earth Engine\
  \ \_|\_ Google for Developers"
url: https://developers.google.com/earth-engine/Earth_Engine_REST_API_compute_image
...
Page Summary
outlined_flag
This guide shows how to prototype a computation with one of the client libraries, serialize the computation graph and use the REST API to obtain the computed result.
To complete this tutorial, you will need a service account that is registered for Earth Engine access and has project level permission to perform Earth Engine computations.
The first step is to authenticate to Google Cloud using your project and obtain a private key file for your service account.
You can then test your credentials by starting an AuthorizedSession and making a GET request through the session.
