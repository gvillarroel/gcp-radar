---
title: "Arrays and Array Images \_|\_ Google Earth Engine \_|\_ Google for Developers"
url: https://developers.google.com/earth-engine/guides/arrays_array_images
...
Page Summary
outlined_flag
Arrays in Earth Engine are built from lists of numbers and lists of lists, with nesting determining the number of dimensions.
A simple example of array creation is demonstrated using Landsat 8 tasseled cap coefficients.
You can confirm the dimensions of an array using the length() function.
...
The following table illustrates the arrangement of the matrix entries along the 0-axis
and the 1-axis:
1-axis ->
0 1 2 3 4 5
...
m
Here is a complete example, which uses the entire coefficients array to compute multiple
tasseled cap components at once and display the result:
Code Editor (JavaScript)
