...
Explore land cover data
Agriculture
Agriculture data is key to understanding global water consumption and food production. Earth Engine includes a number of agriculture data products such as the USDA NASS Cropland Data Layers, as well as layers from the Global Food Security-Support Analysis Data (GFSAD) including cropland extent, crop dominance, and watering sources.
...
Explore other geophysical data
