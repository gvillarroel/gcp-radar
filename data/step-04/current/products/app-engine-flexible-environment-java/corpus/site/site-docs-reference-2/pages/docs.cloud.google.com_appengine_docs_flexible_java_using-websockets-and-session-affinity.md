...
url: https://docs.cloud.google.com/appengine/docs/flexible/java/using-websockets-and-session-affinity
...
the following command from the websocket-jetty directory:
...
command you run.
The sample application is packaged as a jar, and runs automatically using the
Java 8/Jetty 9 with Servlet 3.1 Runtime .
