---
title: "Support Options for Navigation SDK for iOS \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/navigation/ios-sdk/support
...
Resources
Send feedback
Support Options for Navigation SDK for iOS
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Get community support for the Navigation SDK for iOS through Stack Overflow using the google-nav-sdk+ios and google-maps tags.
Report bugs and feature requests via the Issue Tracker, providing clear descriptions and relevant information.
Google Maps Platform offers tiered support with varying response times; Enhanced Support provides faster response times, escalation privileges, and additional services.
For complex map data issues and faster resolution, Enhanced Support offers services like Map Data Quality Assistance, case escalation, and video conferencing.
Access support resources and manage cases through the Google Cloud Platform console.
Get help
...
Stack Overflow
to field technical questions about the Navigation SDK for iOS. Stack Overflow is a
...
google-maps
to your search query. You can look for Navigation SDK for iOS-specific topics by adding
google-nav-sdk+ios . You may wish to add additional tags to your question
...
resolution times.
Bugs
If you think the cause of a problem is a bug in the Navigation SDK for iOS, report it on
