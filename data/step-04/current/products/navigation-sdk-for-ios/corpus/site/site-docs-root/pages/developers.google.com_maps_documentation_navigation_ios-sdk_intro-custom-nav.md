---
title: "Custom navigation experience \_|\_ Navigation SDK for iOS \_|\_ Google for\
  \ Developers"
url: https://developers.google.com/maps/documentation/navigation/ios-sdk/intro-custom-nav
...
Page Summary
outlined_flag
The Navigation SDK offers a custom navigation experience for greater flexibility beyond the standard Google navigation experience.
Custom navigation involves managing UI elements and visuals, starting navigation sessions, listening for events, and ending navigation.
Custom experiences are suitable for scenarios like text-only guidance, Carplay integration, or combining overview maps with minimal turn-by-turn guidance.
Developers can access the turn-by-turn data feed and detailed navigation events to create highly customized navigation interfaces.
...
For more information, see Enable Navigation for Carplay
