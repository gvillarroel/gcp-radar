---
title: "Authenticate to Vertex AI Search \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/generative-ai-app-builder/docs/authentication
...
This document describes how to authenticate to Vertex AI Search programmatically. How
you authenticate to Vertex AI Search depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Vertex AI Search supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Vertex AI Search client libraries provide
high-level language support for authenticating to Vertex AI Search
programmatically.
...
Vertex AI Search supports API keys for the following API methods:
userEvents.Collect . For more information, see Create an
API key.
servingConfigs.searchLite . For more
information, see Get search
results for an app with website data (API key).
For general information about using API keys, see
Authenticate using API keys .
Set up authentication for Vertex AI Search
...
Vertex AI Search, as described in Before you begin .
...
Access control for Vertex AI Search
After you authenticate to Vertex AI Search, you must be authorized to access
Google Cloud resources. Vertex AI Search uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Vertex AI Search, see
