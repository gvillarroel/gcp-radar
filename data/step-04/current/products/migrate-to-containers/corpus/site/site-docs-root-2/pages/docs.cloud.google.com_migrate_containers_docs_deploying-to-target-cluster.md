---
title: "Deploy a Linux system container to a target cluster \_|\_ Migrate to Containers\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/migrate/containers/docs/deploying-to-target-cluster
...
Migrated the workload
using Migrate to Containers.
Reviewed the generate deployment files .
Created the cluster where you want to deploy your workload. For more
information, see:
Creating a zonal cluster
Creating a regional cluster
Creating an Autopilot cluster
Set up kubectl and connected to the cluster .
