---
title: "Configure point-in-time recovery (PITR) \_|\_ Cloud SQL for PostgreSQL \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/postgres/backup-recovery/configure-pitr
