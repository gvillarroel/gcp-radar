---
title: "Configure private IP \_|\_ Cloud SQL for PostgreSQL \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/postgres/configure-private-ip
...
Cloud SQL for PostgreSQL instances with private IP addresses provides better isolation
...
DATABASE_VERSION : The version of the
PostgreSQL database (for example, POSTGRES_14 )
...
Cloud SQL for PostgreSQL instances. Alternatively, you can connect to your instance
...
cloudsql-postgres-googleapis-com is a Private Service Connection
name from your VPC network page.
