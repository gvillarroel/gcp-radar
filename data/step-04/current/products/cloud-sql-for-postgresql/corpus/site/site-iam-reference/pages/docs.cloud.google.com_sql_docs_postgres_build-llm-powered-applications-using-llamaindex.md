---
title: "Build LLM-powered applications using LlamaIndex \_|\_ Cloud SQL for PostgreSQL\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/postgres/build-llm-powered-applications-using-llamaindex
...
using LlamaIndex integrated with Cloud SQL for PostgreSQL.
...
Cloud SQL for PostgreSQL offers the
...
Cloud SQL for PostgreSQL's high performance and reliability, you can build
...
Initialize a default PostgresVectorStore vector store.
...
PostgresChatStore class. You learn how to do the following:
Create a PostgresEngine using
PostgresEngine.from_instance() .
...
the PostgresReader class. You learn how to do the following:
Create a PostgresEngine using
PostgresEngine.from_instance() .
