---
title: "Use Secret Manager to handle secrets in Cloud SQL \_|\_ Cloud SQL for PostgreSQL\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/postgres/use-secret-manager
