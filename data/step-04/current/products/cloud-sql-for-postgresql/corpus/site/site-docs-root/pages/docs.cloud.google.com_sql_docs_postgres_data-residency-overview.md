---
title: "Data residency overview \_|\_ Cloud SQL for PostgreSQL \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/sql/docs/postgres/data-residency-overview
...
Cloud SQL Identity and Access Management (IAM) database authentication provides a single interface to
help you better monitor and manage database access for users and service accounts.
As a result, you can manage the data in your cloud resources centrally.
By configuring Cloud SQL IAM database authentication, you
can control user access to your data in Cloud SQL by defining who has which
access to your data. You configure your database instance , and then grant access to
individuals by adding IAM users as users on the instance. These users can log in to Cloud SQL databases using
Cloud SQL IAM database authentication.
To enable or disable services for sets of users, you can combine organizational policy constraints using
IAM policy configurations. This feature prevents your employees
from accidentally storing data in the wrong Google Cloud region.
...
that you set.
Using IAM permissions, Access Approval, Access Transparency, and Key Access Justifications with Cloud KMS and Cloud EKM,
