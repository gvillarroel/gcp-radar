---
title: "Cloud-based maps styling overview \_|\_ Maps SDK for Android \_|\_ Google\
  \ for Developers"
url: https://developers.google.com/maps/documentation/android-sdk/cloud-customization
...
Cloud-based maps styling overview | Maps SDK for Android | Google for Developers
...
Control collision behavior and visibility
Info windows
Shapes
Ground overlays
Tile overlays
...
Handle click events
Use Places services and Geocoding with data-driven styling
...
Migrate from the Maps SDK v3 Beta
Overview
Beta releases
...
You can create and manage map styles in the Google Cloud Console using a no-code editor, making it easy for designers and developers to collaborate.
Styled maps using map IDs load quickly after initial caching, providing a smooth and engaging user experience.
...
This feature is available across multiple platforms, including Android, iOS, JavaScript, and Web Service, ensuring consistent map styling across your applications.
Select platform:
Android
iOS
JavaScript
