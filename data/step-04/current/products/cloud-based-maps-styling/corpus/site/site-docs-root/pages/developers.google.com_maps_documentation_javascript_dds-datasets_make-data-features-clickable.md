---
title: "Handle mouse events \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/dds-datasets/make-data-features-clickable
...
Handle mouse events | Maps JavaScript API | Google for Developers
...
Issue Tracker
On this page
Enable dataset layer events Complete example code
...
addListener() function on the dataset layer for each event you want to
register. In this example the map also gets a listener.
...
index . js
Add event handler code to style the selected feature based on the type of
interaction.
TypeScript JavaScript
More
...
index . js
Use a feature style function to apply styles. The feature style function
shown here conditionally applies style based on the type of interaction. Three
styles are defined here: one to make the border bold on mousemove , one to
change the background on click , and a default style.
TypeScript JavaScript
More
const styleDefault = {
strokeColor : 'green' ,
...
[[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-04-08 UTC."],[],["To enable interactive features, register a dataset layer for `click` and `mousemove` events using `addListener()`. Implement event handlers (`handleClick`, `handleMouseMove`) to identify interacted features and update their styles. Define a `style` function (`applyStyle`) to conditionally apply styles based on interaction type such as default, clicked, and mouse-over styles. Also include a map event listener that clears interacted feature ids if no layers are under the mouse. These steps modify feature appearances upon user interactions.\n"]]
Stack Overflow
