---
title: "Migrate to advanced markers \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/advanced-markers/migration
...
Page Summary
outlined_flag
google.maps.Marker is deprecated as of February 21st, 2024 (v3.56) and developers should transition to google.maps.marker.AdvancedMarkerElement .
...
if your import statement declares AdvancedMarker , you can omit the qualified
path.
...
defer
></script>
Note: When the legacy script loading tag is used libraries are imported at
initialization time; therefore there is no need to call importLibrary() .
