---
title: "Get a two-wheeled vehicle route \_|\_ Maps JavaScript API \_|\_ Google for\
  \ Developers"
url: https://developers.google.com/maps/documentation/javascript/routes/route-two-wheel
...
Get a two-wheeled vehicle route | Maps JavaScript API | Google for Developers
...
Learn more .
Two-wheeled refers to two-wheeled motorized vehicles (for example, motorcycles). The
two-wheeler travel mode differs from the bicycle travel mode, which is a human-powered travel
mode.
Caution: Requests using a travel mode of TWO_WHEELER are billed at a higher
rate. Learn more about billing
for Routes API.
Use the
travelMode
...
Specify the two-wheeler travel mode
Specify the TWO_WHEELER travel mode in your computeRoute request,
...
Note: For details on supported countries and regions for two-wheeled vehicles, see
Countries and regions
supported for two-wheeled vehicles .
Was this helpful?
Send feedback
