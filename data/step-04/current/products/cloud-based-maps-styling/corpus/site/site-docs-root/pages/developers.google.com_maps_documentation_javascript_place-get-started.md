...
url: https://developers.google.com/maps/documentation/javascript/place-get-started
...
The Places Library is loaded by including the Maps JavaScript API bootstrap loader and then calling importLibrary("places") .
...
Maps JavaScript API
Places API
Places API (New) (required to use Text Search (New)
