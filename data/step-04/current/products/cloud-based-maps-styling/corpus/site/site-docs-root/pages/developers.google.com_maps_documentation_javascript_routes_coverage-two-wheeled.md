---
title: "Countries and regions supported for two-wheeled vehicles \_|\_ Maps JavaScript\
  \ API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/routes/coverage-two-wheeled
...
Countries and regions supported for two-wheeled vehicles | Maps JavaScript API | Google for Developers
...
Issue Tracker
On this page
Countries supported for two-wheeled vehicle routes
...
by country for routes for 2-wheeled vehicles.
Countries supported for two-wheeled vehicle routes
Two-wheeled vehicle routes are currently supported in the following
countries/regions:
Region code
Country/Region
AR
