---
title: "Place Class \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/place
...
Place Class | Maps JavaScript API | Google for Developers
...
On this page
Overview
What you can do with the Place class Search for places
Get place data
...
Nearby Search (New)
lets you search for nearby places by place type.
Place Autocomplete
provides your app with the same type-ahead-search behavior of the Google Maps search field.
Get place data
Place Details (New)
provides detailed information about places, including text summary, operating hours, address,
user reviews, photos, and more.
Place Photos provides access to
high-quality photographic images from the Places database.
Place Reviews provides access to
