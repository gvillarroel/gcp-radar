---
title: "Error Handling \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/error-handling
...
Error Handling | Maps JavaScript API | Google for Developers
...
This page describes how to handle errors when using the Maps JavaScript API,
and the Place class.
The Google Maps JavaScript API uses the following classes for errors:
MapsNetworkError
represents a network error from a web service (can include
RPCStatus errors).
MapsRequestError
...
Note: Errors returned by the classes listed above comprise only one kind of possible
error. It is possible to encounter errors that are not represented by these classes, for
example, client-side validation errors, errors related to API keys or quota, and other
unexpected errors.
