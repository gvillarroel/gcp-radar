---
title: "Support Options for Maps JavaScript API \_|\_ Google for Developers"
...
Support Options for Maps JavaScript API | Google for Developers
...
Browser support
Release notes
Release notes - Cloud-based maps styling
...
Decide on the right support service Enhanced support
Sign up for, or cancel, a support service
Contact the Google Maps Platform support team Create a support case
Manage your cases
...
Was this helpful?
Send feedback
Support Options for Maps Java Script API
...
Page Summary
outlined_flag
Google Maps Platform API support is available through Stack Overflow, the Issue Tracker, and the Google Maps Platform Support page.
Users can create and manage support cases, with varying response times based on the priority level and support plan.
Enhanced Support provides faster response times, case escalation, video conferencing, SLA incident reports, and map data quality assistance.
For privacy inquiries, a dedicated Data Privacy Inquiry Form should be used.
Billing Administrators handle support services for linked projects and require project access to create support cases.
Get help
