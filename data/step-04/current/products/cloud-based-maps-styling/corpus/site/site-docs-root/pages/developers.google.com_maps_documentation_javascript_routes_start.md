---
title: "Get started with Routes \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/routes/start
...
Get started with Routes | Maps JavaScript API | Google for Developers
...
learn more, see Set up your Google Cloud project .
Get an API key
