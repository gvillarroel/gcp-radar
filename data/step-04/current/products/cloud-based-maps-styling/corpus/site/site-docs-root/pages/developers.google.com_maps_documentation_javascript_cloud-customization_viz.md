---
title: "Filter which map features to display \_|\_ Maps JavaScript API \_|\_ Google\
  \ for Developers"
url: https://developers.google.com/maps/documentation/javascript/cloud-customization/viz
...
Filter which map features to display | Maps JavaScript API | Google for Developers
...
In the style editor, select the POI map feature you want to display or hide.
For example, Points of interest > Lodging .
Under Visibility , the visibility is controlled by an eye icon
visibility toggle.
...
Select the icon again to toggle the visibility between off and on.
...
see Manage styles that overlap .
Was this helpful?
Send feedback
