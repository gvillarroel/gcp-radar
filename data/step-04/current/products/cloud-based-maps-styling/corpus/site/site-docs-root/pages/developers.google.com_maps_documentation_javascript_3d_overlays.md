---
title: "Draw on the map \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/3d/overlays
...
Draw on the map | Maps JavaScript API | Google for Developers
