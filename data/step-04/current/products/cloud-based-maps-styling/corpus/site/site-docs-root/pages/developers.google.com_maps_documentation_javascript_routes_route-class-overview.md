---
title: "Route class overview \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/routes/route-class-overview
...
Route class overview | Maps JavaScript API | Google for Developers
...
Diesel, Electric, Hybrid, Gas. Get an eco-friendly route .-->
Set fine-grained options for traffic calculation, letting you make
quality versus latency trade off decisions. Specify how and if to include traffic data .-->
Set vehicle heading (direction of travel) and side-of-road information
for waypoints to increase ETA accuracy. Specify vehicle heading and side of road .-->
Specify pass-through versus terminal locations and safe stopover
locations. Set a stop along a route and
Set a point for a route to pass through .-->
Request toll information, along with route distance and ETA. Calculate toll fees for a route .-->
...
higher request billing rates. Choose what information to return .-->
Next steps
Try the demo
Get started
Get a route
