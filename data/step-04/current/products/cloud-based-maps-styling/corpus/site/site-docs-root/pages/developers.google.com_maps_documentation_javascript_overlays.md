---
title: "Drawing on the Map \_|\_ Maps JavaScript API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/javascript/overlays
...
Page Summary
outlined_flag
The Maps JavaScript API uses objects called overlays to designate points, lines, areas, or collections of objects on the map, which are tied to latitude/longitude coordinates.
...
polylines, polygons and markers on the map.
Geocoding: Retrieving latitudes and longitudes
