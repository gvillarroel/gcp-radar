---
title: "Method: inboundOidcSsoProfiles.list \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/inboundOidcSsoProfiles/list
...
Method: inboundOidcSsoProfiles.list | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Oidc Sso Profiles. list
...
HTTP request
GET https://cloudidentity.googleapis.com/v1/inboundOidcSsoProfiles
...
Specifying a filter of customer=="" will return the global shared OIDC profiles.
page Size
integer
The maximum number of InboundOidcSsoProfile s to return. The service may return fewer than this value.
...
page Token
string
A page token, received from a previous inboundOidcSsoProfiles.list call. Provide this to retrieve the subsequent page.
When paginating, all other parameters provided to inboundOidcSsoProfiles.list must match the call that provided the page token.
Request body
