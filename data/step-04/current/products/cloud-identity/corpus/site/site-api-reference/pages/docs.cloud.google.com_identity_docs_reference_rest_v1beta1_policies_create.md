---
title: "Method: policies.create \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/policies/create
...
Method: policies.create | Cloud Identity | Google Cloud Documentation
...
Create a policy.
HTTP request
POST https://cloudidentity.googleapis.com/v1beta1/policies
