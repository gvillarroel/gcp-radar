---
title: "Method: groups.patch \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups/patch
...
Method: groups.patch | Cloud Identity | Google Cloud Documentation
...
Required. The names of fields to update.
May only contain the following field names: display_name , description , labels , dynamic_group_metadata , posix_groups .
