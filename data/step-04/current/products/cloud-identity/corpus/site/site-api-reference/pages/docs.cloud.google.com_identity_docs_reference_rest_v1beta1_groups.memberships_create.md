---
title: "Method: groups.memberships.create \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups.memberships/create
...
Method: groups.memberships.create | Cloud Identity | Google Cloud Documentation
...
HTTP request
POST https://cloudidentity.googleapis.com/v1beta1/{parent=groups/*}/memberships
