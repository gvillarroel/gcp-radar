---
title: "Method: groups.get \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups/get
...
Method: groups.get | Cloud Identity | Google Cloud Documentation
...
Retrieves a Group .
HTTP request
GET https://cloudidentity.googleapis.com/v1beta1/{name=groups/*}
