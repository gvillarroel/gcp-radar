---
title: "Method: inboundOidcSsoProfiles.get \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundOidcSsoProfiles/get
...
Method: inboundOidcSsoProfiles.get | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Oidc Sso Profiles. get
...
HTTP request
GET https://cloudidentity.googleapis.com/v1beta1/{name=inboundOidcSsoProfiles/*}
...
Response body
If successful, the response body contains an instance of InboundOidcSsoProfile .
Authorization scopes
