---
title: "Method: groups.delete \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups/delete
...
Method: groups.delete | Cloud Identity | Google Cloud Documentation
...
Deletes a Group .
HTTP request
DELETE https://cloudidentity.googleapis.com/v1beta1/{name=groups/*}
The URL uses gRPC Transcoding syntax.
Path parameters
Parameters
name
string
Required. The resource name of the Group to retrieve.
