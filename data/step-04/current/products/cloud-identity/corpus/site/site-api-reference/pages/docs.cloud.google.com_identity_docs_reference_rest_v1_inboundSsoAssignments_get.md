...
title: "Method: inboundSsoAssignments.get \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/inboundSsoAssignments/get
...
HTTP request
GET https://cloudidentity.googleapis.com/v1/{name=inboundSsoAssignments/*}
