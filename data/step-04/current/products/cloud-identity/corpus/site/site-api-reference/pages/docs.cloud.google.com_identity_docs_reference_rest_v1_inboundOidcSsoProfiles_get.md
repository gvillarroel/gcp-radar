...
title: "Method: inboundOidcSsoProfiles.get \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/inboundOidcSsoProfiles/get
...
HTTP request
GET https://cloudidentity.googleapis.com/v1/{name=inboundOidcSsoProfiles/*}
