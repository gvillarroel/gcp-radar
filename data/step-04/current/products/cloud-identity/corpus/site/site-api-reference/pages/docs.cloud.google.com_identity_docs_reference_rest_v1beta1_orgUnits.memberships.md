---
title: "REST Resource: orgUnits.memberships \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/orgUnits.memberships
...
REST Resource: orgUnits.memberships | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
REST Resource: org Units. memberships
...
This follows https://aip.dev/122
Format for shared drive resource: https://drive.googleapis.com/drive/v3/drives/{$memberId }
where $memberId is the id from Drive API (V3) Drive resource .
Entity Type
