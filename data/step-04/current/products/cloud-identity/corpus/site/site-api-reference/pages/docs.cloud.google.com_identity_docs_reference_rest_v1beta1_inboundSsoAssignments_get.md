---
title: "Method: inboundSsoAssignments.get \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundSsoAssignments/get
...
Method: inboundSsoAssignments.get | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Sso Assignments. get
...
HTTP request
GET https://cloudidentity.googleapis.com/v1beta1/{name=inboundSsoAssignments/*}
...
Response body
If successful, the response body contains an instance of InboundSsoAssignment .
Authorization scopes
