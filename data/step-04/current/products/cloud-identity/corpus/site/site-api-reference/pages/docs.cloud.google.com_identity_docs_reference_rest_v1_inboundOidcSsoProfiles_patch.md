---
title: "Method: inboundOidcSsoProfiles.patch \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/inboundOidcSsoProfiles/patch
...
Method: inboundOidcSsoProfiles.patch | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Oidc Sso Profiles. patch
...
HTTP request
PATCH https://cloudidentity.googleapis.com/v1/{inboundOidcSsoProfile.name=inboundOidcSsoProfiles/*}
The URL uses gRPC Transcoding syntax.
Path parameters
Parameters
inbound Oidc Sso Profile. name
string
