---
title: "Method: devices.get \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/devices/get
...
Method: devices.get | Cloud Identity | Google Cloud Documentation
...
customer
string
Optional. Resource name of the Customer in format: customers/{customerId} , where customerId is the customer to whom the device belongs.
Request body
