---
title: "Method: inboundSamlSsoProfiles.list \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundSamlSsoProfiles/list
...
Method: inboundSamlSsoProfiles.list | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Saml Sso Profiles. list
...
page Size
integer
The maximum number of InboundSamlSsoProfile s to return. The service may return fewer than this value.
