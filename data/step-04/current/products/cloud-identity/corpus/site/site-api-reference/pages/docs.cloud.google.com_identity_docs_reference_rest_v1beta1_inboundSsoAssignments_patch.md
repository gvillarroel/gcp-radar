---
title: "Method: inboundSsoAssignments.patch \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundSsoAssignments/patch
...
Method: inboundSsoAssignments.patch | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Sso Assignments. patch
...
HTTP request
PATCH https://cloudidentity.googleapis.com/v1beta1/{inboundSsoAssignment.name=inboundSsoAssignments/*}
The URL uses gRPC Transcoding syntax.
Path parameters
Parameters
inbound Sso Assignment. name
string
