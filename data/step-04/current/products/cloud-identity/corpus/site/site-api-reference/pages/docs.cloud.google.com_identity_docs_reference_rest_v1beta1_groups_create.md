---
title: "Method: groups.create \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups/create
...
Method: groups.create | Cloud Identity | Google Cloud Documentation
...
Enums
INITIAL_ GROUP_ CONFIG_ UNSPECIFIED
Default. Should not be used.
WITH_ INITIAL_ OWNER
