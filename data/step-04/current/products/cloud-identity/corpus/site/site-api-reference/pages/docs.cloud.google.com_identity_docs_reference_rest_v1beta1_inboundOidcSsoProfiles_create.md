...
title: "Method: inboundOidcSsoProfiles.create \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundOidcSsoProfiles/create
...
HTTP request
POST https://cloudidentity.googleapis.com/v1beta1/inboundOidcSsoProfiles
