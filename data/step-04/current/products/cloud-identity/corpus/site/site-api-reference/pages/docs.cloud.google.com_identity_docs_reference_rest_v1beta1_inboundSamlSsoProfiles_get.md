---
title: "Method: inboundSamlSsoProfiles.get \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundSamlSsoProfiles/get
...
Method: inboundSamlSsoProfiles.get | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Saml Sso Profiles. get
...
HTTP request
GET https://cloudidentity.googleapis.com/v1beta1/{name=inboundSamlSsoProfiles/*}
...
Response body
If successful, the response body contains an instance of InboundSamlSsoProfile .
Authorization scopes
