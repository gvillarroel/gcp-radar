---
title: "Method: inboundSsoAssignments.list \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/inboundSsoAssignments/list
...
Method: inboundSsoAssignments.list | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: inbound Sso Assignments. list
...
filter
string
A CEL expression to filter the results.
