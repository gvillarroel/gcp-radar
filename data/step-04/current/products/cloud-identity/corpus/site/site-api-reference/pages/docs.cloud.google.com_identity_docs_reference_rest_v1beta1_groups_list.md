---
title: "Method: groups.list \_|\_ Cloud Identity \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups/list
...
Method: groups.list | Cloud Identity | Google Cloud Documentation
...
Must be of the form identitysources/{identity_source_id} for external- identity-mapped groups or customers/{customer_id} for Google Groups. The customer_id must begin with "C" (for example, 'C046psxkn'). Find your customer ID.
view
enum ( View )
...
View
The view options for the GroupsService.ListGroups method.
Enums
VIEW_UNSPECIFIED
