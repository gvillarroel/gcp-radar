...
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/groups/patch
...
May only contain the following field names: display_name , description , labels .
