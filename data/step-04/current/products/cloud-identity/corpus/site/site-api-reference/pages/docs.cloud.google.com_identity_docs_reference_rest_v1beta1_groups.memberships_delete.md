---
title: "Method: groups.memberships.delete \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/groups.memberships/delete
...
Method: groups.memberships.delete | Cloud Identity | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: groups. memberships. delete
...
HTTP request
DELETE https://cloudidentity.googleapis.com/v1beta1/{name=groups/*/memberships/*}
The URL uses gRPC Transcoding syntax.
Path parameters
Parameters
name
string
Required. The resource name of the Membership to delete.
