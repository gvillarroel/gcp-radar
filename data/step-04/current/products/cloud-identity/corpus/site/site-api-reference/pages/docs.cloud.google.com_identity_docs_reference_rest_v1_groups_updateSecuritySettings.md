...
title: "Method: groups.updateSecuritySettings \_|\_ Cloud Identity \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1/groups/updateSecuritySettings
...
Update Security Settings
HTTP request
PATCH https://cloudidentity.googleapis.com/v1/{securitySettings.name=groups/*/securitySettings}
