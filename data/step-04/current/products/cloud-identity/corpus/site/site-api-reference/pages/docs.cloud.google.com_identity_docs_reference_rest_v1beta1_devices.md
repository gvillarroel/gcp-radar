...
url: https://docs.cloud.google.com/identity/docs/reference/rest/v1beta1/devices
...
REST Resource: devices | Cloud Identity | Google Cloud Documentation
...
name
string
Output only. Resource name of the Device in format: devices/{deviceId} , where deviceId is the unique id assigned to the Device.
createTime
