...
Security Token Service audit logging | Identity and Access Management (IAM) | Google Cloud Documentation
...
API interface audit logs google.identity.sts.SecurityTokenService
...
Methods
ADMIN_ READ
google. identity. sts. Security Token Service. Web Sign In google. identity. sts. Security Token Service. Web Sign Out google. identity. sts. v1. Security Token Service. Exchange Token google. identity. sts. v1beta. Security Token Service. Exchange Token
API interface audit logs
For information about how and which permissions are evaluated for each method,
see the Identity and Access Management documentation for Security Token Service.
google. identity. sts. Security Token Service
