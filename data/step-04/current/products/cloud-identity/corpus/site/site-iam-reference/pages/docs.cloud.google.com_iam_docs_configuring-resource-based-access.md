...
Configure resource-based access | Identity and Access Management (IAM) | Google Cloud Documentation
...
Extract values from resource names Example: Match orders from the last 30 days
Example: Match Compute Engine VMs in any location
Important usage considerations for resource-based conditions Inherited conditions
Custom roles
