...
Authenticate workloads with Google Cloud auth libraries | Identity and Access Management (IAM) | Google Cloud Documentation
...
Authenticate using custom credential suppliers Access resources from AWS
