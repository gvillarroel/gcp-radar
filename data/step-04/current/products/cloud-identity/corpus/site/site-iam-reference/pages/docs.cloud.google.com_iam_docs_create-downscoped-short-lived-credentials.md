...
Create a downscoped short-lived credential | Identity and Access Management (IAM) | Google Cloud Documentation
...
Exchange the OAuth 2.0 access token Client-side token exchange
