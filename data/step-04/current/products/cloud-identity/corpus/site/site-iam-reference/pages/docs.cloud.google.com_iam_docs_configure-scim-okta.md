---
title: "Configure SCIM in Okta \_|\_ Identity and Access Management (IAM) \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/configure-scim-okta
...
source_metadata:
  url: https://docs.cloud.google.com/iam/docs/configure-scim-okta
  title: "Configure SCIM in Okta \_|\_ Identity and Access Management (IAM) \_|\_\
    \ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Configure SCIM in Okta | Identity and Access Management (IAM) | Google Cloud Documentation
...
Click the name of the application you created using the Google Cloud Workforce Identity Federation template.
In the General tab, do the following:
In the App Settings pane, click Edit .
In the Tenant field, enter the Tenant ID obtained from gcloud CLI.
Click Done .
...
In the Application field, enter a name for your app.
In the Tenant field, enter the Tenant ID obtained from gcloud CLI.
Click Done .
In the Provisioning tab, do the following:
In the Integration pane, click Edit .
In the API Token field, enter the SCIM token you obtained from Google Cloud.
To confirm the validity of the API token, click Test Credentials .
Select Import Groups .
Click Save .
In the To App pane, click Edit .
Select Create Users , Update User Attributes , and Deactivate users .
Click Save .
Update the provider to enable SCIM
