...
Configure managed workload identity authentication for Compute Engine | Identity and Access Management (IAM) | Google Cloud Documentation
...
Define a workload attestation policy Define a workload attestation policy with attestation rules
...
Define the trust and certificate issuance config Define the certificate issuance config
...
Service account email address Service account UID Instance ID
More
