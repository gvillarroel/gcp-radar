...
Create and manage custom roles | Identity and Access Management (IAM) | Google Cloud Documentation
...
gcloud C++ C# Go Java Python REST
More
In one of the following development environments, set up the gcloud CLI:
Cloud Shell : to use an online terminal with the gcloud CLI
already set up, activate Cloud Shell.
...
the page.
Select the checkbox for one or more roles to view the role permissions.
...
(hexagon icon).
If you want to find all the roles that include a specific permission, type
the permission name in the Filter box at the top of the Roles list.
In one of the following development environments, set up the gcloud CLI:
Cloud Shell : to use an online terminal with the gcloud CLI
already set up, activate Cloud Shell.
Activate Cloud Shell on this page
...
In the Google Cloud console, go to the Roles page.
Go to the Roles page
Select the role you wish to delete and click
delete Delete on the
top of the page.
In one of the following development environments, set up the gcloud CLI:
Cloud Shell : to use an online terminal with the gcloud CLI
already set up, activate Cloud Shell.
...
In the Google Cloud console, go to the Roles page.
Go to the Roles page
Locate the role you wish to undelete, click the more icon
at the end of the row, and click Undelete .
In one of the following development environments, set up the gcloud CLI:
Cloud Shell : to use an online terminal with the gcloud CLI
already set up, activate Cloud Shell.
Activate Cloud Shell on this page
