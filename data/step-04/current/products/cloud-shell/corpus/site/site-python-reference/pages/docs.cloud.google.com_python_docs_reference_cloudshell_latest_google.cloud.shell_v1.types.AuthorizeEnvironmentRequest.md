---
title: "Class AuthorizeEnvironmentRequest (1.15.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudshell/latest/google.cloud.shell_v1.types.AuthorizeEnvironmentRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/cloudshell/latest/google.cloud.shell_v1.types.AuthorizeEnvironmentRequest
  title: "Class AuthorizeEnvironmentRequest (1.15.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class AuthorizeEnvironmentRequest (1.15.0)
