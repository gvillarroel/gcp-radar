---
title: "Class CloudShellServiceAsyncClient (1.15.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudshell/latest/google.cloud.shell_v1.services.cloud_shell_service.CloudShellServiceAsyncClient
...
Client libraries
Send feedback
Class CloudShellServiceAsyncClient (1.15.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudShellServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.shell_v1.types.AddPublicKeyRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.shell_v1.types.AuthorizeEnvironmentRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.shell_v1.types.GetEnvironmentRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.shell_v1.types.RemovePublicKeyRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.shell_v1.types.StartEnvironmentRequest , dict]]
