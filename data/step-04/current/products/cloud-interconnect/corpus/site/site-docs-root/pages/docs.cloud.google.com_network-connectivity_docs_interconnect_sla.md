---
title: Cloud Dedicated and Partner Interconnect SLA | Google Cloud
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/sla
...
Current
Cloud Dedicated and Partner Interconnect Service Level Agreement (SLA)
...
Interconnect service for production-level applications
>=99.99%
Interconnect service for non-critical applications
>=99.9%
...
" Non-critical applications " means applications that are deployed in Google Cloud Platform meeting all the requirements in the Documentation for " Creating a Topology for Non-critical Applications ".
" Production-level applications " means applications that are deployed in Google Cloud Platform meeting all the requirements in the Documentation for " Creating a Topology for Production-Level Applications ".
...
January 9, 2020 March 7, 2019 June 11, 2018 October 23, 2017 September 8, 2017
menu
