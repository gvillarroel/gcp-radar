---
title: "Connect to Oracle Cloud Infrastructure \_|\_ Cloud Interconnect \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/oci/connectivity-overview
...
between Google Cloud and Oracle Cloud Infrastructure (OCI) networks.
...
OCI ports. Make a note of the location names. You need these details to
...
ordering your OCI ports.
Order
OCI ports Order your OCI ports, and download the
...
region in your VPC network and your OCI resources. Then, for
