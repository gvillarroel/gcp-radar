---
title: "Change Dedicated Interconnect reliability options \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/dedicated/change-reliability-options
...
Change Dedicated Interconnect reliability options | Google Cloud Documentation
...
Console gcloud
More
Note: You can't set the intended reliability for your
Cloud Interconnect connection group to no SLA using the
Google Cloud console. If you need to remove your SLA, use the Google Cloud CLI.
...
More
Note: You can't set the intended reliability for your
Cloud Interconnect VLAN attachment group to no SLA using the
Google Cloud console. If you need to remove your SLA, use the Google Cloud CLI.
In the Google Cloud console, go to the Cloud Interconnect
