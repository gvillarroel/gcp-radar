---
title: "Connect to Amazon Web Services \_|\_ Cloud Interconnect \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/aws/connectivity-overview
...
Connect to Amazon Web Services | Cloud Interconnect | Google Cloud Documentation
...
between Google Cloud and Amazon Web Services (AWS) networks.
...
AWS ports. Make a note of the location names. You need these details to
...
ordering your AWS ports.
Order
AWS ports Order your AWS ports, and download the
...
region in your VPC network and your AWS resources. Then, for
each VLAN attachment, use a Cloud Router to configure a Border Gateway Protocol (BGP) peering
session.
Configure your AWS resources
Configure your AWS resources. This step includes
creating a BGP peering session.
Verify your connections
