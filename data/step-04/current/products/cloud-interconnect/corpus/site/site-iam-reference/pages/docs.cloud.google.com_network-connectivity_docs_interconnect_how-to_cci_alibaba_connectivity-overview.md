---
title: "Connect to Alibaba Cloud \_|\_ Cloud Interconnect \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/alibaba/connectivity-overview
...
Connect to Alibaba Cloud | Cloud Interconnect | Google Cloud Documentation
...
between Google Cloud and Alibaba Cloud networks.
...
Alibaba ports. Make a note of the location names. You need these details to
...
ordering your Alibaba ports.
Order
Alibaba ports Order your Alibaba ports, and download the
...
region in your VPC network and your Alibaba resources. Then, for
