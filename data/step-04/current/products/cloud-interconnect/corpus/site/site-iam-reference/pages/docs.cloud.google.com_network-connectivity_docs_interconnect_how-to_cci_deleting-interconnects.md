---
title: "Delete connections \_|\_ Cloud Interconnect \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/deleting-interconnects
...
Delete connections | Cloud Interconnect | Google Cloud Documentation
...
On this page
What's next
When you delete a Cross-Cloud Interconnect connection, Google
shuts down your ports, and billing stops immediately.
You must also notify your remote cloud service provider to
discontinue your port in their network and avoid further billing.
...
delete Delete .
In the confirmation box, type the name of the connection that you want to
delete.
Click Delete this Interconnect .
Use the
gcloud compute interconnects delete command :
