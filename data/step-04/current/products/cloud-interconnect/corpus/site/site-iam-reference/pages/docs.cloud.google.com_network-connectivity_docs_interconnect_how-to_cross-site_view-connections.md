...
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cross-site/view-connections
...
Go to Interconnect
On the Physical connections tab, select the
...
Replace CONNECTION_NAME with the name of the
