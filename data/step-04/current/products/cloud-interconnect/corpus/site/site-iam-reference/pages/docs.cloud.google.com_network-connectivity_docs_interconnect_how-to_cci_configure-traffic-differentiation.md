...
title: "Configure traffic differentiation \_|\_ Cloud Interconnect \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/configure-traffic-differentiation
...
Turn off traffic differentiation
What's next
Application awareness helps you use your Cross-Cloud Interconnect connections more
efficiently by using
differentiated services field codepoint (DSCP)
for traffic differentiation.
You can configure traffic differentiation for outbound Cross-Cloud Interconnect data
...
Allocate your Cross-Cloud Interconnect outbound data transfer bandwidth among six
different traffic classes .
Use traffic shaping controls in addition to either policy type to set the
maximum bandwidth that each traffic class can use on your Cross-Cloud Interconnect
outbound data transfers.
The following sections describe application awareness on Cloud Interconnect
and how to configure it for your Cross-Cloud Interconnect connection.
...
ranges, to differentiate traffic on Cross-Cloud Interconnect. The following table
