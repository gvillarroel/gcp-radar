...
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/azure/test-connections
...
Check the route table
Review the Troubleshooting page
Note: This page includes instructions about Azure products. Google doesn't guarantee that
this guidance is up to date or that the sample configuration choices are ideal for your use case.
...
input from the Azure port. The value in this column should be OK .
