...
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/modifying-vlan-attachments
...
Disable VLAN attachments .
VLAN ID
BGP IP addresses (Cloud Router IP address, remote cloud
router IP address)
You can't modify these properties for existing attachments. Instead,
you must re-create the VLAN attachment.
MD5 authentication
Update the BGP session by following the steps in
...
The glcoud compute routers update-bgp-peer command reference
The routers.update API method reference
Modify description, capacity, and MTU
