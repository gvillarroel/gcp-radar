...
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/aws/test-connections
...
input from the AWS port. The value in this column should be OK .
