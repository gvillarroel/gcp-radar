---
title: "Disconnect networks \_|\_ Cloud Interconnect \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/disconnecting-networks
...
Disconnect networks | Cloud Interconnect | Google Cloud Documentation
...
For the Cloud Interconnect connection that you want to configure, click
Configure .
In the Router connections section, select the VLAN attachment to
delete.
Select the options button, and then click Delete .
Click Delete to confirm that you want to delete the VLAN
attachment.
Use the
