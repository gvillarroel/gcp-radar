...
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/cci/azure/order-google-connections
...
Project selection
Order your connections
To begin the process of connecting to Microsoft Azure, order your
...
Microsoft Azure .
In the Remote location field, select the Azure
location.
In the Google Cloud location field, select the
Cross-Cloud Interconnect location.
Set Capacity to 10 Gb/s or 100 Gb/s . Because Azure does not support
LACP, the other options are not valid.
...
in the sense that it does not require you to use a partner provider. For that reason, set the
--interconnect-type flag to DEDICATED .
Azure does not support
Link Aggregation Control Protocol (LACP) .
For that reason, set --requested-link-count
to 1 . If you need more capacity, order additional
Cross-Cloud Interconnect connections.
