---
title: "Options for connecting to multiple VPC networks \_|\_ Cloud Interconnect \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/enabling-multiple-networks-access-same-attachment
...
source_metadata:
  url: https://docs.cloud.google.com/network-connectivity/docs/interconnect/how-to/enabling-multiple-networks-access-same-attachment
  title: "Options for connecting to multiple VPC networks \_|\_ Cloud Interconnect\
    \ \_|\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Options for connecting to multiple VPC networks | Cloud Interconnect | Google Cloud Documentation
...
Create VLAN attachments for Dedicated Interconnect
Create VLAN attachments for Partner Interconnect
Use Dedicated Interconnect connections in other projects
Note: If you don't use a Shared VPC network, you can create multiple
VLAN attachments and Cloud Routers for other projects and networks.
However, this method is less cost efficient than using a Shared VPC
network.
Use Cloud Interconnect with Shared VPC
...
network, Service Project Admins don't
