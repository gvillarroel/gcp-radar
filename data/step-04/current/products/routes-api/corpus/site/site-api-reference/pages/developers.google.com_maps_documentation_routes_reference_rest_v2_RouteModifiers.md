---
title: "RouteModifiers \_|\_ Routes API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/routes/reference/rest/v2/RouteModifiers
...
Page Summary
outlined_flag
Route Modifiers allow specifying conditions like avoiding tolls, highways, ferries, or indoor navigation when calculating routes for DRIVE, TWO_WHEELER, and WALK travel modes.
Vehicle information, such as emission type (GASOLINE, ELECTRIC, HYBRID, DIESEL), can be provided for DRIVE travel mode.
Toll pass information can be included to obtain pass prices for supported toll roads around the world when using DRIVE and TWO_WHEELER travel modes.
JSON representation
VehicleInfo
JSON representation
VehicleEmissionType
