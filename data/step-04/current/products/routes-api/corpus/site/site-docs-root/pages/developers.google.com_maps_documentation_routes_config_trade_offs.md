---
title: "Set the level of traffic data \_|\_ Routes API \_|\_ Google for Developers"
...
Page Summary
outlined_flag
The Routes API offers three traffic preferences: TRAFFIC_UNAWARE for fastest response, TRAFFIC_AWARE for balanced accuracy and speed, and TRAFFIC_AWARE_OPTIMAL for the most accurate results with higher latency.
TRAFFIC_UNAWARE uses average traffic conditions and is suitable for scenarios where speed is prioritized over accuracy.
TRAFFIC_AWARE considers real-time traffic but applies optimizations for faster responses.
TRAFFIC_AWARE_OPTIMAL performs an exhaustive search for the best route based on live traffic, similar to Google Maps, but results in higher latency.
...
Caution: Requests using TRAFFIC_AWARE and TRAFFIC_AWARE_OPTIMAL are billed
at a higher rate. Learn more about billing .
Traffic conditions
...
elements in a request (number of origins × number of destinations) is limited.
...
Request polylines for more information.
Send feedback
