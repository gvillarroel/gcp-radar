---
title: "App Engine standard environment for Node.js release notes \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/appengine/docs/standard/nodejs/release-notes
...
Add the GOOGLE_NODE_RUN_SCRIPTS build environment variable with an empty value such as GOOGLE_NODE_RUN_SCRIPTS="" . For details about specifying build environment variables see
build_env_variables .
April 05, 2023
Feature
