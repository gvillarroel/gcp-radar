---
title: "Use the Cloud SQL remote MCP server \_|\_ Cloud SQL for PostgreSQL \_|\_ Google\
  \ Cloud Documentation"
...
source_metadata:
  url: https://docs.cloud.google.com/sql/docs/postgres/use-cloudsql-mcp
  title: "Use the Cloud SQL remote MCP server \_|\_ Cloud SQL for PostgreSQL \_|\_\
...
This document shows you how to use the Cloud SQL for PostgreSQL remote Model Context
...
AI agent platforms.
.
The Cloud SQL for PostgreSQL remote MCP server is enabled when you
enable the Cloud SQL for PostgreSQL API.
...
Cloud SQL for PostgreSQL MCP Toolbox for Databases .
...
The following sections only apply to the Cloud SQL for PostgreSQL
remote MCP server.
Before you begin
Required roles
