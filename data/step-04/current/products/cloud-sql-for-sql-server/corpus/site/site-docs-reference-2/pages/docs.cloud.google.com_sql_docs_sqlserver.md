---
title: "Cloud SQL for SQL Server documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/sqlserver
...
For information specific to Microsoft SQL Server, see the
...
Shows how to migrate data from Microsoft SQL Server 2017 Enterprise running on Compute Engine to Cloud SQL for SQL Server 2017 Enterprise.
Migration
Replication
Use case
Use cases
Migrating data between SQL Server 2008 and Cloud SQL for SQL Server using backup files
Shows how to migrate data from SQL Server 2008 to Cloud SQL for SQL Server 2017 Enterprise.
Migration
Use case
Use cases
