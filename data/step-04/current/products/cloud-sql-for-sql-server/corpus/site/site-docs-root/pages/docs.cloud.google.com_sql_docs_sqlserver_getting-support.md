---
title: "Get support \_|\_ Cloud SQL for SQL Server \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/sqlserver/getting-support
...
Join the
google-cloud-sql-discuss
Google group to discuss Cloud SQL for SQL Server issues.
...
To be notified of product updates and new features for SQL Server,
