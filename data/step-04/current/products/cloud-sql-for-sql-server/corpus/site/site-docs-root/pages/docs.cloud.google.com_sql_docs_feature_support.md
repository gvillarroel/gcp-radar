---
title: "Cloud SQL feature support by database engine \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/feature_support
...
This page lists the main features of Cloud SQL and indicates which
database engines support these features.
...
✓
Data migration
Data migration to external servers
✓
Logs
Instance logging
✓
