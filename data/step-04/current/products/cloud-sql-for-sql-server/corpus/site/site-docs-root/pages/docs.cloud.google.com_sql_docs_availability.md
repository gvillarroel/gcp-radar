---
title: "Availability in Cloud SQL \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/availability
...
Perform a minor version upgrade on a MySQL 8.0 instance
with sub-second downtime
For PostgreSQL instances, minor version upgrades are part of automatic
maintenance and happen with sub-second downtime
Edition upgrade
