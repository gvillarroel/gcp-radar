---
title: "Private Service Connect overview \_|\_ Cloud SQL for SQL Server \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/sqlserver/about-private-service-connect
...
The supported serving ports for SQL Server are as follows:
TCP port 1433 for direct connections to SQL Server database server.
...
your network,
use a linked server
that requires an outbound connection, or do a
...
If you enable Private Service Connect outbound connectivity
for an instance, then you can't create a
replica for that
instance.
