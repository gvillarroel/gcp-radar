---
title: "Manage standard backups \_|\_ Cloud SQL for SQL Server \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/sql/docs/sqlserver/backup-recovery/manage-standard-backups
...
The number can't be less than the PITR log retention days.
Click Save .
gcloud
...
num-to-retain : The number of automated backups to retain. The number can't be
less than the default (7).
project-id : The project ID
instance-id : The instance ID
HTTP method and URL:
