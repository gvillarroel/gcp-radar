---
title: "Place types \_|\_ Places Insights \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/placesinsights/place-types
...
of a place. A place can have one or more place types assigned to it.
A place can have a single primary type from the list
below associated with it. For example, the primary type
might be mexican_restaurant or steak_house .
The primary type may be missing if the place's primary
type is not a supported type.
A place can have multiple type values from the list below
associated with it. For example a restaurant might have the following
