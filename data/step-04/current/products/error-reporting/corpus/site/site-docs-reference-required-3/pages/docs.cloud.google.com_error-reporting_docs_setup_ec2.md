---
title: "Setting up Error Reporting on Amazon EC2 \_|\_ Google Cloud Documentation"
...
You can send errors from your EC2 applications to
...
To connect your EC2 applications to Error Reporting,
send your exceptions or other errors to Logging.
For example:
Connect the Amazon Web Services (AWS) system to Google Cloud.
For more information, see Installing the Logging Agent on individual VMs .
