---
title: "Class ErrorGroupServiceAsyncClient (1.15.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/clouderrorreporting/latest/google.cloud.errorreporting_v1beta1.services.error_group_service.ErrorGroupServiceAsyncClient
...
Client libraries
Send feedback
Class ErrorGroupServiceAsyncClient (1.15.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the ErrorGroupServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.errorreporting_v1beta1.types.GetGroupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.errorreporting_v1beta1.types.UpdateGroupRequest , dict]]
