---
title: "Create an A3 Ultra Slurm cluster \_|\_ Cluster Toolkit \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/cluster-toolkit/docs/deploy/slurm/create-a3-ultra-cluster
...
This document describes how to deploy a Slurm cluster that uses A3 Ultra
...
A3 Ultra : requires a minimum of 10 TiB
...
later. Verify your installed version:
./gcluster --version
...
Cluster Toolkit directory. The ./gcluster deploy command takes
...
redeploying. You can speed up redeployments by using an existing image from a
