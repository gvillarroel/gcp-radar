...
url: https://docs.cloud.google.com/cluster-toolkit/docs/deploy/gke/deploy-a3-mega-gke-cluster
...
verify that all VPC and subnet names are unique per project to
prevent errors.
