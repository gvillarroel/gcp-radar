---
title: "Deploy a regional Google-managed certificate with DNS authorization \_|\_\
  \ Certificate Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/certificate-manager/docs/deploy-google-managed-regional
...
regional Google-managed certificate with DNS
authorization to a
...
Deploy a global Google-managed certificate with DNS
authorization
...
Certificate Manager. To create a regional Google-managed
certificate, you must use per-project DNS authorization.
...
Important : For regional Google-managed certificates, you must create a regional
DNS authorization in the same region as the certificate. You can't use global
...
implementation of account-based DNS authorization for PER_PROJECT_RECORD DNS
authorizations.
Console
...
LOCATION : the target Google Cloud location where you create the DNS authorization. You must provide a
specific target location, such as us-central1 .
...
dns-authorizations and location flags:
...
To deploy the regional Google-managed certificate to a regional external Application Load Balancer or
regional internal Application Load Balancer, attach it directly to the
target proxy.
