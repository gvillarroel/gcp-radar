---
title: "Class Certificate.ManagedCertificate.ProvisioningIssue.Builder (0.91.0) \_\
  |\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-certificate-manager/latest/com.google.cloud.certificatemanager.v1.Certificate.ManagedCertificate.ProvisioningIssue.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-certificate-manager/latest/com.google.cloud.certificatemanager.v1.Certificate.ManagedCertificate.ProvisioningIssue.Builder
  title: "Class Certificate.ManagedCertificate.ProvisioningIssue.Builder (0.91.0)\
...
Client libraries
Send feedback
Class Certificate.ManagedCertificate.ProvisioningIssue.Builder (0.91.0)
...
0.2.0
0.1.1
public static final class Certificate . ManagedCertificate . ProvisioningIssue . Builder extends GeneratedMessage . Builder<Certificate . ManagedCertificate . ProvisioningIssue . Builder > implements Certificate . ManagedCertificate . ProvisioningIssueOrBuilder
...
Methods
build()
public Certificate . ManagedCertificate . ProvisioningIssue build ()
Returns
Type
Description
Certificate.ManagedCertificate.ProvisioningIssue
buildPartial()
public Certificate . ManagedCertificate . ProvisioningIssue buildPartial ()
Returns
Type
Description
Certificate.ManagedCertificate.ProvisioningIssue
clear()
public Certificate . ManagedCertificate . ProvisioningIssue . Builder clear ()
Returns
Type
Description
Certificate.ManagedCertificate.ProvisioningIssue.Builder
...
clearDetails()
public Certificate . ManagedCertificate . ProvisioningIssue . Builder clearDetails ()
...
clearReason()
public Certificate . ManagedCertificate . ProvisioningIssue . Builder clearReason ()
...
mergeFrom(Certificate.ManagedCertificate.ProvisioningIssue other)
public Certificate . ManagedCertificate . ProvisioningIssue . Builder mergeFrom ( Certificate . ManagedCertificate . ProvisioningIssue other )
Parameter
Name
Description
other
...
public Certificate . ManagedCertificate . ProvisioningIssue . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public Certificate . ManagedCertificate . ProvisioningIssue . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public Certificate . ManagedCertificate . ProvisioningIssue . Builder setDetails ( String value )
Output only. Human readable explanation about the issue. Provided to
help address the configuration issues. Not guaranteed to be stable. For
programmatic access use Reason enum.
string details = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];
...
public Certificate . ManagedCertificate . ProvisioningIssue . Builder setDetailsBytes ( ByteString value )
Output only. Human readable explanation about the issue. Provided to
help address the configuration issues. Not guaranteed to be stable. For
programmatic access use Reason enum.
string details = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];
...
Certificate.ManagedCertificate.ProvisioningIssue.Builder
This builder for chaining.
setReason(Certificate.ManagedCertificate.ProvisioningIssue.Reason value)
public Certificate . ManagedCertificate . ProvisioningIssue . Builder setReason ( Certificate . ManagedCertificate . ProvisioningIssue . Reason value )
Output only. Reason for provisioning failures.
.google.cloud.certificatemanager.v1.Certificate.ManagedCertificate.ProvisioningIssue.Reason reason = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];
Parameter
Name
Description
value
Certificate.ManagedCertificate.ProvisioningIssue.Reason The reason to set.
Returns
Type
Description
Certificate.ManagedCertificate.ProvisioningIssue.Builder
...
public Certificate . ManagedCertificate . ProvisioningIssue . Builder setReasonValue ( int value )
Output only. Reason for provisioning failures.
.google.cloud.certificatemanager.v1.Certificate.ManagedCertificate.ProvisioningIssue.Reason reason = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];
Parameter
Name
