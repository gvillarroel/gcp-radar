---
title: "Class Certificate.ManagedCertificate.AuthorizationAttemptInfo (0.91.0) \_\
  |\_ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-certificate-manager/latest/com.google.cloud.certificatemanager.v1.Certificate.ManagedCertificate.AuthorizationAttemptInfo
...
Client libraries
Send feedback
Class Certificate.ManagedCertificate.AuthorizationAttemptInfo (0.91.0)
...
0.2.0
0.1.1
public static final class Certificate . ManagedCertificate . AuthorizationAttemptInfo extends GeneratedMessage implements Certificate . ManagedCertificate . AuthorizationAttemptInfoOrBuilder
...
Static Methods
getDefaultInstance()
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo getDefaultInstance ()
Returns
Type
Description
Certificate.ManagedCertificate.AuthorizationAttemptInfo
...
Descriptor
newBuilder()
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo . Builder newBuilder ()
Returns
Type
Description
Certificate.ManagedCertificate.AuthorizationAttemptInfo.Builder
newBuilder(Certificate.ManagedCertificate.AuthorizationAttemptInfo prototype)
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo . Builder newBuilder ( Certificate . ManagedCertificate . AuthorizationAttemptInfo prototype )
Parameter
Name
Description
prototype
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static Certificate . ManagedCertificate . AuthorizationAttemptInfo parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<Certificate . ManagedCertificate . AuthorizationAttemptInfo > parser ()
Returns
Type
Description
Parser < AuthorizationAttemptInfo >
Methods
equals(Object obj)
...
getParserForType()
public Parser<Certificate . ManagedCertificate . AuthorizationAttemptInfo > getParserForType ()
Returns
Type
Description
Parser < AuthorizationAttemptInfo >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public Certificate . ManagedCertificate . AuthorizationAttemptInfo . Builder newBuilderForType ()
Returns
Type
Description
Certificate.ManagedCertificate.AuthorizationAttemptInfo.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected Certificate . ManagedCertificate . AuthorizationAttemptInfo . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public Certificate . ManagedCertificate . AuthorizationAttemptInfo . Builder toBuilder ()
Returns
Type
Description
Certificate.ManagedCertificate.AuthorizationAttemptInfo.Builder
