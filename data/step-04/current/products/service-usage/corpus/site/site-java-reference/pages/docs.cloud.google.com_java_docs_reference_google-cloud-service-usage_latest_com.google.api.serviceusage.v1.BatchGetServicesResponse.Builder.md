---
title: "Class BatchGetServicesResponse.Builder (2.88.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-service-usage/latest/com.google.api.serviceusage.v1.BatchGetServicesResponse.Builder
...
Client libraries
Send feedback
Class BatchGetServicesResponse.Builder (2.88.0)
...
2.3.7
2.2.8
public static final class BatchGetServicesResponse . Builder extends GeneratedMessage . Builder<BatchGetServicesResponse . Builder > implements BatchGetServicesResponseOrBuilder
...
public BatchGetServicesResponse . Builder addAllServices ( Iterable < ? extends Service > values )
...
public BatchGetServicesResponse . Builder addServices ( Service value )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameter
Name
...
public BatchGetServicesResponse . Builder addServices ( Service . Builder builderForValue )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameter
Name
...
public BatchGetServicesResponse . Builder addServices ( int index , Service value )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameters
Name
...
public BatchGetServicesResponse . Builder addServices ( int index , Service . Builder builderForValue )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameters
Name
...
Service.Builder
build()
public BatchGetServicesResponse build ()
Returns
Type
Description
BatchGetServicesResponse
buildPartial()
public BatchGetServicesResponse buildPartial ()
Returns
Type
Description
BatchGetServicesResponse
clear()
public BatchGetServicesResponse . Builder clear ()
Returns
Type
Description
BatchGetServicesResponse.Builder
...
clearServices()
public BatchGetServicesResponse . Builder clearServices ()
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Returns
Type
...
mergeFrom(BatchGetServicesResponse other)
public BatchGetServicesResponse . Builder mergeFrom ( BatchGetServicesResponse other )
Parameter
Name
Description
other
...
public BatchGetServicesResponse . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public BatchGetServicesResponse . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public BatchGetServicesResponse . Builder removeServices ( int index )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameter
Name
...
public BatchGetServicesResponse . Builder setServices ( int index , Service value )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameters
Name
...
public BatchGetServicesResponse . Builder setServices ( int index , Service . Builder builderForValue )
The requested Service states.
repeated .google.api.serviceusage.v1.Service services = 1;
Parameters
Name
