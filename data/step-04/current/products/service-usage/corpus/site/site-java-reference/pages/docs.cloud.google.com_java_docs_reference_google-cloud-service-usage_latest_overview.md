---
title: "google-cloud-service-usage overview (2.88.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-service-usage/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-service-usage/latest/overview
  title: "google-cloud-service-usage overview (2.88.0) \_|\_ Java client libraries\
...
Client libraries
Send feedback
google-cloud-service-usage overview (2.88.0)
...
Service Usage Product Reference
GitHub Repository
Maven artifact
Getting Started
...
For this library, we recommend using com.google.api.serviceusage.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Service Usage). New Version IDs are introduced infrequently, and often involve
