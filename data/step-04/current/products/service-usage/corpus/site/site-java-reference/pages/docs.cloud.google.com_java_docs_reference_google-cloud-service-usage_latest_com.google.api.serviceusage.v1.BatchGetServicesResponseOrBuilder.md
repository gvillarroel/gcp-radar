---
title: "Interface BatchGetServicesResponseOrBuilder (2.88.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-service-usage/latest/com.google.api.serviceusage.v1.BatchGetServicesResponseOrBuilder
...
Client libraries
Send feedback
Interface BatchGetServicesResponseOrBuilder (2.88.0)
...
2.3.7
2.2.8
public interface BatchGetServicesResponseOrBuilder extends MessageOrBuilder
Implements
MessageOrBuilder
Methods
