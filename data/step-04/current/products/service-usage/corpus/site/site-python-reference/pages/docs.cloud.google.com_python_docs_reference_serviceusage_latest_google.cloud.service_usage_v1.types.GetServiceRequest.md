---
title: "Class GetServiceRequest (1.16.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/serviceusage/latest/google.cloud.service_usage_v1.types.GetServiceRequest
...
Client libraries
Send feedback
Class GetServiceRequest (1.16.0)
