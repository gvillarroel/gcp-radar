---
title: "Class BatchEnableServicesRequest (1.16.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/serviceusage/latest/google.cloud.service_usage_v1.types.BatchEnableServicesRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/serviceusage/latest/google.cloud.service_usage_v1.types.BatchEnableServicesRequest
  title: "Class BatchEnableServicesRequest (1.16.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class BatchEnableServicesRequest (1.16.0)
...
0.2.2
0.1.0
BatchEnableServicesRequest ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
