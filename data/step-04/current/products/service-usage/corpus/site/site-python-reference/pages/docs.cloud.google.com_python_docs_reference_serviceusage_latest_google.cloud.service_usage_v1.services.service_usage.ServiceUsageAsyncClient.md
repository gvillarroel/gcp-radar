---
title: "Class ServiceUsageAsyncClient (1.16.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/serviceusage/latest/google.cloud.service_usage_v1.services.service_usage.ServiceUsageAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/serviceusage/latest/google.cloud.service_usage_v1.services.service_usage.ServiceUsageAsyncClient
  title: "Class ServiceUsageAsyncClient (1.16.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class ServiceUsageAsyncClient (1.16.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the ServiceUsageTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.BatchEnableServicesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.BatchGetServicesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.DisableServiceRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.EnableServiceRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.GetServiceRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.service_usage_v1.types.ListServicesRequest , dict]]
