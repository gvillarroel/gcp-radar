---
title: "Class ListAcceleratorTypesAsyncPager (1.26.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/tpu/latest/google.cloud.tpu_v1.services.tpu.pagers.ListAcceleratorTypesAsyncPager
...
Client libraries
Send feedback
Class ListAcceleratorTypesAsyncPager (1.26.0)
...
request
google.cloud.tpu_v1.types.ListAcceleratorTypesRequest
The initial request object.
response
google.cloud.tpu_v1.types.ListAcceleratorTypesResponse
