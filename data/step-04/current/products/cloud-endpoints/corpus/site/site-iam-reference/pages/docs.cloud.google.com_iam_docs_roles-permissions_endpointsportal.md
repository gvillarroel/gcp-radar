---
title: "Cloud Endpoints Portal roles and permissions \_|\_ Identity and Access Management\
  \ (IAM) \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/roles-permissions/endpointsportal
...
Reference
Send feedback
Cloud Endpoints Portal roles and permissions
Stay organized with collections
Save and categorize content based on your preferences.
This page lists the IAM roles and permissions for Cloud Endpoints Portal. To
search through all roles and permissions, see the role and
permission index .
Cloud Endpoints Portal roles
Cloud Endpoints Portal offers the following service agent roles.
