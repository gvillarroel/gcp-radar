---
title: "Using Google ID tokens to authenticate users \_|\_ Cloud Endpoints with OpenAPI\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/endpoints/docs/openapi/authenticating-users-google-id
...
source_metadata:
  url: https://docs.cloud.google.com/endpoints/docs/openapi/authenticating-users-google-id
  title: "Using Google ID tokens to authenticate users \_|\_ Cloud Endpoints with\
