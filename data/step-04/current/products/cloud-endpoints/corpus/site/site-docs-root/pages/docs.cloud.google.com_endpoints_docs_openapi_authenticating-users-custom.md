---
title: "Using a custom method to authenticate users \_|\_ Cloud Endpoints with OpenAPI\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/endpoints/docs/openapi/authenticating-users-custom
...
OpenAPI 2.0
Add the following to the security definition in your OpenAPI document:
securityDefinitions :
your_custom_auth_id :
authorizationUrl : ""
flow : "implicit"
...
by the x-google-jwks_uri and jwksUri OpenAPI extensions:
JWK set format .
For example:
OpenAPI 2.0
...
If you are using a symmetric key format, set x-google-jwks_uri or jwksUri to
the URI of a file that contains the base64url-encoded key string.
If you omit x-google-jwks_uri or jwksUri , ESP will follow the
...
Note that omitting x-google-jwks_uri or jwksUri will result in higher cold start times, as
