---
title: "All resources \_|\_ Bare Metal Solution \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bare-metal/docs/resource
...
Release notes
Release notes for Bare Metal Solution.
Security bulletins
Security bulletins for Bare Metal Solution.
Known issues and limitations
Known issues and limitations in Bare Metal Solution.
Get support
How to get support for your Bare Metal Solution environment.
Cloud Architecture Center
Cloud Architecture Center articles for Bare Metal Solution.
Service level agreement
Service Level Agreement (SLA) for Bare Metal Solution.
Send feedback
