---
title: "REST Resource: projects.locations.retiredResources \_|\_ Cloud Key Management\
  \ Service \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.retiredResources
...
REST Resource: projects.locations.retiredResources | Cloud Key Management Service | Google Cloud Documentation
...
Was this helpful?
Send feedback
REST Resource: projects. locations. retired Resources
...
Methods
get
Retrieves a specific Retired Resource resource, which represents the record of a deleted Crypto Key .
list
Lists the Retired Resources which are the records of deleted Crypto Keys .
Was this helpful?
Send feedback
