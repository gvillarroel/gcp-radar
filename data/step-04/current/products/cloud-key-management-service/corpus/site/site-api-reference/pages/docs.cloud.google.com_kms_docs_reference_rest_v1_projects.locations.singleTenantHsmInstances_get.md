---
title: "Method: singleTenantHsmInstances.get \_|\_ Cloud Key Management Service \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.singleTenantHsmInstances/get
...
source_metadata:
  url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.singleTenantHsmInstances/get
  title: "Method: singleTenantHsmInstances.get \_|\_ Cloud Key Management Service\
    \ \_|\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Method: singleTenantHsmInstances.get | Cloud Key Management Service | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: single Tenant Hsm Instances. get
...
IAM Permissions
Try it!
Full name : projects.locations.singleTenantHsmInstances.get
...
GET https://cloudkms.googleapis.com/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*}
...
Response body
If successful, the response body contains an instance of SingleTenantHsmInstance .
Authorization scopes
