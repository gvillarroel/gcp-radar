---
title: "Method: keyRings.get \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings/get
...
Method: keyRings.get | Cloud Key Management Service | Google Cloud Documentation
...
Authorization scopes
Try it!
Full name : projects.locations.keyRings.get
...
GET https://cloudkms.googleapis.com/v1/{name=projects/*/locations/*/keyRings/*}
...
Response body
If successful, the response body contains an instance of KeyRing .
Authorization scopes
