---
title: "Method: organizations.updateKajPolicyConfig \_|\_ Cloud Key Management Service\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/organizations/updateKajPolicyConfig
...
Method: organizations.updateKajPolicyConfig | Cloud Key Management Service | Google Cloud Documentation
...
Reference
Send feedback
Method: organizations. update Kaj Policy Config
...
Authorization scopes
Try it!
Full name : organizations.updateKajPolicyConfig
...
PATCH https://cloudkms.googleapis.com/v1/{keyAccessJustificationsPolicyConfig.name=organizations/*/kajPolicyConfig}
