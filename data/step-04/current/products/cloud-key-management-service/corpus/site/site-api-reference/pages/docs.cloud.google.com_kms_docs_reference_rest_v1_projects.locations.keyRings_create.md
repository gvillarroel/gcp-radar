---
title: "Method: keyRings.create \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings/create
...
source_metadata:
  url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings/create
  title: "Method: keyRings.create \_|\_ Cloud Key Management Service \_|\_ Google\
    \ Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Method: keyRings.create | Cloud Key Management Service | Google Cloud Documentation
...
Authorization scopes
Try it!
Full name : projects.locations.keyRings.create
...
POST https://cloudkms.googleapis.com/v1/{parent=projects/*/locations/*}/keyRings
...
Request body
The request body contains an instance of KeyRing .
Response body
If successful, the response body contains a newly created instance of KeyRing .
Authorization scopes
