---
title: "Method: folders.updateKajPolicyConfig \_|\_ Cloud Key Management Service \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/folders/updateKajPolicyConfig
...
source_metadata:
  url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/folders/updateKajPolicyConfig
  title: "Method: folders.updateKajPolicyConfig \_|\_ Cloud Key Management Service\
    \ \_|\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Method: folders.updateKajPolicyConfig | Cloud Key Management Service | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: folders. update Kaj Policy Config
...
PATCH https://cloudkms.googleapis.com/v1/{keyAccessJustificationsPolicyConfig.name=folders/*/kajPolicyConfig}
The URLs use gRPC Transcoding syntax.
Path parameters
Parameters
key Access Justifications Policy Config. name
string
