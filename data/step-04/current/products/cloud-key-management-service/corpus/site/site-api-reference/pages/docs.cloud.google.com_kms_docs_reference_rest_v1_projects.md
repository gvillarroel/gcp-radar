---
title: "REST Resource: projects \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects
...
source_metadata:
  url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects
  title: "REST Resource: projects \_|\_ Cloud Key Management Service \_|\_ Google\
    \ Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

REST Resource: projects | Cloud Key Management Service | Google Cloud Documentation
...
show Effective Key Access Justifications Enrollment Config
Returns the Key Access Justifications Enrollment Config of the resource closest to the given project in hierarchy.
show Effective Key Access Justifications Policy Config
Returns the Key Access Justifications Policy Config of the resource closest to the given project in hierarchy.
update Autokey Config
Updates the Autokey Config for a folder or a project.
update Kaj Policy Config
Updates the Key Access Justifications Policy Config for a given organization, folder, or project.
Was this helpful?
Send feedback
