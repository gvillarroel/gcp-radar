---
title: "Method: importJobs.get \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.importJobs/get
...
Method: importJobs.get | Cloud Key Management Service | Google Cloud Documentation
...
Authorization scopes
Try it!
Full name : projects.locations.keyRings.importJobs.get
...
Response body
If successful, the response body contains an instance of ImportJob .
Authorization scopes
