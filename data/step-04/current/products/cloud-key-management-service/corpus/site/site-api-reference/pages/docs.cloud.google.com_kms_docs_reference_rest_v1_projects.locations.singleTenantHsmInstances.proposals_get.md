---
title: "Method: proposals.get \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.singleTenantHsmInstances.proposals/get
...
Method: proposals.get | Cloud Key Management Service | Google Cloud Documentation
...
IAM Permissions
Try it!
Full name : projects.locations.singleTenantHsmInstances.proposals.get
...
GET https://cloudkms.googleapis.com/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*/proposals/*}
...
Response body
If successful, the response body contains an instance of SingleTenantHsmInstanceProposal .
Authorization scopes
