---
title: "Method: locations.updateEkmConfig \_|\_ Cloud Key Management Service \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/updateEkmConfig
...
source_metadata:
  url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations/updateEkmConfig
  title: "Method: locations.updateEkmConfig \_|\_ Cloud Key Management Service \_\
    |\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Method: locations.updateEkmConfig | Cloud Key Management Service | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: locations. update Ekm Config
...
Authorization scopes
Try it!
Full name : projects.locations.updateEkmConfig
...
PATCH https://cloudkms.googleapis.com/v1/{ekmConfig.name=projects/*/locations/*/ekmConfig}
...
Request body
The request body contains an instance of EkmConfig .
Response body
If successful, the response body contains an instance of EkmConfig .
Authorization scopes
