---
title: "CryptoKeyVersionView \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/CryptoKeyVersionView
...
CryptoKeyVersionView | Cloud Key Management Service | Google Cloud Documentation
...
Enums
CRYPTO_ KEY_ VERSION_ VIEW_ UNSPECIFIED
Default view for each Crypto Key Version . Does not include the attestation field.
FULL
Provides all fields in each Crypto Key Version , including the attestation .
Was this helpful?
Send feedback
