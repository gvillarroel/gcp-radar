---
title: "Use Jsign and PKCS#11 to sign Windows artifacts \_|\_ Cloud Key Management\
  \ Service \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/pkcs11-jsign
...
Use Jsign and PKCS#11 to sign Windows artifacts | Cloud Key Management Service | Google Cloud Documentation
...
Authenticode signing through PKCS#11 and Jsign .
Use cases
...
A Windows machine with the artifacts you want to sign. Make sure that Java
is installed on this machine.
Cloud Shell or your own Linux machine,
to generate a certificate signing request or a certificate. On this machine,
complete the configuration documented in OpenSSL Setup .
...
On your Windows machine, download the latest Jsign release JAR
file using the following powershell command:
...
Use Jsign to sign the artifacts, using your Cloud KMS key and your
certificate.
...
you want to sign.
For a detailed explanation of each command option, see the official
Jsign documentation .
Was this helpful?
Send feedback
