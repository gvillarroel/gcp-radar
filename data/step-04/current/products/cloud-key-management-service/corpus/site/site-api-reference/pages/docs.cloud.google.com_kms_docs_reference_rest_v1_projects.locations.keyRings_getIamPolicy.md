---
title: "Method: keyRings.getIamPolicy \_|\_ Cloud Key Management Service \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings/getIamPolicy
...
Method: keyRings.getIamPolicy | Cloud Key Management Service | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: key Rings. get Iam Policy
...
Authorization scopes
Try it!
Full name : projects.locations.keyRings.getIamPolicy
...
OPTIONAL: A GetPolicyOptions object for specifying options to keyRings.getIamPolicy .
Request body
