---
title: "Method: keyHandles.get \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyHandles/get
...
Method: keyHandles.get | Cloud Key Management Service | Google Cloud Documentation
...
Response body
If successful, the response body contains an instance of KeyHandle .
Authorization scopes
