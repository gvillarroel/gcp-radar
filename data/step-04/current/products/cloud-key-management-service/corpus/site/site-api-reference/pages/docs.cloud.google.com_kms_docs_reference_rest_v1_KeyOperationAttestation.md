...
KeyOperationAttestation | Cloud Key Management Service | Google Cloud Documentation
...
Enums
ATTESTATION_ FORMAT_ UNSPECIFIED
Not specified.
CAVIUM_ V1_ COMPRESSED
