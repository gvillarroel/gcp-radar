---
title: "Method: proposals.execute \_|\_ Cloud Key Management Service \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.singleTenantHsmInstances.proposals/execute
...
Method: proposals.execute | Cloud Key Management Service | Google Cloud Documentation
...
IAM Permissions
Try it!
Full name : projects.locations.singleTenantHsmInstances.proposals.execute
...
POST https://cloudkms.googleapis.com/v1/{name=projects/*/locations/*/singleTenantHsmInstances/*/proposals/*}:execute
