---
title: "Method: proposals.list \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.singleTenantHsmInstances.proposals/list
...
Method: proposals.list | Cloud Key Management Service | Google Cloud Documentation
...
IAM Permissions
Try it!
Full name : projects.locations.singleTenantHsmInstances.proposals.list
...
GET https://cloudkms.googleapis.com/v1/{parent=projects/*/locations/*/singleTenantHsmInstances/*}/proposals
