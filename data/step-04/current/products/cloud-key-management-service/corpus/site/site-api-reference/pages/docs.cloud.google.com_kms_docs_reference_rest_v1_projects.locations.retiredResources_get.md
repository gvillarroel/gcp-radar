---
title: "Method: retiredResources.get \_|\_ Cloud Key Management Service \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.retiredResources/get
...
Method: retiredResources.get | Cloud Key Management Service | Google Cloud Documentation
...
Authorization scopes
Try it!
Full name : projects.locations.retiredResources.get
...
GET https://cloudkms.googleapis.com/v1/{name=projects/*/locations/*/retiredResources/*}
...
Response body
If successful, the response body contains an instance of RetiredResource .
Authorization scopes
