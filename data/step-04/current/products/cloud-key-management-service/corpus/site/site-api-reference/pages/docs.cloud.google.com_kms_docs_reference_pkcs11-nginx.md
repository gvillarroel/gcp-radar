...
Use a Cloud HSM key for TLS offloading with NGINX | Cloud Key Management Service | Google Cloud Documentation
...
Create and configure a Cloud HSM signing key Create a Cloud HSM-hosted signing key
Connect to your VM using SSH and IAP
Create a certificate with OpenSSL
Install your certificate for NGINX
Configure your environment to use the PKCS #11 library Prepare library configurations for NGINX
Test your OpenSSL configuration
Configure NGINX to use Cloud HSM Configure NGINX to listen for TLS traffic
