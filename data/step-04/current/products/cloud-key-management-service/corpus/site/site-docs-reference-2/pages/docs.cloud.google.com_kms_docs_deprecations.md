---
title: "Feature deprecations \_|\_ Cloud Key Management Service \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kms/docs/deprecations
...
defines the deprecation policy that applies to certificate bundles.
...
February 21, 2023
March 20, 2024
Certificate bundles have been replaced by certificate chains. To learn
how to use certificate chains to verify attestations for
Cloud HSM keys, see
