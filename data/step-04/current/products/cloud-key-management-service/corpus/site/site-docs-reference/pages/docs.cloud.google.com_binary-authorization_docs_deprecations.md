---
title: "Binary Authorization deprecations and shutdown \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/binary-authorization/docs/deprecations
...
Resources
Send feedback
Binary Authorization deprecations and shutdown
...
Shutdown date
Details
Legacy continuous validation (legacy CV) for project-singleton policies with GKE
April 15, 2024
May 1, 2025
See legacy continuous validation deprecation and shutdown
Send feedback
