---
title: "google-cloud-data-fusion overview (1.88.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-data-fusion/latest/overview
...
Client libraries
Send feedback
google-cloud-data-fusion overview (1.88.0)
...
1.1.1
Key Reference Links
Cloud Data Fusion Description: Is a fully managed, cloud-native, enterprise data integration service for quickly building and managing data pipelines.
Cloud Data Fusion Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Use the Cloud Data Fusion for Java
...
The example below demonstrates how you would import the BOM and include the google-cloud-data-fusion artifact.
...
implementation ( "com.google.cloud:google-cloud-data-fusion" )
...
For this library, we recommend using com.google.cloud.datafusion.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Data Fusion). New Version IDs are introduced infrequently, and often involve
