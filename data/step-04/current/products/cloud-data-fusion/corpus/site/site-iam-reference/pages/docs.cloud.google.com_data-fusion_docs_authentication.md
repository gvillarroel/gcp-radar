---
title: "Authenticate to Cloud Data Fusion \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/data-fusion/docs/authentication
...
Guides
Send feedback
Authenticate to Cloud Data Fusion
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Cloud Data Fusion programmatically. How
you authenticate to Cloud Data Fusion depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Cloud Data Fusion supports programmatic access. You can access the API in
the following ways:
Google Cloud CLI
REST
Google Cloud CLI
...
For more information about using the gcloud CLI with Cloud Data Fusion,
see the gcloud CLI reference pages .
REST
You can authenticate to
the Cloud Data Fusion API
...
Set up authentication for Cloud Data Fusion
...
Access control for Cloud Data Fusion
After you authenticate to Cloud Data Fusion, you must be authorized to access
Google Cloud resources. Cloud Data Fusion uses
