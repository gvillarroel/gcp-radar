---
title: "Cloud Data Fusion documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/data-fusion/docs
...
quickly building and managing data pipelines. Business users, developers, and data scientists can
easily and reliably build scalable data integration solutions to cleanse, prepare, blend,
transfer, and transform data without having to wrestle with infrastructure.
...
Guides
Quickstart: Create a data pipeline by using Cloud Data Fusion
