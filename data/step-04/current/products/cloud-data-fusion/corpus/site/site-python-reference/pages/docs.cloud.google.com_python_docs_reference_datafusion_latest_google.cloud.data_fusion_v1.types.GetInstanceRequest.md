---
title: "Class GetInstanceRequest (1.16.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/datafusion/latest/google.cloud.data_fusion_v1.types.GetInstanceRequest
...
Client libraries
Send feedback
Class GetInstanceRequest (1.16.0)
