---
title: "Python Client for Cloud Data Fusion \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/datafusion/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/datafusion/latest
  title: "Python Client for Cloud Data Fusion \_|\_ Python client libraries \_|\_\
...
pip install google-cloud-data-fusion
Next Steps
Read the Client Library Documentation for Cloud Data Fusion
to see other available methods on the client.
Read the Cloud Data Fusion Product documentation to learn
