---
title: "Grant service account roles for Dataproc \_|\_ Cloud Data Fusion \_|\_ Google\
  \ Cloud Documentation"
...
want to use for the Dataproc cluster is located, and then
click Open .
Click the email address of the Dataproc service account .
When Cloud Data Fusion provisions
a Dataproc cluster, you can specify which user-managed
service account to use for the Dataproc virtual machines in
