---
title: "Vision API audit logging information \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/vision/docs/audit-logging
...
Guides
Send feedback
Vision API audit logging information
Stay organized with collections
Save and categorize content based on your preferences.
Note: Cloud Vision doesn't offer any
Data Access audit logs . However, if you need
data access audit logs, consider using Vertex AI Vision .
This document describes the audit logs created by Cloud Vision as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Vision:
...
Service name
Vision API audit logs use the service name
...
Resource types
Vision API audit logs use the resource type
