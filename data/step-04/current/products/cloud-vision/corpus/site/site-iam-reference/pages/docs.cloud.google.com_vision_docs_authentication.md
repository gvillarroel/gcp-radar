---
title: "Authenticate to Vision \_|\_ Cloud Vision API \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/vision/docs/authentication
...
Guides
Send feedback
Authenticate to Vision
Stay organized with collections
Save and categorize content based on your preferences.
Google Cloud services use
Identity and Access Management (IAM) for
authentication. IAM permissions and roles offer granular control, by principal
and by resource. To use the Vision API, the security principal usually
needs the
Cloud Storage > Storage object viewer ( roles/storage.objectViewer )
predefined IAM role to send requests. In particular,
the security principal needs this predefined role to send requests that
specify files in Cloud Storage.
This document describes how to authenticate to Cloud Vision programmatically. How
you authenticate to Cloud Vision depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Vision supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Vision client libraries provide
high-level language support for authenticating to Vision
programmatically.
...
User credentials and ADC for Vision
...
authenticate to Vision. For more information about this error and how
to address it, see
User credentials not working .
Set up authentication for Vision
...
Vision, as described in Cloud Vision setup and cleanup .
