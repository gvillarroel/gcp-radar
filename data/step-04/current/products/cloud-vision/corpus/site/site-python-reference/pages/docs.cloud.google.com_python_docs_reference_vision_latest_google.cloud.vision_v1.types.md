---
title: "Package types (3.13.0) \_|\_ Python client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/vision/latest/google.cloud.vision_v1.types
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/vision/latest/google.cloud.vision_v1.types
  title: "Package types (3.13.0) \_|\_ Python client libraries \_|\_ Google Cloud\
    \ Documentation"
...
0.39.0
0.38.1
API documentation for vision_v1.types package.
Classes
...
Response to a single file annotation request. A file may
...
Multiple async file annotation requests are batched into a
single service call.
...
A list of requests to annotate files using the
...
GcsDestination
The Google Cloud Storage location where the output will be
written to.
GcsSource
The Google Cloud Storage location where the input will be
read from.
GetProductRequest
...
If an image was produced from a file (e.g. a PDF), this
...
ImageSource
External image source (Google Cloud Storage or web URL image
location).
...
Config to control which ProductSet contains the Products to
be deleted.
Property
