---
title: "Authenticate to Cloud Scheduler \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/scheduler/docs/authentication
...
Reference
Send feedback
Authenticate to Cloud Scheduler
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Cloud Scheduler programmatically. How
you authenticate to Cloud Scheduler depends on the interface you use to access the API
and the environment where your code is running.
Cloud Scheduler can call HTTP targets that
require authentication if you have set up an associated service account that has
the appropriate credentials. For more information, see
Use authentication with HTTP targets .
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Cloud Scheduler supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Cloud Scheduler client libraries provide
high-level language support for authenticating to Cloud Scheduler
programmatically.
...
For more information about using the gcloud CLI with Cloud Scheduler,
...
Set up authentication for Cloud Scheduler
...
Cloud Scheduler, as described in Setting up your environment .
...
Access control for Cloud Scheduler
After you authenticate to Cloud Scheduler, you must be authorized to access
Google Cloud resources. Cloud Scheduler uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Cloud Scheduler, see
