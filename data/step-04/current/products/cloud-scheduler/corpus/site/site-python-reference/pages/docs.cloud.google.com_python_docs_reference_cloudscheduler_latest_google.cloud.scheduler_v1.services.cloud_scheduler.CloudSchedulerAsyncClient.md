---
title: "Class CloudSchedulerAsyncClient (2.19.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudscheduler/latest/google.cloud.scheduler_v1.services.cloud_scheduler.CloudSchedulerAsyncClient
...
Client libraries
Send feedback
Class CloudSchedulerAsyncClient (2.19.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudSchedulerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.CreateJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.DeleteJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.GetJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.ListJobsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.PauseJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.ResumeJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.RunJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.scheduler_v1.types.UpdateJobRequest , dict]]
