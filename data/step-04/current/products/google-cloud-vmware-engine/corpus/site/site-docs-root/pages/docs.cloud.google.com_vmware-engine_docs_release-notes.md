---
title: "VMware Engine release notes \_|\_ Google Cloud VMware Engine \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/vmware-engine/docs/release-notes
...
This page documents production updates to Google Cloud VMware Engine. Check this page for
announcements about new or updated features, bug fixes, and deprecated
functionality.
...
Google Cloud VMware Engine. For more information, see NFS datastores overview .
December 25, 2025
Announcement
VMware Engine ve2 nodes are now available in the Milan, Italy ( europe-west8-b ) zone in the Milan, Italy, Europe region ( europe-west8 ).
December 05, 2025
Announcement
...
November 26, 2025
Announcement
VMware Engine ve2 nodes are now available in the Dallas, Texas, North America region ( us-south1-b ).
November 14, 2025
Announcement
...
April 01, 2024
Feature
Storage-only nodes are now generally available. For more information, see Use storage-only nodes .
March 11, 2024
Feature
...
Learn more about:
the list of resources available using CAIS and search for VMware.
what you can do with CAIS .
November 14, 2023
Feature
...
To learn more about these new features and how to get started, please visit the VMware Engine documentation on the Hashicorp site and review the IaC Foundations blueprint .
Feature
Google Cloud VMware Engine now supports ESXi syslog forwarding, including distributed firewall logs, which provides more visibility into security events on VMware Engine instances.
Enhanced Service Controls: VMware Engine is also releasing additional security controls that will enable you to manage permissions elevation. This enhanced security model gives you more granular control over how Google support staff access your VMware Engine instances for workloads that require additional controls due to regulatory or compliance reasons. Please contact support for assistance with configuring these services.
June 26, 2023
Announcement
...
Note: Management appliances use different IP allocations in IP Plan version 2.0. See Networking requirements for more information on the new subnet allocations.
Announcement
