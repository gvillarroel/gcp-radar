---
title: "Support levels for permissions in custom roles \_|\_ Identity and Access Management\
  \ (IAM) \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs/custom-roles-permissions-support
...
source_metadata:
  url: https://docs.cloud.google.com/iam/docs/custom-roles-permissions-support
  title: "Support levels for permissions in custom roles \_|\_ Identity and Access\
...
This page indicates which Identity and Access Management (IAM) permissions are supported
in custom roles .
...
The following table lists all IAM permissions and indicates
which permissions are supported in custom roles.
Enter the desired permission name or support level in the text box below:
Permission name
Custom roles support level
...
ces.operations.list
SUPPORTED
ces.securitySettings.get
SUPPORTED
ces.securitySettings.update
SUPPORTED
...
chat.bots.update
SUPPORTED
chronicle.agentSettings.get
SUPPORTED
chronicle.agentSettings.update
SUPPORTED
...
SUPPORTED
databaseinsights.databaseIssues.troubleshoot
SUPPORTED
databaseinsights.dbCenter.query
SUPPORTED
databaseinsights.dbPerformance.query
SUPPORTED
...
SUPPORTED
documentai.rules.create
SUPPORTED
documentai.rules.delete
SUPPORTED
documentai.rules.generate
SUPPORTED
documentai.rules.get
SUPPORTED
documentai.rules.list
SUPPORTED
documentai.rules.update
SUPPORTED
documentai.schemaVersions.create
SUPPORTED
documentai.schemaVersions.delete
SUPPORTED
documentai.schemaVersions.get
SUPPORTED
documentai.schemaVersions.list
SUPPORTED
documentai.schemaVersions.update
SUPPORTED
documentai.schemas.create
SUPPORTED
documentai.schemas.delete
SUPPORTED
documentai.schemas.get
SUPPORTED
documentai.schemas.list
SUPPORTED
documentai.schemas.update
SUPPORTED
documentai.validators.create
SUPPORTED
documentai.validators.delete
SUPPORTED
documentai.validators.get
SUPPORTED
documentai.validators.list
SUPPORTED
documentai.validators.update
SUPPORTED
...
SUPPORTED
geminidataanalytics.locations.suggestContext
SUPPORTED
...
TESTING
iam.accesspolicies.delete
TESTING
iam.accesspolicies.get
TESTING
iam.accesspolicies.list
TESTING
iam.accesspolicies.searchPolicyBindings
TESTING
iam.accesspolicies.unbind
TESTING
iam.accesspolicies.update
TESTING
...
SUPPORTED
iam.workforcePoolProviderScimGroups.create
SUPPORTED
iam.workforcePoolProviderScimGroups.delete
SUPPORTED
iam.workforcePoolProviderScimGroups.get
SUPPORTED
iam.workforcePoolProviderScimGroups.list
SUPPORTED
iam.workforcePoolProviderScimGroups.patch
SUPPORTED
iam.workforcePoolProviderScimGroups.put
SUPPORTED
iam.workforcePoolProviderScimUsers.create
SUPPORTED
iam.workforcePoolProviderScimUsers.delete
SUPPORTED
iam.workforcePoolProviderScimUsers.get
SUPPORTED
iam.workforcePoolProviderScimUsers.list
SUPPORTED
iam.workforcePoolProviderScimUsers.patch
SUPPORTED
iam.workforcePoolProviderScimUsers.put
SUPPORTED
...
SUPPORTED
iap.webServiceVersions.egressViaIAP
SUPPORTED
...
SUPPORTED
redis.aclPolicies.create
SUPPORTED
redis.aclPolicies.delete
SUPPORTED
redis.aclPolicies.get
SUPPORTED
redis.aclPolicies.list
SUPPORTED
redis.aclPolicies.update
SUPPORTED
