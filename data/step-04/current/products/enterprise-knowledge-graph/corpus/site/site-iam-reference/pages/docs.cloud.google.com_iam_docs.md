---
title: "Identity and Access Management documentation \_|\_ Identity and Access Management\
  \ (IAM) \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/iam/docs
...
Guides
Quickstarts:
Quickstart: Grant an IAM role by using the Google Cloud console
or
Quickstart: Write an IAM policy by using client libraries
