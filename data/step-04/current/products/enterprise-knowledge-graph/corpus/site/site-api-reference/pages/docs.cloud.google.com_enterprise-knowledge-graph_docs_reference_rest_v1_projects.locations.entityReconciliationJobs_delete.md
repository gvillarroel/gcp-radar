---
title: "Method: projects.locations.entityReconciliationJobs.delete \_|\_ Enterprise\
  \ Knowledge Graph \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/enterprise-knowledge-graph/docs/reference/rest/v1/projects.locations.entityReconciliationJobs/delete
...
Reference
Send feedback
Method: projects.locations.entityReconciliationJobs.delete
...
HTTP request
DELETE https://enterpriseknowledgegraph.googleapis.com/v1/{name}
Path parameters
Parameters
name
string
