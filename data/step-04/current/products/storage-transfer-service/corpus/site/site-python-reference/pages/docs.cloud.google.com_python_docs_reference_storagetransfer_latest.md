---
title: "Python Client for Storage Transfer Service \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/storagetransfer/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/storagetransfer/latest
  title: "Python Client for Storage Transfer Service \_|\_ Python client libraries\
...
Enable the Storage Transfer Service.
...
pip install google-cloud-storage-transfer
Next Steps
Read the Client Library Documentation for Storage Transfer Service
to see other available methods on the client.
Read the Storage Transfer Service Product documentation to learn
