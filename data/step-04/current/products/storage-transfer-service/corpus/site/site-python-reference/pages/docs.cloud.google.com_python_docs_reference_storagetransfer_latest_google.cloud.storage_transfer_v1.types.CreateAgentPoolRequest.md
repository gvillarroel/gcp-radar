---
title: "Class CreateAgentPoolRequest (1.20.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/storagetransfer/latest/google.cloud.storage_transfer_v1.types.CreateAgentPoolRequest
...
Client libraries
Send feedback
Class CreateAgentPoolRequest (1.20.0)
...
1.0.2
0.1.0
CreateAgentPoolRequest ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
