---
title: "Class AzureCredentials (1.20.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/storagetransfer/latest/google.cloud.storage_transfer_v1.types.AzureCredentials
...
1.0.2
0.1.0
AzureCredentials ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
Azure credentials
