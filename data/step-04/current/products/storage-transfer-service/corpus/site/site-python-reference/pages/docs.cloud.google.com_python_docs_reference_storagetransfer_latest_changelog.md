...
url: https://docs.cloud.google.com/python/docs/reference/storagetransfer/latest/changelog
...
1.17.0 (2025-05-26)
Features
support Azure federated identity ( 4b52aac )
support BYOSA ( 4b52aac )
Documentation
A comment for enum value COPY in enum LoggableAction is changed ( 4b52aac )
A comment for field end_time_of_day in message .google.storagetransfer.v1.Schedule is changed ( 4b52aac )
A comment for field list_url in message .google.storagetransfer.v1.HttpData is changed ( 4b52aac )
A comment for field overwrite_objects_already_existing_in_sink in message .google.storagetransfer.v1.TransferOptions is changed ( 4b52aac )
A comment for message ObjectConditions is changed ( 4b52aac )
1.16.1 (2025-03-15)
Bug Fixes
...
1.15.0 (2024-12-18)
Features
[google-cloud-storage-transfer] support cross-bucket replication ( #13372 ) ( 20d6e4c )
1.14.0 (2024-12-12)
Features
...
1.12.0 (2024-08-19)
Features
add GCS Managed Folders ( 9c54c1d )
add HDFS configuration ( 9c54c1d )
add S3 Cloudfront Domain ( 9c54c1d )
add S3 Managed Private Network ( 9c54c1d )
1.11.5 (2024-07-30)
Bug Fixes
...
1.7.0 (2023-01-10)
Features
Add support for python 3.11 ( #139 ) ( d561a86 )
1.6.0 (2022-12-15)
Features
...
1.5.2 (2022-10-07)
Bug Fixes
deps: Allow protobuf 3.19.5 ( #128 ) ( 97af8c4 )
1.5.1 (2022-09-29)
Bug Fixes
deps: Require protobuf >= 3.20.2 ( #126 ) ( 97051d1 )
1.5.0 (2022-09-12)
Features
...
1.4.0 (2022-07-16)
Features
add audience parameter ( 43557a9 )
Bug Fixes
deps: require google-api-core>=1.32.0,>=2.8.0 ( #105 ) ( 4143850 )
require python 3.7+ ( #103 ) ( 3d6833b )
1.3.1 (2022-06-03)
Bug Fixes
...
1.1.0 (2021-10-15)
Features
add context manager support in client ( #28 ) ( 54fcd0f )
add support for python 3.10 ( #32 ) ( bd43b0a )
1.0.2 (2021-09-30)
Bug Fixes
