---
title: "Method: networks.audienceSegments.list \_|\_ Ad Manager API (Beta) \_|\_ Google\
  \ for Developers"
url: https://developers.google.com/ad-manager/api/beta/reference/rest/v1/networks.audienceSegments/list
...
source_metadata:
  url: https://developers.google.com/ad-manager/api/beta/reference/rest/v1/networks.audienceSegments/list
  title: "Method: networks.audienceSegments.list \_|\_ Ad Manager API (Beta) \_|\_\
...
Reference
Send feedback
Method: networks.audienceSegments.list
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
This API is used to retrieve a list of AudienceSegment objects.
The HTTP request uses the GET method and requires a parent network parameter.
Optional query parameters are available for pagination, filtering, and sorting the results.
The request body must be empty.
The response body contains a list of AudienceSegment objects, a next page token, and the total size.
HTTP request
Path parameters
Query parameters
Request body
...
HTTP request
GET https://admanager.googleapis.com/v1/{parent}/audienceSegments
Path parameters
Parameters
parent
string
Required. The parent publisher network associated with these audience segments. Format: networks/{networkCode}
Query parameters
Parameters
pageSize
integer
...
pageToken
string
Optional. A page token, received from a previous audienceSegments.list call. Provide this to retrieve the subsequent page.
When paginating, all other parameters provided to audienceSegments.list must match the call that provided the page token.
filter
string
