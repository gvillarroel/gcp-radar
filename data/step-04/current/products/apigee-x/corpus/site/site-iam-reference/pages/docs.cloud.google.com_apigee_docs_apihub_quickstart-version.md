---
title: "Create an API version \_|\_ Apigee \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/apigee/docs/apihub/quickstart-version
...
Note: You can also add deployments and API specifications to a version.
For details, see Introduction to deployments and Introduction to API specifications .
...
Go to API hub
Versions are linked to API resources, so find the API resource you'd like to inspect. If you don't see it,
type the name of the API in the Filter .
