---
title: "Authenticate to Secure Source Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/secure-source-manager/docs/authentication
...
Reference
Send feedback
Authenticate to Secure Source Manager
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Secure Source Manager programmatically. How
you authenticate to Secure Source Manager depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Secure Source Manager supports programmatic access. You can access the API in
the following ways:
REST
REST
You can authenticate to
the Secure Source Manager API
...
Set up authentication for Secure Source Manager
...
Access control for Secure Source Manager
After you authenticate to Secure Source Manager, you must be authorized to access
Google Cloud resources. Secure Source Manager uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Secure Source Manager, see
