---
title: "Secure Source Manager audit logging \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/secure-source-manager/docs/audit-logging
...
Guides
Send feedback
Secure Source Manager audit logging
Stay organized with collections
Save and categorize content based on your preferences.
This document describes the audit logs created by Secure Source Manager as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Secure Source Manager:
...
type in Secure Source Manager:
Audit logs category
Secure Source Manager methods
Admin Activity audit logs
SetIamPolicy
...
google.cloud.securesourcemanager.v1.SecureSourceManager.IssueRedirectTicketInternal
...
google.cloud.securesourcemanager.v1.SecureSourceManager.AccessInstance
google.cloud.securesourcemanager.v1.SecureSourceManager.FetchRepository
google.cloud.securesourcemanager.v1.SecureSourceManager.ReadPullRequest
google.cloud.securesourcemanager.v1.SecureSourceManager.ReadIssue
google.cloud.securesourcemanager.v1.SecureSourceManager.ListSshKeys
google.cloud.securesourcemanager.v1.SecureSourceManager.ListAnySshKeys
Data Access (DATA_WRITE) audit logs
google.cloud.securesourcemanager.v1.SecureSourceManager.CreateRepositoryInternal
google.cloud.securesourcemanager.v1.SecureSourceManager.DeleteRepositoryInternal
...
google.cloud.securesourcemanager.v1.SecureSourceManager.CheckCreateRepository
google.cloud.securesourcemanager.v1.SecureSourceManager.PushRepository
google.cloud.securesourcemanager.v1.SecureSourceManager.UpdateRepository
google.cloud.securesourcemanager.v1.SecureSourceManager.WritePullRequest
google.cloud.securesourcemanager.v1.SecureSourceManager.WriteIssue
google.cloud.securesourcemanager.v1.SecureSourceManager.CreateSshKey
google.cloud.securesourcemanager.v1.SecureSourceManager.DeleteSshKey
google.cloud.securesourcemanager.v1.SecureSourceManager.CreateAnySshKey
google.cloud.securesourcemanager.v1.SecureSourceManager.DeleteAnySshKey
Audit log format
...
Service name
Secure Source Manager audit logs use the service name
...
Resource types
Secure Source Manager audit logs use the resource type
