---
title: "Authenticate to Security Command Center \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/security-command-center/docs/reference/authentication
...
This document describes how to authenticate to Security Command Center programmatically. How
you authenticate to Security Command Center depends on the interface you use to access the API
and the environment where your code is running.
For information about authenticating to the
Web Security Scanner, see Authenticate to Web Security Scanner .
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Security Command Center supports programmatic access. You can access the API in
the following ways:
Client libraries
gcloud CLI
REST
Client libraries
The Security Command Center client libraries provide
high-level language support for authenticating to Security Command Center
programmatically.
...
For more information about using the gcloud CLI with Security Command Center,
...
authenticate to Security Command Center. For more information about this error and how
to address it, see
...
After you authenticate to Security Command Center, you must be authorized to access
Google Cloud resources. Security Command Center uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Security Command Center, see
