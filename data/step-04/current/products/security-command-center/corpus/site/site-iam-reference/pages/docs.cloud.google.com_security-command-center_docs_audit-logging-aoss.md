---
title: "Assured OSS audit logging \_|\_ Security Command Center \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/security-command-center/docs/audit-logging-aoss
...
This document describes the audit logs created by Assured OSS as part of
Cloud Audit Logs .
Overview
...
After you
integrate Assured Open Source Software with Security Command Center ,
Assured OSS supports audit logging.
This document applies to the Assured OSS premium tier only.
Audit logging isn't supported for the free tier.
Available audit logs
The following types of audit logs are available for Assured OSS:
...
Service name
Assured OSS audit logs use the service name
...
Resource types
Assured OSS audit logs use the resource type
...
Assured OSS, use the following query, supplying a valid resource
...
protoPayload . serviceName = "assuredoss.googleapis.com"
Route audit logs
