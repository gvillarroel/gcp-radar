---
title: "Profile Cloud SQL data in a single project \_|\_ Sensitive Data Protection\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sensitive-data-protection/docs/profile-project-cloud-sql
...
Cloud SQL data in an organization or
folder .
...
Sensitive Data Protection profiles a new table. If you want to use this
...
If you want to scan a single table, select Scan one
table .
For each table, you can have only one single-resource scan
