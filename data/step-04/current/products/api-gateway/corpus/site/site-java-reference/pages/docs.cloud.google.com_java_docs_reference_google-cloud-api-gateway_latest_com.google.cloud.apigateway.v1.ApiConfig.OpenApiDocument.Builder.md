---
title: "Class ApiConfig.OpenApiDocument.Builder (2.88.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/com.google.cloud.apigateway.v1.ApiConfig.OpenApiDocument.Builder
...
Client libraries
Send feedback
Class ApiConfig.OpenApiDocument.Builder (2.88.0)
...
2.2.1
2.1.12
public static final class ApiConfig . OpenApiDocument . Builder extends GeneratedMessage . Builder<ApiConfig . OpenApiDocument . Builder > implements ApiConfig . OpenApiDocumentOrBuilder
...
Methods
build()
public ApiConfig . OpenApiDocument build ()
Returns
Type
Description
ApiConfig.OpenApiDocument
buildPartial()
public ApiConfig . OpenApiDocument buildPartial ()
Returns
Type
Description
ApiConfig.OpenApiDocument
clear()
public ApiConfig . OpenApiDocument . Builder clear ()
Returns
Type
Description
ApiConfig.OpenApiDocument.Builder
...
clearDocument()
public ApiConfig . OpenApiDocument . Builder clearDocument ()
...
The document.
getDocumentBuilder()
public ApiConfig . File . Builder getDocumentBuilder ()
The OpenAPI Specification document file.
.google.cloud.apigateway.v1.ApiConfig.File document = 1;
Returns
Type
...
mergeDocument(ApiConfig.File value)
public ApiConfig . OpenApiDocument . Builder mergeDocument ( ApiConfig . File value )
The OpenAPI Specification document file.
.google.cloud.apigateway.v1.ApiConfig.File document = 1;
Parameter
Name
...
Description
ApiConfig.OpenApiDocument.Builder
mergeFrom(ApiConfig.OpenApiDocument other)
public ApiConfig . OpenApiDocument . Builder mergeFrom ( ApiConfig . OpenApiDocument other )
Parameter
Name
Description
other
...
public ApiConfig . OpenApiDocument . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public ApiConfig . OpenApiDocument . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
setDocument(ApiConfig.File value)
public ApiConfig . OpenApiDocument . Builder setDocument ( ApiConfig . File value )
The OpenAPI Specification document file.
.google.cloud.apigateway.v1.ApiConfig.File document = 1;
Parameter
Name
...
Description
ApiConfig.OpenApiDocument.Builder
setDocument(ApiConfig.File.Builder builderForValue)
public ApiConfig . OpenApiDocument . Builder setDocument ( ApiConfig . File . Builder builderForValue )
The OpenAPI Specification document file.
.google.cloud.apigateway.v1.ApiConfig.File document = 1;
Parameter
Name
