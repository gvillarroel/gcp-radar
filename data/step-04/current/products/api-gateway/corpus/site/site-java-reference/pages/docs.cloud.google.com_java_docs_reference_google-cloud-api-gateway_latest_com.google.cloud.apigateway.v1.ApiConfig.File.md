---
title: "Class ApiConfig.File (2.88.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/com.google.cloud.apigateway.v1.ApiConfig.File
...
2.2.1
2.1.12
public static final class ApiConfig . File extends GeneratedMessage implements ApiConfig . FileOrBuilder
...
Static Methods
getDefaultInstance()
public static ApiConfig . File getDefaultInstance ()
Returns
Type
Description
ApiConfig.File
...
Descriptor
newBuilder()
public static ApiConfig . File . Builder newBuilder ()
Returns
Type
Description
ApiConfig.File.Builder
newBuilder(ApiConfig.File prototype)
public static ApiConfig . File . Builder newBuilder ( ApiConfig . File prototype )
Parameter
Name
Description
prototype
...
public static ApiConfig . File parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static ApiConfig . File parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static ApiConfig . File parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static ApiConfig . File parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static ApiConfig . File parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static ApiConfig . File parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static ApiConfig . File parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static ApiConfig . File parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static ApiConfig . File parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static ApiConfig . File parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static ApiConfig . File parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static ApiConfig . File parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<ApiConfig . File > parser ()
Returns
Type
Description
Parser < File >
...
ApiConfig.File
getParserForType()
public Parser<ApiConfig . File > getParserForType ()
Returns
Type
Description
Parser < File >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public ApiConfig . File . Builder newBuilderForType ()
Returns
Type
Description
ApiConfig.File.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected ApiConfig . File . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public ApiConfig . File . Builder toBuilder ()
Returns
Type
Description
ApiConfig.File.Builder
