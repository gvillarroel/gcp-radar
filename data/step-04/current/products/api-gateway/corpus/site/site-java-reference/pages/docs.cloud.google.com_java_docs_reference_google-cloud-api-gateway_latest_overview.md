---
title: "google-cloud-api-gateway overview (2.88.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/overview
...
Client libraries
Send feedback
google-cloud-api-gateway overview (2.88.0)
...
The example below demonstrates how you would import the BOM and include the google-cloud-api-gateway artifact.
...
For this library, we recommend using com.google.cloud.apigateway.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. API Gateway). New Version IDs are introduced infrequently, and often involve
