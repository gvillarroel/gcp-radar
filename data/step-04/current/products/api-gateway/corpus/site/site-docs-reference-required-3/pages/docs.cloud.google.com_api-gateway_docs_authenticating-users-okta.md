---
title: "Using Okta to authenticate users \_|\_ API Gateway \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/api-gateway/docs/authenticating-users-okta
...
Okta integration guide for Google Cloud Endpoints .
...
make the following changes to your OpenAPI document:
OpenAPI 2.0
