---
title: "Class PublishEventsResponse.Builder (0.88.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-eventarc-publishing/latest/com.google.cloud.eventarc.publishing.v1.PublishEventsResponse.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-eventarc-publishing/latest/com.google.cloud.eventarc.publishing.v1.PublishEventsResponse.Builder
  title: "Class PublishEventsResponse.Builder (0.88.0) \_|\_ Java client libraries\
...
Client libraries
Send feedback
Class PublishEventsResponse.Builder (0.88.0)
...
0.5.0
0.4.0
public static final class PublishEventsResponse . Builder extends GeneratedMessage . Builder<PublishEventsResponse . Builder > implements PublishEventsResponseOrBuilder
...
Methods
build()
public PublishEventsResponse build ()
Returns
Type
Description
PublishEventsResponse
buildPartial()
public PublishEventsResponse buildPartial ()
Returns
Type
Description
PublishEventsResponse
clear()
public PublishEventsResponse . Builder clear ()
Returns
Type
Description
PublishEventsResponse.Builder
...
mergeFrom(PublishEventsResponse other)
public PublishEventsResponse . Builder mergeFrom ( PublishEventsResponse other )
Parameter
Name
Description
other
...
public PublishEventsResponse . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public PublishEventsResponse . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
