---
title: "google-cloud-eventarc-publishing overview (0.88.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-eventarc-publishing/latest/overview
...
Client libraries
Send feedback
google-cloud-eventarc-publishing overview (0.88.0)
...
0.4.0
Key Reference Links
Eventarc Publishing Description: Lets you asynchronously deliver events from Google services, SaaS, and your own apps using loosely coupled services that react to state changes.
Eventarc Publishing Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Use the Eventarc Publishing for Java
...
The example below demonstrates how you would import the BOM and include the google-cloud-eventarc-publishing artifact.
...
implementation ( "com.google.cloud:google-cloud-eventarc-publishing" )
...
For this library, we recommend using com.google.cloud.eventarc.publishing.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Eventarc Publishing). New Version IDs are introduced infrequently, and often involve
