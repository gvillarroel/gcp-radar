---
title: "Route backup for GKE events to GKE \_|\_ Eventarc Standard \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/eventarc/standard/docs/gke/route-trigger-backup-gke
...
source_metadata:
  url: https://docs.cloud.google.com/eventarc/standard/docs/gke/route-trigger-backup-gke
  title: "Route backup for GKE events to GKE \_|\_ Eventarc Standard \_|\_ Google\
    \ Cloud Documentation"
...
Backup for GKE event. For more details, see the list of
...
--event-filters="type=google.cloud.gkebackup.backupPlan.v1.updated" \
--event-filters-path-pattern="backupplan=my-backupplan-*" \
--service-account=${SERVICE_ACCOUNT_NAME}@${PROJECT_ID}.iam.gserviceaccount.com
...
Try out the Eventarc quickstarts .
