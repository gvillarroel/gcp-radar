---
title: "Route Apigee Registry events to GKE \_|\_ Eventarc Standard \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/eventarc/standard/docs/gke/route-trigger-apigee-registry
...
source_metadata:
  url: https://docs.cloud.google.com/eventarc/standard/docs/gke/route-trigger-apigee-registry
  title: "Route Apigee Registry events to GKE \_|\_ Eventarc Standard \_|\_ Google\
    \ Cloud Documentation"
...
Apigee Registry event. For more details, see the list of
...
for Apigee Registry events, enable the
Apigee Registry API.
...
If applicable, enable the API related to the direct events. For example,
for Apigee Registry events, enable
...
the event identified as google.cloud.apigeeregistry.apiDeployment.v1.updated and
