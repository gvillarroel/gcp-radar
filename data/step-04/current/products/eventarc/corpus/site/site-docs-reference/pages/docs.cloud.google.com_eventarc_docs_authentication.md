---
title: "Authenticate to Eventarc \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/eventarc/docs/authentication
...
Reference
Send feedback
Authenticate to Eventarc
Stay organized with collections
Save and categorize content based on your preferences.
Advanced
Standard
This document describes how to authenticate to Eventarc programmatically. How
you authenticate to Eventarc depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Eventarc supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Eventarc client libraries provide
high-level language support for authenticating to Eventarc
programmatically.
...
For more information about using the gcloud CLI with Eventarc,
...
Set up authentication for Eventarc
...
Access control for Eventarc
After you authenticate to Eventarc, you must be authorized to access
Google Cloud resources. Eventarc uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Eventarc, see
