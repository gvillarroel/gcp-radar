---
title: "AutoMigrationConfig \_|\_ Infrastructure Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/infrastructure-manager/docs/reference/rest/v1/AutoMigrationConfig
...
name
string
Identifier. The name of the AutoMigrationConfig. Format: 'projects/{projectId}/locations/{location}/AutoMigrationConfig'.
updateTime
