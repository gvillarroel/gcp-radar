---
title: "Authenticate to Infra Manager \_|\_ Infrastructure Manager \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/infrastructure-manager/docs/authentication
...
source_metadata:
  url: https://docs.cloud.google.com/infrastructure-manager/docs/authentication
  title: "Authenticate to Infra Manager \_|\_ Infrastructure Manager \_|\_ Google\
    \ Cloud Documentation"
...
Reference
Send feedback
Authenticate to Infra Manager
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Infrastructure Manager programmatically. How
you authenticate to Infrastructure Manager depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Infra Manager supports programmatic access. You can access the API in
the following ways:
Google Cloud CLI
REST
Google Cloud CLI
...
For more information about using the gcloud CLI with Infra Manager,
see the gcloud CLI reference pages .
REST
You can authenticate to
the Infra Manager API
...
Set up authentication for Infra Manager
...
Infra Manager, as described in Enable Infrastructure Manager .
...
Access control for Infra Manager
After you authenticate to Infra Manager, you must be authorized to access
Google Cloud resources. Infra Manager uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Infra Manager, see
