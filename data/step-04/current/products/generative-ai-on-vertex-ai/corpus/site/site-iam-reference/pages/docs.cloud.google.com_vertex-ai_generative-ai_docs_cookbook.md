---
title: "Generative AI on Vertex AI Cookbook \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/cookbook
...
Get started with Gemini 3 Pro in Vertex AI with the Gen AI Python SDK.
View on GitHub
Gemini
Image generation
Multimodal
Gemini 2.5 Flash Image Generation in Vertex AI (Nano Banana)
...
Live api
Multimodal
Get Started with the Gemini Live API
Get started with Gemini Live API in Vertex AI using the Gen AI Python SDK
View on GitHub
Gemini
Search
Intro to Gemini Enterprise
Unlock your company's data with Gemini Enterprise, the AI platform for intelligent search and shareable, automated agents.
View on GitHub
Gemini
Prompting
