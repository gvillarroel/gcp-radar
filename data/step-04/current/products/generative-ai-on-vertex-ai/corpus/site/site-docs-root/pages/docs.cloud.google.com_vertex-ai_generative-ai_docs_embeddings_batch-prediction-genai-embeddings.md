---
title: "Get batch text embeddings inferences \_|\_ Generative AI on Vertex AI \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/embeddings/batch-prediction-genai-embeddings
...
source_metadata:
  url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/embeddings/batch-prediction-genai-embeddings
  title: "Get batch text embeddings inferences \_|\_ Generative AI on Vertex AI \_\
...
of LLM requests in a single batch request. Similar to how batch inference is done
...
embedding models, see Embedding model and versions .
Prepare your inputs
...
INPUT_URI : The input source URI. This is either a BigQuery table URI or a JSONL
...
the BATCH_JOB_ID until the job state is
