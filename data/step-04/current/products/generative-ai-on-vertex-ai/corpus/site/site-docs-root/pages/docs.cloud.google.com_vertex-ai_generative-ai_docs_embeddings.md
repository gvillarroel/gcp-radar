---
title: "Embeddings APIs overview \_|\_ Generative AI on Vertex AI \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/embeddings
...
To take a foundational ML crash course on embeddings, see
Embeddings .
To learn more about how to store vector embeddings in a database, see the
Overview of Vector Search .
To learn about responsible AI best practices and Vertex AI's safety
filters, see Responsible AI .
