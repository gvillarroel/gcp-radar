---
title: "Tutorial: Vertex AI Studio in express mode \_|\_ Generative AI on Vertex AI\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/start/express-mode/vertex-ai-studio-express-mode-quickstart
...
source_metadata:
  url: https://docs.cloud.google.com/vertex-ai/generative-ai/docs/start/express-mode/vertex-ai-studio-express-mode-quickstart
  title: "Tutorial: Vertex AI Studio in express mode \_|\_ Generative AI on Vertex\
...
In the navigation pane, click Prompt Gallery .
In the Prompt Gallery page, click Image to filter to only the prompt
samples that include images.
Click the sample prompt card that's titled Extract text from images .
...
Vertex AI Studio page.
Go to Vertex AI Studio
In the navigation pane, click Create prompt .
