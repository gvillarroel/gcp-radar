---
title: "Point-in-time recovery (PITR) overview \_|\_ Firestore in Native mode \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/firestore/docs/pitr
...
source_metadata:
  url: https://docs.cloud.google.com/firestore/docs/pitr
  title: "Point-in-time recovery (PITR) overview \_|\_ Firestore in Native mode \_\
...
Storage: Firestore measures the database size daily. Over the
