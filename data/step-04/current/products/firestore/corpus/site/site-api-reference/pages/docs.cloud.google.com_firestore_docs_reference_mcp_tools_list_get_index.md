...
title: "MCP Tools Reference: firestore.googleapis.com \_|\_ Firestore \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/firestore/docs/reference/mcp/tools_list/get_index
...
The following sample demonstrate how to use curl to invoke the get_index MCP tool.
Curl Request
