---
title: "Class BulkWriterOptions (3.38.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-firestore/latest/com.google.cloud.firestore.BulkWriterOptions
...
Client libraries
Send feedback
Class BulkWriterOptions (3.38.0)
...
The ScheduledExecutorService that BulkWriter uses to schedule all operations.
...
The throttler's allowed operations per second does not ramp up past the specified operations
per second.
Returns
Type
Description
