---
title: "google-cloud-firestore overview (3.38.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-firestore/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-firestore/latest/overview
  title: "google-cloud-firestore overview (3.38.0) \_|\_ Java client libraries \_\
...
Client libraries
Send feedback
google-cloud-firestore overview (3.38.0)
...
Cloud Firestore Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Version ID : The version of the Cloud service itself (e.g. Cloud Firestore). New Version IDs are introduced infrequently, and often involve
