...
url: https://docs.cloud.google.com/python/docs/reference/firestore/latest/changelog
...
2.22.0 (2025-12-16)
Features
support mTLS certificates when available (#1140) ( 403afb08109c8271eddd97d6172136271cc0a8a9 )
Add support for Python 3.14 (#1110) ( 52b2055d01ab5d2c34e00f8861e29990f89cd3d8 )
Expose tags field in Database and RestoreDatabaseRequest public protos (#1074) ( 49836391dc712bd482781a26ccd3c8a8408c473b )
Added read_time as a parameter to various calls (synchronous/base classes) (#1050) ( d8e3af1f9dbdfaf5df0d993a0a7e28883472c621 )
Bug Fixes
improve typing (#1136) ( d1c730d9eef867d16d7818a75f7d58439a942c1d )
update the async transactional types (#1066) ( 210a14a4b758d70aad05940665ed2a2a21ae2a8b )
2.21.0 (2025-05-23)
Features
...
Bug Fixes
Remove custom retry loop ( #948 ) ( 04bb206 )
2.17.2 (2024-08-13)
Bug Fixes
...
2.17.1 (2024-08-09)
Bug Fixes
Allow protobuf 5.x ( #919 ) ( 3a13bf9 )
2.17.0 (2024-07-12)
Features
Support async Vector Search ( #901 ) ( 2de1620 )
Use generator for stream results ( #926 ) ( 3e5df35 )
2.16.1 (2024-04-17)
Bug Fixes
repr method in vector.py ( #903 ) ( 6886f2b )
Documentation
...
2.13.0 (2023-10-23)
Features
Sum/Avg aggregation queries ( #715 ) ( 443475b )
Bug Fixes
...
2.11.0 (2023-04-03)
Features
OR Query implementation ( #698 ) ( 44dd5d6 )
2.10.1 (2023-03-23)
Documentation
Fix formatting of request arg in docstring ( #700 ) ( 7b09f16 )
2.10.0 (2023-02-21)
Features
Add OR query support ( #689 ) ( 22af4d7 )
Bug Fixes
...
2.9.0 (2023-01-12)
Features
Support the Count aggregation query ( #673 ) ( dfd4c5d )
2.8.0 (2023-01-10)
Features
Add support for python 3.11 ( #675 ) ( 2030a9f )
2.7.3 (2022-12-08)
Bug Fixes
...
2.7.2 (2022-10-10)
Bug Fixes
deps: Allow protobuf 3.19.5 ( #648 ) ( 9ffbd75 )
2.7.1 (2022-09-29)
Bug Fixes
deps: Require protobuf >= 3.20.2 ( #644 ) ( dd7d10b )
2.7.0 (2022-09-13)
Features
...
Bug Fixes
deps: require google-api-core>=1.32.0,>=2.8.0 ( #607 ) ( 40dce54 )
require python 3.7+ ( #613 ) ( 19accae )
2.5.3 (2022-06-02)
Documentation
fix changelog header to consistent size ( #597 ) ( 0aca503 )
2.5.2 (2022-06-01)
Bug Fixes
deps: require protobuf <4.0.0dev ( #598 ) ( 1796592 )
2.5.1 (2022-05-30)
Bug Fixes
...
2.5.0 (2022-05-05)
Features
Enable RunQueryResponse.done ( #572 ) ( 3ec13da )
Documentation
...
2.3.2 (2021-09-09)
Bug Fixes
treat None cursors as a no-op. ( #440 ) ( e7aed0f )
2.3.1 (2021-08-30)
Bug Fixes
...
Documentation
added generated docs for Bundles ( #416 ) ( 0176cc7 )
fixed broken links to devsite ( #417 ) ( 1adfc81 )
2.2.0 (2021-07-22)
Features
add always_use_jwt_access ( #380 ) ( 2ef4194 )
Bug Fixes
...
2.1.3 (2021-06-15)
Bug Fixes
add ‘packaging’ dependency ( #372 ) ( 9623a51 ), closes #371
2.1.2 (2021-06-14)
Documentation
...
2.0.1 (2020-11-12)
Bug Fixes
use an insecure channel under emulation ( #254 ) ( 801f827 ), closes #250
Documentation
update code of conduct ( #253 ) ( 3702dc8 )
2.0.0 (2020-11-06)
⚠ BREAKING CHANGES
...
use DatetimeWithNanoseconds throughout library ( #116 ) ( 1801ba2 )
firestore: add IN , ARRAY_CONTAINS_ANY operators; update docstrings (via synth) ( #9439 ) ( 107e526 )
...
use update_transforms for mutations ( #219 ) ( c122e41 ), closes #217
Bug Fixes
add import message via synth ( #231 ) ( 5fb02e9 ), closes #227 #228 #229
harden version data gathering against DistributionNotFound ( #212 ) ( 20b7260 )
name parameter to indicate snapshot support ( #169 ) ( be98897 ), closes #56
...
Port changelog from 30.1 branch to main ( #6903 )
