---
title: "Module async_transaction (2.23.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/firestore/latest/google.cloud.firestore_v1.async_transaction
...
Client libraries
Send feedback
Module async_transaction (2.23.0)
...
google . cloud . firestore_v1 . async_transaction . AsyncTransaction , ~ P
]
],
typing . Awaitable [ google . cloud . firestore_v1 . async_transaction . T ],
],
) - > typing . Callable [
[
typing_extensions . Concatenate [
...
Type
Description
Callable[[ Transaction , ...], Awaitable[Any]]
