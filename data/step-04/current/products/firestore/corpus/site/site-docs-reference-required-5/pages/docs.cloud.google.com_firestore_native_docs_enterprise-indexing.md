---
title: "Manage Enterprise edition indexes \_|\_ Firestore in Native mode \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/firestore/native/docs/enterprise-indexing
...
describes how to manage your indexes for Firestore Enterprise edition. For Firestore Standard edition,
see Firestore Standard edition index overview .
To learn more
about Firestore Enterprise edition indexes, see Indexes overview .
Before you begin
...
Firestore begins creating your index. When your index is created,
...
DATABASE_ID : a database ID
Index build time
To build an index, Firestore must create the index and then
...
Key Term: Firestore supports several administrative operations that
can take a long time to complete. These operations are called long-running
operations . Firestore includes features to execute and manage long-
