---
title: "Class Action.FailedSecurityPolicyApply (1.86.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.FailedSecurityPolicyApply
...
Client libraries
Send feedback
Class Action.FailedSecurityPolicyApply (1.86.0)
...
1.0.1
0.2.2
public static final class Action . FailedSecurityPolicyApply extends GeneratedMessage implements Action . FailedSecurityPolicyApplyOrBuilder
...
Static Methods
getDefaultInstance()
public static Action . FailedSecurityPolicyApply getDefaultInstance ()
Returns
Type
Description
Action.FailedSecurityPolicyApply
...
Descriptor
newBuilder()
public static Action . FailedSecurityPolicyApply . Builder newBuilder ()
Returns
Type
Description
Action.FailedSecurityPolicyApply.Builder
newBuilder(Action.FailedSecurityPolicyApply prototype)
public static Action . FailedSecurityPolicyApply . Builder newBuilder ( Action . FailedSecurityPolicyApply prototype )
Parameter
Name
Description
prototype
...
public static Action . FailedSecurityPolicyApply parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . FailedSecurityPolicyApply parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static Action . FailedSecurityPolicyApply parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static Action . FailedSecurityPolicyApply parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . FailedSecurityPolicyApply parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static Action . FailedSecurityPolicyApply parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . FailedSecurityPolicyApply parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static Action . FailedSecurityPolicyApply parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . FailedSecurityPolicyApply parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . FailedSecurityPolicyApply parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . FailedSecurityPolicyApply parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static Action . FailedSecurityPolicyApply parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<Action . FailedSecurityPolicyApply > parser ()
Returns
Type
Description
Parser < FailedSecurityPolicyApply >
Methods
equals(Object obj)
...
Action.FailedSecurityPolicyApply
getParserForType()
public Parser<Action . FailedSecurityPolicyApply > getParserForType ()
Returns
Type
Description
Parser < FailedSecurityPolicyApply >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public Action . FailedSecurityPolicyApply . Builder newBuilderForType ()
Returns
Type
Description
Action.FailedSecurityPolicyApply.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected Action . FailedSecurityPolicyApply . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public Action . FailedSecurityPolicyApply . Builder toBuilder ()
Returns
Type
Description
Action.FailedSecurityPolicyApply.Builder
