---
title: "Enum Action.Category (1.86.0) \_|\_ Java client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.Category
...
1.0.1
0.2.2
public enum Action . Category extends Enum<Action . Category > implements ProtocolMessageEnum
