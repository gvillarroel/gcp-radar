---
title: "Class Action.InvalidDataOrganization.Builder (1.86.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.InvalidDataOrganization.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.InvalidDataOrganization.Builder
  title: "Class Action.InvalidDataOrganization.Builder (1.86.0) \_|\_ Java client\
...
Client libraries
Send feedback
Class Action.InvalidDataOrganization.Builder (1.86.0)
...
1.0.1
0.2.2
public static final class Action . InvalidDataOrganization . Builder extends GeneratedMessage . Builder<Action . InvalidDataOrganization . Builder > implements Action . InvalidDataOrganizationOrBuilder
...
Methods
build()
public Action . InvalidDataOrganization build ()
Returns
Type
Description
Action.InvalidDataOrganization
buildPartial()
public Action . InvalidDataOrganization buildPartial ()
Returns
Type
Description
Action.InvalidDataOrganization
clear()
public Action . InvalidDataOrganization . Builder clear ()
Returns
Type
Description
Action.InvalidDataOrganization.Builder
...
mergeFrom(Action.InvalidDataOrganization other)
public Action . InvalidDataOrganization . Builder mergeFrom ( Action . InvalidDataOrganization other )
Parameter
Name
Description
other
...
public Action . InvalidDataOrganization . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public Action . InvalidDataOrganization . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
