---
title: "Class Action.InvalidDataPartition.Builder (1.86.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.InvalidDataPartition.Builder
...
Client libraries
Send feedback
Class Action.InvalidDataPartition.Builder (1.86.0)
...
1.0.1
0.2.2
public static final class Action . InvalidDataPartition . Builder extends GeneratedMessage . Builder<Action . InvalidDataPartition . Builder > implements Action . InvalidDataPartitionOrBuilder
...
Methods
build()
public Action . InvalidDataPartition build ()
Returns
Type
Description
Action.InvalidDataPartition
buildPartial()
public Action . InvalidDataPartition buildPartial ()
Returns
Type
Description
Action.InvalidDataPartition
clear()
public Action . InvalidDataPartition . Builder clear ()
Returns
Type
Description
Action.InvalidDataPartition.Builder
...
clearExpectedStructure()
public Action . InvalidDataPartition . Builder clearExpectedStructure ()
...
mergeFrom(Action.InvalidDataPartition other)
public Action . InvalidDataPartition . Builder mergeFrom ( Action . InvalidDataPartition other )
Parameter
Name
Description
other
...
public Action . InvalidDataPartition . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public Action . InvalidDataPartition . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
setExpectedStructure(Action.InvalidDataPartition.PartitionStructure value)
public Action . InvalidDataPartition . Builder setExpectedStructure ( Action . InvalidDataPartition . PartitionStructure value )
The issue type of InvalidDataPartition.
.google.cloud.dataplex.v1.Action.InvalidDataPartition.PartitionStructure expected_structure = 1;
Parameter
Name
Description
value
Action.InvalidDataPartition.PartitionStructure The expectedStructure to set.
Returns
Type
Description
Action.InvalidDataPartition.Builder
This builder for chaining.
setExpectedStructureValue(int value)
public Action . InvalidDataPartition . Builder setExpectedStructureValue ( int value )
The issue type of InvalidDataPartition.
.google.cloud.dataplex.v1.Action.InvalidDataPartition.PartitionStructure expected_structure = 1;
Parameter
Name
Description
value
int The enum numeric value on the wire for expectedStructure to set.
Returns
Type
Description
Action.InvalidDataPartition.Builder
