---
title: "Class Action.InvalidDataFormat (1.86.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.InvalidDataFormat
...
Client libraries
Send feedback
Class Action.InvalidDataFormat (1.86.0)
...
1.0.1
0.2.2
public static final class Action . InvalidDataFormat extends GeneratedMessage implements Action . InvalidDataFormatOrBuilder
...
Static Fields
EXPECTED_FORMAT_FIELD_NUMBER
public static final int EXPECTED_FORMAT_FIELD_NUMBER
Field Value
Type
Description
int
NEW_FORMAT_FIELD_NUMBER
public static final int NEW_FORMAT_FIELD_NUMBER
Field Value
Type
Description
int
...
Static Methods
getDefaultInstance()
public static Action . InvalidDataFormat getDefaultInstance ()
Returns
Type
Description
Action.InvalidDataFormat
...
Descriptor
newBuilder()
public static Action . InvalidDataFormat . Builder newBuilder ()
Returns
Type
Description
Action.InvalidDataFormat.Builder
newBuilder(Action.InvalidDataFormat prototype)
public static Action . InvalidDataFormat . Builder newBuilder ( Action . InvalidDataFormat prototype )
Parameter
Name
Description
prototype
...
public static Action . InvalidDataFormat parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . InvalidDataFormat parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static Action . InvalidDataFormat parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static Action . InvalidDataFormat parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . InvalidDataFormat parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static Action . InvalidDataFormat parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . InvalidDataFormat parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static Action . InvalidDataFormat parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . InvalidDataFormat parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . InvalidDataFormat parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . InvalidDataFormat parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static Action . InvalidDataFormat parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<Action . InvalidDataFormat > parser ()
Returns
Type
Description
Parser < InvalidDataFormat >
Methods
equals(Object obj)
...
getParserForType()
public Parser<Action . InvalidDataFormat > getParserForType ()
Returns
Type
Description
Parser < InvalidDataFormat >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public Action . InvalidDataFormat . Builder newBuilderForType ()
Returns
Type
Description
Action.InvalidDataFormat.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected Action . InvalidDataFormat . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public Action . InvalidDataFormat . Builder toBuilder ()
Returns
Type
Description
Action.InvalidDataFormat.Builder
