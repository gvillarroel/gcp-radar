---
title: "google-cloud-dataplex overview (1.86.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/overview
...
Client libraries
Send feedback
google-cloud-dataplex overview (1.86.0)
...
Cloud Dataplex Product Reference
GitHub Repository
Maven artifact
Getting Started
...
For this library, we recommend using com.google.cloud.dataplex.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Dataplex). New Version IDs are introduced infrequently, and often involve
