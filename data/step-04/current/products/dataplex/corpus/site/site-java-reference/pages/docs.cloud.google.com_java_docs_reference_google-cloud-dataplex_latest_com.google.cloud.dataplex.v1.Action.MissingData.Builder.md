---
title: "Class Action.MissingData.Builder (1.86.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.MissingData.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.MissingData.Builder
  title: "Class Action.MissingData.Builder (1.86.0) \_|\_ Java client libraries \_\
...
Client libraries
Send feedback
Class Action.MissingData.Builder (1.86.0)
...
1.0.1
0.2.2
public static final class Action . MissingData . Builder extends GeneratedMessage . Builder<Action . MissingData . Builder > implements Action . MissingDataOrBuilder
...
Methods
build()
public Action . MissingData build ()
Returns
Type
Description
Action.MissingData
buildPartial()
public Action . MissingData buildPartial ()
Returns
Type
Description
Action.MissingData
clear()
public Action . MissingData . Builder clear ()
Returns
Type
Description
Action.MissingData.Builder
...
mergeFrom(Action.MissingData other)
public Action . MissingData . Builder mergeFrom ( Action . MissingData other )
Parameter
Name
Description
other
...
public Action . MissingData . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public Action . MissingData . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
