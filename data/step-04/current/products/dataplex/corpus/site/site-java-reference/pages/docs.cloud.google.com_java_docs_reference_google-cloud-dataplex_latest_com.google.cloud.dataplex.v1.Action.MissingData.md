---
title: "Class Action.MissingData (1.86.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataplex/latest/com.google.cloud.dataplex.v1.Action.MissingData
...
Client libraries
Send feedback
Class Action.MissingData (1.86.0)
...
1.0.1
0.2.2
public static final class Action . MissingData extends GeneratedMessage implements Action . MissingDataOrBuilder
...
Static Methods
getDefaultInstance()
public static Action . MissingData getDefaultInstance ()
Returns
Type
Description
Action.MissingData
...
Descriptor
newBuilder()
public static Action . MissingData . Builder newBuilder ()
Returns
Type
Description
Action.MissingData.Builder
newBuilder(Action.MissingData prototype)
public static Action . MissingData . Builder newBuilder ( Action . MissingData prototype )
Parameter
Name
Description
prototype
...
public static Action . MissingData parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . MissingData parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static Action . MissingData parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static Action . MissingData parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . MissingData parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static Action . MissingData parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static Action . MissingData parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static Action . MissingData parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . MissingData parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static Action . MissingData parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static Action . MissingData parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static Action . MissingData parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<Action . MissingData > parser ()
Returns
Type
Description
Parser < MissingData >
...
public Action . MissingData getDefaultInstanceForType ()
Returns
Type
Description
Action.MissingData
getParserForType()
public Parser<Action . MissingData > getParserForType ()
Returns
Type
Description
Parser < MissingData >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public Action . MissingData . Builder newBuilderForType ()
Returns
Type
Description
Action.MissingData.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected Action . MissingData . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public Action . MissingData . Builder toBuilder ()
Returns
Type
Description
Action.MissingData.Builder
