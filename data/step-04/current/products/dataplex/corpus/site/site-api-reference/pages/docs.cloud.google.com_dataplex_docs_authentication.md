---
title: "Authenticate to Dataplex Universal Catalog \_|\_ Knowledge Catalog \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/dataplex/docs/authentication
...
source_metadata:
  url: https://docs.cloud.google.com/dataplex/docs/authentication
  title: "Authenticate to Dataplex Universal Catalog \_|\_ Knowledge Catalog \_|\_\
...
Reference
Send feedback
Authenticate to Dataplex Universal Catalog
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Dataplex Universal Catalog programmatically. How
you authenticate to Dataplex Universal Catalog depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Dataplex Universal Catalog supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Dataplex Universal Catalog client libraries provide
high-level language support for authenticating to Dataplex Universal Catalog
programmatically.
...
Dataplex Universal Catalog, you
...
For more information about using the gcloud CLI with Dataplex Universal Catalog,
see the gcloud CLI reference pages .
REST
You can authenticate to
the Dataplex Universal Catalog API
...
Set up authentication for Dataplex Universal Catalog
...
Access control for Dataplex Universal Catalog
After you authenticate to Dataplex Universal Catalog, you must be authorized to access
Google Cloud resources. Dataplex Universal Catalog uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Dataplex Universal Catalog, see
