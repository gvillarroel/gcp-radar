---
title: "Enable Knowledge Catalog \_|\_ Google Cloud Documentation"
...
Guides
Send feedback
Enable Knowledge Catalog
Stay organized with collections
Save and categorize content based on your preferences.
Before you can use Knowledge Catalog (formerly Dataplex Universal Catalog), you must enable the necessary
APIs in your Google Cloud project. This document shows you how to enable the
Knowledge Catalog API and other required services.
...
Enable Knowledge Catalog
You can use an existing project with Knowledge Catalog or create
...
To create a project and enable Knowledge Catalog, follow these steps:
...
Knowledge Catalog pricing and
Data lineage considerations .
Disable Knowledge Catalog
If you use Knowledge Catalog in a project that also uses BigQuery,
be aware of the
effects on BigQuery behavior
when you disable Knowledge Catalog.
...
Look for an empty list of lake instances on the Knowledge Catalog page.
