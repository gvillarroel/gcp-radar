---
title: "Manage access with IAM \_|\_ Knowledge Catalog \_|\_ Google Cloud Documentation"
...
for Knowledge Catalog (formerly Dataplex Universal Catalog) resources. IAM controls access to
your Knowledge Catalog resources at the Google Cloud resource level. It
...
and its resources, including Knowledge Catalog resources. You grant this access
...
The service agent
Knowledge Catalog uses a Google Cloud managed service account, a
...
The service agent is created when you enable the Dataplex API. You can
identify the service agent by its email ID:
...
The service agent requires the
Dataplex Service Agent ( roles/dataplex.serviceAgent ) role on the project
to manage Knowledge Catalog resources. When you enable the API, the system
automatically grants this role. If you revoke this role, Knowledge Catalog
might not function correctly.
If Knowledge Catalog needs to access resources in other projects (for
...
Execution Identity for data scans
By default, Knowledge Catalog uses the service agent to run your data
quality and data profile scans. However, you can choose to override this
behavior and execute scans using a custom service account or your own End-User
Credentials (EUC).
If you specify a custom service account for your scan's execution identity, the
service agent requires the Service Account Token
Creator ( roles/iam.serviceAccountTokenCreator ) role
(or the iam.serviceAccounts.getAccessToken permission) on the target service
account to impersonate it and run the job. For more details, see the execution
identity documentation for data quality and data profiling .
Resource
Resources you can grant access to in Knowledge Catalog include projects,
...
Similar to other Google Cloud products, Knowledge Catalog supports
...
roles . The Knowledge Catalog IAM roles
documentation details the Knowledge Catalog
predefined roles.
...
provides read-only access to Knowledge Catalog resources. A principal
...
Conversely, the Dataplex Administrator ( roles/dataplex.admin ) grants broad
access to manage Knowledge Catalog resources.
...
pages for Knowledge Catalog roles and
...
Knowledge Catalog resources in the project, but can't manage other
...
permissions .
Learn more about Knowledge Catalog security
Send feedback
