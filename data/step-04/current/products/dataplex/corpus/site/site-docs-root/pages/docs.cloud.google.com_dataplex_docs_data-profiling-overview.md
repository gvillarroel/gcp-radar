---
title: "About data profiling \_|\_ Dataplex Universal Catalog \_|\_ Google Cloud Documentation"
...
source_metadata:
  url: https://docs.cloud.google.com/dataplex/docs/data-profiling-overview
  title: "About data profiling \_|\_ Dataplex Universal Catalog \_|\_ Google Cloud\
    \ Documentation"
...
Dataplex Universal Catalog makes it easier to understand and
...
Dataplex Universal Catalog data
scan that
...
Note: Dataplex Universal Catalog runs scans on resources in a Google tenant project,
...
If you configure a data profile scan to publish the results to BigQuery and Dataplex Universal Catalog, you can view the latest data profile scan
results on the source table's Data profile tab in both BigQuery and Dataplex Universal Catalog. These results are accessible from any project.
