---
title: "Connect to your AKS cluster \_|\_ GKE attached clusters \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/attached/aks/how-to/connect-to-cluster
...
This document describes three methods of connecting to your AKS
attached cluster:
...
cluster.
To attach an AKS cluster, follow the steps in
Attach your AKS cluster . To
update an AKS cluster, follow the steps in
Update your AKS cluster .
