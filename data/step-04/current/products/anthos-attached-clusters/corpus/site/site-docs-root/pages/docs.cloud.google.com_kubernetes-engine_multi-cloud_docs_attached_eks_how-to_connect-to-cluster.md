---
title: "Connect to your EKS attached cluster \_|\_ GKE attached clusters \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/attached/eks/how-to/connect-to-cluster
...
This document describes three methods of connecting to your EKS
attached cluster:
...
cluster.
To attach an EKS cluster, follow the steps in
Attach your EKS cluster . To
update an EKS cluster, follow the steps in
