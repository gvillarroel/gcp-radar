---
title: "GKE on Azure documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/azure
...
GKE clusters running on Azure infrastructure through the
GKE Multi-Cloud API .
Combined with
Connect ,
GKE on Azure lets you manage
...
workloads with the gcloud and kubectl command-line tools.
