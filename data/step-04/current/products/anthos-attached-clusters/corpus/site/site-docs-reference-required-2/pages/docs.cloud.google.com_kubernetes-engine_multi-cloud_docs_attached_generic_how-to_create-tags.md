---
title: "Create and manage Tags on CNCF conformant attached clusters \_|\_ GKE attached\
  \ clusters \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/attached/generic/how-to/create-tags
...
Guides
Send feedback
Create and manage Tags on CNCF conformant attached clusters
...
a resource. For example, if you attached env:dev to your cluster, you can't
also attach env:prod or env:test . You can attach up to 50 tags to each
resource.
In GKE attached clusters, there are several methods to annotate your resources, as
...
You can attach Tags to a new or existing cluster if you have the
correct permissions.
Attach Tags when you create a cluster
To create a tag binding while you create a new cluster, run the following command:
gcloud container attached clusters register CLUSTER_NAME \
--tags = TAG_ID
...
Replace the following:
CLUSTER_NAME : the name of your cluster. The
CLUSTER_NAME must be compliant with the RFC 1123 Label Names
standard .
TAG_ID : the permanent ID or namespaced
name of the tag value to attach—for example, tagValues/4567890123 .
For details about tag identifiers, see Tag definitions and identifiers .
For more information, see Attach your GKE attached clusters .
Attach Tags when you update a cluster
To create a tag binding to attach a tag to an existing cluster, use one of the following methods:
gcloud
...
//container.googleapis.com/projects/ PROJECT_ID /locations/ CLUSTER_LOCATION /attachedClusters/ CLUSTER_NAME .
In the resource ID:
