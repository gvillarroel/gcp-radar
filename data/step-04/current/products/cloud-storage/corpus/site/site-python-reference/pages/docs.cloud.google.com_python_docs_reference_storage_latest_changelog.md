...
url: https://docs.cloud.google.com/python/docs/reference/storage/latest/changelog
...
2.15.0 (2024-02-28)
Features
Support custom universe domains/TPC ( #1212 ) ( f4cf041 )
Bug Fixes
Add “updated” as property for Bucket ( #1220 ) ( ae9a53b )
Remove utcnow usage ( #1215 ) ( 8d8a53a )
2.14.0 (2023-12-10)
Features
Add support for Python 3.12 ( #1187 ) ( ecf4150 )
Support object retention lock ( #1188 ) ( a179337 )
Bug Fixes
...
2.13.0 (2023-10-31)
Features
Add Autoclass v2.1 support ( #1117 ) ( d38adb6 )
Add support for custom headers ( #1121 ) ( 2f92c3a )
Bug Fixes
...
Documentation
Add clarification to batch module ( #1045 ) ( 11f6024 )
2.9.0 (2023-05-04)
Features
...
Bug Fixes
deps: drop pkg_resources ( #744 ) ( e963f33 )
Documentation
fix links in blob module ( #759 ) ( 9b29314 )
2.2.1 (2022-03-15)
Bug Fixes
remove py.typed marker file for PEP 561 ( #735 ) ( f77d2f7 ), closes #734
2.2.0 (2022-03-14)
Features
...
Documentation
update docs build (via synth) ( #222 ) ( 4c5adfa )
1.30.0 (2020-07-24)
Features
...
remove doubled word in docstring ( #209 ) ( 7a4e7a5 )
Dependencies
prep for grmp-1.0.0 release ( #211 ) ( 55bae9a )
1.29.0 (2020-06-09)
Features
...
add if generation Match support, pt1 ( #123 ) ( 0944442 )
