---
title: "Class EncryptionEnforcementConfig (3.10.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/storage/latest/google.cloud.storage.bucket.EncryptionEnforcementConfig
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/storage/latest/google.cloud.storage.bucket.EncryptionEnforcementConfig
  title: "Class EncryptionEnforcementConfig (3.10.0) \_|\_ Python client libraries\
...
point-in time at which the configuration is effective, or None if the property is not set.
restriction_mode
...
Description
str or NoneType
The restriction mode or None if the property is not set.
Methods
clear
clear ()
