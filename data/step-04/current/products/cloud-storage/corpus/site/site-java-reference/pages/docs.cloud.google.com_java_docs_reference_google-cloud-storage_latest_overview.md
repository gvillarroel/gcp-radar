---
title: "google-cloud-storage overview (2.64.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-storage/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-storage/latest/overview
  title: "google-cloud-storage overview (2.64.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
google-cloud-storage overview (2.64.0)
...
Cloud Storage Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Version ID : The version of the Cloud service itself (e.g. Cloud Storage). New Version IDs are introduced infrequently, and often involve
