---
title: "AnywhereCaches: resume \_|\_ Cloud Storage \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/storage/docs/json_api/v1/AnywhereCaches/resume
...
Resumes a cache instance
in a specified bucket from being paused or disabled.
Required permissions
The authenticated user must have the storage.anywhereCaches.resume IAM permission on the bucket to use this method.
Request
HTTP request
...
AnywhereCache resource in the response
body.
Try it!
