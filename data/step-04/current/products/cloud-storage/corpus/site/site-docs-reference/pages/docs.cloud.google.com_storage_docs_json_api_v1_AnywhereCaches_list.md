---
title: "AnywhereCaches: list \_|\_ Cloud Storage \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/storage/docs/json_api/v1/AnywhereCaches/list
...
The authenticated user must have the storage.anywhereCaches.list
IAM permission on the bucket to use this method.
Request
HTTP request
GET https://storage.googleapis.com/storage/v1/b/ bucket /anywhereCaches
...
Response
If successful, this method returns a list of
AnywhereCache resources in the following
structure:
{
