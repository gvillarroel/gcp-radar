---
title: "Data Boundary for Canada Protected B \_|\_ Assured Workloads \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/canada-protected-b
...
Data Boundary for Canada Protected B workloads in Assured Workloads. It provides
...
Data Boundary for Canada Protected B:
Data residency : The Data Boundary for Canada Protected B control package sets data
location controls to support
Canada-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for Data Boundary for Canada Protected B workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. Data Boundary for Canada Protected B workloads support cases are routed to
Canadian support personnel who have completed Reliability Status screenings.
See Getting support
for more information.
Pricing : The Data Boundary for Canada Protected B control package is included in
...
requirements for Data Boundary for Canada Protected B. Unsupported products are not recommended for use
...
Data Boundary for Canada Protected B folders. Other applicable organization policy constraints—even if
...
connectors for Data Boundary for Canada Protected B workloads.
...
Data Boundary for Canada Protected B supports the following service levels:
Standard
Premium
Extreme
