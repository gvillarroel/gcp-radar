---
title: "US Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/us-data-boundary-support
...
source_metadata:
  url: https://docs.cloud.google.com/assured-workloads/docs/control-packages/us-data-boundary-support
  title: "US Data Boundary and Support \_|\_ Assured Workloads \_|\_ Google Cloud\
    \ Documentation"
...
US Data Boundary and Support workloads in Assured Workloads. It provides
...
US Data Boundary and Support:
Data residency : The US Data Boundary and Support control package sets data
location controls to support
US-only regions . See the
Google Cloud-wide organization policy constraints section
for more information.
Support : Technical support services for US Data Boundary and Support workloads
are available with Enhanced or Premium Cloud Customer Care
subscriptions. US Data Boundary and Support workloads support cases are routed to
US Persons located in the US; see
Getting support
for more information.
Pricing : The US Data Boundary and Support control package is included in
...
requirements for US Data Boundary and Support. Unsupported products are not recommended for use
...
US Data Boundary and Support folders. Other applicable organization policy constraints—even if
...
connectors for US Data Boundary and Support workloads.
...
US Data Boundary and Support supports the following service levels:
Standard
Premium
Extreme
...
Learn about the US Data Boundary
control package
