---
title: "Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT \_|\_ Sovereign\
  \ Controls by Partners \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sovereign-controls-by-partners/docs/data-boundaries/ksa-data-boundary-cntxt-foundation
...
Guides
Send feedback
Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT
Stay organized with collections
Save and categorize content based on your preferences.
This page describes the set of controls that are applied on
Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT folders in Sovereign Controls by Partners. It
provides detailed information about supported Google Cloud products and their
API endpoints, as well as any applicable restrictions or limitations on those
products.
See the CNTXT site
Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT
for more information about this offering.
...
are enforced through organization policy constraint settings, are listed in the following table. If
a product is not listed, that product is unsupported and has not met the control requirements for
Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT. Unsupported products are not recommended for use without due diligence and
a thorough understanding of your responsibilities in the
...
Services that interact with Customer Data in their API operations provide
regional API endpoints . These
must be used instead of the service's global API endpoint in Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT. For services
whose API operations don't interact with Customer Data, using global API endpoints is allowed. See
the Assured Workloads
Data residency page for more information.
Unsupported products may share an API endpoint with supported products, making
...
The following sections describe cloud-wide or product-specific restrictions or
limitations for features, including any organization policy constraints that are
set by default on Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT folders.
Google Cloud-wide
Affected Google Cloud-wide features
Feature
Description
Google Cloud console
To access the Google Cloud console when using the Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT control package,
...
The following BigQuery integrations are not supported. It's your responsibility
not to use them with BigQuery for Sovereign Controls by Partners.
The CreateTag , SearchCatalog , Bulk tagging , and
Business Glossary API methods of the Data Catalog API process and store
technical data in a way that is not supported. It's your responsibility not to use those
methods for Sovereign Controls by Partners.
...
Tables
Table Data
The Reservations API is not enabled by default. You can enable the API
...
permissions to create Sovereign Controls by Partners folders can enable an unsupported API. If this
...
connectors for Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT workloads.
...
BigQuery doesn't prevent Sovereign Controls by Partners datasets from being queried from
...
You must use only regional load balancers with Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT. For more
...
Description
Query insights
When deploying a Cloud SQL instance, Query insights can only be used if application
tags are not enabled. If application tags are enabled, you will receive an error message
when attempting to use Query insights.
...
for Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT. The Jurisdictional console prevents uploading and downloading
...
Kingdom of Saudi Arabia Data Boundary Foundation by CNTXT workloads. HMAC keys affect data sovereignty because they can be
