---
title: "Class DomainsAsyncClient (1.13.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/domains/latest/google.cloud.domains_v1.services.domains.DomainsAsyncClient
...
Client libraries
Send feedback
Class DomainsAsyncClient (1.13.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the DomainsTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ConfigureContactSettingsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ConfigureDnsSettingsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ConfigureManagementSettingsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.DeleteRegistrationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ExportRegistrationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.GetRegistrationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ListRegistrationsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.RegisterDomainRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.ResetAuthorizationCodeRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.RetrieveAuthorizationCodeRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.RetrieveRegisterParametersRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.RetrieveTransferParametersRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.SearchDomainsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.TransferDomainRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.domains_v1.types.UpdateRegistrationRequest , dict]]
