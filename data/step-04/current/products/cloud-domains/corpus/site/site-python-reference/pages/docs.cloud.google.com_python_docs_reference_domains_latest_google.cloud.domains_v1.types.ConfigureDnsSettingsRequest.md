---
title: "Class ConfigureDnsSettingsRequest (1.13.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/domains/latest/google.cloud.domains_v1.types.ConfigureDnsSettingsRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/domains/latest/google.cloud.domains_v1.types.ConfigureDnsSettingsRequest
  title: "Class ConfigureDnsSettingsRequest (1.13.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class ConfigureDnsSettingsRequest (1.13.0)
