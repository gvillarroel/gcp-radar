---
title: "google-cloud-domains overview (1.85.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-domains/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-domains/latest/overview
  title: "google-cloud-domains overview (1.85.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
google-cloud-domains overview (1.85.0)
...
Cloud Domains Product Reference
GitHub Repository
Maven artifact
Getting Started
...
For this library, we recommend using com.google.cloud.domains.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Domains). New Version IDs are introduced infrequently, and often involve
