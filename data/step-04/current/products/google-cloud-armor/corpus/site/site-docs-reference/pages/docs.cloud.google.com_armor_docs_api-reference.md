...
url: https://docs.cloud.google.com/armor/docs/api-reference
...
Cloud Armor API reference
Find individual commands that can be used with Cloud Armor.
Cloud Armor custom rules language reference
Use this reference to write expressions in advanced match conditions
