...
url: https://docs.cloud.google.com/memorystore/docs/valkey/reference/mcp/tools_list/reschedule_maintenance
...
Tool: reschedule_maintenance
Reschedule maintenance for a Memorystore for Valkey instance.
The following sample demonstrate how to use curl to invoke the reschedule_maintenance MCP tool.
Curl Request
