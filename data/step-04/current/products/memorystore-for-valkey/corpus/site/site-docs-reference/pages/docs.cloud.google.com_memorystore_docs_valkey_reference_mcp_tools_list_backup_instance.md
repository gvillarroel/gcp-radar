...
url: https://docs.cloud.google.com/memorystore/docs/valkey/reference/mcp/tools_list/backup_instance
...
Tool: backup_instance
Back up a Memorystore for Valkey instance.
The following sample demonstrate how to use curl to invoke the backup_instance MCP tool.
Curl Request
...
"name" : string ,
"ttl" : string ,
// Union field _backup_id can be only one of the following:
"backupId" : string
// End of list of possible types for union field _backup_id .
}
Fields
name
string
...
_backup_id can be only one of the following:
backupId
string
