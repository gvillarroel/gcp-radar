---
title: "Monitor access using audit logs \_|\_ Memorystore for Valkey \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/valkey/audit-logging
...
Note: You must enable data access audit logs before you can view them for Memorystore for Valkey.
This document describes the audit logs created by Memorystore for Valkey as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Memorystore for Valkey:
...
type in Memorystore for Valkey:
Audit logs category
Memorystore for Valkey operations
Admin Activity
...
Service name
Memorystore for Valkey audit logs use the service name memorystore.googleapis.com .
...
Resource types
Memorystore for Valkey audit logs use the resource type audited_resource for all audit logs, because many different types of resources can be monitored.
