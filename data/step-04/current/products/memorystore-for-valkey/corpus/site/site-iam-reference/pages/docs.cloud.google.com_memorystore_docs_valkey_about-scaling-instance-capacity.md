---
title: "About scaling instance capacity \_|\_ Memorystore for Valkey \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/valkey/about-scaling-instance-capacity
...
Note: If you specify Cluster Mode Disabled
when you
create an instance , then Memorystore for Valkey doesn't partition
the instance, but hosts it on a single shard. Therefore, horizontal scaling
doesn't apply for the instance.
...
see Instance and node specification . To learn more about scaling a Memorystore for Valkey instance, see Scale instance capacity .
Impact of scaling
...
number, use the gcloud memorystore instances describe command.
...
the key. You can't update your instance. To resolve this, reduce the size of the
...
You increased the capacity of your instance by scaling out to a smaller shard
count. However, Memorystore for Valkey doesn't have enough memory to accommodate
this request. To resolve this, reduce the capacity of your instance by scaling
in to the original, larger shard count.
Best practices
