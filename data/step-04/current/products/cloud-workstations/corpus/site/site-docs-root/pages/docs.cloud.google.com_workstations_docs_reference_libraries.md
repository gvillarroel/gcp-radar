---
title: "Cloud Workstations client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/workstations/docs/reference/libraries
...
Reference
Send feedback
Cloud Workstations client libraries
Stay organized with collections
Save and categorize content based on your preferences.
This page shows how to get started with the Cloud Client Libraries for the
Cloud Workstations API. Client libraries make it easier to access
...
compile group: 'com.google.cloud', name: 'google-cloud-workstations', version: '0.75.0'
For more information, see Setting Up a Java Development Environment .
Node.js
npm install @google-cloud/workstations
For more information, see Setting Up a Node.js Development Environment .
Python
pip install --upgrade google-cloud-workstations
...
Issue tracker
google-cloud-workstations on Stack Overflow
Source code
Go
The following list contains links to more resources related to the
