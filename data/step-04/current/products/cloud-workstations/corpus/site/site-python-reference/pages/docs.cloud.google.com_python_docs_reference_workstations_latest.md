---
title: "Python Client for Cloud Workstations \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/workstations/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/workstations/latest
  title: "Python Client for Cloud Workstations \_|\_ Python client libraries \_|\_\
...
pip install google-cloud-workstations
Next Steps
Read the Client Library Documentation for Cloud Workstations
to see other available methods on the client.
Read the Cloud Workstations Product documentation to learn
