---
title: "Authenticate to the Cloud Workstations API \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/workstations/docs/authenticate-to-workstations-api
...
Guides
Send feedback
Authenticate to the Cloud Workstations API
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Cloud Workstations programmatically. How
you authenticate to Cloud Workstations depends on the interface you use to access the API
and the environment where your code is running.
If you're new to the Cloud Workstations API, make sure that
you read the following sections first:
Before you begin
...
API access
Cloud Workstations supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Cloud Workstations client libraries provide
high-level language support for authenticating to Cloud Workstations
programmatically.
...
For more information about using the gcloud CLI with Cloud Workstations,
see gcloud workstations .
REST
...
Set up authentication for Cloud Workstations
...
Cloud Workstations, as described in Before you begin .
...
Access control for Cloud Workstations
After you authenticate to Cloud Workstations, you must be authorized to access
Google Cloud resources. Cloud Workstations uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Cloud Workstations, see
Access control with IAM .
