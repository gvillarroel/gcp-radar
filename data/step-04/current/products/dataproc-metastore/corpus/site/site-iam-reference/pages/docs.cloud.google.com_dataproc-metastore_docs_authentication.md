---
title: "Authenticate to Dataproc Metastore \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dataproc-metastore/docs/authentication
...
Guides
Send feedback
Authenticate to Dataproc Metastore
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Dataproc Metastore programmatically. How
you authenticate to Dataproc Metastore depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Dataproc Metastore supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Dataproc Metastore client libraries provide
high-level language support for authenticating to Dataproc Metastore
programmatically.
...
For more information about using the gcloud CLI with Dataproc Metastore,
see gcloud metastore .
REST
You can authenticate to
the Dataproc Metastore API
...
Set up authentication for Dataproc Metastore
...
Access control for Dataproc Metastore
After you authenticate to Dataproc Metastore, you must be authorized to access
Google Cloud resources. Dataproc Metastore uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Dataproc Metastore, see
