---
title: "Python Client for Dataproc Metastore \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/metastore/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/metastore/latest
  title: "Python Client for Dataproc Metastore \_|\_ Python client libraries \_|\_\
...
pip install google-cloud-dataproc-metastore
Next Steps
Read the Client Library Documentation for Dataproc Metastore
to see other available methods on the client.
Read the Dataproc Metastore Product documentation to learn
