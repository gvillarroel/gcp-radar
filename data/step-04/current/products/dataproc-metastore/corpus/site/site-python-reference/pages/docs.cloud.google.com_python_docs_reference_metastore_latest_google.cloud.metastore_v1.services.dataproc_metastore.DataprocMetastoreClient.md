---
title: "Class DataprocMetastoreClient (1.22.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/metastore/latest/google.cloud.metastore_v1.services.dataproc_metastore.DataprocMetastoreClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/metastore/latest/google.cloud.metastore_v1.services.dataproc_metastore.DataprocMetastoreClient
  title: "Class DataprocMetastoreClient (1.22.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class DataprocMetastoreClient (1.22.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the DataprocMetastoreTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.metastore_v1.types.AlterMetadataResourceLocationRequest , dict]
...
Description
request
Union[ google.cloud.metastore_v1.types.MoveTableToDatabaseRequest , dict]
...
Description
request
Union[ google.cloud.metastore_v1.types.QueryMetadataRequest , dict]
