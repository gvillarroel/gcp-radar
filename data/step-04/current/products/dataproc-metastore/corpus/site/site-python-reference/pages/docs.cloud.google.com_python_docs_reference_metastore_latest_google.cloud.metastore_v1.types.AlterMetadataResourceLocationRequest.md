---
title: "Class AlterMetadataResourceLocationRequest (1.22.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/metastore/latest/google.cloud.metastore_v1.types.AlterMetadataResourceLocationRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/metastore/latest/google.cloud.metastore_v1.types.AlterMetadataResourceLocationRequest
  title: "Class AlterMetadataResourceLocationRequest (1.22.0) \_|\_ Python client\
...
Client libraries
Send feedback
Class AlterMetadataResourceLocationRequest (1.22.0)
