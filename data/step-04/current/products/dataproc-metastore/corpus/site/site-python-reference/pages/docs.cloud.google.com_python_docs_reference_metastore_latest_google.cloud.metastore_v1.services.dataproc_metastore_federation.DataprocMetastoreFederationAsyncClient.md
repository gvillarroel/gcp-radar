---
title: "Class DataprocMetastoreFederationAsyncClient (1.22.0) \_|\_ Python client\
  \ libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/metastore/latest/google.cloud.metastore_v1.services.dataproc_metastore_federation.DataprocMetastoreFederationAsyncClient
...
Client libraries
Send feedback
Class DataprocMetastoreFederationAsyncClient (1.22.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the DataprocMetastoreFederationTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.metastore_v1.types.CreateFederationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.metastore_v1.types.DeleteFederationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.metastore_v1.types.GetFederationRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.metastore_v1.types.ListFederationsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.metastore_v1.types.UpdateFederationRequest , dict]]
