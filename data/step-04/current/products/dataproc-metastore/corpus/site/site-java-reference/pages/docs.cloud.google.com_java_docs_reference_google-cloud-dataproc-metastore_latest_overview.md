---
title: "google-cloud-dataproc-metastore overview (2.89.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataproc-metastore/latest/overview
...
Client libraries
Send feedback
google-cloud-dataproc-metastore overview (2.89.0)
...
Dataproc Metastore Product Reference
GitHub Repository
Maven artifact
Getting Started
...
For this library, we recommend using com.google.cloud.metastore.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Dataproc Metastore). New Version IDs are introduced infrequently, and often involve
