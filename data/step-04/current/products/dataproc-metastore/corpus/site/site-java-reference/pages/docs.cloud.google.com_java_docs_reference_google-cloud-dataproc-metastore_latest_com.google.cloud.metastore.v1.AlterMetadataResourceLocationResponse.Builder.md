---
title: "Class AlterMetadataResourceLocationResponse.Builder (2.89.0) \_|\_ Java client\
  \ libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataproc-metastore/latest/com.google.cloud.metastore.v1.AlterMetadataResourceLocationResponse.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataproc-metastore/latest/com.google.cloud.metastore.v1.AlterMetadataResourceLocationResponse.Builder
  title: "Class AlterMetadataResourceLocationResponse.Builder (2.89.0) \_|\_ Java\
...
Client libraries
Send feedback
Class AlterMetadataResourceLocationResponse.Builder (2.89.0)
...
2.2.0
2.1.9
public static final class AlterMetadataResourceLocationResponse . Builder extends GeneratedMessage . Builder<AlterMetadataResourceLocationResponse . Builder > implements AlterMetadataResourceLocationResponseOrBuilder
...
Methods
build()
public AlterMetadataResourceLocationResponse build ()
Returns
Type
Description
AlterMetadataResourceLocationResponse
buildPartial()
public AlterMetadataResourceLocationResponse buildPartial ()
Returns
Type
Description
AlterMetadataResourceLocationResponse
clear()
public AlterMetadataResourceLocationResponse . Builder clear ()
Returns
Type
Description
AlterMetadataResourceLocationResponse.Builder
...
mergeFrom(AlterMetadataResourceLocationResponse other)
public AlterMetadataResourceLocationResponse . Builder mergeFrom ( AlterMetadataResourceLocationResponse other )
Parameter
Name
Description
other
...
public AlterMetadataResourceLocationResponse . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public AlterMetadataResourceLocationResponse . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
