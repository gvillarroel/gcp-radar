---
title: "Class AlterMetadataResourceLocationRequest (2.89.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataproc-metastore/latest/com.google.cloud.metastore.v1.AlterMetadataResourceLocationRequest
...
Client libraries
Send feedback
Class AlterMetadataResourceLocationRequest (2.89.0)
...
2.2.0
2.1.9
public final class AlterMetadataResourceLocationRequest extends GeneratedMessage implements AlterMetadataResourceLocationRequestOrBuilder
Request message for
...
Static Methods
getDefaultInstance()
public static AlterMetadataResourceLocationRequest getDefaultInstance ()
Returns
Type
Description
AlterMetadataResourceLocationRequest
...
Descriptor
newBuilder()
public static AlterMetadataResourceLocationRequest . Builder newBuilder ()
Returns
Type
Description
AlterMetadataResourceLocationRequest.Builder
newBuilder(AlterMetadataResourceLocationRequest prototype)
public static AlterMetadataResourceLocationRequest . Builder newBuilder ( AlterMetadataResourceLocationRequest prototype )
Parameter
Name
Description
prototype
...
public static AlterMetadataResourceLocationRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AlterMetadataResourceLocationRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static AlterMetadataResourceLocationRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static AlterMetadataResourceLocationRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AlterMetadataResourceLocationRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static AlterMetadataResourceLocationRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AlterMetadataResourceLocationRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static AlterMetadataResourceLocationRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AlterMetadataResourceLocationRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AlterMetadataResourceLocationRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AlterMetadataResourceLocationRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static AlterMetadataResourceLocationRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<AlterMetadataResourceLocationRequest> parser ()
Returns
Type
Description
Parser < AlterMetadataResourceLocationRequest >
Methods
equals(Object obj)
...
getParserForType()
public Parser<AlterMetadataResourceLocationRequest> getParserForType ()
Returns
Type
Description
Parser < AlterMetadataResourceLocationRequest >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public AlterMetadataResourceLocationRequest . Builder newBuilderForType ()
Returns
Type
Description
AlterMetadataResourceLocationRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected AlterMetadataResourceLocationRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public AlterMetadataResourceLocationRequest . Builder toBuilder ()
Returns
Type
Description
AlterMetadataResourceLocationRequest.Builder
