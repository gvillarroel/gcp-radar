---
title: "Class AutoscalingSettings (0.92.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.AutoscalingSettings
...
Client libraries
Send feedback
Class AutoscalingSettings (0.92.0)
...
0.8.0
0.5.0
public final class AutoscalingSettings extends GeneratedMessage implements AutoscalingSettingsOrBuilder
...
protected AutoscalingSettings . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
