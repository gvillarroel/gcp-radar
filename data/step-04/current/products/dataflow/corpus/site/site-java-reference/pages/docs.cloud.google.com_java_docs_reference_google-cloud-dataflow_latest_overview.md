---
title: "google-cloud-dataflow overview (0.92.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataflow/latest/overview
...
Client libraries
Send feedback
google-cloud-dataflow overview (0.92.0)
...
0.5.0
Key Reference Links
Dataflow Description: Is a managed service for executing a wide variety of data processing patterns.
Dataflow Product Reference
GitHub Repository
Maven artifact
Getting Started
...
The example below demonstrates how you would import the BOM and include the google-cloud-dataflow artifact.
...
For this library, we recommend using com.google.dataflow.v1beta3 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Dataflow). New Version IDs are introduced infrequently, and often involve
