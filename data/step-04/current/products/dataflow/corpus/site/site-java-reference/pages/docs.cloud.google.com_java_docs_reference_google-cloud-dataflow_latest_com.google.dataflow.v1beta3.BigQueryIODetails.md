---
title: "Class BigQueryIODetails (0.92.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.BigQueryIODetails
...
Client libraries
Send feedback
Class BigQueryIODetails (0.92.0)
...
0.8.0
0.5.0
public final class BigQueryIODetails extends GeneratedMessage implements BigQueryIODetailsOrBuilder
...
Static Methods
getDefaultInstance()
public static BigQueryIODetails getDefaultInstance ()
Returns
Type
Description
BigQueryIODetails
...
Descriptor
newBuilder()
public static BigQueryIODetails . Builder newBuilder ()
Returns
Type
Description
BigQueryIODetails.Builder
newBuilder(BigQueryIODetails prototype)
public static BigQueryIODetails . Builder newBuilder ( BigQueryIODetails prototype )
Parameter
Name
Description
prototype
...
public static BigQueryIODetails parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static BigQueryIODetails parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static BigQueryIODetails parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static BigQueryIODetails parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static BigQueryIODetails parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static BigQueryIODetails parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static BigQueryIODetails parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static BigQueryIODetails parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static BigQueryIODetails parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static BigQueryIODetails parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static BigQueryIODetails parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static BigQueryIODetails parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<BigQueryIODetails> parser ()
Returns
Type
Description
Parser < BigQueryIODetails >
Methods
equals(Object obj)
...
public BigQueryIODetails getDefaultInstanceForType ()
Returns
Type
Description
BigQueryIODetails
getParserForType()
public Parser<BigQueryIODetails> getParserForType ()
Returns
Type
Description
Parser < BigQueryIODetails >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public BigQueryIODetails . Builder newBuilderForType ()
Returns
Type
Description
BigQueryIODetails.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected BigQueryIODetails . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public BigQueryIODetails . Builder toBuilder ()
Returns
Type
Description
BigQueryIODetails.Builder
