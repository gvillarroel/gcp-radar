---
title: "Class CheckActiveJobsResponse.Builder (0.92.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.CheckActiveJobsResponse.Builder
...
Client libraries
Send feedback
Class CheckActiveJobsResponse.Builder (0.92.0)
...
0.8.0
0.5.0
public static final class CheckActiveJobsResponse . Builder extends GeneratedMessage . Builder<CheckActiveJobsResponse . Builder > implements CheckActiveJobsResponseOrBuilder
...
Methods
build()
public CheckActiveJobsResponse build ()
Returns
Type
Description
CheckActiveJobsResponse
buildPartial()
public CheckActiveJobsResponse buildPartial ()
Returns
Type
Description
CheckActiveJobsResponse
clear()
public CheckActiveJobsResponse . Builder clear ()
Returns
Type
Description
CheckActiveJobsResponse.Builder
...
clearActiveJobsExist()
public CheckActiveJobsResponse . Builder clearActiveJobsExist ()
...
mergeFrom(CheckActiveJobsResponse other)
public CheckActiveJobsResponse . Builder mergeFrom ( CheckActiveJobsResponse other )
Parameter
Name
Description
other
...
public CheckActiveJobsResponse . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public CheckActiveJobsResponse . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
setActiveJobsExist(boolean value)
public CheckActiveJobsResponse . Builder setActiveJobsExist ( boolean value )
If True, active jobs exists for project. False otherwise.
bool active_jobs_exist = 1;
Parameter
Name
Description
value
boolean The activeJobsExist to set.
Returns
Type
Description
CheckActiveJobsResponse.Builder
