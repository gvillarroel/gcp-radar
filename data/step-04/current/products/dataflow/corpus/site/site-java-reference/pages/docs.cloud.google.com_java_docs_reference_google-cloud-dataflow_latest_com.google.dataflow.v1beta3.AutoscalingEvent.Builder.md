---
title: "Class AutoscalingEvent.Builder (0.92.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataflow/latest/com.google.dataflow.v1beta3.AutoscalingEvent.Builder
...
Client libraries
Send feedback
Class AutoscalingEvent.Builder (0.92.0)
...
0.8.0
0.5.0
public static final class AutoscalingEvent . Builder extends GeneratedMessage . Builder<AutoscalingEvent . Builder > implements AutoscalingEventOrBuilder
...
public AutoscalingEvent . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public AutoscalingEvent . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public AutoscalingEvent . Builder mergeTime ( Timestamp value )
The time this event was emitted to indicate a new target or current
num_workers value.
.google.protobuf.Timestamp time = 5;
Parameter
...
Description
value
long The currentNumWorkers to set.
Returns
Type
Description
AutoscalingEvent.Builder
...
Description
value
AutoscalingEvent.AutoscalingEventType The eventType to set.
Returns
Type
Description
AutoscalingEvent.Builder
...
Description
value
long The targetNumWorkers to set.
Returns
Type
Description
AutoscalingEvent.Builder
...
public AutoscalingEvent . Builder setTime ( Timestamp value )
The time this event was emitted to indicate a new target or current
num_workers value.
.google.protobuf.Timestamp time = 5;
Parameter
...
public AutoscalingEvent . Builder setTime ( Timestamp . Builder builderForValue )
The time this event was emitted to indicate a new target or current
num_workers value.
.google.protobuf.Timestamp time = 5;
Parameter
...
public AutoscalingEvent . Builder setWorkerPoolBytes ( ByteString value )
A short and friendly name for the worker pool this event refers to.
string worker_pool = 7;
Parameter
Name
