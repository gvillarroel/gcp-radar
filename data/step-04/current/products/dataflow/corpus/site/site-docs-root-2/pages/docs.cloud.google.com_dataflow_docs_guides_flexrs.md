---
title: "Use Flexible Resource Scheduling in Cloud Dataflow \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dataflow/docs/guides/flexrs
...
Guides
Send feedback
Use Flexible Resource Scheduling in Cloud Dataflow
...
preemptible virtual machine (VM) instances
...
Google Cloud environment settings, such as
...
enough Google Cloud project resource quotas to launch
...
preemptible VM quota . You can explicitly request preemptible VM
quota ; otherwise, your FlexRS job
