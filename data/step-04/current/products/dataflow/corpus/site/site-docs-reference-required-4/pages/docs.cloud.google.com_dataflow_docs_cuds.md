---
title: "Committed use discounts \_|\_ Cloud Dataflow \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dataflow/docs/cuds
...
purchasing Compute Engine resource-based commitments
with specifically targeted reservations, and using these reservations
...
Snapshots
Confidential VMs
For a list of applicable SKUs, see Dataflow CUD Eligible SKUs .
...
From the pricing page , see the price in the column labeled 1-year commitment to calculate the approximate hourly commitment cost:
...
What's next
Read an overview of Dataflow pricing .
