---
title: "Class MetricsV1Beta3AsyncClient (0.13.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataflow/latest/google.cloud.dataflow_v1beta3.services.metrics_v1_beta3.MetricsV1Beta3AsyncClient
...
Client libraries
Send feedback
Class MetricsV1Beta3AsyncClient (0.13.0)
...
transport
Optional[Union[str,MetricsV1Beta3Transport,Callable[..., MetricsV1Beta3Transport]]]
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the MetricsV1Beta3Transport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.dataflow_v1beta3.types.GetJobExecutionDetailsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataflow_v1beta3.types.GetJobMetricsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataflow_v1beta3.types.GetStageExecutionDetailsRequest , dict]]
