---
title: "Class FlexTemplatesServiceAsyncClient (0.13.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataflow/latest/google.cloud.dataflow_v1beta3.services.flex_templates_service.FlexTemplatesServiceAsyncClient
...
Client libraries
Send feedback
Class FlexTemplatesServiceAsyncClient (0.13.0)
...
transport
Optional[Union[str,FlexTemplatesServiceTransport,Callable[..., FlexTemplatesServiceTransport]]]
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the FlexTemplatesServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.dataflow_v1beta3.types.LaunchFlexTemplateRequest , dict]]
