---
title: "Cloud Storage Text to BigQuery template \_|\_ Cloud Dataflow \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/dataflow/docs/guides/templates/provided/cloud-storage-to-bigquery
...
The Cloud Storage Text to BigQuery pipeline is a batch pipeline that
reads text files stored in Cloud Storage, transforms them using a JavaScript
...
the Text Files on Cloud Storage to BigQuery (Batch) template.
