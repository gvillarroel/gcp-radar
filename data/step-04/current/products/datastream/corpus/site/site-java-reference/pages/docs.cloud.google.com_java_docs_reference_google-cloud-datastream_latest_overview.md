---
title: "google-cloud-datastream overview (1.87.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/overview
  title: "google-cloud-datastream overview (1.87.0) \_|\_ Java client libraries \_\
...
Client libraries
Send feedback
google-cloud-datastream overview (1.87.0)
...
For this library, we recommend using com.google.cloud.datastream.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Datastream). New Version IDs are introduced infrequently, and often involve
