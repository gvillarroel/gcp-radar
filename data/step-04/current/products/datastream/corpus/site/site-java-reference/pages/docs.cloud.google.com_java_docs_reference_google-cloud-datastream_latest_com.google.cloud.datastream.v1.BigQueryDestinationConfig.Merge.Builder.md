---
title: "Class BigQueryDestinationConfig.Merge.Builder (1.87.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/com.google.cloud.datastream.v1.BigQueryDestinationConfig.Merge.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/com.google.cloud.datastream.v1.BigQueryDestinationConfig.Merge.Builder
  title: "Class BigQueryDestinationConfig.Merge.Builder (1.87.0) \_|\_ Java client\
...
Client libraries
Send feedback
Class BigQueryDestinationConfig.Merge.Builder (1.87.0)
...
1.0.0
0.4.2
public static final class BigQueryDestinationConfig . Merge . Builder extends GeneratedMessage . Builder<BigQueryDestinationConfig . Merge . Builder > implements BigQueryDestinationConfig . MergeOrBuilder
...
Methods
build()
public BigQueryDestinationConfig . Merge build ()
Returns
Type
Description
BigQueryDestinationConfig.Merge
buildPartial()
public BigQueryDestinationConfig . Merge buildPartial ()
Returns
Type
Description
BigQueryDestinationConfig.Merge
clear()
public BigQueryDestinationConfig . Merge . Builder clear ()
Returns
Type
Description
BigQueryDestinationConfig.Merge.Builder
...
mergeFrom(BigQueryDestinationConfig.Merge other)
public BigQueryDestinationConfig . Merge . Builder mergeFrom ( BigQueryDestinationConfig . Merge other )
Parameter
Name
Description
other
...
public BigQueryDestinationConfig . Merge . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public BigQueryDestinationConfig . Merge . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
