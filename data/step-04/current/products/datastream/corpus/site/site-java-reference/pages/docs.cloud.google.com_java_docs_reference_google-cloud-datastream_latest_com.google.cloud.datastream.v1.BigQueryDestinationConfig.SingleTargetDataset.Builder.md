---
title: "Class BigQueryDestinationConfig.SingleTargetDataset.Builder (1.87.0) \_|\_\
  \ Java client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/com.google.cloud.datastream.v1.BigQueryDestinationConfig.SingleTargetDataset.Builder
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datastream/latest/com.google.cloud.datastream.v1.BigQueryDestinationConfig.SingleTargetDataset.Builder
  title: "Class BigQueryDestinationConfig.SingleTargetDataset.Builder (1.87.0) \_\
...
Client libraries
Send feedback
Class BigQueryDestinationConfig.SingleTargetDataset.Builder (1.87.0)
...
1.0.0
0.4.2
public static final class BigQueryDestinationConfig . SingleTargetDataset . Builder extends GeneratedMessage . Builder<BigQueryDestinationConfig . SingleTargetDataset . Builder > implements BigQueryDestinationConfig . SingleTargetDatasetOrBuilder
...
Methods
build()
public BigQueryDestinationConfig . SingleTargetDataset build ()
Returns
Type
Description
BigQueryDestinationConfig.SingleTargetDataset
buildPartial()
public BigQueryDestinationConfig . SingleTargetDataset buildPartial ()
Returns
Type
Description
BigQueryDestinationConfig.SingleTargetDataset
clear()
public BigQueryDestinationConfig . SingleTargetDataset . Builder clear ()
Returns
Type
Description
BigQueryDestinationConfig.SingleTargetDataset.Builder
...
clearDatasetId()
public BigQueryDestinationConfig . SingleTargetDataset . Builder clearDatasetId ()
...
mergeFrom(BigQueryDestinationConfig.SingleTargetDataset other)
public BigQueryDestinationConfig . SingleTargetDataset . Builder mergeFrom ( BigQueryDestinationConfig . SingleTargetDataset other )
Parameter
Name
Description
other
...
public BigQueryDestinationConfig . SingleTargetDataset . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public BigQueryDestinationConfig . SingleTargetDataset . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public BigQueryDestinationConfig . SingleTargetDataset . Builder setDatasetId ( String value )
The dataset ID of the target dataset.
DatasetIds allowed characters:
https://cloud.google.com/bigquery/docs/reference/rest/v2/datasets#datasetreference .
string dataset_id = 1;
...
public BigQueryDestinationConfig . SingleTargetDataset . Builder setDatasetIdBytes ( ByteString value )
The dataset ID of the target dataset.
DatasetIds allowed characters:
https://cloud.google.com/bigquery/docs/reference/rest/v2/datasets#datasetreference .
string dataset_id = 1;
