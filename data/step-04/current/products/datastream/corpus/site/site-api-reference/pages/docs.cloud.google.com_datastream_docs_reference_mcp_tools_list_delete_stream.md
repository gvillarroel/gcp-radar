...
url: https://docs.cloud.google.com/datastream/docs/reference/mcp/tools_list/delete_stream
...
The following sample demonstrate how to use curl to invoke the delete_stream MCP tool.
Curl Request
