...
url: https://docs.cloud.google.com/datastream/docs/reference/mcp/tools_list/list_stream_objects
...
The following sample demonstrate how to use curl to invoke the list_stream_objects MCP tool.
Curl Request
...
pageToken
string
Optional. Page token received from a previous ListStreamObjectsRequest call. Provide this to retrieve the subsequent page.
