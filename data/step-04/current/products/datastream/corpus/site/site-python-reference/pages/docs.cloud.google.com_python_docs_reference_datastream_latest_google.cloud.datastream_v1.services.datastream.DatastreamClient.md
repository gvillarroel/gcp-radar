---
title: "Class DatastreamClient (1.18.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/datastream/latest/google.cloud.datastream_v1.services.datastream.DatastreamClient
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the DatastreamTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.datastream_v1.types.CreateConnectionProfileRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.CreatePrivateConnectionRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.CreateRouteRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.CreateStreamRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.DeleteConnectionProfileRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.DeletePrivateConnectionRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.DeleteRouteRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.DeleteStreamRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.DiscoverConnectionProfileRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.FetchStaticIpsRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.GetConnectionProfileRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.GetPrivateConnectionRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.GetRouteRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.GetStreamRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.GetStreamObjectRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.ListConnectionProfilesRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.ListPrivateConnectionsRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.ListRoutesRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.ListStreamObjectsRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.ListStreamsRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.LookupStreamObjectRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.RunStreamRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.StartBackfillJobRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.StopBackfillJobRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.UpdateConnectionProfileRequest , dict]
...
Description
request
Union[ google.cloud.datastream_v1.types.UpdateStreamRequest , dict]
