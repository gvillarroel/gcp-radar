---
title: "Observability and monitoring \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/docs/observability
...
and more.
Explore observability and monitoring in Google Cloud
...
Plan your approach with Architecture Center resources across a variety of monitoring and logging topics. open_in_new
account_tree
Hybrid and multicloud monitoring and logging patterns
Plan how to implmement monitoring and logging architectures for hybrid and multi-cloud deployments. open_in_new
...
View how to troubleshoot distributed applications by using Cloud Trace and Cloud Logging together. open_in_new
public
Explore log analytics: must-have tools for cloud security professionals
View how to access detailed logs of events and activities within your cloud environment. open_in_new
cloud
Effective alerting in Google Cloud
View how the relevance of what we are monitoring can help us support triage in advance. open_in_new
public
Google Cloud synthetic monitoring tutorial
View step by step instructions on how you can get started with Google Cloud synthetic monitoring. open_in_new
cloud
Gleaning security insights from Audit Logs with Log Analytics
View how Cloud Audit logs can help customers meet their compliance and security requirements. open_in_new
cloud
...
school
Observability in Google Cloud
Study how to use application performance management tools, including Error Reporting, Cloud Trace, and Cloud Profiler. open_in_new
school
DevOps engineer and SRE learning path
Study how to implement efficient and reliable software delivery and infrastructure management. open_in_new
...
Observability for Google Kubernetes Engine
...
View a post for migrating from BigQuery log sink to Observability Analytics.
cloud
