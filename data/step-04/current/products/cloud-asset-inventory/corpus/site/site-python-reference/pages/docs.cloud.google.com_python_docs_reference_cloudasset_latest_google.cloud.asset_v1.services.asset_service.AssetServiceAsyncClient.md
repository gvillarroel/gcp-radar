---
title: "Class AssetServiceAsyncClient (4.2.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudasset/latest/google.cloud.asset_v1.services.asset_service.AssetServiceAsyncClient
...
Client libraries
Send feedback
Class AssetServiceAsyncClient (4.2.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the AssetServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeIamPolicyRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeIamPolicyLongrunningRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeMoveRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeOrgPoliciesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeOrgPolicyGovernedAssetsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.AnalyzeOrgPolicyGovernedContainersRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.BatchGetAssetsHistoryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.BatchGetEffectiveIamPoliciesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.CreateFeedRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.CreateSavedQueryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.DeleteFeedRequest , dict]]
The request object.
name
str
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.DeleteSavedQueryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.ExportAssetsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.GetFeedRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.GetSavedQueryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.ListAssetsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.ListFeedsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.ListSavedQueriesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.QueryAssetsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.SearchAllIamPoliciesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.SearchAllResourcesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.UpdateFeedRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.asset_v1.types.UpdateSavedQueryRequest , dict]]
