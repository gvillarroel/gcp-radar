...
url: https://docs.cloud.google.com/python/docs/reference/cloudasset/latest
...
Enable the Cloud Asset Inventory.
...
pip install google-cloud-asset
Next Steps
Read the Client Library Documentation for Cloud Asset Inventory
to see other available methods on the client.
Read the Cloud Asset Inventory Product documentation to learn
