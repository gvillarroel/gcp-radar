---
title: "Deprecations and shut down features \_|\_ Cloud Asset Inventory \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/asset-inventory/docs/deprecations
...
defines the deprecation policy that applies to Cloud Asset Inventory.
...
Shutdown date
Details
Cloud Asset Inventory API v1p4beta1
May 17, 2021
May 17, 2022
On May 17, 2022, the Cloud Asset Inventory API version 1.4 Beta1 will be removed. We recommend upgrading to Cloud Asset Inventory API version 1.
Send feedback
