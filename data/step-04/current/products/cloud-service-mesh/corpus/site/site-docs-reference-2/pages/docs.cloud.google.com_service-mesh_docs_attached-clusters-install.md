...
url: https://docs.cloud.google.com/service-mesh/docs/attached-clusters-install
...
Run asmcli to do a new installation of Cloud Service Mesh 1.28.5-asm.12.
...
istio-1.28.5-asm.12 subdirectory in the --output_dir directory that you
...
Change to the istio-1.28.5-asm.12 directory.
...
Cloud Service Mesh version, for example: asm-1285-12
