...
url: https://docs.cloud.google.com/service-mesh/docs/enable-optional-features
...
Install-cni - gke.gcr.io/asm/install-cni:1.28.5-asm.12
Managed Data Plane - gke.gcr.io/asm/mdp:1.28.5-asm.12
Pilot - gke.gcr.io/asm/pilot:1.28.5-asm.12
Proxyv2 - gke.gcr.io/asm/proxyv2:1.28.5-asm.12
...
docker pull gke.gcr.io/asm/install-cni:1.28.5-asm.12
docker pull gke.gcr.io/asm/pilot:1.28.5-asm.12
docker pull gke.gcr.io/asm/proxyv2:1.28.5-asm.12
...
docker tag gke.gcr.io/asm/install-cni:1.28.5-asm.12 \
${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/install-cni:1.28.5-asm.12
docker tag gke.gcr.io/asm/mdp:1.28.5-asm.12 \
${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/pilot:1.28.5-asm.12
docker tag gke.gcr.io/asm/proxyv2:1.28.5-asm.12 \
${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/proxyv2:1.28.5-asm.12
Push the tagged images to your private registry:
docker push ${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/install-cni:1.28.5-asm.12
docker push ${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/pilot:1.28.5-asm.12
docker push ${PRIVATE_REGISTRY_URL}/gke.gcr.io/asm/proxyv2:1.28.5-asm.12
