---
title: "google-cloud-developerconnect overview (0.45.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-developerconnect/latest/overview
...
Client libraries
Send feedback
google-cloud-developerconnect overview (0.45.0)
...
0.1.0
Key Reference Links
Developer Connect API Description: Connect third-party source code management to Google
Developer Connect API Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Use the Developer Connect API for Java
...
The example below demonstrates how you would import the BOM and include the google-cloud-developerconnect artifact.
...
<dependency>
<groupId>com.google.cloud</groupId>
<artifactId>google-cloud-developerconnect</artifactId>
</dependency>
</dependencies>
Gradle
...
implementation ( "com.google.cloud:google-cloud-developerconnect" )
...
For this library, we recommend using com.google.cloud.developerconnect.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Developer Connect API). New Version IDs are introduced infrequently, and often involve
