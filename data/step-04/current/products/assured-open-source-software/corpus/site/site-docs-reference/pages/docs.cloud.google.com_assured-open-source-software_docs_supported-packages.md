...
title: "List of supported Java and Python packages for the Assured Open Source Software\
  \ free tier \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-open-source-software/docs/supported-packages
...
Guides
Send feedback
List of supported Java and Python packages for the Assured Open Source Software free tier
Stay organized with collections
Save and categorize content based on your preferences.
Last updated on June 11, 2024
The Assured Open Source Software free tier includes a total of 3,203 curated binaries,
including 1,527 Java, 1,622 Python, and 54 Go primary packages. For a list of
packages that are curated for the Assured Open Source Software premium tier, see List
of supported Java and Python packages for the Assured Open Source Software premium
tier .
For the list of supported Go packages, see List of supported Go packages for
the Assured Open Source Software free
tier .
...
The free tier of Assured Open Source Software supports the following Java packages:
asm:asm
at.favre.lib:bcrypt
...
Assured OSS .
The free tier of Assured Open Source Software supports the following Python packages:
APScheduler
Adafruit-Blinka
Adyen
Alarmageddon
