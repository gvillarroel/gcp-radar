---
title: "Download Assured OSS packages using a remote repository \_|\_ Assured Open\
  \ Source Software \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/assured-open-source-software/docs/remote-repository-access
...
Select the appropriate repository type (for example, select Maven for Java, PyPi for Python, or Go for Go).
