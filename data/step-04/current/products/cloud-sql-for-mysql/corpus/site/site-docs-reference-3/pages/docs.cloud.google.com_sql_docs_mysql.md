---
title: "Cloud SQL for MySQL documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/mysql
...
MySQL relational databases on Google Cloud.
For information specific to MySQL, see the
MySQL documentation or
learn more about Cloud SQL for MySQL .
