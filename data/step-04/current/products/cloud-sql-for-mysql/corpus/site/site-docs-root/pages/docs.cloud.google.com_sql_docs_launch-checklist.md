---
title: "Launch checklist for Cloud SQL \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/launch-checklist
...
the [release notes](/sql/docs/mysql/release-notes) by adding that
