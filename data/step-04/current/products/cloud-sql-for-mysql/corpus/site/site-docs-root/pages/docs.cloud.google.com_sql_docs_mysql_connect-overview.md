---
title: "Choose how to connect to Cloud SQL \_|\_ Cloud SQL for MySQL \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/sql/docs/mysql/connect-overview
...
you can use the mysql client or another available client.
Summary
Recommendation :
...
Learn about
connecting using a mysql client from a local machine or Compute Engine .
Learn about configuring IP connectivity .
Learn about
connecting with other MySQL tools .
Learn about
MySQL connectors .
