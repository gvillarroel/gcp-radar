---
title: "Export and import using CSV files \_|\_ Cloud SQL for MySQL \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/sql/docs/mysql/import-export/import-export-csv
...
source_metadata:
  url: https://docs.cloud.google.com/sql/docs/mysql/import-export/import-export-csv
  title: "Export and import using CSV files \_|\_ Cloud SQL for MySQL \_|\_ Google\
    \ Cloud Documentation"
...
Export data to a CSV file from Cloud SQL for MySQL
...
In the Database section, select the name of the database from the drop-down
menu.
...
If your select query specifies a database, it overrides the
databases property.
...
The preceding gcloud and API examples are equivalent to running
...
To export a MySQL table for import into Cloud SQL, we recommend that you
format the file using the following command:
...
You can
customize the format of your CSV export file.
Import data from a CSV file to Cloud SQL for MySQL
...
CREATE TABLE SQL statement in the mysql client.
Your CSV file must conform to the CSV
file format requirements .
If you are importing data that you exported from an on-premises MySQL
server:
...
If you do not need to retain the IAM permissions you
set previously, remove the permissions.
Customize the format of a CSV file for Cloud SQL for MySQL
