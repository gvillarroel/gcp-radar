---
title: "Send batch requests \_|\_ Admin console \_|\_ Google for Developers"
url: https://developers.google.com/workspace/admin/reports/v1/guides/batch
...
In this version of the API, only the transfer of a subscription uses the batch request. In addition, the batch Content-ID field is not populated in the API's batch request.
...
Note : The batch system for the Admin SDK API uses the same syntax as the OData batch processing system, but the semantics differ.
Batch details
