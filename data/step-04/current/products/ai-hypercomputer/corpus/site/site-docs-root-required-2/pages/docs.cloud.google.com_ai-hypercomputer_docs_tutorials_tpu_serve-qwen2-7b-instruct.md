---
title: "Serve Qwen2-7B-Instruct with vLLM on TPUs \_|\_ AI Hypercomputer \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/ai-hypercomputer/docs/tutorials/tpu/serve-qwen2-7b-instruct
...
This tutorial serves the Qwen/Qwen2-7B-Instruct model
...
Set up your environment
Create a Cloud TPU v6e VM using the queued resources API. For qwen2-7b-instruct,
