---
title: "Create AI-optimized instances in bulk with A4 or A3 Ultra \_|\_ AI Hypercomputer\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/ai-hypercomputer/docs/create/create-vms-in-bulk
...
Create AI-optimized instances in bulk with A4 or A3 Ultra | AI Hypercomputer | Google Cloud Documentation
...
use A4 or A3 Ultra machine types. To learn more about these
...
Deployment options overview .
Limitations
When you create A4 or A3 Ultra VMs in bulk, the following limitations apply:
A4 A3 Ultra
More
...
gcloud REST
More
To create A4 or A3 Ultra instances in bulk, use the
...
Replace the following:
NAME_PATTERN : the name pattern to use for the A4 or A3 Ultra instances.
For example, using
instance-# for the name pattern generates A4 or A3 Ultra instances with names
such as instance-1 and instance-2 , up to the number of
A4 or A3 Ultra instances specified by --count .
COUNT : the number of A4 or A3 Ultra instances to create.
MACHINE_TYPE : the machine type to use for the A4 or A3 Ultra instance.
...
( STOP ) or deletes ( DELETE ) the A4 or A3 Ultra instance at the
...
POLICY_NAME : the name of the compact placement policy.
Run the command.
To create A4 or A3 Ultra instances in bulk, make a POST request to the
...
Complete the following steps:
Replace the following:
PROJECT_ID : the project ID of the project where you want to create the A4 or A3 Ultra instance.
ZONE : specify a zone in which the machine type that you want to
use is available.
If you want to specify a compact placement policy, then
...
A4 or A3 Ultra instances specified by --count .
COUNT : the number of A4 or A3 Ultra instances to create.
MACHINE_TYPE : the machine type to use for the A4 or A3 Ultra
