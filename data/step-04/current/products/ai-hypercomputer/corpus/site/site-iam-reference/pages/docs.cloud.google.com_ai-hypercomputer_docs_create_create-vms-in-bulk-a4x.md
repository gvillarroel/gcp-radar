---
title: "Create AI-optimized instances in bulk with A4X \_|\_ AI Hypercomputer \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/ai-hypercomputer/docs/create/create-vms-in-bulk-a4x
...
source_metadata:
  url: https://docs.cloud.google.com/ai-hypercomputer/docs/create/create-vms-in-bulk-a4x
  title: "Create AI-optimized instances in bulk with A4X \_|\_ AI Hypercomputer \_\
    |\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Create AI-optimized instances in bulk with A4X | AI Hypercomputer | Google Cloud Documentation
...
use A4X machine types. To learn more about this accelerator-optimized machine
type, see A4X .
To learn about other ways to create VMs or clusters, see
Deployment options overview .
Limitations
When you create A4X VMs in bulk, the following limitations apply:
Caution: The
...
18 A4X instances. When you create the instances, apply the compact placement policy that specifies the gpuTopology
...
If a sub-block lacks capacity for all 18 A4X instances, then the bulk creation fails
and doesn't create any instance.
If your workload can operate with less than 18 A4X instances, then you can set the
minCount field
...
gcloud REST
More
To create A4X instances in bulk, use the
...
Replace the following:
NAME_PATTERN : the name pattern to use for the A4X instances.
For example, using
instance-# for the name pattern generates A4X instances with names
such as instance-1 and instance-2 , up to the number of
A4X instances specified by --count .
COUNT : the number of A4X instances to create.
...
( STOP ) or deletes ( DELETE ) the A4X instance at the
end of the reservation period.
POLICY_NAME : the name of the compact placement policy.
To create A4X instances in bulk, make a POST request to the
...
Replace the following:
PROJECT_ID : the project ID of the project where you want to create the A4X instance.
ZONE : specify a zone in which the machine type that you want to
use is available.
