---
title: "Terminology \_|\_ AI Hypercomputer \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/ai-hypercomputer/docs/terminology
...
Terminology | AI Hypercomputer | Google Cloud Documentation
...
AI Hypercomputer.
Block link
A collection of sub-blocks that are interconnected with non-blocking
fabric, which provides high-bandwidth connectivity between all hosts.
Cluster link
A collection of blocks interconnected by a high-speed network fabric. Each
cluster is globally unique. For A4X, A4, A3 Ultra, A3 Mega, and A3 High (8 GPUs) machines, a cluster provides a
