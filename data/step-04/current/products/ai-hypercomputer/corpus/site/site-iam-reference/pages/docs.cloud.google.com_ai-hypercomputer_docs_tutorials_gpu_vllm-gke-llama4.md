---
title: "Use vLLM on GKE to run inference with Llama 4 \_|\_ AI Hypercomputer \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/ai-hypercomputer/docs/tutorials/gpu/vllm-gke-llama4
...
source_metadata:
  url: https://docs.cloud.google.com/ai-hypercomputer/docs/tutorials/gpu/vllm-gke-llama4
  title: "Use vLLM on GKE to run inference with Llama 4 \_|\_ AI Hypercomputer \_\
    |\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Use vLLM on GKE to run inference with Llama 4 | AI Hypercomputer | Google Cloud Documentation
...
Was this helpful?
Send feedback
Use v LLM on GKE to run inference with Llama 4
...
Delete the resources
What's next
This tutorial shows you how to deploy and serve a Llama 4 Scout (17Bx16E), a
17B large language model (LLM), and serve it by using the vLLM framework. You
deploy this model on a single A4 virtual machine (VM) instance on Google Kubernetes Engine (GKE).
...
Deploy a vLLM container to your GKE cluster
To deploy the vLLM container to serve the Llama-4-Scout-17B-16E-Instruct model,
do the following:
...
Llama-4-Scout-17B-16E-Instruct model from Hugging Face. For this reason,
...
Delete the resources
To delete the deployment and service in the vllm-l4-17b.yaml file
