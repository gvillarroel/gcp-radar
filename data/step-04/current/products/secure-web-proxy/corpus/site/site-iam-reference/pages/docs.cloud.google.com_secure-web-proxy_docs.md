---
title: "Secure Web Proxy documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/secure-web-proxy/docs
...
Secure Web Proxy is a cloud first service that helps you secure egress web traffic (HTTP/S).
Go to the Secure Web Proxy product page for more.
