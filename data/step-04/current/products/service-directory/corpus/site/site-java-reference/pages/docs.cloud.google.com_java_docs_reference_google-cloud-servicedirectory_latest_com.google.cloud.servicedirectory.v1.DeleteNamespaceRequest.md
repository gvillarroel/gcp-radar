---
title: "Class DeleteNamespaceRequest (2.89.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-servicedirectory/latest/com.google.cloud.servicedirectory.v1.DeleteNamespaceRequest
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-servicedirectory/latest/com.google.cloud.servicedirectory.v1.DeleteNamespaceRequest
  title: "Class DeleteNamespaceRequest (2.89.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
Class DeleteNamespaceRequest (2.89.0)
...
2.4.5
2.2.7
public final class DeleteNamespaceRequest extends GeneratedMessage implements DeleteNamespaceRequestOrBuilder
...
Descriptor
newBuilder()
public static DeleteNamespaceRequest . Builder newBuilder ()
Returns
Type
Description
DeleteNamespaceRequest.Builder
newBuilder(DeleteNamespaceRequest prototype)
public static DeleteNamespaceRequest . Builder newBuilder ( DeleteNamespaceRequest prototype )
Parameter
Name
Description
prototype
...
public static DeleteNamespaceRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static DeleteNamespaceRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static DeleteNamespaceRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static DeleteNamespaceRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static DeleteNamespaceRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static DeleteNamespaceRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static DeleteNamespaceRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static DeleteNamespaceRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static DeleteNamespaceRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static DeleteNamespaceRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static DeleteNamespaceRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static DeleteNamespaceRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
GeneratedMessage.isInitialized()
newBuilderForType()
public DeleteNamespaceRequest . Builder newBuilderForType ()
Returns
Type
Description
DeleteNamespaceRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected DeleteNamespaceRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public DeleteNamespaceRequest . Builder toBuilder ()
Returns
Type
Description
DeleteNamespaceRequest.Builder
