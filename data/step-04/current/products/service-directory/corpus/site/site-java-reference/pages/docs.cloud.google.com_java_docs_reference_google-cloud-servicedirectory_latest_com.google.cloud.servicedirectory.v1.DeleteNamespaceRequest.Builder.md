---
title: "Class DeleteNamespaceRequest.Builder (2.89.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-servicedirectory/latest/com.google.cloud.servicedirectory.v1.DeleteNamespaceRequest.Builder
...
Client libraries
Send feedback
Class DeleteNamespaceRequest.Builder (2.89.0)
...
2.4.5
2.2.7
public static final class DeleteNamespaceRequest . Builder extends GeneratedMessage . Builder<DeleteNamespaceRequest . Builder > implements DeleteNamespaceRequestOrBuilder
...
clearName()
public DeleteNamespaceRequest . Builder clearName ()
...
mergeFrom(DeleteNamespaceRequest other)
public DeleteNamespaceRequest . Builder mergeFrom ( DeleteNamespaceRequest other )
Parameter
Name
Description
other
...
public DeleteNamespaceRequest . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public DeleteNamespaceRequest . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public DeleteNamespaceRequest . Builder setName ( String value )
Required. The name of the namespace to delete.
string name = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
Name
...
public DeleteNamespaceRequest . Builder setNameBytes ( ByteString value )
Required. The name of the namespace to delete.
string name = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }
Parameter
Name
