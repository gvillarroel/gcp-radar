---
title: "google-cloud-servicedirectory overview (2.89.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-servicedirectory/latest/overview
...
Client libraries
Send feedback
google-cloud-servicedirectory overview (2.89.0)
...
Service Directory Product Reference
GitHub Repository
Maven artifact
Getting Started
...
Version ID : The version of the Cloud service itself (e.g. Service Directory). New Version IDs are introduced infrequently, and often involve
