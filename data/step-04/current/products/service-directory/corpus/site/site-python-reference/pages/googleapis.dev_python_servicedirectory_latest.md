---
title: "Python Client for Service Directory \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://googleapis.dev/python/servicedirectory/latest
knowledge_key: corpus
source_id: site-python-reference
source_type: site
entrypoint: https://googleapis.dev/python/servicedirectory/latest
source_metadata:
  url: https://googleapis.dev/python/servicedirectory/latest
  title: "Python Client for Service Directory \_|\_ Python client libraries \_|\_\
...
0.2.0
0.1.1
Service Directory : Allows the registration and lookup of services.
...
pip install google-cloud-service-directory
Next Steps
Read the Client Library Documentation for Service Directory
to see other available methods on the client.
Read the Service Directory Product documentation to learn
