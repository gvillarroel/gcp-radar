---
title: "Authorize requests \_|\_ Resource Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/resource-manager/docs/authorizing
...
client secret.
Activate the Cloud Resource Manager API in the Google Cloud console. (If the API isn't listed in the Google Cloud console, then skip this step.)
