---
title: "Create projects \_|\_ Resource Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/resource-manager/docs/creating-managing-projects
...
to this role, see Manage tags on resources .
...
Create a tag key named environment .
Create tag values for the environment categories you use. The following values
...
Attach the appropriate tag to your project by
...
determine the badge.
Note: To see environment badges in the project picker , users must have the Tag
Viewer role ( roles/resourcemanager.tagViewer ) at the organization or folder
level.
...
New Project page. After you have reached your
...
soft-deleted count against your quota. These projects
...
From the resource selector, select the organization for which you want to
increase the project quota.
In the Filter option, select Metric and enter
cloudresourcemanager.googleapis.com/projects_count .
Select Cloud Resource Manager API , click more_vert More actions ,
and then select edit Edit quota .
In the Quota changes dialog, enter a new quota value and a description,
and then click Next .
...
Billing Reports support page.
What's next
Learn about viewing and updating projects .
Learn about deleting and restoring projects .
