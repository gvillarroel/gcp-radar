---
title: "Use custom organization policies \_|\_ Identity-Aware Proxy \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/iap/docs/custom-org-policies
...
source_metadata:
  url: https://docs.cloud.google.com/iap/docs/custom-org-policies
  title: "Use custom organization policies \_|\_ Identity-Aware Proxy \_|\_ Google\
    \ Cloud Documentation"
...
numbers, for example custom.denyUnownedDomains . This field can contain up to
...
or numbers, for example, custom.denyUnownedDomains . This field can contain up to 70
...
iap.googleapis.com/TunnelDestGroup . Most resource types support up to 20 custom
constraints. If you attempt to create more custom constraints, the operation fails.
...
"!resource.fqdns.all(value, value.endsWith(\".example-pet-store.com\"))" .
...
example, custom.denyUnownedDomains .
...
tunnel destination groups in a specific project only contain your company's domain .example-pet-store.com .
Before you begin, you must know the following:
Your organization ID
A project ID
Create the constraint
Save the following file as constraint-deny-unowned-domains.yaml :
...
This defines a constraint that rejects an operation to create or update a
tunnel destination group if the fully qualified domain name is not an
owned domain.
...
...
Create the policy
Save the following file as policy-deny-unowned-domains.yaml :
...
The following table lists the Identity-Aware Proxy resources that you can reference
