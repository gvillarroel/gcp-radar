---
title: "APIs and reference \_|\_ Memorystore for Memcached \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/memcached/apis
...
REST API reference
Reference documentation for the Memorystore for Memcached API.
Setting up client libraries
How to install and authenticate client libraries for the Memorystore for Memcached API.
Terraform reference
Visit the Terraform reference page for Memorystore for Memcached
Google Cloud CLI reference
Command reference for the Memorystore for Memcached Google Cloud CLI.
Send feedback
