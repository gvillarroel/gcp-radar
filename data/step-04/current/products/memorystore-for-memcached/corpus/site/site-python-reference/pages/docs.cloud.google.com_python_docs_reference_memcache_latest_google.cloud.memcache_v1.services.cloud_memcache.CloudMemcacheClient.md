---
title: "Class CloudMemcacheClient (1.15.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/memcache/latest/google.cloud.memcache_v1.services.cloud_memcache.CloudMemcacheClient
...
Client libraries
Send feedback
Class CloudMemcacheClient (1.15.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudMemcacheTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.memcache_v1.types.ApplyParametersRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.CreateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.DeleteInstanceRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.GetInstanceRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.ListInstancesRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.RescheduleMaintenanceRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.UpdateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.memcache_v1.types.UpdateParametersRequest , dict]
