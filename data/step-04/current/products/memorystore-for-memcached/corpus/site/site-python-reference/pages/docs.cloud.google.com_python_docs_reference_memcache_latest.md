---
title: "Python Client for Cloud Memorystore for Memcached \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/memcache/latest
...
0.2.0
0.1.0
Cloud Memorystore for Memcached : is a fully-managed in-memory data store service for Memcache.
...
Enable the Cloud Memorystore for Memcached.
...
pip install google-cloud-memcache
Next Steps
Read the Client Library Documentation for Cloud Memorystore for Memcached
to see other available methods on the client.
Read the Cloud Memorystore for Memcached Product documentation to learn
