---
title: "Package cloud_memcache (1.15.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/memcache/latest/google.cloud.memcache_v1.services.cloud_memcache
...
0.2.0
0.1.0
API documentation for memcache_v1.services.cloud_memcache package.
Classes
