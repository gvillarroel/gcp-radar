---
title: "Class CreateInstanceRequest (1.15.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/memcache/latest/google.cloud.memcache_v1.types.CreateInstanceRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/memcache/latest/google.cloud.memcache_v1.types.CreateInstanceRequest
  title: "Class CreateInstanceRequest (1.15.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class CreateInstanceRequest (1.15.0)
