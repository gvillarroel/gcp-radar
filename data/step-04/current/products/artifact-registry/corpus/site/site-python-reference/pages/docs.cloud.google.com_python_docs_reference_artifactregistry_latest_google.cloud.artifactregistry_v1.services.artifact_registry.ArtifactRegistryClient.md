---
title: "Class ArtifactRegistryClient (1.20.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/artifactregistry/latest/google.cloud.artifactregistry_v1.services.artifact_registry.ArtifactRegistryClient
...
Client libraries
Send feedback
Class ArtifactRegistryClient (1.20.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the ArtifactRegistryTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.BatchDeleteVersionsRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.CreateAttachmentRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.CreateRuleRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.DeleteAttachmentRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.DeleteFileRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.DeleteRuleRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ExportArtifactRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetAttachmentRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetMavenArtifactRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetNpmPackageRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetPythonPackageRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetRuleRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.GetVPCSCConfigRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ListAttachmentsRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ListMavenArtifactsRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ListNpmPackagesRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ListPythonPackagesRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.ListRulesRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.UpdateFileRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.UpdatePackageRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.UpdateRuleRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.UpdateVersionRequest , dict]
...
Description
request
Union[ google.cloud.artifactregistry_v1.types.UpdateVPCSCConfigRequest , dict]
