---
title: "Python Client for Cloud Recommender \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/recommender/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/recommender/latest
  title: "Python Client for Cloud Recommender \_|\_ Python client libraries \_|\_\
...
0.2.0
0.1.0
Cloud Recommender : delivers highly personalized product recommendations at scale.
...
pip install google-cloud-recommender
Next Steps
Read the Client Library Documentation for Cloud Recommender
to see other available methods on the client.
Read the Cloud Recommender Product documentation to learn
