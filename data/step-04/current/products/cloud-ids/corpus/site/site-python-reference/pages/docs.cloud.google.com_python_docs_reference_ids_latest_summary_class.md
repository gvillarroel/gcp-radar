---
title: "Package Classes (1.13.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/ids/latest/summary_class
...
Package Classes (1.13.0) | Python client libraries | Google Cloud Documentation
