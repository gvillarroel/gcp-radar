...
Class Endpoint (1.13.0) | Python client libraries | Google Cloud Documentation
...
severity
google. cloud. ids_ v1. types. Endpoint. Severity
Required. Lowest threat severity that this
endpoint will alert on.
state
google. cloud. ids_ v1. types. Endpoint. State
