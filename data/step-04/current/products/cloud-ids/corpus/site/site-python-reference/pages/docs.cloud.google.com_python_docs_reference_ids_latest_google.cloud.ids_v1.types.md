...
url: https://docs.cloud.google.com/python/docs/reference/ids/latest/google.cloud.ids_v1.types
...
Package types (1.13.0) | Python client libraries | Google Cloud Documentation
...
1.0.0
0.1.0
API documentation for ids_v1.types package.
Classes
Create Endpoint Request
Delete Endpoint Request
Endpoint
