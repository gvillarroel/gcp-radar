---
title: "Class LabelsEntry (1.13.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/ids/latest/google.cloud.ids_v1.types.Endpoint.LabelsEntry
...
Class LabelsEntry (1.13.0) | Python client libraries | Google Cloud Documentation
