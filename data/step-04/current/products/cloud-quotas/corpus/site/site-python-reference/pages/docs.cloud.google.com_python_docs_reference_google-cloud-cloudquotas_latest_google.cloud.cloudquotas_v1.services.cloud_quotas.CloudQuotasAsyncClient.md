---
title: "Class CloudQuotasAsyncClient (0.6.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/google-cloud-cloudquotas/latest/google.cloud.cloudquotas_v1.services.cloud_quotas.CloudQuotasAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/google-cloud-cloudquotas/latest/google.cloud.cloudquotas_v1.services.cloud_quotas.CloudQuotasAsyncClient
  title: "Class CloudQuotasAsyncClient (0.6.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class CloudQuotasAsyncClient (0.6.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudQuotasTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.CreateQuotaPreferenceRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.GetQuotaInfoRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.GetQuotaPreferenceRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.ListQuotaInfosRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.ListQuotaPreferencesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.cloudquotas_v1.types.UpdateQuotaPreferenceRequest , dict]]
