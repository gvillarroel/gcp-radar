---
title: "Implement common use cases \_|\_ Cloud Quotas \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/docs/quotas/implement-common-use-cases
...
for required fields and expected values.
...
can be granted.
To adjust the dimensions of your quota preference, you can
do the following:
If you want the quota preference to apply to all regions, remove the
region information.
If your quota is defined per zone, replace the region information with
zone information.
...
To adjust the dimensions of your quota preference, you can
do the following:
To create a QuotaPreference for NVIDIA_H100 GPUs
for all regions, remove the region map from the map of
dimensions.
To create a QuotaPreference for all GPU families in
the region us-central1 , remove the gpu_family map
from the map of dimensions.
