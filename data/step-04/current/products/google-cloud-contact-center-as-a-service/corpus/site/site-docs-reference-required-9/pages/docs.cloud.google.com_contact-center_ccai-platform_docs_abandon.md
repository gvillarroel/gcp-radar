---
title: "Customer abandoned details \_|\_ Google Cloud Contact Center as a Service\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/contact-center/ccai-platform/docs/abandon
...
Note: With the interaction-based data model, only the setting for
the time threshold will be respected since short abandoned calls don't
show in dashboard data.
