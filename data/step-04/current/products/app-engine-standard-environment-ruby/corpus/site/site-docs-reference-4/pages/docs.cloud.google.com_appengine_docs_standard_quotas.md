---
title: "Quotas and limits \_|\_ App Engine standard environment \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/appengine/docs/standard/quotas
...
app's pricing. Both the flexible environment and the standard environment share
...
Free app
Paid app
Maximum services per app
5
210
Maximum versions per app
15
210
...
You can view your instance count quota consumption in
the IAM Quotas page .
Description
Limit
Can be increased
Maximum number of frontend instances per project and region measured over a 1 minute period
Depends on selected region. This limit might be greater in high-capacity regions or lower in recently opened regions.
Yes
Maximum number of backend instances per project and region measured over a 1 minute period
Depends on selected region. This limit might be greater in high-capacity regions or lower in recently opened regions.
Yes
