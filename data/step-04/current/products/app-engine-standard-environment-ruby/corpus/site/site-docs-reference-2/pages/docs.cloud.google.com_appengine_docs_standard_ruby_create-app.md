---
title: "Quickstart: Create a Ruby app in the App Engine standard environment \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/appengine/docs/standard/ruby/create-app
knowledge_key: corpus
source_id: site-docs-reference-2
source_type: site
entrypoint: https://docs.cloud.google.com/appengine/docs/standard/ruby/create-app
source_metadata:
  url: https://docs.cloud.google.com/appengine/docs/standard/ruby/create-app
  title: "Quickstart: Create a Ruby app in the App Engine standard environment \_\
...
about region IDs .
OK
Note: If you are deploying a new Ruby web service to Google Cloud,
...
This quickstart shows you how to create a small App Engine app that
...
OK
This quickstart demonstrates a simple Ruby app
written with the
Sinatra
web framework that you can deploy to App Engine. Although this sample uses
Sinatra, you can use other frameworks such as
Ruby on Rails .
...
This example uses Bundler
to run the Hello World app on your local computer:
If you don't already have the programming language installed for your
runtime, download and install Ruby.
...
command from the standard-hello_world directory:
gcloud app deploy
Learn about the
optional flags .
...
Congratulations! You've deployed your first App Engine app to
