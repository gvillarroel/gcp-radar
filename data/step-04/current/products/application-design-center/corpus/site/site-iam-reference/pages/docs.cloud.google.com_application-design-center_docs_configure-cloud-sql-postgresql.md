---
title: "Configure a Cloud SQL (PostgreSQL) instance \_|\_ Application Design Center\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/application-design-center/docs/configure-cloud-sql-postgresql
...
Guides
Send feedback
Configure a Cloud SQL (PostgreSQL) instance
Stay organized with collections
Save and categorize content based on your preferences.
Cloud SQL (PostgreSQL) is a fully-managed database service that helps you set
...
using App Design Center to create a Cloud SQL (PostgreSQL)
...
Cloud SQL (PostgreSQL) instance, and the resulting updates to your
...
If your template includes a Cloud SQL (PostgreSQL) component, you must
