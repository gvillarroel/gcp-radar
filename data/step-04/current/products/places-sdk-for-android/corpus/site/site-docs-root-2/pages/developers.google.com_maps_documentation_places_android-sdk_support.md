---
title: "Support Options for Places SDK for Android \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/places/android-sdk/support
...
Resources
Send feedback
Support Options for Places SDK for Android
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Get help with technical questions by searching or posting on Stack Overflow using the google-places-api+android and google-maps tags.
Report bugs and request features through the Google issue tracker, providing detailed information and searching for existing issues beforehand.
Utilize Google Maps Platform Support, including Enhanced Support for faster response times and additional services, by contacting sales or creating support cases in the Cloud Console.
Understand support response times and options like case escalation, video conferencing, incident reports, and data quality assistance for Enhanced Support users.
For data privacy inquiries, utilize the Data Privacy Inquiry Form instead of the standard support channels.
Get help
...
Stack Overflow
to field technical questions about the Places SDK for Android. Stack Overflow is a
...
and Google Places related tags on Stack Overflow. You can look for Places SDK for Android-specific
topics by adding
google-places-api+android . You can look for Google Maps Platform APIs topics
by adding
...
issue tracker .
Bugs
If you think the cause of a problem is a bug in the Places SDK for Android, report it on
