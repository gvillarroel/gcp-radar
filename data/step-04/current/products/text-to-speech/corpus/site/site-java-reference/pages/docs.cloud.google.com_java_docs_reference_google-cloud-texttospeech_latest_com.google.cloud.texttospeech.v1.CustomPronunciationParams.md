---
title: "Class CustomPronunciationParams (2.89.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-texttospeech/latest/com.google.cloud.texttospeech.v1.CustomPronunciationParams
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-texttospeech/latest/com.google.cloud.texttospeech.v1.CustomPronunciationParams
  title: "Class CustomPronunciationParams (2.89.0) \_|\_ Java client libraries \_\
...
Client libraries
Send feedback
Class CustomPronunciationParams (2.89.0)
...
2.2.1
2.1.5
public final class CustomPronunciationParams extends GeneratedMessage implements CustomPronunciationParamsOrBuilder
Pronunciation customization for a phrase.
Protobuf type google.cloud.texttospeech.v1.CustomPronunciationParams
Inheritance
Object >
...
Static Fields
PHONETIC_ENCODING_FIELD_NUMBER
public static final int PHONETIC_ENCODING_FIELD_NUMBER
Field Value
Type
Description
int
...
Description
int
PRONUNCIATION_FIELD_NUMBER
public static final int PRONUNCIATION_FIELD_NUMBER
Field Value
Type
Description
int
Static Methods
getDefaultInstance()
public static CustomPronunciationParams getDefaultInstance ()
Returns
Type
Description
CustomPronunciationParams
...
Descriptor
newBuilder()
public static CustomPronunciationParams . Builder newBuilder ()
Returns
Type
Description
CustomPronunciationParams.Builder
newBuilder(CustomPronunciationParams prototype)
public static CustomPronunciationParams . Builder newBuilder ( CustomPronunciationParams prototype )
Parameter
Name
Description
prototype
...
public static CustomPronunciationParams parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciationParams parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CustomPronunciationParams parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CustomPronunciationParams parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CustomPronunciationParams parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CustomPronunciationParams parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CustomPronunciationParams parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciationParams parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CustomPronunciationParams parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciationParams parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CustomPronunciationParams parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CustomPronunciationParams parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CustomPronunciationParams> parser ()
Returns
Type
Description
Parser < CustomPronunciationParams >
Methods
equals(Object obj)
...
public CustomPronunciationParams getDefaultInstanceForType ()
Returns
Type
Description
CustomPronunciationParams
getParserForType()
public Parser<CustomPronunciationParams> getParserForType ()
Returns
Type
Description
Parser < CustomPronunciationParams >
...
GeneratedMessage.getParserForType()
getPhoneticEncoding()
public CustomPronunciationParams . PhoneticEncoding getPhoneticEncoding ()
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CustomPronunciationParams . Builder newBuilderForType ()
Returns
Type
Description
CustomPronunciationParams.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CustomPronunciationParams . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CustomPronunciationParams . Builder toBuilder ()
Returns
Type
Description
CustomPronunciationParams.Builder
