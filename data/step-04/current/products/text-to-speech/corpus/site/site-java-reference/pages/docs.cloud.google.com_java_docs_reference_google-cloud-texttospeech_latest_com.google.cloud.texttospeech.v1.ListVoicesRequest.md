---
title: "Class ListVoicesRequest (2.89.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-texttospeech/latest/com.google.cloud.texttospeech.v1.ListVoicesRequest
...
Client libraries
Send feedback
Class ListVoicesRequest (2.89.0)
...
2.2.1
2.1.5
public final class ListVoicesRequest extends GeneratedMessage implements ListVoicesRequestOrBuilder
...
Descriptor
newBuilder()
public static ListVoicesRequest . Builder newBuilder ()
Returns
Type
Description
ListVoicesRequest.Builder
newBuilder(ListVoicesRequest prototype)
public static ListVoicesRequest . Builder newBuilder ( ListVoicesRequest prototype )
Parameter
Name
Description
prototype
...
public static ListVoicesRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static ListVoicesRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static ListVoicesRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static ListVoicesRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static ListVoicesRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static ListVoicesRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static ListVoicesRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static ListVoicesRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static ListVoicesRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static ListVoicesRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static ListVoicesRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static ListVoicesRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
GeneratedMessage.isInitialized()
newBuilderForType()
public ListVoicesRequest . Builder newBuilderForType ()
Returns
Type
Description
ListVoicesRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected ListVoicesRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public ListVoicesRequest . Builder toBuilder ()
Returns
Type
Description
ListVoicesRequest.Builder
