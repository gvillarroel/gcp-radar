---
title: "Class CustomPronunciations (2.89.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-texttospeech/latest/com.google.cloud.texttospeech.v1.CustomPronunciations
...
Client libraries
Send feedback
Class CustomPronunciations (2.89.0)
...
2.2.1
2.1.5
public final class CustomPronunciations extends GeneratedMessage implements CustomPronunciationsOrBuilder
...
Static Fields
PRONUNCIATIONS_FIELD_NUMBER
public static final int PRONUNCIATIONS_FIELD_NUMBER
Field Value
Type
Description
int
Static Methods
getDefaultInstance()
public static CustomPronunciations getDefaultInstance ()
Returns
Type
Description
CustomPronunciations
...
Descriptor
newBuilder()
public static CustomPronunciations . Builder newBuilder ()
Returns
Type
Description
CustomPronunciations.Builder
newBuilder(CustomPronunciations prototype)
public static CustomPronunciations . Builder newBuilder ( CustomPronunciations prototype )
Parameter
Name
Description
prototype
...
public static CustomPronunciations parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciations parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static CustomPronunciations parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static CustomPronunciations parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CustomPronunciations parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static CustomPronunciations parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static CustomPronunciations parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciations parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CustomPronunciations parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static CustomPronunciations parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static CustomPronunciations parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static CustomPronunciations parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<CustomPronunciations> parser ()
Returns
Type
Description
Parser < CustomPronunciations >
Methods
equals(Object obj)
...
CustomPronunciations
getParserForType()
public Parser<CustomPronunciations> getParserForType ()
Returns
Type
Description
Parser < CustomPronunciations >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public CustomPronunciations . Builder newBuilderForType ()
Returns
Type
Description
CustomPronunciations.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected CustomPronunciations . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public CustomPronunciations . Builder toBuilder ()
Returns
Type
Description
CustomPronunciations.Builder
