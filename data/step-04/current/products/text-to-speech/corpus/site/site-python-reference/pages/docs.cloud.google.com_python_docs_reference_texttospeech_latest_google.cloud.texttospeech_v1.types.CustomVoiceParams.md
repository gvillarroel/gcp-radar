---
title: "Class CustomVoiceParams (2.36.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/texttospeech/latest/google.cloud.texttospeech_v1.types.CustomVoiceParams
...
Client libraries
Send feedback
Class CustomVoiceParams (2.36.0)
