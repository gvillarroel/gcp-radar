---
title: "Class TextToSpeechLongAudioSynthesizeClient (2.36.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/texttospeech/latest/google.cloud.texttospeech_v1.services.text_to_speech_long_audio_synthesize.TextToSpeechLongAudioSynthesizeClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/texttospeech/latest/google.cloud.texttospeech_v1.services.text_to_speech_long_audio_synthesize.TextToSpeechLongAudioSynthesizeClient
  title: "Class TextToSpeechLongAudioSynthesizeClient (2.36.0) \_|\_ Python client\
...
Client libraries
Send feedback
Class TextToSpeechLongAudioSynthesizeClient (2.36.0)
...
transport
Optional[Union[str,TextToSpeechLongAudioSynthesizeTransport,Callable[..., TextToSpeechLongAudioSynthesizeTransport]]]
...
Description
request
Union[ google.cloud.texttospeech_v1.types.SynthesizeLongAudioRequest , dict]
The request object. The top-level message sent by the client for the SynthesizeLongAudio method.
retry
google.api_core.retry.Retry
Designation of what errors, if any, should be retried.
timeout
...
Description
google.api_core.operation.Operation
An object representing a long-running operation. The result type for the operation will be SynthesizeLongAudioResponse The message returned to the client by the SynthesizeLongAudio method.
Send feedback
