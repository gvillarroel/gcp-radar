---
title: "Cloud Text-to-Speech documentation \_|\_ Google Cloud Documentation"
...
Cloud Text-to-Speech converts text or Speech Synthesis Markup Language (SSML)
input into audio data of natural human speech.
Go to the Cloud Text-to-Speech product page for more.
