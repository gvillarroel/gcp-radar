---
title: "Authenticate to Cloud TTS \_|\_ Cloud Text-to-Speech \_|\_ Google Cloud Documentation"
...
source_metadata:
  url: https://docs.cloud.google.com/text-to-speech/docs/authentication
  title: "Authenticate to Cloud TTS \_|\_ Cloud Text-to-Speech \_|\_ Google Cloud\
    \ Documentation"
...
This document describes how to authenticate to Cloud Text-to-Speech programmatically. How
you authenticate to Cloud Text-to-Speech depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Cloud TTS supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Cloud TTS client libraries provide
high-level language support for authenticating to Cloud TTS
programmatically.
...
User credentials and ADC for Cloud TTS
...
authenticate to Cloud TTS. For more information about this error and how
to address it, see
User credentials not working .
Set up authentication for Cloud TTS
