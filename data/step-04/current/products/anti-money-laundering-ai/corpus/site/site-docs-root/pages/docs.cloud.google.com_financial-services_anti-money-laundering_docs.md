---
title: "Anti Money Laundering AI documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/financial-services/anti-money-laundering/docs
...
Anti Money Laundering AI documentation | Google Cloud Documentation
...
Anti Money Laundering AI
Was this helpful?
Anti Money Laundering AI documentation
Read product documentation
Google Cloud's Anti Money Laundering AI (AML AI) product is an API that scores AML risk. Use it
to identify more risk, more defensibly, with fewer false positives and reduced time per review.
The AML AI product video
describes how our risk scoring method surpasses other rule-based solutions to provide superior
protection.
Go to the Anti Money Laundering AI product page for more.
