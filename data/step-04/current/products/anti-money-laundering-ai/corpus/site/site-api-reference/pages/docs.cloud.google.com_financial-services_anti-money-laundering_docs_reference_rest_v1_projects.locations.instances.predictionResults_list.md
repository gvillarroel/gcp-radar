---
title: "Method: projects.locations.instances.predictionResults.list \_|\_ Anti Money\
  \ Laundering AI \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/financial-services/anti-money-laundering/docs/reference/rest/v1/projects.locations.instances.predictionResults/list
...
Method: projects.locations.instances.predictionResults.list | Anti Money Laundering AI | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: projects. locations. instances. prediction Results. list
...
HTTP request
GET https://financialservices.googleapis.com/v1/{parent=projects/*/locations/*/instances/*}/predictionResults
...
page Token
string
In case of paginated results, this is the token that was returned in the previous ListPredictionResultsResponse. It should be copied here to retrieve the next page of resources. Empty will give the first page of ListPredictionResultsRequest, and the last page will return an empty pageToken.
filter
string
