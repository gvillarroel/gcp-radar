...
AML input data model | Anti Money Laundering AI | Google Cloud Documentation
...
SDK, languages, frameworks, and tools
On this page
Data model requirements Table-level requirements
Field-level requirements
Understanding how data changes over time Mutable entities
Immutable entities (including events)
Joinability
Sensitive fields
Data validation
Core banking data tables Party
AccountPartyLink
Transaction
InteractionEvent
Risk investigation data tables RiskCaseEvent
Supplementary data tables PartySupplementaryData
...
on an account.
The validity_ start_ time field
