---
title: "Transcribe speech to text by using the command line \_|\_ Cloud Speech-to-Text\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/speech-to-text/docs/quickstarts/transcribe-api
...
/full/path/to/audio/file.wav with the path to the audio
...
Use curl to make a recognize request:
curl -X POST -H "Content-Type: application/json; charset=utf-8" \
-H "Authorization: Bearer $( gcloud auth print-access-token ) " \
-d @/tmp/data.txt \
https://speech.googleapis.com/v2/projects/ PROJECT_ID /locations/global/recognizers/_:recognize Note: To pass a filename to curl , you use the -d option (for "data") and
precede the filename with an @ sign.
