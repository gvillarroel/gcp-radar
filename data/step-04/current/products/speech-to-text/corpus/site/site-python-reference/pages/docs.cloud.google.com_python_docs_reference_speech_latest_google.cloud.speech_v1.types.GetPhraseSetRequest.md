---
title: "Class GetPhraseSetRequest (2.38.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/speech/latest/google.cloud.speech_v1.types.GetPhraseSetRequest
...
Client libraries
Send feedback
Class GetPhraseSetRequest (2.38.0)
