---
title: "Python Client for Cloud Speech \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/speech/latest
...
pip install google-cloud-speech
Next Steps
Read the Client Library Documentation for Cloud Speech
to see other available methods on the client.
Read the Cloud Speech Product documentation to learn
