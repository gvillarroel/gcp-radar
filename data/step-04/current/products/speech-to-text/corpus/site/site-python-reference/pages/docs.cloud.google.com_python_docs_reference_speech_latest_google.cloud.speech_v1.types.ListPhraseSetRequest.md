---
title: "Class ListPhraseSetRequest (2.38.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/speech/latest/google.cloud.speech_v1.types.ListPhraseSetRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/speech/latest/google.cloud.speech_v1.types.ListPhraseSetRequest
  title: "Class ListPhraseSetRequest (2.38.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class ListPhraseSetRequest (2.38.0)
...
1.2.0
1.1.0
ListPhraseSetRequest ( mapping = None , * , ignore_unknown_fields = False , ** kwargs )
