---
title: "Class SpeechAsyncClient (2.38.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/speech/latest/google.cloud.speech_v1.services.speech.SpeechAsyncClient
...
Client libraries
Send feedback
Class SpeechAsyncClient (2.38.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the SpeechTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.speech_v1.types.LongRunningRecognizeRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.speech_v1.types.RecognizeRequest , dict]]
...
Description
requests
AsyncIterator[ google.cloud.speech_v1.types.StreamingRecognizeRequest ]
