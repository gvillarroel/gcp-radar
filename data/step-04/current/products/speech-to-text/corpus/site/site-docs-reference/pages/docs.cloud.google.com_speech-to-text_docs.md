---
title: "Cloud Speech-to-Text documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/speech-to-text/docs
knowledge_key: corpus
source_id: site-docs-reference
source_type: site
entrypoint: https://docs.cloud.google.com/speech-to-text/docs/reference
source_metadata:
  url: https://docs.cloud.google.com/speech-to-text/docs
  title: "Cloud Speech-to-Text documentation \_|\_ Google Cloud Documentation"
...
Cloud Speech-to-Text enables easy integration of Google speech recognition
technologies into developer applications. Send audio and receive a text transcription
from the Cloud Speech-to-Text API service. Learn more
...
Guides
Quickstart: Use client libraries
