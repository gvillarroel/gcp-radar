---
title: "Answer generation model versions and lifecycle for the Answer API (Legacy)\
  \ \_|\_ Gemini Enterprise \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/enterprise/docs/answer-generation-models
...
Send feedback
Answer generation model versions and lifecycle for the Answer API (Legacy)
Stay organized with collections
Save and categorize content based on your preferences.
Important: Gemini Enterprise retrieves search results from the assistant using
StreamAssist. We recommend using the StreamAssist instead of the Search and Answer.
For more information, see
Get search results using StreamAssist .
Gemini Enterprise offers multiple model versions for you to choose when
generating answers. You can choose the model versions when using search
summaries and answers and
follow-ups .
Available models
Gemini Enterprise uses two types of models for question and answering
use cases:
Vertex AI LLM models that have been tested on question and
answering tasks
Gemini Enterprise models that are based on Vertex AI LLM
models and further trained to address question and answering tasks
Gemini Enterprise models share the same discontinuation date as their
