---
title: "Gemini Enterprise client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/enterprise/docs/libraries
...
Gemini Enterprise API. Client libraries make it easier to access
...
Important: Gemini Enterprise uses the Discovery Engine API and client libraries.
...
Issue tracker
Gemini Enterprise on Stack Overflow
Source code
Java
The following list contains links to more resources related to the
