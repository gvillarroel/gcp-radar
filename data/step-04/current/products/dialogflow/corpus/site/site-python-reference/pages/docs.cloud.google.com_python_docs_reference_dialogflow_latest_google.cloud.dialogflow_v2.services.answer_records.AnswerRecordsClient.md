---
title: "Class AnswerRecordsClient (2.47.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dialogflow/latest/google.cloud.dialogflow_v2.services.answer_records.AnswerRecordsClient
...
Client libraries
Send feedback
Class AnswerRecordsClient (2.47.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the AnswerRecordsTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.dialogflow_v2.types.ListAnswerRecordsRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.UpdateAnswerRecordRequest , dict]
