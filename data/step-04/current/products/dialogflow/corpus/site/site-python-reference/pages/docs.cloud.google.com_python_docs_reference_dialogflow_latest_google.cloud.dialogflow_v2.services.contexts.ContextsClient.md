---
title: "Class ContextsClient (2.47.0) \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dialogflow/latest/google.cloud.dialogflow_v2.services.contexts.ContextsClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/dialogflow/latest/google.cloud.dialogflow_v2.services.contexts.ContextsClient
  title: "Class ContextsClient (2.47.0) \_|\_ Python client libraries \_|\_ Google\
    \ Cloud Documentation"
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the ContextsTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.dialogflow_v2.types.CreateContextRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.DeleteAllContextsRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.DeleteContextRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.GetContextRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.ListContextsRequest , dict]
...
Description
request
Union[ google.cloud.dialogflow_v2.types.UpdateContextRequest , dict]
