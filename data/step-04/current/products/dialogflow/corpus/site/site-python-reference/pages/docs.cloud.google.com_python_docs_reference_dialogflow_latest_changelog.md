...
url: https://docs.cloud.google.com/python/docs/reference/dialogflow/latest/changelog
...
2.46.0 (2026-02-12)
Features
added a new field StreamingAnalyzeContentRequest.output_multiple_utterances ( a6b40b3154a526d35267abafde4c64aa86bcc27c )
2.45.0 (2026-01-08)
Features
updated v2beta1 dialogflow client libraries ( 17cc12897e6afdf3f3131531c50a8226a3f57c0f )
updated v2 dialogflow client libraries ( 17cc12897e6afdf3f3131531c50a8226a3f57c0f )
...
2.44.0 (2025-12-04)
Documentation
Add further clarification for when the event Type CONVERSATION_FINISHED is fired ( 03e69912a61695deefca6ffaae1add8119f026e4 )
Update evaluator version from output only to optional. ( 03e69912a61695deefca6ffaae1add8119f026e4 )
Features
add agentDesktopSource field to the Participant object ( 03e69912a61695deefca6ffaae1add8119f026e4 )
2.43.0 (2025-10-28)
Documentation
minor formatting ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Updated comments for the SuggestionInput message, documenting how it is used with tools ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
update documentation for transcription language code configuration ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Features
Improved generator quota management ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Added tool support for AI Coach feature ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Expose debug info field in ConversationProfile ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Expose skip_empty_event_based_suggestion in ConversationProfile ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Added support for Build Your Own Assist feature ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Added support for AI Coach feature ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Context references added to conversation for dynamic data ingestion ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
A new field ‘security_settings’ is added to GenerateStatelessSuggestionRequest ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Added Vertex extension tool support to v2/v2beta1 ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
add a turn complete signal to BidiStreamingAnalyzeContent ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
Expose flexible safety filter change, rai_settings in ConversationProfile ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
add Agent Assist Generator Evaluation feature ( c3c2fbbacf03dcaf015bbfb949f95d46d9e669cb )
2.42.0 (2025-10-16)
Features
...
2.35.0 (2024-11-11)
Features
add options of query_source, search_config and context_size ( https://github.com/googleapis/google-cloud-python/pull/13242 ) ( e03cab6 )
add SipTrunks service ( https://github.com/googleapis/google-cloud-python/pull/13242 ) ( e03cab6 )
added support for ALAW encoding ( https://github.com/googleapis/google-cloud-python/pull/13242 ) ( e03cab6 )
Bug Fixes
disable universe-domain validation ( #13238 ) ( cb14bda )
...
Documentation
Minor formatting ( de86202 )
2.23.3 (2023-08-03)
Documentation
Minor formatting ( #658 ) ( 4a2c65c )
Minor formatting ( #664 ) ( 466e6dd )
2.23.2 (2023-07-10)
Documentation
...
2.18.0 (2023-01-10)
Features
Add support for python 3.11 ( #604 ) ( 08a6580 )
2.17.0 (2022-12-15)
Features
...
2.16.1 (2022-10-10)
Bug Fixes
deps: Allow protobuf 3.19.5 ( #585 ) ( 4030787 )
Documentation
...
Bug Fixes
deps: Require protobuf >= 3.20.2 ( #579 ) ( 2159259 )
Documentation
...
2.14.1 (2022-06-03)
Bug Fixes
deps: require protobuf <4.0.0dev ( #523 ) ( d444383 )
Documentation
...
2.12.0 (2022-02-11)
Features
add api key support ( #468 ) ( 0d6bebd )
v2: add conversation process config ( #464 ) ( 921861a )
v2: add ImportDocument ( 921861a )
v2: add SuggestSmartReplies ( 921861a )
Bug Fixes
resolve DuplicateCredentialArgs error when using credentials_file ( 74a54c6 )
Documentation
add generated snippets ( #473 ) ( c0c7789 )
fix typos in UPGRADING.md ( #472 ) ( 62bbb7f )
2.11.0 (2022-01-13)
Features
...
2.7.1 (2021-07-26)
Bug Fixes
enable self signed jwt for grpc ( #345 ) ( ae434ed )
Documentation
fix typos ( #347 ) ( 1aa9a7a )
2.7.0 (2021-07-22)
Features
...
2.6.0 (2021-07-10)
Features
add always_use_jwt_access ( #320 ) ( 9bf371d )
Bug Fixes
...
Bug Fixes
remove gRPC send/recv limits ( #245 ) ( ceba454 )
Documentation
...
Features
use microgenerator ( #239 ) ( 57c90a5 )
1.1.0 (2020-08-26)
Features
add environments client ( #217 ) ( 7bf5926 )
Documentation
move to googleapisdotdev ( #155 ) ( 89d071c )
1.0.0 (2020-05-13)
Features
release 1.0.0 ( #192 ) ( 33a7263 ), closes #189
release_status to production/stable ( #189 ) ( 8b995dc )
0.8.0 (2020-03-26)
Features
...
0.7.2 (2019-10-18)
Bug Fixes
define version once in setup.py ( #158 ) ( bf42fc4 )
0.7.1 (2019-10-17)
Bug Fixes
