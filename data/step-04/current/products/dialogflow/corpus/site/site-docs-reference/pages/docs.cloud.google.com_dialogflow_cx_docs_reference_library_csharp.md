---
title: "C# client library \_|\_ Dialogflow CX \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dialogflow/cx/docs/reference/library/csharp
...
Dialogflow CX C# client library.
Resource
Description
Library reference
Dialogflow CX C# library reference
Language guide
General guide for using C# with GCP
GitHub repository
Source code and additional documentation for this library
Stack Overflow
Questions tagged with Dialogflow CX and C#
Installation
To install the client library:
Install the Google.Cloud.Dialogflow.Cx.V3 package from
NuGet .
...
nuget install Google.Cloud.Dialogflow.Cx.V3 -PreRelease
Send feedback
