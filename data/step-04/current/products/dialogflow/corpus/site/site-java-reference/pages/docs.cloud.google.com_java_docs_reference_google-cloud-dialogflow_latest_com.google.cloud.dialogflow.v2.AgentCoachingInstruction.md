---
title: "Class AgentCoachingInstruction (4.94.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dialogflow/latest/com.google.cloud.dialogflow.v2.AgentCoachingInstruction
...
Client libraries
Send feedback
Class AgentCoachingInstruction (4.94.0)
...
4.4.0
4.3.1
public final class AgentCoachingInstruction extends GeneratedMessage implements AgentCoachingInstructionOrBuilder
Agent Coaching instructions that customer can configure.
Protobuf type google.cloud.dialogflow.v2.AgentCoachingInstruction
Inheritance
Object >
...
protected AgentCoachingInstruction . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
