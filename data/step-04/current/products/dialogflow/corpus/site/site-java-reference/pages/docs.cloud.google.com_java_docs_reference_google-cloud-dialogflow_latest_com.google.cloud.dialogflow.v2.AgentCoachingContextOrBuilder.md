---
title: "Interface AgentCoachingContextOrBuilder (4.94.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dialogflow/latest/com.google.cloud.dialogflow.v2.AgentCoachingContextOrBuilder
...
Client libraries
Send feedback
Interface AgentCoachingContextOrBuilder (4.94.0)
...
4.4.0
4.3.1
public interface AgentCoachingContextOrBuilder extends MessageOrBuilder
Implements
MessageOrBuilder
Methods
getInstructions(int index)
public abstract AgentCoachingInstruction getInstructions ( int index )
...
int
getInstructionsList()
public abstract List<AgentCoachingInstruction> getInstructionsList ()
Optional. Customized instructions for agent coaching.
repeated .google.cloud.dialogflow.v2.AgentCoachingInstruction instructions = 1 [(.google.api.field_behavior) = OPTIONAL];
Returns
Type
...
public abstract AgentCoachingInstructionOrBuilder getInstructionsOrBuilder ( int index )
Optional. Customized instructions for agent coaching.
repeated .google.cloud.dialogflow.v2.AgentCoachingInstruction instructions = 1 [(.google.api.field_behavior) = OPTIONAL];
Parameter
Name
...
public abstract List < ? extends AgentCoachingInstructionOrBuilder > getInstructionsOrBuilderList ()
Optional. Customized instructions for agent coaching.
repeated .google.cloud.dialogflow.v2.AgentCoachingInstruction instructions = 1 [(.google.api.field_behavior) = OPTIONAL];
Returns
Type
...
public abstract String getOverarchingGuidance ()
...
public abstract ByteString getOverarchingGuidanceBytes ()
Optional. The overarching guidance for the agent coaching. This should be
set only for v1.5 and later versions.
string overarching_guidance = 7 [(.google.api.field_behavior) = OPTIONAL];
Returns
