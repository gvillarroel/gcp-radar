---
title: "Dialogflow CX audit logging information \_|\_ Google Cloud Documentation"
...
Dialogflow CX
Send feedback
Dialogflow CX audit logging information
Stay organized with collections
Save and categorize content based on your preferences.
This document describes the audit logs created by Dialogflow CX as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Dialogflow CX:
...
Service name
Dialogflow CX audit logs use the service name
...
Resource types
Dialogflow CX audit logs use the resource type
gcs_bucket for all audit logs.
