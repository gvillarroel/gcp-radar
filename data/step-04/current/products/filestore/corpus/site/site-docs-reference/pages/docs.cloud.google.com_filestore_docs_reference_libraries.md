---
title: "Filestore client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/filestore/docs/reference/libraries
...
compile group: 'com.google.cloud', name: 'google-cloud-filestore', version: '8'
...
Issue tracker
cloud-filestore on Stack Overflow
Source code
Send feedback
