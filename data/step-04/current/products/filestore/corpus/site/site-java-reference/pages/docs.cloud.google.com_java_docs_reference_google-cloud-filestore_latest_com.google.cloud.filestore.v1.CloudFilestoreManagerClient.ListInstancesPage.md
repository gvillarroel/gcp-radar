---
title: "Class CloudFilestoreManagerClient.ListInstancesPage (1.89.0) \_|\_ Java client\
  \ libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-filestore/latest/com.google.cloud.filestore.v1.CloudFilestoreManagerClient.ListInstancesPage
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-filestore/latest/com.google.cloud.filestore.v1.CloudFilestoreManagerClient.ListInstancesPage
  title: "Class CloudFilestoreManagerClient.ListInstancesPage (1.89.0) \_|\_ Java\
...
Client libraries
Send feedback
Class CloudFilestoreManagerClient.ListInstancesPage (1.89.0)
...
1.5.0
1.2.0
public static class CloudFilestoreManagerClient . ListInstancesPage extends AbstractPage<ListInstancesRequest , ListInstancesResponse , Instance , CloudFilestoreManagerClient . ListInstancesPage >
Inheritance
java.lang.Object >
AbstractPage >
...
protected CloudFilestoreManagerClient . ListInstancesPage createPage ( PageContext<ListInstancesRequest , ListInstancesResponse , Instance > context , ListInstancesResponse response )
Parameters
Name
Description
context
...
public ApiFuture<CloudFilestoreManagerClient . ListInstancesPage > createPageAsync ( PageContext<ListInstancesRequest , ListInstancesResponse , Instance > context , ApiFuture<ListInstancesResponse> futureResponse )
Parameters
Name
Description
context
