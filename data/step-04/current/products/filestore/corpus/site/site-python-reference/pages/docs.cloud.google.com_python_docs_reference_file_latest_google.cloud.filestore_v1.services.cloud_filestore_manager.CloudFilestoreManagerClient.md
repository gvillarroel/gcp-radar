---
title: "Class CloudFilestoreManagerClient (1.16.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/file/latest/google.cloud.filestore_v1.services.cloud_filestore_manager.CloudFilestoreManagerClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/file/latest/google.cloud.filestore_v1.services.cloud_filestore_manager.CloudFilestoreManagerClient
  title: "Class CloudFilestoreManagerClient (1.16.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class CloudFilestoreManagerClient (1.16.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudFilestoreManagerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.filestore_v1.types.CreateBackupRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.CreateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.CreateSnapshotRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.DeleteBackupRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.DeleteInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.DeleteSnapshotRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.GetBackupRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.GetInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.GetSnapshotRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.ListBackupsRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.ListInstancesRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.ListSnapshotsRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.PromoteReplicaRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.RestoreInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.RevertInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.UpdateBackupRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.UpdateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.filestore_v1.types.UpdateSnapshotRequest , dict]
