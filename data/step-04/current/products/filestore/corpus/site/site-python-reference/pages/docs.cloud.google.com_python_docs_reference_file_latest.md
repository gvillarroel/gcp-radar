---
title: "Python Client for Filestore \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/file/latest
...
0.2.3
0.1.0
Filestore : Filestore instances are fully managed NFS file servers on Google Cloud for use with applications running on Compute Engine virtual machines (VMs) instances or Google Kubernetes Engine clusters.
...
pip install google-cloud-filestore
Next Steps
Read the Client Library Documentation for Filestore
to see other available methods on the client.
Read the Filestore Product documentation to learn
