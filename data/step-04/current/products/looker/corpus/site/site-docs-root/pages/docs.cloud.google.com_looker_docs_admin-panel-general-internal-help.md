---
title: "Admin settings - Internal Help Resources \_|\_ Looker \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/looker/docs/admin-panel-general-internal-help
...
source_metadata:
  url: https://docs.cloud.google.com/looker/docs/admin-panel-general-internal-help
  title: "Admin settings - Internal Help Resources \_|\_ Looker \_|\_ Google Cloud\
    \ Documentation"
...
From the Admin panel, navigate to the Internal Help Resources page.
Once on the page, enable the Enable Internal Help Resources In The Help Menu toggle.
Once the feature is enabled, two fields appear that can be edited:
...
Click Save Changes once you've completed your edits. A Changes successfully saved banner will appear.
