---
title: "Bar chart options \_|\_ Looker \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/looker/docs/bar-options
...
Note: This page describes visualization options for Looker. For information about Looker Studio visualizations, see Types of charts in Looker Studio .
...
You can use the Top Axes and Bottom Axes sections to configure a chart's x-axes. This example shows a chart with two x-axes, one on the bottom and one on the top, each on a different scale:
...
Scale Type
You can specify how the y-axis scale is calculated and displayed. Not all of the following options apply to all chart types.
...
The equation that governs an exponential trend line is y = ae b x .
