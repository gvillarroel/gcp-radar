---
title: "Customizing visualizations using the Chart Config Editor \_|\_ Looker \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/looker/docs/advanced-visualization-editor
...
source_metadata:
  url: https://docs.cloud.google.com/looker/docs/advanced-visualization-editor
  title: "Customizing visualizations using the Chart Config Editor \_|\_ Looker \_\
...
Caution: Don't edit the default visualization options after you make changes in the Chart Config Editor. Editing the default visualization options may cause unexpected behavior, including blank visualizations.
...
{
tooltip : {
format : '<span style="font-size: 1.8em">{key}</span><br/>{#each points}<span style="color:{color}; font-weight: bold;"> \u 25CF {series.name}: </span>{y:.2f}<br/>{/each}' ,
shared : true
},
}
Add chart annotations and captions
...
of the Service Specific Terms . Pre-GA features are available "as is" and might have limited support. For more information, see the
launch stage descriptions .
To report bugs or issues for this feature, fill out the Looker Chart Config Editor Saved Templates - Preview Issues form.
...
In the Chart Config Editor dialog, click Save as template .
Give your template a unique name.
Enter a description that tells other users what your template does.
Edit and preview your code as needed.
Click Save to validate your code.
Fix any validation errors.
Click Save again to save the template.
...
In the Chart Config Editor dialog, click Saved templates .
Click a template, and then click Apply template .
Click Continue .
...
In the Chart Config Editor dialog, click Saved templates .
Click the three-dot menu next to the template that you want to delete.
Click Delete .
...
In the Chart Config Editor dialog, click Saved templates .
Click the three-dot menu next to the template that you want to edit.
Click Edit .
