...
url: https://docs.cloud.google.com/release-notes/all
knowledge_key: corpus
source_id: site-docs-reference-2
source_type: site
entrypoint: https://docs.cloud.google.com/release-notes?authuser=1
source_metadata:
  url: https://docs.cloud.google.com/release-notes/all
  title: "Google Cloud release notes \_|\_ Google Cloud Documentation"
...
App Engine standard environment Java (legacy)
App Engine standard environment Node.js
App Engine standard environment PHP (legacy)
App Engine standard environment Python
App Engine standard environment Python (legacy)
