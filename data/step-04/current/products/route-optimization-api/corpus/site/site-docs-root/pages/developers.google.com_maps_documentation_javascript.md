---
title: "Google Maps Platform Documentation \_|\_ Maps JavaScript API \_|\_ Google\
  \ for Developers"
...
Get started with a Maps Demo Key at no cost.
Get a Demo Key
If you need to use the Maps JavaScript API in a production application, see
Set up the Maps JavaScript API .
Get Started
Start building with commonly used features of the Maps JavaScript API.
explore
Get started with Google Maps Platform
Follow Google Maps Platform getting started guide to create an account, generate an API key, and start building.
map
...
Heatmaps
Visualize the density of data at geographical points. Deprecated feature
Libraries
...
Drawing library
Give your users the ability to interactively draw on the map. Deprecated feature
Geometry library
...
Visualize data intensity at geographical points with heat maps. Deprecated feature
Services
