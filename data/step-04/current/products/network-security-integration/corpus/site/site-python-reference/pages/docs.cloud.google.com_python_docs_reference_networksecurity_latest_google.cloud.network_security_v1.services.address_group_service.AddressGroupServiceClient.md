---
title: "Class AddressGroupServiceClient (0.13.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/networksecurity/latest/google.cloud.network_security_v1.services.address_group_service.AddressGroupServiceClient
...
Client libraries
Send feedback
Class AddressGroupServiceClient (0.13.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the AddressGroupServiceTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.network_security_v1.types.AddAddressGroupItemsRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.CloneAddressGroupItemsRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.CreateAddressGroupRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.DeleteAddressGroupRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.GetAddressGroupRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.ListAddressGroupReferencesRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.ListAddressGroupsRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.RemoveAddressGroupItemsRequest , dict]
...
Description
request
Union[ google.cloud.network_security_v1.types.UpdateAddressGroupRequest , dict]
