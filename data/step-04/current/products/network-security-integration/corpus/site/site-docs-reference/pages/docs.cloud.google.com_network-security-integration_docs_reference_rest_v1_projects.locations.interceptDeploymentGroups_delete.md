---
title: "Method: projects.locations.interceptDeploymentGroups.delete \_|\_ Network\
  \ Security Integration \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-security-integration/docs/reference/rest/v1/projects.locations.interceptDeploymentGroups/delete
...
Reference
Send feedback
Method: projects.locations.interceptDeploymentGroups.delete
Stay organized with collections
Save and categorize content based on your preferences.
Deletes a deployment group. See https://google.aip.dev/135 .
HTTP request
DELETE https://networksecurity.googleapis.com/v1/{name=projects/*/locations/*/interceptDeploymentGroups/*}
