---
title: "Class CloudClientExecutor (6.111.1) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-spanner/latest/com.google.cloud.executor.spanner.CloudClientExecutor
...
Client libraries
Send feedback
Class CloudClientExecutor (6.111.1)
...
CloudClientExecutor
Inherited Members
CloudExecutor.timestampToString(boolean,long)
CloudExecutor.toProto(Status)
CloudExecutor.toStatus(SpannerException)
Object.clone()
