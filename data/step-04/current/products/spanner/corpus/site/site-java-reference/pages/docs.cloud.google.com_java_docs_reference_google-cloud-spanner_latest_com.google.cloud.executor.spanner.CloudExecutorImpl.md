---
title: "Class CloudExecutorImpl (6.111.1) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-spanner/latest/com.google.cloud.executor.spanner.CloudExecutorImpl
...
Client libraries
Send feedback
Class CloudExecutorImpl (6.111.1)
...
CloudExecutorImpl
Inherited Members
SpannerExecutorProxyGrpc.SpannerExecutorProxyImplBase.bindService()
Object.clone()
...
Constructors
CloudExecutorImpl(boolean enableGrpcFaultInjector, double multiplexedSessionOperationsRatio)
public CloudExecutorImpl ( boolean enableGrpcFaultInjector , double multiplexedSessionOperationsRatio )
Parameters
Name
Description
...
Description
responseObserver
io.grpc.stub.StreamObserver < SpannerAsyncActionResponse >
Returns
Type
Description
