---
title: "Array subqueries \_|\_ Spanner \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/spanner/docs/query-operators-array-subqueries
...
An array subquery is similar to a scalar subquery, except that the subquery is
allowed to consume more than one input row. Spanner converts the
consumed rows to a single scalar output array that contains one element per
consumed input row.
