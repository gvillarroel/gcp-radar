---
title: "Spanner Graph and ISO standards \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/spanner/docs/graph/iso-standards
...
The page describes how Spanner Graph supports the ISO international
...
and how Spanner Graph supports these standards.
Standard
SQL/PGQ
GQL
Spanner Graph
...
Both standards are supported. For more information, see Spanner Graph GQL patterns .
Query
...
Both standards are supported. For more information, see Spanner Graph GQL query statements and Query syntax in GoogleSQL .
Query
...
Supported. GQL support can be chosen from GG01: Graph with an open type or GG02. Spanner Graph doesn't support the exact same CREATE_GRAPH_TYPE statement as GQL. However, the CREATE_PROPERTY_GRAPH statement supported by Spanner Graph is closely related to GG02 (with similar support for GG20, GG21, GG22, and GG23).
Lexical structure
...
Spanner Graph GQL shares the exact lexical structure with GoogleSQL. For reference to unicode escape values, see Escape sequences for string and bytes literals .
Data types
...
Supported. For more information, see a full list of data types supported by Spanner Graph GQL.
Additional features
The features listed in the previous sections are the minimal conformance
features of the standards. Spanner Graph supports additional features
