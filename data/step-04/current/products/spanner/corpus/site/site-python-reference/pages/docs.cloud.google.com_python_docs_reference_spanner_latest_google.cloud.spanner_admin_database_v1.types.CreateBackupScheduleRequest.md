---
title: "Class CreateBackupScheduleRequest (3.63.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/spanner/latest/google.cloud.spanner_admin_database_v1.types.CreateBackupScheduleRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/spanner/latest/google.cloud.spanner_admin_database_v1.types.CreateBackupScheduleRequest
  title: "Class CreateBackupScheduleRequest (3.63.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class CreateBackupScheduleRequest (3.63.0)
