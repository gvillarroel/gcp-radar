...
url: https://docs.cloud.google.com/python/docs/reference/spanner/latest/changelog
...
Add QueryAdvisorResult for query plan ( e08260fe24b62313d7964572eeb963eb8c3c923f )
add cloud.region, request_tag and transaction_tag in span attributes (#1449) ( d37fb80a39aea859059ae7d85adc75095a6e14e6 )
Exposing AutoscalingConfig in InstancePartition ( 8b6f154085543953556acde161a739414988b7f0 )
enable OpenTelemetry metrics and tracing by default (#1410) ( bb5095dfb615159a575933a332382ba93ba4bbd1 )
add support for experimental host (#1452) ( 9535e5e096f6ab53f2817af4fd7ac1fa2ca71660 )
Bug Fixes
Provide Spanner Option to disable metrics (#1460) ( f1ebc43ba4c1ee3a8ee77ae4b0b2468937f06b71 )
Deprecate credentials_file argument ( 8b6f154085543953556acde161a739414988b7f0 )
configure keepAlive time for gRPC TCP connections (#1448) ( efb2833e52e54b096e552a4d91f94b017ac733bb )
3.59.0 (2025-10-18)
Features
...
3.54.0 (2025-04-28)
Features
Add interval type support ( #1340 ) ( 6ca9b43 )
Add sample for pre-split feature ( #1333 ) ( ca76108 )
...
Performance Improvements
Add option for last_statement ( #1313 ) ( 19ab6ef )
Documentation
...
3.50.1 (2024-11-14)
Bug Fixes
Json data type for non object values ( #1236 ) ( 0007be3 )
spanner: Multi_scm issue in python release ( #1230 ) ( 6d64e9f )
3.50.0 (2024-11-11)
Features
...
Bug Fixes
Allow protobuf 5.x ( 9609ad9 )
spanner: Unskip emulator tests for proto ( #1145 ) ( cb74679 )
3.47.0 (2024-05-22)
Features
...
Documentation
Remove duplicate paramter description ( #1052 ) ( 1164743 )
3.45.0 (2024-04-17)
Features
Add support for PG.OID in parameterized queries ( #1035 ) ( ea5efe4 )
Bug Fixes
Dates before 1000AD should use 4-digit years ( #1132 ) ( 0ef6565 ), closes #1131
3.44.0 (2024-03-13)
Features
Add support of float32 type ( #1113 ) ( 7e0b46a )
Changes for float32 in dbapi ( #1115 ) ( c9f4fbf )
Bug Fixes
Correcting name of variable from table_schema to schema_name ( #1114 ) ( a92c6d3 )
Documentation
Add sample for managed autoscaler ( #1111 ) ( e73c671 )
3.43.0 (2024-03-06)
Features
...
Documentation
Minor formatting ( #991 ) ( 60efc42 )
3.38.0 (2023-07-21)
Features
Set LAR as False ( #980 ) ( 75e8a59 )
3.37.0 (2023-07-21)
Features
...
Documentation
Fix documentation structure ( #949 ) ( b73e47b )
3.36.0 (2023-06-06)
Features
...
Bug Fixes
Upgrade version of sqlparse ( #943 ) ( df57ce6 )
3.33.0 (2023-04-27)
Features
Leader Aware Routing ( #899 ) ( f9fefad )
3.32.0 (2023-04-25)
Features
Enable instance-level connection ( #931 ) ( d6963e2 )
3.31.0 (2023-04-12)
Features
Add databoost enabled property for batch transactions ( #892 ) ( ffb3915 )
Bug Fixes
Set databoost false ( #928 ) ( c9ed9d2 )
3.30.0 (2023-03-28)
Features
Pass custom Client object to dbapi ( #911 ) ( 52b1a0a )
3.29.0 (2023-03-23)
Features
...
3.25.0 (2022-12-13)
Features
Fgac support and samples ( #867 ) ( 24fa244 )
3.24.0 (2022-11-30)
Features
...
Bug Fixes
deps: Allow protobuf 3.19.5 ( #839 ) ( 06725fc )
Documentation
Describe DB API and transactions retry mechanism ( #844 ) ( 30a0666 ), closes #791
3.22.1 (2022-10-04)
Bug Fixes
deps: Require protobuf >= 3.20.2 ( #830 ) ( 4d71563 )
Documentation
...
3.20.0 (2022-08-30)
Features
Adds TypeAnnotationCode PG_JSONB ( #792 ) ( 6a661d4 )
Bug Fixes
...
3.16.0 (2022-07-11)
Features
Automated Release Blessing ( #767 ) ( 19caf44 )
python typing ( #646 ) ( 169019f )
Bug Fixes
@421 ( #769 ) ( 58640a1 )
...
3.15.0 (2022-06-17)
Features
Add support for Postgresql dialect ( #741 ) ( d2551b0 )
3.14.1 (2022-06-08)
Bug Fixes
deps: require protobuf <4.0.0dev ( #731 ) ( 8004ae5 )
Documentation
...
Documentation
add generated snippets ( #680 ) ( f21dac4 )
3.13.0 (2022-02-04)
Features
add api key support ( 819be92 )
add database dialect ( #671 ) ( 819be92 )
Bug Fixes
...
3.9.0 (2021-08-26)
Features
add support for JSON type ( #353 ) ( b1dd04d )
3.8.0 (2021-08-15)
Features
...
Documentation
fix docstring for session.py ( #387 ) ( 3132587 )
3.6.0 (2021-06-23)
Features
...
Documentation
omit mention of Python 2.7 in ‘CONTRIBUTING.rst’ ( #1127 ) ( #374 ) ( b7b3c38 ), closes #1126
3.5.0 (2021-06-11)
Features
...
3.2.0 (2021-03-02)
Features
add Database.list_tables method ( #219 ) ( 28bde8c )
add sample for commit stats ( #241 ) ( 1343656 )
add samples for PITR ( #222 ) ( da146b7 )
Bug Fixes
remove print statement ( #245 ) ( 1c2a64f )
3.1.0 (2021-02-23)
Features
...
Performance Improvements
improve streaming performance ( #240 ) ( 3e35d4a )
3.0.0 (2021-01-15)
⚠ BREAKING CHANGES
...
Bug Fixes
Add sqlparse dependency ( #171 ) ( e801a2e )
Reverts
...
Features
DB-API driver + unit tests ( #160 ) ( 2493fa1 )
migrate to v2.0.0 ( #147 ) ( bf4b278 )
1.19.1 (2020-10-13)
Bug Fixes
...
1.19.0 (2020-09-08)
Features
add support for NUMERIC type ( #86 ) ( a79786e )
Bug Fixes
list_instances() uses filter_ arg ( #143 ) ( 340028c )
Remove stray bigquery lines ( #138 ) ( cbfcc8b )
1.18.0 (2020-08-25)
Features
