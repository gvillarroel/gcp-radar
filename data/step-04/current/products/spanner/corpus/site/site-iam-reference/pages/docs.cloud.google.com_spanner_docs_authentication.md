---
title: "Authenticate to Spanner \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/spanner/docs/authentication
...
This document describes how to authenticate to Spanner programmatically. How
you authenticate to Spanner depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Spanner supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
...
high-level language support for authenticating to Spanner
programmatically.
...
For more information about using the gcloud CLI with Spanner,
see gcloud spanner .
REST
...
authenticate to Spanner. For more information about this error and how
to address it, see
...
Spanner, as described in Install the gcloud CLI and set up the Cloud Spanner API .
...
After you authenticate to Spanner, you must be authorized to access
Google Cloud resources. Spanner uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Spanner, see
