...
a database in your instance where you will create the tables. For more information, see Create a database on the
Spanner instance
This tutorial requires you to have a database in your Spanner instance. For more
...
Enter spanner to select Spanner as the database engine.
...
Learn how to create or delete a context set in Spanner Studio
