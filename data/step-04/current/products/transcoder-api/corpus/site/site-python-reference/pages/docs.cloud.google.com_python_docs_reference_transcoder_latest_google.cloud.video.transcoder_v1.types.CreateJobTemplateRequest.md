---
title: "Class CreateJobTemplateRequest (1.20.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/transcoder/latest/google.cloud.video.transcoder_v1.types.CreateJobTemplateRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/transcoder/latest/google.cloud.video.transcoder_v1.types.CreateJobTemplateRequest
  title: "Class CreateJobTemplateRequest (1.20.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class CreateJobTemplateRequest (1.20.0)
