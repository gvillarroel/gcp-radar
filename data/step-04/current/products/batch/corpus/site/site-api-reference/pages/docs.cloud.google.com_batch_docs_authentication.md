---
title: "Authenticate to Batch \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/batch/docs/authentication
...
This document describes how to authenticate to Batch programmatically. How
you authenticate to Batch depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Batch supports programmatic access. You can access the API in
the following ways:
Google Cloud CLI
REST
Google Cloud CLI
...
For more information about using the gcloud CLI with Batch,
...
Set up authentication for Batch
...
Access control for Batch
After you authenticate to Batch, you must be authorized to access
Google Cloud resources. Batch uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Batch, see
