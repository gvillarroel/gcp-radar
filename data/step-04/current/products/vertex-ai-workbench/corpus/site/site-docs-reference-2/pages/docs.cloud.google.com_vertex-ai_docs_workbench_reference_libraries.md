---
title: "Vertex AI Workbench client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/vertex-ai/docs/workbench/reference/libraries
...
Notebooks API. Client libraries make it easier to access
...
The following examples show how to use the client library in
