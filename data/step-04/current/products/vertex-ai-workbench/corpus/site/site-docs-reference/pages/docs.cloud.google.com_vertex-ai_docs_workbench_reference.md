---
title: "Notebooks API usage overview \_|\_ Vertex AI Workbench \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/vertex-ai/docs/workbench/reference
...
v2 ( generally available ) is for
managing Vertex AI Workbench instances.
v1 ( generally available ) is for
