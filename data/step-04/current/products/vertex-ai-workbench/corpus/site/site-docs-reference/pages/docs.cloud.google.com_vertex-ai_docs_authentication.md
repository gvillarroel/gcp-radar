---
title: "Authenticate to Vertex AI \_|\_ Google Cloud Documentation"
...
This document describes how to authenticate to Vertex AI programmatically. How
you authenticate to Vertex AI depends on the interface you use to access the API
and the environment where your code is running.
For information about using the Vertex AI API, see API usage overview . If you're trying to authenticate to Vertex AI Workbench, see Authenticate to Vertex AI Workbench .
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Vertex AI supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Vertex AI client libraries provide
high-level language support for authenticating to Vertex AI
programmatically.
...
For more information about using the gcloud CLI with Vertex AI,
...
Vertex AI, as described in Set up a project and a development environment .
...
Access control for Vertex AI
After you authenticate to Vertex AI, you must be authorized to access
Google Cloud resources. Vertex AI uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Vertex AI, see
Vertex AI access control with IAM .
For more information about IAM and authorization, see
IAM overview .
What's next
Learn how to authenticate to Vertex AI Workbench.
