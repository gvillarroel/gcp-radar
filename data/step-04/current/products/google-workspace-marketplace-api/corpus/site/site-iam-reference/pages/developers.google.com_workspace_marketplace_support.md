---
title: "How to get help \_|\_ Google Workspace Marketplace \_|\_ Google for Developers"
url: https://developers.google.com/workspace/marketplace/support
...
tag [google-apps-marketplace] to mark questions relevant to
...
email a Google Workspace developer support specialist
...
[[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-04-01 UTC."],[],["Developers can get help through Stack Overflow for technical questions, using the `[google-apps-marketplace]` tag. For developer product feedback, search the Issue Tracker; if the feedback doesn't exist, submit a new bug report or feature request. Google Workspace administrators can email a developer support specialist, providing detailed problem descriptions, reproduction steps, expected and actual outputs, and development environment information. Feedback on the core product should be submitted via the product's feedback channels.\n"]]
