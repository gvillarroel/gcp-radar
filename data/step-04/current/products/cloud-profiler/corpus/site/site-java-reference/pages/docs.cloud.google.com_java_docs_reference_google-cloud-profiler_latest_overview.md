---
title: "google-cloud-profiler overview (2.88.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-profiler/latest/overview
...
Client libraries
Send feedback
google-cloud-profiler overview (2.88.0)
...
Cloud Profiler Product Reference
GitHub Repository
Maven artifact
Getting Started
...
libraryDependencies += "com.google.cloud" % "google-cloud-profiler" % "2.88.0"
Which version ID should I get started with?
For this library, we recommend using com.google.devtools.cloudprofiler.v2 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Cloud Profiler). New Version IDs are introduced infrequently, and often involve
