...
url: https://docs.cloud.google.com/dotnet/docs/reference/Google.Cloud.AccessApproval.V1/latest
...
Note:
This documentation is for version 2.6.0 of the library.
...
Getting started
All operations are performed through AccessApprovalServiceClient .
