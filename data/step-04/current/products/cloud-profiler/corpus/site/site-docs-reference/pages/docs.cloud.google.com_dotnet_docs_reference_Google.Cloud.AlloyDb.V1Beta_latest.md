---
title: "Google.Cloud.AlloyDb.V1Beta \_|\_ .NET client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/dotnet/docs/reference/Google.Cloud.AlloyDb.V1Beta/latest
...
1.0.0-beta16 (latest)
1.0.0-beta15
Google.Cloud.AlloyDb.V1Beta is a.NET client library for the AlloyDB API .
Note:
This documentation is for version 1.0.0-beta16 of the library.
Some samples may not work with other versions.
Installation
Install the Google.Cloud.AlloyDb.V1Beta package from NuGet. Add it to
your project in the normal way (for example by right-clicking on the
project in Visual Studio and choosing "Manage NuGet Packages...").
Please ensure you enable pre-release packages (for example, in the
Visual Studio NuGet user interface, check the "Include prerelease"
box). Some of the following samples might only work with the latest
pre-release version ( 1.0.0-beta16 ) of Google.Cloud.AlloyDb.V1Beta .
Authentication
