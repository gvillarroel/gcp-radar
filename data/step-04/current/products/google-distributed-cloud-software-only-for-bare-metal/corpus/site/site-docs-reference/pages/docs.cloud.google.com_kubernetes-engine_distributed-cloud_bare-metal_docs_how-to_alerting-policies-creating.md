---
title: "Create alerting policies \_|\_ Google Distributed Cloud (software only) for\
  \ bare metal \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/distributed-cloud/bare-metal/docs/how-to/alerting-policies-creating
...
source_metadata:
  url: https://docs.cloud.google.com/kubernetes-engine/distributed-cloud/bare-metal/docs/how-to/alerting-policies-creating
  title: "Create alerting policies \_|\_ Google Distributed Cloud (software only)\
...
You can download and install all of the alert policy samples described in this
document with the following script:
...
for x in " ${ alerts [@] } "
do
gcloud monitoring policies create --policy-from-file = ${ x }
done
