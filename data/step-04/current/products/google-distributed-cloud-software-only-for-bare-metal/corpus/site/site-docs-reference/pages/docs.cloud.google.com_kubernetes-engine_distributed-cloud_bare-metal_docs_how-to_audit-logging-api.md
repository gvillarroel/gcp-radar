---
title: "Cloud API audit logging \_|\_ Google Distributed Cloud (software only) for\
  \ bare metal \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/distributed-cloud/bare-metal/docs/how-to/audit-logging-api
...
Google Distributed Cloud supports audit logging at both the Cloud API and
Kubernetes cluster level. This document provides audit logging information about
the GKE On-Prem API which the Google Cloud console uses to manage the lifecycle
of user clusters. For information on configuring Kubernetes audit logging for
your user or admin clusters, see
Use Kubernetes audit logging .
This document describes the audit logs created by Google Distributed Cloud as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Google Distributed Cloud:
...
type in Google Distributed Cloud:
Audit logs category
Google Distributed Cloud operations
Admin Activity audit logs
CreateCluster UpdateCluster DeleteCluster EnrollCluster UnenrollCluster CreateNodePool UpdateNodePool DeleteNodePool
Data Access audit logs
GetCluster ListCluster GetNodePool ListNodePool
Audit log format
...
Service name
Google Distributed Cloud audit logs use the service name
...
Resource types
Google Distributed Cloud audit logs use the resource type
