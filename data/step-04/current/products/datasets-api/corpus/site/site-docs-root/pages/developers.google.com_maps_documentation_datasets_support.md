---
title: "Support Options for Maps Datasets API \_|\_ Google for Developers"
...
Support
Send feedback
Support Options for Maps Datasets API
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Google Maps Platform offers both community and premium support options, including Stack Overflow, Issue Tracker, and direct contact with Google representatives for paying customers.
Users can manage support cases, grant access to others, and escalate issues for faster resolution through the Google Cloud Console.
Support response times vary based on the priority level of the issue, ranging from 1 hour for critical production outages with Enhanced Support to 24 hours for low-impact issues with Standard Support.
Enhanced Support provides additional benefits such as case escalation, video conferencing for complex issues, SLA incident reports, and assistance with map data quality.
Data privacy and protection questions should be directed to the Data Privacy Inquiry Form, separate from standard support channels.
Get help
...
Stack Overflow
to field technical questions about the Maps Datasets API. Stack Overflow is a
...
and Google Places related tags on Stack Overflow. You can look for Maps Datasets API-specific
topics by adding
google-maps . You can look for Google Maps Platform APIs topics
by adding
...
issue tracker .
Bugs
If you think the cause of a problem is a bug in the Maps Datasets API, report it on
