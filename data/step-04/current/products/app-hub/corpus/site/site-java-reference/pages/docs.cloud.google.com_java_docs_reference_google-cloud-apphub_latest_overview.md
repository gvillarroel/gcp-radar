---
title: "google-cloud-apphub overview (0.52.0) \_|\_ Java client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-apphub/latest/overview
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-apphub/latest/overview
  title: "google-cloud-apphub overview (0.52.0) \_|\_ Java client libraries \_|\_\
...
Client libraries
Send feedback
google-cloud-apphub overview (0.52.0)
...
0.1.0
Key Reference Links
App Hub API Description: App Hub simplifies the process of building, running, and managing applications on Google Cloud.
App Hub API Product Reference
GitHub Repository
Maven artifact
Getting Started
...
The example below demonstrates how you would import the BOM and include the google-cloud-apphub artifact.
...
implementation ( "com.google.cloud:google-cloud-apphub" )
...
For this library, we recommend using com.google.cloud.apphub.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. App Hub API). New Version IDs are introduced infrequently, and often involve
