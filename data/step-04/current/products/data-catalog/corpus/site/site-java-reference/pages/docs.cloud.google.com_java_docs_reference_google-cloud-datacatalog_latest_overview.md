---
title: "google-cloud-datacatalog overview (1.94.0) \_|\_ Java client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-datacatalog/latest/overview
...
Client libraries
Send feedback
google-cloud-datacatalog overview (1.94.0)
...
Data Catalog Product Reference
GitHub Repository
Maven artifact
Getting Started
...
For this library, we recommend using com.google.cloud.datacatalog.v1 for new applications.
...
Version ID : The version of the Cloud service itself (e.g. Data Catalog). New Version IDs are introduced infrequently, and often involve
