---
title: "Class DataCatalogAsyncClient (3.29.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/datacatalog/latest/google.cloud.datacatalog_v1.services.data_catalog.DataCatalogAsyncClient
...
Client libraries
Send feedback
Class DataCatalogAsyncClient (3.29.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the DataCatalogTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ListEntriesRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ListEntryGroupsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ListTagsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.LookupEntryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ModifyEntryContactsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ModifyEntryOverviewRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.ReconcileTagsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.RenameTagTemplateFieldRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.RenameTagTemplateFieldEnumValueRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.RetrieveConfigRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.RetrieveEffectiveConfigRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.SearchCatalogRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.SetConfigRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.StarEntryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UnstarEntryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UpdateEntryRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UpdateEntryGroupRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UpdateTagRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UpdateTagTemplateRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.datacatalog_v1.types.UpdateTagTemplateFieldRequest , dict]]
