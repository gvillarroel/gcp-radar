---
title: "EXPONENT function \_|\_ Application Integration \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/application-integration/docs/reference/data-mapping-reference/exponent-function-reference
...
EXPONENT(value)
Power value.
Value of the number raised to the specified power.
Supported data type
