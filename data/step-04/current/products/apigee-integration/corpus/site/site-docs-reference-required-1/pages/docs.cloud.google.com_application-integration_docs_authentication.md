---
title: "Authenticate to Application Integration \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/application-integration/docs/authentication
...
This document describes how to authenticate to Application Integration programmatically. How
you authenticate to Application Integration depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Application Integration supports programmatic access. You can access the API in
the following ways:
REST
REST
You can authenticate to
the Application Integration API
...
Set up authentication for Application Integration
...
Access control for Application Integration
After you authenticate to Application Integration, you must be authorized to access
Google Cloud resources. Application Integration uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Application Integration, see
