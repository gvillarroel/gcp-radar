---
title: "Container-Optimized OS Release Notes: Milestone 81 \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/container-optimized-os/docs/release-notes/m81
...
v19.03.15
v1.3.10
Upgraded dev-libs/nspr to v3.42. This resolved CVE-2021-43527.
Upgraded app-crypt/nss to v3.73. This resolved CVE-2021-43527.
Upgraded dev-libs/nss to v3.73. This resolved CVE-2021-43527.
cos-81-12871-1317-7
Date
Kernel
Kubernetes
...
v1.17.15
v19.03.14
Updated sqlite to version 3.33.0. This resolves the following CVEs: CVE-2020-13630,
CVE-2020-9327, CVE-2020-13871, CVE-2020-11656, CVE-2020-11655, CVE-2020-15358,
...
Change
Removed cos-extensions utility. Users should use
cos-gpu-installer
...
Feature
Added the cos-extensions-manager package. Click
here
to learn more about cos-extensions.
Change
...
v19.03.6
Fixed
Updated the built-in kubectl/kubelet to v1.17.6 to fix a bug that could
result in the inability to start a cluster.
cos-81-12871-119-0
Date
Kernel
Kubernetes
...
v1.17.3
v19.03.6
Fixed a few OS Login CVEs: CVE-2020-8903, CVE-2020-8907,
CVE-2020-8933.
cos-81-12871-117-0
Date
Kernel
...
v1.17.3
v19.03.6
Upgraded sys-libs/libseccomp to version 2.4.2-r1 to fix
CVE-2019-9893.
cos-81-12871-103-0
Date
Kernel
...
v19.03.6
Feature
Added support for new Google Compute Engine virtual network interface
(GVNIC).
Feature
...
Feature
Added support for snapshotting any block device without massive
copying.
Feature
Enhanced security by reducing the predictability of the kernel slab
allocator against heap overflows and providing a lightweight support for
...
Fixed
Changed the MTU of the default docker network to 1460 to make it
consistent with Google Compute Engine's default MTU value.
Fixed
Fixed a regression that blocks user-level statically defined tracking
probes (requires a semaphore) to work.
