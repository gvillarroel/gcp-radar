---
title: "Container-Optimized OS Release Notes: Milestone 101 \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/container-optimized-os/docs/release-notes/m101
...
Security
Updated dev-vcs/git to v2.45.1. This fixes
...
Fixed
Fixed system-accounts-secured benchmark by changing the
system account range used in the benchmark.
May 21, 2024
Change
...
Security
Updated sys-apps/shadow to v4.12.3. This resolves
CVE-2013-4235.
Security
...
Fixed CVE-2023-6931 in the Linux kernel.
Security
Updated dev-lang/go to v1.20.12. This resolves CVE-2023-45285
and CVE-2023-39326.
Fixed
...
v470.199.02(default),v535.104.05
Security
Upgraded go from 1.19.13 to 1.20.8. This also required
...
Fixed
Enable persistence mode with Nvidia GPU driver
installation.
Security
...
Change
Updated app-emulation/docker to 20.10.24. This fixes
CVE-2023-28840, CVE-2023-28841, CVE-2023-28842, CVE-2022-27652,
CVE-2022-36109.
May 01, 2023
Change
cos-101-17162-210-9
...
Feature
Added support for L4 GPU in cos-gpu-installer and fix cached
...
Security
Updated net-misc/curl to v7.88.1. This resolves
CVE-2023-23916.
Security
...
Security
Updated dev-lang/go to v1.19.6. Updated dev-go/net to
...
Fixed
Fixed proc_skip_spaces in the Linux kernel to follow existing convention
instead of acting as a wrapper to skip_spaces.
Security
...
Security
Updated vim/vim-core to v9.0.0467. This resolves CVE-2022-3153,
CVE-2022-3134, CVE-2022-3099, CVE-2022-3037, CVE-2022-3016, CVE-2022-2982,
...
Fixed
Fixed an issue in cloud-init where cloud-init fails when not able to log
to /dev/console.
Security
...
Feature
Opting out of a CIS Benchmark will now prevent scripts from adjusting your
instance.
Fixed
...
CVE-2022-1898,CVE-2021-4187,CVE-2022-0128,CVE-2022-0156,CVE-2022-0158,
CVE-2022-0261,CVE-2022-0318,CVE-2022-0319,CVE-2022-0392,CVE-2022-0368,
CVE-2022-0393,CVE-2022-0361,CVE-2022-0359,CVE-2022-0413,CVE-2022-0408,
CVE-2022-0407,CVE-2022-0443,CVE-2022-0714,CVE-2022-0696,CVE-2022-0685,
