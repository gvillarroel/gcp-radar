---
title: "Configuring instances with user-defined guest policies \_|\_ Container-Optimized\
  \ OS \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/container-optimized-os/docs/how-to/osconfig
...
Note: While it is optional to provide an interpreter on other distros,
Container-Optimized OS requires interpreter to execute the given script. Note: While recipes are run once-per-instance on other distros, on Container-Optimized OS,
recipes are run on every boot. This is because most of the directories are
stateless; therefore, changes made by recipes will not persist across reboots.
See Disks and Filesystem
for more information on Container-Optimized OS's filesystem.
Send feedback
