---
title: "Container-Optimized OS from Google documentation \_|\_ Google Cloud Documentation"
...
VMs that is optimized for running Docker containers. With Container-Optimized OS, you can
