...
url: https://docs.cloud.google.com/memorystore/docs/cluster/reference/mcp/tools_list/export_backup
...
The following sample demonstrate how to use curl to invoke the export_backup MCP tool.
Curl Request
