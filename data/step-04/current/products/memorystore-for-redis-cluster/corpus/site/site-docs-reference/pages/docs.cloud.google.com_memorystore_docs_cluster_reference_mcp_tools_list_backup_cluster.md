...
url: https://docs.cloud.google.com/memorystore/docs/cluster/reference/mcp/tools_list/backup_cluster
...
The following sample demonstrate how to use curl to invoke the backup_cluster MCP tool.
Curl Request
