---
title: "About RDB persistence \_|\_ Memorystore for Redis Cluster \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/memorystore/docs/cluster/about-rdb-persistence
...
Memorystore for Redis Cluster also supports AOF persistence, but you must choose either
...
Recovery behavior
Memorystore for Redis Cluster nodes failover to replicas as the primary recovery mechanism, rather than loading
...
incident, use the rdb_save_ages
...
You can monitor the performance impact a snapshot has on your Memorystore instance by viewing the metrics available through Cloud Monitoring such as CPU usage and memory usage.
Send feedback
