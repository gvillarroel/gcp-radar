---
title: "About multiple VPC networking \_|\_ Memorystore for Redis Cluster \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/cluster/about-multiple-vpc-networking
...
source_metadata:
  url: https://docs.cloud.google.com/memorystore/docs/cluster/about-multiple-vpc-networking
  title: "About multiple VPC networking \_|\_ Memorystore for Redis Cluster \_|\_\
...
This page gives an overview of multiple VPC networking for Memorystore for Redis Cluster. In situations where you only need one VPC network, we recommend (but don't require) using a service connection policy to provision your network, as explained in Networking .
...
Each VPC network that you connect to your cluster in Memorystore for Redis Cluster must
...
cluster. The other connection is reserved for internal usage by the
Memorystore for Redis Cluster backend.
Important: Don't configure your Redis client to connect to this reserved,
internal endpoint. Unlike the discovery endpoint, the internal endpoint doesn't
accept connections on port 6379 . Attempting to use this endpoint for either
initial cluster discovery or standard client connections results in a connection
timeout.
For more information about connecting your client to a cluster that uses
