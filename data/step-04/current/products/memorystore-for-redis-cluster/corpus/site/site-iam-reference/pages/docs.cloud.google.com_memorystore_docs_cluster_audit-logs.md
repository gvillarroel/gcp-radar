---
title: "Monitor access using audit logs \_|\_ Memorystore for Redis Cluster \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/cluster/audit-logs
...
Note: You must enable data access audit logs before you can view them for Memorystore for Redis Cluster.
This document describes the audit logs created by Memorystore for Redis Cluster as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Memorystore for Redis Cluster:
...
type in Memorystore for Redis Cluster:
Audit logs category
Memorystore for Redis Cluster operations
Admin Activity
Cluster operations: CreateCluster
DeleteCluster
UpdateCluster
Token-Based Authentication Operations: AddTokenAuthUser
DeleteTokenAuthUser
AddAuthToken
DeleteAuthToken
Data Access (ADMIN_READ)
Cluster operations: GetCluster
ListCluster
Token-Based Authentication Operations: ListTokenAuthUsers
GetTokenAuthUser
ListAuthTokens
GetAuthToken
Audit log format
...
Service name
Memorystore for Redis Cluster audit logs use the service name redis.googleapis.com .
...
Resource types
Memorystore for Redis Cluster audit logs use the resource type audited_resource for all audit logs, because many different types of resources can be monitored.
