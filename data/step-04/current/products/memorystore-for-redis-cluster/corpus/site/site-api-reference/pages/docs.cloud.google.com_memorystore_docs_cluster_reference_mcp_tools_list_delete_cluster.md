...
url: https://docs.cloud.google.com/memorystore/docs/cluster/reference/mcp/tools_list/delete_cluster
...
The following sample demonstrate how to use curl to invoke the delete_cluster MCP tool.
Curl Request
