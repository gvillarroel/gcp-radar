...
url: https://docs.cloud.google.com/memorystore/docs/cluster/reference/mcp/tools_list/delete_backup
...
The following sample demonstrate how to use curl to invoke the delete_backup MCP tool.
Curl Request
