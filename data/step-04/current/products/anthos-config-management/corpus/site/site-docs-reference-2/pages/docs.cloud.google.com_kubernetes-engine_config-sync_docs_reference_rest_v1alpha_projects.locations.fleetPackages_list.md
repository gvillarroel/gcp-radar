---
title: "Method: projects.locations.fleetPackages.list \_|\_ Config Sync \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/config-sync/docs/reference/rest/v1alpha/projects.locations.fleetPackages/list
...
HTTP request
GET https://configdelivery.googleapis.com/v1alpha/{parent=projects/*/locations/*}/fleetPackages
