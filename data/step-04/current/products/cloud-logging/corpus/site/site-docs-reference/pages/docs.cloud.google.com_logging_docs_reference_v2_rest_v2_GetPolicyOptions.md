---
title: "GetPolicyOptions \_|\_ Cloud Logging \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/logging/docs/reference/v2/rest/v2/GetPolicyOptions
...
JSON representation
Encapsulates settings provided to views.getIamPolicy.
JSON representation
{
