...
url: https://developers.google.com/apps-script/guides/macro-converter/compatible-vba-apis
...
Compatible VBA APIs
The following VBA APIs have an equivalent API in Apps Script and
can be successfully converted in most cases.
abs
