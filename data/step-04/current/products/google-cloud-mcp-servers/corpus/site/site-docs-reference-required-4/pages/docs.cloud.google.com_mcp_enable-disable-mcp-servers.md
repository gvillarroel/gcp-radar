---
title: "Enable or disable MCP servers \_|\_ Google Cloud MCP servers \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/mcp/enable-disable-mcp-servers
...
To use Google and Google Cloud remote MCP servers with your AI application or
agent, you must enable the product API in your project.
Before you begin
...
MCP security and governance, see AI security and safety .
What's next
