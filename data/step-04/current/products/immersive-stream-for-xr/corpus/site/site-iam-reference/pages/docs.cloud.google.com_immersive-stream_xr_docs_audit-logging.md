---
title: "Audit logging information for Immersive Stream for XR \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/immersive-stream/xr/docs/audit-logging
...
source_metadata:
  url: https://docs.cloud.google.com/immersive-stream/xr/docs/audit-logging
  title: "Audit logging information for Immersive Stream for XR \_|\_ Google Cloud\
    \ Documentation"
...
Guides
Send feedback
Audit logging information for Immersive Stream for XR
Stay organized with collections
Save and categorize content based on your preferences.
This document describes the audit logs created by Immersive Stream for XR as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Immersive Stream for XR:
...
type in Immersive Stream for XR:
Audit logs category
Immersive Stream for XR operations
Admin Activity audit logs
google.cloud.stream.v1.Stream.CreateStreamContent google.cloud.stream.v1.Stream.UpdateStreamContent google.cloud.stream.v1.Stream.DeleteStreamContent google.cloud.stream.v1.Stream.BuildStreamContent google.cloud.stream.v1.Stream.CreateStreamInstance google.cloud.stream.v1.Stream.UpdateStreamInstance google.cloud.stream.v1.Stream.DeleteStreamInstance google.longrunning.Operations.DeleteOperation google.longrunning.Operations.CancelOperation
Data Access (ADMIN_READ) audit logs
google.cloud.stream.v1.Stream.ListStreamContent google.cloud.stream.v1.Stream.GetStreamContent google.cloud.stream.v1.Stream.ListStreamInstance google.cloud.stream.v1.Stream.GetStreamInstance google.longrunning.Operations.ListOperation google.longrunning.Operations.GetOperation
Audit log format
...
Service name
Immersive Stream for XR audit logs use the service name
...
Resource types
Immersive Stream for XR audit logs use the resource type
...
Immersive Stream for XR, use the following query, supplying a valid resource
...
protoPayload . serviceName = "stream.googleapis.com"
Route audit logs
