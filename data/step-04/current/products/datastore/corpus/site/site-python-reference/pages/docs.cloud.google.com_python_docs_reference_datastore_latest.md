---
title: "Python Client for Google Cloud Datastore API \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/datastore/latest
...
pip install google-cloud-datastore
Next Steps
Read the Client Library Documentation for Google Cloud Datastore API
to see other available methods on the client.
Read the Google Cloud Datastore API Product documentation to learn
