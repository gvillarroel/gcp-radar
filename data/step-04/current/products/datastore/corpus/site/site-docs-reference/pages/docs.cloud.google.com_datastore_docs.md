---
title: "Firestore in Datastore mode documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/datastore/docs
...
While the Datastore mode interface has many of the same features as
traditional databases, as a NoSQL database it differs from them in the way it
describes relationships between data objects.
Not sure what database option is right for you? Learn more about our
database services .
Go to the Firestore in Datastore mode product page for more.
