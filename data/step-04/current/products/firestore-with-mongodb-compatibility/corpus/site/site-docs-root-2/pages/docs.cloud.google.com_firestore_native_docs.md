---
title: "Firestore in Native mode documentation \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/firestore/native/docs
...
Key Point: Firestore now has MongoDB API compatibility. See
