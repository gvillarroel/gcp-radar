...
Capacity management with load balancing | Cloud Load Balancing | Google Cloud Documentation
...
Costs
Before you begin
Setting up your environment Start a Cloud Shell instance
Configure project settings
Create and configure the VPC network
Determining the serving capacity of a single VM instance Setting up the VM instances
Testing the VM instances
Measuring overload effects with a single-region load balancer Creating the single-region HTTP(S) load balancer
Measuring overflow effects to another region Creating servers in multiple regions
