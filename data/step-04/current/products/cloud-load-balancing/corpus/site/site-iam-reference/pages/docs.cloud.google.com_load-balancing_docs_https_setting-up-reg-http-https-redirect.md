---
title: "Set up an HTTP-to-HTTPS redirect for regional external Application Load Balancers\
  \ \_|\_ Cloud Load Balancing \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/https/setting-up-reg-http-https-redirect
...
source_metadata:
  url: https://docs.cloud.google.com/load-balancing/docs/https/setting-up-reg-http-https-redirect
  title: "Set up an HTTP-to-HTTPS redirect for regional external Application Load\
    \ Balancers \_|\_ Cloud Load Balancing \_|\_ Google Cloud Documentation"
  fetched_via: browser_cdp
  cdp_url: http://127.0.0.1:9222
---

Set up an HTTP-to-HTTPS redirect for regional external Application Load Balancers | Cloud Load Balancing | Google Cloud Documentation
...
For existing load balancers Redirecting traffic to your HTTPS load balancer
...
Was this helpful?
Send feedback
Set up an HTTP-to-HTTPS redirect for regional external Application Load Balancers
