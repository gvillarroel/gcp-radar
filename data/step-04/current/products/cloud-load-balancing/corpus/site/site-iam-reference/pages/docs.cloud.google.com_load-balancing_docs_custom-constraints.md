...
Manage Cloud Load Balancing resources using custom constraints | Google Cloud Documentation
...
Test the custom organization policy Create the custom constraint
