---
title: "Set up a global external Application Load Balancer with VM instance group\
  \ backends \_|\_ Cloud Load Balancing \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/https/setup-global-ext-https-compute
...
Set up a global external Application Load Balancer with VM instance group backends | Cloud Load Balancing | Google Cloud Documentation
...
Before you begin Set up an SSL certificate resource
Set up permissions
Optional: Use BYOIP addresses
Configure the network and subnets
Create a managed instance group
Add a named port to the instance group
Configure a firewall rule Create the IPv6 health check firewall rule
...
For Network tags , enter allow-health-check , allow-health-check-ipv6 .
In the Network interfaces section, click
edit Edit . Configure the
following fields:
Network : NETWORK
Subnet : SUBNET
...
target tag allow-health-check-ipv6 to identify the VM instances to which it
applies.
Without this firewall rule, the implied deny
ingress rule blocks incoming IPv6
traffic to the backend instances.
Note: To allow health checks from the IP ranges of Google Cloud probe
systems, you must create a firewall rule. For more information, see
...
fw-allow-lb-access-ipv6 firewall rule:
...
Replace HTTP_KEEP_ALIVE_TIMEOUT_SEC with the
...
Setting up an HTTP-to-HTTPS redirect for an
external Application Load Balancer
Setting up an HTTPS load
balancer
...
For related videos:
How to configure backend services for global external Application Load Balancer
Was this helpful?
Send feedback
