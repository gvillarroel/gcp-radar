---
title: "Set up an HTTP-to-HTTPS redirect for global external Application Load Balancers\
  \ \_|\_ Cloud Load Balancing \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/https/setting-up-global-http-https-redirect
...
Set up an HTTP-to-HTTPS redirect for global external Application Load Balancers | Cloud Load Balancing | Google Cloud Documentation
...
global external Application Load Balancer. This page is for a global external Application Load Balancer only. If
