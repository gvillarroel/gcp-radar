---
title: "Method: projects.locations.backendAuthenticationConfigs.create \_|\_ Cloud\
  \ Load Balancing \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/reference/network-security/rest/v1beta1/projects.locations.backendAuthenticationConfigs/create
...
Method: projects.locations.backendAuthenticationConfigs.create | Cloud Load Balancing | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: projects. locations. backend Authentication Configs. create
...
HTTP request
POST https://networksecurity.googleapis.com/v1beta1/{parent=projects/*/locations/*}/backendAuthenticationConfigs
...
Authorization requires the following IAM permission on the specified resource backendAuthenticationConfigId :
networksecurity.backendAuthenticationConfigs.create
Request body
