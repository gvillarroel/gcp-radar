---
title: "Method: projects.locations.serverTlsPolicies.get \_|\_ Cloud Load Balancing\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/reference/network-security/rest/v1/projects.locations.serverTlsPolicies/get
...
Method: projects.locations.serverTlsPolicies.get | Cloud Load Balancing | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: projects. locations. server Tls Policies. get
...
HTTP request
GET https://networksecurity.googleapis.com/v1/{name=projects/*/locations/*/serverTlsPolicies/*}
...
Response body
If successful, the response body contains an instance of ServerTlsPolicy .
Authorization scopes
