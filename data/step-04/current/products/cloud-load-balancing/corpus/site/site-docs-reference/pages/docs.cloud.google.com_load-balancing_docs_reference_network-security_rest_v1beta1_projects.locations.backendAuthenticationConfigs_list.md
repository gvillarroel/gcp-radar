...
url: https://docs.cloud.google.com/load-balancing/docs/reference/network-security/rest/v1beta1/projects.locations.backendAuthenticationConfigs/list
...
HTTP request
GET https://networksecurity.googleapis.com/v1beta1/{parent=projects/*/locations/*}/backendAuthenticationConfigs
