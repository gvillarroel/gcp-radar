...
url: https://docs.cloud.google.com/load-balancing/docs/reference/network-security/rest/v1beta1/projects.locations.backendAuthenticationConfigs/patch
...
HTTP request
PATCH https://networksecurity.googleapis.com/v1beta1/{backendAuthenticationConfig.name=projects/*/locations/*/backendAuthenticationConfigs/*}
