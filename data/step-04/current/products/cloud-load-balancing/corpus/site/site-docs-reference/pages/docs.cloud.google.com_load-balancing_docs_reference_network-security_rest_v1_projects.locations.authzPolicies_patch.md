---
title: "Method: projects.locations.authzPolicies.patch \_|\_ Cloud Load Balancing\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/load-balancing/docs/reference/network-security/rest/v1/projects.locations.authzPolicies/patch
...
Method: projects.locations.authzPolicies.patch | Cloud Load Balancing | Google Cloud Documentation
...
Was this helpful?
Send feedback
Method: projects. locations. authz Policies. patch
...
HTTP request
PATCH https://networksecurity.googleapis.com/v1/{authzPolicy.name=projects/*/locations/*/authzPolicies/*}
...
Required. Used to specify the fields to be overwritten in the AuthzPolicy resource by the update. The fields specified in the updateMask are relative to the resource, not the full request. A field is overwritten if it is in the mask. If the user does not specify a mask, then all fields are overwritten.
...
Request body
The request body contains an instance of AuthzPolicy .
Response body
...
IAM Permissions
Requires the following IAM permission on the resources resource:
