---
title: "Video Stitcher API client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/video-stitcher/docs/reference/libraries
...
Reference
Send feedback
Video Stitcher API client libraries
Stay organized with collections
Save and categorize content based on your preferences.
This page shows how to get started with the Cloud Client Libraries for the
Video Stitcher API. Client libraries make it easier to access
...
Install-Package Google.Cloud.Video.Stitcher.V1 -Version 3.3.0
If you are using .NET Core command-line interface tools to install your dependencies, run the following command:
dotnet add package Google.Cloud.Video.Stitcher.V1 --version 3.3.0
For more information, see Setting Up a C# Development Environment .
Go
go get cloud.google.com/go/video/stitcher/apiv1
...
compile group : ' com . google . cloud ' , name : ' google - cloud - video - stitcher ' , version : ' 0.52.0 '
For more information, see Setting Up a Java Development Environment .
Node.js
npm i @google-cloud/video-stitcher
For more information, see Setting Up a Node.js Development Environment .
PHP
composer require google/cloud
For more information, see Using PHP on Google Cloud .
Python
pip install --upgrade google-cloud-video-stitcher
