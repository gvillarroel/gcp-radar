---
title: "Python Client for Video Stitcher \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/videostitcher/latest
...
pip install google-cloud-video-stitcher
Next Steps
Read the Client Library Documentation for Video Stitcher
to see other available methods on the client.
Read the Video Stitcher Product documentation to learn
