...
Define access policies using access levels | Access Context Manager | Google Cloud Documentation
...
Common policy configurations Limit access on a corporate network
