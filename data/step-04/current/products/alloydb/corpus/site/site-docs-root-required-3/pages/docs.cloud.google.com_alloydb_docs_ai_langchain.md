---
title: "Build LLM-powered applications using LangChain \_|\_ AlloyDB for PostgreSQL\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/alloydb/docs/ai/langchain
...
LangChain . The overviews on this
...
overview of LLM concepts and services in Google Cloud .
For more information about LangChain, see the Google
LangChain
page. For more information about the LangChain framework, see the
LangChain
...
LangChain Quickstart for AlloyDB .
...
store shows you how to do the following:
Install the integration package and LangChain
Create an AlloyDBEngine object and configure a connection pool to your
AlloyDB database
...
Create a custom vector store to connect to a pre-existing AlloyDB for PostgreSQL
database that has a table with vector embeddings
...
Create a chain for message history using the LangChain Expression Language
(LCEL)
What's next
Migrate data from a vector database to AlloyDB using LangChain .
Send feedback
