---
title: "Class TimeBasedRetention (0.7.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/alloydb/latest/google.cloud.alloydb_v1.types.AutomatedBackupPolicy.TimeBasedRetention
...
Client libraries
Send feedback
Class TimeBasedRetention (0.7.0)
