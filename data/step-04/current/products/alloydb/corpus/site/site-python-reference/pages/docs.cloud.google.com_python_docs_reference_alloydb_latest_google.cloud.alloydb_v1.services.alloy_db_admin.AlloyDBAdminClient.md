---
title: "Class AlloyDBAdminClient (0.7.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/alloydb/latest/google.cloud.alloydb_v1.services.alloy_db_admin.AlloyDBAdminClient
...
Client libraries
Send feedback
Class AlloyDBAdminClient (0.7.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the AlloyDBAdminTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.alloydb_v1.types.BatchCreateInstancesRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateBackupRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateSecondaryClusterRequest , dict]
The request object.
parent
str
Required. The location of the new cluster. For the required format, see the comment on the Cluster.name field. This corresponds to the parent field on the request instance; if request is provided, this should not be set.
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateSecondaryInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.CreateUserRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.DeleteBackupRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.DeleteClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.DeleteInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.DeleteUserRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ExecuteSqlRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ExportClusterRequest , dict]
...
gcs_destination
google.cloud.alloydb_v1.types.GcsDestination
...
csv_export_options
google.cloud.alloydb_v1.types.ExportClusterRequest.CsvExportOptions
...
sql_export_options
google.cloud.alloydb_v1.types.ExportClusterRequest.SqlExportOptions
...
Description
request
Union[ google.cloud.alloydb_v1.types.FailoverInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GenerateClientCertificateRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GetBackupRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GetClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GetConnectionInfoRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GetInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.GetUserRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ImportClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.InjectFaultRequest , dict]
The request object. Message for triggering fault injection on an instance
fault_type
google.cloud.alloydb_v1.types.InjectFaultRequest.FaultType
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListBackupsRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListClustersRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListDatabasesRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListInstancesRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListSupportedDatabaseFlagsRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.ListUsersRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.PromoteClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.RestartInstanceRequest , dict]
The request object.
name
str
Required. The name of the resource. For the required format, see the comment on the Instance.name field. This corresponds to the name field on the request instance; if request is provided, this should not be set.
...
Description
request
Union[ google.cloud.alloydb_v1.types.RestoreClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.SwitchoverClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.UpdateBackupRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.UpdateClusterRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.UpdateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.UpdateUserRequest , dict]
...
Description
request
Union[ google.cloud.alloydb_v1.types.UpgradeClusterRequest , dict]
