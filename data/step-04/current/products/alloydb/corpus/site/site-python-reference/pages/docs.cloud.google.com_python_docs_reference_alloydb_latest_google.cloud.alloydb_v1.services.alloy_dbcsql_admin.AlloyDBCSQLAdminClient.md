---
title: "Class AlloyDBCSQLAdminClient (0.7.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/alloydb/latest/google.cloud.alloydb_v1.services.alloy_dbcsql_admin.AlloyDBCSQLAdminClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/alloydb/latest/google.cloud.alloydb_v1.services.alloy_dbcsql_admin.AlloyDBCSQLAdminClient
  title: "Class AlloyDBCSQLAdminClient (0.7.0) \_|\_ Python client libraries \_|\_\
...
Client libraries
Send feedback
Class AlloyDBCSQLAdminClient (0.7.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the AlloyDBCSQLAdminTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.alloydb_v1.types.RestoreFromCloudSQLRequest , dict]
