...
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-trace/latest/com.google.cloud.trace.v2.TraceServiceSettings.Builder
...
Type
Description
Builder < BatchWriteSpansRequest , Empty >
build()
