---
title: "Class TraceServiceStubSettings (2.88.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-trace/latest/com.google.cloud.trace.v1.stub.TraceServiceStubSettings
...
Client libraries
Send feedback
Class TraceServiceStubSettings (2.88.0)
...
Type
Description
UnaryCallSettings < GetTraceRequest , Trace >
listTracesSettings()
...
Type
Description
PagedCallSettings < ListTracesRequest , ListTracesResponse , ListTracesPagedResponse >
patchTracesSettings()
...
Type
Description
UnaryCallSettings < PatchTracesRequest , Empty >
toBuilder()
