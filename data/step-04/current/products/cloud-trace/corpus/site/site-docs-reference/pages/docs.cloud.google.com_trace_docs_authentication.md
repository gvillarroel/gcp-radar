---
title: "Authenticate to Trace \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/trace/docs/authentication
...
This document describes how to authenticate to Cloud Trace programmatically. How
you authenticate to Cloud Trace depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Trace supports programmatic access. You can access the API in
the following ways:
Client libraries
REST
Client libraries
The Trace client libraries provide
high-level language support for authenticating to Trace
programmatically.
...
User credentials and ADC for Trace
...
authenticate to Trace. For more information about this error and how
to address it, see
User credentials not working .
Set up authentication for Trace
...
Trace, as described in Instrument for Cloud Trace .
...
Access control for Trace
After you authenticate to Trace, you must be authorized to access
Google Cloud resources. Trace uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Trace, see
