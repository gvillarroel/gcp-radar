---
title: "Class PatchTracesRequest (1.19.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudtrace/latest/google.cloud.trace_v1.types.PatchTracesRequest
...
Client libraries
Send feedback
Class PatchTracesRequest (1.19.0)
