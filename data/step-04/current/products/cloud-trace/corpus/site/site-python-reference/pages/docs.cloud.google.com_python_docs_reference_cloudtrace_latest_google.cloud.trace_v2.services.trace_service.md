---
title: "Package trace_service (1.19.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/cloudtrace/latest/google.cloud.trace_v2.services.trace_service
...
0.23.0
0.22.1
API documentation for trace_v2.services.trace_service package.
Classes
