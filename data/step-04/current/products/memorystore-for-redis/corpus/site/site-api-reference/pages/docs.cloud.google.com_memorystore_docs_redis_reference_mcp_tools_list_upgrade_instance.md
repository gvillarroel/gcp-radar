...
url: https://docs.cloud.google.com/memorystore/docs/redis/reference/mcp/tools_list/upgrade_instance
...
Tool: upgrade_instance
Upgrade the version for a Memorystore for Redis instance.
The following sample demonstrate how to use curl to invoke the upgrade_instance MCP tool.
Curl Request
