...
url: https://docs.cloud.google.com/memorystore/docs/redis/reference/mcp/tools_list/import_instance
...
Tool: import_instance
Import a Redis Database (RDB) snapshot file from Cloud Storage into a Memorystore for Redis instance.
The following sample demonstrate how to use curl to invoke the import_instance MCP tool.
Curl Request
