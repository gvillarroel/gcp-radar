---
title: "Connect to a Redis instance from an App Engine flexible environment application\
  \ \_|\_ Memorystore for Redis \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/memorystore/docs/redis/connect-redis-instance-flex
...
Guides
Send feedback
Connect to a Redis instance from an App Engine flexible environment application
Stay organized with collections
Save and categorize content based on your preferences.
App Engine applications must be on the same authorized network as the Redis
instance in order to access it.
Setup
...
To access the Redis instance, the App Engine instance must be deployed
on the same authorized network as the Redis instance, and you must provide your
Redis instance's connection details. You can find your Redis instance's
authorized network, IP address, and port by running the following command:
gcloud redis instances describe [ INSTANCE_ID ] --region [REGION]
Create an
App Engine application .
Note: You can also use an existing App Engine application.
Update the app's configuration to specify the IP address, port, and
network of your Redis instance:
Go
...
for more details.
Java
Update the gae_flex_deployment/app.yaml file to specify
your Redis instance's network:
runtime : java
env : flex
# Update with Redis instance network name
network :
