...
url: https://docs.cloud.google.com/memorystore/docs/redis/reference/mcp/tools_list/failover_instance
...
The following sample demonstrate how to use curl to invoke the failover_instance MCP tool.
Curl Request
