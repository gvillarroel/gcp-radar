---
title: "Class CloudRedisClient (2.21.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/redis/latest/google.cloud.redis_v1.services.cloud_redis.CloudRedisClient
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the CloudRedisTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.redis_v1.types.CreateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.DeleteInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.ExportInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.FailoverInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.GetInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.GetInstanceAuthStringRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.ImportInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.ListInstancesRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.RescheduleMaintenanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.UpdateInstanceRequest , dict]
...
Description
request
Union[ google.cloud.redis_v1.types.UpgradeInstanceRequest , dict]
