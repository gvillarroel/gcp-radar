---
title: "Class ReadReplicasMode (2.21.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/redis/latest/google.cloud.redis_v1.types.Instance.ReadReplicasMode
