---
title: "Python Client for Cloud Redis \_|\_ Python client libraries \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/python/docs/reference/redis/latest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/redis/latest
  title: "Python Client for Cloud Redis \_|\_ Python client libraries \_|\_ Google\
    \ Cloud Documentation"
...
pip install google-cloud-redis
Next Steps
Read the Client Library Documentation for Cloud Redis
to see other available methods on the client.
Read the Cloud Redis Product documentation to learn
