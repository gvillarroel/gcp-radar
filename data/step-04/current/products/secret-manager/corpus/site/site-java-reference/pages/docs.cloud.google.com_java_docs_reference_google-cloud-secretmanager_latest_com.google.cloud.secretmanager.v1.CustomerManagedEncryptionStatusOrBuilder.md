---
title: "Interface CustomerManagedEncryptionStatusOrBuilder (2.88.0) \_|\_ Java client\
  \ libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-secretmanager/latest/com.google.cloud.secretmanager.v1.CustomerManagedEncryptionStatusOrBuilder
...
Client libraries
Send feedback
Interface CustomerManagedEncryptionStatusOrBuilder (2.88.0)
...
2.1.7
2.0.7
public interface CustomerManagedEncryptionStatusOrBuilder extends MessageOrBuilder
Implements
MessageOrBuilder
Methods
