---
title: "Class AccessSecretVersionRequest (2.88.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-secretmanager/latest/com.google.cloud.secretmanager.v1.AccessSecretVersionRequest
...
source_metadata:
  url: https://docs.cloud.google.com/java/docs/reference/google-cloud-secretmanager/latest/com.google.cloud.secretmanager.v1.AccessSecretVersionRequest
  title: "Class AccessSecretVersionRequest (2.88.0) \_|\_ Java client libraries \_\
...
Client libraries
Send feedback
Class AccessSecretVersionRequest (2.88.0)
...
2.1.7
2.0.7
public final class AccessSecretVersionRequest extends GeneratedMessage implements AccessSecretVersionRequestOrBuilder
Request message for
...
Static Methods
getDefaultInstance()
public static AccessSecretVersionRequest getDefaultInstance ()
Returns
Type
Description
AccessSecretVersionRequest
...
Descriptor
newBuilder()
public static AccessSecretVersionRequest . Builder newBuilder ()
Returns
Type
Description
AccessSecretVersionRequest.Builder
newBuilder(AccessSecretVersionRequest prototype)
public static AccessSecretVersionRequest . Builder newBuilder ( AccessSecretVersionRequest prototype )
Parameter
Name
Description
prototype
...
public static AccessSecretVersionRequest parseDelimitedFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AccessSecretVersionRequest parseDelimitedFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
IOException
parseFrom(byte[] data)
public static AccessSecretVersionRequest parseFrom ( byte [] data )
Parameter
Name
Description
data
...
public static AccessSecretVersionRequest parseFrom ( byte [] data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AccessSecretVersionRequest parseFrom ( ByteString data )
Parameter
Name
Description
data
...
public static AccessSecretVersionRequest parseFrom ( ByteString data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
public static AccessSecretVersionRequest parseFrom ( CodedInputStream input )
Parameter
Name
Description
input
...
public static AccessSecretVersionRequest parseFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AccessSecretVersionRequest parseFrom ( InputStream input )
Parameter
Name
Description
input
...
public static AccessSecretVersionRequest parseFrom ( InputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public static AccessSecretVersionRequest parseFrom ( ByteBuffer data )
Parameter
Name
Description
data
...
public static AccessSecretVersionRequest parseFrom ( ByteBuffer data , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
data
...
InvalidProtocolBufferException
parser()
public static Parser<AccessSecretVersionRequest> parser ()
Returns
Type
Description
Parser < AccessSecretVersionRequest >
Methods
equals(Object obj)
...
The bytes for name.
getParserForType()
public Parser<AccessSecretVersionRequest> getParserForType ()
Returns
Type
Description
Parser < AccessSecretVersionRequest >
...
GeneratedMessage.isInitialized()
newBuilderForType()
public AccessSecretVersionRequest . Builder newBuilderForType ()
Returns
Type
Description
AccessSecretVersionRequest.Builder
newBuilderForType(AbstractMessage.BuilderParent parent)
protected AccessSecretVersionRequest . Builder newBuilderForType ( AbstractMessage . BuilderParent parent )
Parameter
Name
Description
parent
...
toBuilder()
public AccessSecretVersionRequest . Builder toBuilder ()
Returns
Type
Description
AccessSecretVersionRequest.Builder
