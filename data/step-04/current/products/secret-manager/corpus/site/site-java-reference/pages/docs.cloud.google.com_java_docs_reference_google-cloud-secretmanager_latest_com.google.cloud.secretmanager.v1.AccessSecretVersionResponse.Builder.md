---
title: "Class AccessSecretVersionResponse.Builder (2.88.0) \_|\_ Java client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-secretmanager/latest/com.google.cloud.secretmanager.v1.AccessSecretVersionResponse.Builder
...
Client libraries
Send feedback
Class AccessSecretVersionResponse.Builder (2.88.0)
...
2.1.7
2.0.7
public static final class AccessSecretVersionResponse . Builder extends GeneratedMessage . Builder<AccessSecretVersionResponse . Builder > implements AccessSecretVersionResponseOrBuilder
...
Methods
build()
public AccessSecretVersionResponse build ()
Returns
Type
Description
AccessSecretVersionResponse
buildPartial()
public AccessSecretVersionResponse buildPartial ()
Returns
Type
Description
AccessSecretVersionResponse
clear()
public AccessSecretVersionResponse . Builder clear ()
Returns
Type
Description
AccessSecretVersionResponse.Builder
...
clearName()
public AccessSecretVersionResponse . Builder clearName ()
...
clearPayload()
public AccessSecretVersionResponse . Builder clearPayload ()
Secret payload
...
mergeFrom(AccessSecretVersionResponse other)
public AccessSecretVersionResponse . Builder mergeFrom ( AccessSecretVersionResponse other )
Parameter
Name
Description
other
...
public AccessSecretVersionResponse . Builder mergeFrom ( CodedInputStream input , ExtensionRegistryLite extensionRegistry )
Parameters
Name
Description
input
...
public AccessSecretVersionResponse . Builder mergeFrom ( Message other )
Parameter
Name
Description
other
...
public AccessSecretVersionResponse . Builder mergePayload ( SecretPayload value )
Secret payload
.google.cloud.secretmanager.v1.SecretPayload payload = 2;
Parameter
Name
...
public AccessSecretVersionResponse . Builder setName ( String value )
The resource name of the
SecretVersion in the format
projects/*/secrets/*/versions/* or
projects/*/locations/*/secrets/*/versions/* .
...
public AccessSecretVersionResponse . Builder setNameBytes ( ByteString value )
The resource name of the
SecretVersion in the format
projects/*/secrets/*/versions/* or
projects/*/locations/*/secrets/*/versions/* .
...
public AccessSecretVersionResponse . Builder setPayload ( SecretPayload value )
Secret payload
.google.cloud.secretmanager.v1.SecretPayload payload = 2;
Parameter
Name
...
public AccessSecretVersionResponse . Builder setPayload ( SecretPayload . Builder builderForValue )
Secret payload
.google.cloud.secretmanager.v1.SecretPayload payload = 2;
Parameter
Name
