---
title: "Class DeleteSecretRequest (2.27.0) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/secretmanager/latest/google.cloud.secretmanager_v1.types.DeleteSecretRequest
...
Client libraries
Send feedback
Class DeleteSecretRequest (2.27.0)
