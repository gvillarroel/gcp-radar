---
title: "Class DisableSecretVersionRequest (2.27.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/secretmanager/latest/google.cloud.secretmanager_v1.types.DisableSecretVersionRequest
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/secretmanager/latest/google.cloud.secretmanager_v1.types.DisableSecretVersionRequest
  title: "Class DisableSecretVersionRequest (2.27.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class DisableSecretVersionRequest (2.27.0)
