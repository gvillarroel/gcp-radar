---
title: "Python Client for Secret Manager \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/secretmanager/latest
...
pip install google-cloud-secret-manager
Next Steps
Read the Client Library Documentation for Secret Manager
to see other available methods on the client.
Read the Secret Manager Product documentation to learn
