---
title: "Class ClusterControllerAsyncClient (5.26.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.cluster_controller.ClusterControllerAsyncClient
...
Client libraries
Send feedback
Class ClusterControllerAsyncClient (5.26.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the ClusterControllerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.CreateClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.DeleteClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.DiagnoseClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.GetClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.ListClustersRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.StartClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.StopClusterRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.UpdateClusterRequest , dict]]
