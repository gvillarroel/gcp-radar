---
title: "Class SessionTemplateControllerClient (5.26.0) \_|\_ Python client libraries\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.session_template_controller.SessionTemplateControllerClient
...
Client libraries
Send feedback
Class SessionTemplateControllerClient (5.26.0)
...
The transport to use, or a Callable that constructs and returns a new transport. If a Callable is given, it will be called with the same set of initialization arguments as used in the SessionTemplateControllerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Union[ google.cloud.dataproc_v1.types.CreateSessionTemplateRequest , dict]
...
Description
request
Union[ google.cloud.dataproc_v1.types.DeleteSessionTemplateRequest , dict]
...
Description
request
Union[ google.cloud.dataproc_v1.types.GetSessionTemplateRequest , dict]
...
Description
request
Union[ google.cloud.dataproc_v1.types.ListSessionTemplatesRequest , dict]
...
Description
request
Union[ google.cloud.dataproc_v1.types.UpdateSessionTemplateRequest , dict]
