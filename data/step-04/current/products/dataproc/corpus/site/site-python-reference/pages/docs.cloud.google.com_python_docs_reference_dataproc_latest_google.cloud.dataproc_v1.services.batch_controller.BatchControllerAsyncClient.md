---
title: "Class BatchControllerAsyncClient (5.26.0) \_|\_ Python client libraries \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.batch_controller.BatchControllerAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.batch_controller.BatchControllerAsyncClient
  title: "Class BatchControllerAsyncClient (5.26.0) \_|\_ Python client libraries\
...
Client libraries
Send feedback
Class BatchControllerAsyncClient (5.26.0)
...
typing . Union [
str ,
google . cloud . dataproc_v1 . services . batch_controller . transports . base . BatchControllerTransport ,
typing . Callable [
[ ... ],
google . cloud . dataproc_v1 . services . batch_controller . transports . base . BatchControllerTransport ,
],
...
transport
Optional[Union[str,BatchControllerTransport,Callable[..., BatchControllerTransport]]]
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the BatchControllerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
batch_path
batch_path ( project : str , location : str , batch : str ) - > str
...
create_batch (
request : typing . Optional [
typing . Union [ google . cloud . dataproc_v1 . types . batches . CreateBatchRequest , dict ]
] = None ,
* ,
parent : typing . Optional [ str ] = None ,
batch : typing . Optional [ google . cloud . dataproc_v1 . types . batches . Batch ] = None ,
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.CreateBatchRequest , dict]]
...
Description
google.api_core.operation_async.AsyncOperation
An object representing a long-running operation. The result type for the operation will be Batch A representation of a batch workload in the service.
delete_batch
delete_batch (
request : typing . Optional [
typing . Union [ google . cloud . dataproc_v1 . types . batches . DeleteBatchRequest , dict ]
] = None ,
* ,
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.DeleteBatchRequest , dict]]
The request object. A request to delete a batch workload.
name
str
Required. The fully qualified name of the batch to retrieve in the format "projects/PROJECT_ID/locations/DATAPROC_REGION/batches/BATCH_ID" This corresponds to the name field on the request instance; if request is provided, this should not be set.
retry
google.api_core.retry_async.AsyncRetry
Designation of what errors, if any, should be retried.
timeout
...
get_batch (
request : typing . Optional [
typing . Union [ google . cloud . dataproc_v1 . types . batches . GetBatchRequest , dict ]
] = None ,
* ,
name : typing . Optional [ str ] = None ,
retry : typing . Optional [
...
timeout : typing . Union [ float , object ] = _MethodDefault . _DEFAULT_VALUE ,
metadata : typing . Sequence [ typing . Tuple [ str , typing . Union [ str , bytes ]]] = ()
) - > google . cloud . dataproc_v1 . types . batches . Batch
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.GetBatchRequest , dict]]
...
list_batches (
request : typing . Optional [
typing . Union [ google . cloud . dataproc_v1 . types . batches . ListBatchesRequest , dict ]
] = None ,
* ,
parent : typing . Optional [ str ] = None ,
retry : typing . Optional [
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.ListBatchesRequest , dict]]
...
Description
google.cloud.dataproc_v1.services.batch_controller.pagers.ListBatchesAsyncPager
A list of batch workloads. Iterating over this object will yield results and resolve additional pages automatically.
list_operations
list_operations (
request : typing . Optional [
...
parse_batch_path
parse_batch_path ( path : str ) - > typing . Dict [ str , str ]
