---
title: "Class JobControllerAsyncClient (5.26.0) \_|\_ Python client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.job_controller.JobControllerAsyncClient
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/dataproc/latest/google.cloud.dataproc_v1.services.job_controller.JobControllerAsyncClient
  title: "Class JobControllerAsyncClient (5.26.0) \_|\_ Python client libraries \_\
...
Client libraries
Send feedback
Class JobControllerAsyncClient (5.26.0)
...
The transport to use, or a Callable that constructs and returns a new transport to use. If a Callable is given, it will be called with the same set of initialization arguments as used in the JobControllerTransport constructor. If set to None, a transport is chosen automatically.
client_options
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.CancelJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.DeleteJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.GetJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.ListJobsRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.SubmitJobRequest , dict]]
...
Description
request
Optional[Union[ google.cloud.dataproc_v1.types.UpdateJobRequest , dict]]
