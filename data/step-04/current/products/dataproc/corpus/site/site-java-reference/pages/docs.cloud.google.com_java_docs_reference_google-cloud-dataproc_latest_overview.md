---
title: "google-cloud-dataproc overview (4.85.0) \_|\_ Java client libraries \_|\_\
  \ Google Cloud Documentation"
url: https://docs.cloud.google.com/java/docs/reference/google-cloud-dataproc/latest/overview
...
Client libraries
Send feedback
google-cloud-dataproc overview (4.85.0)
...
Version ID : The version of the Cloud service itself (e.g. Dataproc). New Version IDs are introduced infrequently, and often involve
