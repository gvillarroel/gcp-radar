---
title: "Method: projects.locations.autoscalingPolicies.create \_|\_ Managed Service\
  \ for Apache Spark \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dataproc/docs/reference/rest/v1/projects.locations.autoscalingPolicies/create
...
Reference
Send feedback
Method: projects.locations.autoscalingPolicies.create
...
HTTP request
POST https://dataproc.googleapis.com/v1/{parent=projects/*/locations/*}/autoscalingPolicies
...
Response body
If successful, the response body contains a newly created instance of AutoscalingPolicy .
Authorization scopes
