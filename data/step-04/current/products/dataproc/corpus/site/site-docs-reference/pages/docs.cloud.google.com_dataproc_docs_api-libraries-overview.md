---
title: "Overview of APIs and Client Libraries \_|\_ Managed Service for Apache Spark\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dataproc/docs/api-libraries-overview
...
Note: Although the Cloud Client Libraries are the preferred library choice,
Google API Client Libraries
for Managed Service for Apache Spark
are also available. These "legacy" libraries access REST but not gRPC
APIs (see Google API Client Libraries for additional information).
