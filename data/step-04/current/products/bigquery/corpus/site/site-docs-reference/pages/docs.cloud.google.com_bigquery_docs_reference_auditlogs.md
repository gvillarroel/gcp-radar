---
title: "BigQuery audit logs overview \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigquery/docs/reference/auditlogs
...
DATA_READ
google.cloud.bigquery.v2.JobService.GetQueryResults google.cloud.bigquery.v2.TableDataService.List
...
Permissions : bigquery.datasets.delete - ADMIN_WRITE
...
Audit log type : Admin activity
Permissions : bigquery.datasets.create - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.datasets.update - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Data access
Permissions : bigquery.tables.getData - DATA_READ
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Data access
Permissions : bigquery.jobs.create - ADMIN_WRITE
...
Audit log type : Admin activity
Permissions : bigquery.routines.delete - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.routines.create - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.rowAccessPolicies.create - ADMIN_WRITE
...
Audit log type : Admin activity
Permissions : bigquery.rowAccessPolicies.delete - ADMIN_WRITE
bigquery.rowAccessPolicies.setIamPolicy - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.rowAccessPolicies.setIamPolicy - PERMISSION_TYPE_UNSPECIFIED
...
Audit log type : Admin activity
Permissions : bigquery.tables.delete - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.tables.create - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.tables.update - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : bigquery.tables.setIamPolicy - ADMIN_WRITE
Method is a long-running or streaming operation :
No.
Filter for this method :
...
For more information, see Truncated log entry .
Message Formats
AuditData format
The AuditData
...
advanced log filter documentation .
...
modifications. Before you run this example, define a log sink
