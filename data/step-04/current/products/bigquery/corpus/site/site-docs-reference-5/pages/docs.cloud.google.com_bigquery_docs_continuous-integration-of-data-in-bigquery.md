---
title: "Continuous data integration in BigQuery \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigquery/docs/continuous-integration-of-data-in-bigquery
...
integration:
Data testing: Are you able to verify that the data you have
...
Data lineage: Are you able to see any table in its context? For
...
Data definition language (DDL) : These assets are used for defining
the schema of tables and views.
Data manipulation language (DML) : These assets are used for
...
What's next
Read about BigQuery table snapshots in Introduction to table snapshots .
Learn more about continuous integration for software development in DevOps tech: Continuous integration .
