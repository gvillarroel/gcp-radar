---
title: "EFFECTIVE_PROJECT_OPTIONS view \_|\_ BigQuery \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigquery/docs/information-schema-effective-project-options
...
INT64
The effective default query timeout in milliseconds for this
project.
default_interactive_query_queue_timeout_ms
STRING
The effective default timeout in milliseconds for queued interactive
queries for this project.
default_batch_query_queue_timeout_ms
STRING
The effective default timeout in milliseconds for queued batch queries
for this project.
