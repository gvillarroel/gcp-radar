---
title: "Forecast multiple time series with an ARIMA_PLUS univariate model \_|\_ BigQuery\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial
...
source_metadata:
  url: https://docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial
  title: "Forecast multiple time series with an ARIMA_PLUS univariate model \_|\_\
...
ARIMA_PLUS univariate time series model to forecast the future value of a given
...
Retrieving the forecasted bike ride information from the model by using the
...
show_all_candidate_model argument to TRUE .
BigQuery DataFrames
Before trying this sample, follow the BigQuery DataFrames
setup instructions in the BigQuery quickstart
using BigQuery DataFrames .
