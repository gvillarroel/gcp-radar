---
title: "Committed use discounts \_|\_ BigQuery \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/bigquery/docs/bigquery-cud
...
Important: This page describes committed use discounts for
BigQuery PAYG capacity. For information about other
Google Cloud CUDs, see
Committed use discounts .
...
Regions: You purchase spend-based CUDs for individual regions. If you're running in
multiple regions, calculate and purchase spend-based CUDs in each separate region.
Projects: Determine the consistent hourly PAYG slot usage per project.
BigQuery capabilities: Spend-based CUDs work across all
BigQuery PAYG SKUs.
...
expected minimum expenditure on BigQuery capacity. For more
information, see
...
BigQuery spend-based CUDs apply only to the PAYG capacity of the features
previously listed.
...
BigQuery pricing . The discounts are the
