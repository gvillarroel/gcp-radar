---
title: "Resources \_|\_ Cloud Deployment Manager \_|\_ Google Cloud Documentation"
...
Quotas & Limits
Learn about quotas and limits related to Deployment Manager.
Release Notes
Periodic release notes related to Deployment Manager.
API Reference
Reference docs for the Deployment Manager API.
Open source examples
Cloud Foundation Toolkit templates
A set of production-ready resource templates that you can use for your
deployments.
Sample template repository
A collection of example templates created by Google and the community.
Send feedback
