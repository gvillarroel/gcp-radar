---
title: "Getting support \_|\_ Cloud Deployment Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/deployment-manager/docs/getting-support
...
Ask a question about Deployment Manager on
Stack Overflow .
Use the tag google-deployment-manager for questions about
Deployment Manager. This tag not only receives responses from the
Stack Overflow community, but also from Google engineers, who monitor the tag
and offer unofficial support.
Discuss Deployment Manager
Visit the Google Cloud
Slack community to discuss
Deployment Manager and other Google Cloud products. If you haven't
already joined,
use this form to sign up .
For Deployment Manager, join the
#deployment-manager
channel.
File bugs or feature requests
From the Deployment Manager documentation, click "Send feedback" near the
top right of the page. This will open a feedback form. Your comments will be
reviewed by the Deployment Manager team.
Send feedback
