---
title: "Deployments: update \_|\_ Cloud Deployment Manager \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/deployment-manager/docs/reference/latest/deployments/update
...
" ACQUIRE ": Acquires an existing resource. If the resource does not exist, the deployment will fail.
