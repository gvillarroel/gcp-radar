---
title: "Audit logging of Google services used by Cloud Service Mesh \_|\_ Cloud Service\
  \ Mesh v1.20 \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/service-mesh/v1.20/docs/audit-logging
...
source_metadata:
  url: https://docs.cloud.google.com/service-mesh/v1.20/docs/audit-logging
  title: "Audit logging of Google services used by Cloud Service Mesh \_|\_ Cloud\
    \ Service Mesh v1.20 \_|\_ Google Cloud Documentation"
...
Audit logging of Google services used by Cloud Service Mesh
This document describes the audit logs created by Cloud Service Mesh as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Cloud Service Mesh:
...
type in Cloud Service Mesh:
Audit logs category
Service name
Cloud Service Mesh operations
Admin Activity audit logs
meshca.googleapis.com
meshca.createCertificate
Admin Activity audit logs
meshconfig.googleapis.com
Admin.Initialize Admin.RunIstiod
Data Access audit logs
meshconfig.googleapis.com
...
Service name
Cloud Service Mesh audit logs use the service names
meshca.googleapis.com and meshconfig.googleapis.com .
...
Resource types
Cloud Service Mesh audit logs use the resource type
