---
title: "Reporting & Monitoring Overview \_|\_ Places API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/places/web-service/report-monitor
...
Page Summary
outlined_flag
Regularly review Google Maps Platform API usage, quota, and billing information to measure consumption, stay within limits, control costs, and identify unexpected interactions.
Google Maps Platform provides Reporting and Monitoring tools to help you review this data, allowing you to track API usage, quotas, and billing details.
Reporting offers predefined visual reports in the Cloud console for basic usage, quota, and billing insights, while Monitoring enables customized dashboards and alerts for deeper analysis.
Use Monitoring to create alerts for specific metrics like API usage or quota limits, ensuring timely notification of potential issues.
