---
title: "Autocomplete (New) and session pricing \_|\_ Places API \_|\_ Google for Developers"
...
source_metadata:
  url: https://developers.google.com/maps/documentation/places/web-service/session-pricing
  title: "Autocomplete (New) and session pricing \_|\_ Places API \_|\_ Google for\
    \ Developers"
...
Without sessions, each Autocomplete (New) request is billed individually.
Select platform:
Android
iOS
JavaScript
