---
title: "Support Options for Places API \_|\_ Google for Developers"
...
Resources
Send feedback
Support Options for Places API
Stay organized with collections
Save and categorize content based on your preferences.
Page Summary
outlined_flag
Google Maps Platform API support is available through community channels (Stack Overflow, Issue Tracker) and the Google Maps Support team.
Premium Plan users have access to enterprise-level support with faster response times and additional services.
Users can report bugs, request features, and find solutions to common issues using the provided resources.
Support cases can be created for issues requiring direct assistance from the Google Maps Support team.
Detailed information on support levels, response times, and case management is available in the Google Cloud Console.
Get help
...
Google Maps Platform Premium Plan customers , in addition to the
community support channels, you have access to
...
Stack Overflow
to field technical questions about the Places API. Stack Overflow is a
...
and Google Places related tags on Stack Overflow. You can look for Places API-specific
topics by adding
google-places-api+web-services . You can look for Google Maps Platform APIs topics
by adding
...
you would like to share with the Google Maps Platform APIs team, please file a bug or
feature request in our
issue tracker .
Bugs
If you think the cause of a problem is a bug in the Places API, report it on
...
[[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-04-09 UTC."],[],["Google Maps Platform support includes community help via Stack Overflow, using specific tags for APIs. The Issue Tracker handles bug reports and feature requests, with status codes indicating progress. Direct support is accessed through the Google Cloud Console, with Enhanced Support offering faster response times and escalation. Billing support is separate. Project roles, such as Owner and Editor, define case creation permissions. Enhanced Support provides additional features like video conferencing, map issue assistance, and SLA incident reports. Response times vary by issue severity, and data privacy inquiries are handled separately.\n"]]
