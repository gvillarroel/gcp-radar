---
title: "Package google.maps.places.v1 \_|\_ Places API \_|\_ Google for Developers"
url: https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1
...
Requests and responses are structured with specific fields, and the document details these fields, their types, and purpose for effective API utilization.
Enums define values for containment, relationships, and travel modes, while concepts like address descriptors, landmarks, and attributions provide location context.
Developers can use this technical reference to understand the API's structure, data elements, and integration processes for seamless implementation.
Comprehensive Place data includes details like name, address, photos, reviews, opening hours, and more, enabling rich location-based experiences.
Index
Places (interface)
...
Place.ConsumerAlert (message)
Place.ConsumerAlert.Details (message)
Place.ConsumerAlert.Details.Link (message)
...
[[["Easy to understand","easyToUnderstand","thumb-up"],["Solved my problem","solvedMyProblem","thumb-up"],["Other","otherUp","thumb-up"]],[["Missing the information I need","missingTheInformationINeed","thumb-down"],["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"],["Out of date","outOfDate","thumb-down"],["Samples / code issue","samplesCodeIssue","thumb-down"],["Other","otherDown","thumb-down"]],["Last updated 2026-03-18 UTC."],[],["The Places API provides detailed information about locations and enables location-based searches using RPC. Key actions include retrieving place details (`GetPlace`), finding nearby locations (`SearchNearby`), searching by text (`SearchText`), and getting place suggestions (`AutocompletePlaces`). Requests utilize messages, enums, and field masks to specify desired data. The API also supports fetching photos, EV charging details, fuel information, user reviews, route modifiers, and accessibility data. Search results can be refined by region, ranking preference, place type, and operational status.\n"]]
