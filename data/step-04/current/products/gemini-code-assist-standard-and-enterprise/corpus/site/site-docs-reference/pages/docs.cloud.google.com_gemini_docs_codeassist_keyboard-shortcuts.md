---
title: "Keyboard shortcuts for Gemini Code Assist features \_|\_ Gemini for Google\
  \ Cloud \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts
...
Option+G
Add
selected code snippet to Gemini Chat context
Control+Alt+X
Command+Alt+X
Finish code
changes in a file
...
Keyboard shortcut (Windows/Linux)
Keyboard shortcut (macOS)
Add the current highlighted terminal content to the Gemini Chat context
Control+Alt+X
Command+Alt+X
IntelliJ
