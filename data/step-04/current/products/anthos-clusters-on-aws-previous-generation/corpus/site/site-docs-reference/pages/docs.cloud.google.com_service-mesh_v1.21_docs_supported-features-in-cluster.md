---
title: "In-cluster control plane supported features \_|\_ Cloud Service Mesh v1.21\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/service-mesh/v1.21/docs/supported-features-in-cluster
...
1.21.5 with an in-cluster control plane. To see the supported
features for Cloud Service Mesh 1.21.5 with a managed control
plane instead, see
...
Cloud Service Mesh 1.19 or later. For information on how to
...
available or it isn't supported in Cloud Service Mesh 1.21.5.
