---
title: "Delete a cluster \_|\_ GKE on AWS \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/aws/how-to/delete-cluster
...
Warning: Soon after you delete a Google Cloud project, the resources in
AWS are permanently deleted. To safeguard against the accidental
deletion of a Google Cloud project, use a
Project lien .
Delete a node pool
...
Note: To delete a cluster, you must have the
GKE Multi-Cloud API role
configured to allow the GKE Multi-Cloud API to manage your cluster
resources. If this role is not properly configured, GKE cannot delete
