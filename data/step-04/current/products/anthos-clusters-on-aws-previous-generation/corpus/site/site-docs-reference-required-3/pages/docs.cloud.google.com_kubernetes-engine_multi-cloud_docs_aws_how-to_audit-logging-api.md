---
title: "Cloud Audit Logs API \_|\_ GKE on AWS \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/aws/how-to/audit-logging-api
...
This document describes the audit logs created by GKE on AWS as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for GKE on AWS:
...
type in GKE on AWS:
Audit logs category
GKE on AWS operations
Admin Activity audit logs
CreateAWSCluster UpdateAWSCluster DeleteAWSCluster CreateAWSNodePool DeleteAWSNodePool
Data Access audit logs
GetAWSCluster ListAWSClusters GenerateAWSAccessToken GetAWSNodePool ListAWSNodePools GetAWSServerConfig
Audit log format
...
Service name
GKE on AWS audit logs use the service name
...
Resource types
GKE on AWS audit logs use the resource type
