---
title: "EQUALS_IGNORE_CASE function \_|\_ Application Integration \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/application-integration/docs/reference/data-mapping-reference/equals-ignore-case-function-reference
...
EQUALS_IGNORE_CASE(value)
Value to compare.
A boolean. Returns TRUE if the specified value matches the existing value (ignoring case)
and FALSE otherwise.
Supported data type
