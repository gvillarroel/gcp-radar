---
title: "Locations supported for data transfer \_|\_ Network Connectivity Center \_\
  |\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/network-connectivity/docs/network-connectivity-center/concepts/locations
...
source_metadata:
  url: https://docs.cloud.google.com/network-connectivity/docs/network-connectivity-center/concepts/locations
  title: "Locations supported for data transfer \_|\_ Network Connectivity Center\
...
If you want to use site-to-site-data-transfer, you must create the
Network Connectivity Center (NCC) spokes in regions that support this feature.
Supported regions include all of those in the following countries:
Africa
South Africa
APAC
Australia, India, Indonesia, Japan, Korea, Singapore, Taiwan
Europe
...
South America
Brazil, Chile
Any restrictions on the use of telecommunications services in your customer
agreement are not applicable to the use of NCC's data transfer
functionality in these locations.
In Japan, NCC is provided through Google Connect Asia
Pacific Pte Ltd.
Locations table
For information about which regions and zones support data transfer, see the
following table.
Africa
APAC
Europe
...
NCC overview .
For information about NCC pricing, see
Pricing .
Send feedback
