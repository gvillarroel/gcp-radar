---
title: "Cloud SQL for PostgreSQL \_|\_ Integration Connectors \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/integration-connectors/docs/connectors/cloudsqlforpostgresql/configure
...
source_metadata:
  url: https://docs.cloud.google.com/integration-connectors/docs/connectors/cloudsqlforpostgresql/configure
  title: "Cloud SQL for PostgreSQL \_|\_ Integration Connectors \_|\_ Google Cloud\
    \ Documentation"
...
TimescaleDB
Before you begin
Before using the Cloud SQL for PostgreSQL connector, do the following tasks:
...
Create a service account for the connector, if you haven't already created one. The connector and the service account must belong to the same project. For more
information, see
...
Connector : Select Cloud SQL for PostgreSQL from the drop down list of available Connectors.
...
Browsable Schemas : Enter a comma-separated list of schemas for the connector to access. For example, SchemaA,SchemaB,SchemaC .
...
The following authentication types are supported by the Cloud SQL for PostgreSQL connection:
...
System limitations
The Cloud SQL for PostgreSQL connector can process 9 transaction per second,
per node ,
...
Use the Cloud SQL for PostgreSQL connection in an integration
...
See also the Perform CRUD operations on a MySQL database tutorial
that shows how to create a MySQL connection and use it in an integration to perform read and write operations.
