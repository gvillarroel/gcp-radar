---
title: "BigCommerce \_|\_ Integration Connectors \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/integration-connectors/docs/connectors/bigcommerce/configure
...
BigCommerce
The BigCommerce connector lets you perform insert, delete, update, and read operations on BigCommerce dataset.
Before you begin
Before using the BigCommerce connector, do the following tasks:
...
Connector : Select BigCommerce from the drop down list of available Connectors.
...
Click NEXT .
In the Authentication section, enter the authentication details, and then click NEXT .
To understand how to configure these authentication types, see Configure authentication .
Review : Review your connection and authentication details.
Click Create .
Configure authentication
Enter the details based on the authentication you want to use.
Client ID : The client ID provided by BigCommerce for the connected app you created.
Client secret : Secret Manager Secret containing the client secret for the connected app you created.
OAuth Access Token : Secret Manager Secret containing OAuth access token provided by BigCommerce for the connected app you created.
Store ID : ID of the store provided by BigCommerce.
Account UUID : Account UUID of the account provided by BigCommerce.
Account Access Token : Account access token of the store provided by BigCommerce.
Create client credentials and access token
Sign in to your BigCommerce admin panel.
Select Advanced Settings > API accounts .
Click Create API Account .
Select V2/V3 API Token in the dialog.
Enter the account name.
Copy the Store ID from the API Path field for later use when you configure authentication for the connection.
Example API path: https://api.bigcommerce.com/stores/ STORE_ID /v3 .
Select the OAuth scopes for the API account.
Click Save .
From the dialog that appears, copy the Client ID , Client secret , and Access Token for later use when you configure authentication for the connection.
...
System limitations
The BigCommerce connector can process 10 transaction per second,
per node ,
...
Known issues
Creation of Orders and OrderShipments isn't supported.
...
Use the BigCommerce connection in an integration
