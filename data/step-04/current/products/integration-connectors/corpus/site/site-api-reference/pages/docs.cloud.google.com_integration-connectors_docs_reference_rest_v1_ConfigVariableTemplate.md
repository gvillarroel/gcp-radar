---
title: "ConfigVariableTemplate \_|\_ Integration Connectors \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/integration-connectors/docs/reference/rest/v1/ConfigVariableTemplate
...
"enumSource" : enum ( EnumSource ) ,
"multipleSelectConfig" : {
object ( MultipleSelectConfig )
}
}
Fields
key
