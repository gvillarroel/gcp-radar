---
title: "Authenticate to Cloud DNS \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/dns/docs/authentication
...
Reference
Send feedback
Authenticate to Cloud DNS
Stay organized with collections
Save and categorize content based on your preferences.
This document describes how to authenticate to Cloud DNS programmatically. How
you authenticate to Cloud DNS depends on the interface you use to access the API
and the environment where your code is running.
For more information about Google Cloud authentication, see the
Authentication methods .
API access
Cloud DNS supports programmatic access. You can access the API in
the following ways:
Client libraries
Google Cloud CLI
REST
Client libraries
The Cloud DNS client libraries provide
high-level language support for authenticating to Cloud DNS
programmatically.
...
For more information about using the gcloud CLI with Cloud DNS,
see the Google Cloud CLI CLI reference pages .
REST
...
Set up authentication for Cloud DNS
...
Access control for Cloud DNS
After you authenticate to Cloud DNS, you must be authorized to access
Google Cloud resources. Cloud DNS uses
Identity and Access Management (IAM) for authorization.
For more information about the roles for Cloud DNS, see
