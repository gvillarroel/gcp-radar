---
title: "Class ResourceRecordSet (0.36.1) \_|\_ Python client libraries \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/dns/latest/google.cloud.dns.resource_record_set.ResourceRecordSet
...
Client libraries
Send feedback
Class ResourceRecordSet (0.36.1)
