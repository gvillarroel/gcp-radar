---
title: "Get support \_|\_ GKE on Azure \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/azure/getting-support
...
procedures:
GKE on Azure issues and feature requests : If you experience
...
Documentation issues : From the GKE on Azure documentation,
...
GKE on Azure documentation team.
Billing questions
...
For the list of the Kubernetes versions that GKE on Azure supports,
see
...
versions that GKE on Azure supports, see
Kubernetes version notes .
