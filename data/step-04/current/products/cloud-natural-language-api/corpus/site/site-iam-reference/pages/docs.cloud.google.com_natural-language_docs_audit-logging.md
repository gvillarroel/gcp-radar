---
title: "Natural Language audit logging \_|\_ Cloud Natural Language API \_|\_ Google\
  \ Cloud Documentation"
url: https://docs.cloud.google.com/natural-language/docs/audit-logging
...
This document describes the audit logs created by Cloud Natural Language as part of
Cloud Audit Logs .
Overview
...
The following types of audit logs are available for Natural Language:
...
You can't disable Data Access audit logs. However, you can
disable
the _Default sink for Cloud Logging, which
prevents these audit logs from being stored.
...
LanguageService.AnalyzeSentiment LanguageService.AnalyzeEntitySentiment LanguageService.AnalyzeEntities LanguageService.AnalyzeSyntax LanguageService.ClassifyText LanguageService.ModerateText LanguageService.AnnotateText
Audit log format
...
Service name
Natural Language audit logs use the service name
...
Resource types
Natural Language audit logs use the resource type
