---
title: "Language Support \_|\_ Cloud Natural Language API \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/natural-language/docs/languages
...
These languages are specified within a request using the optional language
