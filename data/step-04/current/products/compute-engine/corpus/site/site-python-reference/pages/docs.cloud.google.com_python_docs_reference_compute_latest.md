...
url: https://docs.cloud.google.com/python/docs/reference/compute/latest
...
This library has now grown in size past the JetBrains default size limit of ~2.5Mb .
...
pip install google-cloud-compute
Next Steps
Read the Client Library Documentation for Compute Engine
to see other available methods on the client.
Read the Compute Engine Product documentation to learn
