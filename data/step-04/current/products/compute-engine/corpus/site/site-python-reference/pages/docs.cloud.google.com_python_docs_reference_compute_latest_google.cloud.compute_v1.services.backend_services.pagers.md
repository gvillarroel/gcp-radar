---
title: "Module pagers (1.41.0) \_|\_ Python client libraries \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/python/docs/reference/compute/latest/google.cloud.compute_v1.services.backend_services.pagers
...
source_metadata:
  url: https://docs.cloud.google.com/python/docs/reference/compute/latest/google.cloud.compute_v1.services.backend_services.pagers
  title: "Module pagers (1.41.0) \_|\_ Python client libraries \_|\_ Google Cloud\
    \ Documentation"
...
All the usual BackendServiceAggregatedList
...
through the items field on the
corresponding responses.
All the usual BackendServiceList
attributes are available on the pager. If multiple requests are made, only
the most recent response is retained, and thus used for attribute lookup.
ListUsablePager
ListUsablePager (
...
through the items field on the
corresponding responses.
All the usual BackendServiceListUsable
attributes are available on the pager. If multiple requests are made, only
the most recent response is retained, and thus used for attribute lookup.
Send feedback
