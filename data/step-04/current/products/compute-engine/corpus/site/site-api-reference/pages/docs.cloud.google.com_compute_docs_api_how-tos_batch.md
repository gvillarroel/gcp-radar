---
title: "Batching requests \_|\_ Compute Engine \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/compute/docs/api/how-tos/batch
...
Note : The batch system for the Compute Engine API uses the same syntax as the OData batch processing system, but the semantics differ.
Batch details
