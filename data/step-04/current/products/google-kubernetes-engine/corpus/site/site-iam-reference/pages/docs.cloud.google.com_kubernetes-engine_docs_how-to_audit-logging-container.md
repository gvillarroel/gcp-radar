---
title: "Google Kubernetes Engine audit logging \_|\_ GKE security \_|\_ Google Cloud\
  \ Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/docs/how-to/audit-logging-container
...
This document describes audit logging for Google Kubernetes Engine. Google Cloud services
...
Service name
Google Kubernetes Engine audit logs use the service name container.googleapis.com .
...
Google Kubernetes Engine generates an audit log whose category is dependent on the
...
Permissions : container.clusters.update - ADMIN_WRITE
...
Permissions : container.clusters.get - ADMIN_READ
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Admin activity
Permissions : container.clusters.create - ADMIN_WRITE
Method is a long-running or streaming operation :
Long-running operation
Filter for this method :
...
Audit log type : Admin activity
Permissions : container.clusters.delete - ADMIN_WRITE
Method is a long-running or streaming operation :
Long-running operation
Filter for this method :
...
Audit log type : Data access
Permissions : container.operations.get - ADMIN_READ
Method is a long-running or streaming operation :
No.
Filter for this method :
...
Audit log type : Data access
Permissions : container.clusters.list - ADMIN_READ
Method is a long-running or streaming operation :
No.
Filter for this method :
protoPayload.methodName="google.container.v1.ClusterManager.GetServerConfig"
ListClusters
...
Audit log type : Data access
Permissions : container.operations.list - ADMIN_READ
Method is a long-running or streaming operation :
No.
Filter for this method :
...
No.
Filter for this method :
protoPayload.methodName="google.container.v1beta1.ClusterManager.GetServerConfig"
ListClusters
