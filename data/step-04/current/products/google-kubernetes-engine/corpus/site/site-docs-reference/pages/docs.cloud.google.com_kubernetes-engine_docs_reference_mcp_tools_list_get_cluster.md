...
url: https://docs.cloud.google.com/kubernetes-engine/docs/reference/mcp/tools_list/get_cluster
...
Input Schema
MCPGetClusterRequest gets the settings of a cluster.
MCPGetClusterRequest
JSON representation
{
"name" : string ,
"readMask" : string
