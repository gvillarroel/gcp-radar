---
title: "API permissions \_|\_ Google Kubernetes Engine (GKE) \_|\_ Google Cloud Documentation"
...
source_metadata:
  url: https://docs.cloud.google.com/kubernetes-engine/docs/reference/api-permissions
  title: "API permissions \_|\_ Google Kubernetes Engine (GKE) \_|\_ Google Cloud\
    \ Documentation"
...
Some parts of the Google Kubernetes Engine (GKE) API
and the Kubernetes API
require additional permissions before you can use them. Those permissions are
...
Warning: The list below includes several deprecated API methods that are not supported in
Kubernetes 1.16 and later. See
