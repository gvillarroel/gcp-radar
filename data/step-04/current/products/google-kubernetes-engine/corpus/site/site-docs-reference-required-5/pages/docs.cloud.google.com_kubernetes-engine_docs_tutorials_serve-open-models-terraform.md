---
title: "Serve open LLMs on GKE with a pre-configured architecture \_|\_ GKE AI/ML\
  \ \_|\_ Google Cloud Documentation"
url: https://docs.cloud.google.com/kubernetes-engine/docs/tutorials/serve-open-models-terraform
...
models (LLMs) on GKE for inference by using a pre-configured,
...
In this guide, you deploy and serve LLMs using single-host GPU nodes on
...
(such as Gemma or Llama) on their respective Hugging Face model page.
...
For a detailed analysis of model serving performance and costs for these opens
models, you can also use the GKE Inference Quickstart tool. To
learn more, see the GKE Inference Quickstart guide and the accompanying Colab notebook .
Before you begin
...
roles/container.clusterAdmin, roles/iam.roleAdmin, roles/iam.serviceAccountAdmin,
roles/resourcemanager.projectIamAdmin, roles/serviceusage.serviceUsageAdmin, and
...
You can serve models using GPUs in a GKE Autopilot or Standard cluster. An
...
For additional configurations, including other model variants and GPU types,
