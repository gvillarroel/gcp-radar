...
The security report must expose promoted feature artifact links for every
feature that carries security capability signals, and must preserve official
Google evidence links for those signals when they exist in promoted feature
cards.
