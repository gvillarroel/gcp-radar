# Worker availability in Jakarta (asia-southeast2)

Product: Dataflow
Feature slug: `worker-availability-in-jakarta-asia-southeast2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

This feature lets Dataflow use workers in zones in the Jakarta region asia-southeast2.
