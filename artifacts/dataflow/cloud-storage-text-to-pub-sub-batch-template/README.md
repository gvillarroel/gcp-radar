...
Product: Dataflow
Feature slug: `cloud-storage-text-to-pub-sub-batch-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

This Google-provided batch template publishes text data from Cloud Storage to Pub/Sub; This Google-provided streaming template publishes text data from Cloud Storage to Pub/Sub.
...
- [https://docs.cloud.google.com/dataflow/docs/guides/templates/provided/cloud-storage-to-pubsub](https://docs.cloud.google.com/dataflow/docs/guides/templates/provided/cloud-storage-to-pubsub)
