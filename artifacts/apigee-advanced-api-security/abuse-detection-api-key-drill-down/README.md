# Abuse Detection API key drill-down

Product: Apigee Advanced API Security
Feature slug: `abuse-detection-api-key-drill-down`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Abuse Detection preview now supports API key drill-down details so detected abuse can be analyzed by the API key involved.
