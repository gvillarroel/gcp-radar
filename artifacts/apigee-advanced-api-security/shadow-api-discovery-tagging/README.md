# Shadow API Discovery tagging

Product: Apigee Advanced API Security
Feature slug: `shadow-api-discovery-tagging`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Shadow API Discovery in preview now supports tags to label and organize API observation results.
...
- [https://docs.cloud.google.com/apigee/docs/apihub/attach-manage-tags](https://docs.cloud.google.com/apigee/docs/apihub/attach-manage-tags)
