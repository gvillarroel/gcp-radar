...
Feature slug: `automatic-scaling-target-cpu-utilization-setting`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Automatic scaling supports a target CPU utilization setting to tune the balance between latency and cost.
