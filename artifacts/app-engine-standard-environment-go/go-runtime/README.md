...
The App Engine standard Go runtime provides managed execution for Go applications; The App Engine standard Go runtime provides managed execution for Go applications.
