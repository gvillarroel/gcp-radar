...
Feature slug: `custom-domain-and-ssl-certificate-management`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Admin API and gcloud tool added beta support for creating and managing custom domains and SSL certificates.
