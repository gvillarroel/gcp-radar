...
The App Engine standard environment supports deploying applications with the Go 1.16 runtime; The App Engine standard environment supports deploying applications with the Go 1.16 runtime.
