...
Feature slug: `cpu-utilization-metric`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

App Engine standard environment provides a CPU Utilization metric showing average CPU usage across active instances.
