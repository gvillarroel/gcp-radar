# Region availability: europe-central2

Product: App Engine flexible environment Ruby
Feature slug: `region-availability-europe-central2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

App Engine flexible environment Ruby is available in the europe-central2 region.
