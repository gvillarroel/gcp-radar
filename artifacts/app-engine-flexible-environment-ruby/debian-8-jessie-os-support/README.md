# Debian 8 Jessie OS support

Product: App Engine flexible environment Ruby
Feature slug: `debian-8-jessie-os-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

App Engine flexible environment applications could run on the Debian 8 Jessie operating system; deprecated on 2018-05-30.
