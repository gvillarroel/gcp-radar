# Enterprise Search extractive segment confidence scores

Product: Vertex AI Search
Feature slug: `enterprise-search-extractive-segment-confidence-scores`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Enterprise Search now provides confidence scores for extractive segments in allowlist preview, based on similarity between the query and the extracted segment.
