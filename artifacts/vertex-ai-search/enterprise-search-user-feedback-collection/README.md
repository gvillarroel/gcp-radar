...
Feature slug: `enterprise-search-user-feedback-collection`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Enables collecting user feedback on Enterprise Search widget results using thumbs-up and thumbs-down ratings, with optional dislike reasons.
