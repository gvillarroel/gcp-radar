# Vertex AI Search chunk page-span metadata

Product: Vertex AI Search
Feature slug: `vertex-ai-search-chunk-page-span-metadata`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds page-span information to chunk metadata in search responses to show where each chunk appears in the source document.
