# Vertex AI Search media search supported languages

Product: Vertex AI Search
Feature slug: `vertex-ai-search-media-search-supported-languages`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Search for media now supports media search in Arabic, English, French, German, Hindi, Korean, Japanese, Portuguese, and Spanish.
