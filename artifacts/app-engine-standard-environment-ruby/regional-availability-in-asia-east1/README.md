# Regional availability in asia-east1

Product: App Engine standard environment Ruby
Feature slug: `regional-availability-in-asia-east1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Regional availability in asia-east1 lets you create and run App Engine applications in the Taiwan region.
