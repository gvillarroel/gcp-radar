# Regional availability in asia-east2

Product: App Engine standard environment Ruby
Feature slug: `regional-availability-in-asia-east2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Regional availability in asia-east2 lets you create and run App Engine applications in the Hong Kong region.
