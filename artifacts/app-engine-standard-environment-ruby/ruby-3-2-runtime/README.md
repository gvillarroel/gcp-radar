...
Feature slug: `ruby-3-2-runtime`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Ruby 3.2 runtime support lets App Engine standard environment run Ruby 3.2 applications; Ruby 3.2 runtime support lets App Engine standard environment run Ruby 3.2 applications.
