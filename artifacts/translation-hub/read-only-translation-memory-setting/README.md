# Read-only translation memory setting

Product: Translation Hub
Feature slug: `read-only-translation-memory-setting`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Administrators can mark translation memories as read-only in Translation Hub.
