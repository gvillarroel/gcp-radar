# Direct event triggers from Transcoder API

Product: Eventarc
Feature slug: `direct-event-triggers-from-transcoder-api`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Eventarc supports direct triggers for Transcoder API events in Preview.
