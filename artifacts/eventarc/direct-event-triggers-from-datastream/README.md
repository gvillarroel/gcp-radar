# Direct event triggers from Datastream

Product: Eventarc
Feature slug: `direct-event-triggers-from-datastream`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Eventarc can create triggers for direct events from Datastream; Eventarc can create triggers for direct events from Datastream in Preview.
