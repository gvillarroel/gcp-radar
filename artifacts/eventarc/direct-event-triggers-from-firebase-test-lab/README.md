# Direct event triggers from Firebase Test Lab

Product: Eventarc
Feature slug: `direct-event-triggers-from-firebase-test-lab`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Eventarc can create triggers for direct events from Firebase Test Lab.
