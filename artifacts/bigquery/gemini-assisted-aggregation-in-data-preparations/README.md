# Gemini-assisted aggregation in data preparations

Product: BigQuery
Feature slug: `gemini-assisted-aggregation-in-data-preparations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery data preparations can aggregate table data with Gemini assistance.
