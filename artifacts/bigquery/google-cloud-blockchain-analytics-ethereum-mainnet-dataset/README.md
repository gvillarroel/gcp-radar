# Google Cloud Blockchain Analytics Ethereum Mainnet dataset

Product: BigQuery
Feature slug: `google-cloud-blockchain-analytics-ethereum-mainnet-dataset`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

BigQuery provides the Google Cloud Blockchain Analytics Ethereum Mainnet dataset through Public Datasets Program and Analytics Hub.
