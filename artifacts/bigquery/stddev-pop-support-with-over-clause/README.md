# STDDEV_POP support with OVER clause

Product: BigQuery
Feature slug: `stddev-pop-support-with-over-clause`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery standard SQL supports using STDDEV_POP with the OVER clause.
