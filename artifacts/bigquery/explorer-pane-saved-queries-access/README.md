# Explorer pane saved queries access

Product: BigQuery
Feature slug: `explorer-pane-saved-queries-access`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Saved queries can be accessed directly from the Explorer pane under a project.
