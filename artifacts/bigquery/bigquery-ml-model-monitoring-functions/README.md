# BigQuery ML model monitoring functions

Product: BigQuery
Feature slug: `bigquery-ml-model-monitoring-functions`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML provides model monitoring functions for descriptive statistics, data skew detection, data drift detection, and TensorFlow Data Validation-style analysis.
