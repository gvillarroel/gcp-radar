# BigQuery ML components for Vertex AI Managed Pipelines

Product: BigQuery
Feature slug: `bigquery-ml-components-for-vertex-ai-managed-pipelines`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

BigQuery ML provides managed pipeline components for Vertex AI to build, run, and track ML workflows.
