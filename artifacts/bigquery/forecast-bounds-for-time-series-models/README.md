# Forecast bounds for time series models

Product: BigQuery
Feature slug: `forecast-bounds-for-time-series-models`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML time series forecasting lets you set lower and upper bounds on forecasted values.
