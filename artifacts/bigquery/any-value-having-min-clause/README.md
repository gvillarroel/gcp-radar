# ANY_VALUE HAVING MIN clause

Product: BigQuery
Feature slug: `any-value-having-min-clause`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The ANY_VALUE function supports a HAVING MIN clause in queries and materialized views.
