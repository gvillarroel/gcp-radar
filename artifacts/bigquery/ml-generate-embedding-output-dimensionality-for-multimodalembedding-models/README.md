# ML.GENERATE_EMBEDDING output_dimensionality for multimodalembedding models

Product: BigQuery
Feature slug: `ml-generate-embedding-output-dimensionality-for-multimodalembedding-models`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML supports the output_dimensionality argument in ML.GENERATE_EMBEDDING for remote models based on Vertex AI multimodalembedding models.
