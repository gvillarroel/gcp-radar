# COVAR_SAMP support with OVER clause

Product: BigQuery
Feature slug: `covar-samp-support-with-over-clause`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery standard SQL supports using COVAR_SAMP with the OVER clause.

## Lifecycle

- Latest feature date: 2017-08-11
