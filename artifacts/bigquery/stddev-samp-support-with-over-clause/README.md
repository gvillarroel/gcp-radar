# STDDEV_SAMP support with OVER clause

Product: BigQuery
Feature slug: `stddev-samp-support-with-over-clause`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery standard SQL supports using STDDEV_SAMP with the OVER clause.
