...
Product: BigQuery
Feature slug: `data-canvas-assistant`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

BigQuery data canvas now includes a Gemini-powered assistant that can construct and modify canvases from user prompts.
