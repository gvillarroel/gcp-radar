...
Product: BigQuery
Feature slug: `bigquery-data-canvas`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Data canvas provides a graphical interface for discovering, transforming, querying, and visualizing data with natural language; Data canvas provides a graphical interface for discovering, transforming, querying, and visualizing data with natural language.
