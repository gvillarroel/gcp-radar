# ISOWEEK date part support in truncation and difference functions

Product: BigQuery
Feature slug: `isoweek-date-part-support-in-truncation-and-difference-functions`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

BigQuery supports the ISOWEEK date part in DATE_TRUNC, DATETIME_TRUNC, TIMESTAMP_TRUNC, DATE_DIFF, and DATETIME_DIFF.
