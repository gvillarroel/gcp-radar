# TimesFM 2.5 model support

Product: BigQuery
Feature slug: `timesfm-2-5-model-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML supports the TimesFM 2.5 time series foundation model for AI.FORECAST, AI.EVALUATE, and AI.DETECT_ANOMALIES.
