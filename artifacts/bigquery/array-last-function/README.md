...
Product: BigQuery
Feature slug: `array-last-function`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The ARRAY_LAST GoogleSQL function returns the last element of an array; The ARRAY_LAST GoogleSQL function returns the last element of an input array.
