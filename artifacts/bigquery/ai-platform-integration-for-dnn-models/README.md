# AI Platform integration for DNN models

Product: BigQuery
Feature slug: `ai-platform-integration-for-dnn-models`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML integrates with AI Platform for Deep Neural Network model training workflows.
