# Conversational analytics glossary terms

Product: BigQuery
Feature slug: `conversational-analytics-glossary-terms`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery conversational analytics agents can use custom glossary terms and imported Dataplex business glossary terms to better interpret prompts.
