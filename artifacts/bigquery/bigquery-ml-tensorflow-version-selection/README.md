# BigQuery ML TensorFlow version selection

Product: BigQuery
Feature slug: `bigquery-ml-tensorflow-version-selection`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML lets users specify the TensorFlow version used during model training.
