# BigQuery Studio Python notebooks

Product: BigQuery
Feature slug: `bigquery-studio-python-notebooks`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery Studio includes Python notebooks powered by Colab Enterprise with one-click runtimes and built-in support for BigQuery DataFrames.
