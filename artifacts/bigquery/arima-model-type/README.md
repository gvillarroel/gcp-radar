...
Product: BigQuery
Feature slug: `arima-model-type`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The ARIMA model type is the legacy BigQuery ML forecasting model superseded by ARIMA_PLUS; deprecated on 2021-04-19.

## Lifecycle

- Latest feature date: 2021-04-19
- Deprecation date: 2021-04-19
...
- access (evidence: [https://docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial](https://docs.cloud.google.com/bigquery/docs/arima-multiple-time-series-forecasting-tutorial), [https://docs.cloud.google.com/bigquery/docs/arima-time-series-forecasting-with-limits-tutorial](https://docs.cloud.google.com/bigquery/docs/arima-time-series-forecasting-with-limits-tutorial), [https://docs.cloud.google.com/bigquery/docs/time-series-forecasting-holidays-tutorial](https://docs.cloud.google.com/bigquery/docs/time-series-forecasting-holidays-tutorial))
