# Notebook visualization cells

Product: BigQuery
Feature slug: `notebook-visualization-cells`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Visualization cells automatically generate customizable charts from DataFrames in notebooks.
