# ST_GEOGFROMTEXT make_valid parameter

Product: BigQuery
Feature slug: `st-geogfromtext-make-valid-parameter`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The make_valid parameter lets ST_GEOGFROMTEXT attempt to correct polygon issues when importing geography data.
