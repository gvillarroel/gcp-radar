# Holiday effects for weekly time series

Product: BigQuery
Feature slug: `holiday-effects-for-weekly-time-series`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery time series models support holiday effects for weekly time series in addition to daily time series.
