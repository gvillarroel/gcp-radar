# Google Cloud Blockchain Analytics Optimism Mainnet dataset

Product: BigQuery
Feature slug: `google-cloud-blockchain-analytics-optimism-mainnet-dataset`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

BigQuery provides the Google Cloud Blockchain Analytics Optimism Mainnet dataset through Public Datasets Program and Analytics Hub.
