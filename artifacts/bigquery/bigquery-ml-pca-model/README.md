...
Product: BigQuery
Feature slug: `bigquery-ml-pca-model`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML supports principal component analysis models for dimensionality reduction and related tasks; BigQuery ML supports principal component analysis models for dimensionality reduction and related machine learning workflows.
