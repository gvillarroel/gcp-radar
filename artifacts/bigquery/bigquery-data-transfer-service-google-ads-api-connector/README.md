# BigQuery Data Transfer Service Google Ads API connector

Product: BigQuery
Feature slug: `bigquery-data-transfer-service-google-ads-api-connector`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The BigQuery Data Transfer Service Google Ads connector supports the newer Google Ads API and related transfer capabilities.
