# BigQuery Data Transfer Service for YouTube Content Owner reports

Product: BigQuery
Feature slug: `bigquery-data-transfer-service-for-youtube-content-owner-reports`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery Data Transfer Service can ingest YouTube Content Owner reports.
