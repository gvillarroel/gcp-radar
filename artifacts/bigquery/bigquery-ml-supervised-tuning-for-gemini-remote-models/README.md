...
Product: BigQuery
Feature slug: `bigquery-ml-supervised-tuning-for-gemini-remote-models`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML supports supervised tuning for remote models based on Vertex AI Gemini 1.5 Flash and Gemini 1.5 Pro.
