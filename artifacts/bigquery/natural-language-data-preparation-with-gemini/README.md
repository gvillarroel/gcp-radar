# Natural language data preparation with Gemini

Product: BigQuery
Feature slug: `natural-language-data-preparation-with-gemini`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini in BigQuery lets users prepare data using natural language.
