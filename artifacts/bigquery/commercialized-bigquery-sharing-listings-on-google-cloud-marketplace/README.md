# Commercialized BigQuery sharing listings on Google Cloud Marketplace

Product: BigQuery
Feature slug: `commercialized-bigquery-sharing-listings-on-google-cloud-marketplace`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery sharing listings can be commercialized through Google Cloud Marketplace.
