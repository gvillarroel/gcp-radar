# BigQuery ML text generation with gemini-pro

Product: BigQuery
Feature slug: `bigquery-ml-text-generation-with-gemini-pro`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

BigQuery ML can use ML.GENERATE_TEXT with gemini-pro remote models for generative language tasks on text in BigQuery tables.
