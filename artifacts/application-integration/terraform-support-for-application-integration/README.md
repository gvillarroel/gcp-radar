...
Feature slug: `terraform-support-for-application-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Application Integration now supports Terraform workflows, including provisioning new regions and creating authentication profiles through Terraform resources.
