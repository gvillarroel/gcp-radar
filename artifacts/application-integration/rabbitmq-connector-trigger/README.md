...
Feature slug: `rabbitmq-connector-trigger`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Application Integration introduced a RabbitMQ connector trigger in preview so integrations can be invoked by RabbitMQ events.
