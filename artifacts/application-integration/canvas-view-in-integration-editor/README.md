...
Feature slug: `canvas-view-in-integration-editor`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The integration editor introduces a new Canvas view for building integration flows with improved responsiveness and a clearer visual layout.
