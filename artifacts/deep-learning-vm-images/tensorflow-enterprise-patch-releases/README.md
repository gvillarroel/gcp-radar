# TensorFlow Enterprise patch releases

Product: Deep Learning VM Images
Feature slug: `tensorflow-enterprise-patch-releases`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Deep Learning VM Images added TensorFlow Enterprise patch releases 2.6.4 and 2.8.1.
