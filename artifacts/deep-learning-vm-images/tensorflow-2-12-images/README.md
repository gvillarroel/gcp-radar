# TensorFlow 2.12 images

Product: Deep Learning VM Images
Feature slug: `tensorflow-2-12-images`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Deep Learning VM Images now provide TensorFlow 2.12 CPU and GPU images with CUDA 11.8 and Python 3.10.
