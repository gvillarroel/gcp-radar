# TensorFlow 2.11 CPU images

Product: Deep Learning VM Images
Feature slug: `tensorflow-2-11-cpu-images`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Deep Learning VM Images now provide TensorFlow 2.11 CPU images on Debian 11 with Python 3.10.
