...
Feature slug: `asynchronous-background-tasks`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Asynchronous background tasks let Dataproc Metastore run long-running work through the Canary release channel.
