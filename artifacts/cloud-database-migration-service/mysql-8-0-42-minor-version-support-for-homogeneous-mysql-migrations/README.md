...
Feature slug: `mysql-8-0-42-minor-version-support-for-homogeneous-mysql-migrations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Database Migration Service now supports MySQL minor version 8.0.42 for homogeneous MySQL migrations.
