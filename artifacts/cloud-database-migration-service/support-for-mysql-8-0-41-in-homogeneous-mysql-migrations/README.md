# Support for MySQL 8.0.41 in homogeneous MySQL migrations

Product: Cloud Database Migration Service
Feature slug: `support-for-mysql-8-0-41-in-homogeneous-mysql-migrations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Database Migration Service now supports MySQL minor version 8.0.41 for homogeneous MySQL migrations.
