# PostgreSQL 17 source support for homogeneous PostgreSQL-to-AlloyDB migrations

Product: Cloud Database Migration Service
Feature slug: `postgresql-17-source-support-for-homogeneous-postgresql-to-alloydb-migrations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Homogeneous PostgreSQL migrations to AlloyDB for PostgreSQL now support PostgreSQL version 17.
