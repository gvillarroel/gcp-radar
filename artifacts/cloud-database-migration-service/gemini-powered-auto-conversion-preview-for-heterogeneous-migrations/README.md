# Gemini-powered auto-conversion preview for heterogeneous migrations

Product: Cloud Database Migration Service
Feature slug: `gemini-powered-auto-conversion-preview-for-heterogeneous-migrations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini-powered auto-conversion is now available in Preview for all heterogeneous migration scenarios to speed database code and schema conversion.
