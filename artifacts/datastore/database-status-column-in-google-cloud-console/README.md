...
Product: Datastore
Feature slug: `database-status-column-in-google-cloud-console`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Firestore databases page in the Google Cloud console shows a status column for database lifecycle and operation states.
