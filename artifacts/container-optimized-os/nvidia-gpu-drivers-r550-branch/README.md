...
Feature slug: `nvidia-gpu-drivers-r550-branch`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Container-Optimized OS provides NVIDIA GPU drivers from the R550 branch; Container-Optimized OS provides NVIDIA GPU drivers from the R550 branch.
