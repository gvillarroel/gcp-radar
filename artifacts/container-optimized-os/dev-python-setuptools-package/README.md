# dev-python/setuptools Package

Product: Container Optimized OS
Feature slug: `dev-python-setuptools-package`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Provides the dev-python/setuptools package in Container-Optimized OS; deprecated on 2024-09-09.
