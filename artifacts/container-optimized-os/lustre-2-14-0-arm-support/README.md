...
Feature slug: `lustre-2-14-0-arm-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Container-Optimized OS supports Lustre 2.14.0 drivers on ARM platforms; Container-Optimized OS supports Lustre 2.14.0 drivers on ARM platforms.
