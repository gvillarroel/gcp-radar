...
Feature slug: `nvidia-gpu-driver-570-124-06-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Container-Optimized OS supports NVIDIA GPU driver version 570.124.06 and updates related driver labels; Container-Optimized OS supports NVIDIA GPU driver version 570.124.06 and updates related driver labels.
