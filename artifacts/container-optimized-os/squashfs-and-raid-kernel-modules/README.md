# SquashFS and RAID kernel modules

Product: Container Optimized OS
Feature slug: `squashfs-and-raid-kernel-modules`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Container-Optimized OS adds kernel modules for SquashFS, RAID1, and DM RAID.
