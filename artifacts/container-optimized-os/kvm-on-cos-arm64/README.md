...
Feature slug: `kvm-on-cos-arm64`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Container-Optimized OS enables KVM on ARM64 builds; Container-Optimized OS enables KVM on ARM64 builds.
