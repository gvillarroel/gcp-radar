...
Feature slug: `net-libs-grpc-package`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Provides the net-libs/grpc package in Container-Optimized OS; Container-Optimized OS previously included the net-libs/grpc package; deprecated on 2024-08-20.
