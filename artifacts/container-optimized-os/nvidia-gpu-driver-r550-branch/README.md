...
Feature slug: `nvidia-gpu-driver-r550-branch`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Provides the NVIDIA R550 GPU driver branch for Container-Optimized OS; Provides the NVIDIA R550 GPU driver branch for Container-Optimized OS.
