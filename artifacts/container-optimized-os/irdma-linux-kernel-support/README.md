# iRDMA Linux kernel support

Product: Container Optimized OS
Feature slug: `irdma-linux-kernel-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds Linux kernel support for iRDMA devices on Container-Optimized OS; Adds Linux kernel support for iRDMA devices on Container-Optimized OS.
