# dev-embedded/libftdi Package

Product: Container Optimized OS
Feature slug: `dev-embedded-libftdi-package`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Provides the dev-embedded/libftdi package in Container-Optimized OS; deprecated on 2024-09-09.
