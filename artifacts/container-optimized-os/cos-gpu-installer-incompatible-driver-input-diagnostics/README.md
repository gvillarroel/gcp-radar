# cos-gpu-installer incompatible driver input diagnostics

Product: Container Optimized OS
Feature slug: `cos-gpu-installer-incompatible-driver-input-diagnostics`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cos-gpu-installer provides improved error messaging for incompatible GPU driver input; cos-gpu-installer provides improved error messaging for incompatible GPU driver input.
