# RestrictNetworkExclusions constraint template

Product: Anthos Config Management
Feature slug: `restrictnetworkexclusions-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

This constraint template restricts use of network policy exclusions or exception patterns.
