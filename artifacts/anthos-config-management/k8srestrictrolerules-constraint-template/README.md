# K8sRestrictRoleRules constraint template

Product: Anthos Config Management
Feature slug: `k8srestrictrolerules-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sRestrictRoleRules template.
