# K8sPodResourcesBestPractices constraint template

Product: Anthos Config Management
Feature slug: `k8spodresourcesbestpractices-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sPodResourcesBestPractices template.
