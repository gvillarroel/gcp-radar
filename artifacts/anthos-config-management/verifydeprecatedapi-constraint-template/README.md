# VerifyDeprecatedAPI constraint template

Product: Anthos Config Management
Feature slug: `verifydeprecatedapi-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the VerifyDeprecatedAPI template.
