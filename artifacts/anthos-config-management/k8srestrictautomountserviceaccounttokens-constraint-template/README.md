# K8sRestrictAutomountServiceAccountTokens constraint template

Product: Anthos Config Management
Feature slug: `k8srestrictautomountserviceaccounttokens-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sRestrictAutomountServiceAccountTokens template.
