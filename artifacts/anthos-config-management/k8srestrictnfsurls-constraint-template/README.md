# K8sRestrictNfsUrls constraint template

Product: Anthos Config Management
Feature slug: `k8srestrictnfsurls-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sRestrictNfsUrls template.
