# K8sPSSRunAsNonRoot constraint template

Product: Anthos Config Management
Feature slug: `k8spssrunasnonroot-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sPSSRunAsNonRoot template.
