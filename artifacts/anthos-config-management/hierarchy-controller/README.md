...
Feature slug: `hierarchy-controller`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Hierarchy Controller manages hierarchical namespace relationships and related policy behavior in Anthos Config Management.
