# K8sContainerEphemeralStorageLimit constraint template

Product: Anthos Config Management
Feature slug: `k8scontainerephemeralstoragelimit-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

The constraint template library includes the K8sContainerEphemeralStorageLimit template.
