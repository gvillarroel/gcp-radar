...
Feature slug: `k8senforcecloudarmorbackendconfig-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sEnforceCloudArmorBackendConfig template.
