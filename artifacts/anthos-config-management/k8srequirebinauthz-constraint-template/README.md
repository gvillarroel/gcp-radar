# K8sRequireBinAuthZ constraint template

Product: Anthos Config Management
Feature slug: `k8srequirebinauthz-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The constraint template library includes the K8sRequireBinAuthZ template.
