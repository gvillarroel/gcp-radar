# Anthos Policy Controller OPA Gatekeeper build 07e2fd0

Product: Anthos Config Management
Feature slug: `anthos-policy-controller-opa-gatekeeper-build-07e2fd0`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Anthos Policy Controller includes an updated OPA Gatekeeper build identified by hash 07e2fd0.
