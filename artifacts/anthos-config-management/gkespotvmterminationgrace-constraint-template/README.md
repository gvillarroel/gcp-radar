# GkeSpotVMTerminationGrace constraint template

Product: Anthos Config Management
Feature slug: `gkespotvmterminationgrace-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

The constraint template library includes the GkeSpotVMTerminationGrace template.
