...
Feature slug: `k8sblockcreationwithdefaultserviceaccount-constraint-template`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

The constraint template library includes the K8sBlockCreationWithDefaultServiceAccount template.
