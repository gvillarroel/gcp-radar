...
Feature slug: `anthos-clusters-on-vmware`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A managed Anthos Kubernetes deployment for VMware vSphere; A managed Anthos Kubernetes deployment for VMware vSphere.
