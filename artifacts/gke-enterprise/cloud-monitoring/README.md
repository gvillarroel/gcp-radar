...
Feature slug: `cloud-monitoring`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A managed observability service for collecting metrics and monitoring workloads; A managed observability service for collecting metrics and monitoring workloads.
