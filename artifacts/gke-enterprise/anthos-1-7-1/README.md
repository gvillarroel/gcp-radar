...
Feature slug: `anthos-1-7-1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Anthos 1.7.1 is a GKE Enterprise release that updated Anthos clusters on VMware, Anthos clusters on bare metal, Anthos clusters on AWS, and Anthos Config Management.
