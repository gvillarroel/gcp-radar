# MySQL 8.0.31 support

Product: Cloud SQL for MySQL
Feature slug: `mysql-8-0-31-support`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for MySQL supports MySQL minor version 8.0.31.
