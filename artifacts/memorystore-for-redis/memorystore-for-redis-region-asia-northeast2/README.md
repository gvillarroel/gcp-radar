# Memorystore for Redis region asia-northeast2

Product: Memorystore for Redis
Feature slug: `memorystore-for-redis-region-asia-northeast2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds the Memorystore for Redis region asia-northeast2 in Osaka.
