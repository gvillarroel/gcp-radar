# Gemini 2.5 Flash Lite Preview TTS regional availability

Product: Text-to-Speech
Feature slug: `gemini-2-5-flash-lite-preview-tts-regional-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The gemini-2.5-flash-lite-preview-tts model is now available in the global, us, eu, and northamerica-northeast1 regions.
