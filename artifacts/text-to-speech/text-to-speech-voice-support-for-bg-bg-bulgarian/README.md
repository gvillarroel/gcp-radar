# Text-to-Speech voice support for bg-BG (Bulgarian

Product: Text-to-Speech
Feature slug: `text-to-speech-voice-support-for-bg-bg-bulgarian`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Text-to-Speech added a supported voice for the bg-BG locale (Bulgarian, Bulgaria).
