# Text-to-Speech voice support for ms-MY (Malay

Product: Text-to-Speech
Feature slug: `text-to-speech-voice-support-for-ms-my-malay`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Text-to-Speech added a supported voice for the ms-MY locale (Malay, Malaysia).
