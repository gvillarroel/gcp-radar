# Chirp 3 HD voices in Preview for Chinese (Hong Kong) (yue-HK)

Product: Text-to-Speech
Feature slug: `chirp-3-hd-voices-in-preview-for-chinese-hong-kong-yue-hk`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Text-to-Speech Chirp 3 HD voice model gained speech synthesis support in Preview for the Chinese (Hong Kong) yue-HK language.
