...
Feature slug: `gemini-2-5-flash-tts-regional-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/text-to-speech/docs/gemini-tts](https://docs.cloud.google.com/text-to-speech/docs/gemini-tts), [https://docs.cloud.google.com/text-to-speech/docs/create-dialogue-with-multispeakers](https://docs.cloud.google.com/text-to-speech/docs/create-dialogue-with-multispeakers), [https://docs.cloud.google.com/text-to-speech/docs/endpoints](https://docs.cloud.google.com/text-to-speech/docs/endpoints))
