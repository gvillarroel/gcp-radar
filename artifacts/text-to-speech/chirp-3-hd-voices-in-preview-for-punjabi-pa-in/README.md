...
Feature slug: `chirp-3-hd-voices-in-preview-for-punjabi-pa-in`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Text-to-Speech Chirp 3 HD voice model gained speech synthesis support in Preview for the Punjabi (pa-IN) language.
