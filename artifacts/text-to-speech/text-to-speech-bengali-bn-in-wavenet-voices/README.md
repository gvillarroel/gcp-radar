# Text-to-Speech Bengali (bn-IN) WaveNet voices

Product: Text-to-Speech
Feature slug: `text-to-speech-bengali-bn-in-wavenet-voices`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Text-to-Speech added two new Bengali (bn-IN) WaveNet voices.

## Lifecycle

- Latest feature date: 2021-01-22
