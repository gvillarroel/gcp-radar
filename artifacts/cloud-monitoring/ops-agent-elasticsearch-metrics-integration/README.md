# Ops Agent Elasticsearch metrics integration

Product: Cloud Monitoring
Feature slug: `ops-agent-elasticsearch-metrics-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Ops Agent can collect Elasticsearch metrics for Cloud Monitoring.
