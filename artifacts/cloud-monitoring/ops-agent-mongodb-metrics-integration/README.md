# Ops Agent MongoDB metrics integration

Product: Cloud Monitoring
Feature slug: `ops-agent-mongodb-metrics-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Ops Agent can collect MongoDB metrics for Cloud Monitoring.
