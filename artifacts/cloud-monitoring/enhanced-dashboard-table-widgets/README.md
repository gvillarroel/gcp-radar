...
Feature slug: `enhanced-dashboard-table-widgets`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dashboard table widgets support row limits, column persistence, top or bottom filtering, and visual value indicators.
