# Ops Agent Apache Kafka metrics and logs integration

Product: Cloud Monitoring
Feature slug: `ops-agent-apache-kafka-metrics-and-logs-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Ops Agent can collect Apache Kafka metrics and logs for Cloud Monitoring.
