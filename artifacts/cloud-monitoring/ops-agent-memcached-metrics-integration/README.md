# Ops Agent Memcached metrics integration

Product: Cloud Monitoring
Feature slug: `ops-agent-memcached-metrics-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Ops Agent can collect Memcached metrics for Cloud Monitoring.
