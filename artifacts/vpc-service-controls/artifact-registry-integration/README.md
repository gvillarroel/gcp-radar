...
Feature slug: `artifact-registry-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

VPC Service Controls integrates with Artifact Registry to support service perimeter protections for that service.
