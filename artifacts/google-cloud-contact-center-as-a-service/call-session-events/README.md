...
Feature slug: `call-session-events`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

This feature deploys generator and sender applications to process call events and forward them to configured endpoints.
