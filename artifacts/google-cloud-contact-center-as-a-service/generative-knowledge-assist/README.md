...
Feature slug: `generative-knowledge-assist`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Generative knowledge assist is now available in the agent adapter; Generative knowledge assist is now available in Agent Desktop as a draggable widget.
