# Spelling and grammar check for chat adapter

Product: Google Cloud Contact Center as a Service
Feature slug: `spelling-and-grammar-check-for-chat-adapter`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spelling and grammar check for the chat adapter lets agents toggle proofreading on or off and choose the language.
