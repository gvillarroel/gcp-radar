# Spelling and grammar check for SMS and WhatsApp sessions

Product: Google Cloud Contact Center as a Service
Feature slug: `spelling-and-grammar-check-for-sms-and-whatsapp-sessions`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds spelling and grammar checking to SMS and WhatsApp chat sessions.
