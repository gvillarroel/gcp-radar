...
Feature slug: `agent-chat-adapter-automatic-translations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Agent Chat Adapter can automatically translate messages between the end user's language and the queue's default language.
