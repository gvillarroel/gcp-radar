# Agent desktop state persistence

Product: Google Cloud Contact Center as a Service
Feature slug: `agent-desktop-state-persistence`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The agent desktop preserves active conversations, finished tabs, and recently closed sessions after a browser refresh.
