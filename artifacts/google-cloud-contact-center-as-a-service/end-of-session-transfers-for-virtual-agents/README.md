...
Feature slug: `end-of-session-transfers-for-virtual-agents`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Virtual agents can receive end-of-session transfers for wrap-up interactions such as surveys or feedback.
