# Batch C++ client libraries

Product: Batch
Feature slug: `batch-c-client-libraries`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Client Libraries for C++ were made available for the Batch API.
...
- [https://docs.cloud.google.com/python/docs/reference/batch/latest/google.cloud.batch_v1.services.batch_service.pagers](https://docs.cloud.google.com/python/docs/reference/batch/latest/google.cloud.batch_v1.services.batch_service.pagers)
