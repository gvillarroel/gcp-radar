# Inline code completion assistance

Product: Colab Enterprise
Feature slug: `inline-code-completion-assistance`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Colab Enterprise provides inline code completion assistance with Duet AI; Colab Enterprise provides inline code completion assistance with Duet AI.
...
- [https://docs.cloud.google.com/colab/docs/gemini-in-colab/overview](https://docs.cloud.google.com/colab/docs/gemini-in-colab/overview)
