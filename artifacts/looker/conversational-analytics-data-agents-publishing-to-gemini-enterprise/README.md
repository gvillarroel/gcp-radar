# Conversational Analytics data agents publishing to Gemini Enterprise

Product: Looker
Feature slug: `conversational-analytics-data-agents-publishing-to-gemini-enterprise`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

This feature lets you publish Conversational Analytics data agents from Looker to Gemini Enterprise.
