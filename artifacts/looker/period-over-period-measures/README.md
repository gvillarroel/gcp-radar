...
Product: Looker
Feature slug: `period-over-period-measures`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

PoP measures are now generally available with added MySQL 8.0.12+ and Connected Sheets support, expanded based_on measure types, and improved time-based query handling.
