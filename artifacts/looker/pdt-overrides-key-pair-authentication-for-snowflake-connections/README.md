# PDT overrides key-pair authentication for Snowflake connections

Product: Looker
Feature slug: `pdt-overrides-key-pair-authentication-for-snowflake-connections`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Looker supports key-pair authentication in PDT overrides for Snowflake connections.
