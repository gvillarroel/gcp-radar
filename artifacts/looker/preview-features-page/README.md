...
Product: Looker
Feature slug: `preview-features-page`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Admin panel's Preview Features page lets admins enable or disable in-progress features and replaces the Labs page; The Admin panel's Labs page has been renamed Preview Features and now organizes in-progress features into preview and labs categories.
