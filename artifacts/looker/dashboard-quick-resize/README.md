# Dashboard Quick Resize

Product: Looker
Feature slug: `dashboard-quick-resize`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dashboard layouts can be edited with a quick resize capability.
