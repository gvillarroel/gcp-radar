...
Product: Looker
Feature slug: `ide-file-and-folder-loading-indicators`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Looker IDE displays a loading indicator when files or folders are created, updated, or accessed.
