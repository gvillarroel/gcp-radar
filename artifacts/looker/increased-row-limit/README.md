...
Product: Looker
Feature slug: `increased-row-limit`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Increased Row Limit lets admins raise visualization row limits for maps, scatterplots, and tables up to 50,000 rows or datapoints.
