# Content Guardrails admin panel

Product: Looker
Feature slug: `content-guardrails-admin-panel`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Content Guardrails admin panel lets Looker admins limit merged results queries and dashboard auto-refreshes.
