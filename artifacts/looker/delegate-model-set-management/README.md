# Delegate Model Set Management

Product: Looker
Feature slug: `delegate-model-set-management`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

This Labs feature lets admins grant the manage_modelsets_restricted permission to users with access to specific model sets.
