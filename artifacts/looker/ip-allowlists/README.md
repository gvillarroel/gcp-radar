...
Product: Looker
Feature slug: `ip-allowlists`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Looker (Google Cloud core) instances with public or hybrid connections can restrict access to specified IP addresses using IP allowlists.
