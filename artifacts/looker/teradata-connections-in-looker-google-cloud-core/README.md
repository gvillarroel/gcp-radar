# Teradata connections in Looker (Google Cloud core)

Product: Looker
Feature slug: `teradata-connections-in-looker-google-cloud-core`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Looker (Google Cloud core) supports connections to Teradata databases.
