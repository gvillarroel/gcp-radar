# Performant Field Picker Labs

Product: Looker
Feature slug: `performant-field-picker-labs`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Performant Field Picker Labs feature adds refined search options for finding fields in large Explore field pickers.
