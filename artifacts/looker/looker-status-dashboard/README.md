...
Product: Looker
Feature slug: `looker-status-dashboard`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/looker/docs/admin-panel-alerts-and-schedules-alerts](https://docs.cloud.google.com/looker/docs/admin-panel-alerts-and-schedules-alerts), [https://docs.cloud.google.com/looker/docs/admin-panel-database-pdts](https://docs.cloud.google.com/looker/docs/admin-panel-database-pdts), [https://docs.cloud.google.com/looker/docs/admin-panel-database-datagroups](https://docs.cloud.google.com/looker/docs/admin-panel-database-datagroups))
