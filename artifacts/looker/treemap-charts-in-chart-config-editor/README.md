# Treemap Charts in Chart Config Editor

Product: Looker
Feature slug: `treemap-charts-in-chart-config-editor`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Users can now create treemap charts using the Chart Config Editor.
