# Custom embed theme border radius

Product: Looker
Feature slug: `custom-embed-theme-border-radius`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Custom embed themes now include a border radius option for dashboard tiles.
