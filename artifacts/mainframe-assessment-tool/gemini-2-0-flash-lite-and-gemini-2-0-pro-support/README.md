# Gemini 2.0 Flash-Lite and Gemini 2.0 Pro support

Product: Mainframe Assessment Tool
Feature slug: `gemini-2-0-flash-lite-and-gemini-2-0-pro-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds Gemini 2.0 Flash-Lite and Gemini 2.0 Pro as supported models.
