...
Feature slug: `ims-db-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Parses IMS DBD and PSB definitions and extracts CRUD information from COBOL programs.
