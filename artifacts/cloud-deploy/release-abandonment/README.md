...
- access (evidence: [https://docs.cloud.google.com/deploy/docs/abandon-release](https://docs.cloud.google.com/deploy/docs/abandon-release), [https://docs.cloud.google.com/python/docs/reference/clouddeploy/latest/google.cloud.deploy_v1.types.AbandonReleaseRequest](https://docs.cloud.google.com/python/docs/reference/clouddeploy/latest/google.cloud.deploy_v1.types.AbandonReleaseRequest), [https://docs.cloud.google.com/deploy/docs/iam-roles-permissions](https://docs.cloud.google.com/deploy/docs/iam-roles-permissions))
