# VS Code Gemini Code Assist chat keyboard shortcuts tips card

Product: Gemini
Feature slug: `vs-code-gemini-code-assist-chat-keyboard-shortcuts-tips-card`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Chat now shows a tips card with useful keyboard shortcuts for the VS Code Gemini Code Assist plug-in.
