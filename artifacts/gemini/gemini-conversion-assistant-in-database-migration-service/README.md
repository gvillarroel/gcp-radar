# Gemini conversion assistant in Database Migration Service

Product: Gemini
Feature slug: `gemini-conversion-assistant-in-database-migration-service`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini conversion assistant is available in Database Migration Service conversion workspaces for Oracle code and schema conversion.
