# Code snippet attachment in chat context

Product: Gemini
Feature slug: `code-snippet-attachment-in-chat-context`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

You can attach selected code snippets to chat so Gemini can focus on smaller code blocks instead of entire files.

## Lifecycle

- Latest feature date: 2025-06-12
