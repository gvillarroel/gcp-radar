# Gemini models for Spanner prediction functions

Product: Gemini
Feature slug: `gemini-models-for-spanner-prediction-functions`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner supports Gemini models with GoogleSQL and PostgreSQL machine learning prediction functions.
