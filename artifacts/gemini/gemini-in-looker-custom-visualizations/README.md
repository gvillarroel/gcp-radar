# Gemini in Looker custom visualizations

Product: Gemini
Feature slug: `gemini-in-looker-custom-visualizations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Visualization Assistant generates custom formatting options for Looker visualizations from natural-language prompts.
