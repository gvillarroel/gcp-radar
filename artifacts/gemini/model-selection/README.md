...
Product: Gemini
Feature slug: `model-selection`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Eligible VS Code users of Gemini Code Assist can manually choose the model used by the assistant; Eligible VS Code users of Gemini Code Assist can manually choose the model used by the assistant.
