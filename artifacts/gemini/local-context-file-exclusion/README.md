...
Product: Gemini
Feature slug: `local-context-file-exclusion`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Files listed in .gitignore are excluded from local context for chat, code generation, code completion, and code transformation.
