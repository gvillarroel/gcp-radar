# Streamed chat responses in Gemini Code Assist

Product: Gemini
Feature slug: `streamed-chat-responses-in-gemini-code-assist`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Streams Gemini Code Assist chat responses in IntelliJ and VS Code; Streams Gemini Code Assist chat responses in IntelliJ and VS Code public preview.
