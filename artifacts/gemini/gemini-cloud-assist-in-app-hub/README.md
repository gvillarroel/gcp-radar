...
Product: Gemini
Feature slug: `gemini-cloud-assist-in-app-hub`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Cloud Assist is available in App Hub Preview and can answer questions about an application in an app-enabled folder.
