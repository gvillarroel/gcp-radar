# Service account approvals in Privileged Access Manager

Product: Identity and Access Management
Feature slug: `service-account-approvals-in-privileged-access-manager`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Privileged Access Manager supports approval flows for service accounts.
