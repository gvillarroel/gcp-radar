...
Feature slug: `kubernetes-1-18-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Anthos clusters on AWS supports Kubernetes version 1.18, including CoreDNS 1.7.1 and Cluster Autoscaler 1.18.
...
- [https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/aws/apis](https://docs.cloud.google.com/kubernetes-engine/multi-cloud/docs/aws/apis)
