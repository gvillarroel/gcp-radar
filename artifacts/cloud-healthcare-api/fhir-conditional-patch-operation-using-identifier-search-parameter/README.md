# FHIR conditional patch operation using identifier search parameter

Product: Cloud Healthcare API
Feature slug: `fhir-conditional-patch-operation-using-identifier-search-parameter`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The fhir.conditionalPatch conditional operation is generally available using the FHIR identifier search parameter.
