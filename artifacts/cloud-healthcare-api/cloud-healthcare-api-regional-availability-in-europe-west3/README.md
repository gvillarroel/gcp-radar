# Cloud Healthcare API regional availability in europe-west3

Product: Cloud Healthcare API
Feature slug: `cloud-healthcare-api-regional-availability-in-europe-west3`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Cloud Healthcare API added single-region availability in the europe-west3 (Frankfurt) region.
