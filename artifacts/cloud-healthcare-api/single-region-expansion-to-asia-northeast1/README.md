# Single-region expansion to asia-northeast1

Product: Cloud Healthcare API
Feature slug: `single-region-expansion-to-asia-northeast1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Healthcare API added single-region availability in the asia-northeast1 (Tokyo) region.
