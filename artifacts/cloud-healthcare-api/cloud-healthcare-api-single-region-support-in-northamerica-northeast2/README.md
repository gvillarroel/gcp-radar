# Cloud Healthcare API single-region support in northamerica-northeast2

Product: Cloud Healthcare API
Feature slug: `cloud-healthcare-api-single-region-support-in-northamerica-northeast2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Healthcare API added single-region availability in the northamerica-northeast2 (Toronto) region; Cloud Healthcare API added single-region availability in the northamerica-northeast2 (Toronto) region.
...
- access (evidence: [https://docs.cloud.google.com/healthcare-api/docs/concepts/regions](https://docs.cloud.google.com/healthcare-api/docs/concepts/regions), [https://docs.cloud.google.com/healthcare-api/docs/requirements](https://docs.cloud.google.com/healthcare-api/docs/requirements), [https://docs.cloud.google.com/healthcare-api/docs/how-tos/dicom](https://docs.cloud.google.com/healthcare-api/docs/how-tos/dicom))
