# Cloud Healthcare API single-region support in asia-east2

Product: Cloud Healthcare API
Feature slug: `cloud-healthcare-api-single-region-support-in-asia-east2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Cloud Healthcare API added single-region support in the asia-east2 (Hong Kong) region.
