...
Feature slug: `cloud-healthcare-api-single-region-support-in-southamerica-east1`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/healthcare-api/docs/concepts/regions](https://docs.cloud.google.com/healthcare-api/docs/concepts/regions), [https://docs.cloud.google.com/healthcare-api/docs/requirements](https://docs.cloud.google.com/healthcare-api/docs/requirements), [https://docs.cloud.google.com/healthcare-api/docs/best-practices-quota-management](https://docs.cloud.google.com/healthcare-api/docs/best-practices-quota-management))
