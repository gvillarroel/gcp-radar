# A4 support in GKE and Slurm blueprints

Product: Cluster Toolkit
Feature slug: `a4-support-in-gke-and-slurm-blueprints`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cluster Toolkit adds support for the A4 machine family in GKE and Slurm blueprints.
