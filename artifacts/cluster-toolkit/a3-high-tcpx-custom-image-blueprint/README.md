# A3 High TCPx custom image blueprint

Product: Cluster Toolkit
Feature slug: `a3-high-tcpx-custom-image-blueprint`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cluster Toolkit provides an A3 High blueprint that automates custom image creation with a TCPx-patched kernel.
