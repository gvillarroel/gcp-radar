# Managed Lustre Slurm blueprint

Product: Cluster Toolkit
Feature slug: `managed-lustre-slurm-blueprint`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cluster Toolkit adds a blueprint for Managed Lustre attached to Slurm clusters.
