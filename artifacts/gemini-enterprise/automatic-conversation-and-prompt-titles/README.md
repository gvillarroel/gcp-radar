# Automatic conversation and prompt titles

Product: Gemini Enterprise
Feature slug: `automatic-conversation-and-prompt-titles`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Enterprise can automatically generate a title for a new conversation or prompt from the initial query or prompt.
