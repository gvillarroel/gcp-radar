# Box actions in the unified view

Product: Gemini Enterprise
Feature slug: `box-actions-in-the-unified-view`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Enterprise adds new actions for Box in the unified view; Gemini Enterprise adds new actions for Box in the unified view.
