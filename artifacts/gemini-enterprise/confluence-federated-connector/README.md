# Confluence federated connector

Product: Gemini Enterprise
Feature slug: `confluence-federated-connector`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Enterprise provides a federated connector for Confluence.
