...
Feature slug: `java-25-runtime`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Java 25 runtime enables App Engine standard environment Java applications to run on Java 25; The Java 25 runtime enables App Engine standard environment Java applications to run on Java 25.
