# App Engine region availability in europe-west6

Product: App Engine standard environment Java
Feature slug: `app-engine-region-availability-in-europe-west6`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

App Engine became available in the europe-west6 region in Zurich, Switzerland.
