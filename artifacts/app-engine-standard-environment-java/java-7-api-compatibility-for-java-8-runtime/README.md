# Java 7 API compatibility for Java 8 runtime

Product: App Engine standard environment Java
Feature slug: `java-7-api-compatibility-for-java-8-runtime`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Java 8 runtime maintains compatibility with Java 7 App Engine features and built-in APIs.
