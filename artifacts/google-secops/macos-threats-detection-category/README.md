...
Feature slug: `macos-threats-detection-category`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Curated Detections added a MacOS Threats category that includes a Mandiant Intel Emerging Threats rulepack.
