# VPC Service Controls support for Cloud Scheduler jobs targeting Data Pipelines

Product: Cloud Scheduler
Feature slug: `vpc-service-controls-support-for-cloud-scheduler-jobs-targeting-data-pipelines`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Cloud Scheduler jobs that target Data Pipelines can be secured with VPC Service Controls; Cloud Scheduler jobs that target Data Pipelines can be secured with VPC Service Controls.
