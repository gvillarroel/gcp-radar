...
Feature slug: `vertex-ai-agent-builder-agent-designer`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/agent-builder/agent-designer](https://docs.cloud.google.com/agent-builder/agent-designer), [https://docs.cloud.google.com/agent-builder/agent-engine/code-execution/overview](https://docs.cloud.google.com/agent-builder/agent-engine/code-execution/overview), [https://docs.cloud.google.com/agent-builder/agent-engine/agent-identity](https://docs.cloud.google.com/agent-builder/agent-engine/agent-identity), [https://docs.cloud.google.com/agent-builder/agent-engine/develop/langchain](https://docs.cloud.google.com/agent-builder/agent-engine/develop/langchain))
