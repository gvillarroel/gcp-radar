...
Feature slug: `vertex-ai-agent-engine-memory-bank`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Memory Bank now supports creating and managing memory revisions; The Agent Engine page in Cloud Console now includes a Memory Bank tab for displaying and managing memories.
