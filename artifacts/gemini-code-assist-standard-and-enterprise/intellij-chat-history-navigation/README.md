# IntelliJ chat history navigation

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `intellij-chat-history-navigation`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Arrow keys let you revisit, repeat, and edit previous chat prompts in IntelliJ Gemini Code Assist.
