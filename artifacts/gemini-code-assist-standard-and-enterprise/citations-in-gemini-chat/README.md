# citations in Gemini Chat

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `citations-in-gemini-chat`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Code Assist for IntelliJ can show citations in Gemini Chat and in inserted code in the editor.
