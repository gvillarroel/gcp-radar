# Code Transformation in Gemini Code Assist

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `code-transformation-in-gemini-code-assist`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Code Transformation features are in Public Preview for Workstations and Cloud Shell; Code Transformation features are in Public Preview for Cloud Shell.
