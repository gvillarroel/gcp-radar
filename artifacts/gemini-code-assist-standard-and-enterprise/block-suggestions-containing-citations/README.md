# Block suggestions containing citations

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `block-suggestions-containing-citations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

IntelliJ Gemini Code Assist includes a setting to block suggestions that contain citations.
