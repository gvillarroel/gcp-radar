# IntelliJ chat conversation history persistence

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `intellij-chat-conversation-history-persistence`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Chat conversation history persists across IntelliJ IDE sessions and restarts.
