# Automatic chat response scrolling

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `automatic-chat-response-scrolling`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Automatically scrolls through chat responses in VS Code Gemini Code Assist for easier reading.
