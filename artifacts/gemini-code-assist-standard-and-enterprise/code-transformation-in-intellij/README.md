# code transformation in IntelliJ

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `code-transformation-in-intellij`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Code Assist for IntelliJ now supports code transformation with commands or natural language prompts and a diff view of pending changes.
