# Code customization for repositories

Product: Gemini Code Assist Standard and Enterprise
Feature slug: `code-customization-for-repositories`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Code Assist Enterprise code customization supports repositories hosted on GitHub Enterprise Cloud, GitLab, GitLab Enterprise, Bitbucket Cloud, and Bitbucket Data Center.
