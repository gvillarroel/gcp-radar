# Layout parser model pretrained-layout-parser-v1.6-2026-01-13

Product: Document AI
Feature slug: `layout-parser-model-pretrained-layout-parser-v1-6-2026-01-13`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A preview layout parser model version powered by Gemini 3 Flash LLM with ML processing capabilities in the US and EU.
