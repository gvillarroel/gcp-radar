# Layout parser model pretrained-layout-parser-v1.6-pro-2025-12-01

Product: Document AI
Feature slug: `layout-parser-model-pretrained-layout-parser-v1-6-pro-2025-12-01`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A preview layout parser model version powered by Gemini 3 Pro LLM with ML processing capabilities in the US and EU.
