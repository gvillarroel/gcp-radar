...
Product: Document AI
Feature slug: `custom-extractor-model-pretrained-foundation-model-v1-4-2025-02-05`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The pretrained-foundation-model-v1.4-2025-02-05 custom extractor model will no longer be accessible; The pretrained-foundation-model-v1.4-2025-02-05 custom extractor model will no longer be accessible; deprecated on 2026-02-05.

## Lifecycle

- Latest feature date: 2025-03-19
- Deprecation date: 2026-02-05
