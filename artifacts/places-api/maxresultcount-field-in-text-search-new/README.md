# maxResultCount field in Text Search (New)

Product: Places API
Feature slug: `maxresultcount-field-in-text-search-new`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The maxResultCount field in Text Search (New) is deprecated and pageSize should be used instead; deprecated on 2024-05-13.

## Lifecycle

- Latest feature date: 2024-05-13
- Deprecation date: 2024-05-13
