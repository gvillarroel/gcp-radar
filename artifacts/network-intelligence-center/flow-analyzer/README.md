...
Feature slug: `flow-analyzer`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Flow Analyzer is available in general availability; Flow Analyzer helps users understand VPC traffic flows without writing complex SQL queries on VPC Flow Logs.
