...
Feature slug: `performance-dashboard`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Performance Dashboard provides network performance monitoring in Network Intelligence Center; Performance Dashboard provides network performance monitoring in Network Intelligence Center.

## Lifecycle

- Latest feature date: 2020-04-16
