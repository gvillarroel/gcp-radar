# Firewall Insights IPv6 misconfiguration detection

Product: Network Intelligence Center
Feature slug: `firewall-insights-ipv6-misconfiguration-detection`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Firewall Insights can identify firewall misconfigurations for firewall rules that contain IPv6 IP address ranges.
