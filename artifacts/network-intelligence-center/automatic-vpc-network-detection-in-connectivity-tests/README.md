# Automatic VPC network detection in Connectivity Tests

Product: Network Intelligence Center
Feature slug: `automatic-vpc-network-detection-in-connectivity-tests`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Connectivity Tests automatically detects the destination VPC network for in-Google-Cloud destination IP addresses.
