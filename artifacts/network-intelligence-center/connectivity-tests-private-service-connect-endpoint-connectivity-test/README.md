# Connectivity Tests Private Service Connect endpoint connectivity test

Product: Network Intelligence Center
Feature slug: `connectivity-tests-private-service-connect-endpoint-connectivity-test`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Connectivity Tests can verify connectivity from a VM to a Private Service Connect endpoint.
