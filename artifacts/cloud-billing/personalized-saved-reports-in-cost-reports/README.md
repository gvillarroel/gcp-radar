...
Feature slug: `personalized-saved-reports-in-cost-reports`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cost Reports now surfaces frequently opened custom saved reports in the reports carousel for users with Gemini Cloud Assist enabled.
