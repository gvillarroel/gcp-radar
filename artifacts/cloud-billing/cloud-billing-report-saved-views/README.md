# Cloud Billing report saved views

Product: Cloud Billing
Feature slug: `cloud-billing-report-saved-views`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Enabled saving custom Cloud Billing Report views in the Console, including configured filters and dimension settings for reuse.
