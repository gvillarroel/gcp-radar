...
Product: Cloud CDN
Feature slug: `cloud-cdn-ttl-overrides`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- logging (evidence: [https://docs.cloud.google.com/cdn/docs/using-ttl-overrides](https://docs.cloud.google.com/cdn/docs/using-ttl-overrides), [https://docs.cloud.google.com/cdn/docs/caching](https://docs.cloud.google.com/cdn/docs/caching), [https://docs.cloud.google.com/cdn/docs/ext-backend-internet-neg-overview](https://docs.cloud.google.com/cdn/docs/ext-backend-internet-neg-overview))
