# Cache Performance dashboard aggregate data

Product: Apigee Analytics
Feature slug: `cache-performance-dashboard-aggregate-data`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Cache Performance dashboard supports viewing aggregate data in its charts.
