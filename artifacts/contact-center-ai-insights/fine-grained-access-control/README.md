...
Feature slug: `fine-grained-access-control`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Fine-grained access control uses IAM custom roles and authorized views to restrict visibility into specific dataset portions.
