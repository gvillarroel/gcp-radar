# EndpointSlice API v1beta1

Product: Google Kubernetes Engine
Feature slug: `endpointslice-api-v1beta1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

EndpointSlice API v1beta1 is a Kubernetes beta API for endpoint discovery; EndpointSlice API v1beta1 is a Kubernetes beta API for endpoint discovery; deprecated on 2022-05-26.
