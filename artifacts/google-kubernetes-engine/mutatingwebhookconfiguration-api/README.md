...
Feature slug: `mutatingwebhookconfiguration-api`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The v1beta1 MutatingWebhookConfiguration API was removed in Kubernetes 1.22 in favor of the GA API; deprecated on 2021-10-01.
