...
Feature slug: `gatewayclass-network-service-tier-for-ephemeral-ip-addresses`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- key (evidence: [https://docs.cloud.google.com/kubernetes-engine/docs/tutorials/configuring-domain-name-static-ip](https://docs.cloud.google.com/kubernetes-engine/docs/tutorials/configuring-domain-name-static-ip), [https://docs.cloud.google.com/kubernetes-engine/docs/concepts/explore-gke-networking-docs-use-cases](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/explore-gke-networking-docs-use-cases), [https://docs.cloud.google.com/kubernetes-engine/docs/concepts/network-overview](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/network-overview))
- security (evidence: [https://docs.cloud.google.com/kubernetes-engine/docs/tutorials/configuring-domain-name-static-ip](https://docs.cloud.google.com/kubernetes-engine/docs/tutorials/configuring-domain-name-static-ip), [https://docs.cloud.google.com/kubernetes-engine/docs/concepts/explore-gke-networking-docs-use-cases](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/explore-gke-networking-docs-use-cases), [https://docs.cloud.google.com/kubernetes-engine/docs/concepts/network-overview](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/network-overview))
