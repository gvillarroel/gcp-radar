...
Feature slug: `local-ssd-ephemeral-storage-for-emptydir-volumes`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Node pools running GKE 1.18 and later can use local SSD for emptyDir ephemeral storage in beta.
