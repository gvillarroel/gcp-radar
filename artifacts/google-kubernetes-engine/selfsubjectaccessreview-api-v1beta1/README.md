# SelfSubjectAccessReview API v1beta1

Product: Google Kubernetes Engine
Feature slug: `selfsubjectaccessreview-api-v1beta1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

SelfSubjectAccessReview is the Kubernetes API for checking the caller's own permissions; deprecated on 2021-10-01.
