# MutatingWebhookConfiguration API v1beta1

Product: Google Kubernetes Engine
Feature slug: `mutatingwebhookconfiguration-api-v1beta1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

MutatingWebhookConfiguration is the Kubernetes admission webhook configuration for mutating requests; deprecated on 2021-10-01.
