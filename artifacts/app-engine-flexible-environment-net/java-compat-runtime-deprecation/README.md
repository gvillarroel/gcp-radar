# java-compat runtime deprecation

Product: App Engine flexible environment .NET
Feature slug: `java-compat-runtime-deprecation`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The java-compat runtime was deprecated in the App Engine flexible environment; deprecated on 2016-11-15.
