...
Feature slug: `image-captioning`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Image captioning generates text descriptions for images; deprecated on 2025-06-24.

## Lifecycle

- Latest feature date: 2025-06-24
- Deprecation date: 2025-06-24
...
- access (evidence: [https://docs.cloud.google.com/vertex-ai/generative-ai/docs/image/quickstart-image-generate-console](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/image/quickstart-image-generate-console), [https://docs.cloud.google.com/vertex-ai/generative-ai/docs/image/img-gen-prompt-guide](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/image/img-gen-prompt-guide), [https://docs.cloud.google.com/vertex-ai/generative-ai/docs/cookbook](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/cookbook), [https://docs.cloud.google.com/vertex-ai/generative-ai/docs/context-cache/context-cache-getinfo](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/context-cache/context-cache-getinfo))
