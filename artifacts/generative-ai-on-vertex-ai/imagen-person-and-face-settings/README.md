# Imagen person and face settings

Product: Generative AI on Vertex AI
Feature slug: `imagen-person-and-face-settings`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Imagen 2 imagegeneration@006 adds user-configurable person and face settings.
