# Vertex AI Studio login-free access

Product: Generative AI on Vertex AI
Feature slug: `vertex-ai-studio-login-free-access`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Vertex AI Studio multi-model prompt designer can be accessed without signing in.
