...
Feature slug: `vertex-ai-prompt-optimizer`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Prompt Optimizer helps improve prompts, including a zero-shot prompt optimizer option; The prompt optimizer adapts prompts using optimal instructions and examples to improve model performance.
...
- [https://docs.cloud.google.com/vertex-ai/generative-ai/docs/chat/chat-prompts](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/chat/chat-prompts)
