# Vertex AI Studio support for Gemini Live API

Product: Generative AI on Vertex AI
Feature slug: `vertex-ai-studio-support-for-gemini-live-api`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Studio gained updated UI support for Gemini Live API.
