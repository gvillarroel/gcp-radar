...
Feature slug: `imagen-3-0-generate-001`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A deprecated Imagen 3.0 generation endpoint scheduled for shutdown on 2026-06-30; An Imagen 3 image generation model now generally available to all users; deprecated on 2026-06-30.
