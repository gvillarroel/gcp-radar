# Python 2.7 support for Marketplace integrations

Product: Google SecOps SOAR
Feature slug: `python-2-7-support-for-marketplace-integrations`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Python 2.7 support for Marketplace integrations is being deprecated and will be removed; deprecated on 2024-10-13.

## Lifecycle

- Latest feature date: 2024-07-13
- Deprecation date: 2024-10-13
