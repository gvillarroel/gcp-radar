# Firestore region support in asia-northeast3 (Seoul)

Product: Firestore
Feature slug: `firestore-region-support-in-asia-northeast3-seoul`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Firestore is available in the asia-northeast3 region in Seoul.
