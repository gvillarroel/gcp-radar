...
- encrypt (evidence: [https://docs.cloud.google.com/firestore/docs/backups](https://docs.cloud.google.com/firestore/docs/backups), [https://docs.cloud.google.com/firestore/native/docs/backups](https://docs.cloud.google.com/firestore/native/docs/backups), [https://docs.cloud.google.com/firestore/docs/reference/rest/Shared.Types/ChangeType](https://docs.cloud.google.com/firestore/docs/reference/rest/Shared.Types/ChangeType))
