...
Generated from Step 08 card: `data/step-08/current/products/migrate-to-virtual-machines/card.json`
...
- [Active VM limit increase](./active-vm-limit-increase/README.md)
- [Additional virtual disk image format import](./additional-virtual-disk-image-format-import/README.md)
- [Agentless vSphere migration](./agentless-vsphere-migration/README.md)
- [AlmaLinux EL 8 and 9 support](./almalinux-el-8-and-9-support/README.md)
- [Amazon Linux 2 migration support](./amazon-linux-2-migration-support/README.md)
- [Amazon Linux 2 to Rocky Linux 8 conversion](./amazon-linux-2-to-rocky-linux-8-conversion/README.md)
- [and M3 machine type migration support](./and-m3-machine-type-migration-support/README.md)
- [Arm disk image import](./arm-disk-image-import/README.md)
- [Arm64 migration journey](./arm64-migration-journey/README.md)
- [ARM64 migration support](./arm64-migration-support/README.md)
- [AWS EC2 migration support](./aws-ec2-migration-support/README.md)
- [Azure VM migration support](./azure-vm-migration-support/README.md)
- [Azure VM migration to Compute Engine](./azure-vm-migration-to-compute-engine/README.md)
- [BIOS to UEFI boot type conversion](./bios-to-uefi-boot-type-conversion/README.md)
- [BIOS to UEFI conversion](./bios-to-uefi-conversion/README.md)
- [C3](./c3/README.md)
- [CentOS Linux 7 to Rocky Linux 8 conversion](./centos-linux-7-to-rocky-linux-8-conversion/README.md)
- [Compute Engine machine series migration support](./compute-engine-machine-series-migration-support/README.md)
- [Compute Engine migration targets](./compute-engine-migration-targets/README.md)
- [Customer-managed encryption keys for migrations](./customer-managed-encryption-keys-for-migrations/README.md)
- [Cutover](./cutover/README.md)
- [Detached EBS volume migration](./detached-ebs-volume-migration/README.md)
- [Estimated cut-over time field](./estimated-cut-over-time-field/README.md)
- [Google Cloud Console migration UI](./google-cloud-console-migration-ui/README.md)
- [Google Cloud VMware Engine VM migration](./google-cloud-vmware-engine-vm-migration/README.md)
- [H3](./h3/README.md)
- [Hyperdisk Storage Pools support](./hyperdisk-storage-pools-support/README.md)
- [License type override](./license-type-override/README.md)
- [Machine image import from a virtual appliance](./machine-image-import-from-a-virtual-appliance/README.md)
- [Migrate Connector throttling](./migrate-connector-throttling/README.md)
- [Migrating VM expiration time](./migrating-vm-expiration-time/README.md)
- [Multiple network interfaces for migrated VMs](./multiple-network-interfaces-for-migrated-vms/README.md)
- [Replication-based migration](./replication-based-migration/README.md)
- [Seamless OS adaptation](./seamless-os-adaptation/README.md)
- [Second NIC throttling](./second-nic-throttling/README.md)
- [Sole-tenant node deployment](./sole-tenant-node-deployment/README.md)
- [Test clone](./test-clone/README.md)
- [UEFI firmware migration support](./uefi-firmware-migration-support/README.md)
- [Virtual disk image import to Compute Engine images](./virtual-disk-image-import-to-compute-engine-images/README.md)
- [Virtual machine disk migration to Persistent Disk](./virtual-machine-disk-migration-to-persistent-disk/README.md)
- [VM disk migration to Persistent Disk](./vm-disk-migration-to-persistent-disk/README.md)
- [VM groups](./vm-groups/README.md)
- [VM utilization reports](./vm-utilization-reports/README.md)
- [VMware 8.0 support](./vmware-8-0-support/README.md)
- [VPC Service Controls perimeter support](./vpc-service-controls-perimeter-support/README.md)
