# Exadata Database Service on Exascale infrastructure availability in northamerica-northeast1-a-r1

Product: Oracle Database@Google Cloud
Feature slug: `exadata-database-service-on-exascale-infrastructure-availability-in-northamerica-northeast1-a-r1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Exadata Database Service on Exascale infrastructure is available in the northamerica-northeast1-a-r1 location.
...
- access (evidence: [https://docs.cloud.google.com/oracle/database/docs/available-configurations](https://docs.cloud.google.com/oracle/database/docs/available-configurations), [https://docs.cloud.google.com/oracle/database/docs/create-instances](https://docs.cloud.google.com/oracle/database/docs/create-instances), [https://docs.cloud.google.com/oracle/database/docs/delete-instances](https://docs.cloud.google.com/oracle/database/docs/delete-instances), [https://docs.cloud.google.com/oracle/database/docs/manage-instances](https://docs.cloud.google.com/oracle/database/docs/manage-instances))
