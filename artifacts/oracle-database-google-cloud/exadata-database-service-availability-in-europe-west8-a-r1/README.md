# Exadata Database Service availability in europe-west8-a-r1

Product: Oracle Database@Google Cloud
Feature slug: `exadata-database-service-availability-in-europe-west8-a-r1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Exadata Database Service is available in the europe-west8-a-r1 location.
