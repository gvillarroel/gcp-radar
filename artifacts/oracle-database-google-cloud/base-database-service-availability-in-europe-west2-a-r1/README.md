# Base Database Service availability in europe-west2-a-r1

Product: Oracle Database@Google Cloud
Feature slug: `base-database-service-availability-in-europe-west2-a-r1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Base Database Service is available in the europe-west2-a-r1 location.
