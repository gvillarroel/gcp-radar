# Exadata Database Service availability in australia-southeast2-a-r2

Product: Oracle Database@Google Cloud
Feature slug: `exadata-database-service-availability-in-australia-southeast2-a-r2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Exadata Database Service is available in the australia-southeast2-a-r2 location.
