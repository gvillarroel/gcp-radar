...
Product: Spanner
Feature slug: `spanner-googlesql-insert-or-ignore-and-insert-or-update-clauses`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner now supports the GoogleSQL INSERT OR IGNORE and INSERT OR UPDATE clauses.
