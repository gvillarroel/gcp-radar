# Spanner GoogleSQL FLOAT64 function

Product: Spanner
Feature slug: `spanner-googlesql-float64-function`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Spanner GoogleSQL FLOAT64 JSON function is now generally available and converts a JSON number to a SQL FLOAT64.
