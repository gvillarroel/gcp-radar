# Spanner regional instance support in us-east1

Product: Spanner
Feature slug: `spanner-regional-instance-support-in-us-east1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner adds support for creating regional instances in the US East (South Carolina) region (us-east1).

## Lifecycle

- Latest feature date: 2018-04-26
