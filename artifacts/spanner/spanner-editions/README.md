...
Product: Spanner
Feature slug: `spanner-editions`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Spanner now supports a tier-based editions model with Standard, Enterprise, and Enterprise Plus options to match features and pricing to workload needs.
