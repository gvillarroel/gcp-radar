# Spanner Graph ELEMENT_ID() function

Product: Spanner
Feature slug: `spanner-graph-element-id-function`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds the Spanner Graph ELEMENT_ID() function, which returns the unique identifier of a graph element.
