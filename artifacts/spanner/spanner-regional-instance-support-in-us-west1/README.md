# Spanner regional instance support in us-west1

Product: Spanner
Feature slug: `spanner-regional-instance-support-in-us-west1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner adds support for creating regional instances in the US West (Oregon) region (us-west1).
