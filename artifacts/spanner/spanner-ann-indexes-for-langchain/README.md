# Spanner ANN indexes for LangChain

Product: Spanner
Feature slug: `spanner-ann-indexes-for-langchain`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner ANN indexes are now supported for use with LangChain.
...
- access (evidence: [https://docs.cloud.google.com/spanner/docs/use-ado-net](https://docs.cloud.google.com/spanner/docs/use-ado-net), [https://docs.cloud.google.com/spanner/docs/use-golang-database-sql](https://docs.cloud.google.com/spanner/docs/use-golang-database-sql), [https://docs.cloud.google.com/spanner/docs/change-streams/use-dataflow](https://docs.cloud.google.com/spanner/docs/change-streams/use-dataflow))
