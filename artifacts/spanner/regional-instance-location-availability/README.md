...
Product: Spanner
Feature slug: `regional-instance-location-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner added support for creating regional instances in the us-east4 (Northern Virginia) and asia-south1 (Mumbai) regions.

## Lifecycle

- Latest feature date: 2018-01-18
