# Cloud Spanner regional instance support in São Paulo

Product: Spanner
Feature slug: `cloud-spanner-regional-instance-support-in-s-o-paulo`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Spanner added support for creating regional instances in the South America (São Paulo) region (southamerica-east1).

## Lifecycle

- Latest feature date: 2019-07-31
