...
Product: Spanner
Feature slug: `spanner-gemini-cli-extension`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner now includes a dedicated Gemini CLI extension that allows users to execute SQL statements and query a Spanner instance using natural language controls.
