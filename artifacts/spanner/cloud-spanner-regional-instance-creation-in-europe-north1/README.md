# Cloud Spanner regional instance creation in europe-north1

Product: Spanner
Feature slug: `cloud-spanner-regional-instance-creation-in-europe-north1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Spanner regional instances can now be created in the europe-north1 (Finland) region.
