# Cloud Spanner regional instance support in us-west3

Product: Spanner
Feature slug: `cloud-spanner-regional-instance-support-in-us-west3`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Spanner added support for creating regional instances in the us-west3 (Salt Lake City) region.
