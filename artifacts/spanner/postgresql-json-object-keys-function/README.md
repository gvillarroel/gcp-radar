...
Product: Spanner
Feature slug: `postgresql-json-object-keys-function`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The PostgreSQL json_object_keys function is generally available in Spanner and returns the unique keys from a JSON expression.
