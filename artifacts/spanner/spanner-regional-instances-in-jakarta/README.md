# Spanner regional instances in Jakarta

Product: Spanner
Feature slug: `spanner-regional-instances-in-jakarta`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Spanner added support for creating regional instances in the Jakarta (asia-southeast2) region.
