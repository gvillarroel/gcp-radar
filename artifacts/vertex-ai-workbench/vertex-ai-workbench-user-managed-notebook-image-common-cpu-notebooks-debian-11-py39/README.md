# Vertex AI Workbench user-managed notebook image common-cpu-notebooks-debian-11-py39

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-user-managed-notebook-image-common-cpu-notebooks-debian-11-py39`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Introduced the Base CPU user-managed notebook image for Debian 11 with Python 3.9.
