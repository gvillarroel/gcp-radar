# Latest GPU support for Vertex AI Workbench

Product: Vertex AI Workbench
Feature slug: `latest-gpu-support-for-vertex-ai-workbench`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Workbench supports using the latest GPU types in notebook environments.
