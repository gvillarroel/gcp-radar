...
Feature slug: `vertex-ai-workbench-managed-notebooks-executor`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Introduces the managed notebooks executor to run notebook files on a schedule or as one-time executions with configurable run-time parameters.
