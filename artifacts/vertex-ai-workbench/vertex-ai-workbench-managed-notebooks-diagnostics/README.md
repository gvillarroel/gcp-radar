# Vertex AI Workbench managed notebooks diagnostics

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-managed-notebooks-diagnostics`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The managed notebooks feature includes a fix for excessive internal diagnostic tool processes that previously caused high CPU utilization.
