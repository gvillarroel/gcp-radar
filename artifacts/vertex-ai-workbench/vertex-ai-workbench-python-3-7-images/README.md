# Vertex AI Workbench Python 3.7 images

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-python-3-7-images`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Python 3.7 images for Vertex AI managed and user-managed notebooks have reached end of patch and support life; deprecated on 2023-09-18.

## Lifecycle

- Latest feature date: 2023-09-18
- Deprecation date: 2023-09-18
