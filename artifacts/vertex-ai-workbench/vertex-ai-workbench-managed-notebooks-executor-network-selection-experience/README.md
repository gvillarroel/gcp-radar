# Vertex AI Workbench managed notebooks executor network selection experience

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-managed-notebooks-executor-network-selection-experience`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Workbench enhanced the network selection user experience within managed notebooks executor.
