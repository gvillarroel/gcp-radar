# Vertex AI Workbench JupyterLab 4+ preview for new instances

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-jupyterlab-4-preview-for-new-instances`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

JupyterLab 4+ is available in preview on new Vertex AI Workbench instances at creation time.
