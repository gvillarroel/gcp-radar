# Log streaming to consumer project via Logs Viewer

Product: Vertex AI Workbench
Feature slug: `log-streaming-to-consumer-project-via-logs-viewer`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Vertex AI Workbench managed notebooks now support streaming logs to a consumer project through Cloud Logging Logs Viewer.
