# JupyterLab 4+ for Vertex AI Workbench instances

Product: Vertex AI Workbench
Feature slug: `jupyterlab-4-for-vertex-ai-workbench-instances`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

New Vertex AI Workbench instances can now be created with JupyterLab 4+.
