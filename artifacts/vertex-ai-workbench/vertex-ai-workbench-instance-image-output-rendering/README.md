...
Feature slug: `vertex-ai-workbench-instance-image-output-rendering`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Fixes the image output rendering bug so notebook instance image outputs display correctly in Vertex AI Workbench.
