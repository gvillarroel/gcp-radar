...
Feature slug: `python-3-10-support-on-debian-11-for-vertex-ai-workbench-managed-notebooks`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Workbench managed notebooks add support for Python 3.10 on Debian 11 environments.
