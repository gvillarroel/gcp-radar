# TensorFlow 2.6 CPU notebook images

Product: Vertex AI Workbench
Feature slug: `tensorflow-2-6-cpu-notebook-images`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

TensorFlow 2.6 CPU notebook images in Vertex AI Workbench are deprecated and will no longer receive updates; deprecated on 2024-05-17.
