# Vertex AI Workbench Serverless Spark activity logging

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-serverless-spark-activity-logging`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

ActivityLog refresh behavior was improved after Serverless Spark instance creation.
