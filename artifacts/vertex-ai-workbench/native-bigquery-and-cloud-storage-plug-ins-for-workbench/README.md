# Native BigQuery and Cloud Storage plug-ins for Workbench

Product: Vertex AI Workbench
Feature slug: `native-bigquery-and-cloud-storage-plug-ins-for-workbench`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Workbench includes native plug-ins for BigQuery and Cloud Storage access.
