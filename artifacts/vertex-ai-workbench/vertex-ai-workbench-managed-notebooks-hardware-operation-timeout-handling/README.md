# Vertex AI Workbench managed notebooks hardware-operation timeout handling

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-managed-notebooks-hardware-operation-timeout-handling`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Managed notebooks improved timeout behavior when performing hardware operations.
