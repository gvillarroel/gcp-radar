# Vertex AI Workbench user-managed notebooks JupyterLab 3.6.8 upgrade

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-user-managed-notebooks-jupyterlab-3-6-8-upgrade`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Vertex AI Workbench user-managed notebooks now include an upgrade to JupyterLab version 3.6.8.
