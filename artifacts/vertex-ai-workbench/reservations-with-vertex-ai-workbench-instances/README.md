# Reservations with Vertex AI Workbench instances

Product: Vertex AI Workbench
Feature slug: `reservations-with-vertex-ai-workbench-instances`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Vertex AI Workbench instances now support consuming Compute Engine zonal reservations in Preview.
