# VPC Service Controls integration for user-managed notebooks

Product: Vertex AI Workbench
Feature slug: `vpc-service-controls-integration-for-user-managed-notebooks`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Integration with VPC Service Controls for user-managed notebooks was available in beta.
