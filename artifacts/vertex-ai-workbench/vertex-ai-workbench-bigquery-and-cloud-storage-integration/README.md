# Vertex AI Workbench BigQuery and Cloud Storage integration

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-bigquery-and-cloud-storage-integration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Workbench enables access to BigQuery and Cloud Storage directly from JupyterLab.
