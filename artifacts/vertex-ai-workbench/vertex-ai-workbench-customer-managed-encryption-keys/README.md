# Vertex AI Workbench customer managed encryption keys

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-customer-managed-encryption-keys`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Vertex AI Workbench instances support customer managed encryption keys (CMEK).
