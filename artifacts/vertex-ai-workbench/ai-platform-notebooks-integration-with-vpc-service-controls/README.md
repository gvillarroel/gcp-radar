...
Feature slug: `ai-platform-notebooks-integration-with-vpc-service-controls`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

AI Platform Notebooks now supports VPC Service Controls, allowing notebook instances to be used within a service perimeter (beta).
