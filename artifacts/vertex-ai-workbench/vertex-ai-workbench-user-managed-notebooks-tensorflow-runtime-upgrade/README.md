# Vertex AI Workbench user-managed notebooks TensorFlow runtime upgrade

Product: Vertex AI Workbench
Feature slug: `vertex-ai-workbench-user-managed-notebooks-tensorflow-runtime-upgrade`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Vertex AI Workbench user-managed notebooks were upgraded to TensorFlow version 2.15.1.
