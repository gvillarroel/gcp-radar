# TensorFlow 2.9 user-managed instances

Product: Vertex AI Workbench
Feature slug: `tensorflow-2-9-user-managed-instances`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

TensorFlow 2.9 user-managed Vertex AI Workbench instances are a notebook compute option based on a user-managed environment; TensorFlow 2.9 user-managed Vertex AI Workbench instances are a notebook compute option based on a user-managed environment; deprecated on 2023-08-10.
