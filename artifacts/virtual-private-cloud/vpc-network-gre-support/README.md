...
Feature slug: `vpc-network-gre-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

VPC network GRE support adds General Availability for Generic Routing Encapsulation tunneling in Google Cloud Virtual Private Cloud.
