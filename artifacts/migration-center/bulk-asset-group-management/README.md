# Bulk asset group management

Product: Migration Center
Feature slug: `bulk-asset-group-management`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Lets you create asset groups in bulk or update group assignments across many assets simultaneously.
