...
Feature slug: `discovery-client-unregistration`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Migration Center lets you unregister a discovery client so it can be registered in another project without reinstalling.
