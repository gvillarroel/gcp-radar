# Granular Google Compute Engine preferences

Product: Migration Center
Feature slug: `granular-google-compute-engine-preferences`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Migration Center lets you refine Google Compute Engine recommendations by balancing latest technology and cost, prioritizing the lowest price, including pre-released SKUs, and choosing from more pricing tracks.
