# Migration Center discovery client v5

Product: Migration Center
Feature slug: `migration-center-discovery-client-v5`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Migration Center discovery client v5 was shut down and is no longer available; Migration Center discovery client v5 is being retired, with end of sale on July 30, 2024 and end of life on June 30, 2025; deprecated on 2025-06-30.
