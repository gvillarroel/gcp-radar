# Analytics and Cloud Logging opt-out controls

Product: Migration Center
Feature slug: `analytics-and-cloud-logging-opt-out-controls`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

The installation flow lets users opt out of sending analytics and Cloud Logging data to Google.
