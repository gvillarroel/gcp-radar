...
Feature slug: `network-statistics-collection`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

The discovery client collects network statistics such as open ports and traffic usage to support network dependency analysis.
