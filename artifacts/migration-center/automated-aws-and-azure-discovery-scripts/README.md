# Automated AWS and Azure discovery scripts

Product: Migration Center
Feature slug: `automated-aws-and-azure-discovery-scripts`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Migration Center supports automated scripts that collect data from AWS and Azure infrastructure and generate tables for upload.
