# VMware vCenter collection progress indicator

Product: Migration Center
Feature slug: `vmware-vcenter-collection-progress-indicator`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Migration Center Discovery Client shows a progress bar and asset count for VMware vCenter collections.
