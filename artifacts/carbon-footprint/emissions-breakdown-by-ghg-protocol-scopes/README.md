# Emissions breakdown by GHG Protocol scopes

Product: Carbon Footprint
Feature slug: `emissions-breakdown-by-ghg-protocol-scopes`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Carbon Footprint reports emissions broken down into scope 1, scope 2, and scope 3 categories following GHG Protocol standards.
