# AI inference emissions allocation methodology

Product: Carbon Footprint
Feature slug: `ai-inference-emissions-allocation-methodology`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Carbon Footprint allocates AI inference emissions to associated Google Cloud services and SKUs using an updated calculation model.
