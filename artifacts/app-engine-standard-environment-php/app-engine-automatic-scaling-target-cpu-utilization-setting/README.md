...
Feature slug: `app-engine-automatic-scaling-target-cpu-utilization-setting`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

A target CPU utilization setting was added to optimize App Engine automatic-scaling behavior for latency and cost.
