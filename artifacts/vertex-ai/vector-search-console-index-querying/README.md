# Vector Search console index querying

Product: Vertex AI
Feature slug: `vector-search-console-index-querying`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vector Search gained an improved console workflow to create and deploy index endpoints and query private or public deployed indexes for nearest-neighbor search in preview.

## Lifecycle

- Latest feature date: 2024-02-05
