...
Product: Vertex AI
Feature slug: `xgboost-1-4-pre-built-prediction-serving-container`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI added support for using a pre-built container to serve predictions from XGBoost 1.4 models.
