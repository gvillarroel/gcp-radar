# Vertex AI Batch Prediction Job Logging

Product: Vertex AI
Feature slug: `vertex-ai-batch-prediction-job-logging`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI now supports viewing logs for Batch Prediction jobs in Cloud Logging.
