# Vertex AI text-bison@002 stable model version

Product: Vertex AI
Feature slug: `vertex-ai-text-bison-002-stable-model-version`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The text-bison@002 model version is now available as the stable text foundation model release.
