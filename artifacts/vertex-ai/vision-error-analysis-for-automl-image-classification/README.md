# Vision error analysis for AutoML image classification

Product: Vertex AI
Feature slug: `vision-error-analysis-for-automl-image-classification`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI adds vision-focused error analysis for AutoML image classification models.
