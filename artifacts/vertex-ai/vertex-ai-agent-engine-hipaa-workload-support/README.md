# Vertex AI Agent Engine HIPAA workload support

Product: Vertex AI
Feature slug: `vertex-ai-agent-engine-hipaa-workload-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI Agent Engine now supports workloads requiring HIPAA compliance.
