# Custom model training on TPU VMs

Product: Vertex AI
Feature slug: `custom-model-training-on-tpu-vms`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Vertex AI now allows users to train custom models using Cloud TPU Architecture (TPU VMs).

## Lifecycle

- Latest feature date: 2022-04-26
