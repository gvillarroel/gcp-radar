# Region availability: europe-west2

Product: App Engine standard environment Python
Feature slug: `region-availability-europe-west2`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

App Engine standard environment for Python is available in the europe-west2 region.
