# Artifact Registry private Python dependencies

Product: App Engine standard environment Python
Feature slug: `artifact-registry-private-python-dependencies`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Python 3 apps can install private dependencies hosted in an Artifact Registry Python repository through requirements.txt.
