# New Migration private offer

Product: Google Cloud Marketplace Partners
Feature slug: `new-migration-private-offer`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

New Migration is a Private Offer deal type that can be selected when creating an offer.
