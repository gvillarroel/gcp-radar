# Groups nested group inspection

Product: Apps Script
Feature slug: `groups-nested-group-inspection`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Apps Script Groups service adds methods to list groups and test whether a group contains another group.
