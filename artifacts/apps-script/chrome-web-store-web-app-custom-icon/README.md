# Chrome Web Store web app custom icon

Product: Apps Script
Feature slug: `chrome-web-store-web-app-custom-icon`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Web apps published to the Chrome Web Store can now use a custom app icon.
