# Spreadsheet image insertion

Product: Apps Script
Feature slug: `spreadsheet-image-insertion`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Sheets can insert images from blobs at specified row and column positions with optional offsets.
