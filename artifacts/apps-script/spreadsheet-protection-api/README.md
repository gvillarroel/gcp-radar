# Spreadsheet protection API

Product: Apps Script
Feature slug: `spreadsheet-protection-api`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Spreadsheet service can precisely protect sheets and ranges using the Protection model.
