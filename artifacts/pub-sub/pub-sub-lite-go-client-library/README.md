...
Product: Pub/Sub
Feature slug: `pub-sub-lite-go-client-library`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Pub/Sub Lite Go client library reached GA.
