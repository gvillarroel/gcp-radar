# Pub/Sub availability in asia-southeast3

Product: Pub/Sub
Feature slug: `pub-sub-availability-in-asia-southeast3`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Pub/Sub is available in the asia-southeast3 region.
...
- iam (evidence: [https://docs.cloud.google.com/pubsub/docs/reference/service_apis_overview](https://docs.cloud.google.com/pubsub/docs/reference/service_apis_overview), [https://docs.cloud.google.com/pubsub/docs/publish-receive-messages-gcloud](https://docs.cloud.google.com/pubsub/docs/publish-receive-messages-gcloud), [https://docs.cloud.google.com/pubsub/docs/reliability-intro](https://docs.cloud.google.com/pubsub/docs/reliability-intro), [https://docs.cloud.google.com/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.PublisherInterface](https://docs.cloud.google.com/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.PublisherInterface))
