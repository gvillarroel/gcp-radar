# Gemini Code Assist API development features in Apigee

Product: Apigee X
Feature slug: `gemini-code-assist-api-development-features-in-apigee`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini Code Assist in Apigee enables natural-language API design, iteration, testing, publishing, and duplicate endpoint detection within VS Code.
