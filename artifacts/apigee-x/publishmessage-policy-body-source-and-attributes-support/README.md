# PublishMessage policy body source and attributes support

Product: Apigee X
Feature slug: `publishmessage-policy-body-source-and-attributes-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The PublishMessage policy now supports using request or response message content as Pub/Sub data and adding string attributes to published messages; The PublishMessage policy now supports using request or response message content as Pub/Sub data and adding string attributes to published messages.
