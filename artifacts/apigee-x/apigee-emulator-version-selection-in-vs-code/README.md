# Apigee Emulator version selection in VS Code

Product: Apigee X
Feature slug: `apigee-emulator-version-selection-in-vs-code`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Local development in Apigee for VS Code supports using a different Apigee Emulator version.
