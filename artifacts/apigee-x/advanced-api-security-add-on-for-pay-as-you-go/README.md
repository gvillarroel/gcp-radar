# Advanced API Security add-on for Pay-as-you-go

Product: Apigee X
Feature slug: `advanced-api-security-add-on-for-pay-as-you-go`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Advanced API Security is available as a paid add-on for Apigee Pay-as-you-go organizations.
