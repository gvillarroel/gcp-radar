...
Product: Apigee X
Feature slug: `simplified-onboarding-for-pay-as-you-go`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- policy (evidence: [https://docs.cloud.google.com/apigee/docs/api-platform/monetization/manage-rate-plans](https://docs.cloud.google.com/apigee/docs/api-platform/monetization/manage-rate-plans), [https://docs.cloud.google.com/apigee/docs/api-platform/reference/policies/flow-callout-policy](https://docs.cloud.google.com/apigee/docs/api-platform/reference/policies/flow-callout-policy), [https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/understanding-handling-request-response-data](https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/understanding-handling-request-response-data))
