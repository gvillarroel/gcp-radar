...
Apigee now supports Workforce Identity Federation for authenticating and authorizing workforce users through an external identity provider.
...
- auth (evidence: [https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/fault-handling](https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/fault-handling), [https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/understanding-handling-request-response-data](https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/understanding-handling-request-response-data), [https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/what-you-need-know-about-policy-errors](https://docs.cloud.google.com/apigee/docs/api-platform/fundamentals/what-you-need-know-about-policy-errors))
