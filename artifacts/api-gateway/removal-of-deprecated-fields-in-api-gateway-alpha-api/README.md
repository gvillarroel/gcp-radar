...
Product: API Gateway
Feature slug: `removal-of-deprecated-fields-in-api-gateway-alpha-api`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/api-gateway/docs/api-hub-view-apis](https://docs.cloud.google.com/api-gateway/docs/api-hub-view-apis), [https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/com.google.cloud.apigateway.v1.Api.Builder](https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/com.google.cloud.apigateway.v1.Api.Builder), [https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/overview](https://docs.cloud.google.com/java/docs/reference/google-cloud-api-gateway/latest/overview))
