...
Product: AlloyDB
Feature slug: `high-availability-recommender`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The High availability recommender helps identify opportunities to enable high availability for AlloyDB deployments.
