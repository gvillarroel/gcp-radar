# AlloyDB Omni command-line interface

Product: AlloyDB
Feature slug: `alloydb-omni-command-line-interface`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

AlloyDB Omni version 15.2.0 introduces a command-line interface for easier installation and maintenance.
