# Access Approval support for Serverless VPC Access support

Product: Access Approval
Feature slug: `access-approval-support-for-serverless-vpc-access-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Serverless VPC Access support is supported by Access Approval.
