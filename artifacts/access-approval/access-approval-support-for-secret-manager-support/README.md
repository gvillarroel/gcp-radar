# Access Approval support for Secret Manager support

Product: Access Approval
Feature slug: `access-approval-support-for-secret-manager-support`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Secret Manager support is supported by Access Approval.
