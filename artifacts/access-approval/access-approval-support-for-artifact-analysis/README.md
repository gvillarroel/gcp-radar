# Access Approval support for Artifact Analysis

Product: Access Approval
Feature slug: `access-approval-support-for-artifact-analysis`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Artifact Analysis is supported by Access Approval.
