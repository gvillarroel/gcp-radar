# Access Approval support for Speaker ID support

Product: Access Approval
Feature slug: `access-approval-support-for-speaker-id-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Speaker ID support is supported by Access Approval.
