# Access Approval support for Cloud Spanner support

Product: Access Approval
Feature slug: `access-approval-support-for-cloud-spanner-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Cloud Spanner support is supported by Access Approval.
