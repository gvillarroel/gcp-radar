# Access Approval support for Regional internal Application Load Balancer support

Product: Access Approval
Feature slug: `access-approval-support-for-regional-internal-application-load-balancer-support`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Regional internal Application Load Balancer support is supported by Access Approval.
