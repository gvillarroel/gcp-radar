# Access Approval support for Security Command Center Premium tier support

Product: Access Approval
Feature slug: `access-approval-support-for-security-command-center-premium-tier-support`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Security Command Center Premium tier support is supported by Access Approval.
