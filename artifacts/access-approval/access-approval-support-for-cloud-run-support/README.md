# Access Approval support for Cloud Run support

Product: Access Approval
Feature slug: `access-approval-support-for-cloud-run-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Cloud Run support is supported by Access Approval.
