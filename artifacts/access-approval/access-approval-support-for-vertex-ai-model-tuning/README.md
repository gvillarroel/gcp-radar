# Access Approval support for Vertex AI model tuning

Product: Access Approval
Feature slug: `access-approval-support-for-vertex-ai-model-tuning`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Vertex AI model tuning is supported by Access Approval.
