# Access Approval support for Cloud Logging support

Product: Access Approval
Feature slug: `access-approval-support-for-cloud-logging-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Cloud Logging support is supported by Access Approval.
