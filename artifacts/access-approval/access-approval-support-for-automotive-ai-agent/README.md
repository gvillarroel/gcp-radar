# Access Approval support for Automotive AI Agent

Product: Access Approval
Feature slug: `access-approval-support-for-automotive-ai-agent`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Automotive AI Agent is supported by Access Approval.
