# Access Approval support for Cloud Tasks support

Product: Access Approval
Feature slug: `access-approval-support-for-cloud-tasks-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Cloud Tasks support is supported by Access Approval.
