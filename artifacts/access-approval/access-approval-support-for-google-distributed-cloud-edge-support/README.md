# Access Approval support for Google Distributed Cloud Edge support

Product: Access Approval
Feature slug: `access-approval-support-for-google-distributed-cloud-edge-support`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Google Distributed Cloud Edge support is supported by Access Approval.
