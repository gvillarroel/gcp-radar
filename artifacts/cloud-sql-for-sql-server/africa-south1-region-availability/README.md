...
Feature slug: `africa-south1-region-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for SQL Server instances are available in the africa-south1 (Johannesburg) region.
...
- access (evidence: [https://docs.cloud.google.com/sql/docs/sqlserver/pricing](https://docs.cloud.google.com/sql/docs/sqlserver/pricing), [https://docs.cloud.google.com/sql/docs/sqlserver/configure-ha](https://docs.cloud.google.com/sql/docs/sqlserver/configure-ha), [https://docs.cloud.google.com/sql/docs/sqlserver/availability](https://docs.cloud.google.com/sql/docs/sqlserver/availability))
