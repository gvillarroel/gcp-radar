# europe-west10 region availability

Product: Cloud SQL for SQL Server
Feature slug: `europe-west10-region-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for SQL Server instances are available in the europe-west10 (Berlin) region.
