# asia-northeast3 region support

Product: Cloud SQL for SQL Server
Feature slug: `asia-northeast3-region-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for SQL Server instances can be deployed in the asia-northeast3 (Seoul) region.
