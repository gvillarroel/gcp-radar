...
- access (evidence: [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/active_directory_ds](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/active_directory_ds), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/activemq](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/activemq), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/aerospike](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/aerospike))
