...
Feature slug: `apache-hadoop-log-and-metric-collection-in-ops-agent`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- access (evidence: [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/hadoop](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/hadoop), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/apache](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/apache), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/cassandra](https://docs.cloud.google.com/logging/docs/agent/ops-agent/third-party/cassandra))
