...
Feature slug: `ops-agent-built-in-log-rotation`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- logging (evidence: [https://docs.cloud.google.com/logging/docs/agent/ops-agent/rotate-logs](https://docs.cloud.google.com/logging/docs/agent/ops-agent/rotate-logs), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/configuration](https://docs.cloud.google.com/logging/docs/agent/ops-agent/configuration), [https://docs.cloud.google.com/logging/docs/agent/logging](https://docs.cloud.google.com/logging/docs/agent/logging))
- security (evidence: [https://docs.cloud.google.com/logging/docs/agent/ops-agent/rotate-logs](https://docs.cloud.google.com/logging/docs/agent/ops-agent/rotate-logs), [https://docs.cloud.google.com/logging/docs/agent/ops-agent/configuration](https://docs.cloud.google.com/logging/docs/agent/ops-agent/configuration), [https://docs.cloud.google.com/logging/docs/agent/logging](https://docs.cloud.google.com/logging/docs/agent/logging))
