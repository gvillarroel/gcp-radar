# PyTorch 1.6 support via PyTorch/XLA

Product: Cloud TPU
Feature slug: `pytorch-1-6-support-via-pytorch-xla`
Coverage: `LOW`
IAM mapping: `explicit`

## Technical Summary

Cloud TPU supports PyTorch 1.6 through PyTorch/XLA integration for training supported models on TPUs.
