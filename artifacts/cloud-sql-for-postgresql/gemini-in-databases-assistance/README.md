...
Feature slug: `gemini-in-databases-assistance`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Gemini in Databases assistance adds AI-powered help for Query Insights, system insights, index advisor, and active queries in Cloud SQL for PostgreSQL.
