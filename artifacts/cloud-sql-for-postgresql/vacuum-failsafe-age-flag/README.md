# vacuum_failsafe_age flag

Product: Cloud SQL for PostgreSQL
Feature slug: `vacuum-failsafe-age-flag`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The vacuum_failsafe_age flag sets the maximum transaction age before VACUUM takes extraordinary measures to avoid transaction ID wraparound failure.
