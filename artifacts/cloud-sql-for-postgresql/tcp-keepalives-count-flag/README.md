# tcp_keepalives_count flag

Product: Cloud SQL for PostgreSQL
Feature slug: `tcp-keepalives-count-flag`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The tcp_keepalives_count flag sets the number of TCP keepalive probes sent before declaring a connection dead.
