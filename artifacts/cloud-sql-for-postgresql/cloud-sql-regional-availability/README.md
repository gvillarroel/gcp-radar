...
Feature slug: `cloud-sql-regional-availability`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for PostgreSQL is available in the africa-south1 region; Cloud SQL for PostgreSQL is available in the me-central2 region.
