# effective_io_concurrency flag

Product: Cloud SQL for PostgreSQL
Feature slug: `effective-io-concurrency-flag`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The effective_io_concurrency flag sets the number of concurrent disk I/O operations that can run at the same time.
