# Region availability in southamerica-west1

Product: Cloud SQL for PostgreSQL
Feature slug: `region-availability-in-southamerica-west1`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud SQL for PostgreSQL is available in the southamerica-west1 region.
