...
Feature slug: `bigquery-results-storage`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Allows inspection results from BigQuery, Cloud Datastore, and Cloud Storage scans to be written to BigQuery.

## Lifecycle

- Latest feature date: 2017-08-03
...
- allow (evidence: [https://docs.cloud.google.com/sensitive-data-protection/docs/inspecting-storage](https://docs.cloud.google.com/sensitive-data-protection/docs/inspecting-storage), [https://docs.cloud.google.com/sensitive-data-protection/docs/creating-job-triggers](https://docs.cloud.google.com/sensitive-data-protection/docs/creating-job-triggers), [https://docs.cloud.google.com/sensitive-data-protection/docs/deidentify-storage](https://docs.cloud.google.com/sensitive-data-protection/docs/deidentify-storage))
