# DOCUMENT_TYPE/R&D/SOURCE_CODE/POWERSHELL infoType detector

Product: Sensitive Data Protection
Feature slug: `document-type-r-d-source-code-powershell-infotype-detector`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The DOCUMENT_TYPE/R&D/SOURCE_CODE/POWERSHELL infoType detector is available in all regions.
