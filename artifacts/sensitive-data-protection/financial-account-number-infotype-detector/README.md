# FINANCIAL_ACCOUNT_NUMBER infoType detector

Product: Sensitive Data Protection
Feature slug: `financial-account-number-infotype-detector`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The FINANCIAL_ACCOUNT_NUMBER built-in infoType detector identifies financial account numbers.
