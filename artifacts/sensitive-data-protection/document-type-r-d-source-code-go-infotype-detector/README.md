...
Feature slug: `document-type-r-d-source-code-go-infotype-detector`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The DOCUMENT_TYPE/R&D/SOURCE_CODE/GO infoType detector is available in all regions.
