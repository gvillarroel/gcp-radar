...
Feature slug: `general-purpose-c3-vms`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

General purpose C3 VMs provide the C3 machine family for general-purpose workloads; General purpose C3 VMs provide the C3 machine family for general-purpose workloads.
