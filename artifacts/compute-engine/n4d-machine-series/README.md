...
Feature slug: `n4d-machine-series`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

N4D is a general-purpose VM series powered by 5th generation AMD EPYC Turin processors with DDR5 memory, Hyperdisk support, and up to 50 Gbps networking.
