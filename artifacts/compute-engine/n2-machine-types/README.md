...
Feature slug: `n2-machine-types`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

N2 machine types provide balanced VM instances based on Intel Cascade Lake processors; N2 machine types are general-purpose virtual machine types for Compute Engine workloads.
