...
Feature slug: `cpu-overcommit-on-sole-tenant-nodes`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

CPU overcommit on sole-tenant nodes lets you provision more VM CPUs on a node than are physically available.

## Lifecycle

- Latest feature date: 2020-06-05
