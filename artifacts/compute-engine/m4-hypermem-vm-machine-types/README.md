# M4 Hypermem VM machine types

Product: Compute Engine
Feature slug: `m4-hypermem-vm-machine-types`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

M4 memory-optimized Hypermem VMs add smaller machine types with a 15.5:1 GB-to-vCPU ratio.
