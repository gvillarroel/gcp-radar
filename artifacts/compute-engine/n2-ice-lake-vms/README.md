...
Feature slug: `n2-ice-lake-vms`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Third generation Intel Xeon Scalable Processor (Ice Lake) based N2 virtual machines are available in select regions and zones.
