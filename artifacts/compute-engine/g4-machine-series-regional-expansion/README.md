# G4 machine series regional expansion

Product: Compute Engine
Feature slug: `g4-machine-series-regional-expansion`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The G4 accelerator-optimized machine series is now available in additional regions and zones including Singapore, Netherlands, Iowa, Virginia, and Ohio.
