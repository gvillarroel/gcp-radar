# TensorFlow Enterprise 2.1 in AI Platform Notebooks

Product: Tensorflow Enterprise
Feature slug: `tensorflow-enterprise-2-1-in-ai-platform-notebooks`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

TensorFlow Enterprise 2.1 is available for use in AI Platform Notebooks.
