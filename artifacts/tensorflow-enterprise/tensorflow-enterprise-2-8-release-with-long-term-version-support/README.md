# TensorFlow Enterprise 2.8 release with Long Term Version Support

Product: Tensorflow Enterprise
Feature slug: `tensorflow-enterprise-2-8-release-with-long-term-version-support`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

TensorFlow Enterprise 2.8 was released and includes Long Term Version Support.
