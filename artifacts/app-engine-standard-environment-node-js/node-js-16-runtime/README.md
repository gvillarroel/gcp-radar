...
Feature slug: `node-js-16-runtime`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Node.js 16 runtime enables App Engine standard environment applications to run on Node.js 16; The Node.js 16 runtime enables App Engine standard environment applications to run on Node.js 16.

## Lifecycle

- Latest feature date: 2021-11-29
