...
Feature slug: `automatic-scaling-target-throughput-utilization`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Automatic scaling can tune instance creation based on a target throughput utilization setting.
