...
The Node.js 18 runtime enables App Engine standard environment applications to run on Node.js 18; The Node.js 18 runtime enables App Engine standard environment applications to run on Node.js 18.
