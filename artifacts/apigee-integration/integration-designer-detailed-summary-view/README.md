# Integration designer detailed summary view

Product: Apigee Integration
Feature slug: `integration-designer-detailed-summary-view`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Adds the ability to view a detailed summary of an integration from the Integration designer.
