# Cloud VPN regional availability in us-west4

Product: Cloud VPN
Feature slug: `cloud-vpn-regional-availability-in-us-west4`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud VPN is available in the us-west4 region (Las Vegas, Nevada, USA).
