# Storage LUN and access control assignment in Bare Metal Solution Order Form

Product: Bare Metal Solution
Feature slug: `storage-lun-and-access-control-assignment-in-bare-metal-solution-order-form`
Coverage: `MEDIUM`
IAM mapping: `explicit`

## Technical Summary

Supports selecting LUNs and assigning which servers can access a storage volume.
