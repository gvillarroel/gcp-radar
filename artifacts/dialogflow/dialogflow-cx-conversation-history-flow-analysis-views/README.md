# Dialogflow CX conversation history flow analysis views

Product: Dialogflow
Feature slug: `dialogflow-cx-conversation-history-flow-analysis-views`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX conversation history includes flow analysis table and graph views.
