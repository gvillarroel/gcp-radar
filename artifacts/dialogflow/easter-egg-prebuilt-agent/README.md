# Easter Egg Prebuilt Agent

Product: Dialogflow
Feature slug: `easter-egg-prebuilt-agent`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Easter Egg prebuilt agent provides a ready-made conversational agent for novelty interactions.

## Lifecycle

- Latest feature date: 2017-12-01
