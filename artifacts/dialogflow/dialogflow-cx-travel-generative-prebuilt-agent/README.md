# Dialogflow CX travel generative prebuilt agent

Product: Dialogflow
Feature slug: `dialogflow-cx-travel-generative-prebuilt-agent`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a generative prebuilt agent for travel use cases.
