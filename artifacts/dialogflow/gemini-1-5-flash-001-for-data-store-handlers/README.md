# gemini-1.5-flash-001 for data store handlers

Product: Dialogflow
Feature slug: `gemini-1-5-flash-001-for-data-store-handlers`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Conversational Agents data store handlers support the gemini-1.5-flash-001 model in general availability.
