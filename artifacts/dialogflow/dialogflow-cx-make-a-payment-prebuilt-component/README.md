# Dialogflow CX make a payment prebuilt component

Product: Dialogflow
Feature slug: `dialogflow-cx-make-a-payment-prebuilt-component`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt component for payment flows.
