...
Product: Dialogflow
Feature slug: `code-bison-model`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX generative features used the code-bison model for supported agent capabilities; deprecated on 2024-10-21.

## Lifecycle

- Latest feature date: 2024-09-19
- Deprecation date: 2024-10-21
