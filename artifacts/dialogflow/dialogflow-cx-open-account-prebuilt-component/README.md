# Dialogflow CX open account prebuilt component

Product: Dialogflow
Feature slug: `dialogflow-cx-open-account-prebuilt-component`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt component for account opening flows.
