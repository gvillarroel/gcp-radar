# Dialogflow CX disputes prebuilt component

Product: Dialogflow
Feature slug: `dialogflow-cx-disputes-prebuilt-component`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt component for disputes flows.
