# Dialogflow CX Order and account management agent

Product: Dialogflow
Feature slug: `dialogflow-cx-order-and-account-management-agent`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt Order and account management agent.
