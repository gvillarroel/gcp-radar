...
Product: Dialogflow
Feature slug: `dialogflow-cx-console`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Dialogflow CX console will be deprecated and users will be automatically routed to the Conversational Agents console; deprecated on 2025-10-31.
