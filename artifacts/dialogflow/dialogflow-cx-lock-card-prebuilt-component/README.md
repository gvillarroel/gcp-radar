# Dialogflow CX lock card prebuilt component

Product: Dialogflow
Feature slug: `dialogflow-cx-lock-card-prebuilt-component`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt component for lock card flows.
