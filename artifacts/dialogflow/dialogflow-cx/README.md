...
Product: Dialogflow
Feature slug: `dialogflow-cx`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX is a conversational agent design experience based on flow and state-machine concepts; Dialogflow CX is a conversational agent design experience based on flow and state-machine concepts.
