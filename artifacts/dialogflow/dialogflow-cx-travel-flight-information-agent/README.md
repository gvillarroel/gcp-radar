# Dialogflow CX Travel flight information agent

Product: Dialogflow
Feature slug: `dialogflow-cx-travel-flight-information-agent`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Dialogflow CX provides a prebuilt Travel flight information agent.
