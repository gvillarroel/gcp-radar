...
Feature slug: `backup-and-dr-metrics-reporting-enhancements`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Metrics reporting was improved for ongoing management console and backup/recovery appliance supportability.
