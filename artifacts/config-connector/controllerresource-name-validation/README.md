# ControllerResource name validation

Product: Config Connector
Feature slug: `controllerresource-name-validation`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Config Connector added name validation for customizable ControllerResource CRDs.
