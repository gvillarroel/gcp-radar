# ContainerCluster GPU partition size

Product: Config Connector
Feature slug: `containercluster-gpu-partition-size`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Config Connector supports configuring GPU partition size on ContainerCluster resources.
