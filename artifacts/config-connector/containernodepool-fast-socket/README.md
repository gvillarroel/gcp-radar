# ContainerNodePool fast socket

Product: Config Connector
Feature slug: `containernodepool-fast-socket`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Config Connector added the fastSocket field to the ContainerNodePool node configuration.
