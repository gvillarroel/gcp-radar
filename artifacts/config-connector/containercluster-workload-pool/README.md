# ContainerCluster workload pool

Product: Config Connector
Feature slug: `containercluster-workload-pool`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Config Connector supports configuring the workload pool on ContainerCluster resources.
