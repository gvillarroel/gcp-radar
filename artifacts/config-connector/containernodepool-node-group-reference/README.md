# ContainerNodePool node group reference

Product: Config Connector
Feature slug: `containernodepool-node-group-reference`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The ContainerNodePool resource supports node group references through spec.nodeConfig.nodeGroupRef.
