# EdgeNetworkSubnet resource

Product: Config Connector
Feature slug: `edgenetworksubnet-resource`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Config Connector added support for managing the EdgeNetworkSubnet resource in v1beta1.
