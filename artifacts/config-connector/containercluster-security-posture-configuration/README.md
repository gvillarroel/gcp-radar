# ContainerCluster security posture configuration

Product: Config Connector
Feature slug: `containercluster-security-posture-configuration`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Config Connector supports security posture configuration on ContainerCluster resources.
