# NetworkServicesHTTPRoute resource

Product: Config Connector
Feature slug: `networkserviceshttproute-resource`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Config Connector supports the NetworkServicesHTTPRoute resource in alpha.
