# ComputeTargetHTTPSProxy certificate map reference

Product: Config Connector
Feature slug: `computetargethttpsproxy-certificate-map-reference`
Coverage: `LOW`
IAM mapping: `unknown`

## Technical Summary

Config Connector supports the certificateMapRef field for ComputeTargetHTTPSProxy resources.
