# Speech-to-Text telephony_short model

Product: Speech-to-Text
Feature slug: `speech-to-text-telephony-short-model`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Introduces the telephony_short model for phone-call audio recognition as an updated variant of the existing phone_call model.
