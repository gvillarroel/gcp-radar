...
Feature slug: `speech-adaptation-boost`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Speech-to-Text added the speech adaptation boost feature for additional supported languages.
...
- [https://docs.cloud.google.com/speech-to-text/docs/encryption](https://docs.cloud.google.com/speech-to-text/docs/encryption)
