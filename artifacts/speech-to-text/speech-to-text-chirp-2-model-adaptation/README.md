# Speech-to-Text Chirp 2 model adaptation

Product: Speech-to-Text
Feature slug: `speech-to-text-chirp-2-model-adaptation`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Chirp 2 model added support for model adaptation in Speech-to-Text.
