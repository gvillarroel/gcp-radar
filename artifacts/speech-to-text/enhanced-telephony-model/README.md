...
Feature slug: `enhanced-telephony-model`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Cloud Speech-to-Text added the enhanced telephony model feature for additional supported languages.
