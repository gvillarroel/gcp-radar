...
Feature slug: `local-processing-in-aws-clusters`
Coverage: `MEDIUM`
IAM mapping: `unknown`
...
- Latest feature date: 2022-12-06
- Deprecation date: 2022-12-06
...
- credential (evidence: [https://docs.cloud.google.com/migrate/containers/docs/getting-started](https://docs.cloud.google.com/migrate/containers/docs/getting-started), [https://docs.cloud.google.com/migrate/containers/docs/m2c-cli/clean-up](https://docs.cloud.google.com/migrate/containers/docs/m2c-cli/clean-up), [https://docs.cloud.google.com/migrate/containers/docs/deploy-autopilot](https://docs.cloud.google.com/migrate/containers/docs/deploy-autopilot))
