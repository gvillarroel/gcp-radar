...
Provides an improved integration for Chrome Enterprise Premium with streamlined connection to Google SecOps, enhanced log context, updated documentation, curated dashboards, and related SOAR actions.
