# Capacity Planner REST API reference documentation

Product: Capacity Planner
Feature slug: `capacity-planner-rest-api-reference-documentation`
Coverage: `MEDIUM`
IAM mapping: `unknown`
