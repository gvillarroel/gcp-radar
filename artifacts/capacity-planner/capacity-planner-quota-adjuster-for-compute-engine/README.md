...
- access (evidence: [https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster](https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster))
- iam (evidence: [https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster](https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster))
- identity (evidence: [https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster](https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster))
- permission (evidence: [https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster](https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster))
- role (evidence: [https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster](https://docs.cloud.google.com/capacity-planner/docs/enable-quota-adjuster))
