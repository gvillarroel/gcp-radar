# Monitoring Agent for SAP HANA v1.0

Product: SAP on Google Cloud
Feature slug: `monitoring-agent-for-sap-hana-v1-0`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

Version 1.0 of the Google Cloud monitoring agent for SAP HANA is deprecated in favor of v2.0; deprecated on 2021-12-31.

## Lifecycle

- Latest feature date: 2021-03-01
- Deprecation date: 2021-12-31
