...
Feature slug: `monitoring-agent-for-sap-hana`
Coverage: `MEDIUM`
IAM mapping: `unknown`

## Technical Summary

The Google Cloud monitoring agent for SAP HANA is deprecated and replaced by SAP HANA monitoring metrics collection in Agent for SAP v2.0; deprecated on 2024-05-31.
